...
## 01E.1 How to use this checklist

### 01E.1.1 Conformance is a claim about a toolchain, not just a compiler
...
## 01E.2 Profile definitions (normative)

### 01E.2.1 ObjC 3.0 v1 Core
A toolchain claiming **ObjC 3.0 v1 Core** shall:

- implement the language mode selection and feature-test mechanisms (Part 1),
- implement modules/interface emission and required metadata preservation (Part 2, 01B, 01D),
...
- implement the error model (`throws`, `try`, bridging) (Part 6, 01C),
- implement the concurrency model (`async/await`, executors, cancellation, actors) sufficiently to compile and run correct programs (Part 7, 01C).

“Core” does **not** require the optional feature sets (metaprogramming macros, Swift overlays) unless separately claimed.

### 01E.2.2 ObjC 3.0 v1 Strict
...
- ensure canonical spellings are emitted in textual interfaces (01B, Part 2, Part 12).

### 01E.2.3 ObjC 3.0 v1 Strict Concurrency
...
- preserve concurrency-relevant metadata across modules (01D Table A).

### 01E.2.4 ObjC 3.0 v1 Strict System
...
- preserve borrowed/lifetime annotations across modules (01B.8, 01D Table A),
...
### 01E.3.1 Language mode selection, feature tests, and versioning
...
### 01E.3.2 Modules, namespacing, and interface emission
...
- [ ] **[CORE]** Emit **canonical spellings** for ObjC 3.0 features in textual interfaces, per 01B. (01B.1, 01B.7; Part 2)
- [ ] **[CORE]** Preserve and record all “must preserve” metadata in 01D Table A. (01D.3.1)
...
### 01E.3.3 Type system: nullability defaults, optionals, generics, key paths
- [ ] **[CORE]** Support nullability qualifiers and treat them as part of the type system in ObjC 3.0 mode. (Part 3)
- [ ] **[CORE]** Support nonnull-by-default regions with canonical pragma spellings (01B.2). (Part 3, 01B.2)
...
- [ ] **[CORE]** Support optional types `T?` and IUO `T!` where specified, including:
  ...
  - optional chaining / optional message send `[receiver? sel]` (Part 3, 01C.3.1),
  - postfix propagation `expr?` per carrier rules (Part 3; Part 6; 01C.3.3).
- [ ] **[CORE]** Enforce v1 restriction that optional chaining is reference-only for member returns (D‑001; Part 3).
- [ ] **[CORE]** Preserve optional and nullability information in module metadata and textual interfaces (01D Table A).
...
### 01E.3.4 Memory management and lifetime
- [ ] **[CORE]** Preserve ObjC ARC semantics and ensure new language features lower without violating ARC rules. (Part 4)
- [ ] **[CORE]** Implement the suspension-point autorelease pool contract (D‑006; 01C.7; Part 7). This includes:
...
### 01E.3.5 Control flow and safety constructs
...
### 01E.3.6 Errors and `throws`
- [ ] **[CORE]** Implement untyped `throws` as the v1 model (D‑002; Part 6).
- [ ] **[CORE]** Provide a stable ABI/lowering model for `throws` (D‑009; 01C.4; 01D Table B).
- [ ] **[CORE]** Support `try`, `do/catch`, and propagation rules that integrate with optionals as specified. (Part 6)
- [ ] **[CORE]** Support NSError/status-code bridging attributes where specified (01B.4; Part 6), including module metadata preservation (01D Table A).
- [ ] **[STRICT]** Provide diagnostics for ignored errors, missing `try`, and invalid bridging patterns. (Part 12)

### 01E.3.7 Concurrency: `async/await`, executors, cancellation, actors
- [ ] **[CORE]** Implement `async` and `await` grammar and typing rules as specified. (Part 7)
- [ ] **[CORE]** Implement a coroutine-based lowering model for `async` (D‑010; 01C.5) and preserve required ABI metadata (01D Table B).
- [ ] **[CORE]** Implement cancellation propagation and task-context behavior as specified. (Part 7; 01C.5.2)
- [ ] **[CORE]** Implement executor affinity annotations and call-site behavior:
  - accept canonical `objc_executor(...)` spellings (01B.3.1),
  - preserve in module metadata (01D Table A),
  - perform required hops as specified. (Part 7; 01C.5.3)
- [ ] **[CORE]** Implement actor declarations and actor isolation rules (Part 7; 01C.6).
...
- [ ] **[CONC]** Enforce Sendable-like constraints for:
  ...
  - values crossing executor domains. (Part 7; 01D Table A)
...
### 01E.3.8 System programming extensions (Part 8)
- [ ] **[SYSTEM]** Support canonical attribute spellings for Part 8 features (01B.8), including:
...
- [ ] **[SYSTEM]** Preserve borrowed/lifetime annotations in module metadata (01D Table A).
...
### 01E.3.9 Performance and dynamism controls
- [ ] **[CORE]** Accept and preserve canonical spellings for `objc_direct`, `objc_final`, `objc_sealed` (01B.5; Part 9).
- [ ] **[CORE]** Enforce legality rules across categories/extensions and module boundaries as specified. (Part 9; 01C.8; 01D)
...
### 01E.3.10 Metaprogramming (optional feature set)
- [ ] **[OPT-META]** Implement derives (`objc_derive(...)`) with deterministic, tool-visible expansion. (Part 10; 01B.6.1)
- [ ] **[OPT-META]** Implement macros (`objc_macro(...)`) with sandboxing / safety constraints as specified. (Part 10; 01B.6.2)
- [ ] **[OPT-META]** Preserve macro/derive expansions in module metadata and textual interfaces as required by 01D. (01D Table A)

### 01E.3.11 Interoperability (optional feature sets)
- [ ] **[CORE]** Maintain full interop with C and Objective‑C runtime behavior. (Baseline + Part 11)
- [ ] **[OPT-CXX]** Document and test ObjC++ interactions for ownership, `throws`, and `async` lowering. (Part 11; 01C)
...
### 01E.3.12 Diagnostics, tooling, and tests
...
## 01E.4 Recommended evidence for a conformance claim (non-normative)
...
- CI proofs that:
  ...
  - 01D Table A metadata is preserved under separate compilation,
