...
- **[MODULE_METADATA_AND_ABI_TABLES.md](#d)** — Module metadata requirements, ABI boundaries, capability gates, and current implementation status
...
- **[PART_1_VERSIONING_COMPATIBILITY_CONFORMANCE.md](#part-1)** — Canonical language mode, capability states, conformance evidence, and rejected-form diagnostics
...
- **[PART_12_DIAGNOSTICS_TOOLING_TESTS.md](#part-12)** — Required diagnostics, canonicalization fix-its, analyzers, and conformance test suites

## How to read this draft {#toc-how-to-read-this-draft}

1. Start with **[INTRODUCTION.md](#intro)** (goals + cross-cutting constraints).
2. Read **[Part 1](#part-1)** next (**[PART_1_VERSIONING_COMPATIBILITY_CONFORMANCE.md](#part-1)**) for canonical support states and evidence-backed conformance.
...
- It keeps support claims tied to capability states and executable evidence instead of local roadmap prose.
