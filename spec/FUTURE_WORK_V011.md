...
| `D-06` | Produce migration guidance for optional, mangling, and reification changes. | `docs/migration/v011_language_changes.md`                                                  | Guide includes migration paths, fix-it usage, and canonical rewrite recommendations.            | `A-12`, `B-06`, `B-08`, `B-09`                 |
