...
the current public command or support model. Active repo docs must route
commands through `npm run objc3c -- <action>`, treat direct helper paths as
implementation evidence only, and keep retired spellings, retired adapters,
alternate acceptance paths, alias adapters, and retired-source lane behavior out
of accepted support.
...
| ------ | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- | ------------------------------ |
| `A-01` | Define and publish machine-readable schema for `objc3-runtime-2025Q4` and `objc3-abi-2025Q4` manifests. | `scripts/objc3c_shared/schema_registry.py`, `docs/support/capability_matrix.md`, `docs/support/evidence_map.md`     | Manifest schema ownership resolves through the shared registry and support/evidence rows; direct planning-ledger mirrors are not support owners. | None                           |
