...
| ------ | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- | ------------------------------ |
| `A-01` | Define and publish machine-readable schema for `objc3-runtime-2025Q4` and `objc3-abi-2025Q4` manifests. | `docs/reference/legacy_spec_anchor_index.md`, `schemas/objc3_artifact_manifest.schema.json`                        | Schema is reviewed by spec editors, example manifests validate, and Part 0 references are ready.         | None                           |
| `A-02` | Define manifest schema versioning and compatibility policy.                                             | `docs/reference/legacy_spec_anchor_index.md`, `spec/DECISIONS_LOG.md` entry                                        | Major/minor compatibility and deprecation windows are explicit and accepted by release owners.           | `A-01`                         |
...
| `D-07` | Define docs synchronization workflow for normative and tooling artifacts.   | `docs/reference/legacy_spec_anchor_index.md`                                               | Workflow defines trigger conditions, required reviewers, and publication cadence.               | `A-14`, `B-13`, `C-14`                         |
