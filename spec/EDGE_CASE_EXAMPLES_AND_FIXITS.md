...
| ID            | Edge case                                                         | Expected result                                                                            | Conformance artifact                                                            |
| ------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| `EC-OPTSP-01` | Source type signature uses canonical `Optional<int>`              | Accept as a type-signature carrier; runtime construction/lowering remains fail-closed      | [EC-OPTSP-01](../tests/conformance/examples/optional_spelling/EC-OPTSP-01.json) |
...
| `EC-OPTSP-04` | v1 executable/storage surface sees `Optional<int>`                | Reject with `O3P159`; type signatures remain source/interface carriers only.               | [EC-OPTSP-04](../tests/conformance/examples/optional_spelling/EC-OPTSP-04.json) |
