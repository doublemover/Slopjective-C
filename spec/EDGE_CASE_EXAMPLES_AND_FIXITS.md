...
| ID            | Edge case                                                      | Expected result                                                                            | Conformance artifact                                                            |
| ------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| `EC-OPTSP-01` | Canonical mode uses canonical `Optional<int>`                  | Accept                                                                                     | [EC-OPTSP-01](../tests/conformance/examples/optional_spelling/EC-OPTSP-01.json) |
...
| `EC-OPTSP-05` | Nested noncanonical forms (`optional<optional<int>>`)          | Reject with `O3C004` and a one-step fix-it to `Optional<int>`.                             | [EC-OPTSP-05](../tests/conformance/examples/optional_spelling/EC-OPTSP-05.json) |
