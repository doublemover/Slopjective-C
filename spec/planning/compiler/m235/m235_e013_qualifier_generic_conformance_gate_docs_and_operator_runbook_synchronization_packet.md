...
Execute lane-E qualifier/generic conformance gate docs and operator runbook synchronization
...
| --- | --- | --- |
| `M235-E012` | `M235-E012` | Issue `#5851`; `check:objc3c:m235-e002-lane-e-readiness` |
