...
Freeze lane-C IR-emission diagnostics hardening closure so C006 edge-case
robustness outputs remain deterministic and fail-closed on diagnostics
continuity drift before direct LLVM IR emission.
...
- Dependency anchors from `M228-C006`:
