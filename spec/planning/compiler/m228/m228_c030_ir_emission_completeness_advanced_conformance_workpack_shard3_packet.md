...
Freeze lane-C IR-emission advanced conformance workpack (shard 3)
closure so C029 advanced-conformance outputs remain deterministic and fail-closed on
...
- Dependency anchors from `M228-C029`:
...
- `package.json`
  - add `check:objc3c:m228-c030-ir-emission-completeness-advanced-conformance-workpack-shard3-contract`
  - add `test:tooling:m228-c030-ir-emission-completeness-advanced-conformance-workpack-shard3-contract`
  - add `check:objc3c:m228-c030-lane-c-readiness` chained from C029 -> C030
