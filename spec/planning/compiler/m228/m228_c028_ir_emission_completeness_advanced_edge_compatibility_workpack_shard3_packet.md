...
Freeze lane-C IR-emission advanced edge compatibility workpack (shard 3)
closure so C027 advanced-conformance outputs remain deterministic and fail-closed on
...
- Dependency anchors from `M228-C027`:
...
- `package.json`
  - add `check:objc3c:m228-c028-ir-emission-completeness-advanced-edge-compatibility-workpack-shard3-contract`
  - add `test:tooling:m228-c028-ir-emission-completeness-advanced-edge-compatibility-workpack-shard3-contract`
  - add `check:objc3c:m228-c028-lane-c-readiness` chained from C027 -> C028
