...
Freeze lane-C IR-emission advanced integration workpack (shard 3)
closure so C030 advanced-conformance outputs remain deterministic and fail-closed on
...
- Dependency anchors from `M228-C030`:
...
- `package.json`
  - add `check:objc3c:m228-c031-ir-emission-completeness-advanced-integration-workpack-shard3-contract`
  - add `test:tooling:m228-c031-ir-emission-completeness-advanced-integration-workpack-shard3-contract`
  - add `check:objc3c:m228-c031-lane-c-readiness` chained from C030 -> C031
