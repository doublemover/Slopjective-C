...
Execute release-candidate and replay dry-run governance for lane-C lowering of protocol/category artifacts so declaration-grammar boundary anchors remain deterministic and fail-closed before modular split/scaffolding expansion.
...
- `npm run check:objc3c:m233-c014-lane-c-readiness`
