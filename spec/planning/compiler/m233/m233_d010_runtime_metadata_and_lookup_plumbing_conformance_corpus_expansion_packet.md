...
corpus expansion prerequisites for M233 so predecessor continuity remains
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m233_d009_lane_d_readiness.py` before D010 checks.
- Dependency anchors from `M233-D009`:
