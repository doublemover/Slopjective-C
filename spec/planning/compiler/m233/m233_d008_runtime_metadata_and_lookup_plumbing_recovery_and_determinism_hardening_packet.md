...
Freeze lane-D runtime metadata and lookup plumbing recovery and
determinism hardening prerequisites for M233 so predecessor continuity
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m233_d007_lane_d_readiness.py` before D008 checks.
- Dependency anchors from `M233-D007`:
