...
Execute performance and quality guardrails governance for lane-A protocol/category grammar and AST shape so declaration-grammar boundary anchors remain deterministic and fail-closed before modular split/scaffolding expansion.
...
- `npm run check:objc3c:m233-a011-lane-a-readiness`
