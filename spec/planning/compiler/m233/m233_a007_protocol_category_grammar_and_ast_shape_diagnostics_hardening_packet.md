...
Execute diagnostics hardening governance for lane-A protocol/category grammar and AST shape so declaration-grammar boundary anchors remain deterministic and fail-closed before modular split/scaffolding expansion.
...
- `npm run check:objc3c:m233-a007-lane-a-readiness`
