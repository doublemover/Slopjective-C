...
Freeze lane-D runtime metadata and lookup plumbing diagnostics
hardening prerequisites for M233 so predecessor continuity
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m233_d006_lane_d_readiness.py` before D007 checks.
- Dependency anchors from `M233-D006`:
