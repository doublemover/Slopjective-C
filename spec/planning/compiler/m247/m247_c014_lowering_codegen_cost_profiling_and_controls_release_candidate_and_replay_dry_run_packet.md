...
Freeze lane-C lowering/codegen cost profiling and controls release-candidate and
replay dry-run continuity for M247 so dependency surfaces and governance remain
deterministic and fail-closed, with code/spec anchors and milestone optimization
