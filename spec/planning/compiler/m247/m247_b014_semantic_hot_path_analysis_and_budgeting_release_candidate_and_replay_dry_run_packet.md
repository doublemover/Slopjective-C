...
Freeze lane-B semantic hot-path analysis and budgeting release-candidate/replay dry-run prerequisites so `M247-B013` dependency continuity stays explicit, deterministic, and fail-closed, including code/spec anchors and milestone optimization improvements as mandatory scope inputs.
...
- Dependency anchors from `M247-B013`:
...
- `npm run check:objc3c:m247-b014-lane-b-readiness`
