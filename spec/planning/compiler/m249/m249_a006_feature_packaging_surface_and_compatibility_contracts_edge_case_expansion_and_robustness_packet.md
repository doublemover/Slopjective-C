...
Freeze lane-A edge-case expansion and robustness prerequisites for M249 feature packaging surface and compatibility contracts continuity so dependency wiring remains deterministic and fail-closed, including code/spec anchors and milestone optimization improvements as mandatory scope inputs.
...
- Readiness runner:
  ...
  - Chains through `check:objc3c:m249-a005-lane-a-readiness` before A006 checks.
- Dependency anchors from `M249-A005`:
