...
corpus expansion prerequisites for M249 so predecessor continuity remains
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m249_d009_lane_d_readiness.py` before D010 checks.
- Dependency anchors from `M249-D009`:
