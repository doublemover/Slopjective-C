...
Freeze lane-D installer/runtime operations and support tooling recovery and
determinism hardening prerequisites for M249 so predecessor continuity
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m249_d007_lane_d_readiness.py` before D008 checks.
- Dependency anchors from `M249-D007`:
