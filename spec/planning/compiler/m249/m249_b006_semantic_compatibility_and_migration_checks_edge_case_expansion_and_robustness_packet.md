...
Freeze lane-B semantic compatibility and migration checks edge-case expansion
and robustness prerequisites for M249 so dependency continuity stays
...
- Dependency anchors from `M249-B005`:
