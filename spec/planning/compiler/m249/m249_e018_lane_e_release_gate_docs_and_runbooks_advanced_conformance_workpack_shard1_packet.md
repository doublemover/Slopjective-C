...
Freeze lane-E release gate/docs/runbooks advanced conformance workpack (shard
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m249_e017_lane_e_readiness.py` before E018 checks.
...
- `python scripts/check_m249_e018_lane_e_release_gate_docs_and_runbooks_advanced_conformance_workpack_shard1_contract.py`
- `python -m pytest tests/tooling/test_check_m249_e018_lane_e_release_gate_docs_and_runbooks_advanced_conformance_workpack_shard1_contract.py -q`
