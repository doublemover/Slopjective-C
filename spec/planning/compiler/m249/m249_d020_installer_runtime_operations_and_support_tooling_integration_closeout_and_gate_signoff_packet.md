...
Freeze lane-D installer/runtime operations and support tooling integration closeout
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m249_d019_lane_d_readiness.py` before D020 checks.
- Dependency anchors from `M249-D019`:
