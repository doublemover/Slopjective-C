...
robustness prerequisites for M249 so predecessor continuity
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m249_d005_lane_d_readiness.py` before D006 checks.
- Dependency anchors from `M249-D005`:
