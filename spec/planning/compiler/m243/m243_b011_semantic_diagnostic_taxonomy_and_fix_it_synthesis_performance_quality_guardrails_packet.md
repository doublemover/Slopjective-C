...
Freeze lane-B performance and quality guardrails prerequisites for semantic
diagnostic taxonomy and ARC fix-it synthesis continuity so conformance corpus
and performance/quality guardrails closure remain deterministic and fail-closed,
...
- Performance/quality guardrails surfaces:
  - `native/objc3c/src/pipeline/objc3_semantic_diagnostic_taxonomy_and_fix_it_synthesis_performance_quality_guardrails_surface.h`
  - `native/objc3c/src/pipeline/objc3_frontend_types.h`
  - `native/objc3c/src/pipeline/objc3_frontend_pipeline.cpp`
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m243-b011-lane-b-readiness`
- Dependency anchors from `M243-B010`:
