...
Freeze lane-B edge-case and compatibility completion prerequisites for semantic
diagnostic taxonomy and ARC fix-it synthesis continuity so typed handoff and
parse/lowering compatibility replay closure remain deterministic and fail-closed,
...
- Edge-case compatibility surfaces:
  - `native/objc3c/src/pipeline/objc3_semantic_diagnostic_taxonomy_and_fix_it_synthesis_edge_case_compatibility_surface.h`
  - `native/objc3c/src/pipeline/objc3_frontend_types.h`
  - `native/objc3c/src/pipeline/objc3_frontend_pipeline.cpp`
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m243-b005-lane-b-readiness`
- Dependency anchors from `M243-B004`:
