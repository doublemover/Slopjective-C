# M243-E029 Lane-E Diagnostics Quality Gate and Replay Policy Advanced Diagnostics Workpack (shard 3) Packet
...
- Contract:
  `docs/contracts/m243_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_3_e029_expectations.md`
- Checker:
...
- Dependency anchors from `M243-E028`:
...
- `python scripts/check_m243_e029_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_3_contract.py --emit-json`
