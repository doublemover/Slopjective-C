...
Freeze lane-B core feature implementation prerequisites for semantic diagnostic
taxonomy and ARC fix-it synthesis continuity so dependency wiring remains
deterministic and fail-closed, with code/spec anchors and milestone
...
- Core feature implementation surfaces:
  - `native/objc3c/src/pipeline/objc3_semantic_diagnostic_taxonomy_and_fix_it_synthesis_core_feature_implementation_surface.h`
  - `native/objc3c/src/pipeline/objc3_frontend_types.h`
  - `native/objc3c/src/pipeline/objc3_frontend_pipeline.cpp`
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m243-b003-lane-b-readiness`
- Dependency anchors from `M243-B002`:
