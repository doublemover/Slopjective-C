# M242-E024 Macro/source-map gate and docs Advanced Conformance Workpack (shard 2) Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_advanced_conformance_workpack_shard_2_e024_expectations.md`
- Checker:
