# M242-E010 Macro/source-map gate and docs Conformance Corpus Expansion Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_conformance_corpus_expansion_e010_expectations.md`
- Checker:
  `scripts/check_m242_e010_macro_source_map_gate_and_docs_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m242_e010_macro_source_map_gate_and_docs_contract.py`
...
- `python scripts/check_m242_e010_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E010/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e010_macro_source_map_gate_and_docs_contract.py -q`

## Evidence Output

- `tmp/reports/m242/M242-E010/local_check_summary.json`
