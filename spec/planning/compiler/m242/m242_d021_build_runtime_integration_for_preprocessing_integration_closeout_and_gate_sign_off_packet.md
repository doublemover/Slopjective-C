...
- Contract:
  `docs/contracts/m242_build_runtime_integration_for_preprocessing_integration_closeout_and_gate_sign_off_d021_expectations.md`
- Checker:
...
- Dependency anchors from `M242-C001`:
  ...
  - `spec/planning/compiler/m242/m242_c001_expanded_source_lowering_traceability_integration_closeout_and_gate_sign_off_packet.md`
