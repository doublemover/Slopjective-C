# M242-E017 Macro/source-map gate and docs Advanced Diagnostics Workpack (shard 1) Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_advanced_diagnostics_workpack_shard_1_e017_expectations.md`
- Checker:
  `scripts/check_m242_e017_macro_source_map_gate_and_docs_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m242_e017_macro_source_map_gate_and_docs_contract.py`
...
- `python scripts/check_m242_e017_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E017/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e017_macro_source_map_gate_and_docs_contract.py -q`

## Evidence Output

- `tmp/reports/m242/M242-E017/local_check_summary.json`
