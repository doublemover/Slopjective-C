# M242-E015 Macro/source-map gate and docs Advanced Core Workpack (shard 1) Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_advanced_core_workpack_shard_1_e015_expectations.md`
- Checker:
