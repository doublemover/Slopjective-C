# M242-E018 Macro/source-map gate and docs Advanced Conformance Workpack (shard 1) Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_advanced_conformance_workpack_shard_1_e018_expectations.md`
- Checker:
