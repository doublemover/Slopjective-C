# M242-E025 Macro/source-map gate and docs Advanced Integration Workpack (shard 2) Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_advanced_integration_workpack_shard_2_e025_expectations.md`
- Checker:
