# M242-E027 Macro/source-map gate and docs Advanced Core Workpack (shard 3) Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_advanced_core_workpack_shard_3_e027_expectations.md`
- Checker:
