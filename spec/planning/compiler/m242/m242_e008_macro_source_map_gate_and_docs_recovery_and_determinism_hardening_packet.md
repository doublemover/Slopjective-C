# M242-E008 Macro/source-map gate and docs Recovery and Determinism Hardening Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_recovery_and_determinism_hardening_e008_expectations.md`
- Checker:
  `scripts/check_m242_e008_macro_source_map_gate_and_docs_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m242_e008_macro_source_map_gate_and_docs_contract.py`
...
- `python scripts/check_m242_e008_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E008/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e008_macro_source_map_gate_and_docs_contract.py -q`

## Evidence Output

- `tmp/reports/m242/M242-E008/local_check_summary.json`
