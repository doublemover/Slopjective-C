# M242-E022 Macro/source-map gate and docs Advanced Edge Compatibility Workpack (shard 2) Packet
...
- Contract:
  `docs/contracts/m242_macro_source_map_gate_and_docs_advanced_edge_compatibility_workpack_shard_2_e022_expectations.md`
- Checker:
  `scripts/check_m242_e022_macro_source_map_gate_and_docs_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m242_e022_macro_source_map_gate_and_docs_contract.py`
...
- `python scripts/check_m242_e022_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E022/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e022_macro_source_map_gate_and_docs_contract.py -q`

## Evidence Output

- `tmp/reports/m242/M242-E022/local_check_summary.json`
