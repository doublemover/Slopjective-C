...
Execute conformance corpus expansion governance for lane-B preprocessor semantic model and expansion rules so declaration-grammar boundary anchors remain deterministic and fail-closed before modular split/scaffolding expansion.
...
- `npm run check:objc3c:m242-b010-lane-b-readiness`
