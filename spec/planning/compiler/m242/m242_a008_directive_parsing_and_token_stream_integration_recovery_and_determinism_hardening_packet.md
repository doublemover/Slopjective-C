# M242-A008 Qualifier/Generic Grammar Normalization Contract and Architecture Freeze Packet
...
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m242-a008-directive-parsing-and-token-stream-integration-contract`
  - `test:tooling:m242-a008-directive-parsing-and-token-stream-integration-contract`
  - `check:objc3c:m242-a008-lane-a-readiness`
