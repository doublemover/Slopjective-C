...
Execute advanced edge compatibility workpack (shard 1) governance for lane-E Program control and release readiness governance so corpus boundary anchors remain deterministic and fail-closed before modular split/scaffolding expansion.
...
- `npm run check:objc3c:m230-e016-lane-e-readiness`
