# M237-E010 Block conformance and replay gate Conformance Corpus Expansion Packet
...
- Contract:
  `docs/contracts/m237_block_conformance_and_replay_gate_conformance_corpus_expansion_e010_expectations.md`
- Checker:
  `scripts/check_m237_e010_block_conformance_and_replay_gate_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m237_e010_block_conformance_and_replay_gate_contract.py`
...
- `python scripts/check_m237_e010_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E010/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e010_block_conformance_and_replay_gate_contract.py -q`

## Evidence Output

- `tmp/reports/m237/M237-E010/local_check_summary.json`
