# M237-B001 Qualifier/Generic Semantic Inference Contract and Architecture Freeze Packet
...
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m237-b001-block-semantic-capture-and-lifetime-rules-contract`
  - `test:tooling:m237-b001-block-semantic-capture-and-lifetime-rules-contract`
  - `check:objc3c:m237-b001-lane-b-readiness`
