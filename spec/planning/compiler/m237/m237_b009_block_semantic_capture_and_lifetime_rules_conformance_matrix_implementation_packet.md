# M237-B009 Qualifier/Generic Semantic Inference Contract and Architecture Freeze Packet
...
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m237-b009-block-semantic-capture-and-lifetime-rules-conformance-matrix-implementation-contract`
  - `test:tooling:m237-b009-block-semantic-capture-and-lifetime-rules-conformance-matrix-implementation-contract`
