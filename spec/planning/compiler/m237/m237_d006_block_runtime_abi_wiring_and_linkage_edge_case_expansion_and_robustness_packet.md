...
- Contract:
  `docs/contracts/m237_block_runtime_abi_wiring_and_linkage_edge_case_expansion_and_robustness_d006_expectations.md`
- Checker:
...
- Dependency anchors from `M237-C001`:
  ...
  - `spec/planning/compiler/m237/m237_c001_block_lowering_and_invoke_emission_edge_case_expansion_and_robustness_packet.md`
