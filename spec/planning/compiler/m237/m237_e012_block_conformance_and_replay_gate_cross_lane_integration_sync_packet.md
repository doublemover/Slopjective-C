...
- `python scripts/check_m237_e012_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E012/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e012_block_conformance_and_replay_gate_contract.py -q`
