# M237-E014 Block conformance and replay gate Release-candidate and Replay Dry-run Packet
...
- Contract:
  `docs/contracts/m237_block_conformance_and_replay_gate_release_candidate_and_replay_dry_run_e014_expectations.md`
- Checker:
  `scripts/check_m237_e014_block_conformance_and_replay_gate_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m237_e014_block_conformance_and_replay_gate_contract.py`
...
- `python scripts/check_m237_e014_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E014/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e014_block_conformance_and_replay_gate_contract.py -q`

## Evidence Output

- `tmp/reports/m237/M237-E014/local_check_summary.json`
