# M237-E015 Block conformance and replay gate Advanced Core Workpack (shard 1) Packet
...
- Contract:
  `docs/contracts/m237_block_conformance_and_replay_gate_advanced_core_workpack_shard_1_e015_expectations.md`
- Checker:
  `scripts/check_m237_e015_block_conformance_and_replay_gate_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m237_e015_block_conformance_and_replay_gate_contract.py`
...
- `python scripts/check_m237_e015_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E015/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e015_block_conformance_and_replay_gate_contract.py -q`

## Evidence Output

- `tmp/reports/m237/M237-E015/local_check_summary.json`
