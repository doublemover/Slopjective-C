...
- Contract:
  `docs/contracts/m241_build_system_and_artifact_orchestration_edge_case_expansion_and_robustness_d006_expectations.md`
- Checker:
  `scripts/check_m241_d006_build_system_and_artifact_orchestration_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m241_d006_build_system_and_artifact_orchestration_contract.py`
- Dependency anchors from `M241-C001`:
  ...
  - `spec/planning/compiler/m241/m241_c001_incremental_lowering_and_artifact_reuse_edge_case_expansion_and_robustness_packet.md`
...
- `python scripts/check_m241_d006_build_system_and_artifact_orchestration_contract.py`
- `python -m pytest tests/tooling/test_check_m241_d006_build_system_and_artifact_orchestration_contract.py -q`
