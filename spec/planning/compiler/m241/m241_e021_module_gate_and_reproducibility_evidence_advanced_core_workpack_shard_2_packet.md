# M241-E021 Module gate and reproducibility evidence Advanced Core Workpack (shard 2) Packet
...
- Contract:
  `docs/contracts/m241_module_gate_and_reproducibility_evidence_advanced_core_workpack_shard_2_e021_expectations.md`
- Checker:
  `scripts/check_m241_e021_module_gate_and_reproducibility_evidence_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m241_e021_module_gate_and_reproducibility_evidence_contract.py`
...
- `python scripts/check_m241_e021_module_gate_and_reproducibility_evidence_contract.py --summary-out tmp/reports/m241/M241-E021/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m241_e021_module_gate_and_reproducibility_evidence_contract.py -q`
