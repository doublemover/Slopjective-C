# M241-E015 Module gate and reproducibility evidence Advanced Core Workpack (shard 1) Packet
...
- Contract:
  `docs/contracts/m241_module_gate_and_reproducibility_evidence_advanced_core_workpack_shard_1_e015_expectations.md`
- Checker:
  `scripts/check_m241_e015_module_gate_and_reproducibility_evidence_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m241_e015_module_gate_and_reproducibility_evidence_contract.py`
...
- `python scripts/check_m241_e015_module_gate_and_reproducibility_evidence_contract.py --summary-out tmp/reports/m241/M241-E015/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m241_e015_module_gate_and_reproducibility_evidence_contract.py -q`

## Evidence Output

- `tmp/reports/m241/M241-E015/local_check_summary.json`
