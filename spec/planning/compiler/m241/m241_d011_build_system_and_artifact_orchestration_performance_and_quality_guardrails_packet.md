...
- Contract:
  `docs/contracts/m241_build_system_and_artifact_orchestration_performance_and_quality_guardrails_d011_expectations.md`
- Checker:
...
- Dependency anchors from `M241-C001`:
  ...
  - `spec/planning/compiler/m241/m241_c001_incremental_lowering_and_artifact_reuse_performance_and_quality_guardrails_packet.md`
