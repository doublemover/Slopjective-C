...
- Contract:
  `docs/contracts/m241_build_system_and_artifact_orchestration_advanced_edge_compatibility_workpack_shard_1_d016_expectations.md`
- Checker:
...
- Dependency anchors from `M241-C001`:
  ...
  - `spec/planning/compiler/m241/m241_c001_incremental_lowering_and_artifact_reuse_advanced_edge_compatibility_workpack_shard_1_packet.md`
