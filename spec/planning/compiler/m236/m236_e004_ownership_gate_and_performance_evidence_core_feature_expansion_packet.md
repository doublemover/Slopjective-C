...
- `python scripts/check_m236_e004_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E004/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e004_ownership_gate_and_performance_evidence_contract.py -q`
