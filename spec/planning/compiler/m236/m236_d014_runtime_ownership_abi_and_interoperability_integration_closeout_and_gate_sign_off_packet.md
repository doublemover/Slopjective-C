...
- Contract:
  `docs/contracts/m236_runtime_ownership_abi_and_interoperability_integration_closeout_and_gate_sign_off_d014_expectations.md`
- Checker:
...
- Dependency anchors from `M236-C001`:
  ...
  - `spec/planning/compiler/m236/m236_c001_arc_style_lowering_insertion_and_cleanup_integration_closeout_and_gate_sign_off_packet.md`
