# M236-B011 Qualifier/Generic Semantic Inference Contract and Architecture Freeze Packet
...
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m236-b011-ownership-semantic-modeling-and-checks-performance-and-quality-guardrails-contract`
  - `test:tooling:m236-b011-ownership-semantic-modeling-and-checks-performance-and-quality-guardrails-contract`
  - `check:objc3c:m236-b011-lane-b-readiness`
