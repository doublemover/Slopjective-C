# M236-D008 Interop Behavior for Qualified Generic APIs Recovery and Determinism Hardening Packet
...
- Contract:
  `docs/contracts/m236_runtime_ownership_abi_and_interoperability_recovery_and_determinism_hardening_d008_expectations.md`
- Checker:
  `scripts/check_m236_d008_runtime_ownership_abi_and_interoperability_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m236_d008_runtime_ownership_abi_and_interoperability_contract.py`
- Dependency anchors from `M236-C001`:
  ...
  - `spec/planning/compiler/m236/m236_c001_arc_style_lowering_insertion_and_cleanup_recovery_and_determinism_hardening_packet.md`
...
- `python scripts/check_m236_d008_runtime_ownership_abi_and_interoperability_contract.py`
- `python -m pytest tests/tooling/test_check_m236_d008_runtime_ownership_abi_and_interoperability_contract.py -q`
- `npm run check:objc3c:m236-c001-lane-c-readiness`

## Evidence Output

- `tmp/reports/m236/M236-D008/runtime_ownership_abi_and_interoperability_contract_summary.json`
