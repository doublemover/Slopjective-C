# M236-A008 Qualifier/Generic Grammar Normalization Contract and Architecture Freeze Packet
...
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m236-a008-ownership-syntax-and-annotation-ingestion-contract`
  - `test:tooling:m236-a008-ownership-syntax-and-annotation-ingestion-contract`
  - `check:objc3c:m236-a008-lane-a-readiness`
