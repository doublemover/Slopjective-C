...
- `python scripts/check_m238_e011_exception_conformance_gate_and_documentation_contract.py --summary-out tmp/reports/m238/M238-E011/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m238_e011_exception_conformance_gate_and_documentation_contract.py -q`
