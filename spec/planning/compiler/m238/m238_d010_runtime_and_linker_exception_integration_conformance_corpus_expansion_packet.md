...
- Contract:
  `docs/contracts/m238_runtime_and_linker_exception_integration_conformance_corpus_expansion_d010_expectations.md`
- Checker:
...
- Dependency anchors from `M238-C001`:
  ...
  - `spec/planning/compiler/m238/m238_c001_cleanup_lowering_and_unwind_control_flow_conformance_corpus_expansion_packet.md`
