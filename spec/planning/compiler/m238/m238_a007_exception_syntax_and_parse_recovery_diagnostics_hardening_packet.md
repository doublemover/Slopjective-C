# M238-A007 Qualifier/Generic Grammar Normalization Contract and Architecture Freeze Packet
...
- Build/readiness scripts (`package.json`):
  - `check:objc3c:m238-a007-exception-syntax-and-parse-recovery-contract`
  - `test:tooling:m238-a007-exception-syntax-and-parse-recovery-contract`
