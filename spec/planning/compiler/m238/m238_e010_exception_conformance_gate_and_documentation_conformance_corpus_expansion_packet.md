# M238-E010 Exception conformance gate and documentation Conformance Corpus Expansion Packet
...
- Contract:
  `docs/contracts/m238_exception_conformance_gate_and_documentation_conformance_corpus_expansion_e010_expectations.md`
- Checker:
  `scripts/check_m238_e010_exception_conformance_gate_and_documentation_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m238_e010_exception_conformance_gate_and_documentation_contract.py`
...
- `python scripts/check_m238_e010_exception_conformance_gate_and_documentation_contract.py --summary-out tmp/reports/m238/M238-E010/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m238_e010_exception_conformance_gate_and_documentation_contract.py -q`

## Evidence Output

- `tmp/reports/m238/M238-E010/local_check_summary.json`
