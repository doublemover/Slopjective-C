...
- Contract:
  `docs/contracts/m238_runtime_and_linker_exception_integration_modular_split_and_scaffolding_d002_expectations.md`
- Checker:
...
- Dependency anchors from `M238-C001`:
  ...
  - `spec/planning/compiler/m238/m238_c001_cleanup_lowering_and_unwind_control_flow_modular_split_and_scaffolding_packet.md`
