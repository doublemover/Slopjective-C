...
Freeze lane-C IR optimization pass wiring and validation docs and operator
runbook synchronization continuity for M246 so dependency surfaces and
optimizer validation governance remain deterministic and fail-closed, with
code/spec anchors and milestone optimization improvements treated as mandatory scope
inputs.
...
- Dependency anchors (`M246-C012`):
  - `docs/contracts/m246_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_c012_expectations.md`
  - `spec/planning/compiler/m246/m246_c012_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_packet.md`
...
- `python scripts/check_m246_c013_ir_optimization_pass_wiring_and_validation_docs_and_operator_runbook_synchronization_contract.py`
- `python -m pytest tests/tooling/test_check_m246_c013_ir_optimization_pass_wiring_and_validation_docs_and_operator_runbook_synchronization_contract.py -q`
- `python scripts/run_m246_c013_lane_c_readiness.py`
