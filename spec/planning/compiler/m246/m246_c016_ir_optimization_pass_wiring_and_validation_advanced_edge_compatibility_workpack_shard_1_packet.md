...
- Dependency anchors (`M246-C015`):
  - `docs/contracts/m246_ir_optimization_pass_wiring_and_validation_advanced_core_workpack_shard_1_c015_expectations.md`
  - `spec/planning/compiler/m246/m246_c015_ir_optimization_pass_wiring_and_validation_release_candidate_and_replay_dry_run_packet.md`
...
- `python scripts/check_m246_c016_ir_optimization_pass_wiring_and_validation_advanced_edge_compatibility_workpack_shard_1_contract.py`
- `python -m pytest tests/tooling/test_check_m246_c016_ir_optimization_pass_wiring_and_validation_advanced_edge_compatibility_workpack_shard_1_contract.py -q`
- `python scripts/run_m246_c016_lane_c_readiness.py`
