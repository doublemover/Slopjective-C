# M246-C021 IR Optimization Pass Wiring and Validation Advanced Core Workpack (Shard 2) Packet
...
- Contract:
  `docs/contracts/m246_ir_optimization_pass_wiring_and_validation_advanced_core_workpack_shard_2_c021_expectations.md`
- Checker:
  `scripts/check_m246_c021_ir_optimization_pass_wiring_and_validation_advanced_core_workpack_shard_2_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m246_c021_ir_optimization_pass_wiring_and_validation_advanced_core_workpack_shard_2_contract.py`
- Readiness runner:
  `scripts/run_m246_c021_lane_c_readiness.py`

## Dependency Anchors

- Primary dependency: `M246-C020`
- Predecessor anchors inherited via `M246-C020`: `M246-C001`, `M246-C002`, `M246-C003`, `M246-C004`, `M246-C005`, `M246-C006`, `M246-C007`, `M246-C008`, `M246-C009`, `M246-C010`, `M246-C011`, `M246-C012`.
- Dependency anchors (`M246-C020`):
  - `docs/contracts/m246_ir_optimization_pass_wiring_and_validation_advanced_performance_workpack_shard_1_c020_expectations.md`
  - `spec/planning/compiler/m246/m246_c020_ir_optimization_pass_wiring_and_validation_advanced_performance_workpack_shard_1_packet.md`
...
- `python scripts/check_m246_c021_ir_optimization_pass_wiring_and_validation_advanced_core_workpack_shard_2_contract.py`
- `python -m pytest tests/tooling/test_check_m246_c021_ir_optimization_pass_wiring_and_validation_advanced_core_workpack_shard_2_contract.py -q`
- `python scripts/run_m246_c021_lane_c_readiness.py`

## Evidence Output

- `tmp/reports/m246/M246-C021/ir_optimization_pass_wiring_validation_advanced_core_workpack_shard_2_summary.json`
