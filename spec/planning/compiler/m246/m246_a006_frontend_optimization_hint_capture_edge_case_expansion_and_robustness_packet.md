...
Freeze lane-A edge-case expansion and robustness prerequisites for M246 frontend optimization hint capture continuity so dependency wiring remains deterministic and fail-closed, including code/spec anchors and milestone optimization improvements as mandatory scope inputs.
...
- Lane-A readiness runner:
  ...
  - Chains through `python scripts/run_m246_a005_lane_a_readiness.py` before A006 checks.
- Dependency anchors from `M246-A005`:
