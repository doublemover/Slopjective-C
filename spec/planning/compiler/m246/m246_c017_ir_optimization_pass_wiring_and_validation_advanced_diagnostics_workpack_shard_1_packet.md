...
- Dependency anchors (`M246-C016`):
  ...
  - `spec/planning/compiler/m246/m246_c016_ir_optimization_pass_wiring_and_validation_advanced_edge_compatibility_workpack_shard_1_packet.md`
...
- `python scripts/check_m246_c017_ir_optimization_pass_wiring_and_validation_advanced_diagnostics_workpack_shard_1_contract.py`
- `python -m pytest tests/tooling/test_check_m246_c017_ir_optimization_pass_wiring_and_validation_advanced_diagnostics_workpack_shard_1_contract.py -q`
- `python scripts/run_m246_c017_lane_c_readiness.py`
