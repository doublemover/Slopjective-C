...
- Contract:
  `docs/contracts/m240_runtime_registration_and_startup_integration_diagnostics_hardening_d007_expectations.md`
- Checker:
  `scripts/check_m240_d007_runtime_registration_and_startup_integration_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m240_d007_runtime_registration_and_startup_integration_contract.py`
- Dependency anchors from `M240-C001`:
  ...
  - `spec/planning/compiler/m240/m240_c001_metadata_lowering_and_section_emission_diagnostics_hardening_packet.md`
...
- `python scripts/check_m240_d007_runtime_registration_and_startup_integration_contract.py`
- `python -m pytest tests/tooling/test_check_m240_d007_runtime_registration_and_startup_integration_contract.py -q`
