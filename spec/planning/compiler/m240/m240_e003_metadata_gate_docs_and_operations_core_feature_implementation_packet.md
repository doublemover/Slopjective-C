# M240-E003 Metadata gate, docs, and operations Core Feature Implementation Packet
...
- Contract:
  `docs/contracts/m240_metadata_gate_docs_and_operations_core_feature_implementation_e003_expectations.md`
- Checker:
