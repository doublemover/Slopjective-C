...
- Contract:
  `docs/contracts/m240_runtime_registration_and_startup_integration_advanced_edge_compatibility_workpack_shard_1_d016_expectations.md`
- Checker:
...
- Dependency anchors from `M240-C001`:
  ...
  - `spec/planning/compiler/m240/m240_c001_metadata_lowering_and_section_emission_advanced_edge_compatibility_workpack_shard_1_packet.md`
