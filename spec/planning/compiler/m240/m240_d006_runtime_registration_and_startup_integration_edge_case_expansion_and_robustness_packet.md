...
- Contract:
  `docs/contracts/m240_runtime_registration_and_startup_integration_edge_case_expansion_and_robustness_d006_expectations.md`
- Checker:
...
- Dependency anchors from `M240-C001`:
  ...
  - `spec/planning/compiler/m240/m240_c001_metadata_lowering_and_section_emission_edge_case_expansion_and_robustness_packet.md`
