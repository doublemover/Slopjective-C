...
- `python scripts/check_m240_e008_metadata_gate_docs_and_operations_contract.py --summary-out tmp/reports/m240/M240-E008/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m240_e008_metadata_gate_docs_and_operations_contract.py -q`
