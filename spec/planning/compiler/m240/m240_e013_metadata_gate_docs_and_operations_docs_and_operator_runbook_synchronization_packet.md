# M240-E013 Metadata gate, docs, and operations Docs and Operator Runbook Synchronization Packet
...
- Contract:
  `docs/contracts/m240_metadata_gate_docs_and_operations_docs_and_operator_runbook_synchronization_e013_expectations.md`
- Checker:
