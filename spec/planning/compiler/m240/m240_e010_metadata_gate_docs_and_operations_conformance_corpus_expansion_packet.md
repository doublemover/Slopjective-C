# M240-E010 Metadata gate, docs, and operations Conformance Corpus Expansion Packet
...
- Contract:
  `docs/contracts/m240_metadata_gate_docs_and_operations_conformance_corpus_expansion_e010_expectations.md`
- Checker:
  `scripts/check_m240_e010_metadata_gate_docs_and_operations_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m240_e010_metadata_gate_docs_and_operations_contract.py`
...
- `python scripts/check_m240_e010_metadata_gate_docs_and_operations_contract.py --summary-out tmp/reports/m240/M240-E010/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m240_e010_metadata_gate_docs_and_operations_contract.py -q`

## Evidence Output

- `tmp/reports/m240/M240-E010/local_check_summary.json`
