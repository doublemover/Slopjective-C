# M239-E006 CFG correctness gate and replay evidence Edge-case Expansion and Robustness Packet
...
- Contract:
  `docs/contracts/m239_cfg_correctness_gate_and_replay_evidence_edge_case_expansion_and_robustness_e006_expectations.md`
- Checker:
