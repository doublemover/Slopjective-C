# M239-E002 CFG correctness gate and replay evidence Modular Split and Scaffolding Packet
...
- Contract:
  `docs/contracts/m239_cfg_correctness_gate_and_replay_evidence_modular_split_and_scaffolding_e002_expectations.md`
- Checker:
  `scripts/check_m239_e002_cfg_correctness_gate_and_replay_evidence_contract.py`
- Tooling tests:
  `tests/tooling/test_check_m239_e002_cfg_correctness_gate_and_replay_evidence_contract.py`
...
- `python scripts/check_m239_e002_cfg_correctness_gate_and_replay_evidence_contract.py --summary-out tmp/reports/m239/M239-E002/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m239_e002_cfg_correctness_gate_and_replay_evidence_contract.py -q`

## Evidence Output

- `tmp/reports/m239/M239-E002/local_check_summary.json`
