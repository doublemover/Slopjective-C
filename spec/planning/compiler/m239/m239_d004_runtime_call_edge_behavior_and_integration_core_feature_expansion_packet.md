# M239-D004 Interop Behavior for Qualified Generic APIs Core Feature Expansion Packet
...
- Contract:
  `docs/contracts/m239_runtime_call_edge_behavior_and_integration_core_feature_expansion_d004_expectations.md`
- Checker:
...
- Dependency anchors from `M239-C001`:
  ...
  - `spec/planning/compiler/m239/m239_c001_cfg_ssa_lowering_and_phi_construction_core_feature_expansion_packet.md`
