# M239-D006 Interop Behavior for Qualified Generic APIs Edge-case Expansion and Robustness Packet
...
- Contract:
  `docs/contracts/m239_runtime_call_edge_behavior_and_integration_edge_case_expansion_and_robustness_d006_expectations.md`
- Checker:
...
- Dependency anchors from `M239-C001`:
  ...
  - `spec/planning/compiler/m239/m239_c001_cfg_ssa_lowering_and_phi_construction_edge_case_expansion_and_robustness_packet.md`
