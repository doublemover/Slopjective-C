...
- `python scripts/check_m239_e009_cfg_correctness_gate_and_replay_evidence_contract.py --summary-out tmp/reports/m239/M239-E009/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m239_e009_cfg_correctness_gate_and_replay_evidence_contract.py -q`
