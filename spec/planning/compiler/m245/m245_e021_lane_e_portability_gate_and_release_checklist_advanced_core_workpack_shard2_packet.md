...
- Predecessor continuity:
  `M245-E020` contract/packet/checker/test assets are mandatory inheritance anchors for E020 fail-closed gating.
- Contract:
...
- Dependency anchors from `M245-E020`:
