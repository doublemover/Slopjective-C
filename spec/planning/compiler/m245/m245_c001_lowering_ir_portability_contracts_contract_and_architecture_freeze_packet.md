...
Freeze lane-C lowering/IR portability contracts contract prerequisites for M245
so toolchain portability boundaries remain deterministic and fail-closed,
