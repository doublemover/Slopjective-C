...
Freeze lane-D build/link/runtime reproducibility operations performance and
quality guardrails prerequisites for M245 so dependency continuity stays
...
- Dependency anchors from `M245-D010`:
