...
Freeze lane-D build/link/runtime reproducibility operations diagnostics
hardening prerequisites for M245 so dependency continuity stays deterministic
...
- Dependency anchors from `M245-D006`:
