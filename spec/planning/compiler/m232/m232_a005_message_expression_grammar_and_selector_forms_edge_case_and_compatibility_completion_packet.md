...
Execute edge-case and compatibility completion governance for lane-A message expression grammar and selector forms so declaration-grammar boundary anchors remain deterministic and fail-closed before modular split/scaffolding expansion.
...
- `npm run check:objc3c:m232-a005-lane-a-readiness`
