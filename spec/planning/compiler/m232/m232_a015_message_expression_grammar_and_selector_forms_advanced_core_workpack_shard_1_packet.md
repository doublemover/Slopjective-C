...
Execute advanced core workpack (shard 1) governance for lane-A message expression grammar and selector forms so declaration-grammar boundary anchors remain deterministic and fail-closed before modular split/scaffolding expansion.
...
- `npm run check:objc3c:m232-a015-lane-a-readiness`
