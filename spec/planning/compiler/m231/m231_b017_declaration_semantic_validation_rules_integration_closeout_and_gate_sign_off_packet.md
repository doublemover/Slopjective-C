...
Execute integration closeout and gate sign-off governance for lane-B Declaration semantic validation rules so declaration-grammar boundary anchors remain deterministic and fail-closed before modular split/scaffolding expansion.
...
- `npm run check:objc3c:m231-b017-lane-b-readiness`
