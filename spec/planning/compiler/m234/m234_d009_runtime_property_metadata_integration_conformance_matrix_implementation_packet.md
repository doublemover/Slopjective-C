...
matrix implementation prerequisites for M234 so predecessor continuity remains
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m234_d008_lane_d_readiness.py` before D009 checks.
- Dependency anchors from `M234-D008`:
