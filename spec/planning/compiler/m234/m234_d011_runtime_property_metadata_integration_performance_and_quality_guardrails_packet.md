...
Freeze lane-D runtime property metadata integration performance and
quality guardrails prerequisites for M234 so predecessor continuity remains
...
- Readiness runner:
  ...
  - Chains through `python scripts/run_m234_d010_lane_d_readiness.py` before D011 checks.
- Dependency anchors from `M234-D010`:
