...
The spec defines optional profiles (e.g., `@profile(system)`, `@profile(kernel)`) as a mechanism to apply additional restrictions and defaults.

Profiles are defined primarily in Part 8 and may be extended in future drafts.
