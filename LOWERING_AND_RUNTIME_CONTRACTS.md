...
## C.3 Canonical lowering patterns {#c-3}
...
## C.4 `throws` ABI and lowering {#c-4}
...
## C.5 `async` ABI and lowering {#c-5}
...
## C.6 Actors: runtime representation and dispatch {#c-6}
...
## C.8 Direct/final/sealed lowering (recommended) {#c-8}
