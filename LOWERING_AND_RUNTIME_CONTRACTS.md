...
### C.3.2 Nil-coalescing `??` (recommended)
...
### C.3.3 Postfix propagation `?` (recommended)
...
### C.4.2 Throwing Objective‑C methods (recommended)
...
### C.4.3 Lowering of `try` (recommended)
...
### C.5.3 Executor hops (recommended)
...
## C.8 Direct/final/sealed lowering (recommended)
...
## C.10 System programming analysis hooks (recommended)
