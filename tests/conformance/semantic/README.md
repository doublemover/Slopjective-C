...
- `TYP-8013-01.json` through `TYP-8013-07.json` for issue #8013 typed object,
  nullability, canonical protocol conformance, protocol-composition,
  protocol-qualified message dispatch, generic-suffix, optional-flow, and
  key-path semantic model closure. These are backed by
