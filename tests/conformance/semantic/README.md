...
- `TYP-8013-01.json`, `TYP-8013-02.json`, `TYP-8013-03.json` for issue #8013 typed object,
  nullability, protocol-composition, generic-suffix, optional-flow, and key-path
  semantic model closure. These are backed by
