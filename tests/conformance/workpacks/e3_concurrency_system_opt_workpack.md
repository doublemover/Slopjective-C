...
- [x] **Issue #80 - Implement `async` and `await` grammar and typing rules**
  - Spec anchors: [E.3.7](../../../docs/reference/legacy_spec_anchor_index.md#e-3-7), [Part 7](../../../docs/reference/legacy_spec_anchor_index.md#part-7), [7.1](../../../docs/reference/legacy_spec_anchor_index.md#part-7-1), [7.2](../../../docs/reference/legacy_spec_anchor_index.md#part-7-2), [7.3](../../../docs/reference/legacy_spec_anchor_index.md#part-7-3).
...
- [x] **Issue #81 - Implement coroutine-based lowering for `async` and preserve ABI metadata**
  - Spec anchors: [D-010](../../../docs/reference/legacy_spec_anchor_index.md#decisions-d-010), [C.5](../../../docs/reference/legacy_spec_anchor_index.md#c-5), [Part 7 7.12.2](../../../docs/reference/legacy_spec_anchor_index.md#part-7-12-2), [D Table B](../../../docs/reference/legacy_spec_anchor_index.md#d-3-2).
...
- [x] **Issue #82 - Implement cancellation propagation and task-context behavior**
  - Spec anchors: [Part 7 7.6](../../../docs/reference/legacy_spec_anchor_index.md#part-7-6), [7.6.2](../../../docs/reference/legacy_spec_anchor_index.md#part-7-6-2), [7.6.7](../../../docs/reference/legacy_spec_anchor_index.md#part-7-6-7), [C.5.2](../../../docs/reference/legacy_spec_anchor_index.md#c-5-2).
...
- [x] **Issue #83 - Implement executor affinity annotations and call-site behavior**
  - Spec anchors: [B.3.1](../../../docs/reference/legacy_spec_anchor_index.md#b-3-1), [Part 7 7.4.3](../../../docs/reference/legacy_spec_anchor_index.md#part-7-4-3), [7.4.5](../../../docs/reference/legacy_spec_anchor_index.md#part-7-4-5), [7.4.7](../../../docs/reference/legacy_spec_anchor_index.md#part-7-4-7), [D Table A](../../../docs/reference/legacy_spec_anchor_index.md#d-3-1).
...
- [x] **Issue #84 - Implement actor declarations and actor isolation rules**
  - Spec anchors: [Part 7 7.7](../../../docs/reference/legacy_spec_anchor_index.md#part-7-7), [7.7.2.1](../../../docs/reference/legacy_spec_anchor_index.md#part-7-7-2-1), [7.7.5](../../../docs/reference/legacy_spec_anchor_index.md#part-7-7-5), [C.6](../../../docs/reference/legacy_spec_anchor_index.md#c-6).
...
- [x] **Issue #85 - Provide strict diagnostics for isolation, executor annotation misuse, and suspicious cross-actor calls**
  - Spec anchors: [Part 12](../../../docs/reference/legacy_spec_anchor_index.md#part-12), [12.3.3](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-3), [Part 7 7.10](../../../docs/reference/legacy_spec_anchor_index.md#part-7-10).
...
- [x] **Issue #86 - Enforce Sendable-like constraints across task/actor/executor boundaries**
  - Spec anchors: [Part 7 7.8](../../../docs/reference/legacy_spec_anchor_index.md#part-7-8), [7.8.3](../../../docs/reference/legacy_spec_anchor_index.md#part-7-8-3), [7.8.6](../../../docs/reference/legacy_spec_anchor_index.md#part-7-8-6), [D Table A](../../../docs/reference/legacy_spec_anchor_index.md#d-3-1).
...
- [x] **Issue #87 - Enforce D-011 await requirement for all potentially-suspending operations**
  - Spec anchors: [D-011](../../../docs/reference/legacy_spec_anchor_index.md#decisions-d-011), [Part 7 7.3.2](../../../docs/reference/legacy_spec_anchor_index.md#part-7-3-2), [7.4.3.2](../../../docs/reference/legacy_spec_anchor_index.md#part-7-4-3-2), [7.7.2.1](../../../docs/reference/legacy_spec_anchor_index.md#part-7-7-2-1).
...
- [x] **Issue #88 - Support canonical attribute spellings for Part 8 features**
  - Spec anchors: [E.3.8](../../../docs/reference/legacy_spec_anchor_index.md#e-3-8), [Part 8 8.0.1](../../../docs/reference/legacy_spec_anchor_index.md#part-8-0-1), [B.8](../../../docs/reference/legacy_spec_anchor_index.md#b-8).
...
- [x] **Issue #89 - Implement resource cleanup semantics and required diagnostics**
  - Spec anchors: [Part 8 8.1](../../../docs/reference/legacy_spec_anchor_index.md#part-8-1), [8.3](../../../docs/reference/legacy_spec_anchor_index.md#part-8-3), [Part 12 12.3.6](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-6), [Part 12 12.5.13](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-13).
...
- [x] **Issue #90 - Implement `withLifetime`/`keepAlive` semantics and ARC interaction**
  - Spec anchors: [Part 8 8.6](../../../docs/reference/legacy_spec_anchor_index.md#part-8-6), [8.6.1](../../../docs/reference/legacy_spec_anchor_index.md#part-8-6-1), [8.6.2](../../../docs/reference/legacy_spec_anchor_index.md#part-8-6-2), [8.6.3](../../../docs/reference/legacy_spec_anchor_index.md#part-8-6-3).
...
- [x] **Issue #91 - Implement borrowed pointer rules and diagnostics (intra-procedural minimum)**
  - Spec anchors: [Part 8 8.7](../../../docs/reference/legacy_spec_anchor_index.md#part-8-7), [8.7.3](../../../docs/reference/legacy_spec_anchor_index.md#part-8-7-3), [8.7.4](../../../docs/reference/legacy_spec_anchor_index.md#part-8-7-4), [Part 12 12.5.12](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-12).
...
- [x] **Issue #92 - Preserve borrowed/lifetime annotations in module metadata**
  - Spec anchors: [D Table A](../../../docs/reference/legacy_spec_anchor_index.md#d-3-1), [Part 8 8.7.2](../../../docs/reference/legacy_spec_anchor_index.md#part-8-7-2), [Part 2](../../../docs/reference/legacy_spec_anchor_index.md#part-2).
...
- [x] **Issue #93 - Implement capture lists with required order and move/weak/unowned semantics**
  - Spec anchors: [Part 8 8.8](../../../docs/reference/legacy_spec_anchor_index.md#part-8-8), [8.8.2](../../../docs/reference/legacy_spec_anchor_index.md#part-8-8-2), [8.8.3](../../../docs/reference/legacy_spec_anchor_index.md#part-8-8-3), [8.8.4](../../../docs/reference/legacy_spec_anchor_index.md#part-8-8-4).
...
- [x] **Issue #94 - Provide diagnostics for borrowed escapes, use-after-move, and dangerous `unowned` captures**
  - Spec anchors: [Part 12 12.3.6](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-6), [Part 8 8.7.4](../../../docs/reference/legacy_spec_anchor_index.md#part-8-7-4), [Part 8 8.8.6](../../../docs/reference/legacy_spec_anchor_index.md#part-8-8-6).
...
- [x] **Issue #95 - Accept and preserve canonical `objc_direct`/`objc_final`/`objc_sealed` spellings**
  - Spec anchors: [E.3.9](../../../docs/reference/legacy_spec_anchor_index.md#e-3-9), [B.5](../../../docs/reference/legacy_spec_anchor_index.md#b-5), [Part 9](../../../docs/reference/legacy_spec_anchor_index.md#part-9), [D Table A](../../../docs/reference/legacy_spec_anchor_index.md#d-3-1).
...
- [x] **Issue #96 - Enforce legality rules across categories/extensions and module boundaries**
  - Spec anchors: [Part 9](../../../docs/reference/legacy_spec_anchor_index.md#part-9), [9.9.1](../../../docs/reference/legacy_spec_anchor_index.md#part-9-9-1), [C.8](../../../docs/reference/legacy_spec_anchor_index.md#c-8), [D](../../../docs/reference/legacy_spec_anchor_index.md#d).
...
- [x] **Issue #97 - Provide diagnostics for dynamic-dispatch misuse and final/sealed override violations**
  - Spec anchors: [Part 12 12.3.5](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-5), [Part 9 9.7](../../../docs/reference/legacy_spec_anchor_index.md#part-9-7), [Part 9 9.9.2](../../../docs/reference/legacy_spec_anchor_index.md#part-9-9-2).
...
- [x] **Issue #98 - Implement derives (`objc_derive(...)`) with deterministic, tool-visible expansion**
  - Spec anchors: [E.3.10](../../../docs/reference/legacy_spec_anchor_index.md#e-3-10), [Part 10](../../../docs/reference/legacy_spec_anchor_index.md#part-10), [B.6.1](../../../docs/reference/legacy_spec_anchor_index.md#b-6-1), [Part 10 10.6](../../../docs/reference/legacy_spec_anchor_index.md#part-10-6).
...
- [x] **Issue #99 - Implement macros (`objc_macro(...)`) with sandboxing and safety constraints**
  - Spec anchors: [Part 10](../../../docs/reference/legacy_spec_anchor_index.md#part-10), [B.6.2](../../../docs/reference/legacy_spec_anchor_index.md#b-6-2), [Part 10 10.5](../../../docs/reference/legacy_spec_anchor_index.md#part-10-5), [Part 10 10.6](../../../docs/reference/legacy_spec_anchor_index.md#part-10-6).
...
- [x] **Issue #100 - Preserve macro/derive expansions in module metadata and textual interfaces**
  - Spec anchors: [D Table A](../../../docs/reference/legacy_spec_anchor_index.md#d-3-1), [Part 10](../../../docs/reference/legacy_spec_anchor_index.md#part-10), [Part 2](../../../docs/reference/legacy_spec_anchor_index.md#part-2).
...
- [x] **Issue #101 - Maintain full interop with C and Objective-C runtime behavior**
  - Spec anchors: [E.3.11](../../../docs/reference/legacy_spec_anchor_index.md#e-3-11), [Part 11](../../../docs/reference/legacy_spec_anchor_index.md#part-11), [Part 11 11.2.4](../../../docs/reference/legacy_spec_anchor_index.md#part-11-2-4), [C.2](../../../docs/reference/legacy_spec_anchor_index.md#c-2), [C.5](../../../docs/reference/legacy_spec_anchor_index.md#c-5).
...
- [x] **Issue #102 - Document and test ObjC++ interactions for ownership, `throws`, and `async` lowering**
  - Spec anchors: [Part 11 11.3](../../../docs/reference/legacy_spec_anchor_index.md#part-11-3), [Part 6](../../../docs/reference/legacy_spec_anchor_index.md#part-6), [Part 7](../../../docs/reference/legacy_spec_anchor_index.md#part-7), [C.5](../../../docs/reference/legacy_spec_anchor_index.md#c-5).
...
- [x] **Issue #103 - Provide Swift interop story for optionals, throws, async/await, and actor metadata**
  - Spec anchors: [Part 11 11.4](../../../docs/reference/legacy_spec_anchor_index.md#part-11-4), [11.4.1](../../../docs/reference/legacy_spec_anchor_index.md#part-11-4-1), [11.4.2](../../../docs/reference/legacy_spec_anchor_index.md#part-11-4-2), [11.4.3](../../../docs/reference/legacy_spec_anchor_index.md#part-11-4-3), [11.4.4](../../../docs/reference/legacy_spec_anchor_index.md#part-11-4-4).
...
- [x] **Issue #104 - Implement minimum diagnostic groups from Part 12**
  - Spec anchors: [E.3.12](../../../docs/reference/legacy_spec_anchor_index.md#e-3-12), [Part 12 12.3](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3), [12.3.1](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-1), [12.3.2](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-2), [12.3.3](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-3), [12.3.4](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-4), [12.3.5](../../../docs/reference/legacy_spec_anchor_index.md#part-12-3-5).
...
- [x] **Issue #105 - Provide fix-its and migrator support for canonical spellings and safer idioms**
  - Spec anchors: [Part 12 12.4](../../../docs/reference/legacy_spec_anchor_index.md#part-12-4), [12.4.1](../../../docs/reference/legacy_spec_anchor_index.md#part-12-4-1), [Part 12 12.5.7](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-7).
...
- [x] **Issue #106 - Provide/publish conformance suite with required structure and coverage**
  - Spec anchors: [Part 12 12.5](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5), [12.5.0](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-0), [12.5.2](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-2), [12.5.6](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-6), [12.5.7](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-7), [12.5.9](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-9), [12.5.10](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-10).
...
- [x] **Issue #107 - Include tests for borrowed-pointer escape diagnostics and resource cleanup semantics**
  - Spec anchors: [Part 8](../../../docs/reference/legacy_spec_anchor_index.md#part-8), [Part 12](../../../docs/reference/legacy_spec_anchor_index.md#part-12), [12.5.12](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-12), [12.5.13](../../../docs/reference/legacy_spec_anchor_index.md#part-12-5-13).
