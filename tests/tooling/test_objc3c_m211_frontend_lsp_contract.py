...
def test_m211_frontend_lsp_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m211_frontend_lsp_contract.py -q",
    ):
        assert text in fragment


def test_m211_frontend_lsp_markers_map_to_sources() -> None:
