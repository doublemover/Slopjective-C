...
def test_m220_sema_public_beta_profile_section_exists() -> None:
    ...
    for text in (
        ...
        "scalar_param_i32",
        "scalar_param_bool",
        "python -m pytest tests/tooling/test_objc3c_m220_sema_public_beta_contract.py -q",
    ):
        assert text in fragment


def test_m220_sema_public_beta_profile_maps_to_markers() -> None:
