...
def test_m220_frontend_public_beta_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m220_frontend_public_beta_contract.py -q",
    ):
        assert text in fragment


def test_m220_frontend_public_beta_markers_map_to_sources() -> None:
