...
def test_m217_frontend_differential_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m217_frontend_differential_contract.py -q",
    ):
        assert text in fragment


def test_m217_frontend_differential_markers_map_to_sources() -> None:
