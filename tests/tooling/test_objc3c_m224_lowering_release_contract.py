...
def test_m224_lowering_release_readiness_section_present() -> None:
...
def test_m224_lowering_release_markers_align_to_source_surfaces() -> None:
    ...
    assert '";runtime_dispatch_arg_slots=" + std::to_string(boundary.runtime_dispatch_arg_slots) +' in (
        lowering_contract_source
    )
