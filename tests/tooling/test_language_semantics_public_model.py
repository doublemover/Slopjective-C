...
def test_language_semantics_public_model_schema_and_contract_are_stable() -> None:
    ...
    assert '"support_claim": { "const": "objc3c.behavior.language.generics.protocol-qualified-arguments" }' in schema_text
    ...
    assert '"macro_metaprogramming_public_surface"' in schema_text
...
def test_language_semantics_public_model_header_exposes_typed_surfaces() -> None:
    ...
    for token in (
        ...
        "Objc3MacroMetaprogrammingSurface",
