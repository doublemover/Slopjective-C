...
def test_m190_integration_concurrency_replay_race_guard_is_documented() -> None:
    ...
    assert (
        "tests/tooling/test_objc3c_m190_integration_concurrency_replay_race_guard_contract.py" in library_api_doc
        or "tests/tooling/test_objc3c_m190_integration_concurrency_replay_contract.py" in library_api_doc
    )
