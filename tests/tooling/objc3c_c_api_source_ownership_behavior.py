...
def assert_c_api_cpp_pins_core_compile_and_c_only_helper_owners(
    ...
    assert_contains_all(
        ...
        [
            ...
            "const objc3c_frontend_c_version_t version = OBJC3C_FRONTEND_VERSION_INIT;",
            ...
            "CopyFrontendContextLastError(context, buffer,",
            ...
            "OBJC3C_FRONTEND_C_API_POLICY_OWNED_RESULT_HANDLE == 9",
...
def assert_c_api_helper_contract_tracks_result_error_artifact_stage_helpers(
    ...
    assert contract["header_paths"] == [
        ...
        "native/objc3c/src/libobjc3c_frontend/c_api_result_lifecycle.h",
        "native/objc3c/src/libobjc3c_frontend/c_api_result_artifacts.h",
        "native/objc3c/src/libobjc3c_frontend/c_api_result_error.h",
