...
def test_m225_sema_roadmap_seed_profile_section_exists() -> None:
    ...
    for text in (
        ...
        "scalar_param_i32",
        "scalar_param_bool",
        "python -m pytest tests/tooling/test_objc3c_m225_sema_roadmap_seed_contract.py -q",
    ):
        assert text in fragment


def test_m225_sema_roadmap_seed_profile_maps_to_markers() -> None:
