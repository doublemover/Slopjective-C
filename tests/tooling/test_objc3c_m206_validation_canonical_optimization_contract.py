...
def test_m206_validation_canonical_optimization_runbook_section_present() -> None:
...
def test_m206_validation_canonical_optimization_commands_and_scripts_available() -> None:
