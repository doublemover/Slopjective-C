...
def test_m213_validation_perf_debug_fidelity_runbook_section_present() -> None:
...
def test_m213_validation_perf_debug_fidelity_runbook_commands_and_scripts_available() -> None:
    ...
    for relative_path in (
        ...
        "tests/tooling/test_check_m145_direct_llvm_matrix_contract.py",
    ):
