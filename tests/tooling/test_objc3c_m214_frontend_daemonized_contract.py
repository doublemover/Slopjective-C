...
def test_m214_frontend_daemonized_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m214_frontend_daemonized_contract.py -q",
    ):
        assert text in fragment


def test_m214_frontend_daemonized_markers_map_to_sources() -> None:
