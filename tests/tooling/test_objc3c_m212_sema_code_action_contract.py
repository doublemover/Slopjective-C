...
def test_m212_sema_code_action_profile_section_exists() -> None:
    fragment = _read(SEMA_DOC_FRAGMENT)
    for text in (
        "## M212 sema/type code-action profile",
        "compiler-driven code actions and refactoring safety",
        ...
        "m212_code_action_sema_diagnostics_packet",
        ...
        "scalar_param_i32",
        "scalar_param_bool",
        "m212_code_action_type_metadata_handoff_packet",
        "python -m pytest tests/tooling/test_objc3c_m212_sema_code_action_contract.py -q",
    ):
        assert text in fragment


def test_m212_sema_code_action_profile_maps_to_source_anchors() -> None:
