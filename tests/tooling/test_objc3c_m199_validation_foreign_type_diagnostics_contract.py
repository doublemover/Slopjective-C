...
def test_m199_validation_foreign_type_diagnostics_runbook_section_present() -> None:
...
def test_m199_validation_foreign_type_diagnostics_commands_and_scripts_available() -> None:
