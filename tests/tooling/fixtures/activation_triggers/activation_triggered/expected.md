...
- Fail closed: `true`
- Issues snapshot: `tests/tooling/fixtures/activation_triggers/activation_triggered/issues.json`
- Milestones snapshot: `tests/tooling/fixtures/activation_triggers/activation_triggered/milestones.json`
- Catalog JSON: `tests/tooling/fixtures/activation_triggers/activation_triggered/catalog.json`
...
| --- | --- | --- | --- |
| `T1-ISSUES` | `true` | 2 | open issues > 0 |
| `T2-MILESTONES` | `true` | 1 | open milestones > 0 |
| `T3-ACTIONABLE-ROWS` | `true` | 2 | actionable catalog rows > 0 |
