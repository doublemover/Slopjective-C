...
- Fail closed: `true`
- Issues snapshot: `tests/tooling/fixtures/activation_triggers/release_scale_foundation_w2_happy/issues.json`
- Milestones snapshot: `tests/tooling/fixtures/activation_triggers/release_scale_foundation_w2_happy/milestones.json`
- Catalog JSON: `tests/tooling/fixtures/activation_triggers/release_scale_foundation_w2_happy/catalog.json`
