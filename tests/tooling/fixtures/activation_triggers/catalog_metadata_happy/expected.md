...
- Fail closed: `true`
- Issues snapshot: `tests/tooling/fixtures/activation_triggers/catalog_metadata_happy/issues.json`
- Milestones snapshot: `tests/tooling/fixtures/activation_triggers/catalog_metadata_happy/milestones.json`
- Catalog JSON: `tests/tooling/fixtures/activation_triggers/catalog_metadata_happy/catalog.json`
