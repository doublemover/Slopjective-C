...
- Fail closed: `true`
- Issues snapshot: `tests/tooling/fixtures/activation_triggers/dispatch_evidence_w5_happy/issues.json`
- Milestones snapshot: `tests/tooling/fixtures/activation_triggers/dispatch_evidence_w5_happy/milestones.json`
- Catalog JSON: `tests/tooling/fixtures/activation_triggers/dispatch_evidence_w5_happy/catalog.json`
