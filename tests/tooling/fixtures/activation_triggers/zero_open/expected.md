...
- Fail closed: `true`
- Issues snapshot: `tests/tooling/fixtures/activation_triggers/zero_open/issues.json`
- Milestones snapshot: `tests/tooling/fixtures/activation_triggers/zero_open/milestones.json`
- Catalog JSON: `tests/tooling/fixtures/activation_triggers/zero_open/catalog.json`
