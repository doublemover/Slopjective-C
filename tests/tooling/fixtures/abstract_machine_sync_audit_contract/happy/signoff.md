...
| --- | --- | --- | --- | --- | --- |
| `EDGE-V013-016` | `V013-REL-02` | `V013-REL-03` | `docs/reference/legacy_spec_anchor_index.md` | Canonical ledger path is authoritative. | `blocking` |
...
| `EDGE-V013-018` | `V013-SPEC-04` | `V013-REL-03` | `docs/reference/legacy_spec_anchor_index.md`; `docs/reference/legacy_spec_anchor_index.md#conformance-profile-checklist` | Treat profile delta package as decision source. | `blocking` |
| `EDGE-V013-019` | `V013-GOV-03` | `V013-REL-03` | `docs/reference/legacy_spec_anchor_index.md`; `reports/reviews/v013_review_board_calendar.md` | Consume cadence/quorum contract and precomputed deadlines. | `blocking` |
...
| --- | --- | --- | ---: | --- |
| `REL03-CMD-03` | `rg -n "docs/reference/legacy_spec_anchor_index.md|reports/spec_sync/abstract_machine_audit_2026Q2.md|docs/reference/legacy_spec_anchor_index.md|docs/reference/legacy_spec_anchor_index.md#conformance-profile-checklist|docs/reference/legacy_spec_anchor_index.md|reports/reviews/v013_review_board_calendar.md" docs/reference/legacy_spec_anchor_index.md` | `matched all required upstream artifact references` | `0` | `PASS` |
