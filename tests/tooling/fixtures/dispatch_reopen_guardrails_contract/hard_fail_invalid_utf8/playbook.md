# Fixture: Activation Reopen Playbook
...
| `AR-DEP-M03-02` | `Hard` | Snapshot refresh (`AR-RUN-08`) and freshness (`AR-RUN-09`) evidence must be linked to the same reopen decision cycle as `AR-RUN-02` and `AR-DECISION-01`. |
...
| `AR-FRESHNESS-01` | Freshness record linked to the active cycle. |
