...
; frontend_objc_error_diagnostics_recovery_lowering_profile = error_diagnostics_recovery_sites=15, diagnostic_emission_sites=11, recovery_attempt_sites=9, recovery_success_sites=7, fixit_hint_sites=6, diagnostic_rendering_sites=10, normalized_sites=12, gate_blocked_sites=3, contract_violation_sites=0, deterministic_error_diagnostics_recovery_lowering_handoff=true
!objc3.objc_error_diagnostics_recovery_lowering = !{!45}
!45 = !{i64 15, i64 11, i64 9, i64 7, i64 6, i64 10, i64 12, i64 3, i64 0, i1 1}
