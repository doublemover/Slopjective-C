...
; frontend_objc_ns_error_bridging_lowering_profile = ns_error_bridging_sites=5, ns_error_parameter_sites=2, ns_error_out_parameter_sites=2, ns_error_bridge_path_sites=1, failable_call_sites=3, normalized_sites=4, bridge_boundary_sites=1, contract_violation_sites=0, deterministic_ns_error_bridging_lowering_handoff=true
!objc3.objc_ns_error_bridging_lowering = !{!36}
!36 = !{i64 5, i64 2, i64 2, i64 1, i64 3, i64 4, i64 1, i64 0, i1 1}
