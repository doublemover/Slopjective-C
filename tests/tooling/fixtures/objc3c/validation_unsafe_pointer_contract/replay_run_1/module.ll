...
; frontend_objc_unsafe_pointer_extension_lowering_profile = unsafe_pointer_extension_sites=6, unsafe_keyword_sites=4, pointer_arithmetic_sites=3, raw_pointer_type_sites=5, unsafe_operation_sites=2, normalized_sites=4, gate_blocked_sites=2, contract_violation_sites=0, deterministic_unsafe_pointer_extension_lowering_handoff=true
!objc3.objc_unsafe_pointer_extension_lowering = !{!37}
!37 = !{i64 6, i64 4, i64 3, i64 5, i64 2, i64 4, i64 2, i64 0, i1 1}
