...
def test_m212_frontend_code_action_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m212_frontend_code_action_contract.py -q",
    ):
        assert text in fragment


def test_m212_frontend_code_action_markers_map_to_sources() -> None:
