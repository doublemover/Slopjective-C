...
def test_m215_frontend_sdk_packaging_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m215_frontend_sdk_packaging_contract.py -q",
    ):
        assert text in fragment


def test_m215_frontend_sdk_packaging_markers_map_to_sources() -> None:
