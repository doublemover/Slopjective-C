...
def test_m221_lowering_ga_blocker_burndown_profile_section_present() -> None:
    ...
    for text in (
        ...
        'rg -n "lowering_ir_boundary|frontend_profile|!objc3.frontend|declare i32 @" tmp/artifacts/compilation/objc3c-native/m221/lowering-ga-blocker-burndown/module.ll > tmp/reports/objc3c-native/m221/lowering-ga-blocker-burndown/replay-markers.txt',
        'rg -n "\\"lowering\\":{\\"runtime_dispatch_symbol\\"" tmp/artifacts/compilation/objc3c-native/m221/lowering-ga-blocker-burndown/module.manifest.json >> tmp/reports/objc3c-native/m221/lowering-ga-blocker-burndown/replay-markers.txt',
        "python -m pytest tests/tooling/test_objc3c_m221_lowering_ga_blocker_contract.py -q",
    ):
        assert text in fragment


def test_m221_lowering_ga_blocker_burndown_markers_align_to_source_surfaces() -> None:
