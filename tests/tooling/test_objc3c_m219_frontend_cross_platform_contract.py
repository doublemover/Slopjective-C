...
def test_m219_frontend_cross_platform_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m219_frontend_cross_platform_contract.py -q",
    ):
        assert text in fragment


def test_m219_frontend_cross_platform_markers_map_to_sources() -> None:
