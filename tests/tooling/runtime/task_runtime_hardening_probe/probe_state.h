...
struct PassResult {
  ...
  int cancelled = 0;
  int wait_next = 0;
  int wait_second_next = 0;
  int hop = 0;
  int cancel_all = 0;
  int on_cancel = 0;
  int spawn_detached = 0;
  int after_add_copy_status = 0;
  int after_second_add_copy_status = 0;
  int after_wait_copy_status = 0;
  int after_second_wait_copy_status = 0;
  ...
  objc3_runtime_task_runtime_state_snapshot after_second_add_task{};
  objc3_runtime_task_runtime_state_snapshot after_wait_next{};
  objc3_runtime_task_runtime_state_snapshot after_second_wait_next{};
