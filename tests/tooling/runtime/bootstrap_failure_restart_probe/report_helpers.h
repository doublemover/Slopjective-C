#ifndef OBJC3C_TESTS_TOOLING_RUNTIME_BOOTSTRAP_FAILURE_RESTART_PROBE_REPORT_HELPERS_H_
#define OBJC3C_TESTS_TOOLING_RUNTIME_BOOTSTRAP_FAILURE_RESTART_PROBE_REPORT_HELPERS_H_
...
inline void PrintStartupReportFields(const BootstrapFixture &startup) {
...
inline void PrintUnsupportedReplayReportFields(
    bool second_attempt,
    const UnsupportedReplayScenario &unsupported_replay) {
  using objc3c::runtime::probe::PrintIntField;
  using objc3c::runtime::probe::PrintUint64Field;
...
#endif  // OBJC3C_TESTS_TOOLING_RUNTIME_BOOTSTRAP_FAILURE_RESTART_PROBE_REPORT_HELPERS_H_
