...
int main() {
  ...
  PrintJsonStringOrNull(post_replay_registration.last_registered_module_name);
  std::printf(",\"post_replay_last_walked_module_name\":");
  PrintJsonStringOrNull(post_replay_walk.last_walked_module_name);
  std::printf(",\"post_replay_last_replayed_module_name\":");
  PrintJsonStringOrNull(post_replay_reset_replay.last_replayed_module_name);
