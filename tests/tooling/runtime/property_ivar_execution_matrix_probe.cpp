...
using objc3c::runtime::probe::PrintDispatchStatePropertyExecution;
...
int main() {
  ...
  StabilizeDispatchState(
      ...
      set_count_dispatch_implementation_kind, set_count_dispatch_property_name,
      set_count_dispatch_class_name, set_count_dispatch_owner_identity);
  ...
  const int set_value_result = objc3_runtime_dispatch_i32(
      widget_instance, "setCurrentValue:", 55, 0, 0, 0);
  ...
  StabilizeDispatchState(
      ...
      set_value_dispatch_implementation_kind, set_value_dispatch_property_name,
      set_value_dispatch_class_name, set_value_dispatch_owner_identity);
  ...
  (void)objc3_runtime_copy_property_entry_for_testing("Widget", "count",
                                                      &count_entry);
  (void)objc3_runtime_copy_property_entry_for_testing("Widget", "enabled",
                                                      &enabled_entry);
  ...
  StabilizeMethodCacheEntry(count_method, count_method_selector,
                            count_method_class, count_method_owner);
  ...
  StabilizeMethodCacheEntry(value_method, value_method_selector,
                            value_method_class, value_method_owner);
  std::string token_method_selector;
  std::string token_method_class;
  std::string token_method_owner;
  StabilizeMethodCacheEntry(token_method, token_method_selector,
                            token_method_class, token_method_owner);
  ...
  PrintDispatchStatePropertyExecution(set_count_dispatch);
  std::printf(",\"count_dispatch\":");
  PrintDispatchStatePropertyExecution(count_dispatch);
  std::printf(",\"set_enabled_dispatch\":");
  PrintDispatchStatePropertyExecution(set_enabled_dispatch);
  std::printf(",\"enabled_dispatch\":");
  PrintDispatchStatePropertyExecution(enabled_dispatch);
  std::printf(",\"set_value_dispatch\":");
  PrintDispatchStatePropertyExecution(set_value_dispatch);
  std::printf(",\"value_dispatch\":");
  PrintDispatchStatePropertyExecution(value_dispatch);
  std::printf(",\"token_dispatch\":");
  PrintDispatchStatePropertyExecution(token_dispatch);
  std::printf("}");
  return 0;
}
