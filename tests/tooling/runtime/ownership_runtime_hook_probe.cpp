...
using objc3c::runtime::probe::PrintPropertyEntryOwnershipHook;
...
int main() {
  ...
  StabilizePropertyEntry(
      current_value_entry, current_queried_class_storage,
      current_resolved_class_storage, current_property_name_storage,
      current_declaration_owner_storage, current_getter_owner_storage,
      current_setter_owner_storage, current_lifetime_storage,
      current_hook_storage, current_accessor_storage);
  ...
  StabilizePropertyEntry(
      ...
      weak_property_name_storage, weak_declaration_owner_storage,
      weak_getter_owner_storage, weak_setter_owner_storage,
      weak_lifetime_storage, weak_hook_storage, weak_accessor_storage);
  ...
  PrintAllocationGraph(graph_after_drop_local);
  ...
  PrintPropertyEntryOwnershipHook(current_value_entry);
  std::printf(",\"weak_value_entry\":");
  PrintPropertyEntryOwnershipHook(weak_value_entry);
  std::printf("}");
  return 0;
}
