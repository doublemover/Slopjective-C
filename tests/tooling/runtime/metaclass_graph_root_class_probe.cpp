...
using objc3c::runtime::probe::PrintRealizedEntryMetaclass;
using objc3c::runtime::probe::PrintRealizedGraphStateMetaclass;
...
int main() {
  ...
  StabilizeMethodCacheState(
      widget_known_class_state, widget_known_class_selector_storage,
      widget_known_class_class_storage, widget_known_class_owner_storage);
  ...
  StabilizeMethodCacheState(
      widget_inherited_state, widget_inherited_selector_storage,
      widget_inherited_class_storage, widget_inherited_owner_storage);
  ...
  StabilizeMethodCacheState(widget_own_state, widget_own_selector_storage,
                            widget_own_class_storage, widget_own_owner_storage);
  ...
  (void)objc3_runtime_copy_method_cache_entry_for_testing(
      1042, "rootValue", &widget_inherited_entry);
  (void)objc3_runtime_copy_method_cache_entry_for_testing(1042, "widgetValue",
                                                          &widget_own_entry);
  StabilizeMethodCacheEntry(
      root_shared_entry, root_shared_entry_selector_storage,
      root_shared_entry_class_storage, root_shared_entry_owner_storage);
  StabilizeMethodCacheEntry(
      widget_shared_entry, widget_shared_entry_selector_storage,
      widget_shared_entry_class_storage, widget_shared_entry_owner_storage);
  ...
  StabilizeMethodCacheEntry(widget_own_entry, widget_own_entry_selector_storage,
  ...
  std::printf("\"widget_known_class_value\":%d,", widget_known_class_value);
  std::printf("\"widget_inherited_instance_value\":%d,",
              widget_inherited_instance_value);
  std::printf("\"widget_own_instance_value\":%d,", widget_own_instance_value);
  std::printf("\"registration_state\":");
  PrintRegistrationStateBasic(registration_state);
  std::printf(",\"graph_state\":");
  PrintRealizedGraphStateMetaclass(graph_state);
  std::printf(",\"root_entry\":");
  PrintRealizedEntryMetaclass(root_entry);
  std::printf(",\"widget_entry\":");
  PrintRealizedEntryMetaclass(widget_entry);
