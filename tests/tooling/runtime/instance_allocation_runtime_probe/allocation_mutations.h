...
inline AllocationMutationResults CaptureAllocationMutationResults(
  ...
  results.set_count_first = DispatchWidgetMessage(
  ...
  results.set_enabled_first = DispatchWidgetMessage(
      fixture.first_alloc, kEnabledSetterSelector, kFirstEnabledValue);
  results.enabled_value_first =
      DispatchWidgetMessage(fixture.first_alloc, kEnabledGetterSelector);
  results.enabled_value_second =
      DispatchWidgetMessage(fixture.second_alloc, kEnabledGetterSelector);

  results.set_value_first = DispatchWidgetMessage(
      fixture.first_alloc, kValueSetterSelector, kFirstStoredValue);
  results.value_result_first =
      DispatchWidgetMessage(fixture.first_alloc, kValueGetterSelector);
  results.value_result_second_before =
      DispatchWidgetMessage(fixture.second_alloc, kValueGetterSelector);

  results.set_count_second = DispatchWidgetMessage(
  ...
  results.set_value_second = DispatchWidgetMessage(
