...
int main() {
  ...
  const int fallback_entry_status =
      objc3_runtime_copy_method_cache_entry_for_testing(1024, fallback_selector,
                                                        &fallback_entry);
  fallback_entry_selector =
      fallback_entry.selector != nullptr ? fallback_entry.selector : "";
  fallback_entry_fast_path_reason = fallback_entry.fast_path_reason != nullptr
                                        ? fallback_entry.fast_path_reason
                                        : "";
  ...
  WriteLabeledDispatchState(std::cout, "mixed_second_dispatch_state",
                            ...
                            mixed_second_dispatch_last_implementation_kind,
                            mixed_second_dispatch_last_resolved_class_name);
  WriteLabeledDispatchState(std::cout, "fallback_first_dispatch_state",
                            fallback_first_dispatch_state,
                            fallback_first_dispatch_last_selector,
                            fallback_first_dispatch_last_fast_path_reason,
                            fallback_first_dispatch_last_path,
                            fallback_first_dispatch_last_implementation_kind,
                            fallback_first_dispatch_last_resolved_class_name);
  WriteLabeledDispatchState(std::cout, "fallback_second_dispatch_state",
                            fallback_second_dispatch_state,
                            fallback_second_dispatch_last_selector,
                            fallback_second_dispatch_last_fast_path_reason,
                            fallback_second_dispatch_last_path,
  ...
  const bool ok =
      ...
      fallback_entry.fast_path_seeded == 0 &&
      fallback_entry_fast_path_reason.empty();
