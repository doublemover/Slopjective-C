...
int main() {
  ...
  PrintMethodCacheEntryBasic(enabled_entry);
  std::printf(",\"set_enabled_entry\":");
  PrintMethodCacheEntryBasic(set_enabled_entry);
  std::printf(",\"value_entry\":");
  PrintMethodCacheEntryBasic(value_entry);
  std::printf(",\"set_value_entry\":");
  PrintMethodCacheEntryBasic(set_value_entry);
  std::printf("}");
  return 0;
}
