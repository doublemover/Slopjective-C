...
def test_m213_frontend_debug_fidelity_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m213_frontend_debug_fidelity_contract.py -q",
    ):
        assert text in fragment


def test_m213_frontend_debug_fidelity_markers_map_to_sources() -> None:
