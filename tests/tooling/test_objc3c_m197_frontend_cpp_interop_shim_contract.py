...
def test_m197_frontend_cpp_interop_shim_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m197_frontend_cpp_interop_shim_contract.py -q",
    ):
        assert text in fragment


def test_m197_frontend_cpp_interop_shim_markers_map_to_sources() -> None:
