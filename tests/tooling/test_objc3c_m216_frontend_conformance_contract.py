...
def test_m216_frontend_conformance_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m216_frontend_conformance_contract.py -q",
    ):
        assert text in fragment


def test_m216_frontend_conformance_markers_map_to_sources() -> None:
