...
EXPECTED_MODULE_IMPORT_ROWS = {
    ...
    "objc3c.behavior.modules.visibility-reexport-rebuild-contract": {
        "capability_id": "modules.visibility-reexport-rebuild-contract",
        "owner_phase": "sema",
        "behavior_fixture": "tests/tooling/fixtures/module_interop_contracts/foundation_next_visibility_bridge_contract.json",
        "runnable_command": "npm run objc3c -- validate-module-interop-contracts",
        "runtime_acceptance_case": "module-interop-visibility-reexport-rebuild-contract",
        "required_positive": {
            "tests/tooling/test_objc3c_module_interop_contracts.py",
            ...
            "schemas/objc3c-module-interop-contract-v1.schema.json",
        },
        "required_negative": {
            "tests/tooling/test_objc3c_module_interop_contracts.py",
            "scripts/check_objc3c_module_interop_contracts.py",
...
EXPECTED_MODULE_IMPORT_FIXTURES = {
    ...
    "tests/tooling/fixtures/module_interop_contracts/foundation_next_visibility_bridge_contract.json": ("sema", "module-import", "positive", ""),
