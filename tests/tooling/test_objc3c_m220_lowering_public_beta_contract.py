...
def test_m220_lowering_public_beta_profile_section_present() -> None:
    ...
    for text in (
        ...
        'rg -n "lowering_ir_boundary|frontend_profile|!objc3.frontend|declare i32 @" tmp/artifacts/compilation/objc3c-native/m220/lowering-runtime-public-beta-triage/module.ll > tmp/reports/objc3c-native/m220/lowering-runtime-public-beta-triage/replay-markers.txt',
        'rg -n "\\"lowering\\":{\\"runtime_dispatch_symbol\\"" tmp/artifacts/compilation/objc3c-native/m220/lowering-runtime-public-beta-triage/module.manifest.json >> tmp/reports/objc3c-native/m220/lowering-runtime-public-beta-triage/replay-markers.txt',
        "python -m pytest tests/tooling/test_objc3c_m220_lowering_public_beta_contract.py -q",
    ):
        assert text in fragment


def test_m220_lowering_public_beta_expected_anchors_align_to_source_surfaces() -> None:
