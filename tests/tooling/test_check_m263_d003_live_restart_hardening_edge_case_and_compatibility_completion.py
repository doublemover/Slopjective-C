...
MODULE_PATH = (
    ROOT / "scripts" / "check_m263_d003_live_restart_hardening_edge_case_and_compatibility_completion.py"
)
SPEC = importlib.util.spec_from_file_location("m263_d003_checker", MODULE_PATH)
...
def test_models_and_cases_are_wired() -> None:
    assert MODULE.CONTRACT_ID == "objc3c-runtime-live-restart-hardening/m263-d003-v1"
    assert MODULE.RESET_FOR_TESTING_SYMBOL == "objc3_runtime_reset_for_testing"
