...
def test_m196_integration_c_interop_headers_abi_gate_is_wired() -> None:
    package_json = _read(PACKAGE_JSON)
    workflow = _read(TASK_HYGIENE_WORKFLOW)

    assert '"check:objc3c:m196-c-interop-headers-abi"' in package_json
    assert (
        "npm run check:objc3c:m197-cpp-interop-shim && python -m pytest "
        "tests/tooling/test_objc3c_m196_frontend_c_interop_headers_abi_contract.py "
        "tests/tooling/test_objc3c_m196_sema_c_interop_headers_abi_contract.py "
        "tests/tooling/test_objc3c_m196_lowering_c_interop_headers_abi_contract.py "
        "tests/tooling/test_objc3c_m196_validation_c_interop_headers_abi_contract.py "
        "tests/tooling/test_objc3c_m196_integration_c_interop_headers_abi_contract.py -q"
    ) in package_json

    assert "Run M196 C interop headers ABI gate" in workflow
    assert "npm run check:objc3c:m196-c-interop-headers-abi" in workflow
