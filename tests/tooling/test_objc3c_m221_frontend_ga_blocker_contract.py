...
def test_m221_frontend_ga_blocker_section_exists() -> None:
    ...
    for text in (
        ...
        "python -m pytest tests/tooling/test_objc3c_m221_frontend_ga_blocker_contract.py -q",
    ):
        assert text in fragment


def test_m221_frontend_ga_blocker_markers_map_to_sources() -> None:
