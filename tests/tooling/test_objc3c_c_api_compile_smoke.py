    ...
    c_source.write_text(
        "\n".join(
            [
                ...
                "  if (objc3c_frontend_c_owned_result_status(0) !=",
                "      OBJC3C_FRONTEND_STATUS_USAGE_ERROR) return 8;",
                "  if (objc3c_frontend_c_owned_result_process_exit_code(0) != 2) return 9;",
                "  if (objc3c_frontend_c_owned_result_success(0) != 0u) return 10;",
                "  if (objc3c_frontend_c_owned_result_has_artifact(",
                "          0, OBJC3C_FRONTEND_ARTIFACT_OBJECT) != 0u) return 11;",
                "  if (objc3c_frontend_c_owned_result_error_message(0) != 0) return 12;",
                "  if (objc3c_frontend_c_owned_result_error_message_view(0).data != 0) return 13;",
                "  objc3c_frontend_c_owned_result_destroy(0);",
