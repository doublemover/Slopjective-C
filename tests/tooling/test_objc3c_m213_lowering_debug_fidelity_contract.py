...
def test_m213_lowering_runtime_debug_fidelity_profile_section_present() -> None:
...
def test_m213_lowering_runtime_debug_fidelity_markers_align_to_source_surfaces() -> None:
    ...
    assert 'out << "source_filename = \\"" << program_.module_name << ".objc3\\"\\n\\n";' in emitter_source
