...
struct KeyPathSlot {
  ...
  std::string object_model_owner_identity_storage;
  std::string object_model_member_identity_storage;
  std::string debug_source_map_key_storage;
  std::string diagnostic_anchor_key_storage;
