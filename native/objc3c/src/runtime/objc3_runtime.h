...
// lookup-dispatch-runtime anchor: the canonical runtime-owned lookup
...
// class-realization-runtime anchor: the current runtime-owned class
...
// metaclass-graph-root-class anchor: the realized class graph and
...
// category-attachment-protocol-conformance anchor: realized category
...
// runtime-arc-helper-api-surface anchor: later ARC-specific runtime
...
// error-runtime/bridge-helper anchor: the first runnable Part 6
...
// continuation/runtime-helper anchor: the first Part 7 continuation
...
// scheduler/executor runtime anchor: the first truthful task
...
// live task runtime anchor: the supported helper-backed task slice
// now executes through that same private runtime surface, but this public
// runtime header still does not widen.
// runtime-bootstrap-api anchor: these exported C ABI type names and
