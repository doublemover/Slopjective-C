...
void PopulateRuntimeTaskRuntimeStateSnapshot(
  ...
  snapshot.cancelled_group_task_count = state.cancelled_group_task_count;
  ...
  snapshot.scheduler_cancelled_count = state.scheduler_cancelled_count;
  ...
  snapshot.last_cancelled_task_handle = state.last_cancelled_task_handle;
  snapshot.last_cancelled_executor_tag = state.last_cancelled_executor_tag;
