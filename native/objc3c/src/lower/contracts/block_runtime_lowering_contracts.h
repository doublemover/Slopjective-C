...
// Block runtime lowering owns source capture and block ABI lowering records;
// private runtime helper/gate surfaces are owned by block_runtime_helper_contracts.h.
