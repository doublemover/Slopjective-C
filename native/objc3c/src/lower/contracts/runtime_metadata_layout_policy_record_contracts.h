...
// Runtime metadata layout policy records are the replayable validation handoff
// between deterministic family layout rules and object-format-specific emission.
