...
inline constexpr std::array<Objc3LanguageSemanticsConcreteFixtureContract, 21>
    kObjc3LanguageSemanticsConcreteFixtureContracts = {{
        ...
        {8168,
         Objc3LanguageSemanticsConcretePhase::kSema,
         "metaprogramming-derive-expansion-inventory",
        ...
        {8168,
         Objc3LanguageSemanticsConcretePhase::kSema,
         "metaprogramming-macro-safety-sandbox-determinism",
