...
#define OBJC3C_FRONTEND_C_API_CONTRACT_ID \
  "objc3c.frontend.c_api.public_contract.v4"
#define OBJC3C_FRONTEND_C_API_OWNED_RESULT_OWNER \
  "frontend-c-api-owned-result-handle"
...
typedef enum objc3c_frontend_c_api_policy {
  OBJC3C_FRONTEND_C_API_POLICY_CALLER_OWNS_COMPILE_RESULT = 1,
