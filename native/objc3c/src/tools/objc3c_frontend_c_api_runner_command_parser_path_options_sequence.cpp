...
ParseFrontendCApiRunnerPathStringOptionPassSequence(
  ...
  const FrontendCApiRunnerCommandOptionParseResult output_result =
      ParseFrontendCApiRunnerPathStringOutputPass(arg,
                                                  argc,
                                                  argv,
                                                  index,
                                                  options);
  ...
  const FrontendCApiRunnerCommandOptionParseResult toolchain_result =
      ParseFrontendCApiRunnerPathStringToolchainPass(arg,
                                                     argc,
                                                     argv,
                                                     index,
                                                     options);
  ...
  return ParseFrontendCApiRunnerPathStringSummaryOutputPass(arg,
                                                           argc,
                                                           argv,
                                                           index,
                                                           options);
