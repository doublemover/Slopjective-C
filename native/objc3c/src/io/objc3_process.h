...
struct Objc3RuntimeTranslationUnitRegistrationManifestArtifactInputs {
  ...
  std::string storage_accessor_runtime_abi_contract_id;
  std::string storage_accessor_runtime_abi_boundary_model;
  std::string storage_accessor_public_header_path;
  std::string storage_accessor_private_header_path;
  std::string storage_accessor_property_registry_state_snapshot_symbol;
  std::string storage_accessor_property_entry_snapshot_symbol;
  std::string storage_accessor_current_property_read_symbol;
  std::string storage_accessor_current_property_write_symbol;
  std::string storage_accessor_current_property_exchange_symbol;
  std::string storage_accessor_bind_current_property_context_symbol;
  std::string storage_accessor_clear_current_property_context_symbol;
  std::string storage_accessor_weak_current_property_load_symbol;
  std::string storage_accessor_weak_current_property_store_symbol;
  bool storage_accessor_private_testing_surface_only = false;
  bool storage_accessor_deterministic = false;
