...
std::string RenderDashboardArtifact(std::string_view artifact_id,
  ...
  artifact.StringField("file_sha256",
...
std::string RenderDashboardSummary() {
  ...
  summary.RawJsonField(
      "profile_counts",
      RenderDashboardCountObject({"pass", "fail", "blocked", "incomplete"}, 4));
  summary.RawJsonField(
      "dependency_counts",
      RenderDashboardCountObject({"pass", "fail", "blocked", "stale", "missing"},
                                 4));
  summary.RawJsonField(
      "blocker_counts",
      RenderDashboardCountObject({"open", "resolved", "high_or_critical"}, 0));
