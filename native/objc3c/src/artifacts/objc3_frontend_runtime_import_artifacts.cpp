...
BuildDispatchDispatchMetadataInterfacePreservationSummary(
  ...
  summary.contract_id = kObjc3DispatchDispatchMetadataInterfacePreservationContractId;
  summary.source_contract_id = kObjc3DispatchDispatchControlLoweringContractId;
  summary.surface_path = kObjc3DispatchDispatchMetadataInterfacePreservationSurfacePath;
  summary.import_artifact_member_name =
      kObjc3DispatchDispatchMetadataInterfacePreservationImportArtifactMemberName;
  summary.source_model = kObjc3DispatchDispatchMetadataInterfacePreservationSourceModel;
  ...
  for (const auto &surface : imported_runtime_module_surfaces) {
    ...
    summary.deterministic = summary.deterministic && surface.dispatch_deterministic;
  }
