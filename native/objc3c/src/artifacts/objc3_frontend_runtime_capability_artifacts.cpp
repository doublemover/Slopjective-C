...
std::string BuildRuntimeCapabilityOptionalFeaturesJson() {
  ...
  constexpr OptionalFeatureEntry kEntries[] = {
      ...
      {"typed-throws", "not-claimed",
       "#8233 preserves single throws(E) payloads through source/interface metadata, hidden error-out ABI lowering, exact typed catches, and explicit id<Error> bridge policy; the broad public typed-throws capability row remains reserved until replay gates prove full support",
      ...
      {"value-optionals", "not-claimed",
       "#8234 admits Optional<T> type signatures and bounded scalar packed runtime ABI lowering while keeping nested/generic payloads, property/ivar storage, unchecked unwrap, nil-to-scalar, implicit nil absence, nullable-pointer conversion, and throws/result conversion fail-closed",
