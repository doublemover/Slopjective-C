...
std::string RenderVersionedConformanceReportArtifactJson(
  ...
  object.UnsignedField("language_version", language_version);
  ...
  object.RawJsonField("feature_claim_truth_surface",
                      feature_claim_truth_surface_json);
  object.RawJsonField("compatibility_strictness_claim_semantics",
                      compatibility_strictness_claim_semantics_json);
  object.RawJsonField("runtime_capability_report", runtime_capability_report_json);
  object.RawJsonField("public_conformance_report",
                      public_conformance_report_json);
  object.RawJsonField("advanced_feature_reporting",
                      advanced_feature_reporting_json);
