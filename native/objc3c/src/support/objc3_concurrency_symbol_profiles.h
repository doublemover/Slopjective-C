...
inline std::string BuildConcurrencyLowercaseProfileToken(
    std::string_view token) {
  return LowercaseAscii(token);
}

inline bool IsConcurrencyTaskCreationSymbol(std::string_view symbol) {
  if (symbol.empty()) {
    return false;
  }
...
inline bool IsConcurrencyDetachedTaskCreationSymbol(std::string_view symbol) {
  if (symbol.empty()) {
    return false;
  }
  const std::string lowered = BuildConcurrencyLowercaseProfileToken(symbol);
...
inline bool IsConcurrencyTaskGroupScopeSymbol(std::string_view symbol) {
  if (symbol.empty()) {
    return false;
  }
  const std::string lowered = BuildConcurrencyLowercaseProfileToken(symbol);
...
inline bool IsConcurrencyTaskGroupAddTaskSymbol(std::string_view symbol) {
  if (symbol.empty()) {
    return false;
  }
  const std::string lowered = BuildConcurrencyLowercaseProfileToken(symbol);
...
inline bool IsConcurrencyTaskGroupWaitNextSymbol(std::string_view symbol) {
  if (symbol.empty()) {
    return false;
  }
  const std::string lowered = BuildConcurrencyLowercaseProfileToken(symbol);
...
inline bool IsConcurrencyTaskGroupCancelAllSymbol(std::string_view symbol) {
  if (symbol.empty()) {
    return false;
  }
  const std::string lowered = BuildConcurrencyLowercaseProfileToken(symbol);
...
inline bool IsConcurrencyCancellationCheckSymbol(std::string_view symbol) {
  if (symbol.empty()) {
    return false;
  }
  const std::string lowered = BuildConcurrencyLowercaseProfileToken(symbol);
...
inline bool IsConcurrencyCancellationHandlerSymbol(std::string_view symbol) {
  if (symbol.empty()) {
    return false;
  }
  const std::string lowered = BuildConcurrencyLowercaseProfileToken(symbol);
