...
constexpr std::array<LanguageFeatureState, kRejectedFeatureStateDataCount>
    kRejectedFeatureStates = {{
        ...
        {"removed-runtime-dispatch-gate", FeatureState::Rejected, "O3R001",
         "Retired runtime gate dispatch switches are rejected."},
        {"removed-runtime-dispatch-retired-route", FeatureState::Rejected, "O3R001",
         "Retired runtime retired route dispatch switches are rejected."},
        ...
        {"removed-gate-command-options", FeatureState::Rejected, "O3C001",
         "Retired gate switches are rejected by the native command surface."},
