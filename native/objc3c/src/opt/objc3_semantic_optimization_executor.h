...
struct Objc3SemanticOptimizationCandidate {
  ...
  std::string method_inline_runtime_invalidation_replay_key;
  std::string method_inline_inline_frame_id_key;
  std::string method_inline_inlined_callsite_source_span_key;
  std::string method_inline_stepping_policy_key;
  std::string method_inline_optimized_ir_source_correlation_key;
  bool method_inline_original_call_source_span_present = false;
  bool method_inline_inline_frame_id_present = false;
  bool method_inline_inlined_callsite_source_span_present = false;
  bool method_inline_imported_debug_map_inline_frame_present = false;
  bool method_inline_emitted_debug_map_inline_frame_present = false;
  bool method_inline_stepping_policy_unambiguous = false;
  bool method_inline_optimized_ir_source_correlation_present = false;
  bool method_inline_generated_only_source_map = false;
  bool method_inline_scalar_subset = false;
  bool method_inline_receiver_dispatch_assumptions_pinned = false;
  bool method_inline_ownership_arc_effects_safe = false;
  bool method_inline_side_effect_summary_safe = false;
  bool method_inline_side_effect_replay_complete = false;
  bool method_inline_source_map_debug_preserved = false;
  bool method_inline_diagnostic_location_preserved = false;
  bool method_inline_debug_stepping_evidence_present = false;
  ...
  bool method_inline_runtime_cache_assumptions_fresh = false;
  bool method_inline_runtime_invalidation_replay_present = false;
