...
void EmitObjc3IRRuntimeCategoryBundleSection(
  ...
  for (std::size_t i = 0;
    ...
    const std::string class_name_symbol =
        BuildObjc3IRRuntimeObjectMetadataAuxiliarySymbol(
            layout_policy, family, "class_name", i);
    const std::string category_name_symbol =
        BuildObjc3IRRuntimeObjectMetadataAuxiliarySymbol(
            layout_policy, family, "category_name", i);
    const std::string owner_identity_symbol =
        BuildObjc3IRRuntimeObjectMetadataAuxiliarySymbol(
            layout_policy, family, "owner_identity", i);
    const std::string record_kind_symbol =
        BuildObjc3IRRuntimeObjectMetadataAuxiliarySymbol(
            layout_policy, family, "record_kind", i);
    const std::string category_owner_identity_symbol =
        BuildObjc3IRRuntimeObjectMetadataAuxiliarySymbol(
            layout_policy, family, "category_owner_identity", i);
    const std::string class_owner_identity_symbol =
        BuildObjc3IRRuntimeObjectMetadataAuxiliarySymbol(
            layout_policy, family, "class_owner_identity", i);
    const std::string attachment_list_symbol =
        BuildObjc3IRRuntimeObjectMetadataAuxiliarySymbol(
            layout_policy, family, "attachments", i);
