...
inline void RetainObjc3IRRuntimeMemberMetadataGlobal(
    std::vector<std::string> &retained_globals, const std::string &symbol) {
  retained_globals.push_back(symbol);
}

inline std::string BuildObjc3IRRuntimeMemberMetadataDescriptorSymbol(
...
inline std::string BuildObjc3IRRuntimeMemberMetadataAuxiliarySymbol(
    const Objc3RuntimeMetadataLayoutPolicy &layout_policy,
    const Objc3RuntimeMetadataLayoutPolicyFamily &family,
...
inline std::string BuildObjc3IRRuntimeMemberMetadataMethodListKey(
