...
inline Objc3RuntimeExportViolationAccumulator
...
inline bool IsInterfaceRuntimePropertyOwnerKind(
    const std::string &owner_kind) {
  return owner_kind == "class-interface" ||
         owner_kind == "category-interface";
}

inline bool IsImplementationRuntimePropertyOwnerKind(
    const std::string &owner_kind) {
  return owner_kind == "class-implementation" ||
         owner_kind == "category-implementation";
}

inline bool IsInterfaceRuntimeMethodOwnerKind(const std::string &owner_kind) {
  return owner_kind == "class-interface" ||
         owner_kind == "category-interface";
}

inline bool IsImplementationRuntimeMethodOwnerKind(
    const std::string &owner_kind) {
  return owner_kind == "class-implementation" ||
         owner_kind == "category-implementation";
}

inline bool AreCompatibleRuntimePropertyRedeclarations(
...
inline bool AreCompatibleRuntimeMethodRedeclarations(
...
inline std::vector<Objc3RuntimeExportBlockingDiagnostic>
...
inline bool HasRuntimeMetadataSourceRecords(
    const Objc3RuntimeMetadataSourceRecordSet &records) {
...
inline Objc3RuntimeExportEnforcementSummary
