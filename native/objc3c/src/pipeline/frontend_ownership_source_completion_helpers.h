...
inline void CollectOwnershipCleanupResourceCaptureStmtSites(
    const Stmt *stmt,
    Objc3FrontendOwnershipCleanupResourceCaptureSourceCompletionSummary &summary);

inline void CollectOwnershipCleanupResourceCaptureExprSites(
    const Expr *expr,
    Objc3FrontendOwnershipCleanupResourceCaptureSourceCompletionSummary &summary) {
  if (expr == nullptr) {
    return;
...
inline Objc3FrontendOwnershipCleanupResourceCaptureSourceCompletionSummary
