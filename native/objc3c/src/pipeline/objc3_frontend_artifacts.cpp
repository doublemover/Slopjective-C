...
BuildCrossModuleRuntimeMetadataSemanticPreservationSummary(
  ...
  for (const auto &ivar_record : runtime_metadata_source_records.ivars_lexicographic) {
...
std::string BuildCrossModuleRuntimeMetadataSemanticPreservationSummaryJson(
  ...
  out << "{"
      << "\"contract_id\":\"" << EscapeJsonString(summary.contract_id)
      << "\",\"source_frontend_closure_contract_id\":\""
      << EscapeJsonString(summary.source_frontend_closure_contract_id)
      << "\",\"frontend_surface_path\":\""
      << EscapeJsonString(summary.frontend_surface_path)
      << "\",\"source_artifact_relative_path\":\""
      ...
      << "\",\"authority_model\":\""
      << EscapeJsonString(summary.authority_model)
      << "\",\"conformance_shape_model\":\""
      << EscapeJsonString(summary.conformance_shape_model)
      << "\",\"dispatch_trait_model\":\""
      << EscapeJsonString(summary.dispatch_trait_model)
      << "\",\"effect_trait_model\":\""
      << EscapeJsonString(summary.effect_trait_model)
      << "\",\"module_name\":\"" << EscapeJsonString(summary.module_name)
      << "\",\"class_record_count\":" << summary.class_record_count
      << ",\"protocol_record_count\":" << summary.protocol_record_count
      << ",\"category_record_count\":" << summary.category_record_count
      ...
      << (IsReadyObjc3CrossModuleRuntimeMetadataSemanticPreservationSummary(
              ...
              : "false")
      << ",\"fail_closed\":" << (summary.fail_closed ? "true" : "false")
      << ",\"source_frontend_closure_ready\":"
      << (summary.source_frontend_closure_ready ? "true" : "false")
      << ",\"runtime_metadata_source_records_ready\":"
      << (summary.runtime_metadata_source_records_ready ? "true" : "false")
      ...
      << (summary.ready_for_cross_module_dispatch_equivalence ? "true"
                                                              : "false")
      << ",\"source_frontend_closure_replay_key\":\""
      << EscapeJsonString(summary.source_frontend_closure_replay_key)
      << "\",\"replay_key\":\"" << EscapeJsonString(summary.replay_key)
      << "\",\"failure_reason\":\""
      << EscapeJsonString(summary.failure_reason) << "\"}";
  return out.str();
...
BuildFrontendCompatibilityStrictnessClaimSemanticsSummary(
  ...
  if (summary.semantic_boundary_ready) {
    summary.effective_compatibility_mode =
        semantic_boundary.effective_compatibility_mode;
    summary.migration_assist_enabled =
        semantic_boundary.migration_assist_enabled;
    summary.valid_compatibility_mode_count =
        semantic_boundary.valid_compatibility_mode_count;
    ...
    summary.migration_assist_semantics_landed =
        semantic_boundary.migration_assist_semantics_landed;
...
std::string BuildFrontendCompatibilityStrictnessClaimSemanticsSummaryJson(
  ...
  out << "{"
      ...
      << "\",\"migration_assist_enabled\":"
      << (summary.migration_assist_enabled ? "true" : "false")
      << ",\"valid_compatibility_mode_count\":"
      << summary.valid_compatibility_mode_count
...
std::string BuildRuntimeCapabilityOptionalFeaturesJson() {
  ...
  for (std::size_t i = 0; i < kEntryCount; ++i) {
    ...
    out << "{\"id\":\"" << entry.id << "\",\"status\":\""
        << entry.status << "\",\"reason\":\""
        << EscapeJsonString(entry.reason) << "\",\"backing_claim_id\":\""
        << entry.backing_claim_id << "\"}";
  }
  out << "]";
  return out.str();
}
...
std::string BuildRuntimeCapabilityVersionsJson() {
  std::ostringstream out;
  out << "{\"frontend\":\""
      << kObjc3RuntimeCapabilityToolchainVersion
...
std::string BuildRuntimeCapabilityReportJson(
  ...
  out << "{"
      ...
      << "\",\"source_contract_id\":\""
      << EscapeJsonString(summary.contract_id)
      << "\",\"frontend_surface_path\":\""
...
std::string BuildPublicConformanceReportJson(
  ...
  out << "{"
      ...
      << (summary.migration_assist_enabled ? "true" : "false")
      << "},\"profiles\":"
      << BuildPublicConformanceProfilesJson()
      << ",\"optional_features\":"
      << BuildRuntimeCapabilityOptionalFeaturesJson()
      << ",\"versions\":" << BuildRuntimeCapabilityVersionsJson()
      << ",\"known_deviations\":[]"
