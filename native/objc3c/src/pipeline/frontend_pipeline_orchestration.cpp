...
Objc3FrontendTypeSystemTypeSourceClosureSummary BuildTypeSystemTypeSourceClosureSummary(
  ...
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildTypeSystemTypeSourceClosureReplayKey(summary);
  return summary;
}
...
BuildErrorHandlingErrorSourceClosureSummary(const Objc3Program &program,
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildErrorHandlingErrorSourceClosureReplayKey(summary);
  return summary;
}
...
BuildConcurrencyAsyncSourceClosureSummary(const Objc3Program &program,
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildConcurrencyAsyncSourceClosureReplayKey(summary);
  return summary;
}
...
BuildConcurrencyActorMemberIsolationSourceClosureSummary(const Objc3Program &program) {
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildConcurrencyActorMemberIsolationSourceClosureReplayKey(summary);
  return summary;
}
...
BuildConcurrencyTaskGroupCancellationSourceClosureSummary(
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildConcurrencyTaskGroupCancellationSourceClosureReplayKey(summary);
  return summary;
}
...
BuildOwnershipSystemExtensionSourceClosureSummary(const Objc3Program &program) {
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildOwnershipSystemExtensionSourceClosureReplayKey(summary);
  return summary;
}
...
BuildOwnershipCleanupResourceCaptureSourceCompletionSummary(
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildOwnershipCleanupResourceCaptureSourceCompletionReplayKey(summary);
  return summary;
}
...
BuildOwnershipRetainableCFamilySourceCompletionSummary(
  ...
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildOwnershipRetainableCFamilySourceCompletionReplayKey(summary);
  return summary;
}
...
BuildDispatchDispatchIntentSourceClosureSummary(const Objc3Program &program) {
  ...
  summary.ready_for_semantic_expansion = true;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildDispatchDispatchIntentSourceClosureReplayKey(summary);
  return summary;
}
...
BuildDispatchDispatchIntentSourceCompletionSummary(const Objc3Program &program) {
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildDispatchDispatchIntentSourceCompletionReplayKey(summary);
  return summary;
}
...
BuildInteropForeignImportSourceClosureSummary(const Objc3Program &program) {
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildInteropForeignImportSourceClosureReplayKey(summary);
  return summary;
}
...
BuildInteropCppSwiftInteropAnnotationSourceCompletionSummary(
  ...
  summary.ready_for_semantic_expansion = summary.deterministic_handoff;
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildInteropCppSwiftInteropAnnotationSourceCompletionReplayKey(summary);
  return summary;
}
...
BuildToolingDiagnosticTaxonomyPortabilityContractSummary(
  ...
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildToolingDiagnosticTaxonomyPortabilityContractReplayKey(summary);
  return summary;
}
...
BuildToolingFeatureSpecificFixitSynthesisSummary(
  ...
  summary.replay_key =
      objc3c::pipeline::orchestration::BuildToolingFeatureSpecificFixitSynthesisReplayKey(summary);
  return summary;
}
