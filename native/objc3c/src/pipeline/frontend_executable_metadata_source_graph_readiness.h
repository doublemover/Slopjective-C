...
inline bool HasExecutableMetadataGraphEdge(
...
inline void SortExecutableMetadataSourceGraph(
...
inline bool IsExecutableMetadataSourceGraphDeterministic(
    const Objc3ExecutableMetadataSourceGraph &graph) {
...
inline void MarkExecutableMetadataSourceGraphReadiness(
