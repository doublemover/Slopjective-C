...
inline std::string BuildObjc3IREmissionCoreFeatureAdvancedCoreShard1Key(
    const Objc3IREmissionCoreFeatureImplementationSurface &surface) {
  std::ostringstream key;
...
inline std::string BuildObjc3IREmissionCoreFeatureAdvancedEdgeCompatibilityShard1Key(
    const Objc3IREmissionCoreFeatureImplementationSurface &surface) {
  std::ostringstream key;
...
inline std::string BuildObjc3IREmissionCoreFeatureAdvancedConformanceShard1Key(
    const Objc3IREmissionCoreFeatureImplementationSurface &surface) {
  std::ostringstream key;
...
inline std::string BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key(
    const Objc3IREmissionCoreFeatureImplementationSurface &surface) {
  std::ostringstream key;
