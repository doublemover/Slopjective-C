...
struct Objc3ImportedRuntimeModuleSurface {
  ...
  bool type_system_generic_contract_ready = false;
  bool type_system_generic_contract_deterministic = false;
  std::size_t type_system_generic_interface_count = 0;
  std::size_t type_system_generic_parameter_count = 0;
  std::size_t type_system_generic_variance_annotation_count = 0;
  std::size_t type_system_generic_argument_reference_count = 0;
...
inline bool IsReadyObjc3ImportedRuntimeModuleSurfaceCrossModuleContract(
...
inline bool IsReadyObjc3ImportedRuntimeModulePackagingLinkPlan(
    const Objc3ImportedRuntimeModulePackagingPeerArtifacts &artifacts) {
  const bool live_restart_replay_symbols_ready =
      !artifacts.bootstrap_live_restart_replay_registered_images_symbol.empty() &&
      !artifacts.bootstrap_live_restart_reset_replay_state_snapshot_symbol.empty();
