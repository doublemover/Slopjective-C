...
| ------------- | ------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `ECP50-001`   | `docs/reference/legacy_spec_anchor_index.md#planning-issue-187-cross-lane-checkpoint-package`          | `Checkpoint schema and escalation contract reference.`                           | `Sections 4 through 6 used for CP-50 audit.`                               |
...
| `ECP50-003`   | `docs/reference/legacy_spec_anchor_index.md#planning-issue-173-conformance-evidence-dashboard-package` | `Source for B-13 status payload dependency and schema assumptions.`              | `VAR-CP50-002 linkage validated against dashboard feed contract.`          |
...
| `ECP50-005`   | `docs/reference/legacy_spec_anchor_index.md#planning-future-work-v011-milestones`                      | `Gate impact baseline for G3 risk statement.`                                    | `G3 timing statement in Gate/Decision Summary matches milestone baseline.` |
