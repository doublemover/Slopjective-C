...
- Issues snapshot: `tmp/v015_m23_open_issues_snapshot.json`
- Milestones snapshot: `tmp/v015_m23_open_milestones_snapshot.json`
...
- Issues snapshot path: `tmp/v015_m23_open_issues_snapshot.json`
- Milestones snapshot path: `tmp/v015_m23_open_milestones_snapshot.json`
...
- Output directory: `reports/activation_preflight/v015_activation_seed_hardening_w3_dispatch_20260224`
