...
| --- | --- | --- | --- | --- | --- |
| Issues | `true` | `86400` | `2026-02-24T21:37:24Z` | `1` | `true` |
| Milestones | `true` | `86400` | `2026-02-24T21:37:24Z` | `1` | `true` |

## Trigger Results

| Trigger ID | Fired | Count | Condition |
| --- | --- | --- | --- |
| `T1-ISSUES` | `true` | 150 | open issues > 0 |
| `T2-MILESTONES` | `true` | 15 | open milestones > 0 |
