...
- Issues snapshot path: `tmp/v015_activation_open_issues_snapshot.json`
- Milestones snapshot path: `tmp/v015_activation_open_milestones_snapshot.json`
...
- Queue state: `idle`
- Active trigger IDs: _none_
- Open blocker count: `0`
- Open blockers trigger fired: `false`
- Activation checker exit code: `0`
...
- Output directory: `reports/activation_preflight/v015_activation_seed_dispatch_20260224`
...
| Command | Exit Code |
| --- | --- |
| `check_activation_triggers_json` | `0` |
| `check_activation_triggers_markdown` | `0` |
| `spec_lint` | `0` |
