...
- Issues snapshot path: `tmp/v015_m24_open_issues_snapshot.json`
- Milestones snapshot path: `tmp/v015_m24_open_milestones_snapshot.json`
...
- Output directory: `reports/activation_preflight/v015_activation_seed_hardening_w4_dispatch_20260224`
