...
- Issues snapshot path: `tmp/v015_m28_live_issues_snapshot.json`
- Milestones snapshot path: `tmp/v015_m28_live_milestones_snapshot.json`
- Open blockers snapshot path: _none_
- Issues max age seconds: `86400`
- Milestones max age seconds: `86400`
...
- Output directory: `reports/activation_preflight/v015_activation_execution_hardening_w2_dispatch_20260224`
