#!/usr/bin/env python3
"""Fail-closed checker for M248-A006 suite partitioning edge-case expansion and robustness contract."""
...
MODE = "m248-a006-suite-partitioning-fixture-ownership-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-A006/"
    "suite_partitioning_and_fixture_ownership_edge_case_expansion_and_robustness_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-A006-DOC-EXP-01",
        "Contract ID: `objc3c-suite-partitioning-and-fixture-ownership-edge-case-expansion-and-robustness/m248-a006-v1`",
    ),
    SnippetCheck("M248-A006-DOC-EXP-02", "Dependencies: `M248-A005`"),
    SnippetCheck("M248-A006-DOC-EXP-03", "Issue `#6793` defines canonical lane-A edge-case expansion and robustness scope."),
    SnippetCheck("M248-A006-DOC-EXP-04", "`check:objc3c:m248-a006-lane-a-readiness`"),
    SnippetCheck("M248-A006-DOC-EXP-05", "`check:objc3c:m248-a005-lane-a-readiness`"),
    SnippetCheck("M248-A006-DOC-EXP-06", "`test:objc3c:parser-replay-proof`"),
    SnippetCheck(
        "M248-A006-DOC-EXP-07",
    ...
    SnippetCheck(
        "M248-A006-DOC-EXP-08",
        "optimization improvements as mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-A006-DOC-PKT-01", "Packet: `M248-A006`"),
    SnippetCheck("M248-A006-DOC-PKT-02", "Issue: `#6793`"),
    SnippetCheck("M248-A006-DOC-PKT-03", "Dependencies: `M248-A005`"),
    SnippetCheck(
        "M248-A006-DOC-PKT-04",
        "`scripts/check_m248_a006_suite_partitioning_and_fixture_ownership_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M248-A006-DOC-PKT-05",
    ...
    SnippetCheck("M248-A006-DOC-PKT-06", "`test:objc3c:parser-replay-proof`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-A006-PKG-03", "check:objc3c:m248-a006-lane-a-readiness"),
    PackageScriptKeyCheck("M248-A006-PKG-04", "test:objc3c:parser-replay-proof"),
    PackageScriptKeyCheck("M248-A006-PKG-05", "test:objc3c:parser-ast-extraction"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-a005-lane-a-readiness && npm run check:objc3c:m248-a006-suite-partitioning-fixture-ownership-edge-case-expansion-robustness-contract && npm run test:tooling:m248-a006-suite-partitioning-fixture-ownership-edge-case-expansion-robustness-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M248-A006-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M248-A006-DOC-PKT-00", PACKET_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M248-A006-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M248-A006-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M248-A006-META-00", METADATA_SPEC_SNIPPETS),
    ):
