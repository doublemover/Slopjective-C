#!/usr/bin/env python3
"""Fail-closed checker for M243-E010 lane-E diagnostics gate/replay-policy conformance corpus expansion."""
...
MODE = "m243-e010-lane-e-diagnostics-quality-gate-replay-policy-conformance-corpus-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m243_lane_e_diagnostics_quality_gate_and_replay_policy_conformance_corpus_expansion_e010_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m243"
    / "m243_e010_lane_e_diagnostics_quality_gate_and_replay_policy_conformance_corpus_expansion_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m243/M243-E010/"
    "lane_e_diagnostics_quality_gate_and_replay_policy_conformance_corpus_expansion_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M243-E010-D007-01",
        "M243-D007",
        Path("docs/contracts/m243_cli_reporting_and_output_contract_integration_diagnostics_hardening_d007_expectations.md"),
    ),
    AssetCheck(
        "M243-E010-D007-02",
        "M243-D007",
        Path("scripts/check_m243_d007_cli_reporting_and_output_contract_integration_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M243-E010-D007-03",
        "M243-D007",
        Path("tests/tooling/test_check_m243_d007_cli_reporting_and_output_contract_integration_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M243-E010-D007-04",
        "M243-D007",
        Path("spec/planning/compiler/m243/m243_d007_cli_reporting_and_output_contract_integration_diagnostics_hardening_packet.md"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M243-E010-DOC-EXP-01",
        "Contract ID: `objc3c-lane-e-diagnostics-quality-gate-replay-policy-conformance-corpus-expansion/m243-e010-v1`",
    ),
    SnippetCheck(
        "M243-E010-DOC-EXP-02",
        "Dependencies: `M243-E009`, `M243-A004`, `M243-B005`, `M243-C005`, `M243-D007`",
    ),
    SnippetCheck("M243-E010-DOC-EXP-03", "Issue `#6496` defines the canonical lane-E dependency chain for E010."),
    SnippetCheck("M243-E010-DOC-EXP-04", "E009 contract anchors remain mandatory prerequisites:"),
    SnippetCheck("M243-E010-DOC-EXP-05", "`check:objc3c:m243-e010-lane-e-readiness`"),
    SnippetCheck("M243-E010-DOC-EXP-06", "`compile:objc3c`"),
    SnippetCheck("M243-E010-DOC-EXP-07", "`proof:objc3c`"),
    SnippetCheck("M243-E010-DOC-EXP-08", "`test:objc3c:diagnostics-replay-proof`"),
    SnippetCheck("M243-E010-DOC-EXP-09", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M243-E010-DOC-EXP-10", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M243-E010-DOC-PKT-01", "Packet: `M243-E010`"),
    SnippetCheck("M243-E010-DOC-PKT-02", "Issue: `#6496`"),
    SnippetCheck(
        "M243-E010-DOC-PKT-03",
        "Dependencies: `M243-E009`, `M243-A004`, `M243-B005`, `M243-C005`, `M243-D007`",
    ),
    SnippetCheck(
        "M243-E010-DOC-PKT-04",
        "`scripts/check_m243_e010_lane_e_diagnostics_quality_gate_and_replay_policy_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M243-E010-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M243-E010-CFG-03", "check:objc3c:m243-e010-lane-e-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m243-e009-lane-e-readiness && npm run check:objc3c:m243-a004-lane-a-readiness && npm run check:objc3c:m243-b005-lane-b-readiness && npm run check:objc3c:m243-c005-lane-c-readiness && npm run check:objc3c:m243-d007-lane-d-readiness && npm run check:objc3c:m243-e010-lane-e-diagnostics-quality-gate-replay-policy-conformance-corpus-expansion-contract && npm run test:tooling:m243-e010-lane-e-diagnostics-quality-gate-replay-policy-conformance-corpus-expansion-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M243-E010-ARCH-02",
        "(`M243-E009`, `M243-A004`, `M243-B005`, `M243-C005`, and `M243-D007`)",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M243-E010-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M243-E010-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M243-E010-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M243-E010-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M243-E010-META-00",
