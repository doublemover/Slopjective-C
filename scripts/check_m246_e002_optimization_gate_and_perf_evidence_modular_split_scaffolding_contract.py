#!/usr/bin/env python3
"""Fail-closed checker for M246-E002 optimization gate/perf modular split/scaffolding."""
...
MODE = "m246-e002-optimization-gate-perf-evidence-modular-split-scaffolding-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m246"
    / "m246_e002_optimization_gate_and_perf_evidence_modular_split_scaffolding_packet.md"
)
DEFAULT_E001_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M246-E002-DEP-E001-01",
        Path("docs/contracts/m246_optimization_gate_and_perf_evidence_contract_and_architecture_freeze_e001_expectations.md"),
    ),
    AssetCheck(
        "M246-E002-DEP-E001-02",
        Path("spec/planning/compiler/m246/m246_e001_optimization_gate_and_perf_evidence_contract_and_architecture_freeze_packet.md"),
    ),
    AssetCheck(
        "M246-E002-DEP-E001-03",
        Path("scripts/check_m246_e001_optimization_gate_and_perf_evidence_contract_and_architecture_freeze_contract.py"),
    ),
    AssetCheck(
        "M246-E002-DEP-E001-04",
        Path("tests/tooling/test_check_m246_e001_optimization_gate_and_perf_evidence_contract_and_architecture_freeze_contract.py"),
    ),
    AssetCheck(
        "M246-E002-DEP-A002-01",
        Path("docs/contracts/m246_frontend_optimization_hint_capture_modular_split_scaffolding_a002_expectations.md"),
    ),
    AssetCheck(
        "M246-E002-DEP-A002-02",
        Path("spec/planning/compiler/m246/m246_a002_frontend_optimization_hint_capture_modular_split_scaffolding_packet.md"),
    ),
    AssetCheck(
        "M246-E002-DEP-A002-03",
        Path("scripts/check_m246_a002_frontend_optimization_hint_capture_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-E002-DEP-A002-04",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-E002-DOC-PKT-01",
        "# M246-E002 Optimization Gate and Perf Evidence Modular Split/Scaffolding Packet",
    ),
    SnippetCheck("M246-E002-DOC-PKT-02", "Packet: `M246-E002`"),
    SnippetCheck("M246-E002-DOC-PKT-03", "Issue: `#6693`"),
    SnippetCheck(
        "M246-E002-DOC-PKT-04",
        "Dependencies: `M246-E001`, `M246-A002`, `M246-B002`, `M246-C004`, `M246-D002`",
    ),
    SnippetCheck("M246-E002-DOC-PKT-05", "Pending seeded dependency tokens:"),
)

E001_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-E002-E001-01",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-E002-ARCH-02",
        "`M246-E001`, `M246-A002`, `M246-B002`, `M246-C004`, and `M246-D002`",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-E002-SPC-02",
        "`M246-E001`, `M246-A002`, `M246-B002`,",
    ),
    SnippetCheck(
        "M246-E002-SPC-03",
        "`M246-C004`, and `M246-D002`",
    ),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--e001-expectations-doc", type=Path, default=DEFAULT_E001_EXPECTATIONS_DOC)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-E002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-E002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.e001_expectations_doc, "M246-E002-E001-DOC-EXISTS", E001_SNIPPETS),
        (args.a002_expectations_doc, "M246-E002-A002-DOC-EXISTS", A002_SNIPPETS),
        (args.architecture_doc, "M246-E002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M246-E002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M246-E002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M246-E002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
