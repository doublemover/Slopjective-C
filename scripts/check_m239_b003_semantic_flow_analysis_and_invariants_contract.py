#!/usr/bin/env python3
"""Fail-closed checker for M239-B003 semantic flow analysis and invariants contract freeze."""
...
MODE = "m239-b003-semantic-flow-analysis-and-invariants-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m239"
    / "m239_b003_semantic_flow_analysis_and_invariants_core_feature_implementation_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M239-B003-DOC-EXP-01",
        "# M239 Semantic flow analysis and invariants Contract and Architecture Freeze Expectations (B003)",
    ),
    SnippetCheck(
        "M239-B003-DOC-EXP-02",
        "Contract ID: `objc3c-semantic-flow-analysis-and-invariants/m239-b003-v1`",
    ),
    SnippetCheck("M239-B003-DOC-EXP-03", "Issue: `#4951`"),
    SnippetCheck("M239-B003-DOC-EXP-04", "Dependencies: none"),
    SnippetCheck(
        "M239-B003-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M239-B003-DOC-EXP-06",
        "`check:objc3c:m239-b003-lane-b-readiness`",
    ),
    SnippetCheck(
        "M239-B003-DOC-EXP-07",
        "`tmp/reports/m239/M239-B003/semantic_flow_analysis_and_invariants_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M239-B003-DOC-PKT-01",
        "# M239-B003 Semantic flow analysis and invariants Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M239-B003-DOC-PKT-02", "Packet: `M239-B003`"),
    SnippetCheck("M239-B003-DOC-PKT-03", "Issue: `#4951`"),
    SnippetCheck("M239-B003-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M239-B003-DOC-PKT-05",
        "check:objc3c:m239-b003-semantic-flow-analysis-and-invariants-contract",
    ),
    SnippetCheck(
        "M239-B003-DOC-PKT-06",
        "tmp/reports/m239/M239-B003/semantic_flow_analysis_and_invariants_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M239-B003-PKG-03",
        '"check:objc3c:m239-b003-lane-b-readiness": '
        '"npm run check:objc3c:m239-b003-semantic-flow-analysis-and-invariants-contract '
        '&& npm run test:tooling:m239-b003-semantic-flow-analysis-and-invariants-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M239-B003-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M239-B003-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M239-B003-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M239-B003-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M239-B003-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M239-B003-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
