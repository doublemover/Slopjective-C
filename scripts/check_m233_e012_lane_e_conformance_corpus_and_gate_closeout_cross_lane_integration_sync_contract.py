#!/usr/bin/env python3
"""Fail-closed checker for M233-E012 conformance corpus and gate closeout cross-lane integration sync."""
...
MODE = "m233-e012-lane-e-conformance-corpus-gate-closeout-cross-lane-integration-sync-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_e012_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_e012_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E012-DOC-PKT-01",
        "# M233-E012 Lane-E Conformance Corpus and Gate Closeout Cross-Lane Integration Sync Packet",
    ),
    SnippetCheck("M233-E012-DOC-PKT-02", "Packet: `M233-E012`"),
    SnippetCheck("M233-E012-DOC-PKT-03", "Issue: `#5665`"),
    SnippetCheck(
        "M233-E012-DOC-PKT-04",
        "Dependencies: `M233-E011`, `M233-A008`, `M233-B012`, `M233-C016`, `M233-D020`",
    ),
    SnippetCheck("M233-E012-DOC-PKT-05", "Predecessor: `M233-E011`"),
    SnippetCheck("M233-E012-DOC-PKT-06", "Theme: cross-lane integration sync"),
    SnippetCheck(
        "M233-E012-DOC-PKT-07",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_e012_expectations.md",
    ),
    SnippetCheck(
        "M233-E012-DOC-PKT-08",
        "scripts/check_m233_e012_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M233-E012-DOC-PKT-09",
        "tests/tooling/test_check_m233_e012_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M233-E012-DOC-PKT-10",
    ...
    SnippetCheck(
        "M233-E012-DOC-PKT-11",
        "cross-lane integration sync traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E012-DOC-PKT-12",
        "tmp/reports/m233/M233-E012/lane_e_conformance_corpus_gate_closeout_cross_lane_integration_sync_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-E012-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M233-E012-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M233-E012-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-E012-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-E012-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-E012-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M233-E012-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
