#!/usr/bin/env python3
"""Fail-closed checker for M243-E011 lane-E diagnostics gate/replay-policy performance and quality guardrails."""
...
MODE = "m243-e011-lane-e-diagnostics-quality-gate-replay-policy-performance-quality-guardrails-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m243_lane_e_diagnostics_quality_gate_and_replay_policy_performance_quality_guardrails_e011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m243"
    / "m243_e011_lane_e_diagnostics_quality_gate_and_replay_policy_performance_quality_guardrails_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m243/M243-E011/"
    "lane_e_diagnostics_quality_gate_and_replay_policy_performance_quality_guardrails_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M243-E011-C006-01",
        "M243-C006",
        Path("docs/contracts/m243_lowering_runtime_diagnostics_surfacing_edge_case_expansion_and_robustness_c006_expectations.md"),
    ),
    AssetCheck(
        "M243-E011-C006-02",
        "M243-C006",
        Path("scripts/check_m243_c006_lowering_runtime_diagnostics_surfacing_edge_case_expansion_and_robustness_contract.py"),
    ),
    AssetCheck(
        "M243-E011-C006-03",
        "M243-C006",
        Path("tests/tooling/test_check_m243_c006_lowering_runtime_diagnostics_surfacing_edge_case_expansion_and_robustness_contract.py"),
    ),
    AssetCheck(
        "M243-E011-C006-04",
        "M243-C006",
        Path("spec/planning/compiler/m243/m243_c006_lowering_runtime_diagnostics_surfacing_edge_case_expansion_and_robustness_packet.md"),
    ),
    AssetCheck(
        "M243-E011-D008-01",
        "M243-D008",
        Path("docs/contracts/m243_cli_reporting_and_output_contract_integration_recovery_determinism_hardening_d008_expectations.md"),
    ),
    AssetCheck(
        "M243-E011-D008-02",
        "M243-D008",
        Path("scripts/check_m243_d008_cli_reporting_and_output_contract_integration_recovery_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M243-E011-D008-03",
        "M243-D008",
        Path("tests/tooling/test_check_m243_d008_cli_reporting_and_output_contract_integration_recovery_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M243-E011-D008-04",
        "M243-D008",
        Path("spec/planning/compiler/m243/m243_d008_cli_reporting_and_output_contract_integration_recovery_determinism_hardening_packet.md"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M243-E011-DOC-EXP-01",
        "Contract ID: `objc3c-lane-e-diagnostics-quality-gate-replay-policy-performance-quality-guardrails/m243-e011-v1`",
    ),
    SnippetCheck(
        "M243-E011-DOC-EXP-02",
        "Dependencies: `M243-E010`, `M243-A004`, `M243-B005`, `M243-C006`, `M243-D008`",
    ),
    SnippetCheck("M243-E011-DOC-EXP-03", "Issue `#6497` defines the canonical lane-E dependency chain for E011."),
    SnippetCheck("M243-E011-DOC-EXP-04", "E010 contract anchors remain mandatory prerequisites:"),
    SnippetCheck("M243-E011-DOC-EXP-05", "`check:objc3c:m243-e011-lane-e-readiness`"),
    SnippetCheck("M243-E011-DOC-EXP-06", "`compile:objc3c`"),
    SnippetCheck("M243-E011-DOC-EXP-07", "`proof:objc3c`"),
    SnippetCheck("M243-E011-DOC-EXP-08", "`test:objc3c:diagnostics-replay-proof`"),
    SnippetCheck("M243-E011-DOC-EXP-09", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M243-E011-DOC-EXP-10", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M243-E011-DOC-PKT-01", "Packet: `M243-E011`"),
    SnippetCheck("M243-E011-DOC-PKT-02", "Issue: `#6497`"),
    SnippetCheck(
        "M243-E011-DOC-PKT-03",
        "Dependencies: `M243-E010`, `M243-A004`, `M243-B005`, `M243-C006`, `M243-D008`",
    ),
    SnippetCheck(
        "M243-E011-DOC-PKT-04",
        "`scripts/check_m243_e011_lane_e_diagnostics_quality_gate_and_replay_policy_performance_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M243-E011-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M243-E011-CFG-03", "check:objc3c:m243-e011-lane-e-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m243-e010-lane-e-readiness && npm run check:objc3c:m243-a004-lane-a-readiness && npm run check:objc3c:m243-b005-lane-b-readiness && npm run check:objc3c:m243-c006-lane-c-readiness && npm run check:objc3c:m243-d008-lane-d-readiness && npm run check:objc3c:m243-e011-lane-e-diagnostics-quality-gate-replay-policy-performance-quality-guardrails-contract && npm run test:tooling:m243-e011-lane-e-diagnostics-quality-gate-replay-policy-performance-quality-guardrails-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M243-E011-ARCH-02",
        "(`M243-E010`, `M243-A004`, `M243-B005`, `M243-C006`, and `M243-D008`)",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M243-E011-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M243-E011-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M243-E011-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M243-E011-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M243-E011-META-00",
