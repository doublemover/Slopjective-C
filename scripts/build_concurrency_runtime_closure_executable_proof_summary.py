...
def main() -> int:
    ...
    checks = {
        ...
        "runbook_mentions_public_command_boundary": "npm run objc3c -- validate-concurrency-conformance" in runbook_text and "npm run objc3c -- validate-runnable-concurrency" in runbook_text,
