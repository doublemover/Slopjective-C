#!/usr/bin/env python3
"""Fail-closed checker for M244-A011 interop surface performance and quality guardrails contract."""
...
MODE = "m244-a011-interop-surface-syntax-and-declaration-forms-performance-and-quality-guardrails-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_surface_syntax_and_declaration_forms_performance_and_quality_guardrails_a011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_a011_interop_surface_syntax_and_declaration_forms_performance_and_quality_guardrails_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-A011/"
    "interop_surface_syntax_and_declaration_forms_performance_and_quality_guardrails_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-A011-DOC-EXP-01",
        "Contract ID: `objc3c-interop-surface-syntax-and-declaration-forms-performance-and-quality-guardrails/m244-a011-v1`",
    ),
    SnippetCheck("M244-A011-DOC-EXP-02", "Dependencies: `M244-A010`"),
    SnippetCheck("M244-A011-DOC-EXP-03", "Issue `#6528` defines canonical lane-A performance and quality guardrails scope."),
    SnippetCheck("M244-A011-DOC-EXP-04", "`check:objc3c:m244-a011-lane-a-readiness`"),
    SnippetCheck("M244-A011-DOC-EXP-05", "`check:objc3c:m244-a010-lane-a-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-A011-DOC-PKT-01", "Packet: `M244-A011`"),
    SnippetCheck("M244-A011-DOC-PKT-02", "Issue: `#6528`"),
    SnippetCheck("M244-A011-DOC-PKT-03", "Dependencies: `M244-A010`"),
    SnippetCheck(
        "M244-A011-DOC-PKT-04",
        "`scripts/check_m244_a011_interop_surface_syntax_and_declaration_forms_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M244-A011-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-A011-CFG-03", "check:objc3c:m244-a011-lane-a-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-a010-lane-a-readiness && npm run check:objc3c:m244-a011-interop-surface-syntax-declaration-forms-performance-and-quality-guardrails-contract && npm run test:tooling:m244-a011-interop-surface-syntax-declaration-forms-performance-and-quality-guardrails-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A011-ARCH-02", "`M244-A010` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A011-SPC-02", "lane-A dependency anchor (`M244-A010`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-A011-META-02",
        "explicit `M244-A010` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-A011-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-A011-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-A011-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-A011-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-A011-META-00",
