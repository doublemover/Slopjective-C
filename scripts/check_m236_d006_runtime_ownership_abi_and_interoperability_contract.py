#!/usr/bin/env python3
"""Fail-closed contract checker for M236-D006 interop behavior for qualified generic APIs."""
...
MODE = "m236-d006-runtime-ownership-abi-and-interoperability-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m236_runtime_ownership_abi_and_interoperability_edge_case_expansion_and_robustness_d006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m236"
    / "m236_d006_runtime_ownership_abi_and_interoperability_edge_case_expansion_and_robustness_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M236-D006-DOC-PKT-01",
        "# M236-D006 Interop Behavior for Qualified Generic APIs Edge-case Expansion and Robustness Packet",
    ),
    SnippetCheck("M236-D006-DOC-PKT-02", "Packet: `M236-D006`"),
    SnippetCheck("M236-D006-DOC-PKT-03", "Issue: `#5831`"),
    SnippetCheck("M236-D006-DOC-PKT-04", "Dependencies: `M236-C001`"),
    SnippetCheck(
        "M236-D006-DOC-PKT-05",
        "scripts/check_m236_d006_runtime_ownership_abi_and_interoperability_contract.py",
    ),
    SnippetCheck(
        "M236-D006-DOC-PKT-06",
        "scripts/check_m236_c001_arc_style_lowering_insertion_and_cleanup_contract.py",
    ),
    SnippetCheck("M236-D006-DOC-PKT-07", "`compile:objc3c`"),
    SnippetCheck("M236-D006-DOC-PKT-08", "`check:objc3c:m236-c001-lane-c-readiness`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M236-D006-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M236-D006-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M236-D006-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M236-D006-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M236-D006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M236-D006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M236-D006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M236-D006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M236-D006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M236-D006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
