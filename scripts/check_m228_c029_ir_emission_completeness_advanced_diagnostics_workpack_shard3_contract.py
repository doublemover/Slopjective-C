#!/usr/bin/env python3
"""Fail-closed validator for M228-C029 IR-emission advanced integration shard1 contract."""
...
MODE = "m228-c029-ir-emission-completeness-advanced-diagnostics-workpack-shard3-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c028_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_edge_compatibility_workpack_shard3_c028_expectations.md",
    "c028_checker": ROOT
    / "scripts"
    / "check_m228_c028_ir_emission_completeness_advanced_edge_compatibility_workpack_shard3_contract.py",
    "c028_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c028_ir_emission_completeness_advanced_edge_compatibility_workpack_shard3_contract.py",
    "c028_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c028_ir_emission_completeness_advanced_edge_compatibility_workpack_shard3_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_diagnostics_workpack_shard3_c029_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c029_ir_emission_completeness_advanced_diagnostics_workpack_shard3_packet.md",
}
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        (
            "M228-C029-RUN-03",
            "python -m pytest tests/tooling/test_check_m228_c029_ir_emission_completeness_advanced_diagnostics_workpack_shard3_contract.py -q",
        ),
        ("M228-C029-RUN-04", "npm run check:objc3c:m228-c029-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C029-ARC-01",
    ...
    "package_json": (
        ("M228-C029-PKG-01", '"check:objc3c:m228-c028-lane-c-readiness"'),
        (
            "M228-C029-PKG-02",
            '"check:objc3c:m228-c029-ir-emission-completeness-advanced-diagnostics-workpack-shard3-contract"',
        ),
        (
            "M228-C029-PKG-03",
            '"test:tooling:m228-c029-ir-emission-completeness-advanced-diagnostics-workpack-shard3-contract"',
        ),
        ("M228-C029-PKG-04", '"check:objc3c:m228-c029-lane-c-readiness"'),
        (
            "M228-C029-PKG-05",
            '"check:objc3c:m228-c029-lane-c-readiness": "npm run check:objc3c:m228-c028-lane-c-readiness &&',
        ),
    ),
    "c028_contract_doc": (
        (
    ...
    "c028_checker": (
        (
            "M228-C029-DEP-02",
            'MODE = "m228-c028-ir-emission-completeness-advanced-edge-compatibility-workpack-shard3-contract-v1"',
        ),
    ),
    "c028_tooling_test": (
        ("M228-C029-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c028_packet_doc": (
        ("M228-C029-DEP-04", "Packet: `M228-C028`"),
        ("M228-C029-DEP-05", "Issue: `#5254`"),
    ),
    "contract_doc": (
        (
            "M228-C029-DOC-01",
            "Contract ID: `objc3c-ir-emission-completeness-advanced-diagnostics-workpack-shard3/m228-c029-v1`",
        ),
        ("M228-C029-DOC-02", "Execute issue `#5255`"),
        ("M228-C029-DOC-03", "Dependencies: `M228-C028`"),
        (
            "M228-C029-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
        ...
        (
            "M228-C029-DOC-10",
            "tmp/reports/m228/M228-C029/ir_emission_completeness_advanced_diagnostics_workpack_shard3_contract_summary.json",
        ),
    ),
    "packet_doc": (
        (
            "M228-C029-PKT-01",
            "# M228-C029 IR Emission Completeness Advanced Diagnostics Workpack (Shard 3) Packet",
        ),
        ("M228-C029-PKT-02", "Packet: `M228-C029`"),
        ("M228-C029-PKT-03", "Issue: `#5255`"),
        ("M228-C029-PKT-04", "Dependencies: `M228-C028`"),
        (
            "M228-C029-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C029-FORB-01",
            '"check:objc3c:m228-c029-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C029/"
            "ir_emission_completeness_advanced_diagnostics_workpack_shard3_contract_summary.json"
        ),
    )
