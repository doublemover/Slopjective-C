#!/usr/bin/env python3
"""Fail-closed checker for M248-A008 suite partitioning recovery and determinism hardening contract."""
...
MODE = "m248-a008-suite-partitioning-fixture-ownership-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-A008/"
    "suite_partitioning_and_fixture_ownership_recovery_and_determinism_hardening_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        ...
        Path(
            "tests/tooling/"
            "test_check_m248_a007_suite_partitioning_and_fixture_ownership_diagnostics_hardening_contract.py"
        ),
    ),
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-A008-DOC-EXP-01",
        "Contract ID: `objc3c-suite-partitioning-and-fixture-ownership-recovery-and-determinism-hardening/m248-a008-v1`",
    ),
    SnippetCheck("M248-A008-DOC-EXP-02", "Dependencies: `M248-A007`"),
    SnippetCheck("M248-A008-DOC-EXP-03", "Issue `#6795` defines canonical lane-A recovery and determinism hardening scope."),
    SnippetCheck("M248-A008-DOC-EXP-04", "`check:objc3c:m248-a008-lane-a-readiness`"),
    SnippetCheck("M248-A008-DOC-EXP-05", "`check:objc3c:m248-a007-lane-a-readiness`"),
    SnippetCheck("M248-A008-DOC-EXP-06", "`test:objc3c:parser-replay-proof`"),
    SnippetCheck("M248-A008-DOC-EXP-07", "`test:objc3c:parser-ast-extraction`"),
    SnippetCheck(
        "M248-A008-DOC-EXP-08",
    ...
    SnippetCheck(
        "M248-A008-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-A008-DOC-PKT-01", "Packet: `M248-A008`"),
    SnippetCheck("M248-A008-DOC-PKT-02", "Issue: `#6795`"),
    SnippetCheck("M248-A008-DOC-PKT-03", "Dependencies: `M248-A007`"),
    SnippetCheck(
        "M248-A008-DOC-PKT-04",
        "`scripts/check_m248_a008_suite_partitioning_and_fixture_ownership_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-A008-DOC-PKT-05",
    ...
    SnippetCheck("M248-A008-DOC-PKT-06", "`check:objc3c:m248-a008-lane-a-readiness`"),
    SnippetCheck("M248-A008-DOC-PKT-07", "`test:objc3c:parser-replay-proof`"),
    SnippetCheck(
        "M248-A008-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-A008-PKG-03", "check:objc3c:m248-a008-lane-a-readiness"),
    PackageScriptKeyCheck("M248-A008-PKG-04", "test:objc3c:parser-replay-proof"),
    PackageScriptKeyCheck("M248-A008-PKG-05", "test:objc3c:parser-ast-extraction"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-a007-lane-a-readiness && npm run check:objc3c:m248-a008-suite-partitioning-fixture-ownership-recovery-and-determinism-hardening-contract && npm run test:tooling:m248-a008-suite-partitioning-fixture-ownership-recovery-and-determinism-hardening-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M248-A008-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M248-A008-DOC-PKT-00", PACKET_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M248-A008-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M248-A008-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M248-A008-META-00", METADATA_SPEC_SNIPPETS),
    ):
