#!/usr/bin/env python3
"""Fail-closed checker for M234-C009 accessor and ivar lowering conformance matrix implementation."""
...
MODE = "m234-c009-accessor-and-ivar-lowering-contracts-conformance-matrix-implementation-contract-v1"
...
DEFAULT_C008_CHECKER = (
    ROOT / "scripts" / "check_m234_c008_accessor_and_ivar_lowering_contracts_recovery_and_determinism_hardening_contract.py"
)
DEFAULT_C008_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_c008_accessor_and_ivar_lowering_contracts_recovery_and_determinism_hardening_contract.py"
)
...
C008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-C009-C008-PKT-01", "Packet: `M234-C008`"),
    SnippetCheck("M234-C009-C008-PKT-02", "Dependencies: `M234-C007`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-C009-META-02",
        "explicit `M234-C008` dependency continuity so conformance matrix implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-C009-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-C009-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-C009-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-C009-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str] | None = None) -> int:
    ...
    for path, exists_id, snippets in (
        (args.expectations_doc, "M234-C009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-C009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c008_expectations_doc, "M234-C009-C008-DOC-EXISTS", C008_EXPECTATIONS_SNIPPETS),
        (args.c008_packet_doc, "M234-C009-C008-PKT-EXISTS", C008_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-C009-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-C009-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-C009-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-C009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c008_checker, "M234-C009-C008-CHECKER-EXISTS"),
        (args.c008_test, "M234-C009-C008-TEST-EXISTS"),
    ):
