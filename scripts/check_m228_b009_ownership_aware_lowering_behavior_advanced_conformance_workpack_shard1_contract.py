#!/usr/bin/env python3
"""Fail-closed validator for M228-B018 ownership-aware lowering advanced conformance workpack (shard 1) contract."""
...
MODE = "m228-b018-ownership-aware-lowering-behavior-advanced-conformance-workpack-shard1-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m228"
    / "m228_b018_ownership_aware_lowering_behavior_advanced_conformance_workpack_shard1_packet.md",
    ...
    / "tests"
    / "tooling"
    / "test_check_m228_b017_ownership_aware_lowering_behavior_advanced_diagnostics_workpack_shard1_contract.py",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "contract_doc": (
        ...
        ("M228-B018-DOC-02", "Execute issue `#5212`"),
        ("M228-B018-DOC-03", "Dependencies: `M228-B017`"),
        (
            "M228-B018-DOC-04",
            "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
        ),
        ("M228-B018-DOC-05", "`docs/runbooks/m228_wave_execution_runbook.md`"),
        (
            "M228-B018-DOC-06",
        ...
        ("M228-B018-DOC-08", "`npm run check:objc3c:m228-b018-lane-b-readiness`"),
        (
            "M228-B018-DOC-09",
    ...
    "runbook_doc": (
        ...
        ("M228-B018-RUN-06", "npm run check:objc3c:m228-b018-lane-b-readiness"),
        ("M228-B018-RUN-07", "tmp/reports/m228/"),
    ),
    "planning_packet": (
        ("M228-B018-PKT-01", "Packet: `M228-B018`"),
        ("M228-B018-PKT-02", "Issue: `#5212`"),
        ("M228-B018-PKT-03", "Dependencies: `M228-B017`"),
        ("M228-B018-PKT-04", "docs/runbooks/m228_wave_execution_runbook.md"),
        (
            "M228-B018-PKT-05",
            "scripts/check_m228_b018_ownership_aware_lowering_behavior_advanced_conformance_workpack_shard1_contract.py",
        ),
        ...
        ("M228-B018-PKT-07", "check:objc3c:m228-b018-lane-b-readiness"),
        (
            "M228-B018-PKT-08",
            "tmp/reports/m228/M228-B018/ownership_aware_lowering_behavior_advanced_conformance_workpack_shard1_contract_summary.json",
        ),
    ...
    "b017_tooling_test": (
        ("M228-B018-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "b017_packet_doc": (
        ("M228-B018-DEP-04", "Packet: `M228-B017`"),
        ("M228-B018-DEP-05", "Issue: `#5211`"),
    ),
    "package_json": (
        ("M228-B018-PKG-01", '"check:objc3c:m228-b017-lane-b-readiness"'),
        (
            "M228-B018-PKG-02",
        ...
        ("M228-B018-PKG-04", '"check:objc3c:m228-b018-lane-b-readiness"'),
        (
            "M228-B018-PKG-05",
        ...
        (
            "M228-B018-PKG-07",
            "tests/tooling/test_check_m228_b018_ownership_aware_lowering_behavior_advanced_conformance_workpack_shard1_contract.py -q",
        ),
        ("M228-B018-PKG-08", '"compile:objc3c"'),
        ("M228-B018-PKG-09", '"proof:objc3c"'),
        ("M228-B018-PKG-10", '"test:objc3c:execution-smoke"'),
        ("M228-B018-PKG-11", '"test:objc3c:lowering-replay-proof"'),
    ),
    "architecture_doc": (
        (
            "M228-B018-ARC-01",
    ...
    "lowering_spec": (
        (
            "M228-B018-SPC-01",
            "ownership-aware lowering advanced conformance workpack (shard 1)",
        ),
        (
            "M228-B018-SPC-02",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-B018-FORB-01",
            '"check:objc3c:m228-b018-lane-b-readiness": "npm run check:objc3c:m228-b016-lane-b-readiness',
        ),
    ),
}
