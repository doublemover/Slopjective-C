#!/usr/bin/env python3
"""Fail-closed checker for M233-D015 runtime metadata and lookup advanced core workpack (shard 1)."""
...
MODE = "m233-d015-installer-runtime-operations-lookup-plumbing-advanced-core-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_runtime_metadata_and_lookup_plumbing_advanced_core_workpack_shard1_d015_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_d015_runtime_metadata_and_lookup_plumbing_advanced_core_workpack_shard1_packet.md"
)
...
DEFAULT_D014_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m233_d014_runtime_metadata_and_lookup_plumbing_release_candidate_and_replay_dry_run_contract.py"
)
DEFAULT_D014_READINESS_RUNNER = ROOT / "scripts" / "run_m233_d014_lane_d_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m233_d015_lane_d_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D015-DOC-EXP-01",
        "# M233 Runtime Metadata and Lookup Plumbing Advanced Core Workpack (Shard 1) Expectations (D015)",
    ),
    SnippetCheck(
        "M233-D015-DOC-EXP-02",
        "Contract ID: `objc3c-installer-runtime-operations-lookup-plumbing-advanced-core-workpack-shard1/m233-d015-v1`",
    ),
    SnippetCheck("M233-D015-DOC-EXP-03", "Dependencies: `M233-D014`"),
    SnippetCheck("M233-D015-DOC-EXP-04", "Issue: `#6942`"),
    SnippetCheck(
        "M233-D015-DOC-EXP-05",
        "scripts/check_m233_d014_runtime_metadata_and_lookup_plumbing_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck("M233-D015-DOC-EXP-06", "scripts/run_m233_d015_lane_d_readiness.py"),
    SnippetCheck("M233-D015-DOC-EXP-07", "code/spec anchors and milestone optimization"),
    SnippetCheck(
        "M233-D015-DOC-EXP-08",
        "tmp/reports/m233/M233-D015/runtime_metadata_and_lookup_plumbing_advanced_core_workpack_shard1_contract_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D015-DOC-PKT-01",
        "# M233-D015 Runtime Metadata and Lookup Plumbing Advanced Core Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M233-D015-DOC-PKT-02", "Packet: `M233-D015`"),
    SnippetCheck("M233-D015-DOC-PKT-03", "Issue: `#6942`"),
    SnippetCheck("M233-D015-DOC-PKT-04", "Dependencies: `M233-D014`"),
    SnippetCheck(
        "M233-D015-DOC-PKT-05",
        "scripts/check_m233_d014_runtime_metadata_and_lookup_plumbing_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck(
        "M233-D015-DOC-PKT-06",
        "python scripts/run_m233_d014_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M233-D015-DOC-PKT-07",
...
D014_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D015-D014-DOC-01",
        "Contract ID: `objc3c-installer-runtime-operations-lookup-plumbing-release-candidate-replay-dry-run/m233-d014-v1`",
    ),
    SnippetCheck("M233-D015-D014-DOC-02", "Dependencies: `M233-D013`"),
)

D014_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-D015-D014-PKT-01", "Packet: `M233-D014`"),
    SnippetCheck("M233-D015-D014-PKT-02", "Issue: `#6941`"),
    SnippetCheck("M233-D015-D014-PKT-03", "Dependencies"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D015-RUN-01",
        '"""Run M233-D015 lane-D readiness checks without deep npm nesting."""',
    ),
    SnippetCheck("M233-D015-RUN-02", "scripts/run_m233_d014_lane_d_readiness.py"),
    SnippetCheck(
        "M233-D015-RUN-03",
    ...
    SnippetCheck("M233-D015-RUN-05", "[ok] M233-D015 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-D015-PKG-03",
        '"check:objc3c:m233-d015-lane-d-readiness": "python scripts/run_m233_d015_lane_d_readiness.py"',
    ),
    SnippetCheck("M233-D015-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M233-D015-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M233-D015-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-D015-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-D015-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-D015-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d014_expectations_doc, "M233-D015-D014-DOC-EXISTS", D014_EXPECTATIONS_SNIPPETS),
        (args.d014_packet_doc, "M233-D015-D014-PKT-EXISTS", D014_PACKET_SNIPPETS),
        (args.readiness_runner, "M233-D015-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M233-D015-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M233-D015-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M233-D015-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M233-D015-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d014_checker, "M233-D015-DEP-D014-ARG-01"),
        (args.d014_test, "M233-D015-DEP-D014-ARG-02"),
        (args.d014_readiness_runner, "M233-D015-DEP-D014-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
