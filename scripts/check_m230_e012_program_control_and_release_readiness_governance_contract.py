#!/usr/bin/env python3
"""Fail-closed checker for M230-E012 Program control and release readiness governance contract freeze."""
...
MODE = "m230-e012-program-control-and-release-readiness-governance-cross-lane-integration-sync-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_e012_program_control_and_release_readiness_governance_cross_lane_integration_sync_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-E012-DOC-PKT-01",
        "# M230-E012 Program control and release readiness governance Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-E012-DOC-PKT-02", "Packet: `M230-E012`"),
    SnippetCheck("M230-E012-DOC-PKT-03", "Issue: `#5473`"),
    SnippetCheck("M230-E012-DOC-PKT-04", "Dependencies: `M230-E011`"),
    SnippetCheck(
        "M230-E012-DOC-PKT-05",
        "check:objc3c:m230-e012-program-control-and-release-readiness-governance-cross-lane-integration-sync-contract",
    ),
    SnippetCheck(
        "M230-E012-DOC-PKT-06",
        "tmp/reports/m230/M230-E012/program_control_and_release_readiness_governance_cross_lane_integration_sync_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-E012-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-E012-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-E012-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-E012-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-E012-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-E012-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
