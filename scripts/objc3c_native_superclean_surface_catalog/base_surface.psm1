...
function New-Objc3cNativeRepoSupercleanBaseSurface {
  param(
  ...
  return New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
    ...
    implementation_roots = New-Objc3cNativeRepoSupercleanPathList -Paths @(
      "native/objc3c",
      "scripts",
      "tests"
    )
    checked_in_doc_sources = New-Objc3cNativeRepoSupercleanPathList -Paths @(
      "README.md",
      "CONTRIBUTING.md",
      "showcase",
      "stdlib",
    ...
    generated_checked_in_outputs = New-Objc3cNativeRepoSupercleanPathList -Paths @(
      "site/index.md",
      "docs/objc3c-native.md",
      "docs/runbooks/objc3c_public_command_surface.md"
    )
    maintainer_runbooks = New-Objc3cNativeRepoSupercleanPathList -Paths @(
    ...
    machine_owned_output_roots = New-Objc3cNativeRepoSupercleanPathList -Paths @(
      "tmp",
      "artifacts"
    )
    package_entrypoints = New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
...
Export-ModuleMember -Function "New-Objc3cNativeRepoSupercleanBaseSurface"
