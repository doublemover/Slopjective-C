...
function New-Objc3cNativeRepoSupercleanPerformanceSurfaces {
  return New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
    performance_benchmark_surface = New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
    ...
    runtime_performance_surface = New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
    ...
    compiler_throughput_surface = New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
    ...
    performance_governance_surface = New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
...
Export-ModuleMember -Function "New-Objc3cNativeRepoSupercleanPerformanceSurfaces"
