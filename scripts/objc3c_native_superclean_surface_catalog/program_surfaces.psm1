  ...
  return New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
    ...
    conformance_corpus_surface = New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
      ...
      workflow_surface = New-Objc3cNativeRepoSupercleanCatalogPayload -Entries ([ordered]@{
        ...
        runnable_surface_check_command = "npm run objc3c -- validate-runnable-conformance-corpus"
        implementation_anchors = New-Objc3cNativeRepoSupercleanPathList -Paths @(
        ...
        support_claim_runnable_evidence_catalog = "tests/conformance/support_claim_runnable_evidence_catalog.json"
      })
    })
  })
}
