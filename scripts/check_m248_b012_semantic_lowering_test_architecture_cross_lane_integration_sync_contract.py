#!/usr/bin/env python3
"""Fail-closed contract checker for M248-B012 semantic/lowering cross-lane integration sync."""
...
MODE = "m248-b012-semantic-lowering-test-architecture-cross-lane-integration-sync-contract-v1"
...
DEFAULT_B011_CHECKER = (
    ROOT
    / "scripts"
    / "check_m248_b011_semantic_lowering_test_architecture_performance_and_quality_guardrails_contract.py"
)
DEFAULT_B011_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m248_b011_semantic_lowering_test_architecture_performance_and_quality_guardrails_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B012-DOC-PKT-01",
        "# M248-B012 Semantic/Lowering Test Architecture Cross-Lane Integration Sync Packet",
    ),
    SnippetCheck("M248-B012-DOC-PKT-02", "Packet: `M248-B012`"),
    SnippetCheck("M248-B012-DOC-PKT-03", "Issue: `#6812`"),
    SnippetCheck("M248-B012-DOC-PKT-04", "Dependencies: `M248-B011`"),
    SnippetCheck(
        "M248-B012-DOC-PKT-05",
        "`scripts/check_m248_b012_semantic_lowering_test_architecture_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M248-B012-DOC-PKT-06",
        "`check:objc3c:m248-b012-lane-b-readiness`",
    ),
    SnippetCheck(
        "M248-B012-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M248-B012-DOC-PKT-08",
...
B011_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B012-B011-DOC-01",
        "Contract ID: `objc3c-semantic-lowering-test-architecture-performance-quality-guardrails/m248-b011-v1`",
    ),
    SnippetCheck("M248-B012-B011-DOC-02", "- Dependencies: `M248-B010`"),
    SnippetCheck(
        "M248-B012-B011-DOC-03",
        "scripts/check_m248_b011_semantic_lowering_test_architecture_performance_and_quality_guardrails_contract.py",
    ),
)

B011_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-B012-B011-PKT-01", "Packet: `M248-B011`"),
    SnippetCheck("M248-B012-B011-PKT-02", "Dependencies: `M248-B010`"),
    SnippetCheck(
        "M248-B012-B011-PKT-03",
        "`scripts/check_m248_b011_semantic_lowering_test_architecture_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M248-B012-B011-PKT-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-B012-PKG-04", '"check:objc3c:m248-b011-lane-b-readiness": '),
    SnippetCheck("M248-B012-PKG-05", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M248-B012-PKG-06", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B012-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B012-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b011_expectations_doc, "M248-B012-B011-DOC-EXISTS", B011_EXPECTATIONS_SNIPPETS),
        (args.b011_packet_doc, "M248-B012-B011-PKT-EXISTS", B011_PACKET_SNIPPETS),
        (args.architecture_doc, "M248-B012-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B012-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B012-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-B012-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b011_checker, "M248-B012-DEP-B011-ARG-01"),
        (args.b011_test, "M248-B012-DEP-B011-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
