#!/usr/bin/env python3
"""Fail-closed checker for M235-D004 interop behavior core feature expansion."""
...
MODE = "m235-d004-interop-behavior-for-qualified-generic-apis-core-feature-expansion-contract-v1"
...
DEFAULT_D003_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m235_interop_behavior_for_qualified_generic_apis_core_feature_implementation_d003_expectations.md"
)
DEFAULT_D003_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_d003_interop_behavior_for_qualified_generic_apis_core_feature_implementation_packet.md"
)
DEFAULT_D003_CHECKER = (
    ROOT / "scripts" / "check_m235_d003_interop_behavior_for_qualified_generic_apis_core_feature_implementation_contract.py"
)
DEFAULT_D003_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_d003_interop_behavior_for_qualified_generic_apis_core_feature_implementation_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M235-D004-DEP-D003-01",
        Path("docs/contracts/m235_interop_behavior_for_qualified_generic_apis_core_feature_implementation_d003_expectations.md"),
    ),
    AssetCheck(
        "M235-D004-DEP-D003-02",
        Path("spec/planning/compiler/m235/m235_d003_interop_behavior_for_qualified_generic_apis_core_feature_implementation_packet.md"),
    ),
    AssetCheck(
        "M235-D004-DEP-D003-03",
        Path("scripts/check_m235_d003_interop_behavior_for_qualified_generic_apis_core_feature_implementation_contract.py"),
    ),
    AssetCheck(
        "M235-D004-DEP-D003-04",
        Path("tests/tooling/test_check_m235_d003_interop_behavior_for_qualified_generic_apis_core_feature_implementation_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-D004-DOC-EXP-01",
        "# M235 Interop Behavior for Qualified Generic APIs Core Feature Expansion Expectations (D004)",
    ),
    SnippetCheck(
        "M235-D004-DOC-EXP-02",
        "Contract ID: `objc3c-interop-behavior-for-qualified-generic-apis-core-feature-expansion/m235-d004-v1`",
    ),
    SnippetCheck(
        "M235-D004-DOC-EXP-03",
        "Issue `#5834` defines canonical lane-D core feature expansion scope.",
    ),
    SnippetCheck("M235-D004-DOC-EXP-04", "Dependencies: `M235-D003`"),
    SnippetCheck(
        "M235-D004-DOC-EXP-05",
        "milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-D004-DOC-EXP-06",
        "docs/contracts/m235_interop_behavior_for_qualified_generic_apis_core_feature_implementation_d003_expectations.md",
    ),
    SnippetCheck(
        "M235-D004-DOC-EXP-07",
        "scripts/check_m235_d003_interop_behavior_for_qualified_generic_apis_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M235-D004-DOC-EXP-08",
        "tests/tooling/test_check_m235_d003_interop_behavior_for_qualified_generic_apis_core_feature_implementation_contract.py",
    ),
    SnippetCheck("M235-D004-DOC-EXP-09", "`check:objc3c:m235-d003-lane-d-readiness`"),
    SnippetCheck(
        "M235-D004-DOC-EXP-10",
        "`check:objc3c:m235-d004-interop-behavior-for-qualified-generic-apis-core-feature-expansion-contract`",
    ),
    SnippetCheck(
        "M235-D004-DOC-EXP-11",
        "`check:objc3c:m235-d004-lane-d-readiness`",
    ),
    SnippetCheck("M235-D004-DOC-EXP-12", "`compile:objc3c`"),
    SnippetCheck(
        "M235-D004-DOC-EXP-13",
        "`tmp/reports/m235/M235-D004/interop_behavior_for_qualified_generic_apis_core_feature_expansion_contract_summary.json`",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m235-d003-interop-behavior-for-qualified-generic-apis-core-feature-implementation-contract '
        '&& npm run test:tooling:m235-d003-interop-behavior-for-qualified-generic-apis-core-feature-implementation-contract"',
    ),
    SnippetCheck(
        "M235-D004-PKG-04",
        '"check:objc3c:m235-d004-interop-behavior-for-qualified-generic-apis-core-feature-expansion-contract": '
    ...
    SnippetCheck("M235-D004-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-D004-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-D004-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-D004-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-D004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-D004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d003_expectations_doc, "M235-D004-D003-DOC-EXISTS", D003_EXPECTATIONS_SNIPPETS),
        (args.d003_packet_doc, "M235-D004-D003-PKT-EXISTS", D003_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-D004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-D004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-D004-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-D004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d003_checker, "M235-D004-DEP-D003-ARG-01"),
        (args.d003_test, "M235-D004-DEP-D003-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
