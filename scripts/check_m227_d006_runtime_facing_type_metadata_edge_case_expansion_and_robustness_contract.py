#!/usr/bin/env python3
"""Fail-closed checker for M227-D006 runtime-facing type metadata edge-case expansion and robustness."""
...
MODE = "m227-d006-runtime-facing-type-metadata-edge-case-expansion-and-robustness-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_runtime_facing_type_metadata_edge_case_expansion_and_robustness_d006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_d006_runtime_facing_type_metadata_edge_case_expansion_and_robustness_packet.md"
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-D006-CFG-03", "check:objc3c:m227-d006-lane-d-readiness"),
    PackageScriptKeyCheck("M227-D006-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M227-D006-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M227-D006-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-D006-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "python scripts/check_m227_d005_runtime_facing_type_metadata_edge_case_compatibility_completion_contract.py && python -m pytest tests/tooling/test_check_m227_d005_runtime_facing_type_metadata_edge_case_compatibility_completion_contract.py -q && npm run check:objc3c:m227-d006-runtime-facing-type-metadata-edge-case-expansion-and-robustness-contract && npm run test:tooling:m227-d006-runtime-facing-type-metadata-edge-case-expansion-and-robustness-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-D006-SPC-01",
        "runtime-facing type metadata edge-case expansion and robustness governance shall preserve explicit lane-D dependency anchors (`M227-D006`, `M227-D005`)",
    ),
    SnippetCheck(
        "M227-D006-SPC-02",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-D006-META-02",
        "explicit `M227-D005` dependency continuity and fail-closed evidence continuity",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M227-D006-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M227-D006-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M227-D006-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M227-D006-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M227-D006-META-00",
