#!/usr/bin/env python3
"""Fail-closed contract checker for M244-E015 advanced core workpack (shard 1)."""
...
MODE = "m244-e015-lane-e-interop-conformance-gate-operations-advanced-core-workpack-shard1-contract-v1"

ARTIFACTS: dict[str, Path] = {
    "expectations_doc": ROOT
    / "docs"
    / "contracts"
    / "m244_lane_e_interop_conformance_gate_and_operations_advanced_core_workpack_shard1_e015_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m244"
    / "m244_e015_lane_e_interop_conformance_gate_and_operations_advanced_core_workpack_shard1_packet.md",
...
EXISTENCE_CHECK_IDS: dict[str, str] = {
    "expectations_doc": "M244-E015-DOC-EXP-EXISTS",
    "packet_doc": "M244-E015-DOC-PKT-EXISTS",
    "lowering_spec": "M244-E015-SPC-EXISTS",
    "metadata_spec": "M244-E015-META-EXISTS",
    "package_json": "M244-E015-PKG-EXISTS",
}

REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "expectations_doc": (
        (
            "M244-E015-DOC-EXP-01",
            "# M244 Lane E Interop Conformance Gate and Operations Advanced Core Workpack (shard 1) Expectations (E009)",
        ),
        (
            "M244-E015-DOC-EXP-02",
            "Contract ID: `objc3c-lane-e-interop-conformance-gate-operations-advanced-core-workpack-shard1/m244-e015-v1`",
        ),
        (
            "M244-E015-DOC-EXP-03",
            "Dependencies: `M244-E014`, `M244-A007`, `M244-B010`, `M244-C012`, `M244-D012`",
        ),
        (
            "M244-E015-DOC-EXP-04",
            "Issue `#6609` governs lane-E advanced core workpack (shard 1) scope and dependency-token/reference continuity.",
        ),
        (
            "M244-E015-DOC-EXP-05",
            "The E009 checker and readiness wiring fail close on dependency token/reference",
        ),
        (
            "M244-E015-DOC-EXP-06",
            "`npm run --if-present check:objc3c:m244-b010-lane-b-readiness`",
        ),
        (
            "M244-E015-DOC-EXP-07",
            "`npm run --if-present check:objc3c:m244-c012-lane-c-readiness`",
        ),
        (
            "M244-E015-DOC-EXP-08",
            "`npm run --if-present check:objc3c:m244-d012-lane-d-readiness`",
        ),
        (
            "M244-E015-DOC-EXP-09",
            "scripts/check_m244_e015_lane_e_interop_conformance_gate_and_operations_advanced_core_workpack_shard1_contract.py",
        ),
        (
            "M244-E015-DOC-EXP-10",
            "tests/tooling/test_check_m244_e015_lane_e_interop_conformance_gate_and_operations_advanced_core_workpack_shard1_contract.py",
        ),
        ("M244-E015-DOC-EXP-11", "`check:objc3c:m244-e009-lane-e-readiness`"),
        ("M244-E015-DOC-EXP-12", "`compile:objc3c`"),
        ("M244-E015-DOC-EXP-13", "`proof:objc3c`"),
        ("M244-E015-DOC-EXP-14", "`test:objc3c:diagnostics-replay-proof`"),
        ("M244-E015-DOC-EXP-15", "`test:objc3c:execution-replay-proof`"),
        ("M244-E015-DOC-EXP-16", "`test:objc3c:perf-budget`"),
        (
            "M244-E015-DOC-EXP-17",
            "tmp/reports/m244/M244-E015/lane_e_interop_conformance_gate_operations_conformance_matrix_implementation_summary.json",
        ),
    ),
    "packet_doc": (
        (
            "M244-E015-DOC-PKT-01",
            "# M244-E015 Lane-E Interop Conformance Gate and Operations Advanced Core Workpack (shard 1) Packet",
        ),
        ("M244-E015-DOC-PKT-02", "Packet: `M244-E015`"),
        ("M244-E015-DOC-PKT-03", "Issue: `#6609`"),
        (
            "M244-E015-DOC-PKT-04",
            "Dependencies: `M244-E014`, `M244-A007`, `M244-B010`, `M244-C012`, `M244-D012`",
        ),
        (
            "M244-E015-DOC-PKT-05",
            "docs/contracts/m244_lane_e_interop_conformance_gate_and_operations_advanced_core_workpack_shard1_e015_expectations.md",
        ),
        (
            "M244-E015-DOC-PKT-06",
            "scripts/check_m244_e015_lane_e_interop_conformance_gate_and_operations_advanced_core_workpack_shard1_contract.py",
        ),
        (
            "M244-E015-DOC-PKT-07",
            "tests/tooling/test_check_m244_e015_lane_e_interop_conformance_gate_and_operations_advanced_core_workpack_shard1_contract.py",
        ),
        (
            "M244-E015-DOC-PKT-08",
            "including code/spec anchors and milestone",
        ),
        (
            "M244-E015-DOC-PKT-09",
            "`npm run --if-present check:objc3c:m244-b010-lane-b-readiness`",
        ),
        (
            "M244-E015-DOC-PKT-10",
            "`npm run --if-present check:objc3c:m244-c012-lane-c-readiness`",
        ),
        (
            "M244-E015-DOC-PKT-11",
            "`npm run --if-present check:objc3c:m244-d012-lane-d-readiness`",
        ),
        ("M244-E015-DOC-PKT-12", "`compile:objc3c`"),
        ("M244-E015-DOC-PKT-13", "`proof:objc3c`"),
        ("M244-E015-DOC-PKT-14", "`test:objc3c:diagnostics-replay-proof`"),
        ("M244-E015-DOC-PKT-15", "`test:objc3c:execution-replay-proof`"),
        ("M244-E015-DOC-PKT-16", "`test:objc3c:perf-budget`"),
        (
            "M244-E015-DOC-PKT-17",
            "tmp/reports/m244/M244-E015/lane_e_interop_conformance_gate_operations_conformance_matrix_implementation_summary.json",
        ),
    ),
    "lowering_spec": (
    ...
    "package_json": (
        ...
        (
            ...
            '&& npm run --if-present check:objc3c:m244-c012-lane-c-readiness '
            '&& npm run --if-present check:objc3c:m244-d012-lane-d-readiness '
            '&& npm run check:objc3c:m244-e015-lane-e-interop-conformance-gate-operations-advanced-core-workpack-shard1-contract '
            '&& npm run test:tooling:m244-e015-lane-e-interop-conformance-gate-operations-advanced-core-workpack-shard1-contract"',
        ),
        (
            "M244-E015-PKG-04",
            '"compile:objc3c": ',
