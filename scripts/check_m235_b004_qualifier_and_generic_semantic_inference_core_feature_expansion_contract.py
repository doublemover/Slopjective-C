#!/usr/bin/env python3
"""Fail-closed checker for M235-B004 qualifier/generic semantic inference core feature expansion."""
...
MODE = "m235-b004-qualifier-and-generic-semantic-inference-core-feature-expansion-contract-v1"
...
DEFAULT_B003_CHECKER = (
    ROOT / "scripts" / "check_m235_b003_qualifier_and_generic_semantic_inference_core_feature_implementation_contract.py"
)
DEFAULT_B003_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_b003_qualifier_and_generic_semantic_inference_core_feature_implementation_contract.py"
)
...
B003_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B004-B003-PKT-01", "Packet: `M235-B003`"),
    SnippetCheck("M235-B004-B003-PKT-02", "Dependencies: `M235-B002`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B004-META-02",
        "explicit `M235-B003` dependency continuity so core feature expansion drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B004-PKG-03",
        '"check:objc3c:m235-b004-lane-b-readiness": '
        '"npm run check:objc3c:m235-b003-lane-b-readiness '
        '&& npm run check:objc3c:m235-b004-qualifier-and-generic-semantic-inference-core-feature-expansion-contract '
        '&& npm run test:tooling:m235-b004-qualifier-and-generic-semantic-inference-core-feature-expansion-contract"',
    ),
    SnippetCheck("M235-B004-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B004-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b003_expectations_doc, "M235-B004-B003-DOC-EXISTS", B003_EXPECTATIONS_SNIPPETS),
        (args.b003_packet_doc, "M235-B004-B003-PKT-EXISTS", B003_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B004-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b003_checker, "M235-B004-DEP-B003-ARG-01"),
        (args.b003_test, "M235-B004-DEP-B003-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
