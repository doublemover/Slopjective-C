#!/usr/bin/env python3
"""Fail-closed checker for M230-B001 CI matrix simplification/flake elimination contract freeze."""
...
MODE = "m230-b001-ci-matrix-simplification-and-flake-elimination-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_b001_ci_matrix_simplification_and_flake_elimination_contract_and_architecture_freeze_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-B001-DOC-EXP-01",
        "# M230 Conformance Corpus Governance and Sharding Contract and Architecture Freeze Expectations (A001)",
    ),
    SnippetCheck(
        "M230-B001-DOC-EXP-02",
        "Contract ID: `objc3c-ci-matrix-simplification-and-flake-elimination/m230-b001-v1`",
    ),
    SnippetCheck("M230-B001-DOC-EXP-03", "Issue: `#5395`"),
    SnippetCheck("M230-B001-DOC-EXP-04", "Dependencies: none"),
    SnippetCheck(
        "M230-B001-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-B001-DOC-EXP-06",
        "`check:objc3c:m230-b001-lane-b-readiness`",
    ),
    SnippetCheck(
        "M230-B001-DOC-EXP-07",
        "`tmp/reports/m230/M230-B001/ci_matrix_simplification_and_flake_elimination_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-B001-DOC-PKT-01",
        "# M230-B001 Conformance Corpus Governance and Sharding Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-B001-DOC-PKT-02", "Packet: `M230-B001`"),
    SnippetCheck("M230-B001-DOC-PKT-03", "Issue: `#5395`"),
    SnippetCheck("M230-B001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M230-B001-DOC-PKT-05",
        "check:objc3c:m230-b001-ci-matrix-simplification-and-flake-elimination-contract",
    ),
    SnippetCheck(
        "M230-B001-DOC-PKT-06",
        "tmp/reports/m230/M230-B001/ci_matrix_simplification_and_flake_elimination_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-B001-PKG-03",
        '"check:objc3c:m230-b001-lane-b-readiness": '
        '"npm run check:objc3c:m230-b001-ci-matrix-simplification-and-flake-elimination-contract '
        '&& npm run test:tooling:m230-b001-ci-matrix-simplification-and-flake-elimination-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-B001-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-B001-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-B001-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-B001-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-B001-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-B001-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
