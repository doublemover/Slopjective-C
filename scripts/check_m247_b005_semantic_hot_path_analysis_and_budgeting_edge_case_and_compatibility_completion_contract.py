#!/usr/bin/env python3
"""Fail-closed checker for M247-B005 semantic hot-path edge-case and compatibility completion."""
...
MODE = "m247-b005-semantic-hot-path-analysis-and-budgeting-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_B004_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m247_semantic_hot_path_analysis_and_budgeting_core_feature_expansion_b004_expectations.md"
)
DEFAULT_B004_PACKET_DOC = (
    ...
    / "compiler"
    / "m247"
    / "m247_b004_semantic_hot_path_analysis_and_budgeting_core_feature_expansion_packet.md"
)
...
DEFAULT_B004_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m247_b004_semantic_hot_path_analysis_and_budgeting_core_feature_expansion_contract.py"
)
DEFAULT_B004_READINESS_RUNNER = ROOT / "scripts" / "run_m247_b004_lane_b_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m247_b005_lane_b_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B005-DOC-PKT-01",
        "# M247-B005 Semantic Hot-Path Analysis and Budgeting Edge-Case and Compatibility Completion Packet",
    ),
    SnippetCheck("M247-B005-DOC-PKT-02", "Packet: `M247-B005`"),
    SnippetCheck("M247-B005-DOC-PKT-03", "Issue: `#6728`"),
    SnippetCheck("M247-B005-DOC-PKT-04", "Dependencies: `M247-B004`"),
    SnippetCheck("M247-B005-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-B005-DOC-PKT-06",
        "`scripts/check_m247_b005_semantic_hot_path_analysis_and_budgeting_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M247-B005-DOC-PKT-07",
        "`tests/tooling/test_check_m247_b005_semantic_hot_path_analysis_and_budgeting_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M247-B005-DOC-PKT-08",
        "`scripts/run_m247_b005_lane_b_readiness.py`",
    ),
    SnippetCheck(
        "M247-B005-DOC-PKT-09",
        "`B004 readiness -> B005 checker -> B005 pytest`",
    ),
    SnippetCheck(
        "M247-B005-DOC-PKT-10",
        "tmp/reports/m247/M247-B005/semantic_hot_path_analysis_and_budgeting_edge_case_and_compatibility_completion_contract_summary.json",
    ),
)
...
B004_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B005-B004-DOC-01",
        "Contract ID: `objc3c-semantic-hot-path-analysis-and-budgeting-core-feature-expansion/m247-b004-v1`",
    ),
    SnippetCheck("M247-B005-B004-DOC-02", "Dependencies: `M247-B003`"),
    SnippetCheck(
        "M247-B005-B004-DOC-03",
        "Issue `#6727` defines canonical lane-B core feature expansion scope.",
    ),
)

B004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B005-B004-PKT-01", "Packet: `M247-B004`"),
    SnippetCheck("M247-B005-B004-PKT-02", "Issue: `#6727`"),
    SnippetCheck("M247-B005-B004-PKT-03", "Dependencies: `M247-B003`"),
    SnippetCheck("M247-B005-B004-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B005-RUN-01", 'DEPENDENCY_TOKEN = "M247-B004"'),
    SnippetCheck("M247-B005-RUN-02", "scripts/run_m247_b004_lane_b_readiness.py"),
    SnippetCheck("M247-B005-RUN-03", "[ok] M247-B005 lane-B readiness chain completed"),
)

B004_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B005-B004-RUN-01", 'DEPENDENCY_TOKEN = "M247-B003"'),
    SnippetCheck(
        "M247-B005-B004-RUN-02",
        "scripts/check_m247_b004_semantic_hot_path_analysis_and_budgeting_core_feature_expansion_contract.py",
    ),
    SnippetCheck("M247-B005-B004-RUN-03", "[ok] M247-B004 lane-B readiness chain completed"),
)

PACKAGE_JSON_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B005-PKG-01",
        '"check:objc3c:m247-b005-semantic-hot-path-analysis-and-budgeting-edge-case-and-compatibility-completion-contract": '
    ...
    SnippetCheck(
        "M247-B005-PKG-02",
        '"test:tooling:m247-b005-semantic-hot-path-analysis-and-budgeting-edge-case-and-compatibility-completion-contract": '
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--b004-readiness-runner", type=Path, default=DEFAULT_B004_READINESS_RUNNER)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-B005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-B005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b004_expectations_doc, "M247-B005-B004-DOC-EXISTS", B004_EXPECTATIONS_SNIPPETS),
        (args.b004_packet_doc, "M247-B005-B004-PKT-EXISTS", B004_PACKET_SNIPPETS),
        (args.readiness_runner, "M247-B005-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.b004_readiness_runner, "M247-B005-B004-RUN-EXISTS", B004_READINESS_SNIPPETS),
        (args.package_json, "M247-B005-PKG-EXISTS", PACKAGE_JSON_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b004_checker, "M247-B005-DEP-B004-ARG-01"),
        (args.b004_test, "M247-B005-DEP-B004-ARG-02"),
    ):
    ...
    if not wrote_summary:
        print(
            f"[M247-B005-SUMMARY-WRITE-01] {display_path(summary_path)}: {error_message}",
            file=sys.stderr,
        )
        return 1
