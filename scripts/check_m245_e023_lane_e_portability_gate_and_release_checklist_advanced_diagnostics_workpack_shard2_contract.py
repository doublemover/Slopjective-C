#!/usr/bin/env python3
"""Fail-closed checker for M245-E023 portability gate/release checklist advanced performance workpack shard 1."""
...
MODE = "m245-e023-lane-e-portability-gate-release-checklist-advanced-diagnostics-workpack-shard2-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_lane_e_portability_gate_and_release_checklist_advanced_diagnostics_workpack_shard2_e023_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_e023_lane_e_portability_gate_and_release_checklist_advanced_diagnostics_workpack_shard2_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M245-E023-DEP-E019-02",
        "M245-E022",
        Path("spec/planning/compiler/m245/m245_e022_lane_e_portability_gate_and_release_checklist_advanced_edge_compatibility_workpack_shard2_packet.md"),
    ),
    AssetCheck(
        "M245-E023-DEP-E019-03",
        "M245-E022",
        Path("scripts/check_m245_e022_lane_e_portability_gate_and_release_checklist_advanced_edge_compatibility_workpack_shard2_contract.py"),
    ),
    AssetCheck(
        "M245-E023-DEP-E019-04",
        "M245-E022",
        Path("tests/tooling/test_check_m245_e022_lane_e_portability_gate_and_release_checklist_advanced_edge_compatibility_workpack_shard2_contract.py"),
    ),
    AssetCheck(
        "M245-E023-DEP-A008-01",
        "M245-A008",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-E023-DOC-EXP-07",
        "scripts/check_m245_a008_frontend_behavior_parity_across_toolchains_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M245-E023-DOC-EXP-08",
        "scripts/check_m245_b009_semantic_parity_and_platform_constraints_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M245-E023-DOC-EXP-09",
        "scripts/check_m245_c011_lowering_ir_portability_contracts_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M245-E023-DOC-EXP-10",
        "scripts/check_m245_d014_build_link_runtime_reproducibility_operations_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck(
        "M245-E023-DOC-EXP-11",
        "advanced diagnostics workpack (shard 2) traceability, and milestone optimization inputs as mandatory scope inputs.",
    ),
    SnippetCheck("M245-E023-DOC-EXP-12", "`check:objc3c:m245-e019-lane-e-readiness`"),
    SnippetCheck("M245-E023-DOC-EXP-13", "`check:objc3c:m245-a008-lane-a-readiness`"),
    SnippetCheck("M245-E023-DOC-EXP-14", "`check:objc3c:m245-b009-lane-b-readiness`"),
    SnippetCheck("M245-E023-DOC-EXP-15", "`check:objc3c:m245-c011-lane-c-readiness`"),
    SnippetCheck("M245-E023-DOC-EXP-16", "`check:objc3c:m245-d014-lane-d-readiness`"),
    SnippetCheck(
        "M245-E023-DOC-EXP-17",
        "`scripts/check_m245_e023_lane_e_portability_gate_and_release_checklist_advanced_diagnostics_workpack_shard2_contract.py`",
    ),
    SnippetCheck(
        "M245-E023-DOC-EXP-18",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-E023-DOC-PKT-01",
        "# M245-E023 Lane-E Portability Gate and Release Checklist Advanced Diagnostics Workpack (Shard 2) Packet",
    ),
    SnippetCheck("M245-E023-DOC-PKT-02", "Packet: `M245-E023`"),
    SnippetCheck("M245-E023-DOC-PKT-03", "Issue: `#5041`"),
    SnippetCheck(
        "M245-E023-DOC-PKT-04",
        "Dependencies: `M245-E022`, `M245-A008`, `M245-B009`, `M245-C011`, `M245-D014`",
    ),
    SnippetCheck("M245-E023-DOC-PKT-05", "Predecessor: `M245-E022`"),
    SnippetCheck("M245-E023-DOC-PKT-06", "Theme: advanced diagnostics workpack (shard 2)"),
    SnippetCheck(
        "M245-E023-DOC-PKT-07",
    ...
    SnippetCheck(
        "M245-E023-DOC-PKT-08",
        "scripts/check_m245_e023_lane_e_portability_gate_and_release_checklist_advanced_diagnostics_workpack_shard2_contract.py",
    ),
    SnippetCheck(
        "M245-E023-DOC-PKT-09",
        "tests/tooling/test_check_m245_e023_lane_e_portability_gate_and_release_checklist_advanced_diagnostics_workpack_shard2_contract.py",
    ),
    SnippetCheck(
        "M245-E023-DOC-PKT-10",
    ...
    SnippetCheck("M245-E023-DOC-PKT-11", "check:objc3c:m245-e019-lane-e-readiness"),
    SnippetCheck("M245-E023-DOC-PKT-12", "check:objc3c:m245-a008-lane-a-readiness"),
    SnippetCheck("M245-E023-DOC-PKT-13", "check:objc3c:m245-b009-lane-b-readiness"),
    SnippetCheck("M245-E023-DOC-PKT-14", "check:objc3c:m245-c011-lane-c-readiness"),
    SnippetCheck("M245-E023-DOC-PKT-15", "check:objc3c:m245-d014-lane-d-readiness"),
    SnippetCheck(
        "M245-E023-DOC-PKT-16",
        "tmp/reports/m245/M245-E023/lane_e_portability_gate_release_checklist_advanced_performance_workpack_shard1_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-E023-PKG-01", '"check:objc3c:m245-e019-lane-e-readiness": '),
    SnippetCheck("M245-E023-PKG-02", '"check:objc3c:m245-a008-lane-a-readiness": '),
    SnippetCheck("M245-E023-PKG-03", '"check:objc3c:m245-b009-lane-b-readiness": '),
    SnippetCheck("M245-E023-PKG-04", '"check:objc3c:m245-c011-lane-c-readiness": '),
    SnippetCheck("M245-E023-PKG-05", '"check:objc3c:m245-d014-lane-d-readiness": '),
    SnippetCheck("M245-E023-PKG-06", '"compile:objc3c": '),
    SnippetCheck("M245-E023-PKG-07", '"proof:objc3c": '),
    SnippetCheck("M245-E023-PKG-08", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-E023-PKG-09", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-E023-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-E023-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M245-E023-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
