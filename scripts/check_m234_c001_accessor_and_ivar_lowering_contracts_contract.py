#!/usr/bin/env python3
"""Fail-closed contract checker for the M234-C001 accessor/ivar lowering freeze."""
...
MODE = "m234-c001-accessor-and-ivar-lowering-contracts-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-C001-DOC-PKT-01",
        "# M234-C001 Accessor and Ivar Lowering Contracts Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M234-C001-DOC-PKT-02", "Packet: `M234-C001`"),
    SnippetCheck("M234-C001-DOC-PKT-03", "Issue: `#5719`"),
    SnippetCheck("M234-C001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M234-C001-DOC-PKT-05",
        "`check:objc3c:m234-c001-accessor-and-ivar-lowering-contracts-contract-and-architecture-freeze-contract`",
    ),
    SnippetCheck("M234-C001-DOC-PKT-06", "`compile:objc3c`"),
    SnippetCheck("M234-C001-DOC-PKT-07", "`proof:objc3c`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-C001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-C001-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-C001-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-C001-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-C001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-C001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M234-C001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-C001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-C001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-C001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
