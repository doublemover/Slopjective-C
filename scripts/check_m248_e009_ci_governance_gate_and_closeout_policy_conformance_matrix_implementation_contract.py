#!/usr/bin/env python3
"""Fail-closed checker for M248-E009 lane-E CI governance gate/closeout policy conformance matrix implementation."""
...
MODE = "m248-e009-lane-e-ci-governance-gate-closeout-policy-conformance-matrix-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_lane_e_ci_governance_gate_and_closeout_policy_conformance_matrix_implementation_e009_expectations.md"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-E009-PKG-03",
        '"check:objc3c:m248-e009-lane-e-readiness": '
        ...
        '&& npm run test:tooling:m248-e009-ci-governance-gate-closeout-policy-conformance-matrix-implementation-contract"',
    ),
    SnippetCheck("M248-E009-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M248-E009-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M248-E009-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M248-E009-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-E009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.package_json, "M248-E009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
