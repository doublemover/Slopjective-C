#!/usr/bin/env python3
"""Fail-closed checker for M247-C015 lowering/codegen advanced core workpack shard 1."""
...
MODE = "m247-c015-lowering-codegen-cost-profiling-controls-advanced-core-workpack-shard-1-contract-v1"
...
DEFAULT_C014_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c014_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c015_lane_c_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M247-C015-OWN-03",
        Path("scripts/check_m247_c015_lowering_codegen_cost_profiling_and_controls_advanced_core_workpack_shard_1_contract.py"),
    ),
    AssetCheck(
        "M247-C015-OWN-04",
        Path(
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-C015-DOC-EXP-11",
        "Code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C015-DOC-EXP-12",
        "tmp/reports/m247/M247-C015/lowering_codegen_cost_profiling_and_controls_advanced_core_workpack_shard_1_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C015-DOC-PKT-01",
        "# M247-C015 Lowering/Codegen Cost Profiling and Controls Advanced Core Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M247-C015-DOC-PKT-02", "Packet: `M247-C015`"),
    SnippetCheck("M247-C015-DOC-PKT-03", "Issue: `#6756`"),
    SnippetCheck("M247-C015-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M247-C015-DOC-PKT-05", "Dependencies: `M247-C014`"),
    SnippetCheck(
        "M247-C015-DOC-PKT-06",
        "Predecessor anchors inherited via `M247-C014`: `M247-C001`, `M247-C002`, `M247-C003`, `M247-C004`, `M247-C005`, `M247-C006`, `M247-C007`, `M247-C008`, `M247-C009`, `M247-C010`, `M247-C011`, `M247-C012`, `M247-C013`.",
    ),
    SnippetCheck(
        "M247-C015-DOC-PKT-07",
        "scripts/check_m247_c015_lowering_codegen_cost_profiling_and_controls_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M247-C015-DOC-PKT-08",
        "tests/tooling/test_check_m247_c015_lowering_codegen_cost_profiling_and_controls_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M247-C015-DOC-PKT-09",
        "scripts/run_m247_c015_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M247-C015-DOC-PKT-10",
        "scripts/run_m247_c014_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M247-C015-DOC-PKT-11",
        "treated as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C015-DOC-PKT-12",
        "tmp/reports/m247/M247-C015/lowering_codegen_cost_profiling_and_controls_advanced_core_workpack_shard_1_summary.json",
    ),
)
...
C014_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C015-C014-PKT-01", "Packet: `M247-C014`"),
    SnippetCheck("M247-C015-C014-PKT-02", "Issue: `#6755`"),
    SnippetCheck("M247-C015-C014-PKT-03", "Dependencies: `M247-C013`"),
    SnippetCheck("M247-C015-C014-PKT-04", "scripts/run_m247_c014_lane_c_readiness.py"),
    SnippetCheck("M247-C015-C014-PKT-05", "scripts/run_m247_c013_lane_c_readiness.py"),
)

C014_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C015-C014-RUN-01",
        "scripts/run_m247_c013_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M247-C015-C014-RUN-02",
        "scripts/check_m247_c014_lowering_codegen_cost_profiling_and_controls_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck(
        "M247-C015-C014-RUN-03",
        "tests/tooling/test_check_m247_c014_lowering_codegen_cost_profiling_and_controls_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck(
        "M247-C015-C014-RUN-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-C015-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M247-C015-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M247-C015-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M247-C015-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-C015-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-C015-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c014_expectations_doc, "M247-C015-C014-EXP-EXISTS", C014_EXPECTATIONS_SNIPPETS),
        (args.c014_packet_doc, "M247-C015-C014-PKT-EXISTS", C014_PACKET_SNIPPETS),
        (args.c014_readiness_script, "M247-C015-C014-RUN-EXISTS", C014_READINESS_SNIPPETS),
        (args.readiness_script, "M247-C015-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M247-C015-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
