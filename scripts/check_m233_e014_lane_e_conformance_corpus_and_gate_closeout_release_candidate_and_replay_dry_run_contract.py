#!/usr/bin/env python3
"""Fail-closed checker for M233-E014 conformance corpus and gate closeout release-candidate and replay dry-run."""
...
MODE = "m233-e014-lane-e-conformance-corpus-gate-closeout-release-candidate-and-replay-dry-run-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_lane_e_conformance_corpus_and_gate_closeout_release_candidate_and_replay_dry_run_e014_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_e014_lane_e_conformance_corpus_and_gate_closeout_release_candidate_and_replay_dry_run_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E014-DOC-PKT-01",
        "# M233-E014 Lane-E Conformance Corpus and Gate Closeout Release-Candidate and Replay Dry-Run Packet",
    ),
    SnippetCheck("M233-E014-DOC-PKT-02", "Packet: `M233-E014`"),
    SnippetCheck("M233-E014-DOC-PKT-03", "Issue: `#5667`"),
    SnippetCheck(
        "M233-E014-DOC-PKT-04",
        "Dependencies: `M233-E013`, `M233-A010`, `M233-B014`, `M233-C018`, `M233-D023`",
    ),
    SnippetCheck("M233-E014-DOC-PKT-05", "Predecessor: `M233-E013`"),
    SnippetCheck("M233-E014-DOC-PKT-06", "Theme: release-candidate and replay dry-run"),
    SnippetCheck(
        "M233-E014-DOC-PKT-07",
    ...
    SnippetCheck(
        "M233-E014-DOC-PKT-08",
        "scripts/check_m233_e014_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M233-E014-DOC-PKT-09",
        "tests/tooling/test_check_m233_e014_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M233-E014-DOC-PKT-10",
    ...
    SnippetCheck(
        "M233-E014-DOC-PKT-11",
        "release-candidate and replay dry-run traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E014-DOC-PKT-12",
        "tmp/reports/m233/M233-E014/lane_e_conformance_corpus_gate_closeout_release_candidate_and_replay_dry_run_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-E014-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M233-E014-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M233-E014-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-E014-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-E014-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-E014-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M233-E014-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
