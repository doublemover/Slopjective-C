#!/usr/bin/env python3
"""Fail-closed checker for M246-C003 IR optimization pass wiring core feature implementation."""
...
MODE = "m246-c003-ir-optimization-pass-wiring-validation-core-feature-implementation-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c003_lane_c_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-C003-DOC-PKT-06",
        "scripts/check_m246_c003_ir_optimization_pass_wiring_and_validation_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M246-C003-DOC-PKT-07",
        "tests/tooling/test_check_m246_c003_ir_optimization_pass_wiring_and_validation_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M246-C003-DOC-PKT-08",
        "scripts/run_m246_c003_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C003-DOC-PKT-09",
        "m246_c002_ir_optimization_pass_wiring_and_validation_modular_split_scaffolding_packet.md",
    ),
    SnippetCheck(
        "M246-C003-DOC-PKT-10",
        "treated as mandatory scope",
    ),
    SnippetCheck(
        "M246-C003-DOC-PKT-11",
        "tmp/reports/m246/M246-C003/ir_optimization_pass_wiring_validation_core_feature_implementation_summary.json",
    ),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C003-C001-02", "Dependencies: none"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C003-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-C003-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-C003-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C003-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M246-C003-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M246-C003-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.readiness_script, "M246-C003-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M246-C003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
