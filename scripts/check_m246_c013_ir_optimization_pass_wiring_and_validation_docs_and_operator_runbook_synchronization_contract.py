#!/usr/bin/env python3
"""Fail-closed checker for M246-C013 IR optimization pass wiring docs/runbook synchronization."""
...
MODE = "m246-c013-ir-optimization-pass-wiring-validation-docs-and-operator-runbook-synchronization-contract-v1"
...
DEFAULT_C012_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m246_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_c012_expectations.md"
)
DEFAULT_C012_PACKET_DOC = (
    ...
    / "compiler"
    / "m246"
    / "m246_c012_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_packet.md"
)
DEFAULT_C012_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c012_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c013_lane_c_readiness.py"
DEFAULT_PACKAGE_JSON = ROOT / "package.json"
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m246/M246-C013/ir_optimization_pass_wiring_validation_docs_and_operator_runbook_synchronization_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M246-C013-DEP-C002-03",
        Path("scripts/check_m246_c002_ir_optimization_pass_wiring_and_validation_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-C013-DEP-C002-04",
        Path("tests/tooling/test_check_m246_c002_ir_optimization_pass_wiring_and_validation_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-C013-DEP-C012-01",
        Path("docs/contracts/m246_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_c012_expectations.md"),
    ),
    AssetCheck(
        "M246-C013-DEP-C012-02",
        Path("spec/planning/compiler/m246/m246_c012_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_packet.md"),
    ),
    AssetCheck(
        "M246-C013-DEP-C012-03",
        Path("scripts/check_m246_c012_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_contract.py"),
    ),
    AssetCheck(
        "M246-C013-DEP-C012-04",
        Path("tests/tooling/test_check_m246_c012_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_contract.py"),
    ),
    AssetCheck(
        "M246-C013-DEP-C012-05",
        Path("scripts/run_m246_c012_lane_c_readiness.py"),
    ),
    AssetCheck(
        "M246-C013-OWN-01",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C013-DOC-EXP-01",
        "# M246 IR Optimization Pass Wiring and Validation Docs and Operator Runbook Synchronization Expectations (C013)",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-02",
        "Contract ID: `objc3c-ir-optimization-pass-wiring-validation-docs-and-operator-runbook-synchronization/m246-c013-v1`",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-03",
        "Issue `#5089` defines canonical lane-C docs and operator runbook synchronization scope.",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-04",
        "Dependencies: `M246-C012`",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-05",
        "Predecessor anchors inherited via `M246-C012`: `M246-C001`, `M246-C002`, `M246-C003`, `M246-C004`, `M246-C005`, `M246-C006`, `M246-C007`, `M246-C008`, `M246-C009`, `M246-C010`, `M246-C011`.",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-06",
        "docs/contracts/m246_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_c012_expectations.md",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-07",
        "scripts/run_m246_c012_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-08",
        "scripts/check_m246_c013_ir_optimization_pass_wiring_and_validation_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-09",
    ...
    SnippetCheck(
        "M246-C013-DOC-EXP-10",
        "improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-C013-DOC-EXP-11",
        "tmp/reports/m246/M246-C013/ir_optimization_pass_wiring_validation_docs_and_operator_runbook_synchronization_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C013-DOC-PKT-01",
        "# M246-C013 IR Optimization Pass Wiring and Validation Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M246-C013-DOC-PKT-02", "Packet: `M246-C013`"),
    SnippetCheck("M246-C013-DOC-PKT-03", "Issue: `#5089`"),
    SnippetCheck("M246-C013-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-C013-DOC-PKT-05", "Dependencies: `M246-C012`"),
    SnippetCheck(
        "M246-C013-DOC-PKT-06",
        "Predecessor anchors inherited via `M246-C012`: `M246-C001`, `M246-C002`, `M246-C003`, `M246-C004`, `M246-C005`, `M246-C006`, `M246-C007`, `M246-C008`, `M246-C009`, `M246-C010`, `M246-C011`.",
    ),
    SnippetCheck(
        "M246-C013-DOC-PKT-07",
        "scripts/check_m246_c013_ir_optimization_pass_wiring_and_validation_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M246-C013-DOC-PKT-08",
        "tests/tooling/test_check_m246_c013_ir_optimization_pass_wiring_and_validation_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M246-C013-DOC-PKT-09",
        "scripts/run_m246_c013_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C013-DOC-PKT-10",
        "scripts/run_m246_c012_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C013-DOC-PKT-11",
        "treated as mandatory scope",
    ),
    SnippetCheck(
        "M246-C013-DOC-PKT-12",
        "tmp/reports/m246/M246-C013/ir_optimization_pass_wiring_validation_docs_and_operator_runbook_synchronization_summary.json",
    ),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C013-C001-02", "Dependencies: none"),
)
...
C012_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C013-C012-EXP-01",
        "Contract ID: `objc3c-ir-optimization-pass-wiring-validation-cross-lane-integration-sync/m246-c012-v1`",
    ),
    SnippetCheck(
        "M246-C013-C012-EXP-02",
        "Dependencies: `M246-C011`",
    ),
    SnippetCheck(
        "M246-C013-C012-EXP-03",
        "scripts/run_m246_c012_lane_c_readiness.py",
    ),
)

C012_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-C013-C012-PKT-01", "Packet: `M246-C012`"),
    SnippetCheck("M246-C013-C012-PKT-02", "Dependencies: `M246-C011`"),
    SnippetCheck("M246-C013-C012-PKT-03", "scripts/run_m246_c012_lane_c_readiness.py"),
)

C012_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C013-C012-RUN-01",
        "scripts/run_m246_c011_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C013-C012-RUN-02",
        "scripts/check_m246_c012_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M246-C013-C012-RUN-03",
        "tests/tooling/test_check_m246_c012_ir_optimization_pass_wiring_and_validation_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M246-C013-C012-RUN-04",
        "[ok] M246-C012 lane-C readiness chain completed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C013-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-C013-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-C013-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C013-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c012-readiness-script", type=Path, default=DEFAULT_C012_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M246-C013-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M246-C013-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.c012_expectations_doc, "M246-C013-C012-EXP-EXISTS", C012_EXPECTATIONS_SNIPPETS),
        (args.c012_packet_doc, "M246-C013-C012-PKT-EXISTS", C012_PACKET_SNIPPETS),
        (args.c012_readiness_script, "M246-C013-C012-RUN-EXISTS", C012_READINESS_SNIPPETS),
        (args.readiness_script, "M246-C013-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M246-C013-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
