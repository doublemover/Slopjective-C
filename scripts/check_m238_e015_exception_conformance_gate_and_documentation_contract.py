#!/usr/bin/env python3
"""Fail-closed checker for M238-E015 exception conformance gate and documentation contract freeze."""
...
MODE = "m238-e015-exception-conformance-gate-and-documentation-integration-closeout-and-gate-sign-off-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m238_exception_conformance_gate_and_documentation_integration_closeout_and_gate_sign_off_e015_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
...
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m238/M238-E015/local_check_summary.json")
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M238-E015-DOC-EXP-01",
        "# M238 Exception conformance gate and documentation Integration Closeout and Gate Sign-off Expectations (E015)",
    ),
    SnippetCheck(
        "M238-E015-DOC-EXP-02",
        "Contract ID: `objc3c-exception-conformance-gate-and-documentation-integration-closeout-and-gate-sign-off/m238-e015-v1`",
    ),
    SnippetCheck("M238-E015-DOC-EXP-03", "Issue: `#6129`"),
    SnippetCheck(
        "M238-E015-DOC-EXP-04",
        "Dependencies: `M238-A001`, `M238-B001`, `M238-C001`",
    ),
    SnippetCheck(
        "M238-E015-DOC-EXP-05",
        "currently-closed early lane steps",
    ),
    SnippetCheck("M238-E015-DOC-EXP-06", "| `M238-A001` |"),
    SnippetCheck("M238-E015-DOC-EXP-07", "| `M238-B001` |"),
    SnippetCheck("M238-E015-DOC-EXP-08", "| `M238-C001` |"),
    SnippetCheck(
        "M238-E015-DOC-EXP-09",
        "scripts/check_m238_e015_exception_conformance_gate_and_documentation_contract.py",
    ),
    SnippetCheck(
        "M238-E015-DOC-EXP-10",
        "tests/tooling/test_check_m238_e015_exception_conformance_gate_and_documentation_contract.py",
    ),
    SnippetCheck(
        "M238-E015-DOC-EXP-11",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M238-E015-DOC-PKT-01",
        "# M238-E015 Exception conformance gate and documentation Integration Closeout and Gate Sign-off Packet",
    ),
    SnippetCheck("M238-E015-DOC-PKT-02", "Packet: `M238-E015`"),
    SnippetCheck("M238-E015-DOC-PKT-03", "Issue: `#6129`"),
    SnippetCheck(
        "M238-E015-DOC-PKT-04",
        "Dependencies: `M238-A001`, `M238-B001`, `M238-C001`",
    ),
    SnippetCheck(
        "M238-E015-DOC-PKT-05",
        "currently-closed early lane steps",
    ),
    SnippetCheck(
        "M238-E015-DOC-PKT-06",
    ...
    SnippetCheck(
        "M238-E015-DOC-PKT-07",
        "scripts/check_m238_e015_exception_conformance_gate_and_documentation_contract.py",
    ),
    SnippetCheck(
        "M238-E015-DOC-PKT-08",
        "tests/tooling/test_check_m238_e015_exception_conformance_gate_and_documentation_contract.py",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M238-E015-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M238-E015-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
