#!/usr/bin/env python3
"""Fail-closed checker for M230-D008 Developer CLI and diagnostics ergonomics contract freeze."""
...
MODE = "m230-d008-developer-cli-and-diagnostics-ergonomics-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_d008_developer_cli_and_diagnostics_ergonomics_recovery_and_determinism_hardening_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-D008-DOC-PKT-01",
        "# M230-D008 Developer CLI and diagnostics ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-D008-DOC-PKT-02", "Packet: `M230-D008`"),
    SnippetCheck("M230-D008-DOC-PKT-03", "Issue: `#5447`"),
    SnippetCheck("M230-D008-DOC-PKT-04", "Dependencies: `M230-D007`"),
    SnippetCheck(
        "M230-D008-DOC-PKT-05",
        "check:objc3c:m230-d008-developer-cli-and-diagnostics-ergonomics-recovery-and-determinism-hardening-contract",
    ),
    SnippetCheck(
        "M230-D008-DOC-PKT-06",
        "tmp/reports/m230/M230-D008/developer_cli_and_diagnostics_ergonomics_recovery_and_determinism_hardening_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-D008-PKG-03",
        '"check:objc3c:m230-d008-lane-d-readiness": '
        '"npm run check:objc3c:m230-d007-lane-d-readiness && npm run check:objc3c:m230-d008-developer-cli-and-diagnostics-ergonomics-recovery-and-determinism-hardening-contract '
        '&& npm run test:tooling:m230-d008-developer-cli-and-diagnostics-ergonomics-recovery-and-determinism-hardening-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-D008-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-D008-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-D008-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-D008-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-D008-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-D008-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
