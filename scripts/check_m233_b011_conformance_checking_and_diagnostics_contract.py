#!/usr/bin/env python3
"""Fail-closed checker for M233-B011 conformance checking and diagnostics contract freeze."""
...
MODE = "m233-b011-conformance-checking-and-diagnostics-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_b011_conformance_checking_and_diagnostics_performance_and_quality_guardrails_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-B011-DOC-PKT-01",
        "# M233-B011 Conformance checking and diagnostics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M233-B011-DOC-PKT-02", "Packet: `M233-B011`"),
    SnippetCheck("M233-B011-DOC-PKT-03", "Issue: `#4919`"),
    SnippetCheck("M233-B011-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M233-B011-DOC-PKT-05",
        "check:objc3c:m233-b011-conformance-checking-and-diagnostics-contract",
    ),
    SnippetCheck(
        "M233-B011-DOC-PKT-06",
        "tmp/reports/m233/M233-B011/conformance_checking_and_diagnostics_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-B011-PKG-03",
        '"check:objc3c:m233-b011-lane-b-readiness": '
        '"npm run check:objc3c:m233-b011-conformance-checking-and-diagnostics-contract '
        '&& npm run test:tooling:m233-b011-conformance-checking-and-diagnostics-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M233-B011-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M233-B011-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M233-B011-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M233-B011-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M233-B011-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M233-B011-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
