param(
  [string]$ReportRoot = "tmp/reports/m226/M226-A025"
)
...
$upstream = @(
  @{ packet = "A021"; path = "tmp/reports/m226/M226-A021/parser_advanced_core_workpack_summary.json" },
  @{ packet = "A022"; path = "tmp/reports/m226/M226-A022/parser_advanced_edge_compat_workpack_summary.json" },
  @{ packet = "A023"; path = "tmp/reports/m226/M226-A023/parser_advanced_diagnostics_workpack_summary.json" },
  @{ packet = "A024"; path = "tmp/reports/m226/M226-A024/parser_conformance_shard2_summary.json" }
)
...
$summary = [ordered]@{
  contract_id = "objc3c-parser-advanced-integration-workpack-contract/m226-a025-v1"
