#!/usr/bin/env python3
"""Fail-closed contract checker for M247-B011 semantic hot-path performance and quality guardrails."""
...
MODE = "m247-b011-semantic-hot-path-analysis-budgeting-performance-and-quality-guardrails-contract-v1"
...
DEFAULT_B010_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m247_b010_semantic_hot_path_analysis_and_budgeting_conformance_corpus_expansion_contract.py"
)
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m247_b011_lane_b_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B011-DOC-EXP-01",
        "# M247 Semantic Hot-Path Analysis and Budgeting Performance and Quality Guardrails Expectations (B011)",
    ),
    SnippetCheck(
        "M247-B011-DOC-EXP-02",
        "Contract ID: `objc3c-semantic-hot-path-analysis-and-budgeting-performance-and-quality-guardrails/m247-b011-v1`",
    ),
    SnippetCheck("M247-B011-DOC-EXP-03", "Dependencies: `M247-B010`"),
    SnippetCheck(
        "M247-B011-DOC-EXP-04",
        "Issue `#6734` defines canonical lane-B performance and quality guardrails scope.",
    ),
    SnippetCheck("M247-B011-DOC-EXP-05", "performance and quality guardrails governance"),
    SnippetCheck(
        "M247-B011-DOC-EXP-06",
        "performance and quality guardrails budgeting continuity",
    ),
    SnippetCheck("M247-B011-DOC-EXP-07", "Performance profiling and compile-time budgets."),
    SnippetCheck(
        "M247-B011-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-B011-DOC-EXP-09",
        "`scripts/check_m247_b010_semantic_hot_path_analysis_and_budgeting_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M247-B011-DOC-EXP-10",
    ...
    SnippetCheck(
        "M247-B011-DOC-EXP-11",
        "`check:objc3c:m247-b011-lane-b-readiness`",
    ),
    SnippetCheck(
        "M247-B011-DOC-EXP-12",
        "`scripts/run_m247_b011_lane_b_readiness.py`",
    ),
    SnippetCheck(
        "M247-B011-DOC-EXP-13",
        "`tmp/reports/m247/M247-B011/semantic_hot_path_analysis_and_budgeting_performance_and_quality_guardrails_summary.json`",
    ),
    SnippetCheck("M247-B011-DOC-EXP-14", "`compile:objc3c`"),
    SnippetCheck("M247-B011-DOC-EXP-15", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B011-DOC-PKT-01",
        "# M247-B011 Semantic Hot-Path Analysis and Budgeting Performance and Quality Guardrails Packet",
    ),
    SnippetCheck("M247-B011-DOC-PKT-02", "Packet: `M247-B011`"),
    SnippetCheck("M247-B011-DOC-PKT-03", "Issue: `#6734`"),
    SnippetCheck("M247-B011-DOC-PKT-04", "Dependencies: `M247-B010`"),
    SnippetCheck(
        "M247-B011-DOC-PKT-05",
        "`scripts/check_m247_b011_semantic_hot_path_analysis_and_budgeting_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M247-B011-DOC-PKT-06",
    ...
    SnippetCheck(
        "M247-B011-DOC-PKT-07",
        "`scripts/run_m247_b011_lane_b_readiness.py`",
    ),
    SnippetCheck("M247-B011-DOC-PKT-08", "`check:objc3c:m247-b011-lane-b-readiness`"),
    SnippetCheck(
        "M247-B011-DOC-PKT-09",
        "performance and quality guardrails budgeting continuity",
    ),
    SnippetCheck(
        "M247-B011-DOC-PKT-10",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-B011-DOC-PKT-11",
        "tmp/reports/m247/M247-B011/semantic_hot_path_analysis_and_budgeting_performance_and_quality_guardrails_summary.json",
    ),
)
...
B010_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B011-B010-DOC-01",
        "Contract ID: `objc3c-semantic-hot-path-analysis-and-budgeting-conformance-corpus-expansion/m247-b010-v1`",
    ),
    SnippetCheck("M247-B011-B010-DOC-02", "Dependencies: `M247-B009`"),
    SnippetCheck(
        "M247-B011-B010-DOC-03",
        "scripts/check_m247_b010_semantic_hot_path_analysis_and_budgeting_conformance_corpus_expansion_contract.py",
    ),
)

B010_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B011-B010-PKT-01", "Packet: `M247-B010`"),
    SnippetCheck("M247-B011-B010-PKT-02", "Issue: `#6733`"),
    SnippetCheck("M247-B011-B010-PKT-03", "Dependencies: `M247-B009`"),
    SnippetCheck(
        "M247-B011-B010-PKT-04",
        "scripts/check_m247_b010_semantic_hot_path_analysis_and_budgeting_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M247-B011-B010-PKT-05",
...
READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B011-RUN-01",
        '"""Run M247-B011 lane-B readiness checks without deep npm nesting."""',
    ),
    SnippetCheck(
        "M247-B011-RUN-02",
    ...
    SnippetCheck("M247-B011-RUN-05", "[ok] M247-B011 lane-B readiness chain completed"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-B011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-B011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b010_expectations_doc, "M247-B011-B010-DOC-EXISTS", B010_EXPECTATIONS_SNIPPETS),
        (args.b010_packet_doc, "M247-B011-B010-PKT-EXISTS", B010_PACKET_SNIPPETS),
        (args.readiness_runner, "M247-B011-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b010_checker, "M247-B011-DEP-B010-ARG-01"),
        (args.b010_test, "M247-B011-DEP-B010-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
