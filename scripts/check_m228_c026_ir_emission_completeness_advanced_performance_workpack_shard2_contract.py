#!/usr/bin/env python3
"""Fail-closed validator for M228-C026 IR-emission advanced integration shard1 contract."""
...
MODE = "m228-c026-ir-emission-completeness-advanced-performance-workpack-shard2-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c025_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_integration_workpack_shard2_c025_expectations.md",
    "c025_checker": ROOT
    / "scripts"
    / "check_m228_c025_ir_emission_completeness_advanced_integration_workpack_shard2_contract.py",
    "c025_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c025_ir_emission_completeness_advanced_integration_workpack_shard2_contract.py",
    "c025_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c025_ir_emission_completeness_advanced_integration_workpack_shard2_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_performance_workpack_shard2_c026_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c026_ir_emission_completeness_advanced_performance_workpack_shard2_packet.md",
}
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C026-RUN-04", "npm run check:objc3c:m228-c026-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C026-ARC-01",
    ...
    "package_json": (
        ("M228-C026-PKG-01", '"check:objc3c:m228-c025-lane-c-readiness"'),
        (
            "M228-C026-PKG-02",
            '"check:objc3c:m228-c026-ir-emission-completeness-advanced-performance-workpack-shard2-contract"',
        ),
        (
            "M228-C026-PKG-03",
            '"test:tooling:m228-c026-ir-emission-completeness-advanced-performance-workpack-shard2-contract"',
        ),
        ("M228-C026-PKG-04", '"check:objc3c:m228-c026-lane-c-readiness"'),
        (
            "M228-C026-PKG-05",
            '"check:objc3c:m228-c026-lane-c-readiness": "npm run check:objc3c:m228-c025-lane-c-readiness &&',
        ),
    ),
    "c025_contract_doc": (
        (
    ...
    "c025_checker": (
        (
            "M228-C026-DEP-02",
            'MODE = "m228-c025-ir-emission-completeness-advanced-integration-workpack-shard2-contract-v1"',
        ),
    ),
    "c025_tooling_test": (
        ("M228-C026-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c025_packet_doc": (
        ("M228-C026-DEP-04", "Packet: `M228-C025`"),
        ("M228-C026-DEP-05", "Issue: `#5251`"),
    ),
    "contract_doc": (
        (
            "M228-C026-DOC-01",
            "Contract ID: `objc3c-ir-emission-completeness-advanced-performance-workpack-shard2/m228-c026-v1`",
        ),
        ("M228-C026-DOC-02", "Execute issue `#5252`"),
        ("M228-C026-DOC-03", "Dependencies: `M228-C025`"),
        (
            "M228-C026-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C026-PKT-02", "Packet: `M228-C026`"),
        ("M228-C026-PKT-03", "Issue: `#5252`"),
        ("M228-C026-PKT-04", "Dependencies: `M228-C025`"),
        (
            "M228-C026-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C026-FORB-01",
            '"check:objc3c:m228-c026-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C026/"
            "ir_emission_completeness_advanced_performance_workpack_shard2_contract_summary.json"
        ),
    )
