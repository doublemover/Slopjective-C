#!/usr/bin/env python3
"""Fail-closed checker for M247-C008 lowering/codegen recovery and determinism hardening."""
...
MODE = "m247-c008-lowering-codegen-cost-profiling-controls-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c008_lane_c_readiness.py"
DEFAULT_C007_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m247_lane_c_lowering_codegen_cost_profiling_and_controls_diagnostics_hardening_c007_expectations.md"
)
DEFAULT_C007_PACKET_DOC = (
    ...
    / "compiler"
    / "m247"
    / "m247_c007_lowering_codegen_cost_profiling_and_controls_diagnostics_hardening_packet.md"
)
DEFAULT_C007_CHECKER = (
    ROOT
    / "scripts"
    / "check_m247_c007_lowering_codegen_cost_profiling_and_controls_diagnostics_hardening_contract.py"
)
DEFAULT_C007_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m247_c007_lowering_codegen_cost_profiling_and_controls_diagnostics_hardening_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-C008-DOC-EXP-02", "Dependencies: `M247-C007`"),
    SnippetCheck(
        "M247-C008-DOC-EXP-03",
        "Issue `#6749` defines canonical lane-C recovery and determinism hardening scope.",
    ),
    SnippetCheck(
        "M247-C008-DOC-EXP-04",
        "scripts/check_m247_c007_lowering_codegen_cost_profiling_and_controls_diagnostics_hardening_contract.py",
    ),
    SnippetCheck(
        "M247-C008-DOC-EXP-05",
        "scripts/run_m247_c008_lane_c_readiness.py",
    ),
    SnippetCheck("M247-C008-DOC-EXP-06", "`check:objc3c:m247-c008-lane-c-readiness`"),
    SnippetCheck("M247-C008-DOC-EXP-07", "`check:objc3c:m247-c007-lane-c-readiness`"),
    SnippetCheck("M247-C008-DOC-EXP-08", "`C007 readiness -> C008 checker -> C008 pytest`."),
    SnippetCheck(
        "M247-C008-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C008-DOC-EXP-10",
        "tmp/reports/m247/M247-C008/lowering_codegen_cost_profiling_and_controls_recovery_and_determinism_hardening_contract_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C008-DOC-PKT-01",
        "# M247-C008 Lowering/Codegen Cost Profiling and Controls Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M247-C008-DOC-PKT-02", "Packet: `M247-C008`"),
    SnippetCheck("M247-C008-DOC-PKT-03", "Issue: `#6749`"),
    SnippetCheck("M247-C008-DOC-PKT-04", "Dependencies: `M247-C007`"),
    SnippetCheck("M247-C008-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-C008-DOC-PKT-06",
        "`scripts/check_m247_c008_lowering_codegen_cost_profiling_and_controls_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M247-C008-DOC-PKT-07",
    ...
    SnippetCheck(
        "M247-C008-DOC-PKT-08",
        "`scripts/run_m247_c008_lane_c_readiness.py`",
    ),
    SnippetCheck(
        "M247-C008-DOC-PKT-09",
        "`check:objc3c:m247-c008-lane-c-readiness`",
    ),
    SnippetCheck(
        "M247-C008-DOC-PKT-10",
...
C007_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C008-C007-DOC-01",
        "Contract ID: `objc3c-lane-c-lowering-codegen-cost-profiling-controls-diagnostics-hardening-contract/m247-c007-v1`",
    ),
    SnippetCheck("M247-C008-C007-DOC-02", "Dependencies: `M247-C006`"),
    SnippetCheck(
        "M247-C008-C007-DOC-03",
        "Issue `#6748` defines canonical lane-C diagnostics hardening scope.",
    ),
)

C007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C008-C007-PKT-01", "Packet: `M247-C007`"),
    SnippetCheck("M247-C008-C007-PKT-02", "Issue: `#6748`"),
    SnippetCheck("M247-C008-C007-PKT-03", "Dependencies: `M247-C006`"),
    SnippetCheck("M247-C008-C007-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C008-RUN-01", 'DEPENDENCY_TOKEN = "M247-C007"'),
    SnippetCheck("M247-C008-RUN-02", "check:objc3c:m247-c007-lane-c-readiness"),
    SnippetCheck(
        "M247-C008-RUN-03",
        "scripts/check_m247_c008_lowering_codegen_cost_profiling_and_controls_recovery_and_determinism_hardening_contract.py",
    ),
    ...
    SnippetCheck("M247-C008-RUN-05", "[ok] M247-C008 lane-C readiness chain completed"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C008-SPC-01",
        "lowering/codegen recovery and determinism hardening wiring shall preserve explicit lane-C dependency anchor (`M247-C007`)",
    ),
    SnippetCheck(
        "M247-C008-SPC-02",
        "recovery/determinism evidence commands drift",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-C008-META-02",
        "explicit `M247-C007` dependency continuity and fail-closed diagnostics hardening evidence continuity",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M247-C008-CFG-03", "check:objc3c:m247-c008-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C008-CFG-04", "check:objc3c:m247-c007-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C008-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M247-C008-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M247-C008-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-C008-CFG-11", "test:objc3c:perf-budget"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-C008-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-C008-DOC-PKT-00", PACKET_SNIPPETS),
        ("c007_expectations_doc", args.c007_expectations_doc, "M247-C008-C007-DOC-00", C007_EXPECTATIONS_SNIPPETS),
        ("c007_packet_doc", args.c007_packet_doc, "M247-C008-C007-PKT-00", C007_PACKET_SNIPPETS),
        ("readiness_script", args.readiness_script, "M247-C008-RUN-00", READINESS_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M247-C008-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M247-C008-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M247-C008-META-00", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c007_checker, "M247-C008-DEP-01"),
        (args.c007_test, "M247-C008-DEP-02"),
    ):
