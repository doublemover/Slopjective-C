#!/usr/bin/env python3
"""Fail-closed checker for M247-B002 semantic hot-path modular split/scaffolding."""
...
MODE = "m247-b002-semantic-hot-path-analysis-and-budgeting-modular-split-scaffolding-contract-v1"
...
DEFAULT_B001_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m247_semantic_hot_path_analysis_and_budgeting_contract_and_architecture_freeze_b001_expectations.md"
)
DEFAULT_B001_PACKET_DOC = (
    ...
    / "compiler"
    / "m247"
    / "m247_b001_semantic_hot_path_analysis_and_budgeting_contract_and_architecture_freeze_packet.md"
)
...
DEFAULT_B001_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m247_b001_semantic_hot_path_analysis_and_budgeting_contract_and_architecture_freeze_contract.py"
)
DEFAULT_B001_READINESS_RUNNER = ROOT / "scripts" / "run_m247_b001_lane_b_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m247_b002_lane_b_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B002-DOC-PKT-01",
        "# M247-B002 Semantic Hot-Path Analysis and Budgeting Modular Split and Scaffolding Packet",
    ),
    SnippetCheck("M247-B002-DOC-PKT-02", "Packet: `M247-B002`"),
    SnippetCheck("M247-B002-DOC-PKT-03", "Issue: `#6725`"),
    SnippetCheck("M247-B002-DOC-PKT-04", "Dependencies: `M247-B001`"),
    SnippetCheck("M247-B002-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-B002-DOC-PKT-06",
        "`scripts/check_m247_b002_semantic_hot_path_analysis_and_budgeting_modular_split_scaffolding_contract.py`",
    ),
    SnippetCheck(
        "M247-B002-DOC-PKT-07",
        "`tests/tooling/test_check_m247_b002_semantic_hot_path_analysis_and_budgeting_modular_split_scaffolding_contract.py`",
    ),
    SnippetCheck(
        "M247-B002-DOC-PKT-08",
        "`scripts/run_m247_b002_lane_b_readiness.py`",
    ),
    SnippetCheck(
        "M247-B002-DOC-PKT-09",
        "`B001 readiness -> B002 checker -> B002 pytest`",
    ),
    SnippetCheck(
        "M247-B002-DOC-PKT-10",
        "tmp/reports/m247/M247-B002/semantic_hot_path_analysis_and_budgeting_modular_split_scaffolding_contract_summary.json",
    ),
)
...
B001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B002-B001-DOC-01",
        "Contract ID: `objc3c-semantic-hot-path-analysis-and-budgeting-contract-and-architecture-freeze/m247-b001-v1`",
    ),
    SnippetCheck("M247-B002-B001-DOC-02", "Dependencies: none"),
    SnippetCheck(
        "M247-B002-B001-DOC-03",
        "Issue `#6724` defines canonical lane-B contract and architecture freeze scope.",
    ),
)

B001_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B002-B001-PKT-01", "Packet: `M247-B001`"),
    SnippetCheck("M247-B002-B001-PKT-02", "Issue: `#6724`"),
    SnippetCheck("M247-B002-B001-PKT-03", "Dependencies: none"),
    SnippetCheck("M247-B002-B001-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B002-RUN-01", 'DEPENDENCY_TOKEN = "M247-B001"'),
    SnippetCheck("M247-B002-RUN-02", "scripts/run_m247_b001_lane_b_readiness.py"),
    SnippetCheck(
        "M247-B002-RUN-03",
        "scripts/check_m247_b002_semantic_hot_path_analysis_and_budgeting_modular_split_scaffolding_contract.py",
    ),
    ...
    SnippetCheck("M247-B002-RUN-05", "[ok] M247-B002 lane-B readiness chain completed"),
)

B001_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B002-B001-RUN-01", "dependency continuity token: none"),
    SnippetCheck(
        "M247-B002-B001-RUN-02",
        "scripts/check_m247_b001_semantic_hot_path_analysis_and_budgeting_contract_and_architecture_freeze_contract.py",
    ),
    SnippetCheck("M247-B002-B001-RUN-03", "[ok] M247-B001 lane-B readiness chain completed"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--b001-readiness-runner", type=Path, default=DEFAULT_B001_READINESS_RUNNER)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-B002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-B002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b001_expectations_doc, "M247-B002-B001-DOC-EXISTS", B001_EXPECTATIONS_SNIPPETS),
        (args.b001_packet_doc, "M247-B002-B001-PKT-EXISTS", B001_PACKET_SNIPPETS),
        (args.readiness_runner, "M247-B002-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.b001_readiness_runner, "M247-B002-B001-RUN-EXISTS", B001_READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b001_checker, "M247-B002-DEP-B001-ARG-01"),
        (args.b001_test, "M247-B002-DEP-B001-ARG-02"),
    ):
    ...
    if not wrote_summary:
        print(
            f"[M247-B002-SUMMARY-WRITE-01] {display_path(summary_path)}: {error_message}",
            file=sys.stderr,
        )
        return 1
