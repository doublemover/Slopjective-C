#!/usr/bin/env python3
"""Fail-closed checker for M245-D003 build/link/runtime reproducibility core feature implementation."""
...
MODE = "m245-d003-build-link-runtime-reproducibility-operations-core-feature-implementation-contract-v1"
...
DEFAULT_D002_CHECKER = (
    ROOT / "scripts" / "check_m245_d002_build_link_runtime_reproducibility_operations_modular_split_scaffolding_contract.py"
)
DEFAULT_D002_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m245_d002_build_link_runtime_reproducibility_operations_modular_split_scaffolding_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D003-DOC-PKT-01",
        "# M245-D003 Build/Link/Runtime Reproducibility Operations Core Feature Implementation Packet",
    ),
    SnippetCheck("M245-D003-DOC-PKT-02", "Packet: `M245-D003`"),
    SnippetCheck("M245-D003-DOC-PKT-03", "Issue: `#6654`"),
    SnippetCheck("M245-D003-DOC-PKT-04", "Dependencies: `M245-D002`"),
    SnippetCheck(
        "M245-D003-DOC-PKT-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D003-DOC-PKT-06",
        "scripts/check_m245_d003_build_link_runtime_reproducibility_operations_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M245-D003-DOC-PKT-07",
        "tests/tooling/test_check_m245_d003_build_link_runtime_reproducibility_operations_core_feature_implementation_contract.py",
    ),
    SnippetCheck("M245-D003-DOC-PKT-08", "`npm run check:objc3c:m245-d003-lane-d-readiness`"),
    SnippetCheck(
        "M245-D003-DOC-PKT-09",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-D003-META-02",
        "explicit `M245-D002` dependency continuity so core feature implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-D003-PKG-03",
        '"check:objc3c:m245-d003-lane-d-readiness": '
        '"npm run check:objc3c:m245-d002-lane-d-readiness '
        '&& npm run check:objc3c:m245-d003-build-link-runtime-reproducibility-operations-core-feature-implementation-contract '
        '&& npm run test:tooling:m245-d003-build-link-runtime-reproducibility-operations-core-feature-implementation-contract"',
    ),
    SnippetCheck("M245-D003-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D003-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D003-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D003-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d002_expectations_doc, "M245-D003-D002-DOC-EXISTS", D002_EXPECTATIONS_SNIPPETS),
        (args.d002_packet_doc, "M245-D003-D002-PKT-EXISTS", D002_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d002_checker, "M245-D003-DEP-D002-ARG-01"),
        (args.d002_test, "M245-D003-DEP-D002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
