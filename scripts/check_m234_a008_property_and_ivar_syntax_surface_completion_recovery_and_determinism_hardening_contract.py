#!/usr/bin/env python3
"""Fail-closed checker for M234-A008 property and ivar syntax surface completion recovery and determinism hardening."""
...
MODE = "m234-a008-property-and-ivar-syntax-surface-completion-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_A007_CHECKER = (
    ROOT / "scripts" / "check_m234_a007_property_and_ivar_syntax_surface_completion_diagnostics_hardening_contract.py"
)
DEFAULT_A007_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_a007_property_and_ivar_syntax_surface_completion_diagnostics_hardening_contract.py"
)
...
A007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-A008-A007-PKT-01", "Packet: `M234-A007`"),
    SnippetCheck("M234-A008-A007-PKT-02", "Dependencies: `M234-A006`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A008-META-02",
        "explicit `M234-A007` dependency continuity so recovery and determinism hardening drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-A008-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M234-A008-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-A008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-A008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a007_expectations_doc, "M234-A008-A007-DOC-EXISTS", A007_EXPECTATIONS_SNIPPETS),
        (args.a007_packet_doc, "M234-A008-A007-PKT-EXISTS", A007_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-A008-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-A008-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-A008-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-A008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a007_checker, "M234-A008-DEP-A007-ARG-01"),
        (args.a007_test, "M234-A008-DEP-A007-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
