#!/usr/bin/env python3
"""Fail-closed checker for M234-C016 accessor and ivar lowering advanced edge compatibility workpack (shard 1)."""
...
MODE = "m234-c016-accessor-and-ivar-lowering-contracts-advanced-edge-compatibility-workpack-shard-1-contract-v1"
...
DEFAULT_C015_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m234_accessor_and_ivar_lowering_contracts_advanced_core_workpack_shard_1_c015_expectations.md"
)
DEFAULT_C015_PACKET_DOC = (
    ...
    / "compiler"
    / "m234"
    / "m234_c015_accessor_and_ivar_lowering_contracts_advanced_core_workpack_shard_1_packet.md"
)
DEFAULT_C015_CHECKER = (
    ROOT / "scripts" / "check_m234_c015_accessor_and_ivar_lowering_contracts_advanced_core_workpack_shard_1_contract.py"
)
DEFAULT_C015_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_c015_accessor_and_ivar_lowering_contracts_advanced_core_workpack_shard_1_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-C016-DOC-PKT-01",
        "# M234-C016 Accessor and Ivar Lowering Contracts Advanced Edge Compatibility Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M234-C016-DOC-PKT-02", "Packet: `M234-C016`"),
    SnippetCheck("M234-C016-DOC-PKT-03", "Issue: `#5734`"),
    SnippetCheck("M234-C016-DOC-PKT-04", "Dependencies: `M234-C015`"),
    SnippetCheck(
        "M234-C016-DOC-PKT-05",
        "scripts/check_m234_c016_accessor_and_ivar_lowering_contracts_advanced_edge_compatibility_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M234-C016-DOC-PKT-06",
...
C015_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-C016-C015-PKT-01", "Packet: `M234-C015`"),
    SnippetCheck("M234-C016-C015-PKT-02", "Dependencies: `M234-C014`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-C016-META-02",
        "explicit `M234-C015` dependency continuity so advanced edge compatibility workpack (shard 1) drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-C016-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-C016-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-C016-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-C016-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str] | None = None) -> int:
    ...
    for path, exists_id, snippets in (
        (args.expectations_doc, "M234-C016-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-C016-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c015_expectations_doc, "M234-C016-C015-DOC-EXISTS", C015_EXPECTATIONS_SNIPPETS),
        (args.c015_packet_doc, "M234-C016-C015-PKT-EXISTS", C015_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-C016-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-C016-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-C016-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-C016-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c015_checker, "M234-C016-C015-CHECKER-EXISTS"),
        (args.c015_test, "M234-C016-C015-TEST-EXISTS"),
    ):
