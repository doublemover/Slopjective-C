#!/usr/bin/env python3
"""Fail-closed checker for M235-C014 qualified type release-candidate and replay dry-run."""
...
MODE = "m235-c014-qualified-type-lowering-and-abi-representation-release-candidate-and-replay-dry-run-contract-v1"
...
DEFAULT_C013_CHECKER = (
    ROOT / "scripts" / "check_m235_c013_qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_contract.py"
)
DEFAULT_C013_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c013_qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M235-C014-DEP-C013-02",
        Path("spec/planning/compiler/m235/m235_c013_qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_packet.md"),
    ),
    AssetCheck(
        "M235-C014-DEP-C013-03",
        Path("scripts/check_m235_c013_qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_contract.py"),
    ),
    AssetCheck(
        "M235-C014-DEP-C013-04",
        Path("tests/tooling/test_check_m235_c013_qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C014-DOC-EXP-01",
        "# M235 Qualified Type Lowering and ABI Representation Release-candidate and Replay Dry-run Expectations (C014)",
    ),
    SnippetCheck(
        "M235-C014-DOC-EXP-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-release-candidate-and-replay-dry-run/m235-c014-v1`",
    ),
    SnippetCheck("M235-C014-DOC-EXP-03", "Dependencies: `M235-C013`"),
    SnippetCheck(
        "M235-C014-DOC-EXP-04",
        "Issue `#5824` defines canonical lane-C release-candidate and replay dry-run scope.",
    ),
    SnippetCheck(
        "M235-C014-DOC-EXP-05",
        "optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-C014-DOC-EXP-06",
        "docs/contracts/m235_qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_c013_expectations.md",
    ),
    SnippetCheck(
        "M235-C014-DOC-EXP-07",
    ...
    SnippetCheck("M235-C014-DOC-EXP-09", "`C013 readiness -> C014 checker -> C014 pytest`."),
    SnippetCheck(
        "M235-C014-DOC-EXP-10",
        "`tmp/reports/m235/M235-C014/qualified_type_lowering_and_abi_representation_release_candidate_and_replay_dry_run_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C014-DOC-PKT-01",
        "# M235-C014 Qualified Type Lowering and ABI Representation Release-candidate and Replay Dry-run Packet",
    ),
    SnippetCheck("M235-C014-DOC-PKT-02", "Packet: `M235-C014`"),
    SnippetCheck("M235-C014-DOC-PKT-03", "Issue: `#5824`"),
    SnippetCheck("M235-C014-DOC-PKT-04", "Dependencies: `M235-C013`"),
    SnippetCheck(
        "M235-C014-DOC-PKT-05",
        "including code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M235-C014-DOC-PKT-06",
        "scripts/check_m235_c014_qualified_type_lowering_and_abi_representation_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck(
        "M235-C014-DOC-PKT-07",
    ...
    SnippetCheck("M235-C014-DOC-PKT-08", "`npm run check:objc3c:m235-c013-lane-c-readiness`"),
    SnippetCheck(
        "M235-C014-DOC-PKT-09",
        "`C013 readiness -> C014 checker -> C014 pytest`",
    ),
    SnippetCheck(
        "M235-C014-DOC-PKT-10",
...
C013_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-C014-C013-PKT-01", "Packet: `M235-C013`"),
    SnippetCheck("M235-C014-C013-PKT-02", "Issue: `#5823`"),
    SnippetCheck("M235-C014-C013-PKT-03", "Dependencies: `M235-C012`"),
    SnippetCheck("M235-C014-C013-PKT-04", "Freeze date: `2026-03-05`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-C014-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-C014-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-C014-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C014-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C014-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C014-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c013_expectations_doc, "M235-C014-C013-DOC-EXISTS", C013_EXPECTATIONS_SNIPPETS),
        (args.c013_packet_doc, "M235-C014-C013-PKT-EXISTS", C013_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C014-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C014-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C014-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C014-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c013_checker, "M235-C014-DEP-C013-ARG-01"),
        (args.c013_test, "M235-C014-DEP-C013-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
