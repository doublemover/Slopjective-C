#!/usr/bin/env python3
"""Fail-closed checker for M229-A008 class/protocol/category metadata recovery and determinism hardening."""
...
MODE = "m229-a008-class-protocol-category-metadata-generation-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_A007_CHECKER = (
    ROOT / "scripts" / "check_m229_a007_class_protocol_category_metadata_generation_diagnostics_hardening_contract.py"
)
DEFAULT_A007_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m229_a007_class_protocol_category_metadata_generation_diagnostics_hardening_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[tuple[str, Path], ...] = (
    (
        "M229-A008-DEP-A007-01",
        Path("docs/contracts/m229_class_protocol_category_metadata_generation_diagnostics_hardening_a007_expectations.md"),
    ),
    (
        "M229-A008-DEP-A007-02",
        Path("spec/planning/compiler/m229/m229_a007_class_protocol_category_metadata_generation_diagnostics_hardening_packet.md"),
    ),
    (
        "M229-A008-DEP-A007-03",
        Path("scripts/check_m229_a007_class_protocol_category_metadata_generation_diagnostics_hardening_contract.py"),
    ),
    (
        "M229-A008-DEP-A007-04",
        Path("tests/tooling/test_check_m229_a007_class_protocol_category_metadata_generation_diagnostics_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A008-DOC-EXP-01",
        "# M229 Class/Protocol/Category Metadata Generation Recovery and Determinism Hardening Expectations (A008)",
    ),
    SnippetCheck(
        "M229-A008-DOC-EXP-02",
        "Contract ID: `objc3c-class-protocol-category-metadata-generation-recovery-and-determinism-hardening/m229-a008-v1`",
    ),
    SnippetCheck("M229-A008-DOC-EXP-03", "Dependencies: `M229-A007`"),
    SnippetCheck(
        "M229-A008-DOC-EXP-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A008-DOC-EXP-05",
        "check:objc3c:m229-a008-class-protocol-category-metadata-generation-recovery-and-determinism-hardening-contract",
    ),
    SnippetCheck(
        "M229-A008-DOC-EXP-06",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A008-DOC-PKT-01",
        "# M229-A008 Class/Protocol/Category Metadata Generation Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M229-A008-DOC-PKT-02", "Packet: `M229-A008`"),
    SnippetCheck("M229-A008-DOC-PKT-03", "Dependencies: `M229-A007`"),
    SnippetCheck(
        "M229-A008-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A008-DOC-PKT-05",
...
A007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M229-A008-A007-PKT-01", "Packet: `M229-A007`"),
    SnippetCheck("M229-A008-A007-PKT-02", "Dependencies: `M229-A006`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m229-a008-class-protocol-category-metadata-generation-recovery-and-determinism-hardening-contract '
        '&& npm run test:tooling:m229-a008-class-protocol-category-metadata-generation-recovery-and-determinism-hardening-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M229-A008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M229-A008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a007_expectations_doc, "M229-A008-A007-EXP-EXISTS", A007_EXPECTATIONS_SNIPPETS),
        (args.a007_packet_doc, "M229-A008-A007-PKT-EXISTS", A007_PACKET_SNIPPETS),
        (args.architecture_doc, "M229-A008-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M229-A008-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M229-A008-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M229-A008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
