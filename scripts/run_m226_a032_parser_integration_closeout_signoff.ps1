param(
  [string]$ReportRoot = "tmp/reports/m226/M226-A032"
)
...
$upstream = @(
  @{ packet = "A025"; path = "tmp/reports/m226/M226-A025/parser_integration_shard2_summary.json" },
  @{ packet = "A031"; path = "tmp/reports/m226/M226-A031/parser_integration_shard3_summary.json" }
)
...
$summary = [ordered]@{
  contract_id = "objc3c-parser-integration-closeout-signoff-contract/m226-a032-v1"
