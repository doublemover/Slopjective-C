...
def compile_negative_summary(
    *,
    ...
    generic_function_constraint_violation_negative_run: dict[str, Any],
    generic_function_unresolved_return_negative_run: dict[str, Any],
    ...
    return {
        ...
        "generic_function_constraint_violation_negative_fixture_fails_closed": generic_function_constraint_violation_negative_run["exit_code"] != 0,
        "generic_function_constraint_violation_negative_diagnostics_json_emitted": generic_function_constraint_violation_negative_run["diagnostics_path"] is not None,
        "generic_function_constraint_violation_diagnostic_observed": diagnostic_matches(generic_function_constraint_violation_negative_run["diagnostics"], "O3S206", 24, 32),
        "generic_function_unresolved_return_negative_fixture_fails_closed": generic_function_unresolved_return_negative_run["exit_code"] != 0,
        "generic_function_unresolved_return_negative_diagnostics_json_emitted": generic_function_unresolved_return_negative_run["diagnostics_path"] is not None,
        "generic_function_unresolved_return_diagnostic_observed": diagnostic_matches(generic_function_unresolved_return_negative_run["diagnostics"], "O3S206", 18, 16),
