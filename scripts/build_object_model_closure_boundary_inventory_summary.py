...
OUT_DIR = ROOT / "tmp/reports/object-model-closure/boundary-inventory"
...
def main() -> int:
    ...
    summary = {
        "issue": "object-model-closure-boundary-inventory",
    ...
    MD_OUT.write_text(
        "# Object-Model Closure Boundary Inventory Summary\n\n"
