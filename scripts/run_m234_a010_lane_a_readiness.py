#!/usr/bin/env python3
"""Run M234-A010 lane-A readiness checks without deep npm nesting."""
...
COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    (
        sys.executable,
        "scripts/run_m234_a009_lane_a_readiness.py",
    ),
    (
        sys.executable,
...
def run_chain() -> int:
    ...
    print("[ok] M234-A010 lane-A readiness chain completed")
    return 0
