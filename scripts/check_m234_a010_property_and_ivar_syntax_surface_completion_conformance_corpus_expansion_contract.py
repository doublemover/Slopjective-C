#!/usr/bin/env python3
"""Fail-closed checker for M234-A010 property and ivar syntax surface completion conformance corpus expansion."""
...
MODE = "m234-a010-property-and-ivar-syntax-surface-completion-conformance-corpus-expansion-contract-v1"
...
DEFAULT_A009_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m234_property_and_ivar_syntax_surface_completion_conformance_matrix_implementation_a009_expectations.md"
)
DEFAULT_A009_PACKET_DOC = (
    ...
    / "compiler"
    / "m234"
    / "m234_a009_property_and_ivar_syntax_surface_completion_conformance_matrix_implementation_packet.md"
)
DEFAULT_A009_CHECKER = (
    ROOT / "scripts" / "check_m234_a009_property_and_ivar_syntax_surface_completion_conformance_matrix_implementation_contract.py"
)
DEFAULT_A009_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_a009_property_and_ivar_syntax_surface_completion_conformance_matrix_implementation_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-A010-DOC-PKT-01",
        "# M234-A010 Property and Ivar Syntax Surface Completion Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M234-A010-DOC-PKT-02", "Packet: `M234-A010`"),
    SnippetCheck("M234-A010-DOC-PKT-03", "Dependencies: `M234-A009`"),
    SnippetCheck(
        "M234-A010-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M234-A010-DOC-PKT-05",
        "scripts/check_m234_a010_property_and_ivar_syntax_surface_completion_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M234-A010-DOC-PKT-06",
        "tests/tooling/test_check_m234_a010_property_and_ivar_syntax_surface_completion_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck("M234-A010-DOC-PKT-07", "`npm run check:objc3c:m234-a010-lane-a-readiness`"),
)

A009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-A010-A009-DOC-01",
        "# M234 Property and Ivar Syntax Surface Completion Conformance Matrix Implementation Expectations (A009)",
    ),
    SnippetCheck(
        "M234-A010-A009-DOC-02",
...
A009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-A010-A009-PKT-01", "Packet: `M234-A009`"),
    SnippetCheck("M234-A010-A009-PKT-02", "Dependencies: `M234-A008`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A010-META-02",
        "explicit `M234-A009` dependency continuity so conformance corpus expansion drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A010-PKG-03",
        '"check:objc3c:m234-a010-lane-a-readiness": '
        '"npm run check:objc3c:m234-a009-lane-a-readiness '
        '&& npm run check:objc3c:m234-a010-property-and-ivar-syntax-surface-completion-conformance-corpus-expansion-contract '
        '&& npm run test:tooling:m234-a010-property-and-ivar-syntax-surface-completion-conformance-corpus-expansion-contract"',
    ),
    SnippetCheck("M234-A010-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M234-A010-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-A010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-A010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a009_expectations_doc, "M234-A010-A009-DOC-EXISTS", A009_EXPECTATIONS_SNIPPETS),
        (args.a009_packet_doc, "M234-A010-A009-PKT-EXISTS", A009_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-A010-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-A010-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-A010-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-A010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a009_checker, "M234-A010-DEP-A009-ARG-01"),
        (args.a009_test, "M234-A010-DEP-A009-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
