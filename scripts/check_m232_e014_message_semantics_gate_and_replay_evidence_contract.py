#!/usr/bin/env python3
"""Fail-closed checker for M232-E014 message semantics gate and replay evidence contract freeze."""
...
MODE = "m232-e014-message-semantics-gate-and-replay-evidence-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m232"
    / "m232_e014_message_semantics_gate_and_replay_evidence_release_candidate_and_replay_dry_run_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-E014-DOC-EXP-01",
        "# M232 Runtime Selector Binding Integration Contract and Architecture Freeze Expectations (E014)",
    ),
    SnippetCheck(
        "M232-E014-DOC-EXP-02",
        "Contract ID: `objc3c-message-semantics-gate-and-replay-evidence/m232-e014-v1`",
    ),
    SnippetCheck("M232-E014-DOC-EXP-03", "Issue: `#4895`"),
    SnippetCheck("M232-E014-DOC-EXP-04", "Dependencies: none"),
    SnippetCheck(
        "M232-E014-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M232-E014-DOC-EXP-06",
        "`check:objc3c:m232-e014-lane-e-readiness`",
    ),
    SnippetCheck(
        "M232-E014-DOC-EXP-07",
        "`tmp/reports/m232/M232-E014/message_semantics_gate_and_replay_evidence_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-E014-DOC-PKT-01",
        "# M232-E014 Runtime Selector Binding Integration Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M232-E014-DOC-PKT-02", "Packet: `M232-E014`"),
    SnippetCheck("M232-E014-DOC-PKT-03", "Issue: `#4895`"),
    SnippetCheck("M232-E014-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M232-E014-DOC-PKT-05",
        "check:objc3c:m232-e014-message-semantics-gate-and-replay-evidence-contract",
    ),
    SnippetCheck(
        "M232-E014-DOC-PKT-06",
        "tmp/reports/m232/M232-E014/message_semantics_gate_and_replay_evidence_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M232-E014-PKG-03",
        '"check:objc3c:m232-e014-lane-e-readiness": '
        '"npm run check:objc3c:m232-e014-message-semantics-gate-and-replay-evidence-contract '
        '&& npm run test:tooling:m232-e014-message-semantics-gate-and-replay-evidence-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M232-E014-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M232-E014-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M232-E014-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M232-E014-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M232-E014-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M232-E014-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
