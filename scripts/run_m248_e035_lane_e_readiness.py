#!/usr/bin/env python3
"""Run M248-E035 lane-E readiness checks without deep npm nesting."""
...
COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    ...
    (
        sys.executable,
        "scripts/run_m248_d025_lane_d_readiness.py",
    ),
    (
        sys.executable,
...
def run_chain() -> int:
    ...
    print("[ok] M248-E035 lane-E readiness chain completed")
    return 0
