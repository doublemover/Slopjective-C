#!/usr/bin/env python3
"""Fail-closed checker for M235-C007 qualified type diagnostics hardening."""
...
MODE = "m235-c007-qualified-type-lowering-and-abi-representation-diagnostics-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualified_type_lowering_and_abi_representation_diagnostics_hardening_c007_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_c007_qualified_type_lowering_and_abi_representation_diagnostics_hardening_packet.md"
)
...
DEFAULT_C006_CHECKER = (
    ROOT / "scripts" / "check_m235_c006_qualified_type_lowering_and_abi_representation_edge_case_expansion_and_robustness_contract.py"
)
DEFAULT_C006_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c006_qualified_type_lowering_and_abi_representation_edge_case_expansion_and_robustness_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M235-C007-DEP-C006-02",
        Path("spec/planning/compiler/m235/m235_c006_qualified_type_lowering_and_abi_representation_edge_case_expansion_and_robustness_packet.md"),
    ),
    AssetCheck(
        "M235-C007-DEP-C006-03",
        Path("scripts/check_m235_c006_qualified_type_lowering_and_abi_representation_edge_case_expansion_and_robustness_contract.py"),
    ),
    AssetCheck(
        "M235-C007-DEP-C006-04",
        Path("tests/tooling/test_check_m235_c006_qualified_type_lowering_and_abi_representation_edge_case_expansion_and_robustness_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C007-DOC-EXP-01",
        "# M235 Qualified Type Lowering and ABI Representation Diagnostics Hardening Expectations (C007)",
    ),
    SnippetCheck(
        "M235-C007-DOC-EXP-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-diagnostics-hardening/m235-c007-v1`",
    ),
    SnippetCheck("M235-C007-DOC-EXP-03", "Dependencies: `M235-C006`"),
    SnippetCheck(
        "M235-C007-DOC-EXP-04",
        "Issue `#5817` defines canonical lane-C diagnostics hardening scope.",
    ),
    SnippetCheck(
        "M235-C007-DOC-EXP-05",
        "optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-C007-DOC-EXP-06",
        "docs/contracts/m235_qualified_type_lowering_and_abi_representation_edge_case_expansion_and_robustness_c006_expectations.md",
    ),
    SnippetCheck(
        "M235-C007-DOC-EXP-07",
        "scripts/check_m235_c006_qualified_type_lowering_and_abi_representation_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M235-C007-DOC-EXP-08",
    ...
    SnippetCheck("M235-C007-DOC-EXP-09", "`C006 readiness -> C007 checker -> C007 pytest`."),
    SnippetCheck(
        "M235-C007-DOC-EXP-10",
        "`tmp/reports/m235/M235-C007/qualified_type_lowering_and_abi_representation_diagnostics_hardening_contract_summary.json`",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-C007-PKG-04",
        '"check:objc3c:m235-c007-lane-c-readiness": '
        '"npm run check:objc3c:m235-c006-lane-c-readiness '
        '&& npm run check:objc3c:m235-c007-qualified-type-lowering-and-abi-representation-diagnostics-hardening-contract '
        '&& npm run test:tooling:m235-c007-qualified-type-lowering-and-abi-representation-diagnostics-hardening-contract"',
    ),
    SnippetCheck(
        "M235-C007-PKG-05",
    ...
    SnippetCheck("M235-C007-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-C007-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-C007-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C007-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c006-checker", type=Path, default=DEFAULT_C006_CHECKER)
    parser.add_argument("--c006-test", type=Path, default=DEFAULT_C006_TEST)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C007-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C007-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c006_expectations_doc, "M235-C007-C006-DOC-EXISTS", C006_EXPECTATIONS_SNIPPETS),
        (args.c006_packet_doc, "M235-C007-C006-PKT-EXISTS", C006_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C007-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C007-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C007-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C007-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c006_checker, "M235-C007-DEP-C006-ARG-01"),
        (args.c006_test, "M235-C007-DEP-C006-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
