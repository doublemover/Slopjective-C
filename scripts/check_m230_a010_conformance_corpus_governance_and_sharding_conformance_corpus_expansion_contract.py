#!/usr/bin/env python3
"""Fail-closed checker for M230-A010 conformance corpus governance/sharding conformance corpus expansion."""
...
MODE = "m230-a010-conformance-corpus-governance-and-sharding-conformance-corpus-expansion-contract-v1"
...
DEFAULT_A009_CHECKER = (
    ROOT / "scripts" / "check_m230_a009_conformance_corpus_governance_and_sharding_conformance_matrix_implementation_contract.py"
)
DEFAULT_A009_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m230_a009_conformance_corpus_governance_and_sharding_conformance_matrix_implementation_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[tuple[str, Path], ...] = (
    (
        "M230-A010-DEP-A009-01",
        Path("docs/contracts/m230_conformance_corpus_governance_and_sharding_conformance_matrix_implementation_a009_expectations.md"),
    ),
    (
        "M230-A010-DEP-A009-02",
        Path("spec/planning/compiler/m230/m230_a009_conformance_corpus_governance_and_sharding_conformance_matrix_implementation_packet.md"),
    ),
    (
        "M230-A010-DEP-A009-03",
        Path("scripts/check_m230_a009_conformance_corpus_governance_and_sharding_conformance_matrix_implementation_contract.py"),
    ),
    (
        "M230-A010-DEP-A009-04",
        Path("tests/tooling/test_check_m230_a009_conformance_corpus_governance_and_sharding_conformance_matrix_implementation_contract.py"),
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-A010-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-A010-DOC-PKT-05",
...
A009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M230-A010-A009-PKT-01", "Packet: `M230-A009`"),
    SnippetCheck("M230-A010-A009-PKT-02", "Dependencies: `M230-A008`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m230-a010-conformance-corpus-governance-and-sharding-conformance-corpus-expansion-contract '
        '&& npm run test:tooling:m230-a010-conformance-corpus-governance-and-sharding-conformance-corpus-expansion-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M230-A010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M230-A010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a009_expectations_doc, "M230-A010-A009-EXP-EXISTS", A009_EXPECTATIONS_SNIPPETS),
        (args.a009_packet_doc, "M230-A010-A009-PKT-EXISTS", A009_PACKET_SNIPPETS),
        (args.architecture_doc, "M230-A010-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M230-A010-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M230-A010-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M230-A010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
