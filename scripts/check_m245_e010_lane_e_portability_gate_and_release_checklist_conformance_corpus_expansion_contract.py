#!/usr/bin/env python3
"""Fail-closed checker for M245-E010 portability gate/release checklist conformance corpus expansion."""
...
MODE = "m245-e010-lane-e-portability-gate-release-checklist-conformance-corpus-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_lane_e_portability_gate_and_release_checklist_conformance_corpus_expansion_e010_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_e010_lane_e_portability_gate_and_release_checklist_conformance_corpus_expansion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-E010-DOC-PKT-01",
        "# M245-E010 Lane-E Portability Gate and Release Checklist Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M245-E010-DOC-PKT-02", "Packet: `M245-E010`"),
    SnippetCheck("M245-E010-DOC-PKT-03", "Issue: `#6682`"),
    SnippetCheck(
        "M245-E010-DOC-PKT-04",
        "Dependencies: `M245-E009`, `M245-A004`, `M245-B004`, `M245-C006`, `M245-D007`",
    ),
    SnippetCheck("M245-E010-DOC-PKT-05", "Predecessor: `M245-E009`"),
    SnippetCheck("M245-E010-DOC-PKT-06", "Theme: conformance corpus expansion"),
    SnippetCheck(
        "M245-E010-DOC-PKT-07",
        "docs/contracts/m245_lane_e_portability_gate_and_release_checklist_conformance_corpus_expansion_e010_expectations.md",
    ),
    SnippetCheck(
        "M245-E010-DOC-PKT-08",
        "scripts/check_m245_e010_lane_e_portability_gate_and_release_checklist_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-E010-DOC-PKT-09",
        "tests/tooling/test_check_m245_e010_lane_e_portability_gate_and_release_checklist_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-E010-DOC-PKT-10",
    ...
    SnippetCheck(
        "M245-E010-DOC-PKT-11",
        "conformance corpus expansion traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-E010-DOC-PKT-12",
        "tmp/reports/m245/M245-E010/lane_e_portability_gate_release_checklist_conformance_corpus_expansion_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-E010-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M245-E010-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M245-E010-PKG-03", '"test:objc3c:diagnostics-replay-proof": '),
    SnippetCheck("M245-E010-PKG-04", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-E010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-E010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M245-E010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
