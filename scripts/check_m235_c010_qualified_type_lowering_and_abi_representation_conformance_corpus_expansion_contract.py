#!/usr/bin/env python3
"""Fail-closed checker for M235-C010 qualified type conformance corpus expansion."""
...
MODE = "m235-c010-qualified-type-lowering-and-abi-representation-conformance-corpus-expansion-contract-v1"
...
DEFAULT_C009_CHECKER = (
    ROOT / "scripts" / "check_m235_c009_qualified_type_lowering_and_abi_representation_conformance_matrix_implementation_contract.py"
)
DEFAULT_C009_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c009_qualified_type_lowering_and_abi_representation_conformance_matrix_implementation_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M235-C010-DEP-C009-02",
        Path("spec/planning/compiler/m235/m235_c009_qualified_type_lowering_and_abi_representation_conformance_matrix_implementation_packet.md"),
    ),
    AssetCheck(
        "M235-C010-DEP-C009-03",
        Path("scripts/check_m235_c009_qualified_type_lowering_and_abi_representation_conformance_matrix_implementation_contract.py"),
    ),
    AssetCheck(
        "M235-C010-DEP-C009-04",
        Path("tests/tooling/test_check_m235_c009_qualified_type_lowering_and_abi_representation_conformance_matrix_implementation_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C010-DOC-EXP-01",
        "# M235 Qualified Type Lowering and ABI Representation Conformance Corpus Expansion Expectations (C010)",
    ),
    SnippetCheck(
        "M235-C010-DOC-EXP-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-conformance-corpus-expansion/m235-c010-v1`",
    ),
    SnippetCheck("M235-C010-DOC-EXP-03", "Dependencies: `M235-C009`"),
    SnippetCheck(
        "M235-C010-DOC-EXP-04",
        "Issue `#5820` defines canonical lane-C conformance corpus expansion scope.",
    ),
    SnippetCheck(
        "M235-C010-DOC-EXP-05",
        "optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-C010-DOC-EXP-06",
        "docs/contracts/m235_qualified_type_lowering_and_abi_representation_conformance_matrix_implementation_c009_expectations.md",
    ),
    SnippetCheck(
        "M235-C010-DOC-EXP-07",
        "scripts/check_m235_c009_qualified_type_lowering_and_abi_representation_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M235-C010-DOC-EXP-08",
    ...
    SnippetCheck("M235-C010-DOC-EXP-09", "`C009 readiness -> C010 checker -> C010 pytest`."),
    SnippetCheck(
        "M235-C010-DOC-EXP-10",
        "`tmp/reports/m235/M235-C010/qualified_type_lowering_and_abi_representation_conformance_corpus_expansion_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C010-DOC-PKT-01",
        "# M235-C010 Qualified Type Lowering and ABI Representation Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M235-C010-DOC-PKT-02", "Packet: `M235-C010`"),
    SnippetCheck("M235-C010-DOC-PKT-03", "Issue: `#5820`"),
    SnippetCheck("M235-C010-DOC-PKT-04", "Dependencies: `M235-C009`"),
    SnippetCheck(
        "M235-C010-DOC-PKT-05",
        "including code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M235-C010-DOC-PKT-06",
        "scripts/check_m235_c010_qualified_type_lowering_and_abi_representation_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M235-C010-DOC-PKT-07",
    ...
    SnippetCheck("M235-C010-DOC-PKT-08", "`npm run check:objc3c:m235-c009-lane-c-readiness`"),
    SnippetCheck(
        "M235-C010-DOC-PKT-09",
        "`C009 readiness -> C010 checker -> C010 pytest`",
    ),
    SnippetCheck(
        "M235-C010-DOC-PKT-10",
...
C009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C010-C009-DOC-01",
        "# M235 Qualified Type Lowering and ABI Representation Conformance Matrix Implementation Expectations (C009)",
    ),
    SnippetCheck(
        "M235-C010-C009-DOC-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-conformance-matrix-implementation/m235-c009-v1`",
    ),
    SnippetCheck("M235-C010-C009-DOC-03", "Dependencies: `M235-C008`"),
    SnippetCheck(
        "M235-C010-C009-DOC-04",
        "Issue `#5819` defines canonical lane-C conformance matrix implementation scope.",
    ),
)

C009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-C010-C009-PKT-01", "Packet: `M235-C009`"),
    SnippetCheck("M235-C010-C009-PKT-02", "Issue: `#5819`"),
    SnippetCheck("M235-C010-C009-PKT-03", "Dependencies: `M235-C008`"),
    SnippetCheck("M235-C010-C009-PKT-04", "Freeze date: `2026-03-05`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-C010-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-C010-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-C010-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C010-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c009_expectations_doc, "M235-C010-C009-DOC-EXISTS", C009_EXPECTATIONS_SNIPPETS),
        (args.c009_packet_doc, "M235-C010-C009-PKT-EXISTS", C009_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C010-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C010-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C010-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c009_checker, "M235-C010-DEP-C009-ARG-01"),
        (args.c009_test, "M235-C010-DEP-C009-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
