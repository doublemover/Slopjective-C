#!/usr/bin/env python3
"""Fail-closed checker for M249-A002 feature packaging modular split/scaffolding."""
...
MODE = "m249-a002-feature-packaging-surface-compatibility-modular-split-scaffolding-contract-v1"
...
DEFAULT_A001_CHECKER = (
    ROOT / "scripts" / "check_m249_a001_feature_packaging_surface_and_compatibility_contracts_contract.py"
)
DEFAULT_A001_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m249_a001_feature_packaging_surface_and_compatibility_contracts_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M249-A002-DEP-A001-01",
        Path("docs/contracts/m249_feature_packaging_surface_and_compatibility_contracts_contract_freeze_a001_expectations.md"),
    ),
    AssetCheck(
        "M249-A002-DEP-A001-02",
        Path("spec/planning/compiler/m249/m249_a001_feature_packaging_surface_and_compatibility_contracts_contract_freeze_packet.md"),
    ),
    AssetCheck(
        "M249-A002-DEP-A001-03",
        Path("scripts/check_m249_a001_feature_packaging_surface_and_compatibility_contracts_contract.py"),
    ),
    AssetCheck(
        "M249-A002-DEP-A001-04",
        Path("tests/tooling/test_check_m249_a001_feature_packaging_surface_and_compatibility_contracts_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-A002-DOC-EXP-01",
        "# M249 Feature Packaging Surface and Compatibility Contracts Modular Split/Scaffolding Expectations (A002)",
    ),
    SnippetCheck(
        "M249-A002-DOC-EXP-02",
        "Contract ID: `objc3c-feature-packaging-surface-compatibility-contracts-modular-split-scaffolding/m249-a002-v1`",
    ),
    SnippetCheck("M249-A002-DOC-EXP-03", "Dependencies: `M249-A001`"),
    SnippetCheck(
        "M249-A002-DOC-EXP-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M249-A002-DOC-EXP-05",
        "docs/contracts/m249_feature_packaging_surface_and_compatibility_contracts_contract_freeze_a001_expectations.md",
    ),
    SnippetCheck(
        "M249-A002-DOC-EXP-06",
        "scripts/check_m249_a001_feature_packaging_surface_and_compatibility_contracts_contract.py",
    ),
    SnippetCheck(
        "M249-A002-DOC-EXP-07",
        "tests/tooling/test_check_m249_a001_feature_packaging_surface_and_compatibility_contracts_contract.py",
    ),
    SnippetCheck(
        "M249-A002-DOC-EXP-08",
        "`check:objc3c:m249-a002-feature-packaging-surface-compatibility-modular-split-scaffolding-contract`",
    ),
    SnippetCheck("M249-A002-DOC-EXP-09", "`test:objc3c:parser-replay-proof`"),
    SnippetCheck(
        "M249-A002-DOC-EXP-10",
        "`tmp/reports/m249/M249-A002/feature_packaging_surface_and_compatibility_contracts_modular_split_scaffolding_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-A002-DOC-PKT-08", "`npm run check:objc3c:m249-a002-lane-a-readiness`"),
    SnippetCheck(
        "M249-A002-DOC-PKT-09",
        "`tmp/reports/m249/M249-A002/feature_packaging_surface_and_compatibility_contracts_modular_split_scaffolding_summary.json`",
    ),
    SnippetCheck(
        "M249-A002-DOC-PKT-10",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-A002-META-02",
        "explicit `M249-A001` dependency continuity so compatibility scaffolding drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-A002-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M249-A002-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-A002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-A002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a001_expectations_doc, "M249-A002-A001-DOC-EXISTS", A001_EXPECTATIONS_SNIPPETS),
        (args.a001_packet_doc, "M249-A002-A001-PKT-EXISTS", A001_PACKET_SNIPPETS),
        (args.architecture_doc, "M249-A002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-A002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-A002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-A002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a001_checker, "M249-A002-DEP-A001-ARG-01"),
        (args.a001_test, "M249-A002-DEP-A001-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
