#!/usr/bin/env python3
"""Fail-closed checker for M244-D003 runtime/link bridge-path core feature implementation contract."""
...
MODE = "m244-d003-runtime-link-bridge-path-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_runtime_link_bridge_path_core_feature_implementation_d003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_d003_runtime_link_bridge_path_core_feature_implementation_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-D003-D002-01",
        "M244-D002",
        Path("docs/contracts/m244_runtime_link_bridge_path_modular_split_scaffolding_d002_expectations.md"),
    ),
    AssetCheck(
        "M244-D003-D002-02",
        "M244-D002",
        Path("spec/planning/compiler/m244/m244_d002_runtime_link_bridge_path_modular_split_scaffolding_packet.md"),
    ),
    AssetCheck(
        "M244-D003-D002-03",
        "M244-D002",
        Path("scripts/check_m244_d002_runtime_link_bridge_path_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M244-D003-D002-04",
        "M244-D002",
        Path("tests/tooling/test_check_m244_d002_runtime_link_bridge_path_modular_split_scaffolding_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D003-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-bridge-path-core-feature-implementation/m244-d003-v1`",
    ),
    SnippetCheck("M244-D003-DOC-EXP-02", "Dependencies: `M244-D002`"),
    SnippetCheck("M244-D003-DOC-EXP-03", "Issue `#6575` defines canonical lane-D core-feature implementation scope."),
    SnippetCheck("M244-D003-DOC-EXP-04", "`check:objc3c:m244-d003-lane-d-readiness`"),
    SnippetCheck("M244-D003-DOC-EXP-05", "`check:objc3c:m244-d002-lane-d-readiness`"),
    SnippetCheck("M244-D003-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M244-D003-DOC-EXP-07",
        "tmp/reports/m244/M244-D003/runtime_link_bridge_path_core_feature_implementation_contract_summary.json",
    ),
    SnippetCheck(
        "M244-D003-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-D003-DOC-PKT-01", "Packet: `M244-D003`"),
    SnippetCheck("M244-D003-DOC-PKT-02", "Issue: `#6575`"),
    SnippetCheck("M244-D003-DOC-PKT-03", "Dependencies: `M244-D002`"),
    SnippetCheck(
        "M244-D003-DOC-PKT-04",
        "`scripts/check_m244_d003_runtime_link_bridge_path_core_feature_implementation_contract.py`",
    ),
    SnippetCheck(
        "M244-D003-DOC-PKT-05",
        "`tests/tooling/test_check_m244_d003_runtime_link_bridge_path_core_feature_implementation_contract.py`",
    ),
    SnippetCheck("M244-D003-DOC-PKT-06", "`check:objc3c:m244-d003-lane-d-readiness`"),
    SnippetCheck(
        "M244-D003-DOC-PKT-07",
        "`python scripts/check_m244_d003_runtime_link_bridge_path_core_feature_implementation_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M244-D003-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-D003-CFG-03", "check:objc3c:m244-d003-lane-d-readiness"),
    PackageScriptKeyCheck("M244-D003-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M244-D003-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M244-D003-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-D003-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-d002-lane-d-readiness && npm run check:objc3c:m244-d003-runtime-link-bridge-path-core-feature-implementation-contract && npm run test:tooling:m244-d003-runtime-link-bridge-path-core-feature-implementation-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D003-SPC-01",
        "runtime/link bridge-path core feature implementation governance shall preserve explicit lane-D dependency anchors (`M244-D002`)",
    ),
    SnippetCheck(
        "M244-D003-SPC-02",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-D003-META-02",
        "explicit `M244-D002` dependency continuity and fail-closed evidence continuity",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-D003-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-D003-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-D003-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-D003-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-D003-META-00",
