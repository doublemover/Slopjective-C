param(
  ...
  [string]$ReportRoot = "tmp/reports/m249/M249-D014"
)
...
$summary = [ordered]@{
  contract_id = "objc3c-installer-runtime-operations-support-tooling-release-candidate-replay-dry-run/m249-d014-v1"
