#!/usr/bin/env python3
"""Fail-closed checker for M234-A006 property and ivar syntax surface completion edge-case expansion and robustness."""
...
MODE = "m234-a006-property-and-ivar-syntax-surface-completion-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_A005_CHECKER = (
    ROOT / "scripts" / "check_m234_a005_property_and_ivar_syntax_surface_completion_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_A005_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_a005_property_and_ivar_syntax_surface_completion_edge_case_and_compatibility_completion_contract.py"
)
...
A005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-A006-A005-PKT-01", "Packet: `M234-A005`"),
    SnippetCheck("M234-A006-A005-PKT-02", "Dependencies: `M234-A004`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A006-META-02",
        "explicit `M234-A005` dependency continuity so edge-case expansion and robustness drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A006-PKG-03",
        '"check:objc3c:m234-a006-lane-a-readiness": '
        '"npm run check:objc3c:m234-a005-lane-a-readiness '
        '&& npm run check:objc3c:m234-a006-property-and-ivar-syntax-surface-completion-edge-case-expansion-and-robustness-contract '
        '&& npm run test:tooling:m234-a006-property-and-ivar-syntax-surface-completion-edge-case-expansion-and-robustness-contract"',
    ),
    SnippetCheck("M234-A006-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M234-A006-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-A006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-A006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a005_expectations_doc, "M234-A006-A005-DOC-EXISTS", A005_EXPECTATIONS_SNIPPETS),
        (args.a005_packet_doc, "M234-A006-A005-PKT-EXISTS", A005_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-A006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-A006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-A006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-A006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a005_checker, "M234-A006-DEP-A005-ARG-01"),
        (args.a005_test, "M234-A006-DEP-A005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
