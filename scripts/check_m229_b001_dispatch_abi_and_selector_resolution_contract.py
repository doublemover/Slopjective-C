#!/usr/bin/env python3
"""Fail-closed checker for M229-B001 dispatch ABI and selector resolution contract freeze."""
...
MODE = "m229-b001-dispatch-abi-and-selector-resolution-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_b001_dispatch_abi_and_selector_resolution_contract_and_architecture_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-B001-DOC-PKT-01",
        "# M229-B001 Dispatch ABI and selector resolution Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-B001-DOC-PKT-02", "Packet: `M229-B001`"),
    SnippetCheck("M229-B001-DOC-PKT-03", "Issue: `#5312`"),
    SnippetCheck("M229-B001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M229-B001-DOC-PKT-05",
        "check:objc3c:m229-b001-dispatch-abi-and-selector-resolution-contract",
    ),
    SnippetCheck(
        "M229-B001-DOC-PKT-06",
        "tmp/reports/m229/M229-B001/dispatch_abi_and_selector_resolution_contract_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-B001-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-B001-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-B001-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-B001-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-B001-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-B001-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
