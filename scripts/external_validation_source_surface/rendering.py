...
def render_summary(
    ...
    *,
    ...
    return {
        ...
        "repro_corpus": required_paths["repro_corpus"],
        "support_claim_gate": required_paths["support_claim_gate"],
        "support_claim_gate_script": required_paths["support_claim_gate_script"],
