#!/usr/bin/env python3
"""Fail-closed contract checker for M248-B004 semantic/lowering core feature expansion."""
...
MODE = "m248-b004-semantic-lowering-test-architecture-core-feature-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_semantic_lowering_test_architecture_core_feature_expansion_b004_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_b004_semantic_lowering_test_architecture_core_feature_expansion_packet.md"
)
...
DEFAULT_B003_CHECKER = (
    ROOT / "scripts" / "check_m248_b003_semantic_lowering_test_architecture_core_feature_implementation_contract.py"
)
DEFAULT_B003_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m248_b003_semantic_lowering_test_architecture_core_feature_implementation_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B004-DOC-PKT-01",
        "# M248-B004 Semantic/Lowering Test Architecture Core Feature Expansion Packet",
    ),
    SnippetCheck("M248-B004-DOC-PKT-02", "Packet: `M248-B004`"),
    SnippetCheck("M248-B004-DOC-PKT-03", "Dependencies: `M248-B003`"),
    SnippetCheck(
        "M248-B004-DOC-PKT-04",
        "`scripts/check_m248_b004_semantic_lowering_test_architecture_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M248-B004-DOC-PKT-05",
        "`check:objc3c:m248-b004-lane-b-readiness`",
    ),
    SnippetCheck(
        "M248-B004-DOC-PKT-06",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M248-B004-DOC-PKT-07",
        "code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M248-B004-DOC-PKT-08",
        "improvements as mandatory scope inputs.",
    ),
)
...
B003_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B004-B003-DOC-01",
        "Contract ID: `objc3c-semantic-lowering-test-architecture-core-feature-implementation/m248-b003-v1`",
    ),
    SnippetCheck("M248-B004-B003-DOC-02", "- Dependencies: `M248-B002`"),
    SnippetCheck(
        "M248-B004-B003-DOC-03",
        "scripts/check_m248_b003_semantic_lowering_test_architecture_core_feature_implementation_contract.py",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m248-b004-semantic-lowering-test-architecture-core-feature-expansion-contract '
        '&& npm run test:tooling:m248-b004-semantic-lowering-test-architecture-core-feature-expansion-contract"',
    ),
    SnippetCheck("M248-B004-PKG-04", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M248-B004-PKG-05", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b003_expectations_doc, "M248-B004-B003-DOC-EXISTS", B003_EXPECTATIONS_SNIPPETS),
        (args.architecture_doc, "M248-B004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B004-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-B004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b003_checker, "M248-B004-DEP-B003-ARG-01"),
        (args.b003_test, "M248-B004-DEP-B003-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
