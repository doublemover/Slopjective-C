#!/usr/bin/env python3
"""Fail-closed checker for M235-C012 qualified type cross-lane integration sync."""
...
MODE = "m235-c012-qualified-type-lowering-and-abi-representation-cross-lane-integration-sync-contract-v1"
...
DEFAULT_C011_CHECKER = (
    ROOT / "scripts" / "check_m235_c011_qualified_type_lowering_and_abi_representation_performance_and_quality_guardrails_contract.py"
)
DEFAULT_C011_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c011_qualified_type_lowering_and_abi_representation_performance_and_quality_guardrails_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M235-C012-DEP-C011-02",
        Path("spec/planning/compiler/m235/m235_c011_qualified_type_lowering_and_abi_representation_performance_and_quality_guardrails_packet.md"),
    ),
    AssetCheck(
        "M235-C012-DEP-C011-03",
        Path("scripts/check_m235_c011_qualified_type_lowering_and_abi_representation_performance_and_quality_guardrails_contract.py"),
    ),
    AssetCheck(
        "M235-C012-DEP-C011-04",
        Path("tests/tooling/test_check_m235_c011_qualified_type_lowering_and_abi_representation_performance_and_quality_guardrails_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C012-DOC-EXP-01",
        "# M235 Qualified Type Lowering and ABI Representation Cross-lane Integration Sync Expectations (C012)",
    ),
    SnippetCheck(
        "M235-C012-DOC-EXP-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-cross-lane-integration-sync/m235-c012-v1`",
    ),
    SnippetCheck("M235-C012-DOC-EXP-03", "Dependencies: `M235-C011`"),
    SnippetCheck(
        "M235-C012-DOC-EXP-04",
        "Issue `#5822` defines canonical lane-C cross-lane integration sync scope.",
    ),
    SnippetCheck(
        "M235-C012-DOC-EXP-05",
        "optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-C012-DOC-EXP-06",
        "docs/contracts/m235_qualified_type_lowering_and_abi_representation_performance_and_quality_guardrails_c011_expectations.md",
    ),
    SnippetCheck(
        "M235-C012-DOC-EXP-07",
        "scripts/check_m235_c011_qualified_type_lowering_and_abi_representation_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M235-C012-DOC-EXP-08",
    ...
    SnippetCheck("M235-C012-DOC-EXP-09", "`C011 readiness -> C012 checker -> C012 pytest`."),
    SnippetCheck(
        "M235-C012-DOC-EXP-10",
        "`tmp/reports/m235/M235-C012/qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C012-DOC-PKT-01",
        "# M235-C012 Qualified Type Lowering and ABI Representation Cross-lane Integration Sync Packet",
    ),
    SnippetCheck("M235-C012-DOC-PKT-02", "Packet: `M235-C012`"),
    SnippetCheck("M235-C012-DOC-PKT-03", "Issue: `#5822`"),
    SnippetCheck("M235-C012-DOC-PKT-04", "Dependencies: `M235-C011`"),
    SnippetCheck(
        "M235-C012-DOC-PKT-05",
        "including code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M235-C012-DOC-PKT-06",
        "scripts/check_m235_c012_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M235-C012-DOC-PKT-07",
    ...
    SnippetCheck("M235-C012-DOC-PKT-08", "`npm run check:objc3c:m235-c011-lane-c-readiness`"),
    SnippetCheck(
        "M235-C012-DOC-PKT-09",
        "`C011 readiness -> C012 checker -> C012 pytest`",
    ),
    SnippetCheck(
        "M235-C012-DOC-PKT-10",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-C012-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-C012-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-C012-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C012-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C012-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C012-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c011_expectations_doc, "M235-C012-C011-DOC-EXISTS", C011_EXPECTATIONS_SNIPPETS),
        (args.c011_packet_doc, "M235-C012-C011-PKT-EXISTS", C011_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C012-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C012-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C012-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C012-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c011_checker, "M235-C012-DEP-C011-ARG-01"),
        (args.c011_test, "M235-C012-DEP-C011-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
