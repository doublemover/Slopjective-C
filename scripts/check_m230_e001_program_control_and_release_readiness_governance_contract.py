#!/usr/bin/env python3
"""Fail-closed checker for M230-E001 Program control and release readiness governance contract freeze."""
...
MODE = "m230-e001-program-control-and-release-readiness-governance-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_e001_program_control_and_release_readiness_governance_contract_and_architecture_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-E001-DOC-PKT-01",
        "# M230-E001 Program control and release readiness governance Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-E001-DOC-PKT-02", "Packet: `M230-E001`"),
    SnippetCheck("M230-E001-DOC-PKT-03", "Issue: `#5462`"),
    SnippetCheck("M230-E001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M230-E001-DOC-PKT-05",
        "check:objc3c:m230-e001-program-control-and-release-readiness-governance-contract",
    ),
    SnippetCheck(
        "M230-E001-DOC-PKT-06",
        "tmp/reports/m230/M230-E001/program_control_and_release_readiness_governance_contract_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-E001-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-E001-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-E001-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-E001-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-E001-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-E001-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
