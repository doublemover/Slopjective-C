#!/usr/bin/env python3
"""Fail-closed validator for M250-D021 toolchain/runtime GA advanced core workpack (shard 2)."""
...
MODE = "m250-toolchain-runtime-ga-operations-readiness-advanced-core-workpack-shard2-contract-d021-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m250"
    / "m250_d021_toolchain_runtime_ga_operations_readiness_advanced_core_workpack_shard2_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "architecture_doc": (
        ("M250-D021-ARC-01", "M250 lane-D D021 advanced core workpack (shard 2)"),
        (
            "M250-D021-ARC-02",
            "toolchain_runtime_ga_operations_advanced_core_shard2_*",
        ),
    ),
    "d020_contract_doc": (
        (
    ...
    "contract_doc": (
        ...
        (
            "M250-D021-DOC-04",
            "scripts/check_m250_d021_toolchain_runtime_ga_operations_readiness_advanced_core_workpack_shard2_contract.py",
        ),
        (
            "M250-D021-DOC-05",
            "tests/tooling/test_check_m250_d021_toolchain_runtime_ga_operations_readiness_advanced_core_workpack_shard2_contract.py",
        ),
        ("M250-D021-DOC-06", "npm run check:objc3c:m250-d021-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M250-D021-PKT-01", "Packet: `M250-D021`"),
        ("M250-D021-PKT-02", "Dependencies: `M250-D020`"),
        (
            "M250-D021-PKT-03",
            "scripts/check_m250_d021_toolchain_runtime_ga_operations_readiness_advanced_core_workpack_shard2_contract.py",
        ),
    ...
    "package_json": (
        (
            "M250-D021-CFG-01",
            '"check:objc3c:m250-d021-toolchain-runtime-ga-operations-readiness-advanced-core-workpack-shard2-contract"',
        ),
        (
            "M250-D021-CFG-02",
            '"test:tooling:m250-d021-toolchain-runtime-ga-operations-readiness-advanced-core-workpack-shard2-contract"',
        ),
        ("M250-D021-CFG-03", '"check:objc3c:m250-d021-lane-d-readiness"'),
    ),
}
