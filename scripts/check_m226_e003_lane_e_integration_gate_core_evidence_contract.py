#!/usr/bin/env python3
"""Fail-closed validator for M226-E003 lane-E integration gate core evidence."""
...
MODE = "m226-e003-lane-e-integration-gate-core-evidence-contract-v1"

DEFAULT_CONTRACT_DOC = (
    ROOT / "docs" / "contracts" / "m226_lane_e_integration_gate_e003_core_evidence_expectations.md"
)
DEFAULT_PACKET_DOC = ROOT / "spec" / "planning" / "compiler" / "m226" / "m226_e003_lane_e_integration_gate_core_evidence_packet.md"
DEFAULT_EVIDENCE_DOC = (
    ROOT / "spec" / "planning" / "compiler" / "m226" / "m226_e003_lane_e_integration_gate_core_evidence_scaffold.md"
)
DEFAULT_FREEZE_DOC = ROOT / "spec" / "planning" / "compiler" / "m226" / "m226_lane_e_contract_freeze_20260302.md"
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m226/m226_e003_lane_e_integration_gate_core_evidence_contract_summary.json")
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M226-E003-ASSET-08",
        Path("spec/planning/compiler/m226/m226_e003_lane_e_integration_gate_core_evidence_packet.md"),
    ),
    AssetCheck(
        "M226-E003-ASSET-09",
        Path("spec/planning/compiler/m226/m226_e003_lane_e_integration_gate_core_evidence_scaffold.md"),
    ),
    AssetCheck(
        "M226-E003-ASSET-10",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E003-DOC-PKT-02",
        "# M226 Lane E Integration Gate Core Evidence Packet (E003)",
    ),
    SnippetCheck("M226-E003-DOC-PKT-03", "Packet: `M226-E003`"),
    SnippetCheck("M226-E003-DOC-PKT-04", "Upstream packet dependency: `M226-E002`"),
    SnippetCheck(
        "M226-E003-DOC-PKT-05",
        "`scripts/check_m226_e003_lane_e_integration_gate_core_evidence_contract.py`",
    ),
    SnippetCheck(
        "M226-E003-DOC-PKT-06",
        "`python scripts/check_m226_e003_lane_e_integration_gate_core_evidence_contract.py`",
    ),
    SnippetCheck(
...
FREEZE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M226-E003-DOC-FRZ-02", "# M226 Lane E Contract Freeze (2026-03-02)"),
    SnippetCheck(
        "M226-E003-DOC-FRZ-03",
        "| `M226-E003` | `objc3c-lane-e-integration-gate-core-evidence-contract/m226-e003-v1` |",
    ),
    SnippetCheck("M226-E003-DOC-FRZ-04", "## Packet: `M226-E003`"),
    SnippetCheck(
        "M226-E003-DOC-FRZ-05",
        "`docs/contracts/m226_lane_e_integration_gate_e003_core_evidence_expectations.md`",
    ),
    SnippetCheck(
        "M226-E003-DOC-FRZ-06",
        "`scripts/check_m226_e003_lane_e_integration_gate_core_evidence_contract.py`",
    ),
    SnippetCheck(
        "M226-E003-DOC-FRZ-07",
        "`tests/tooling/test_check_m226_e003_lane_e_integration_gate_core_evidence_contract.py`",
    ),
    SnippetCheck(
        "M226-E003-DOC-FRZ-08",
        "`python scripts/check_m226_e003_lane_e_integration_gate_core_evidence_contract.py`",
    ),
    SnippetCheck(
        "M226-E003-DOC-FRZ-09",
        "`tmp/reports/m226/e003/evidence_index.json`",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    contract_checks, contract_findings = check_doc_contract(
        ...
        exists_check_id="M226-E003-DOC-CON-01",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M226-E003-DOC-PKT-01",
    ...
    evidence_checks, evidence_findings = check_doc_contract(
        ...
        exists_check_id="M226-E003-DOC-EVI-01",
    ...
    freeze_checks, freeze_findings = check_doc_contract(
        ...
        exists_check_id="M226-E003-DOC-FRZ-01",
    ...
    try:
        ...
        print(
            "m226-e003-lane-e-integration-gate-core-evidence-contract: "
    ...
    if not findings:
        print("m226-e003-lane-e-integration-gate-core-evidence-contract: OK")
        return 0

    print(
        "m226-e003-lane-e-integration-gate-core-evidence-contract: contract drift detected "
