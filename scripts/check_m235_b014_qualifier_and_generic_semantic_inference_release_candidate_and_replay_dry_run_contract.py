#!/usr/bin/env python3
"""Fail-closed checker for M235-B014 qualifier/generic semantic inference release-candidate and replay dry-run."""
...
MODE = "m235-b014-qualifier-and-generic-semantic-inference-release-candidate-and-replay-dry-run-contract-v1"
...
DEFAULT_B013_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_docs_and_operator_runbook_synchronization_b013_expectations.md"
)
DEFAULT_B013_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_b013_qualifier_and_generic_semantic_inference_docs_and_operator_runbook_synchronization_packet.md"
)
...
DEFAULT_B013_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m235_b013_qualifier_and_generic_semantic_inference_docs_and_operator_runbook_synchronization_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-B014-DOC-EXP-01",
        "# M235 Qualifier/Generic Semantic Inference Release-Candidate and Replay Dry-Run Expectations (B014)",
    ),
    SnippetCheck(
        "M235-B014-DOC-EXP-02",
        "Contract ID: `objc3c-qualifier-and-generic-semantic-inference-release-candidate-and-replay-dry-run/m235-b014-v1`",
    ),
    SnippetCheck("M235-B014-DOC-EXP-03", "Dependencies: `M235-B013`"),
    SnippetCheck(
        "M235-B014-DOC-EXP-04",
        "Issue `#5794` defines canonical lane-B release-candidate and replay dry-run scope.",
    ),
    SnippetCheck("M235-B014-DOC-EXP-05", "release_candidate_replay_dry_run_consistent"),
    SnippetCheck("M235-B014-DOC-EXP-06", "release_candidate_replay_dry_run_ready"),
    SnippetCheck("M235-B014-DOC-EXP-07", "release_candidate_replay_dry_run_key_ready"),
    SnippetCheck("M235-B014-DOC-EXP-08", "release_candidate_replay_dry_run_key"),
    SnippetCheck("M235-B014-DOC-EXP-09", "`M235-B013`"),
    SnippetCheck(
        "M235-B014-DOC-EXP-10",
        "`scripts/check_m235_b013_qualifier_and_generic_semantic_inference_docs_and_operator_runbook_synchronization_contract.py`",
    ),
    SnippetCheck(
        "M235-B014-DOC-EXP-11",
        "`check:objc3c:m235-b014-qualifier-and-generic-semantic-inference-release-candidate-and-replay-dry-run-contract`",
    ),
    SnippetCheck(
        "M235-B014-DOC-EXP-12",
        "`tmp/reports/m235/M235-B014/qualifier_and_generic_semantic_inference_release_candidate_and_replay_dry_run_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-B014-DOC-PKT-01",
        "# M235-B014 Qualifier/Generic Semantic Inference Release-Candidate and Replay Dry-Run Packet",
    ),
    SnippetCheck("M235-B014-DOC-PKT-02", "Packet: `M235-B014`"),
    SnippetCheck("M235-B014-DOC-PKT-03", "Issue: `#5794`"),
    SnippetCheck("M235-B014-DOC-PKT-04", "Dependencies: `M235-B013`"),
    SnippetCheck("M235-B014-DOC-PKT-05", "Theme: `release-candidate and replay dry-run`"),
    SnippetCheck(
        "M235-B014-DOC-PKT-06",
        "`scripts/check_m235_b014_qualifier_and_generic_semantic_inference_release_candidate_and_replay_dry_run_contract.py`",
    ),
    SnippetCheck(
        "M235-B014-DOC-PKT-07",
    ...
    SnippetCheck("M235-B014-DOC-PKT-08", "`npm run check:objc3c:m235-b014-lane-b-readiness`"),
)

B013_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-B014-B013-DOC-01",
        "# M235 Qualifier/Generic Semantic Inference Docs and Operator Runbook Synchronization Expectations (B013)",
    ),
    SnippetCheck(
        "M235-B014-B013-DOC-02",
        "Contract ID: `objc3c-qualifier-and-generic-semantic-inference-docs-and-operator-runbook-synchronization/m235-b013-v1`",
    ),
    SnippetCheck("M235-B014-B013-DOC-03", "Dependencies: `M235-B012`"),
)

B013_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B014-B013-PKT-01", "Packet: `M235-B013`"),
    SnippetCheck("M235-B014-B013-PKT-02", "Issue: `#5793`"),
    SnippetCheck("M235-B014-B013-PKT-03", "Dependencies: `M235-B012`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B014-META-02",
        "explicit `M235-B013` dependency continuity so release-candidate and replay dry-run drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-B014-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M235-B014-PKG-05", '"test:objc3c:perf-budget": '),
    SnippetCheck("M235-B014-PKG-06", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B014-PKG-07", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B014-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B014-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b013_expectations_doc, "M235-B014-B013-DOC-EXISTS", B013_EXPECTATIONS_SNIPPETS),
        (args.b013_packet_doc, "M235-B014-B013-PKT-EXISTS", B013_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B014-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B014-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B014-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B014-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b013_checker, "M235-B014-DEP-B013-ARG-01"),
        (args.b013_test, "M235-B014-DEP-B013-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
