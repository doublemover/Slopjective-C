#!/usr/bin/env python3
"""Fail-closed checker for M230-E024 Program control and release readiness governance contract freeze."""
...
MODE = "m230-e024-program-control-and-release-readiness-governance-advanced-conformance-workpack-shard-2-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_e024_program_control_and_release_readiness_governance_advanced_conformance_workpack_shard_2_packet.md"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-E024-PKG-03",
        '"check:objc3c:m230-e024-lane-e-readiness": '
        '"npm run check:objc3c:m230-e023-lane-e-readiness && npm run check:objc3c:m230-e024-program-control-and-release-readiness-governance-advanced-conformance-workpack-shard-2-contract '
        '&& npm run test:tooling:m230-e024-program-control-and-release-readiness-governance-advanced-conformance-workpack-shard-2-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-E024-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-E024-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-E024-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-E024-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-E024-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-E024-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
