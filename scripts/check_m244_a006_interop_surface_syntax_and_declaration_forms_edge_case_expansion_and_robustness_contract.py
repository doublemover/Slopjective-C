#!/usr/bin/env python3
"""Fail-closed checker for M244-A006 interop surface edge-case expansion and robustness contract."""
...
MODE = "m244-a006-interop-surface-syntax-and-declaration-forms-edge-case-expansion-and-robustness-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_surface_syntax_and_declaration_forms_edge_case_expansion_and_robustness_a006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_a006_interop_surface_syntax_and_declaration_forms_edge_case_expansion_and_robustness_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-A006/"
    "interop_surface_syntax_and_declaration_forms_edge_case_expansion_and_robustness_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-A006-DOC-EXP-01",
        "Contract ID: `objc3c-interop-surface-syntax-and-declaration-forms-edge-case-expansion-and-robustness/m244-a006-v1`",
    ),
    SnippetCheck("M244-A006-DOC-EXP-02", "Dependencies: `M244-A005`"),
    SnippetCheck("M244-A006-DOC-EXP-03", "Issue `#6523` defines canonical lane-A edge-case expansion and robustness scope."),
    SnippetCheck("M244-A006-DOC-EXP-04", "`check:objc3c:m244-a006-lane-a-readiness`"),
    SnippetCheck("M244-A006-DOC-EXP-05", "`check:objc3c:m244-a005-lane-a-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-A006-DOC-PKT-01", "Packet: `M244-A006`"),
    SnippetCheck("M244-A006-DOC-PKT-02", "Issue: `#6523`"),
    SnippetCheck("M244-A006-DOC-PKT-03", "Dependencies: `M244-A005`"),
    SnippetCheck(
        "M244-A006-DOC-PKT-04",
        "`scripts/check_m244_a006_interop_surface_syntax_and_declaration_forms_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M244-A006-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-A006-CFG-03", "check:objc3c:m244-a006-lane-a-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-a005-lane-a-readiness && npm run check:objc3c:m244-a006-interop-surface-syntax-declaration-forms-edge-case-expansion-and-robustness-contract && npm run test:tooling:m244-a006-interop-surface-syntax-declaration-forms-edge-case-expansion-and-robustness-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A006-ARCH-02", "`M244-A005` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A006-SPC-02", "lane-A dependency anchor (`M244-A005`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-A006-META-02",
        "explicit `M244-A005` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-A006-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-A006-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-A006-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-A006-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-A006-META-00",
