#!/usr/bin/env python3
"""Fail-closed checker for M237-E008 block conformance and replay gate contract freeze."""
...
MODE = "m237-e008-block-conformance-and-replay-gate-recovery-and-determinism-hardening-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m237_block_conformance_and_replay_gate_recovery_and_determinism_hardening_e008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m237"
    / "m237_e008_block_conformance_and_replay_gate_recovery_and_determinism_hardening_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m237/M237-E008/local_check_summary.json")
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M237-E008-DOC-PKT-01",
        "# M237-E008 Block conformance and replay gate Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M237-E008-DOC-PKT-02", "Packet: `M237-E008`"),
    SnippetCheck("M237-E008-DOC-PKT-03", "Issue: `#6039`"),
    SnippetCheck(
        "M237-E008-DOC-PKT-04",
        "Dependencies: `M237-A001`, `M237-B001`, `M237-C001`",
    ),
    SnippetCheck(
        "M237-E008-DOC-PKT-05",
        "currently-closed early lane steps",
    ),
    SnippetCheck(
        "M237-E008-DOC-PKT-06",
        "docs/contracts/m237_block_conformance_and_replay_gate_recovery_and_determinism_hardening_e008_expectations.md",
    ),
    SnippetCheck(
        "M237-E008-DOC-PKT-07",
        "scripts/check_m237_e008_block_conformance_and_replay_gate_contract.py",
    ),
    SnippetCheck(
        "M237-E008-DOC-PKT-08",
        "tests/tooling/test_check_m237_e008_block_conformance_and_replay_gate_contract.py",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M237-E008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M237-E008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
