#!/usr/bin/env python3
"""Fail-closed checker for M244-A009 interop surface conformance matrix implementation contract."""
...
MODE = "m244-a009-interop-surface-syntax-and-declaration-forms-conformance-matrix-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m244"
    / "m244_a009_interop_surface_syntax_and_declaration_forms_conformance_matrix_implementation_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-A009/"
    "interop_surface_syntax_and_declaration_forms_conformance_matrix_implementation_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-A009-DOC-EXP-01",
        "Contract ID: `objc3c-interop-surface-syntax-and-declaration-forms-conformance-matrix-implementation/m244-a009-v1`",
    ),
    SnippetCheck("M244-A009-DOC-EXP-02", "Dependencies: `M244-A008`"),
    SnippetCheck("M244-A009-DOC-EXP-03", "Issue `#6526` defines canonical lane-A conformance matrix implementation scope."),
    SnippetCheck("M244-A009-DOC-EXP-04", "`check:objc3c:m244-a009-lane-a-readiness`"),
    SnippetCheck("M244-A009-DOC-EXP-05", "`check:objc3c:m244-a008-lane-a-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-A009-DOC-PKT-01", "Packet: `M244-A009`"),
    SnippetCheck("M244-A009-DOC-PKT-02", "Issue: `#6526`"),
    SnippetCheck("M244-A009-DOC-PKT-03", "Dependencies: `M244-A008`"),
    SnippetCheck(
        "M244-A009-DOC-PKT-04",
        "`scripts/check_m244_a009_interop_surface_syntax_and_declaration_forms_conformance_matrix_implementation_contract.py`",
    ),
    SnippetCheck(
        "M244-A009-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-A009-CFG-03", "check:objc3c:m244-a009-lane-a-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-a008-lane-a-readiness && npm run check:objc3c:m244-a009-interop-surface-syntax-declaration-forms-conformance-matrix-implementation-contract && npm run test:tooling:m244-a009-interop-surface-syntax-declaration-forms-conformance-matrix-implementation-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A009-ARCH-02", "`M244-A008` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A009-SPC-02", "lane-A dependency anchor (`M244-A008`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-A009-META-02",
        "explicit `M244-A008` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-A009-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-A009-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-A009-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-A009-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-A009-META-00",
