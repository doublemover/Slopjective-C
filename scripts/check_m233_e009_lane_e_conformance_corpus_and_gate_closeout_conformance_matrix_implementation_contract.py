#!/usr/bin/env python3
"""Fail-closed checker for M233-E009 conformance corpus and gate closeout conformance matrix implementation."""
...
MODE = "m233-e009-lane-e-conformance-corpus-gate-closeout-conformance-matrix-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_lane_e_conformance_corpus_and_gate_closeout_conformance_matrix_implementation_e009_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_e009_lane_e_conformance_corpus_and_gate_closeout_conformance_matrix_implementation_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M233-E009-DEP-E008-01",
        Path("docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_e008_expectations.md"),
    ),
    AssetCheck(
        "M233-E009-DEP-E008-02",
        Path("spec/planning/compiler/m233/m233_e008_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_packet.md"),
    ),
    AssetCheck(
        "M233-E009-DEP-E008-03",
        Path("scripts/check_m233_e008_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M233-E009-DEP-E008-04",
        Path("tests/tooling/test_check_m233_e008_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E009-DOC-EXP-01",
        "# M233 Lane E Conformance Corpus and Gate Closeout Conformance Matrix Implementation Expectations (E009)",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-conformance-corpus-gate-closeout-conformance-matrix-implementation/m233-e009-v1`",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-03",
        "Issue `#5662` defines canonical lane-E conformance matrix implementation scope.",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-04",
        "Dependencies: `M233-E008`, `M233-A006`, `M233-B009`, `M233-C012`, `M233-D015`",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-05",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_e008_expectations.md",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-06",
        "`M233-A006`",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-07",
        "`M233-B009`",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-08",
        "`M233-C012`",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-09",
        "`M233-D015`",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-10",
        "conformance matrix implementation traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-11",
        "`scripts/check_m233_e009_lane_e_conformance_corpus_and_gate_closeout_conformance_matrix_implementation_contract.py`",
    ),
    SnippetCheck(
        "M233-E009-DOC-EXP-12",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E009-DOC-PKT-01",
        "# M233-E009 Lane-E Conformance Corpus and Gate Closeout Conformance Matrix Implementation Packet",
    ),
    SnippetCheck("M233-E009-DOC-PKT-02", "Packet: `M233-E009`"),
    SnippetCheck("M233-E009-DOC-PKT-03", "Issue: `#5662`"),
    SnippetCheck(
        "M233-E009-DOC-PKT-04",
        "Dependencies: `M233-E008`, `M233-A006`, `M233-B009`, `M233-C012`, `M233-D015`",
    ),
    SnippetCheck("M233-E009-DOC-PKT-05", "Theme: conformance matrix implementation"),
    SnippetCheck(
        "M233-E009-DOC-PKT-06",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_conformance_matrix_implementation_e009_expectations.md",
    ),
    SnippetCheck(
        "M233-E009-DOC-PKT-07",
        "scripts/check_m233_e009_lane_e_conformance_corpus_and_gate_closeout_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M233-E009-DOC-PKT-08",
        "tests/tooling/test_check_m233_e009_lane_e_conformance_corpus_and_gate_closeout_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M233-E009-DOC-PKT-09",
    ...
    SnippetCheck(
        "M233-E009-DOC-PKT-10",
        "conformance matrix implementation traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E009-DOC-PKT-11",
        "tmp/reports/m233/M233-E009/lane_e_conformance_corpus_gate_closeout_conformance_matrix_implementation_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-E009-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M233-E009-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M233-E009-PKG-03", '"test:objc3c:diagnostics-replay-proof": '),
    SnippetCheck("M233-E009-PKG-04", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-E009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-E009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M233-E009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
