...
BASELINE_DEPENDENCIES = ("M247-E008",)
PENDING_SEEDED_DEPENDENCY_TOKENS = ("M247-A009", "M247-B009", "M247-C009", "M247-D009")
...
INITIAL_COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    ...
    (
        ...
        "run",
        "--if-present",
        "check:objc3c:m247-c009-lane-c-readiness",
    ),
    (
        NPM_EXECUTABLE,
        "run",
...
def run_chain() -> int:
    ...
    print("[ok] M247-E009 lane-E readiness chain completed")
    return 0
