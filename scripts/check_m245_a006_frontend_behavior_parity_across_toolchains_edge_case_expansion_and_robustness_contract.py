#!/usr/bin/env python3
"""Fail-closed checker for M245-A006 frontend behavior parity edge-case expansion and robustness."""
...
MODE = "m245-a006-frontend-behavior-parity-toolchains-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_A005_CHECKER = (
    ROOT / "scripts" / "check_m245_a005_frontend_behavior_parity_across_toolchains_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_A005_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_a005_frontend_behavior_parity_across_toolchains_edge_case_and_compatibility_completion_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-A006-DOC-PKT-01",
        "# M245-A006 Frontend Behavior Parity Across Toolchains Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M245-A006-DOC-PKT-02", "Packet: `M245-A006`"),
    SnippetCheck("M245-A006-DOC-PKT-03", "Dependencies: `M245-A005`"),
    SnippetCheck(
        "M245-A006-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-A006-DOC-PKT-05",
        "scripts/check_m245_a006_frontend_behavior_parity_across_toolchains_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M245-A006-DOC-PKT-06",
...
A005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-A006-A005-PKT-01", "Packet: `M245-A005`"),
    SnippetCheck("M245-A006-A005-PKT-02", "Dependencies: `M245-A004`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-A006-META-02",
        "explicit `M245-A005` dependency continuity so edge-case expansion and robustness drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m245-a006-frontend-behavior-parity-toolchains-edge-case-expansion-and-robustness-contract '
        '&& npm run test:tooling:m245-a006-frontend-behavior-parity-toolchains-edge-case-expansion-and-robustness-contract"',
    ),
    SnippetCheck("M245-A006-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M245-A006-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-A006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-A006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a005_expectations_doc, "M245-A006-A005-DOC-EXISTS", A005_EXPECTATIONS_SNIPPETS),
        (args.a005_packet_doc, "M245-A006-A005-PKT-EXISTS", A005_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-A006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-A006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-A006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-A006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a005_checker, "M245-A006-DEP-A005-ARG-01"),
        (args.a005_test, "M245-A006-DEP-A005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
