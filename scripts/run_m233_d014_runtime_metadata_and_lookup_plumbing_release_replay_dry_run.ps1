param(
  ...
  [string]$ReportRoot = "tmp/reports/m233/M233-D014"
)
...
$summary = [ordered]@{
  contract_id = "objc3c-installer-runtime-operations-lookup-plumbing-release-candidate-replay-dry-run/m233-d014-v1"
