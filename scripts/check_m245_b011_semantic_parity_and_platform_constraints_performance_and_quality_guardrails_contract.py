#!/usr/bin/env python3
"""Fail-closed contract checker for the M245-B011 semantic parity/platform constraints performance and quality guardrails packet."""
...
MODE = "m245-b011-semantic-parity-platform-constraints-performance-and-quality-guardrails-contract-v1"
...
DEFAULT_B010_CHECKER = (
    ROOT / "scripts" / "check_m245_b010_semantic_parity_and_platform_constraints_conformance_corpus_expansion_contract.py"
)
DEFAULT_B010_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_b010_semantic_parity_and_platform_constraints_conformance_corpus_expansion_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-B011-DOC-EXP-09",
        "performance and quality guardrails dependency anchors remain explicit, deterministic, and traceable",
    ),
    SnippetCheck(
        "M245-B011-DOC-EXP-10",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B011-DOC-PKT-01",
        "# M245-B011 Semantic Parity and Platform Constraints Performance and Quality Guardrails Packet",
    ),
    SnippetCheck("M245-B011-DOC-PKT-02", "Packet: `M245-B011`"),
    SnippetCheck("M245-B011-DOC-PKT-03", "Issue: `#6633`"),
    SnippetCheck("M245-B011-DOC-PKT-04", "Dependencies: `M245-B010`"),
    SnippetCheck("M245-B011-DOC-PKT-05", "Theme: `performance and quality guardrails`"),
    SnippetCheck(
        "M245-B011-DOC-PKT-06",
        "`scripts/check_m245_b011_semantic_parity_and_platform_constraints_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M245-B011-DOC-PKT-07",
        "`tests/tooling/test_check_m245_b011_semantic_parity_and_platform_constraints_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M245-B011-DOC-PKT-08",
        "`scripts/check_m245_b010_semantic_parity_and_platform_constraints_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M245-B011-DOC-PKT-09",
        "`tests/tooling/test_check_m245_b010_semantic_parity_and_platform_constraints_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M245-B011-DOC-PKT-10",
        "including code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-B011-DOC-PKT-11",
        "`tmp/reports/m245/M245-B011/semantic_parity_and_platform_constraints_performance_and_quality_guardrails_summary.json`",
    ),
)
...
B010_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B011-B010-DOC-01",
        "Contract ID: `objc3c-semantic-parity-platform-constraints-conformance-corpus-expansion/m245-b010-v1`",
    ),
    SnippetCheck("M245-B011-B010-DOC-02", "- Issue: `#6632`"),
    SnippetCheck("M245-B011-B010-DOC-03", "- Dependencies: `M245-B009`"),
    SnippetCheck(
        "M245-B011-B010-DOC-04",
        "scripts/check_m245_b010_semantic_parity_and_platform_constraints_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-B011-B010-DOC-05",
...
B010_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-B011-B010-PKT-01", "Packet: `M245-B010`"),
    SnippetCheck("M245-B011-B010-PKT-02", "Issue: `#6632`"),
    SnippetCheck("M245-B011-B010-PKT-03", "Dependencies: `M245-B009`"),
    SnippetCheck(
        "M245-B011-B010-PKT-04",
        "scripts/check_m245_b010_semantic_parity_and_platform_constraints_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-B011-B010-PKT-05",
        "tests/tooling/test_check_m245_b010_semantic_parity_and_platform_constraints_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-B011-B010-PKT-06",
        "tmp/reports/m245/M245-B010/semantic_parity_and_platform_constraints_conformance_corpus_expansion_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-B011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-B011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b010_expectations_doc, "M245-B011-B010-DOC-EXISTS", B010_EXPECTATIONS_SNIPPETS),
        (args.b010_packet_doc, "M245-B011-B010-PKT-EXISTS", B010_PACKET_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b010_checker, "M245-B011-DEP-B010-ARG-01"),
        (args.b010_test, "M245-B011-DEP-B010-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
