#!/usr/bin/env python3
"""Fail-closed checker for M229-C013 interop boundary ABI handling contract freeze."""
...
MODE = "m229-c013-interop-boundary-abi-handling-docs-and-operator-runbook-synchronization-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_c013_interop_boundary_abi_handling_docs_and_operator_runbook_synchronization_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-C013-DOC-PKT-01",
        "# M229-C013 Interop boundary ABI handling Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M229-C013-DOC-PKT-02", "Packet: `M229-C013`"),
    SnippetCheck("M229-C013-DOC-PKT-03", "Issue: `#5341`"),
    SnippetCheck("M229-C013-DOC-PKT-04", "Dependencies: `M229-C012`"),
    SnippetCheck(
        "M229-C013-DOC-PKT-05",
        "check:objc3c:m229-c013-interop-boundary-abi-handling-docs-and-operator-runbook-synchronization-contract",
    ),
    SnippetCheck(
        "M229-C013-DOC-PKT-06",
        "tmp/reports/m229/M229-C013/interop_boundary_abi_handling_docs_and_operator_runbook_synchronization_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-C013-PKG-03",
        '"check:objc3c:m229-c013-lane-c-readiness": '
        '"npm run check:objc3c:m229-c012-lane-c-readiness && npm run check:objc3c:m229-c013-interop-boundary-abi-handling-docs-and-operator-runbook-synchronization-contract '
        '&& npm run test:tooling:m229-c013-interop-boundary-abi-handling-docs-and-operator-runbook-synchronization-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-C013-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-C013-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-C013-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-C013-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-C013-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-C013-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
