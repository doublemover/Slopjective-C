#!/usr/bin/env python3
"""Fail-closed checker for M245-D012 build/link/runtime reproducibility cross-lane integration sync."""
...
MODE = "m245-d012-build-link-runtime-reproducibility-operations-cross-lane-integration-sync-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_cross_lane_integration_sync_d012_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_d012_build_link_runtime_reproducibility_operations_cross_lane_integration_sync_packet.md"
)
...
DEFAULT_D011_CHECKER = (
    ROOT
    / "scripts"
    / "check_m245_d011_build_link_runtime_reproducibility_operations_performance_and_quality_guardrails_contract.py"
)
DEFAULT_D011_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_d011_build_link_runtime_reproducibility_operations_performance_and_quality_guardrails_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D012-DOC-PKT-01",
        "# M245-D012 Build/Link/Runtime Reproducibility Operations Cross-Lane Integration Sync Packet",
    ),
    SnippetCheck("M245-D012-DOC-PKT-02", "Packet: `M245-D012`"),
    SnippetCheck("M245-D012-DOC-PKT-03", "Issue: `#6663`"),
    SnippetCheck("M245-D012-DOC-PKT-04", "Dependencies: `M245-D011`"),
    SnippetCheck("M245-D012-DOC-PKT-05", "Theme: `cross-lane integration sync`"),
    SnippetCheck(
        "M245-D012-DOC-PKT-06",
        "dependency continuity and code/spec anchors as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D012-DOC-PKT-07",
        "scripts/check_m245_d012_build_link_runtime_reproducibility_operations_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M245-D012-DOC-PKT-08",
        "tests/tooling/test_check_m245_d012_build_link_runtime_reproducibility_operations_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M245-D012-DOC-PKT-09",
    ...
    SnippetCheck("M245-D012-DOC-PKT-10", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-D012-DOC-PKT-11",
        "`python scripts/check_m245_d012_build_link_runtime_reproducibility_operations_cross_lane_integration_sync_contract.py --emit-json`",
    ),
)
...
D011_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D012-D011-DOC-01",
        "# M245 Build/Link/Runtime Reproducibility Operations Performance and Quality Guardrails Expectations (D011)",
    ),
    SnippetCheck(
        "M245-D012-D011-DOC-02",
        "Contract ID: `objc3c-build-link-runtime-reproducibility-operations-performance-and-quality-guardrails/m245-d011-v1`",
    ),
    SnippetCheck("M245-D012-D011-DOC-03", "Dependencies: `M245-D010`"),
)

D011_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-D012-D011-PKT-01", "Packet: `M245-D011`"),
    SnippetCheck("M245-D012-D011-PKT-02", "Issue: `#6662`"),
    SnippetCheck("M245-D012-D011-PKT-03", "Dependencies: `M245-D010`"),
    SnippetCheck("M245-D012-D011-PKT-04", "Freeze date: `2026-03-04`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D012-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D012-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D012-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D012-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D012-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D012-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d011_expectations_doc, "M245-D012-D011-DOC-EXISTS", D011_EXPECTATIONS_SNIPPETS),
        (args.d011_packet_doc, "M245-D012-D011-PKT-EXISTS", D011_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D012-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D012-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D012-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D012-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d011_checker, "M245-D012-DEP-D011-ARG-01"),
        (args.d011_test, "M245-D012-DEP-D011-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
