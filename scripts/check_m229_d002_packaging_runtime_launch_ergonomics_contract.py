#!/usr/bin/env python3
"""Fail-closed checker for M229-D002 packaging and runtime launch ergonomics contract freeze."""
...
MODE = "m229-d002-packaging-runtime-launch-ergonomics-modular-split-and-scaffolding-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_d002_packaging_runtime_launch_ergonomics_modular_split_and_scaffolding_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-D002-DOC-EXP-01",
        "# M229 Packaging and runtime launch ergonomics Contract and Architecture Freeze Expectations (B001)",
    ),
    SnippetCheck(
        "M229-D002-DOC-EXP-02",
        "Contract ID: `objc3c-packaging-runtime-launch-ergonomics/m229-d002-v1`",
    ),
    SnippetCheck("M229-D002-DOC-EXP-03", "Issue: `#5352`"),
    SnippetCheck("M229-D002-DOC-EXP-04", "Dependencies: `M229-D001`"),
    SnippetCheck(
        "M229-D002-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-D002-DOC-EXP-06",
        "`check:objc3c:m229-d002-lane-d-readiness`",
    ),
    SnippetCheck(
        "M229-D002-DOC-EXP-07",
        "`tmp/reports/m229/M229-D002/packaging_runtime_launch_ergonomics_modular_split_and_scaffolding_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-D002-DOC-PKT-01",
        "# M229-D002 Packaging and runtime launch ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-D002-DOC-PKT-02", "Packet: `M229-D002`"),
    SnippetCheck("M229-D002-DOC-PKT-03", "Issue: `#5352`"),
    SnippetCheck("M229-D002-DOC-PKT-04", "Dependencies: `M229-D001`"),
    SnippetCheck(
        "M229-D002-DOC-PKT-05",
        "check:objc3c:m229-d002-packaging-runtime-launch-ergonomics-modular-split-and-scaffolding-contract",
    ),
    SnippetCheck(
        "M229-D002-DOC-PKT-06",
        "tmp/reports/m229/M229-D002/packaging_runtime_launch_ergonomics_modular_split_and_scaffolding_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-D002-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-D002-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-D002-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-D002-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-D002-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-D002-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
