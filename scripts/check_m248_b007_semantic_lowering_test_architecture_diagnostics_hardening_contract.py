#!/usr/bin/env python3
"""Fail-closed contract checker for M248-B007 semantic/lowering diagnostics hardening."""
...
MODE = "m248-b007-semantic-lowering-test-architecture-diagnostics-hardening-contract-v1"
...
DEFAULT_B006_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m248_semantic_lowering_test_architecture_edge_case_expansion_and_robustness_b006_expectations.md"
)
DEFAULT_B006_PACKET_DOC = (
    ...
    / "compiler"
    / "m248"
    / "m248_b006_semantic_lowering_test_architecture_edge_case_expansion_and_robustness_packet.md"
)
DEFAULT_B006_CHECKER = (
    ROOT / "scripts" / "check_m248_b006_semantic_lowering_test_architecture_edge_case_expansion_and_robustness_contract.py"
)
DEFAULT_B006_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m248_b006_semantic_lowering_test_architecture_edge_case_expansion_and_robustness_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B007-DOC-PKT-01",
        "# M248-B007 Semantic/Lowering Test Architecture Diagnostics Hardening Packet",
    ),
    SnippetCheck("M248-B007-DOC-PKT-02", "Packet: `M248-B007`"),
    SnippetCheck("M248-B007-DOC-PKT-03", "Issue: `#6807`"),
    SnippetCheck("M248-B007-DOC-PKT-04", "Dependencies: `M248-B006`"),
    SnippetCheck(
        "M248-B007-DOC-PKT-05",
        "`scripts/check_m248_b007_semantic_lowering_test_architecture_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-B007-DOC-PKT-06",
        "`check:objc3c:m248-b007-lane-b-readiness`",
    ),
    SnippetCheck(
        "M248-B007-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M248-B007-DOC-PKT-08",
...
B006_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B007-B006-DOC-01",
        "Contract ID: `objc3c-semantic-lowering-test-architecture-edge-case-expansion-and-robustness/m248-b006-v1`",
    ),
    SnippetCheck("M248-B007-B006-DOC-02", "- Dependencies: `M248-B005`"),
    SnippetCheck(
        "M248-B007-B006-DOC-03",
        "scripts/check_m248_b006_semantic_lowering_test_architecture_edge_case_expansion_and_robustness_contract.py",
    ),
)

B006_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-B007-B006-PKT-01", "Packet: `M248-B006`"),
    SnippetCheck("M248-B007-B006-PKT-02", "Dependencies: `M248-B005`"),
    SnippetCheck(
        "M248-B007-B006-PKT-03",
        "`scripts/check_m248_b006_semantic_lowering_test_architecture_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M248-B007-B006-PKT-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        "&& npm run check:objc3c:m248-b007-semantic-lowering-test-architecture-diagnostics-hardening-contract "
        '&& npm run test:tooling:m248-b007-semantic-lowering-test-architecture-diagnostics-hardening-contract"',
    ),
    SnippetCheck("M248-B007-PKG-04", '"check:objc3c:m248-b006-lane-b-readiness": '),
    SnippetCheck("M248-B007-PKG-05", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M248-B007-PKG-06", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B007-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B007-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b006_expectations_doc, "M248-B007-B006-DOC-EXISTS", B006_EXPECTATIONS_SNIPPETS),
        (args.b006_packet_doc, "M248-B007-B006-PKT-EXISTS", B006_PACKET_SNIPPETS),
        (args.architecture_doc, "M248-B007-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B007-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B007-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-B007-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b006_checker, "M248-B007-DEP-B006-ARG-01"),
        (args.b006_test, "M248-B007-DEP-B006-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
