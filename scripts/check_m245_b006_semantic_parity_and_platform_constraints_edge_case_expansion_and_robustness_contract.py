#!/usr/bin/env python3
"""Fail-closed contract checker for the M245-B006 semantic parity/platform constraints edge-case expansion and robustness packet."""
...
MODE = "m245-b006-semantic-parity-platform-constraints-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_B005_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m245_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_b005_expectations.md"
)
DEFAULT_B005_PACKET_DOC = (
    ...
    / "compiler"
    / "m245"
    / "m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_packet.md"
)
DEFAULT_B005_CHECKER = (
    ROOT / "scripts" / "check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_B005_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-B006-DOC-EXP-09",
        "platform variance constraints as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-B006-DOC-EXP-10",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B006-DOC-PKT-01",
        "# M245-B006 Semantic Parity and Platform Constraints Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M245-B006-DOC-PKT-02", "Packet: `M245-B006`"),
    SnippetCheck("M245-B006-DOC-PKT-03", "Issue: `#6628`"),
    SnippetCheck("M245-B006-DOC-PKT-04", "Dependencies: `M245-B005`"),
    SnippetCheck(
        "M245-B006-DOC-PKT-05",
        "`scripts/check_m245_b006_semantic_parity_and_platform_constraints_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M245-B006-DOC-PKT-06",
        "`tests/tooling/test_check_m245_b006_semantic_parity_and_platform_constraints_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M245-B006-DOC-PKT-07",
        "`scripts/check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M245-B006-DOC-PKT-08",
        "`tests/tooling/test_check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M245-B006-DOC-PKT-09",
        "dependency surfaces and platform variance constraints as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-B006-DOC-PKT-10",
        "`tmp/reports/m245/M245-B006/semantic_parity_and_platform_constraints_edge_case_expansion_and_robustness_summary.json`",
    ),
)
...
B005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B006-B005-DOC-01",
        "Contract ID: `objc3c-semantic-parity-platform-constraints-edge-case-and-compatibility-completion/m245-b005-v1`",
    ),
    SnippetCheck("M245-B006-B005-DOC-02", "- Issue: `#6627`"),
    SnippetCheck("M245-B006-B005-DOC-03", "- Dependencies: `M245-B004`"),
    SnippetCheck(
        "M245-B006-B005-DOC-04",
        "scripts/check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M245-B006-B005-DOC-05",
...
B005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-B006-B005-PKT-01", "Packet: `M245-B005`"),
    SnippetCheck("M245-B006-B005-PKT-02", "Issue: `#6627`"),
    SnippetCheck("M245-B006-B005-PKT-03", "Dependencies: `M245-B004`"),
    SnippetCheck(
        "M245-B006-B005-PKT-04",
        "scripts/check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M245-B006-B005-PKT-05",
        "tests/tooling/test_check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M245-B006-B005-PKT-06",
        "tmp/reports/m245/M245-B005/semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-B006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-B006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b005_expectations_doc, "M245-B006-B005-DOC-EXISTS", B005_EXPECTATIONS_SNIPPETS),
        (args.b005_packet_doc, "M245-B006-B005-PKT-EXISTS", B005_PACKET_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b005_checker, "M245-B006-DEP-B005-ARG-01"),
        (args.b005_test, "M245-B006-DEP-B005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
