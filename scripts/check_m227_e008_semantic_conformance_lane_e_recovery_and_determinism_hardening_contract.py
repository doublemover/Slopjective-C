#!/usr/bin/env python3
"""Fail-closed validator for M227-E008 semantic conformance lane-E recovery and determinism hardening."""
...
MODE = "m227-e008-semantic-conformance-lane-e-recovery-and-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_lane_e_semantic_conformance_recovery_and_determinism_hardening_e008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_e008_semantic_conformance_lane_e_recovery_and_determinism_hardening_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-E008-E005-01",
        "M227-E007",
        Path("docs/contracts/m227_lane_e_semantic_conformance_diagnostics_hardening_e007_expectations.md"),
    ),
    AssetCheck(
        "M227-E008-E005-02",
        "M227-E007",
        Path("scripts/check_m227_e007_semantic_conformance_lane_e_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M227-E008-E005-03",
        "M227-E007",
        Path("tests/tooling/test_check_m227_e007_semantic_conformance_lane_e_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M227-E008-E005-04",
        "M227-E007",
        Path("spec/planning/compiler/m227/m227_e007_semantic_conformance_lane_e_diagnostics_hardening_packet.md"),
    ),
    AssetCheck(
        "M227-E008-A006-01",
        "M227-A008",
    ...
    AssetCheck(
        "M227-E008-B006-01",
        "M227-B008",
        Path("docs/contracts/m227_type_system_objc3_forms_recovery_determinism_hardening_b008_expectations.md"),
    ),
    AssetCheck(
        "M227-E008-B006-02",
        "M227-B008",
        Path("scripts/check_m227_b008_type_system_objc3_forms_recovery_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M227-E008-B006-03",
        "M227-B008",
        Path("tests/tooling/test_check_m227_b008_type_system_objc3_forms_recovery_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M227-E008-B006-04",
        "M227-B008",
        Path("spec/planning/compiler/m227/m227_b008_type_system_objc3_forms_recovery_determinism_hardening_packet.md"),
    ),
    AssetCheck(
        "M227-E008-C006-01",
        "M227-C008",
        Path("docs/contracts/m227_typed_sema_to_lowering_recovery_determinism_hardening_c008_expectations.md"),
    ),
    AssetCheck(
        "M227-E008-C006-02",
        "M227-C008",
        Path("scripts/check_m227_c008_typed_sema_to_lowering_recovery_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M227-E008-C006-03",
        "M227-C008",
        Path("tests/tooling/test_check_m227_c008_typed_sema_to_lowering_recovery_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M227-E008-C006-04",
        "M227-C008",
        Path("spec/planning/compiler/m227/m227_c008_typed_sema_to_lowering_recovery_determinism_hardening_packet.md"),
    ),
    AssetCheck(
        "M227-E008-D006-01",
        "M227-D008",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E008-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-E008-EXP-08",
        "checker `scripts/check_m227_e007_semantic_conformance_lane_e_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck(
        "M227-E008-EXP-09",
    ...
    SnippetCheck(
        "M227-E008-EXP-10",
        "checker `scripts/check_m227_b008_type_system_objc3_forms_recovery_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M227-E008-EXP-11",
        "checker `scripts/check_m227_c008_typed_sema_to_lowering_recovery_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M227-E008-EXP-12",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E008-PKT-04", "Packet: `M227-E008`"),
    SnippetCheck("M227-E008-PKT-05", "Issue: `#5166`"),
    SnippetCheck("M227-E008-PKT-06", "Scaffold date: `2026-03-03`"),
    SnippetCheck(
        "M227-E008-PKT-07",
        "Dependencies: `M227-E007`, `M227-A008`, `M227-B008`, `M227-C008`, `M227-D008`",
    ),
    SnippetCheck("M227-E008-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-E008-PKT-09",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-E008-ARCH-01",
        "M227 lane-E E008 semantic conformance recovery and determinism hardening anchors dependency references",
    ),
    SnippetCheck(
        "M227-E008-ARCH-02",
        "(`M227-E007`, `M227-A008`, `M227-B008`, `M227-C008`, and `M227-D008`)",
    ),
    SnippetCheck(
        "M227-E008-ARCH-03",
        "check:objc3c:m227-e008-lane-e-readiness",
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E008-SPC-03",
        "lane-E recovery and determinism hardening evidence drift.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E008-META-03",
        "semantic conformance lane-E recovery and determinism hardening metadata governance drift fails closed.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-E008-CFG-03", "check:objc3c:m227-e008-lane-e-readiness"),
    PackageScriptKeyCheck("M227-E008-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M227-E008-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M227-E008-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-E008-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        "M227-E008-CFG-06",
        "check:objc3c:m227-e008-lane-e-readiness",
        "python scripts/check_m227_e007_semantic_conformance_lane_e_diagnostics_hardening_contract.py && python -m pytest tests/tooling/test_check_m227_e007_semantic_conformance_lane_e_diagnostics_hardening_contract.py -q && python scripts/check_m227_a008_semantic_pass_recovery_determinism_hardening_contract.py && python -m pytest tests/tooling/test_check_m227_a008_semantic_pass_recovery_determinism_hardening_contract.py -q && npm run check:objc3c:m227-b008-lane-b-readiness && npm run check:objc3c:m227-c008-lane-c-readiness && npm run check:objc3c:m227-d008-lane-d-readiness && npm run check:objc3c:m227-e008-semantic-conformance-lane-e-recovery-and-determinism-hardening-contract && npm run test:tooling:m227-e008-semantic-conformance-lane-e-recovery-and-determinism-hardening-contract",
    ),
)
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-E007": "scripts/check_m227_e007_semantic_conformance_lane_e_diagnostics_hardening_contract.py",
    "M227-A008": "scripts/check_m227_a008_semantic_pass_recovery_determinism_hardening_contract.py",
    "M227-B008": "scripts/check_m227_b008_type_system_objc3_forms_recovery_determinism_hardening_contract.py",
    "M227-C008": "scripts/check_m227_c008_typed_sema_to_lowering_recovery_determinism_hardening_contract.py",
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_text = check_document(
        ...
        exists_check_id="M227-E008-EXP-01",
        utf8_check_id="M227-E008-EXP-02",
        snippets=EXPECTATIONS_SNIPPETS,
    )
    packet_text = check_document(
        path=args.packet_doc,
        artifact="packet_doc",
        exists_check_id="M227-E008-PKT-01",
        utf8_check_id="M227-E008-PKT-02",
        snippets=PACKET_SNIPPETS,
    )
    check_document(
        path=args.architecture_doc,
        artifact="architecture_doc",
        exists_check_id="M227-E008-ARCH-00",
        utf8_check_id="M227-E008-ARCH-UTF8",
        snippets=ARCHITECTURE_SNIPPETS,
    )
    check_document(
        path=args.lowering_spec,
        artifact="lowering_spec",
        exists_check_id="M227-E008-SPC-00",
        utf8_check_id="M227-E008-SPC-UTF8",
        snippets=LOWERING_SPEC_SNIPPETS,
    )
    check_document(
        path=args.metadata_spec,
        artifact="metadata_spec",
        exists_check_id="M227-E008-META-00",
        utf8_check_id="M227-E008-META-UTF8",
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-E008-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if isinstance(package_payload, dict):
        ...
        check(
            artifact="package_json",
            check_id="M227-E008-CFG-SCRIPTS",
    ...
    if findings:
        if not args.emit_json:
            print(
                "m227-e008-semantic-conformance-lane-e-recovery-and-determinism-hardening: "
    ...
    if not args.emit_json:
        print("m227-e008-semantic-conformance-lane-e-recovery-and-determinism-hardening: OK")
        print(f"- mode={MODE}")
