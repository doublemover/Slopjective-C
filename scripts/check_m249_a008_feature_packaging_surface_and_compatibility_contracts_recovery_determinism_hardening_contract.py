#!/usr/bin/env python3
"""Fail-closed checker for M249-A008 feature packaging recovery and determinism hardening."""
...
MODE = "m249-a008-feature-packaging-surface-compatibility-recovery-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_feature_packaging_surface_and_compatibility_contracts_recovery_determinism_hardening_a008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_a008_feature_packaging_surface_and_compatibility_contracts_recovery_determinism_hardening_packet.md"
)
...
DEFAULT_A007_CHECKER = (
    ROOT / "scripts" / "check_m249_a007_feature_packaging_surface_and_compatibility_contracts_diagnostics_hardening_contract.py"
)
DEFAULT_A007_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m249_a007_feature_packaging_surface_and_compatibility_contracts_diagnostics_hardening_contract.py"
)
DEFAULT_RUNNER_SCRIPT = ROOT / "scripts" / "run_m249_a008_lane_a_readiness.py"
DEFAULT_ARCHITECTURE_DOC = ROOT / "native" / "objc3c" / "src" / "ARCHITECTURE.md"
DEFAULT_LOWERING_SPEC = ROOT / "spec" / "LOWERING_AND_RUNTIME_CONTRACTS.md"
DEFAULT_METADATA_SPEC = ROOT / "spec" / "MODULE_METADATA_AND_ABI_TABLES.md"
DEFAULT_PACKAGE_JSON = ROOT / "package.json"
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m249/M249-A008/"
    "feature_packaging_surface_and_compatibility_contracts_recovery_determinism_hardening_summary.json"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-A008-DOC-PKT-01",
        "# M249-A008 Feature Packaging Surface and Compatibility Contracts Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M249-A008-DOC-PKT-02", "Packet: `M249-A008`"),
    SnippetCheck("M249-A008-DOC-PKT-03", "Dependencies: `M249-A007`"),
    SnippetCheck(
        "M249-A008-DOC-PKT-04",
        "recovery and determinism hardening prerequisites",
    ),
    SnippetCheck(
        "M249-A008-DOC-PKT-05",
        "scripts/check_m249_a008_feature_packaging_surface_and_compatibility_contracts_recovery_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M249-A008-DOC-PKT-06",
    ...
    SnippetCheck(
        "M249-A008-DOC-PKT-07",
        "scripts/run_m249_a008_lane_a_readiness.py",
    ),
    SnippetCheck("M249-A008-DOC-PKT-08", "`npm run check:objc3c:m249-a008-lane-a-readiness`"),
    SnippetCheck("M249-A008-DOC-PKT-09", "`check:objc3c:m249-a007-lane-a-readiness`"),
)

A007_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-A008-A007-DOC-01",
        "# M249 Feature Packaging Surface and Compatibility Contracts Diagnostics Hardening Expectations (A007)",
    ),
    SnippetCheck(
        "M249-A008-A007-DOC-02",
        "Contract ID: `objc3c-feature-packaging-surface-compatibility-contracts-diagnostics-hardening/m249-a007-v1`",
    ),
    SnippetCheck("M249-A008-A007-DOC-03", "Dependencies: `M249-A006`"),
)

A007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-A008-A007-PKT-01", "Packet: `M249-A007`"),
    SnippetCheck("M249-A008-A007-PKT-02", "Dependencies: `M249-A006`"),
    SnippetCheck("M249-A008-A007-PKT-03", "scripts/run_m249_a007_lane_a_readiness.py"),
)
...
RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-A008-RUN-04",
        "M249-A008 lane-A readiness chain completed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-A008-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M249-A008-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--a007-checker", type=Path, default=DEFAULT_A007_CHECKER)
    parser.add_argument("--a007-test", type=Path, default=DEFAULT_A007_TEST)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-A008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-A008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a007_expectations_doc, "M249-A008-A007-DOC-EXISTS", A007_EXPECTATIONS_SNIPPETS),
        (args.a007_packet_doc, "M249-A008-A007-PKT-EXISTS", A007_PACKET_SNIPPETS),
        (args.runner_script, "M249-A008-RUN-EXISTS", RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-A008-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-A008-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-A008-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-A008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a007_checker, "M249-A008-DEP-A007-ARG-01"),
        (args.a007_test, "M249-A008-DEP-A007-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
