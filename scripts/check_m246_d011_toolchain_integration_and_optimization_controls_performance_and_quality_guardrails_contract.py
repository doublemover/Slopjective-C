#!/usr/bin/env python3
"""Fail-closed checker for M246-D011 toolchain integration/optimization controls performance and quality guardrails."""
...
MODE = "m246-d011-toolchain-integration-optimization-controls-performance-and-quality-guardrails-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_d011_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D011-DOC-PKT-01",
        "# M246-D011 Toolchain Integration and Optimization Controls Performance and Quality Guardrails Packet",
    ),
    SnippetCheck("M246-D011-DOC-PKT-02", "Packet: `M246-D011`"),
    SnippetCheck("M246-D011-DOC-PKT-03", "Issue: `#6690`"),
    SnippetCheck("M246-D011-DOC-PKT-04", "Dependencies: `M246-D010`"),
    SnippetCheck("M246-D011-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-D011-DOC-PKT-06", "Dependency anchors from `M246-D010`:"),
    SnippetCheck(
        "M246-D011-DOC-PKT-07",
        "scripts/run_m246_d011_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M246-D011-DOC-PKT-08",
    ...
    SnippetCheck(
        "M246-D011-DOC-PKT-09",
        "`D010 readiness -> D011 checker -> D011 pytest`",
    ),
    SnippetCheck(
        "M246-D011-DOC-PKT-10",
        "tmp/reports/m246/M246-D011/toolchain_integration_optimization_controls_performance_and_quality_guardrails_contract_summary.json",
    ),
)
...
D010_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D011-D010-DOC-01",
        "Contract ID: `objc3c-toolchain-integration-optimization-controls-conformance-corpus-expansion/m246-d010-v1`",
    ),
    SnippetCheck(
        "M246-D011-D010-DOC-02",
        "Dependencies: `M246-D009`",
    ),
    SnippetCheck(
        "M246-D011-D010-DOC-03",
        "Issue `#6689` defines canonical lane-D conformance corpus expansion scope.",
    ),
)

D010_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D011-D010-PKT-01", "Packet: `M246-D010`"),
    SnippetCheck("M246-D011-D010-PKT-02", "Issue: `#6689`"),
    SnippetCheck("M246-D011-D010-PKT-03", "Dependencies: `M246-D009`"),
    SnippetCheck("M246-D011-D010-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D011-RDY-01", 'DEPENDENCY_TOKEN = "M246-D010"'),
    SnippetCheck(
        "M246-D011-RDY-02",
    ...
    SnippetCheck("M246-D011-RDY-05", "[ok] M246-D011 lane-D readiness chain completed"),
)

D010_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D011-D010-RDY-01", 'DEPENDENCY_TOKEN = "M246-D009"'),
    SnippetCheck(
        "M246-D011-D010-RDY-02",
        "scripts/run_m246_d009_lane_d_readiness.py",
    ),
    SnippetCheck("M246-D011-D010-RDY-03", "[ok] M246-D010 lane-D readiness chain completed"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-D011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-D011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d010_expectations_doc, "M246-D011-D010-DOC-EXISTS", D010_EXPECTATIONS_SNIPPETS),
        (args.d010_packet_doc, "M246-D011-D010-PKT-EXISTS", D010_PACKET_SNIPPETS),
        (args.readiness_script, "M246-D011-RDY-EXISTS", READINESS_SNIPPETS),
        (args.d010_readiness_script, "M246-D011-D010-RDY-EXISTS", D010_READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d010_checker, "M246-D011-DEP-D010-ARG-01"),
        (args.d010_test, "M246-D011-DEP-D010-ARG-02"),
    ):
    ...
    if not summary_ok:
        print(
            f"[M246-D011-SUMMARY-WRITE-01] {display_path(summary_path)}: {summary_error}",
            file=sys.stderr,
        )
        return 1
