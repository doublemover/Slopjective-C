#!/usr/bin/env python3
"""Fail-closed checker for M247-B004 semantic hot-path core feature expansion."""
...
MODE = "m247-b004-semantic-hot-path-analysis-and-budgeting-core-feature-expansion-contract-v1"
...
DEFAULT_B003_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m247_b003_semantic_hot_path_analysis_and_budgeting_core_feature_implementation_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B004-DOC-PKT-01",
        "# M247-B004 Semantic Hot-Path Analysis and Budgeting Core Feature Expansion Packet",
    ),
    SnippetCheck("M247-B004-DOC-PKT-02", "Packet: `M247-B004`"),
    SnippetCheck("M247-B004-DOC-PKT-03", "Issue: `#6727`"),
    SnippetCheck("M247-B004-DOC-PKT-04", "Dependencies: `M247-B003`"),
    SnippetCheck("M247-B004-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-B004-DOC-PKT-06",
        "`scripts/check_m247_b004_semantic_hot_path_analysis_and_budgeting_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M247-B004-DOC-PKT-07",
        "`tests/tooling/test_check_m247_b004_semantic_hot_path_analysis_and_budgeting_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M247-B004-DOC-PKT-08",
        "`scripts/run_m247_b004_lane_b_readiness.py`",
    ),
    SnippetCheck(
        "M247-B004-DOC-PKT-09",
        "`B003 readiness -> B004 checker -> B004 pytest`",
    ),
    SnippetCheck(
        "M247-B004-DOC-PKT-10",
        "tmp/reports/m247/M247-B004/semantic_hot_path_analysis_and_budgeting_core_feature_expansion_contract_summary.json",
    ),
)
...
B003_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-B004-B003-DOC-01",
        "Contract ID: `objc3c-semantic-hot-path-analysis-and-budgeting-core-feature-implementation/m247-b003-v1`",
    ),
    SnippetCheck("M247-B004-B003-DOC-02", "Dependencies: `M247-B002`"),
    SnippetCheck(
        "M247-B004-B003-DOC-03",
        "Issue `#6726` defines canonical lane-B core feature implementation scope.",
    ),
)

B003_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B004-B003-PKT-01", "Packet: `M247-B003`"),
    SnippetCheck("M247-B004-B003-PKT-02", "Issue: `#6726`"),
    SnippetCheck("M247-B004-B003-PKT-03", "Dependencies: `M247-B002`"),
    SnippetCheck("M247-B004-B003-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B004-RUN-01", 'DEPENDENCY_TOKEN = "M247-B003"'),
    SnippetCheck("M247-B004-RUN-02", "scripts/run_m247_b003_lane_b_readiness.py"),
    SnippetCheck("M247-B004-RUN-03", "[ok] M247-B004 lane-B readiness chain completed"),
)

B003_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-B004-B003-RUN-01", 'DEPENDENCY_TOKEN = "M247-B002"'),
    SnippetCheck(
        "M247-B004-B003-RUN-02",
        "scripts/check_m247_b003_semantic_hot_path_analysis_and_budgeting_core_feature_implementation_contract.py",
    ),
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-B004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-B004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b003_expectations_doc, "M247-B004-B003-DOC-EXISTS", B003_EXPECTATIONS_SNIPPETS),
    ...
    for path, check_id in (
        (args.b003_checker, "M247-B004-DEP-B003-ARG-01"),
        (args.b003_test, "M247-B004-DEP-B003-ARG-02"),
    ):
    ...
    if not wrote_summary:
        print(
            f"[M247-B004-SUMMARY-WRITE-01] {display_path(summary_path)}: {error_message}",
            file=sys.stderr,
        )
        return 1
