#!/usr/bin/env python3
"""Fail-closed checker for M229-D011 packaging and runtime launch ergonomics contract freeze."""
...
MODE = "m229-d011-packaging-runtime-launch-ergonomics-performance-and-quality-guardrails-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_d011_packaging_runtime_launch_ergonomics_performance_and_quality_guardrails_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-D011-DOC-PKT-01",
        "# M229-D011 Packaging and runtime launch ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-D011-DOC-PKT-02", "Packet: `M229-D011`"),
    SnippetCheck("M229-D011-DOC-PKT-03", "Issue: `#5361`"),
    SnippetCheck("M229-D011-DOC-PKT-04", "Dependencies: `M229-D010`"),
    SnippetCheck(
        "M229-D011-DOC-PKT-05",
        "check:objc3c:m229-d011-packaging-runtime-launch-ergonomics-performance-and-quality-guardrails-contract",
    ),
    SnippetCheck(
        "M229-D011-DOC-PKT-06",
        "tmp/reports/m229/M229-D011/packaging_runtime_launch_ergonomics_performance_and_quality_guardrails_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-D011-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-D011-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-D011-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-D011-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-D011-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-D011-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
