...
ABI_API_DRIFT_PY = ROOT / "scripts" / "check_objc3c_release_abi_api_drift.py"
...
ABI_API_DRIFT_SUMMARY_PATH = ROOT / "tmp" / "reports" / "release-foundation" / "abi-api-drift-summary.json"
