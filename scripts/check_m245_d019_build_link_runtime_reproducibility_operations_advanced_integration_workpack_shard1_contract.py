#!/usr/bin/env python3
"""Fail-closed checker for M245-D019 build/link/runtime reproducibility advanced integration workpack shard 1."""
...
MODE = "m245-d019-build-link-runtime-reproducibility-operations-advanced-integration-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_advanced_integration_workpack_shard1_d019_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_d019_build_link_runtime_reproducibility_operations_advanced_integration_workpack_shard1_packet.md"
)
DEFAULT_D018_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_advanced_conformance_workpack_shard1_d018_expectations.md"
)
DEFAULT_D018_PACKET_DOC = (
    ...
    / "compiler"
    / "m245"
    / "m245_d018_build_link_runtime_reproducibility_operations_advanced_conformance_workpack_shard1_packet.md"
)
DEFAULT_D018_CHECKER = (
    ROOT
    / "scripts"
    / "check_m245_d018_build_link_runtime_reproducibility_operations_advanced_conformance_workpack_shard1_contract.py"
)
DEFAULT_D018_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_d018_build_link_runtime_reproducibility_operations_advanced_conformance_workpack_shard1_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D019-DOC-PKT-01",
        "# M245-D019 Build/Link/Runtime Reproducibility Operations Advanced Integration Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M245-D019-DOC-PKT-02", "Packet: `M245-D019`"),
    SnippetCheck("M245-D019-DOC-PKT-03", "Issue: `#6670`"),
    SnippetCheck("M245-D019-DOC-PKT-04", "Dependencies: `M245-D018`"),
    SnippetCheck("M245-D019-DOC-PKT-05", "Theme: `advanced integration workpack (shard 1)`"),
    SnippetCheck(
        "M245-D019-DOC-PKT-06",
        "dependency continuity and code/spec anchors as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D019-DOC-PKT-07",
        "scripts/check_m245_d019_build_link_runtime_reproducibility_operations_advanced_integration_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D019-DOC-PKT-08",
        "tests/tooling/test_check_m245_d019_build_link_runtime_reproducibility_operations_advanced_integration_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D019-DOC-PKT-09",
    ...
    SnippetCheck("M245-D019-DOC-PKT-10", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-D019-DOC-PKT-11",
        "`python scripts/check_m245_d019_build_link_runtime_reproducibility_operations_advanced_integration_workpack_shard1_contract.py --emit-json`",
    ),
)
...
D018_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D019-D018-DOC-01",
        "# M245 Build/Link/Runtime Reproducibility Operations Advanced Conformance Workpack (Shard 1) Expectations (D018)",
    ),
    SnippetCheck(
        "M245-D019-D018-DOC-02",
        "Contract ID: `objc3c-build-link-runtime-reproducibility-operations-advanced-conformance-workpack-shard1/m245-d018-v1`",
    ),
    SnippetCheck("M245-D019-D018-DOC-03", "Dependencies: `M245-D017`"),
)

D018_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-D019-D018-PKT-01", "Packet: `M245-D018`"),
    SnippetCheck("M245-D019-D018-PKT-02", "Issue: `#6669`"),
    SnippetCheck("M245-D019-D018-PKT-03", "Dependencies: `M245-D017`"),
    SnippetCheck("M245-D019-D018-PKT-04", "Freeze date: `2026-03-04`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D019-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D019-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D019-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D019-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D019-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D019-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d018_expectations_doc, "M245-D019-D018-DOC-EXISTS", D018_EXPECTATIONS_SNIPPETS),
        (args.d018_packet_doc, "M245-D019-D018-PKT-EXISTS", D018_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D019-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D019-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D019-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D019-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d018_checker, "M245-D019-DEP-D018-ARG-01"),
        (args.d018_test, "M245-D019-DEP-D018-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
