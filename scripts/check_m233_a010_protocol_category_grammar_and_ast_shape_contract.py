#!/usr/bin/env python3
"""Fail-closed checker for M233-A010 protocol/category grammar and AST shape contract freeze."""
...
MODE = "m233-a010-protocol-category-grammar-and-ast-shape-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_a010_protocol_category_grammar_and_ast_shape_conformance_corpus_expansion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-A010-DOC-PKT-01",
        "# M233-A010 Protocol/category grammar and AST shape Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M233-A010-DOC-PKT-02", "Packet: `M233-A010`"),
    SnippetCheck("M233-A010-DOC-PKT-03", "Issue: `#4906`"),
    SnippetCheck("M233-A010-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M233-A010-DOC-PKT-05",
        "check:objc3c:m233-a010-protocol-category-grammar-and-ast-shape-contract",
    ),
    SnippetCheck(
        "M233-A010-DOC-PKT-06",
        "tmp/reports/m233/M233-A010/protocol_category_grammar_and_ast_shape_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-A010-PKG-03",
        '"check:objc3c:m233-a010-lane-a-readiness": '
        '"npm run check:objc3c:m233-a010-protocol-category-grammar-and-ast-shape-contract '
        '&& npm run test:tooling:m233-a010-protocol-category-grammar-and-ast-shape-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M233-A010-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M233-A010-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M233-A010-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M233-A010-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M233-A010-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M233-A010-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
