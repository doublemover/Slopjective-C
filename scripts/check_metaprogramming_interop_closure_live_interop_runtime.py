...
def main() -> int:
    ...
    checks = {
        ...
        "bridge_surface_keeps_private_header_boundary": bridge_surface.get("internal_header_path") == "native/objc3c/src/runtime/objc3_runtime_bootstrap_internal.h" and bridge_surface.get("public_header_path") == "native/objc3c/src/runtime/public/objc3_runtime_api.h",
