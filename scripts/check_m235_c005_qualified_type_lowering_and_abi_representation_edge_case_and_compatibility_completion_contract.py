#!/usr/bin/env python3
"""Fail-closed checker for M235-C005 qualified type edge-case and compatibility completion."""
...
MODE = "m235-c005-qualified-type-lowering-and-abi-representation-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_C004_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m235_qualified_type_lowering_and_abi_representation_core_feature_expansion_c004_expectations.md"
)
DEFAULT_C004_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_c004_qualified_type_lowering_and_abi_representation_core_feature_expansion_packet.md"
)
DEFAULT_C004_CHECKER = (
    ROOT / "scripts" / "check_m235_c004_qualified_type_lowering_and_abi_representation_core_feature_expansion_contract.py"
)
DEFAULT_C004_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c004_qualified_type_lowering_and_abi_representation_core_feature_expansion_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C005-DOC-PKT-01",
        "# M235-C005 Qualified Type Lowering and ABI Representation Edge-case and Compatibility Completion Packet",
    ),
    SnippetCheck("M235-C005-DOC-PKT-02", "Packet: `M235-C005`"),
    SnippetCheck("M235-C005-DOC-PKT-03", "Issue: `#5815`"),
    SnippetCheck("M235-C005-DOC-PKT-04", "Dependencies: `M235-C004`"),
    SnippetCheck(
        "M235-C005-DOC-PKT-05",
        "including code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M235-C005-DOC-PKT-06",
    ...
    SnippetCheck("M235-C005-DOC-PKT-08", "`npm run check:objc3c:m235-c004-lane-c-readiness`"),
    SnippetCheck(
        "M235-C005-DOC-PKT-09",
        "`C004 readiness -> C005 checker -> C005 pytest`",
    ),
    SnippetCheck(
        "M235-C005-DOC-PKT-10",
...
C004_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C005-C004-DOC-01",
        "# M235 Qualified Type Lowering and ABI Representation Core Feature Expansion Expectations (C004)",
    ),
    SnippetCheck(
        "M235-C005-C004-DOC-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-core-feature-expansion/m235-c004-v1`",
    ),
    SnippetCheck("M235-C005-C004-DOC-03", "Dependencies: `M235-C003`"),
    SnippetCheck(
        "M235-C005-C004-DOC-04",
        "Issue `#5814` defines canonical lane-C core feature expansion scope.",
    ),
)

C004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-C005-C004-PKT-01", "Packet: `M235-C004`"),
    SnippetCheck("M235-C005-C004-PKT-02", "Issue: `#5814`"),
    SnippetCheck("M235-C005-C004-PKT-03", "Dependencies: `M235-C003`"),
    SnippetCheck("M235-C005-C004-PKT-04", "Freeze date: `2026-03-05`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-C005-PKG-03",
        '"check:objc3c:m235-c004-lane-c-readiness": '
        '"npm run check:objc3c:m235-c003-lane-c-readiness '
        '&& npm run check:objc3c:m235-c004-qualified-type-lowering-and-abi-representation-core-feature-expansion-contract '
        '&& npm run test:tooling:m235-c004-qualified-type-lowering-and-abi-representation-core-feature-expansion-contract"',
    ),
    SnippetCheck(
        "M235-C005-PKG-04",
    ...
    SnippetCheck("M235-C005-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-C005-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-C005-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C005-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c004_expectations_doc, "M235-C005-C004-DOC-EXISTS", C004_EXPECTATIONS_SNIPPETS),
        (args.c004_packet_doc, "M235-C005-C004-PKT-EXISTS", C004_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c004_checker, "M235-C005-DEP-C004-ARG-01"),
        (args.c004_test, "M235-C005-DEP-C004-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
