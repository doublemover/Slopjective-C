#!/usr/bin/env python3
"""Fail-closed checker for M246-C004 IR optimization pass wiring core feature expansion."""
...
MODE = "m246-c004-ir-optimization-pass-wiring-validation-core-feature-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m246_ir_optimization_pass_wiring_and_validation_core_feature_expansion_c004_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m246"
    / "m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_packet.md"
)
...
DEFAULT_C003_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m246_ir_optimization_pass_wiring_and_validation_core_feature_implementation_c003_expectations.md"
)
DEFAULT_C003_PACKET_DOC = (
    ...
    / "compiler"
    / "m246"
    / "m246_c003_ir_optimization_pass_wiring_and_validation_core_feature_implementation_packet.md"
)
DEFAULT_C003_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c003_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c004_lane_c_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M246-C004-DEP-C002-03",
        Path("scripts/check_m246_c002_ir_optimization_pass_wiring_and_validation_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-C004-DEP-C002-04",
        Path("tests/tooling/test_check_m246_c002_ir_optimization_pass_wiring_and_validation_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-C004-DEP-C003-01",
        Path("docs/contracts/m246_ir_optimization_pass_wiring_and_validation_core_feature_implementation_c003_expectations.md"),
    ),
    AssetCheck(
        "M246-C004-DEP-C003-02",
        Path("spec/planning/compiler/m246/m246_c003_ir_optimization_pass_wiring_and_validation_core_feature_implementation_packet.md"),
    ),
    AssetCheck(
        "M246-C004-DEP-C003-03",
        Path("scripts/check_m246_c003_ir_optimization_pass_wiring_and_validation_core_feature_implementation_contract.py"),
    ),
    AssetCheck(
        "M246-C004-DEP-C003-04",
        Path("tests/tooling/test_check_m246_c003_ir_optimization_pass_wiring_and_validation_core_feature_implementation_contract.py"),
    ),
    AssetCheck(
        "M246-C004-DEP-C003-05",
        Path("scripts/run_m246_c003_lane_c_readiness.py"),
    ),
    AssetCheck(
        "M246-C004-OWN-01",
        Path("docs/contracts/m246_ir_optimization_pass_wiring_and_validation_core_feature_expansion_c004_expectations.md"),
    ),
    AssetCheck(
        "M246-C004-OWN-02",
        Path("spec/planning/compiler/m246/m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_packet.md"),
    ),
    AssetCheck(
        "M246-C004-OWN-03",
        Path("scripts/check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M246-C004-OWN-04",
        Path("tests/tooling/test_check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M246-C004-OWN-05",
        Path("scripts/run_m246_c004_lane_c_readiness.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C004-DOC-EXP-01",
        "# M246 IR Optimization Pass Wiring and Validation Core Feature Expansion Expectations (C004)",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-02",
        "Contract ID: `objc3c-ir-optimization-pass-wiring-validation-core-feature-expansion/m246-c004-v1`",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-03",
        "Issue `#5080` defines canonical lane-C core feature expansion scope.",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-04",
        "Dependencies: `M246-C003`",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-05",
        "Predecessor anchors inherited via `M246-C003`: `M246-C001`, `M246-C002`.",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-06",
        "docs/contracts/m246_ir_optimization_pass_wiring_and_validation_core_feature_implementation_c003_expectations.md",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-07",
        "scripts/run_m246_c003_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-08",
        "scripts/check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-09",
        "tests/tooling/test_check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-10",
        "improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-C004-DOC-EXP-11",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C004-DOC-PKT-01",
        "# M246-C004 IR Optimization Pass Wiring and Validation Core Feature Expansion Packet",
    ),
    SnippetCheck("M246-C004-DOC-PKT-02", "Packet: `M246-C004`"),
    SnippetCheck("M246-C004-DOC-PKT-03", "Issue: `#5080`"),
    SnippetCheck("M246-C004-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-C004-DOC-PKT-05", "Dependencies: `M246-C003`"),
    SnippetCheck(
        "M246-C004-DOC-PKT-06",
        "Predecessor anchors inherited via `M246-C003`: `M246-C001`, `M246-C002`.",
    ),
    SnippetCheck(
        "M246-C004-DOC-PKT-07",
        "scripts/check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-C004-DOC-PKT-08",
        "tests/tooling/test_check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-C004-DOC-PKT-09",
        "scripts/run_m246_c004_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C004-DOC-PKT-10",
        "scripts/run_m246_c003_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C004-DOC-PKT-11",
        "treated as mandatory scope",
    ),
    SnippetCheck(
        "M246-C004-DOC-PKT-12",
        "python scripts/check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py --emit-json --summary-out tmp/reports/m246/M246-C004/ir_optimization_pass_wiring_validation_core_feature_expansion_summary.json",
    ),
    SnippetCheck(
        "M246-C004-DOC-PKT-13",
        "tmp/reports/m246/M246-C004/ir_optimization_pass_wiring_validation_core_feature_expansion_summary.json",
    ),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C004-C001-02", "Dependencies: none"),
)
...
READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-C004-RUN-04",
        "[ok] M246-C004 lane-C readiness chain completed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C004-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-C004-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-C004-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C004-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c003-readiness-script", type=Path, default=DEFAULT_C003_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M246-C004-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M246-C004-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.c003_expectations_doc, "M246-C004-C003-EXP-EXISTS", C003_EXPECTATIONS_SNIPPETS),
        (args.c003_packet_doc, "M246-C004-C003-PKT-EXISTS", C003_PACKET_SNIPPETS),
        (args.c003_readiness_script, "M246-C004-C003-RUN-EXISTS", C003_READINESS_SNIPPETS),
        (args.readiness_script, "M246-C004-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M246-C004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
