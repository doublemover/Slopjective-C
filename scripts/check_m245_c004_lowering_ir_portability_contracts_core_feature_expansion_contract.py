#!/usr/bin/env python3
"""Fail-closed contract checker for M245-C004 lowering/IR portability core feature expansion."""
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-C004-DOC-PKT-01",
        "# M245-C004 Lowering/IR Portability Contracts Core Feature Expansion Packet",
    ),
    SnippetCheck("M245-C004-DOC-PKT-02", "Packet: `M245-C004`"),
    SnippetCheck("M245-C004-DOC-PKT-03", "Issue: `#6639`"),
    SnippetCheck("M245-C004-DOC-PKT-04", "Dependencies: `M245-C003`"),
    SnippetCheck("M245-C004-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-C004-DOC-PKT-06",
        "m245_c003_lowering_ir_portability_contracts_core_feature_implementation_packet.md",
    ),
    SnippetCheck(
        "M245-C004-DOC-PKT-07",
        "`check:objc3c:m245-c004-lane-c-readiness`",
    ),
    SnippetCheck(
        "M245-C004-DOC-PKT-08",
        "python scripts/check_m245_c004_lowering_ir_portability_contracts_core_feature_expansion_contract.py --emit-json",
    ),
    SnippetCheck(
        "M245-C004-DOC-PKT-09",
        "improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-C004-DOC-PKT-10",
        "tmp/reports/m245/M245-C004/lowering_ir_portability_contracts_core_feature_expansion_summary.json",
    ),
)
...
C003_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-C004-C003-PKT-01", "Packet: `M245-C003`"),
    SnippetCheck("M245-C004-C003-PKT-02", "Dependencies: `M245-C001`, `M245-C002`"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-C004-SPC-01",
        "lowering/IR portability contracts core feature expansion shall preserve explicit lane-C dependency token (`M245-C003`)",
    ),
    SnippetCheck(
        "M245-C004-SPC-02",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-C004-META-02",
        "with explicit `M245-C003` dependency continuity and fail-closed core-feature expansion evidence continuity",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-C004-PKG-04", '"test:objc3c:lowering-replay-proof": '),
    SnippetCheck("M245-C004-PKG-05", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-C004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-C004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c003_expectations_doc, "M245-C004-C003-EXISTS", C003_EXPECTATIONS_SNIPPETS),
        (args.c003_packet_doc, "M245-C004-C003-PKT-EXISTS", C003_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-C004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-C004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-C004-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-C004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
