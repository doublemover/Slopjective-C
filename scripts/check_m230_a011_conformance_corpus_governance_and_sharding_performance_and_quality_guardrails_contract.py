#!/usr/bin/env python3
"""Fail-closed checker for M230-A011 conformance corpus governance/sharding performance and quality guardrails."""
...
MODE = "m230-a011-conformance-corpus-governance-and-sharding-performance-and-quality-guardrails-contract-v1"
...
DEFAULT_A010_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_a010_conformance_corpus_governance_and_sharding_conformance_corpus_expansion_packet.md"
)
DEFAULT_A010_CHECKER = (
    ROOT / "scripts" / "check_m230_a010_conformance_corpus_governance_and_sharding_conformance_corpus_expansion_contract.py"
)
DEFAULT_A010_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m230_a010_conformance_corpus_governance_and_sharding_conformance_corpus_expansion_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[tuple[str, Path], ...] = (
    (
        "M230-A011-DEP-A010-01",
        Path("docs/contracts/m230_conformance_corpus_governance_and_sharding_conformance_corpus_expansion_a010_expectations.md"),
    ),
    (
        "M230-A011-DEP-A010-02",
        Path("spec/planning/compiler/m230/m230_a010_conformance_corpus_governance_and_sharding_conformance_corpus_expansion_packet.md"),
    ),
    (
        "M230-A011-DEP-A010-03",
        Path("scripts/check_m230_a010_conformance_corpus_governance_and_sharding_conformance_corpus_expansion_contract.py"),
    ),
    (
        "M230-A011-DEP-A010-04",
        Path("tests/tooling/test_check_m230_a010_conformance_corpus_governance_and_sharding_conformance_corpus_expansion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-A011-DOC-EXP-01",
        "# M230 Conformance Corpus Governance and Sharding Performance and Quality Guardrails Expectations (A011)",
    ),
    SnippetCheck(
        "M230-A011-DOC-EXP-02",
        "Contract ID: `objc3c-conformance-corpus-governance-and-sharding-performance-and-quality-guardrails/m230-a011-v1`",
    ),
    SnippetCheck("M230-A011-DOC-EXP-03", "Dependencies: `M230-A010`"),
    SnippetCheck(
        "M230-A011-DOC-EXP-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-A011-DOC-EXP-05",
        "check:objc3c:m230-a011-conformance-corpus-governance-and-sharding-performance-and-quality-guardrails-contract",
    ),
    SnippetCheck(
        "M230-A011-DOC-EXP-06",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-A011-DOC-PKT-01",
        "# M230-A011 Conformance Corpus Governance and Sharding Performance and Quality Guardrails Packet",
    ),
    SnippetCheck("M230-A011-DOC-PKT-02", "Packet: `M230-A011`"),
    SnippetCheck("M230-A011-DOC-PKT-03", "Dependencies: `M230-A010`"),
    SnippetCheck(
        "M230-A011-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-A011-DOC-PKT-05",
...
A010_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M230-A011-A010-PKT-01", "Packet: `M230-A010`"),
    SnippetCheck("M230-A011-A010-PKT-02", "Dependencies: `M230-A009`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m230-a011-conformance-corpus-governance-and-sharding-performance-and-quality-guardrails-contract '
        '&& npm run test:tooling:m230-a011-conformance-corpus-governance-and-sharding-performance-and-quality-guardrails-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M230-A011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M230-A011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a010_expectations_doc, "M230-A011-A010-EXP-EXISTS", A010_EXPECTATIONS_SNIPPETS),
        (args.a010_packet_doc, "M230-A011-A010-PKT-EXISTS", A010_PACKET_SNIPPETS),
        (args.architecture_doc, "M230-A011-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M230-A011-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M230-A011-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M230-A011-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
