#!/usr/bin/env python3
"""Fail-closed checker for M229-A009 class/protocol/category metadata conformance matrix implementation."""
...
MODE = "m229-a009-class-protocol-category-metadata-generation-conformance-matrix-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_a009_class_protocol_category_metadata_generation_conformance_matrix_implementation_packet.md"
)
...
DEFAULT_A008_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_a008_class_protocol_category_metadata_generation_recovery_and_determinism_hardening_packet.md"
)
DEFAULT_A008_CHECKER = (
    ROOT / "scripts" / "check_m229_a008_class_protocol_category_metadata_generation_recovery_and_determinism_hardening_contract.py"
)
DEFAULT_A008_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m229_a008_class_protocol_category_metadata_generation_recovery_and_determinism_hardening_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[tuple[str, Path], ...] = (
    (
        "M229-A009-DEP-A008-01",
        Path("docs/contracts/m229_class_protocol_category_metadata_generation_recovery_and_determinism_hardening_a008_expectations.md"),
    ),
    (
        "M229-A009-DEP-A008-02",
        Path("spec/planning/compiler/m229/m229_a008_class_protocol_category_metadata_generation_recovery_and_determinism_hardening_packet.md"),
    ),
    (
        "M229-A009-DEP-A008-03",
        Path("scripts/check_m229_a008_class_protocol_category_metadata_generation_recovery_and_determinism_hardening_contract.py"),
    ),
    (
        "M229-A009-DEP-A008-04",
        Path("tests/tooling/test_check_m229_a008_class_protocol_category_metadata_generation_recovery_and_determinism_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A009-DOC-EXP-01",
        "# M229 Class/Protocol/Category Metadata Generation Conformance Matrix Implementation Expectations (A009)",
    ),
    SnippetCheck(
        "M229-A009-DOC-EXP-02",
        "Contract ID: `objc3c-class-protocol-category-metadata-generation-conformance-matrix-implementation/m229-a009-v1`",
    ),
    SnippetCheck("M229-A009-DOC-EXP-03", "Dependencies: `M229-A008`"),
    SnippetCheck(
        "M229-A009-DOC-EXP-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A009-DOC-EXP-05",
        "check:objc3c:m229-a009-class-protocol-category-metadata-generation-conformance-matrix-implementation-contract",
    ),
    SnippetCheck(
        "M229-A009-DOC-EXP-06",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A009-DOC-PKT-01",
        "# M229-A009 Class/Protocol/Category Metadata Generation Conformance Matrix Implementation Packet",
    ),
    SnippetCheck("M229-A009-DOC-PKT-02", "Packet: `M229-A009`"),
    SnippetCheck("M229-A009-DOC-PKT-03", "Dependencies: `M229-A008`"),
    SnippetCheck(
        "M229-A009-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A009-DOC-PKT-05",
...
A008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M229-A009-A008-PKT-01", "Packet: `M229-A008`"),
    SnippetCheck("M229-A009-A008-PKT-02", "Dependencies: `M229-A007`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m229-a009-class-protocol-category-metadata-generation-conformance-matrix-implementation-contract '
        '&& npm run test:tooling:m229-a009-class-protocol-category-metadata-generation-conformance-matrix-implementation-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M229-A009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M229-A009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a008_expectations_doc, "M229-A009-A008-EXP-EXISTS", A008_EXPECTATIONS_SNIPPETS),
        (args.a008_packet_doc, "M229-A009-A008-PKT-EXISTS", A008_PACKET_SNIPPETS),
        (args.architecture_doc, "M229-A009-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M229-A009-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M229-A009-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M229-A009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
