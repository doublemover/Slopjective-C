#!/usr/bin/env python3
"""Fail-closed checker for M229-C001 interop boundary ABI handling contract freeze."""
...
MODE = "m229-c001-interop-boundary-abi-handling-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_c001_interop_boundary_abi_handling_contract_and_architecture_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-C001-DOC-PKT-01",
        "# M229-C001 Interop boundary ABI handling Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-C001-DOC-PKT-02", "Packet: `M229-C001`"),
    SnippetCheck("M229-C001-DOC-PKT-03", "Issue: `#5330`"),
    SnippetCheck("M229-C001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M229-C001-DOC-PKT-05",
        "check:objc3c:m229-c001-interop-boundary-abi-handling-contract",
    ),
    SnippetCheck(
        "M229-C001-DOC-PKT-06",
        "tmp/reports/m229/M229-C001/interop_boundary_abi_handling_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-C001-PKG-03",
        '"check:objc3c:m229-c001-lane-c-readiness": '
        '"npm run check:objc3c:m229-c001-interop-boundary-abi-handling-contract '
        '&& npm run test:tooling:m229-c001-interop-boundary-abi-handling-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-C001-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-C001-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-C001-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-C001-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-C001-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-C001-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
