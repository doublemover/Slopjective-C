#!/usr/bin/env python3
"""Fail-closed checker for M231-B014 Declaration semantic validation rules contract freeze."""
...
MODE = "m231-b014-declaration-semantic-validation-rules-release-candidate-and-replay-dry-run-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_b014_declaration_semantic_validation_rules_release_candidate_and_replay_dry_run_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M231-B014-DOC-PKT-01",
        "# M231-B014 Declaration Grammar Expansion and Normalization Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M231-B014-DOC-PKT-02", "Packet: `M231-B014`"),
    SnippetCheck("M231-B014-DOC-PKT-03", "Issue: `#5528`"),
    SnippetCheck("M231-B014-DOC-PKT-04", "Dependencies: `M231-B013`"),
    SnippetCheck(
        "M231-B014-DOC-PKT-05",
        "check:objc3c:m231-b014-declaration-semantic-validation-rules-release-candidate-and-replay-dry-run-contract",
    ),
    SnippetCheck(
        "M231-B014-DOC-PKT-06",
        "tmp/reports/m231/M231-B014/declaration_semantic_validation_rules_release_candidate_and_replay_dry_run_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M231-B014-PKG-03",
        '"check:objc3c:m231-b014-lane-b-readiness": '
        '"npm run check:objc3c:m231-b013-lane-b-readiness && npm run check:objc3c:m231-b014-declaration-semantic-validation-rules-release-candidate-and-replay-dry-run-contract '
        '&& npm run test:tooling:m231-b014-declaration-semantic-validation-rules-release-candidate-and-replay-dry-run-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-B014-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-B014-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-B014-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-B014-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-B014-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-B014-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
