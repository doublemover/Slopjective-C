#!/usr/bin/env python3
"""Fail-closed checker for M229-D007 packaging and runtime launch ergonomics contract freeze."""
...
MODE = "m229-d007-packaging-runtime-launch-ergonomics-diagnostics-hardening-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_d007_packaging_runtime_launch_ergonomics_diagnostics_hardening_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-D007-DOC-PKT-01",
        "# M229-D007 Packaging and runtime launch ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-D007-DOC-PKT-02", "Packet: `M229-D007`"),
    SnippetCheck("M229-D007-DOC-PKT-03", "Issue: `#5357`"),
    SnippetCheck("M229-D007-DOC-PKT-04", "Dependencies: `M229-D006`"),
    SnippetCheck(
        "M229-D007-DOC-PKT-05",
        "check:objc3c:m229-d007-packaging-runtime-launch-ergonomics-diagnostics-hardening-contract",
    ),
    SnippetCheck(
        "M229-D007-DOC-PKT-06",
        "tmp/reports/m229/M229-D007/packaging_runtime_launch_ergonomics_diagnostics_hardening_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-D007-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-D007-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-D007-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-D007-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-D007-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-D007-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
