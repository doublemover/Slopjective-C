#!/usr/bin/env python3
"""Fail-closed checker for M234-C008 accessor and ivar lowering recovery and determinism hardening."""
...
MODE = "m234-c008-accessor-and-ivar-lowering-contracts-recovery-and-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_accessor_and_ivar_lowering_contracts_recovery_and_determinism_hardening_c008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_c008_accessor_and_ivar_lowering_contracts_recovery_and_determinism_hardening_packet.md"
)
DEFAULT_C007_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_accessor_and_ivar_lowering_contracts_diagnostics_hardening_c007_expectations.md"
)
DEFAULT_C007_PACKET_DOC = (
    ...
    / "compiler"
    / "m234"
    / "m234_c007_accessor_and_ivar_lowering_contracts_diagnostics_hardening_packet.md"
)
DEFAULT_C007_CHECKER = (
    ROOT / "scripts" / "check_m234_c007_accessor_and_ivar_lowering_contracts_diagnostics_hardening_contract.py"
)
DEFAULT_C007_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_c007_accessor_and_ivar_lowering_contracts_diagnostics_hardening_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-C008-DOC-PKT-01",
        "# M234-C008 Accessor and Ivar Lowering Contracts Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M234-C008-DOC-PKT-02", "Packet: `M234-C008`"),
    SnippetCheck("M234-C008-DOC-PKT-03", "Issue: `#5726`"),
    SnippetCheck("M234-C008-DOC-PKT-04", "Dependencies: `M234-C007`"),
    SnippetCheck(
        "M234-C008-DOC-PKT-05",
        "scripts/check_m234_c008_accessor_and_ivar_lowering_contracts_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M234-C008-DOC-PKT-06",
        "tests/tooling/test_check_m234_c008_accessor_and_ivar_lowering_contracts_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck("M234-C008-DOC-PKT-07", "`npm run check:objc3c:m234-c008-lane-c-readiness`"),
)

C007_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-C008-C007-DOC-01",
        "# M234 Accessor and Ivar Lowering Contracts Diagnostics Hardening Expectations (C007)",
    ),
    SnippetCheck(
        "M234-C008-C007-DOC-02",
...
C007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-C008-C007-PKT-01", "Packet: `M234-C007`"),
    SnippetCheck("M234-C008-C007-PKT-02", "Dependencies: `M234-C006`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-C008-META-02",
        "explicit `M234-C007` dependency continuity so recovery and determinism hardening drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m234-c008-accessor-and-ivar-lowering-contracts-recovery-and-determinism-hardening-contract '
        '&& npm run test:tooling:m234-c008-accessor-and-ivar-lowering-contracts-recovery-and-determinism-hardening-contract"',
    ),
    SnippetCheck("M234-C008-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-C008-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-C008-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-C008-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str] | None = None) -> int:
    ...
    for path, exists_id, snippets in (
        (args.expectations_doc, "M234-C008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-C008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c007_expectations_doc, "M234-C008-C007-DOC-EXISTS", C007_EXPECTATIONS_SNIPPETS),
        (args.c007_packet_doc, "M234-C008-C007-PKT-EXISTS", C007_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-C008-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-C008-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-C008-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-C008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c007_checker, "M234-C008-C007-CHECKER-EXISTS"),
        (args.c007_test, "M234-C008-C007-TEST-EXISTS"),
    ):
