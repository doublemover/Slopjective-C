#!/usr/bin/env python3
"""Fail-closed contract checker for M238-B014 qualifier/generic semantic inference."""
...
MODE = "m238-b014-exception-semantic-legality-and-typing-release-candidate-and-replay-dry-run-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m238_exception_semantic_legality_and_typing_release_candidate_and_replay_dry_run_b014_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m238"
    / "m238_b014_exception_semantic_legality_and_typing_release_candidate_and_replay_dry_run_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M238-B014-DOC-PKT-01",
        "# M238-B014 Qualifier/Generic Semantic Inference Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M238-B014-DOC-PKT-02", "Packet: `M238-B014`"),
    SnippetCheck("M238-B014-DOC-PKT-03", "Issue: `#5781`"),
    SnippetCheck("M238-B014-DOC-PKT-04", "Dependencies: `M238-B013`"),
    SnippetCheck(
        "M238-B014-DOC-PKT-05",
        "`check:objc3c:m238-b014-exception-semantic-legality-and-typing-release-candidate-and-replay-dry-run-contract`",
    ),
    SnippetCheck(
        "M238-B014-DOC-PKT-06",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M238-B014-PKG-03",
        '"check:objc3c:m238-b014-lane-b-readiness": '
        '"npm run check:objc3c:m238-b013-lane-b-readiness && npm run check:objc3c:m238-b014-exception-semantic-legality-and-typing-release-candidate-and-replay-dry-run-contract '
        '&& npm run test:tooling:m238-b014-exception-semantic-legality-and-typing-release-candidate-and-replay-dry-run-contract"',
    ),
    SnippetCheck("M238-B014-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M238-B014-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M238-B014-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M238-B014-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M238-B014-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M238-B014-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M238-B014-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M238-B014-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
