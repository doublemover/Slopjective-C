#!/usr/bin/env python3
"""Fail-closed contract checker for M239-B002 qualifier/generic semantic inference."""
...
MODE = "m239-b002-semantic-flow-analysis-and-invariants-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m239_semantic_flow_analysis_and_invariants_modular_split_and_scaffolding_b002_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m239"
    / "m239_b002_semantic_flow_analysis_and_invariants_modular_split_and_scaffolding_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M239-B002-DOC-PKT-01",
        "# M239-B002 Qualifier/Generic Semantic Inference Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M239-B002-DOC-PKT-02", "Packet: `M239-B002`"),
    SnippetCheck("M239-B002-DOC-PKT-03", "Issue: `#5781`"),
    SnippetCheck("M239-B002-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M239-B002-DOC-PKT-05",
        "`check:objc3c:m239-b002-semantic-flow-analysis-and-invariants-contract`",
    ),
    SnippetCheck(
        "M239-B002-DOC-PKT-06",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M239-B002-PKG-03",
        '"check:objc3c:m239-b002-lane-b-readiness": '
        '"npm run check:objc3c:m239-b002-semantic-flow-analysis-and-invariants-contract '
        '&& npm run test:tooling:m239-b002-semantic-flow-analysis-and-invariants-contract"',
    ),
    SnippetCheck("M239-B002-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M239-B002-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M239-B002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M239-B002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M239-B002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M239-B002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M239-B002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M239-B002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
