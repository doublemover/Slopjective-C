#!/usr/bin/env python3
"""Fail-closed checker for M233-E006 conformance corpus and gate closeout edge-case expansion and robustness."""
...
MODE = "m233-e006-lane-e-conformance-corpus-gate-closeout-edge-case-expansion-and-robustness-contract-v1"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M233-E006-DEP-E005-03",
        Path(
            "scripts/"
            "check_m233_e005_lane_e_conformance_corpus_and_gate_closeout_edge_case_and_compatibility_completion_contract.py"
        ),
    ),
    AssetCheck(
        "M233-E006-DEP-E005-04",
        Path(
            "tests/tooling/"
            "test_check_m233_e005_lane_e_conformance_corpus_and_gate_closeout_edge_case_and_compatibility_completion_contract.py"
        ),
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E006-DOC-PKT-01",
        "# M233-E006 Lane-E Conformance Corpus and Gate Closeout Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M233-E006-DOC-PKT-02", "Packet: `M233-E006`"),
    SnippetCheck("M233-E006-DOC-PKT-03", "Issue: `#5659`"),
    SnippetCheck(
        "M233-E006-DOC-PKT-04",
        "Dependencies: `M233-E005`, `M233-A004`, `M233-B006`, `M233-C008`, `M233-D010`",
    ),
    SnippetCheck(
        "M233-E006-DOC-PKT-05",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_edge_case_expansion_and_robustness_e006_expectations.md",
    ),
    SnippetCheck(
        "M233-E006-DOC-PKT-06",
        "scripts/check_m233_e006_lane_e_conformance_corpus_and_gate_closeout_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M233-E006-DOC-PKT-07",
        "tests/tooling/test_check_m233_e006_lane_e_conformance_corpus_and_gate_closeout_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M233-E006-DOC-PKT-08",
    ...
    SnippetCheck(
        "M233-E006-DOC-PKT-09",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E006-DOC-PKT-10",
        "tmp/reports/m233/M233-E006/lane_e_conformance_corpus_gate_closeout_edge_case_expansion_and_robustness_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-E006-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M233-E006-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M233-E006-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-E006-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-E006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-E006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M233-E006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
