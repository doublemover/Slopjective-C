#!/usr/bin/env python3
"""Fail-closed validator for M227-A020 semantic pass advanced performance shard1 contract."""
...
MODE = "m227-semantic-pass-advanced-performance-workpack-shard1-contract-a020-v1"

ARTIFACTS: dict[str, Path] = {
    "a019_contract_doc": ROOT
    / "docs"
    / "contracts"
    ...
    / "compiler"
    / "m227"
    / "m227_a020_semantic_pass_advanced_performance_workpack_shard1_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        ...
        ("M227-A020-DOC-02", "Dependencies: `M227-A019`"),
        ("M227-A020-DOC-03", "toolchain_runtime_ga_operations_advanced_performance_consistent"),
        ("M227-A020-DOC-04", "toolchain_runtime_ga_operations_advanced_performance_ready"),
        ("M227-A020-DOC-05", "toolchain_runtime_ga_operations_advanced_performance_key"),
        (
            "M227-A020-DOC-06",
        ...
        ("M227-A020-DOC-08", "npm run check:objc3c:m227-a020-lane-a-readiness"),
    ),
    "packet_doc": (
        ("M227-A020-PKT-01", "Packet: `M227-A020`"),
        ("M227-A020-PKT-02", "Dependencies: `M227-A019`"),
        ("M227-A020-PKT-03", "objc3_parse_lowering_readiness_surface.h"),
        (
            "M227-A020-PKT-04",
            "scripts/check_m227_a020_semantic_pass_advanced_performance_workpack_shard1_contract.py",
        ),
    ...
    "parse_surface": (
        ("M227-A020-SUR-01", "IsObjc3ToolchainRuntimeGaOperationsAdvancedPerformanceConsistent("),
        ("M227-A020-SUR-02", "IsObjc3ToolchainRuntimeGaOperationsAdvancedPerformanceReady("),
        ("M227-A020-SUR-03", "BuildObjc3ToolchainRuntimeGaOperationsAdvancedPerformanceKey("),
        (
            "M227-A020-SUR-04",
    ...
    "runbook": (
        ...
        ("M227-A020-RBK-04", "npm run check:objc3c:m227-a020-lane-a-readiness"),
    ),
    "package_json": (
        (
            "M227-A020-CFG-01",
            '"check:objc3c:m227-a020-semantic-pass-advanced-performance-workpack-shard1-contract"',
        ),
        (
            "M227-A020-CFG-02",
            '"test:tooling:m227-a020-semantic-pass-advanced-performance-workpack-shard1-contract"',
        ),
        ("M227-A020-CFG-03", '"check:objc3c:m227-a020-lane-a-readiness"'),
        ("M227-A020-CFG-04", "check:objc3c:m227-a019-lane-a-readiness"),
    ),
    "architecture_doc": (
        (
            "M227-A020-ARC-01",
