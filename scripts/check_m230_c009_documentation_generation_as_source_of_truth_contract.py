#!/usr/bin/env python3
"""Fail-closed checker for M230-C009 Documentation generation as source-of-truth contract freeze."""
...
MODE = "m230-c009-documentation-generation-as-source-of-truth-conformance-matrix-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_c009_documentation_generation_as_source_of_truth_conformance_matrix_implementation_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-C009-DOC-PKT-01",
        "# M230-C009 Documentation generation as source-of-truth Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-C009-DOC-PKT-02", "Packet: `M230-C009`"),
    SnippetCheck("M230-C009-DOC-PKT-03", "Issue: `#5430`"),
    SnippetCheck("M230-C009-DOC-PKT-04", "Dependencies: `M230-C008`"),
    SnippetCheck(
        "M230-C009-DOC-PKT-05",
        "check:objc3c:m230-c009-documentation-generation-as-source-of-truth-conformance-matrix-implementation-contract",
    ),
    SnippetCheck(
        "M230-C009-DOC-PKT-06",
        "tmp/reports/m230/M230-C009/documentation_generation_as_source_of_truth_conformance_matrix_implementation_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-C009-PKG-03",
        '"check:objc3c:m230-c009-lane-c-readiness": '
        '"npm run check:objc3c:m230-c008-lane-c-readiness && npm run check:objc3c:m230-c009-documentation-generation-as-source-of-truth-conformance-matrix-implementation-contract '
        '&& npm run test:tooling:m230-c009-documentation-generation-as-source-of-truth-conformance-matrix-implementation-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-C009-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-C009-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-C009-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-C009-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-C009-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-C009-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
