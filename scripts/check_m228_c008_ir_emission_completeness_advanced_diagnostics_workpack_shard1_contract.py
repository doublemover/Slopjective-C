#!/usr/bin/env python3
"""Fail-closed validator for M228-C017 IR-emission advanced diagnostics shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c016_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_edge_compatibility_workpack_shard1_c016_expectations.md",
    "c016_checker": ROOT
    / "scripts"
    / "check_m228_c016_ir_emission_completeness_advanced_edge_compatibility_workpack_shard1_contract.py",
    "c016_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c016_ir_emission_completeness_advanced_edge_compatibility_workpack_shard1_contract.py",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "core_surface_header": (
        ...
        (
            "M228-C017-SUR-12",
            "BuildObjc3IREmissionCoreFeatureAdvancedDiagnosticsShard1Key(",
        ),
        (
            "M228-C017-SUR-13",
    ...
    "artifacts_source": (
        (
            "M228-C017-ART-01",
            "IsObjc3IREmissionCoreFeatureAdvancedDiagnosticsShard1Ready(",
        ),
        ("M228-C017-ART-02", '"O3L335"'),
        (
            "M228-C017-ART-03",
            "IR emission core feature advanced diagnostics shard 1 check failed",
        ),
        (
            "M228-C017-ART-04",
    ...
    "runbook_doc": (
        ...
        ("M228-C017-RUN-04", "npm run check:objc3c:m228-c017-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C017-ARC-01",
    ...
    "lowering_spec": (
        ...
        (
            "M228-C017-SPC-02",
            "lane-C dependency anchors (`M228-C017`, `M228-C016`)",
        ),
    ),
    "metadata_spec": (
        (
    ...
    "package_json": (
        ("M228-C017-PKG-01", '"check:objc3c:m228-c016-lane-c-readiness"'),
        (
            "M228-C017-PKG-02",
            '"check:objc3c:m228-c017-ir-emission-completeness-advanced-diagnostics-workpack-shard1-contract"',
        ),
        (
            "M228-C017-PKG-03",
            '"test:tooling:m228-c017-ir-emission-completeness-advanced-diagnostics-workpack-shard1-contract"',
        ),
        ("M228-C017-PKG-04", '"check:objc3c:m228-c017-lane-c-readiness"'),
        (
            "M228-C017-PKG-05",
            '"check:objc3c:m228-c017-lane-c-readiness": "npm run check:objc3c:m228-c016-lane-c-readiness &&',
        ),
    ),
    "c016_contract_doc": (
        (
    ...
    "c016_tooling_test": (
        ("M228-C017-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c016_packet_doc": (
        ("M228-C017-DEP-04", "Packet: `M228-C016`"),
        ("M228-C017-DEP-05", "Issue: `#5242`"),
    ),
    "contract_doc": (
        (
            "M228-C017-DOC-01",
        ...
        ("M228-C017-DOC-02", "Execute issue `#5243`"),
        ("M228-C017-DOC-03", "Dependencies: `M228-C016`"),
        (
            "M228-C017-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedDiagnosticsShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C017-PKT-02", "Packet: `M228-C017`"),
        ("M228-C017-PKT-03", "Issue: `#5243`"),
        ("M228-C017-PKT-04", "Dependencies: `M228-C016`"),
        (
            "M228-C017-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C017-FORB-01",
            '"check:objc3c:m228-c017-lane-c-readiness": "npm run check:objc3c:m228-c015-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C017/"
            "ir_emission_completeness_advanced_diagnostics_workpack_shard1_contract_summary.json"
        ),
    )
