#!/usr/bin/env python3
"""Fail-closed contract checker for the M246-C001 IR optimization pass wiring freeze."""
...
MODE = "m246-c001-ir-optimization-pass-wiring-validation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m246"
    / "m246_c001_ir_optimization_pass_wiring_and_validation_contract_and_architecture_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C001-DOC-PKT-01",
        "# M246-C001 IR Optimization Pass Wiring and Validation Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M246-C001-DOC-PKT-02", "Packet: `M246-C001`"),
    SnippetCheck("M246-C001-DOC-PKT-03", "Issue: `#5077`"),
    SnippetCheck("M246-C001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M246-C001-DOC-PKT-05",
        "`check:objc3c:m246-c001-ir-optimization-pass-wiring-validation-contract`",
    ),
    SnippetCheck("M246-C001-DOC-PKT-06", "`compile:objc3c`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-C001-META-02",
        "IR pass-wiring evidence and optimizer replay-budget continuity",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M246-C001-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M246-C001-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C001-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M246-C001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M246-C001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M246-C001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M246-C001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
