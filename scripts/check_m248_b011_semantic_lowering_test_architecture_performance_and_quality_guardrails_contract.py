#!/usr/bin/env python3
"""Fail-closed contract checker for M248-B011 semantic/lowering performance and quality guardrails."""
...
MODE = "m248-b011-semantic-lowering-test-architecture-performance-quality-guardrails-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_semantic_lowering_test_architecture_performance_and_quality_guardrails_b011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_b011_semantic_lowering_test_architecture_performance_and_quality_guardrails_packet.md"
)
DEFAULT_B010_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_semantic_lowering_test_architecture_conformance_corpus_expansion_b010_expectations.md"
)
DEFAULT_B010_PACKET_DOC = (
    ...
    / "compiler"
    / "m248"
    / "m248_b010_semantic_lowering_test_architecture_conformance_corpus_expansion_packet.md"
)
DEFAULT_B010_CHECKER = (
    ROOT / "scripts" / "check_m248_b010_semantic_lowering_test_architecture_conformance_corpus_expansion_contract.py"
)
DEFAULT_B010_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m248_b010_semantic_lowering_test_architecture_conformance_corpus_expansion_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B011-DOC-PKT-01",
        "# M248-B011 Semantic/Lowering Test Architecture Performance and Quality Guardrails Packet",
    ),
    SnippetCheck("M248-B011-DOC-PKT-02", "Packet: `M248-B011`"),
    SnippetCheck("M248-B011-DOC-PKT-03", "Issue: `#6811`"),
    SnippetCheck("M248-B011-DOC-PKT-04", "Dependencies: `M248-B010`"),
    SnippetCheck(
        "M248-B011-DOC-PKT-05",
        "`scripts/check_m248_b011_semantic_lowering_test_architecture_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M248-B011-DOC-PKT-06",
        "`check:objc3c:m248-b011-lane-b-readiness`",
    ),
    SnippetCheck(
        "M248-B011-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M248-B011-DOC-PKT-08",
...
B010_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B011-B010-DOC-01",
        "Contract ID: `objc3c-semantic-lowering-test-architecture-conformance-corpus-expansion/m248-b010-v1`",
    ),
    SnippetCheck("M248-B011-B010-DOC-02", "- Dependencies: `M248-B009`"),
    SnippetCheck(
        "M248-B011-B010-DOC-03",
        "scripts/check_m248_b010_semantic_lowering_test_architecture_conformance_corpus_expansion_contract.py",
    ),
)

B010_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-B011-B010-PKT-01", "Packet: `M248-B010`"),
    SnippetCheck("M248-B011-B010-PKT-02", "Dependencies: `M248-B009`"),
    SnippetCheck(
        "M248-B011-B010-PKT-03",
        "`scripts/check_m248_b010_semantic_lowering_test_architecture_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M248-B011-B010-PKT-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        "&& npm run check:objc3c:m248-b011-semantic-lowering-test-architecture-performance-quality-guardrails-contract "
        '&& npm run test:tooling:m248-b011-semantic-lowering-test-architecture-performance-quality-guardrails-contract"',
    ),
    SnippetCheck("M248-B011-PKG-04", '"check:objc3c:m248-b010-lane-b-readiness": '),
    SnippetCheck("M248-B011-PKG-05", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M248-B011-PKG-06", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b010_expectations_doc, "M248-B011-B010-DOC-EXISTS", B010_EXPECTATIONS_SNIPPETS),
        (args.b010_packet_doc, "M248-B011-B010-PKT-EXISTS", B010_PACKET_SNIPPETS),
        (args.architecture_doc, "M248-B011-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B011-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B011-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-B011-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b010_checker, "M248-B011-DEP-B010-ARG-01"),
        (args.b010_test, "M248-B011-DEP-B010-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
