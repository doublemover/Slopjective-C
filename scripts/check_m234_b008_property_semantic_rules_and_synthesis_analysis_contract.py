#!/usr/bin/env python3
"""Fail-closed contract checker for the M234-B008 property/ivar syntax surface freeze."""
...
MODE = "m234-b008-property-semantic-rules-and-synthesis-analysis-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_property_semantic_rules_and_synthesis_analysis_recovery_and_determinism_hardening_b008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_b008_property_semantic_rules_and_synthesis_analysis_recovery_and_determinism_hardening_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-B008-DOC-PKT-01",
        "# M234-B008 Property semantic rules and synthesis analysis Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M234-B008-DOC-PKT-02", "Packet: `M234-B008`"),
    SnippetCheck("M234-B008-DOC-PKT-03", "Dependencies: none"),
    SnippetCheck(
        "M234-B008-DOC-PKT-04",
        "`check:objc3c:m234-b008-property-semantic-rules-and-synthesis-analysis-contract`",
    ),
    SnippetCheck(
        "M234-B008-DOC-PKT-05",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-B008-PKG-03",
        '"check:objc3c:m234-b008-lane-b-readiness": '
        '"npm run check:objc3c:m234-b008-property-semantic-rules-and-synthesis-analysis-contract '
        '&& npm run test:tooling:m234-b008-property-semantic-rules-and-synthesis-analysis-contract"',
    ),
    SnippetCheck("M234-B008-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M234-B008-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-B008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-B008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M234-B008-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-B008-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-B008-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-B008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
