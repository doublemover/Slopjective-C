#!/usr/bin/env python3
"""Fail-closed contract checker for M241-D004 interop behavior for qualified generic APIs."""
...
MODE = "m241-d004-build-system-and-artifact-orchestration-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m241"
    / "m241_d004_build_system_and_artifact_orchestration_core_feature_expansion_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M241-D004-DOC-EXP-01",
        "# M241 Interop Behavior for Qualified Generic APIs Core Feature Expansion Expectations (D004)",
    ),
    SnippetCheck(
        "M241-D004-DOC-EXP-02",
        "Contract ID: `objc3c-build-system-and-artifact-orchestration/m241-d004-v1`",
    ),
    SnippetCheck(
        "M241-D004-DOC-EXP-03",
        "Issue `#6278` defines canonical lane-D core feature expansion scope.",
    ),
    SnippetCheck("M241-D004-DOC-EXP-04", "Dependencies: `M241-C001`"),
    SnippetCheck(
        "M241-D004-DOC-EXP-05",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M241-D004-DOC-EXP-06",
        "scripts/check_m241_d004_build_system_and_artifact_orchestration_contract.py",
    ),
    SnippetCheck(
        "M241-D004-DOC-EXP-07",
        "scripts/check_m241_c001_incremental_lowering_and_artifact_reuse_contract.py",
    ),
    SnippetCheck(
        "M241-D004-DOC-EXP-08",
        "`tmp/reports/m241/M241-D004/build_system_and_artifact_orchestration_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M241-D004-DOC-PKT-01",
        "# M241-D004 Interop Behavior for Qualified Generic APIs Core Feature Expansion Packet",
    ),
    SnippetCheck("M241-D004-DOC-PKT-02", "Packet: `M241-D004`"),
    SnippetCheck("M241-D004-DOC-PKT-03", "Issue: `#5831`"),
    SnippetCheck("M241-D004-DOC-PKT-04", "Dependencies: `M241-C001`"),
    SnippetCheck(
        "M241-D004-DOC-PKT-05",
        "scripts/check_m241_d004_build_system_and_artifact_orchestration_contract.py",
    ),
    SnippetCheck(
        "M241-D004-DOC-PKT-06",
        "scripts/check_m241_c001_incremental_lowering_and_artifact_reuse_contract.py",
    ),
    SnippetCheck("M241-D004-DOC-PKT-07", "`compile:objc3c`"),
    SnippetCheck("M241-D004-DOC-PKT-08", "`check:objc3c:m241-c001-lane-c-readiness`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M241-D004-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M241-D004-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M241-D004-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M241-D004-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M241-D004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M241-D004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M241-D004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M241-D004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M241-D004-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M241-D004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
