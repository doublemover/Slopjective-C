#!/usr/bin/env python3
"""Fail-closed checker for M229-C009 interop boundary ABI handling contract freeze."""
...
MODE = "m229-c009-interop-boundary-abi-handling-conformance-matrix-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_c009_interop_boundary_abi_handling_conformance_matrix_implementation_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-C009-DOC-PKT-01",
        "# M229-C009 Interop boundary ABI handling Conformance Matrix Implementation Packet",
    ),
    SnippetCheck("M229-C009-DOC-PKT-02", "Packet: `M229-C009`"),
    SnippetCheck("M229-C009-DOC-PKT-03", "Issue: `#5337`"),
    SnippetCheck("M229-C009-DOC-PKT-04", "Dependencies: `M229-C008`"),
    SnippetCheck(
        "M229-C009-DOC-PKT-05",
        "check:objc3c:m229-c009-interop-boundary-abi-handling-conformance-matrix-implementation-contract",
    ),
    SnippetCheck(
        "M229-C009-DOC-PKT-06",
        "tmp/reports/m229/M229-C009/interop_boundary_abi_handling_conformance_matrix_implementation_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-C009-PKG-03",
        '"check:objc3c:m229-c009-lane-c-readiness": '
        '"npm run check:objc3c:m229-c008-lane-c-readiness && npm run check:objc3c:m229-c009-interop-boundary-abi-handling-conformance-matrix-implementation-contract '
        '&& npm run test:tooling:m229-c009-interop-boundary-abi-handling-conformance-matrix-implementation-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-C009-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-C009-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-C009-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-C009-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-C009-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-C009-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
