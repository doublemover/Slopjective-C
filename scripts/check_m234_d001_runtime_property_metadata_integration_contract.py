#!/usr/bin/env python3
"""Fail-closed contract checker for the M234-D001 runtime property metadata integration freeze."""
...
MODE = "m234-d001-runtime-property-metadata-integration-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-D001-DOC-PKT-01",
        "# M234-D001 Runtime Property Metadata Integration Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M234-D001-DOC-PKT-02", "Packet: `M234-D001`"),
    SnippetCheck("M234-D001-DOC-PKT-03", "Issue: `#5736`"),
    SnippetCheck("M234-D001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M234-D001-DOC-PKT-05",
        "`check:objc3c:m234-d001-runtime-property-metadata-integration-contract-and-architecture-freeze-contract`",
    ),
    SnippetCheck("M234-D001-DOC-PKT-06", "`compile:objc3c`"),
    SnippetCheck("M234-D001-DOC-PKT-07", "`proof:objc3c`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-D001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-D001-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-D001-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-D001-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-D001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-D001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M234-D001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-D001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-D001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-D001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
