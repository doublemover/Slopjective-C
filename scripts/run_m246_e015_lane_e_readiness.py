#!/usr/bin/env python3
"""Run M246-E015 lane-E readiness checks without deep npm nesting."""
...
BASELINE_DEPENDENCIES = ("M246-E014", "M246-A011", "M246-B016", "M246-D011")
PENDING_SEEDED_DEPENDENCY_TOKENS = ("M246-C027",)
D011_REAL_READINESS_SCRIPT = "scripts/run_m246_d011_lane_d_readiness.py"
...
def run_chain() -> int:
    ...
    print("[ok] M246-E015 lane-E readiness chain completed")
    return 0
