#!/usr/bin/env python3
"""Fail-closed checker for M245-D006 build/link/runtime reproducibility edge-case expansion and robustness."""
...
MODE = "m245-d006-build-link-runtime-reproducibility-operations-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_D005_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_edge_case_and_compatibility_completion_d005_expectations.md"
)
DEFAULT_D005_PACKET_DOC = (
    ...
    / "compiler"
    / "m245"
    / "m245_d005_build_link_runtime_reproducibility_operations_edge_case_and_compatibility_completion_packet.md"
)
DEFAULT_D005_CHECKER = (
    ROOT / "scripts" / "check_m245_d005_build_link_runtime_reproducibility_operations_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_D005_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m245_d005_build_link_runtime_reproducibility_operations_edge_case_and_compatibility_completion_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D006-DOC-PKT-01",
        "# M245-D006 Build/Link/Runtime Reproducibility Operations Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M245-D006-DOC-PKT-02", "Packet: `M245-D006`"),
    SnippetCheck("M245-D006-DOC-PKT-03", "Issue: `#6657`"),
    SnippetCheck("M245-D006-DOC-PKT-04", "Dependencies: `M245-D005`"),
    SnippetCheck(
        "M245-D006-DOC-PKT-05",
        "dependency continuity and code/spec anchors as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D006-DOC-PKT-06",
        "scripts/check_m245_d006_build_link_runtime_reproducibility_operations_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M245-D006-DOC-PKT-07",
        "tests/tooling/test_check_m245_d006_build_link_runtime_reproducibility_operations_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M245-D006-DOC-PKT-08",
    ...
    SnippetCheck("M245-D006-DOC-PKT-09", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-D006-DOC-PKT-10",
        "`python scripts/check_m245_d006_build_link_runtime_reproducibility_operations_edge_case_expansion_and_robustness_contract.py --emit-json`",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-D006-ARCH-03",
        "and fail-closed against `M245-D005` dependency drift.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-D006-META-02",
        "explicit `M245-D005` dependency continuity so edge-case expansion and robustness drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D006-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D006-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D006-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D006-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d005_expectations_doc, "M245-D006-D005-DOC-EXISTS", D005_EXPECTATIONS_SNIPPETS),
        (args.d005_packet_doc, "M245-D006-D005-PKT-EXISTS", D005_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d005_checker, "M245-D006-DEP-D005-ARG-01"),
        (args.d005_test, "M245-D006-DEP-D005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
