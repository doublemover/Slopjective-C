...
ACTION_SPECS: dict[str, ActionSpec] = {
    ...
    "test-full": ActionSpec("test-full", "full developer validation entrypoint with bounded smoke slice", "runner-internal + runtime acceptance + replay + smoke -Limit 24", ("test:objc3c:full",), validation_tier="full", guarantee_owner="runtime acceptance, canonical replay, and a deterministic 24-fixture smoke slice; use test-smoke or test-nightly for exhaustive smoke"),
