#!/usr/bin/env python3
"""Fail-closed checker for M237-E007 block conformance and replay gate contract freeze."""
...
DEFAULT_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m237_block_conformance_and_replay_gate_diagnostics_hardening_e007_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
...
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m237/M237-E007/local_check_summary.json")
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M237-E007-DOC-EXP-05",
        "currently-closed early lane steps",
    ),
    SnippetCheck("M237-E007-DOC-EXP-06", "| `M237-A001` |"),
    SnippetCheck("M237-E007-DOC-EXP-07", "| `M237-B001` |"),
    SnippetCheck("M237-E007-DOC-EXP-08", "| `M237-C001` |"),
    SnippetCheck(
        "M237-E007-DOC-EXP-09",
        "scripts/check_m237_e007_block_conformance_and_replay_gate_contract.py",
    ),
    SnippetCheck(
        "M237-E007-DOC-EXP-10",
        "tests/tooling/test_check_m237_e007_block_conformance_and_replay_gate_contract.py",
    ),
    SnippetCheck(
        "M237-E007-DOC-EXP-11",
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M237-E007-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M237-E007-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
