#!/usr/bin/env python3
"""Fail-closed contract checker for the M245-B013 semantic parity/platform constraints integration closeout and gate sign-off packet."""
...
MODE = "m245-b013-semantic-parity-platform-constraints-integration-closeout-and-gate-signoff-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_semantic_parity_and_platform_constraints_integration_closeout_and_gate_signoff_b013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_b013_semantic_parity_and_platform_constraints_integration_closeout_and_gate_signoff_packet.md"
)
...
DEFAULT_B012_CHECKER = (
    ROOT / "scripts" / "check_m245_b012_semantic_parity_and_platform_constraints_cross_lane_integration_sync_contract.py"
)
DEFAULT_B012_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_b012_semantic_parity_and_platform_constraints_cross_lane_integration_sync_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-B013-DOC-EXP-09",
        "integration closeout and gate sign-off dependency anchors",
    ),
    SnippetCheck(
        "M245-B013-DOC-EXP-10",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B013-DOC-PKT-01",
        "# M245-B013 Semantic Parity and Platform Constraints Integration Closeout and Gate Sign-off Packet",
    ),
    SnippetCheck("M245-B013-DOC-PKT-02", "Packet: `M245-B013`"),
    SnippetCheck("M245-B013-DOC-PKT-03", "Issue: `#6635`"),
    SnippetCheck("M245-B013-DOC-PKT-04", "Dependencies: `M245-B012`"),
    SnippetCheck("M245-B013-DOC-PKT-05", "Theme: `integration closeout and gate sign-off`"),
    SnippetCheck(
        "M245-B013-DOC-PKT-06",
        "`scripts/check_m245_b013_semantic_parity_and_platform_constraints_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M245-B013-DOC-PKT-07",
        "`tests/tooling/test_check_m245_b013_semantic_parity_and_platform_constraints_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M245-B013-DOC-PKT-08",
        "`scripts/check_m245_b012_semantic_parity_and_platform_constraints_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M245-B013-DOC-PKT-09",
        "`tests/tooling/test_check_m245_b012_semantic_parity_and_platform_constraints_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M245-B013-DOC-PKT-10",
        "including code/spec anchors and milestone optimization improvements",
    ),
    SnippetCheck(
        "M245-B013-DOC-PKT-11",
        "`tmp/reports/m245/M245-B013/semantic_parity_and_platform_constraints_integration_closeout_and_gate_signoff_summary.json`",
    ),
)
...
B012_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B013-B012-DOC-01",
        "Contract ID: `objc3c-semantic-parity-platform-constraints-cross-lane-integration-sync/m245-b012-v1`",
    ),
    SnippetCheck("M245-B013-B012-DOC-02", "- Issue: `#6634`"),
    SnippetCheck("M245-B013-B012-DOC-03", "- Dependencies: `M245-B011`"),
    SnippetCheck(
        "M245-B013-B012-DOC-04",
        "scripts/check_m245_b012_semantic_parity_and_platform_constraints_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M245-B013-B012-DOC-05",
...
B012_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-B013-B012-PKT-01", "Packet: `M245-B012`"),
    SnippetCheck("M245-B013-B012-PKT-02", "Issue: `#6634`"),
    SnippetCheck("M245-B013-B012-PKT-03", "Dependencies: `M245-B011`"),
    SnippetCheck(
        "M245-B013-B012-PKT-04",
        "scripts/check_m245_b012_semantic_parity_and_platform_constraints_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M245-B013-B012-PKT-05",
        "tests/tooling/test_check_m245_b012_semantic_parity_and_platform_constraints_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M245-B013-B012-PKT-06",
        "tmp/reports/m245/M245-B012/semantic_parity_and_platform_constraints_cross_lane_integration_sync_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-B013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-B013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b012_expectations_doc, "M245-B013-B012-DOC-EXISTS", B012_EXPECTATIONS_SNIPPETS),
        (args.b012_packet_doc, "M245-B013-B012-PKT-EXISTS", B012_PACKET_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b012_checker, "M245-B013-DEP-B012-ARG-01"),
        (args.b012_test, "M245-B013-DEP-B012-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
