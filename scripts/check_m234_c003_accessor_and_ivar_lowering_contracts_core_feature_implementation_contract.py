#!/usr/bin/env python3
"""Fail-closed contract checker for M234-C003 accessor/ivar lowering core feature implementation."""
...
MODE = "m234-c003-accessor-and-ivar-lowering-contracts-core-feature-implementation-contract-v1"
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m234-c003-accessor-and-ivar-lowering-contracts-core-feature-implementation-contract '
        '&& npm run test:tooling:m234-c003-accessor-and-ivar-lowering-contracts-core-feature-implementation-contract"',
    ),
    SnippetCheck("M234-C003-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-C003-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-C003-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-C003-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-C003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-C003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M234-C003-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M234-C003-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.architecture_doc, "M234-C003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-C003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-C003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-C003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
