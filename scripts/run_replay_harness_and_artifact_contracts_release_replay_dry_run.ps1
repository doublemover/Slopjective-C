param(
  ...
  [string]$ReportRoot = "tmp/reports/validation_architecture/replay_harness_release_replay_dry_run"
)
...
$summary = [ordered]@{
  contract_id = "objc3c-replay-harness-and-artifact-contracts-release-candidate-and-replay-dry-run/validation_architecture-replay-harness-release-replay-dry-run-v1"
