#!/usr/bin/env python3
"""Fail-closed checker for M231-B016 Declaration semantic validation rules contract freeze."""
...
MODE = "m231-b016-declaration-semantic-validation-rules-advanced-edge-compatibility-workpack-shard-1-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_b016_declaration_semantic_validation_rules_advanced_edge_compatibility_workpack_shard_1_packet.md"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M231-B016-PKG-03",
        '"check:objc3c:m231-b016-lane-b-readiness": '
        '"npm run check:objc3c:m231-b015-lane-b-readiness && npm run check:objc3c:m231-b016-declaration-semantic-validation-rules-advanced-edge-compatibility-workpack-shard-1-contract '
        '&& npm run test:tooling:m231-b016-declaration-semantic-validation-rules-advanced-edge-compatibility-workpack-shard-1-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-B016-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-B016-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-B016-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-B016-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-B016-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-B016-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
