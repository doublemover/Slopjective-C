#!/usr/bin/env python3
"""Fail-closed checker for M248-C012 replay harness/artifact cross-lane integration sync contract."""
...
MODE = "m248-c012-replay-harness-and-artifact-contracts-cross-lane-integration-sync-contract-v1"
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-C012/"
    "replay_harness_and_artifact_contracts_cross_lane_integration_sync_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-C012-DOC-EXP-01",
        "Contract ID: `objc3c-replay-harness-artifact-contracts-cross-lane-integration-sync/m248-c012-v1`",
    ),
    SnippetCheck("M248-C012-DOC-EXP-02", "Dependencies: `M248-C011`"),
    SnippetCheck(
        "M248-C012-DOC-EXP-03",
        "Scope: lane-C replay harness/artifact cross-lane integration sync governance with fail-closed continuity from C011.",
    ),
    SnippetCheck(
        "M248-C012-DOC-EXP-04",
        "Issue `#6828` defines canonical lane-C cross-lane integration sync scope.",
    ),
    SnippetCheck("M248-C012-DOC-EXP-05", "cross_lane_integration_sync_consistent"),
    SnippetCheck("M248-C012-DOC-EXP-06", "cross_lane_integration_sync_ready"),
    SnippetCheck("M248-C012-DOC-EXP-07", "cross_lane_integration_sync_key_ready"),
    SnippetCheck(
        "M248-C012-DOC-EXP-08",
        "`check:objc3c:m248-c012-lane-c-readiness`",
    ),
    SnippetCheck(
        "M248-C012-DOC-EXP-09",
        "`scripts/check_m248_c012_replay_harness_and_artifact_contracts_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M248-C012-DOC-EXP-10",
        "`tests/tooling/test_check_m248_c012_replay_harness_and_artifact_contracts_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M248-C012-DOC-EXP-11",
        "`tmp/reports/m248/M248-C012/replay_harness_and_artifact_contracts_cross_lane_integration_sync_contract_summary.json`",
    ),
    SnippetCheck(
        "M248-C012-DOC-EXP-12",
        "`docs/contracts/m248_replay_harness_and_artifact_contracts_performance_and_quality_guardrails_c011_expectations.md`",
    ),
    SnippetCheck(
        "M248-C012-DOC-EXP-13",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M248-C012-DOC-EXP-14",
        "## Milestone Optimization Inputs (Mandatory Scope Inputs)",
    ),
    SnippetCheck("M248-C012-DOC-EXP-15", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C012-DOC-PKT-01", "Packet: `M248-C012`"),
    SnippetCheck("M248-C012-DOC-PKT-02", "Issue: `#6828`"),
    SnippetCheck("M248-C012-DOC-PKT-03", "Dependencies: `M248-C011`"),
    SnippetCheck("M248-C012-DOC-PKT-03A", "## Dependency Anchors (M248-C011)"),
    SnippetCheck(
        "M248-C012-DOC-PKT-04",
        "`scripts/check_m248_c012_replay_harness_and_artifact_contracts_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M248-C012-DOC-PKT-05",
        "`tests/tooling/test_check_m248_c012_replay_harness_and_artifact_contracts_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck("M248-C012-DOC-PKT-06", "`check:objc3c:m248-c012-lane-c-readiness`"),
    SnippetCheck(
        "M248-C012-DOC-PKT-07",
        "`tmp/reports/m248/M248-C012/replay_harness_and_artifact_contracts_cross_lane_integration_sync_contract_summary.json`",
    ),
    SnippetCheck("M248-C012-DOC-PKT-08", "## Scope Anchors"),
    SnippetCheck("M248-C012-DOC-PKT-09", "- Architecture/spec anchors:"),
    SnippetCheck("M248-C012-DOC-PKT-10", "## Milestone Optimization Inputs"),
    SnippetCheck("M248-C012-DOC-PKT-11", "`test:objc3c:perf-budget`"),
)

C011_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-C012-C011-DOC-01",
        "Contract ID: `objc3c-replay-harness-artifact-contracts-performance-and-quality-guardrails/m248-c011-v1`",
    ),
    SnippetCheck("M248-C012-C011-DOC-02", "Dependencies: `M248-C010`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-C012-CFG-03", "check:objc3c:m248-c012-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C012-CFG-04", "check:objc3c:m248-c011-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C012-CFG-05", "compile:objc3c"),
    PackageScriptKeyCheck("M248-C012-CFG-06", "proof:objc3c"),
    PackageScriptKeyCheck("M248-C012-CFG-07", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M248-C012-CFG-08", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M248-C012-CFG-09", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        "M248-C012-CFG-12",
        "check:objc3c:m248-c012-lane-c-readiness",
        "npm run check:objc3c:m248-c011-lane-c-readiness && npm run check:objc3c:m248-c012-replay-harness-artifact-contracts-cross-lane-integration-sync-contract && npm run test:tooling:m248-c012-replay-harness-artifact-contracts-cross-lane-integration-sync-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M248-C012-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M248-C012-DOC-PKT-00",
        snippets=PACKET_SNIPPETS,
    )
    checks_total += packet_checks
    findings.extend(packet_findings)

    c011_checks, c011_findings = check_doc_contract(
        artifact_name="c011_expectations_doc",
        path=args.c011_expectations_doc,
        exists_check_id="M248-C012-C011-DOC-00",
        snippets=C011_EXPECTATIONS_SNIPPETS,
    )
    checks_total += c011_checks
    findings.extend(c011_findings)
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M248-C012-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M248-C012-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M248-C012-META-00",
