#!/usr/bin/env python3
"""Fail-closed checker for M233-E010 conformance corpus and gate closeout conformance corpus expansion."""
...
MODE = "m233-e010-lane-e-conformance-corpus-gate-closeout-conformance-corpus-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_e010_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_e010_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E010-DOC-PKT-01",
        "# M233-E010 Lane-E Conformance Corpus and Gate Closeout Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M233-E010-DOC-PKT-02", "Packet: `M233-E010`"),
    SnippetCheck("M233-E010-DOC-PKT-03", "Issue: `#5663`"),
    SnippetCheck(
        "M233-E010-DOC-PKT-04",
        "Dependencies: `M233-E009`, `M233-A007`, `M233-B010`, `M233-C013`, `M233-D016`",
    ),
    SnippetCheck("M233-E010-DOC-PKT-05", "Predecessor: `M233-E009`"),
    SnippetCheck("M233-E010-DOC-PKT-06", "Theme: conformance corpus expansion"),
    SnippetCheck(
        "M233-E010-DOC-PKT-07",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_e010_expectations.md",
    ),
    SnippetCheck(
        "M233-E010-DOC-PKT-08",
        "scripts/check_m233_e010_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M233-E010-DOC-PKT-09",
        "tests/tooling/test_check_m233_e010_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M233-E010-DOC-PKT-10",
    ...
    SnippetCheck(
        "M233-E010-DOC-PKT-11",
        "conformance corpus expansion traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E010-DOC-PKT-12",
        "tmp/reports/m233/M233-E010/lane_e_conformance_corpus_gate_closeout_conformance_corpus_expansion_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-E010-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M233-E010-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M233-E010-PKG-03", '"test:objc3c:diagnostics-replay-proof": '),
    SnippetCheck("M233-E010-PKG-04", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-E010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-E010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M233-E010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
