#!/usr/bin/env python3
"""Fail-closed checker for M244-C005 interop lowering edge-case and compatibility completion contract."""
...
MODE = "m244-c005-interop-lowering-and-abi-conformance-edge-case-and-compatibility-completion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_edge_case_and_compatibility_completion_c005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c005_interop_lowering_and_abi_conformance_edge_case_and_compatibility_completion_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C005/"
    "interop_lowering_and_abi_conformance_edge_case_and_compatibility_completion_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-C005-C004-01",
        "M244-C004",
        Path("docs/contracts/m244_interop_lowering_and_abi_conformance_core_feature_expansion_c004_expectations.md"),
    ),
    AssetCheck(
        "M244-C005-C004-02",
        "M244-C004",
        Path("spec/planning/compiler/m244/m244_c004_interop_lowering_and_abi_conformance_core_feature_expansion_packet.md"),
    ),
    AssetCheck(
        "M244-C005-C004-03",
        "M244-C004",
        Path("scripts/check_m244_c004_interop_lowering_and_abi_conformance_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M244-C005-C004-04",
        "M244-C004",
        Path("tests/tooling/test_check_m244_c004_interop_lowering_and_abi_conformance_core_feature_expansion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C005-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-edge-case-and-compatibility-completion/m244-c005-v1`",
    ),
    SnippetCheck("M244-C005-DOC-EXP-02", "Dependencies: `M244-C004`"),
    SnippetCheck(
        "M244-C005-DOC-EXP-03",
        "Issue `#6554` defines canonical lane-C edge-case and compatibility completion scope.",
    ),
    SnippetCheck("M244-C005-DOC-EXP-04", "`check:objc3c:m244-c005-lane-c-readiness`"),
    SnippetCheck("M244-C005-DOC-EXP-05", "`check:objc3c:m244-c004-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C005-DOC-PKT-01", "Packet: `M244-C005`"),
    SnippetCheck("M244-C005-DOC-PKT-02", "Issue: `#6554`"),
    SnippetCheck("M244-C005-DOC-PKT-03", "Dependencies: `M244-C004`"),
    SnippetCheck(
        "M244-C005-DOC-PKT-04",
        "`scripts/check_m244_c005_interop_lowering_and_abi_conformance_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M244-C005-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C005-CFG-03", "check:objc3c:m244-c005-lane-c-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c004-lane-c-readiness && npm run check:objc3c:m244-c005-interop-lowering-abi-conformance-edge-case-and-compatibility-completion-contract && npm run test:tooling:m244-c005-interop-lowering-abi-conformance-edge-case-and-compatibility-completion-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C005-ARCH-02",
        "`M244-C004` dependency continuity and edge-case completion evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C005-SPC-02", "lane-C dependency anchor (`M244-C004`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C005-META-02",
        "explicit `M244-C004` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C005-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C005-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C005-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C005-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C005-META-00",
