...
def main() -> int:
    ...
    payload = {
        ...
        "runtime_bridging_filter_unwind_diagnostics_surface": public_workflow_report[
            "runtime_bridging_filter_unwind_diagnostics_surface"
        ],
        "runtime_error_lowering_unwind_bridge_helper_surface": public_workflow_report[
            "runtime_error_lowering_unwind_bridge_helper_surface"
        ],
        ...
        "runtime_block_arc_unified_source_surface": public_workflow_report[
            "runtime_block_arc_unified_source_surface"
        ],
        "runtime_ownership_transfer_capture_family_source_surface": public_workflow_report[
            "runtime_ownership_transfer_capture_family_source_surface"
        ],
        "runtime_block_arc_lowering_helper_surface": public_workflow_report[
            "runtime_block_arc_lowering_helper_surface"
        ],
        "runtime_block_arc_runtime_abi_surface": public_workflow_report[
            "runtime_block_arc_runtime_abi_surface"
        ],
        ...
        "runtime_claimable_surface_residual_non_claimable_gaps_source_surface": public_workflow_report[
            "runtime_claimable_surface_residual_non_claimable_gaps_source_surface"
        ],
        "runtime_strict_profile_feature_claim_source_surface": public_workflow_report[
            "runtime_strict_profile_feature_claim_source_surface"
        ],
        "runtime_claimability_semantics_release_policy_surface": public_workflow_report[
            "runtime_claimability_semantics_release_policy_surface"
        ],
        "runtime_strict_profile_claim_implementation_surface": public_workflow_report[
            "runtime_strict_profile_claim_implementation_surface"
        ],
        "runtime_scaffold_retirement_deprecated_sidecar_compatibility_diagnostics_surface": public_workflow_report[
            "runtime_scaffold_retirement_deprecated_sidecar_compatibility_diagnostics_surface"
        ],
        "runtime_claim_publication_dashboard_schema_surface": public_workflow_report[
            "runtime_claim_publication_dashboard_schema_surface"
        ],
        "runtime_final_claim_publication_deprecated_path_shutdown_surface": public_workflow_report[
            "runtime_final_claim_publication_deprecated_path_shutdown_surface"
        ],
        "runtime_release_candidate_claim_abi_surface": public_workflow_report[
            "runtime_release_candidate_claim_abi_surface"
        ],
        "runtime_final_release_evidence_descaffolding_implementation_surface": public_workflow_report[
            "runtime_final_release_evidence_descaffolding_implementation_surface"
        ],
