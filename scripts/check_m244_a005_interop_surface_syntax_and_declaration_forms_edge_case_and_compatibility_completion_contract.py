#!/usr/bin/env python3
"""Fail-closed checker for M244-A005 interop surface edge-case and compatibility completion contract."""
...
MODE = "m244-a005-interop-surface-syntax-and-declaration-forms-edge-case-and-compatibility-completion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_surface_syntax_and_declaration_forms_edge_case_and_compatibility_completion_a005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_a005_interop_surface_syntax_and_declaration_forms_edge_case_and_compatibility_completion_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-A005/"
    "interop_surface_syntax_and_declaration_forms_edge_case_and_compatibility_completion_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M244-A005-A004-03",
        "M244-A004",
        Path("scripts/check_m244_a004_interop_surface_syntax_and_declaration_forms_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M244-A005-A004-04",
        "M244-A004",
        Path("tests/tooling/test_check_m244_a004_interop_surface_syntax_and_declaration_forms_core_feature_expansion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-A005-DOC-EXP-01",
        "Contract ID: `objc3c-interop-surface-syntax-and-declaration-forms-edge-case-and-compatibility-completion/m244-a005-v1`",
    ),
    SnippetCheck("M244-A005-DOC-EXP-02", "Dependencies: `M244-A004`"),
    SnippetCheck("M244-A005-DOC-EXP-03", "Issue `#6522` defines canonical lane-A edge-case and compatibility completion scope."),
    SnippetCheck("M244-A005-DOC-EXP-04", "`check:objc3c:m244-a005-lane-a-readiness`"),
    SnippetCheck("M244-A005-DOC-EXP-05", "`check:objc3c:m244-a004-lane-a-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-A005-DOC-PKT-01", "Packet: `M244-A005`"),
    SnippetCheck("M244-A005-DOC-PKT-02", "Issue: `#6522`"),
    SnippetCheck("M244-A005-DOC-PKT-03", "Dependencies: `M244-A004`"),
    SnippetCheck(
        "M244-A005-DOC-PKT-04",
        "`scripts/check_m244_a005_interop_surface_syntax_and_declaration_forms_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M244-A005-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-A005-CFG-03", "check:objc3c:m244-a005-lane-a-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-a004-lane-a-readiness && npm run check:objc3c:m244-a005-interop-surface-syntax-declaration-forms-edge-case-and-compatibility-completion-contract && npm run test:tooling:m244-a005-interop-surface-syntax-declaration-forms-edge-case-and-compatibility-completion-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A005-ARCH-02", "`M244-A004` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A005-SPC-02", "lane-A dependency anchor (`M244-A004`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-A005-META-02",
        "explicit `M244-A004` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-A005-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-A005-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-A005-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-A005-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-A005-META-00",
