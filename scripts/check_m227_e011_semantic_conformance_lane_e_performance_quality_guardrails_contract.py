#!/usr/bin/env python3
"""Fail-closed validator for M227-E011 semantic conformance lane-E performance and quality guardrails."""
...
MODE = "m227-e011-semantic-conformance-lane-e-performance-quality-guardrails-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_lane_e_semantic_conformance_performance_quality_guardrails_e011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_e011_semantic_conformance_lane_e_performance_quality_guardrails_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-E011-E005-01",
        "M227-E010",
        Path("docs/contracts/m227_lane_e_semantic_conformance_conformance_corpus_expansion_e010_expectations.md"),
    ),
    AssetCheck(
        "M227-E011-E005-02",
        "M227-E010",
        Path("scripts/check_m227_e010_semantic_conformance_lane_e_conformance_corpus_expansion_contract.py"),
    ),
    AssetCheck(
        "M227-E011-E005-03",
        "M227-E010",
        Path("tests/tooling/test_check_m227_e010_semantic_conformance_lane_e_conformance_corpus_expansion_contract.py"),
    ),
    AssetCheck(
        "M227-E011-E005-04",
        "M227-E010",
        Path("spec/planning/compiler/m227/m227_e010_semantic_conformance_lane_e_conformance_corpus_expansion_packet.md"),
    ),
    AssetCheck(
        "M227-E011-A006-01",
        "M227-A012",
        Path("docs/contracts/m227_semantic_pass_cross_lane_integration_sync_expectations.md"),
    ),
    AssetCheck(
        "M227-E011-A006-02",
        "M227-A012",
        Path("scripts/check_m227_a012_semantic_pass_cross_lane_integration_sync_contract.py"),
    ),
    AssetCheck(
        "M227-E011-A006-03",
        "M227-A012",
        Path("tests/tooling/test_check_m227_a012_semantic_pass_cross_lane_integration_sync_contract.py"),
    ),
    AssetCheck(
        "M227-E011-A006-04",
        "M227-A012",
        Path("spec/planning/compiler/m227/m227_a012_semantic_pass_cross_lane_integration_sync_packet.md"),
    ),
    AssetCheck(
        "M227-E011-B006-01",
        "M227-B021",
    ...
    AssetCheck(
        "M227-E011-B006-02",
        "M227-B021",
        Path("scripts/check_m227_b021_type_system_objc3_forms_advanced_core_workpack_shard2_contract.py"),
    ),
    AssetCheck(
        "M227-E011-B006-03",
        "M227-B021",
        Path("tests/tooling/test_check_m227_b021_type_system_objc3_forms_advanced_core_workpack_shard2_contract.py"),
    ),
    AssetCheck(
        "M227-E011-B006-04",
        "M227-B021",
        Path("spec/planning/compiler/m227/m227_b021_type_system_objc3_forms_advanced_core_workpack_shard2_packet.md"),
    ),
    AssetCheck(
        "M227-E011-C006-01",
        "M227-C014",
    ...
    AssetCheck(
        "M227-E011-C006-02",
        "M227-C014",
        Path("scripts/check_m227_c014_typed_sema_to_lowering_release_candidate_replay_dry_run_contract.py"),
    ),
    AssetCheck(
        "M227-E011-C006-03",
        "M227-C014",
        Path("tests/tooling/test_check_m227_c014_typed_sema_to_lowering_release_candidate_replay_dry_run_contract.py"),
    ),
    AssetCheck(
        "M227-E011-C006-04",
        "M227-C014",
        Path("spec/planning/compiler/m227/m227_c014_typed_sema_to_lowering_release_candidate_replay_dry_run_packet.md"),
    ),
    AssetCheck(
        "M227-E011-D006-01",
        "M227-D007",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E011-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-E011-EXP-08",
        "checker `scripts/check_m227_e010_semantic_conformance_lane_e_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M227-E011-EXP-09",
        "checker `scripts/check_m227_a012_semantic_pass_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M227-E011-EXP-10",
        "checker `scripts/check_m227_b021_type_system_objc3_forms_advanced_core_workpack_shard2_contract.py`",
    ),
    SnippetCheck(
        "M227-E011-EXP-11",
        "checker `scripts/check_m227_c014_typed_sema_to_lowering_release_candidate_replay_dry_run_contract.py`",
    ),
    SnippetCheck(
        "M227-E011-EXP-12",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E011-PKT-04", "Packet: `M227-E011`"),
    SnippetCheck("M227-E011-PKT-05", "Issue: `#5169`"),
    SnippetCheck("M227-E011-PKT-06", "Scaffold date: `2026-03-05`"),
    SnippetCheck(
        "M227-E011-PKT-07",
        "Dependencies: `M227-E010`, `M227-A012`, `M227-B021`, `M227-C014`, `M227-D007`",
    ),
    SnippetCheck("M227-E011-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-E011-PKT-09",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-E011-ARCH-01",
        "M227 lane-E E011 semantic conformance performance and quality guardrails anchors dependency references",
    ),
    SnippetCheck(
        "M227-E011-ARCH-02",
        "(`M227-E010`, `M227-A012`, `M227-B021`, `M227-C014`, and `M227-D007`)",
    ),
    SnippetCheck(
        "M227-E011-ARCH-03",
        "check:objc3c:m227-e011-lane-e-readiness",
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E011-SPC-03",
        "lane-E performance and quality guardrails evidence drift.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E011-META-03",
        "semantic conformance lane-E performance and quality guardrails metadata governance drift fails closed.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-E011-CFG-03", "check:objc3c:m227-e011-lane-e-readiness"),
    PackageScriptKeyCheck("M227-E011-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M227-E011-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M227-E011-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-E011-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        "M227-E011-CFG-06",
        "check:objc3c:m227-e011-lane-e-readiness",
        "python scripts/check_m227_e010_semantic_conformance_lane_e_conformance_corpus_expansion_contract.py && python -m pytest tests/tooling/test_check_m227_e010_semantic_conformance_lane_e_conformance_corpus_expansion_contract.py -q && python scripts/check_m227_a012_semantic_pass_cross_lane_integration_sync_contract.py && python -m pytest tests/tooling/test_check_m227_a012_semantic_pass_cross_lane_integration_sync_contract.py -q && npm run check:objc3c:m227-b021-lane-b-readiness && npm run check:objc3c:m227-c014-lane-c-readiness && python scripts/check_m227_d007_runtime_facing_type_metadata_diagnostics_hardening_contract.py && python -m pytest tests/tooling/test_check_m227_d007_runtime_facing_type_metadata_diagnostics_hardening_contract.py -q && npm run check:objc3c:m227-e011-semantic-conformance-lane-e-performance-quality-guardrails-contract && npm run test:tooling:m227-e011-semantic-conformance-lane-e-performance-quality-guardrails-contract",
    ),
)
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-E010": "scripts/check_m227_e010_semantic_conformance_lane_e_conformance_corpus_expansion_contract.py",
    "M227-A012": "scripts/check_m227_a012_semantic_pass_cross_lane_integration_sync_contract.py",
    "M227-B021": "scripts/check_m227_b021_type_system_objc3_forms_advanced_core_workpack_shard2_contract.py",
    "M227-C014": "scripts/check_m227_c014_typed_sema_to_lowering_release_candidate_replay_dry_run_contract.py",
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_text = check_document(
        ...
        exists_check_id="M227-E011-EXP-01",
        utf8_check_id="M227-E011-EXP-02",
        snippets=EXPECTATIONS_SNIPPETS,
    )
    packet_text = check_document(
        path=args.packet_doc,
        artifact="packet_doc",
        exists_check_id="M227-E011-PKT-01",
        utf8_check_id="M227-E011-PKT-02",
        snippets=PACKET_SNIPPETS,
    )
    check_document(
        path=args.architecture_doc,
        artifact="architecture_doc",
        exists_check_id="M227-E011-ARCH-00",
        utf8_check_id="M227-E011-ARCH-UTF8",
        snippets=ARCHITECTURE_SNIPPETS,
    )
    check_document(
        path=args.lowering_spec,
        artifact="lowering_spec",
        exists_check_id="M227-E011-SPC-00",
        utf8_check_id="M227-E011-SPC-UTF8",
        snippets=LOWERING_SPEC_SNIPPETS,
    )
    check_document(
        path=args.metadata_spec,
        artifact="metadata_spec",
        exists_check_id="M227-E011-META-00",
        utf8_check_id="M227-E011-META-UTF8",
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-E011-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if isinstance(package_payload, dict):
        ...
        check(
            artifact="package_json",
            check_id="M227-E011-CFG-SCRIPTS",
    ...
    if findings:
        if not args.emit_json:
            print(
                "m227-e011-semantic-conformance-lane-e-performance-quality-guardrails: "
    ...
    if not args.emit_json:
        print("m227-e011-semantic-conformance-lane-e-performance-quality-guardrails: OK")
        print(f"- mode={MODE}")
