...
from .config import ACCEPTANCE_REPORT, INTEGRATION_REPORT, REQUIRED_SURFACE_CONTRACTS
...
def select_release_candidate_surfaces(
    ...
    case_map = build_report_case_map(acceptance_report)
    if report_has_required_cases(case_map) and report_has_required_surfaces(
        acceptance_report
    ):
        surfaces = {
        ...
        return surfaces, "acceptance-report", None
