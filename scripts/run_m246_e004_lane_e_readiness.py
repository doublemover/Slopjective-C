#!/usr/bin/env python3
"""Run M246-E004 lane-E readiness checks without deep npm nesting."""
...
BASELINE_DEPENDENCIES = ("M246-E003", "M246-A003")
PENDING_SEEDED_DEPENDENCY_TOKENS = ("M246-B004", "M246-C007", "M246-D003")
...
INITIAL_COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    ...
    (
        ...
        "run",
        "--if-present",
        "check:objc3c:m246-b004-lane-b-readiness",
    ),
    (
        NPM_EXECUTABLE,
        "run",
        "--if-present",
        "check:objc3c:m246-c007-lane-c-readiness",
    ),
    (
        NPM_EXECUTABLE,
        "run",
        "--if-present",
        "check:objc3c:m246-d003-lane-d-readiness",
    ),
)
...
def run_chain() -> int:
    ...
    print("[ok] M246-E004 lane-E readiness chain completed")
    return 0
