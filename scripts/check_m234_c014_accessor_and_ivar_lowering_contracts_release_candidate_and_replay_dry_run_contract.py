#!/usr/bin/env python3
"""Fail-closed checker for M234-C014 accessor and ivar lowering release-candidate and replay dry-run."""
...
MODE = "m234-c014-accessor-and-ivar-lowering-contracts-release-candidate-and-replay-dry-run-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_accessor_and_ivar_lowering_contracts_release_candidate_and_replay_dry_run_c014_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_c014_accessor_and_ivar_lowering_contracts_release_candidate_and_replay_dry_run_packet.md"
)
...
DEFAULT_C013_CHECKER = (
    ROOT / "scripts" / "check_m234_c013_accessor_and_ivar_lowering_contracts_docs_and_operator_runbook_synchronization_contract.py"
)
DEFAULT_C013_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_c013_accessor_and_ivar_lowering_contracts_docs_and_operator_runbook_synchronization_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-C014-DOC-PKT-01",
        "# M234-C014 Accessor and Ivar Lowering Contracts Release-Candidate and Replay Dry-Run Packet",
    ),
    SnippetCheck("M234-C014-DOC-PKT-02", "Packet: `M234-C014`"),
    SnippetCheck("M234-C014-DOC-PKT-03", "Issue: `#5732`"),
    SnippetCheck("M234-C014-DOC-PKT-04", "Dependencies: `M234-C013`"),
    SnippetCheck(
        "M234-C014-DOC-PKT-05",
        "scripts/check_m234_c014_accessor_and_ivar_lowering_contracts_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck(
        "M234-C014-DOC-PKT-06",
        "tests/tooling/test_check_m234_c014_accessor_and_ivar_lowering_contracts_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck("M234-C014-DOC-PKT-07", "`npm run check:objc3c:m234-c014-lane-c-readiness`"),
)

C013_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-C014-C013-DOC-01",
        "# M234 Accessor and Ivar Lowering Contracts Docs and Operator Runbook Synchronization Expectations (C013)",
    ),
    SnippetCheck(
        "M234-C014-C013-DOC-02",
...
C013_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-C014-C013-PKT-01", "Packet: `M234-C013`"),
    SnippetCheck("M234-C014-C013-PKT-02", "Dependencies: `M234-C012`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-C014-META-02",
        "explicit `M234-C013` dependency continuity so release-candidate and replay dry-run drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m234-c014-accessor-and-ivar-lowering-contracts-release-candidate-and-replay-dry-run-contract '
        '&& npm run test:tooling:m234-c014-accessor-and-ivar-lowering-contracts-release-candidate-and-replay-dry-run-contract"',
    ),
    SnippetCheck("M234-C014-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-C014-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-C014-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-C014-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str] | None = None) -> int:
    ...
    for path, exists_id, snippets in (
        (args.expectations_doc, "M234-C014-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-C014-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c013_expectations_doc, "M234-C014-C013-DOC-EXISTS", C013_EXPECTATIONS_SNIPPETS),
        (args.c013_packet_doc, "M234-C014-C013-PKT-EXISTS", C013_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-C014-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-C014-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-C014-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-C014-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c013_checker, "M234-C014-C013-CHECKER-EXISTS"),
        (args.c013_test, "M234-C014-C013-TEST-EXISTS"),
    ):
