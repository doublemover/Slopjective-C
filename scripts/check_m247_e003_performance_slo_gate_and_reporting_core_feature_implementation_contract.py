#!/usr/bin/env python3
"""Fail-closed checker for M247-E003 performance SLO core feature implementation."""
...
MODE = "m247-e003-performance-slo-gate-reporting-core-feature-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m247"
    / "m247_e003_performance_slo_gate_and_reporting_core_feature_implementation_packet.md"
)
DEFAULT_E002_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m247_lane_e_performance_slo_gate_and_reporting_modular_split_scaffolding_e002_expectations.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M247-E003-DEP-E002-01",
        Path("docs/contracts/m247_lane_e_performance_slo_gate_and_reporting_modular_split_scaffolding_e002_expectations.md"),
    ),
    AssetCheck(
        "M247-E003-DEP-E002-02",
        Path("spec/planning/compiler/m247/m247_e002_performance_slo_gate_and_reporting_modular_split_scaffolding_packet.md"),
    ),
    AssetCheck(
        "M247-E003-DEP-E002-03",
        Path("scripts/check_m247_e002_performance_slo_gate_and_reporting_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M247-E003-DEP-E002-04",
        Path("tests/tooling/test_check_m247_e002_performance_slo_gate_and_reporting_modular_split_scaffolding_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-E003-DOC-EXP-01",
        "# M247 Lane E Performance SLO Gate and Reporting Core Feature Implementation Expectations (E003)",
    ),
    SnippetCheck(
        "M247-E003-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-performance-slo-gate-reporting-core-feature-implementation-contract/m247-e003-v1`",
    ),
    SnippetCheck("M247-E003-DOC-EXP-03", "`M247-E002`"),
    SnippetCheck("M247-E003-DOC-EXP-04", "`M247-A003`"),
    SnippetCheck("M247-E003-DOC-EXP-05", "`M247-B003`"),
    SnippetCheck(
        "M247-E003-DOC-EXP-06",
        "| `M247-C003` | Dependency token `M247-C003` is mandatory as pending seeded lane-C core feature implementation assets. |",
    ),
    SnippetCheck("M247-E003-DOC-EXP-07", "`M247-D002`"),
    SnippetCheck(
        "M247-E003-DOC-EXP-08",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-E003-DOC-EXP-09",
        "`check:objc3c:m247-e003-performance-slo-gate-reporting-core-feature-implementation-contract`",
    ),
    SnippetCheck(
        "M247-E003-DOC-EXP-10",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-E003-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M247-E003-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M247-E003-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M247-E003-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-E003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-E003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.e002_expectations_doc, "M247-E003-E002-DOC-EXISTS", E002_SNIPPETS),
        (args.package_json, "M247-E003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
