#!/usr/bin/env python3
"""Fail-closed checker for M245-D020 build/link/runtime reproducibility advanced performance workpack shard 1."""
...
MODE = "m245-d020-build-link-runtime-reproducibility-operations-advanced-performance-workpack-shard1-contract-v1"
...
DEFAULT_D019_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m245_d019_build_link_runtime_reproducibility_operations_advanced_integration_workpack_shard1_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D020-DOC-PKT-01",
        "# M245-D020 Build/Link/Runtime Reproducibility Operations Advanced Performance Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M245-D020-DOC-PKT-02", "Packet: `M245-D020`"),
    SnippetCheck("M245-D020-DOC-PKT-03", "Issue: `#6671`"),
    SnippetCheck("M245-D020-DOC-PKT-04", "Dependencies: `M245-D019`"),
    SnippetCheck("M245-D020-DOC-PKT-05", "Theme: `advanced performance workpack (shard 1)`"),
    SnippetCheck(
        "M245-D020-DOC-PKT-06",
        "dependency continuity and code/spec anchors as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D020-DOC-PKT-07",
        "scripts/check_m245_d020_build_link_runtime_reproducibility_operations_advanced_performance_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D020-DOC-PKT-08",
        "tests/tooling/test_check_m245_d020_build_link_runtime_reproducibility_operations_advanced_performance_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D020-DOC-PKT-09",
    ...
    SnippetCheck("M245-D020-DOC-PKT-10", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-D020-DOC-PKT-11",
        "`python scripts/check_m245_d020_build_link_runtime_reproducibility_operations_advanced_performance_workpack_shard1_contract.py --emit-json`",
    ),
)
...
D019_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D020-D019-DOC-01",
        "# M245 Build/Link/Runtime Reproducibility Operations Advanced Integration Workpack (Shard 1) Expectations (D019)",
    ),
    SnippetCheck(
        "M245-D020-D019-DOC-02",
        "Contract ID: `objc3c-build-link-runtime-reproducibility-operations-advanced-integration-workpack-shard1/m245-d019-v1`",
    ),
    SnippetCheck("M245-D020-D019-DOC-03", "Dependencies: `M245-D018`"),
)

D019_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-D020-D019-PKT-01", "Packet: `M245-D019`"),
    SnippetCheck("M245-D020-D019-PKT-02", "Issue: `#6670`"),
    SnippetCheck("M245-D020-D019-PKT-03", "Dependencies: `M245-D018`"),
    SnippetCheck("M245-D020-D019-PKT-04", "Freeze date: `2026-03-04`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D020-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D020-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D020-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D020-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D020-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D020-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d019_expectations_doc, "M245-D020-D019-DOC-EXISTS", D019_EXPECTATIONS_SNIPPETS),
        (args.d019_packet_doc, "M245-D020-D019-PKT-EXISTS", D019_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D020-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D020-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D020-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D020-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d019_checker, "M245-D020-DEP-D019-ARG-01"),
        (args.d019_test, "M245-D020-DEP-D019-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
