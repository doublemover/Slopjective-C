#!/usr/bin/env python3
"""Fail-closed checker for M247-D007 runtime/link/build throughput optimization diagnostics hardening."""
...
MODE = "m247-d007-runtime-link-build-throughput-optimization-diagnostics-hardening-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_d007_lane_d_readiness.py"
...
DEFAULT_D006_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m247_d006_runtime_link_build_throughput_optimization_edge_case_expansion_and_robustness_contract.py"
)
DEFAULT_D006_READINESS = ROOT / "scripts" / "run_m247_d006_lane_d_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M247-D007-D006-01",
        "M247-D006",
        Path("docs/contracts/m247_runtime_link_build_throughput_optimization_edge_case_expansion_and_robustness_d006_expectations.md"),
    ),
    AssetCheck(
        "M247-D007-D006-02",
        "M247-D006",
        Path("spec/planning/compiler/m247/m247_d006_runtime_link_build_throughput_optimization_edge_case_expansion_and_robustness_packet.md"),
    ),
    AssetCheck(
        "M247-D007-D006-03",
        "M247-D006",
        Path("scripts/check_m247_d006_runtime_link_build_throughput_optimization_edge_case_expansion_and_robustness_contract.py"),
    ),
    AssetCheck(
        "M247-D007-D006-04",
        "M247-D006",
        Path("tests/tooling/test_check_m247_d006_runtime_link_build_throughput_optimization_edge_case_expansion_and_robustness_contract.py"),
    ),
    AssetCheck(
        "M247-D007-D006-05",
        "M247-D006",
        Path("scripts/run_m247_d006_lane_d_readiness.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D007-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-build-throughput-optimization-diagnostics-hardening/m247-d007-v1`",
    ),
    SnippetCheck("M247-D007-DOC-EXP-02", "Dependencies: `M247-D006`"),
    SnippetCheck(
        "M247-D007-DOC-EXP-03",
        "Issue `#6765` defines canonical lane-D diagnostics hardening scope.",
    ),
    SnippetCheck(
        "M247-D007-DOC-EXP-04",
        "scripts/check_m247_d006_runtime_link_build_throughput_optimization_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M247-D007-DOC-EXP-05",
        "scripts/run_m247_d007_lane_d_readiness.py",
    ),
    SnippetCheck("M247-D007-DOC-EXP-06", "`check:objc3c:m247-d007-lane-d-readiness`"),
    SnippetCheck("M247-D007-DOC-EXP-07", "`check:objc3c:m247-d006-lane-d-readiness`"),
    SnippetCheck("M247-D007-DOC-EXP-08", "`D006 readiness -> D007 checker -> D007 pytest`."),
    SnippetCheck(
        "M247-D007-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-D007-DOC-EXP-10",
        "tmp/reports/m247/M247-D007/runtime_link_build_throughput_optimization_diagnostics_hardening_contract_summary.json",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D007-DOC-PKT-01", "Packet: `M247-D007`"),
    SnippetCheck("M247-D007-DOC-PKT-02", "Issue: `#6765`"),
    SnippetCheck("M247-D007-DOC-PKT-03", "Dependencies: `M247-D006`"),
    SnippetCheck("M247-D007-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-D007-DOC-PKT-05",
        "`scripts/check_m247_d007_runtime_link_build_throughput_optimization_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck(
        "M247-D007-DOC-PKT-06",
        "`tests/tooling/test_check_m247_d007_runtime_link_build_throughput_optimization_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck(
        "M247-D007-DOC-PKT-07",
        "`scripts/run_m247_d007_lane_d_readiness.py`",
    ),
    SnippetCheck(
        "M247-D007-DOC-PKT-08",
        "`check:objc3c:m247-d007-lane-d-readiness`",
    ),
    SnippetCheck(
        "M247-D007-DOC-PKT-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-D007-DOC-PKT-10",
...
D006_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D007-D006-DOC-01",
        "Contract ID: `objc3c-runtime-link-build-throughput-optimization-edge-case-expansion-and-robustness/m247-d006-v1`",
    ),
    SnippetCheck(
        "M247-D007-D006-DOC-02",
        "Dependencies: `M247-D005`",
    ),
    SnippetCheck(
        "M247-D007-D006-DOC-03",
        "Issue `#6764` defines canonical lane-D edge-case expansion and robustness scope.",
    ),
)

D006_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D007-D006-PKT-01", "Packet: `M247-D006`"),
    SnippetCheck("M247-D007-D006-PKT-02", "Issue: `#6764`"),
    SnippetCheck("M247-D007-D006-PKT-03", "Dependencies: `M247-D005`"),
    SnippetCheck("M247-D007-D006-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D007-RUN-01", 'DEPENDENCY_TOKEN = "M247-D006"'),
    SnippetCheck("M247-D007-RUN-02", "check:objc3c:m247-d006-lane-d-readiness"),
    SnippetCheck(
        "M247-D007-RUN-03",
        "scripts/check_m247_d007_runtime_link_build_throughput_optimization_diagnostics_hardening_contract.py",
    ),
    ...
    SnippetCheck("M247-D007-RUN-05", "[ok] M247-D007 lane-D readiness chain completed"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M247-D007-CFG-03", "check:objc3c:m247-d007-lane-d-readiness"),
    PackageScriptKeyCheck("M247-D007-CFG-04", "check:objc3c:m247-d006-lane-d-readiness"),
    PackageScriptKeyCheck("M247-D007-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M247-D007-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M247-D007-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-D007-CFG-11", "test:objc3c:perf-budget"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--d006-readiness-script", type=Path, default=DEFAULT_D006_READINESS)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-D007-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-D007-DOC-PKT-00", PACKET_SNIPPETS),
        ("d006_expectations_doc", args.d006_expectations_doc, "M247-D007-D006-DOC-00", D006_EXPECTATIONS_SNIPPETS),
        ("d006_packet_doc", args.d006_packet_doc, "M247-D007-D006-PKT-00", D006_PACKET_SNIPPETS),
        ("readiness_script", args.readiness_script, "M247-D007-RUN-00", READINESS_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M247-D007-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M247-D007-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M247-D007-META-00", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d006_checker, "M247-D007-DEP-01"),
        (args.d006_test, "M247-D007-DEP-02"),
        (args.d006_readiness_script, "M247-D007-DEP-03"),
    ):
