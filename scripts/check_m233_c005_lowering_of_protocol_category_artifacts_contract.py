#!/usr/bin/env python3
"""Fail-closed checker for M233-C005 lowering of protocol/category artifacts contract freeze."""
...
MODE = "m233-c005-lowering-of-protocol-category-artifacts-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_c005_lowering_of_protocol_category_artifacts_edge_case_and_compatibility_completion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-C005-DOC-PKT-01",
        "# M233-C005 Lowering of protocol/category artifacts Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M233-C005-DOC-PKT-02", "Packet: `M233-C005`"),
    SnippetCheck("M233-C005-DOC-PKT-03", "Issue: `#4930`"),
    SnippetCheck("M233-C005-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M233-C005-DOC-PKT-05",
        "check:objc3c:m233-c005-lowering-of-protocol-category-artifacts-contract",
    ),
    SnippetCheck(
        "M233-C005-DOC-PKT-06",
        "tmp/reports/m233/M233-C005/lowering_of_protocol_category_artifacts_contract_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M233-C005-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M233-C005-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M233-C005-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M233-C005-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M233-C005-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M233-C005-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
