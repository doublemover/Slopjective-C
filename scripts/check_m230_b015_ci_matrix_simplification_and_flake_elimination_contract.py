#!/usr/bin/env python3
"""Fail-closed checker for M230-B015 CI matrix simplification/flake elimination contract freeze."""
...
MODE = "m230-b015-ci-matrix-simplification-and-flake-elimination-integration-closeout-and-gate-sign-off-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_b015_ci_matrix_simplification_and_flake_elimination_integration_closeout_and_gate_sign_off_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-B015-DOC-EXP-01",
        "# M230 Conformance Corpus Governance and Sharding Contract and Architecture Freeze Expectations (A001)",
    ),
    SnippetCheck(
        "M230-B015-DOC-EXP-02",
        "Contract ID: `objc3c-ci-matrix-simplification-and-flake-elimination/m230-b015-v1`",
    ),
    SnippetCheck("M230-B015-DOC-EXP-03", "Issue: `#5395`"),
    SnippetCheck("M230-B015-DOC-EXP-04", "Dependencies: `M230-B014`"),
    SnippetCheck(
        "M230-B015-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-B015-DOC-EXP-06",
        "`check:objc3c:m230-b015-lane-b-readiness`",
    ),
    SnippetCheck(
        "M230-B015-DOC-EXP-07",
        "`tmp/reports/m230/M230-B015/ci_matrix_simplification_and_flake_elimination_integration_closeout_and_gate_sign_off_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-B015-DOC-PKT-01",
        "# M230-B015 Conformance Corpus Governance and Sharding Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-B015-DOC-PKT-02", "Packet: `M230-B015`"),
    SnippetCheck("M230-B015-DOC-PKT-03", "Issue: `#5395`"),
    SnippetCheck("M230-B015-DOC-PKT-04", "Dependencies: `M230-B014`"),
    SnippetCheck(
        "M230-B015-DOC-PKT-05",
        "check:objc3c:m230-b015-ci-matrix-simplification-and-flake-elimination-integration-closeout-and-gate-sign-off-contract",
    ),
    SnippetCheck(
        "M230-B015-DOC-PKT-06",
        "tmp/reports/m230/M230-B015/ci_matrix_simplification_and_flake_elimination_integration_closeout_and_gate_sign_off_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-B015-PKG-03",
        '"check:objc3c:m230-b015-lane-b-readiness": '
        '"npm run check:objc3c:m230-b014-lane-b-readiness && npm run check:objc3c:m230-b015-ci-matrix-simplification-and-flake-elimination-integration-closeout-and-gate-sign-off-contract '
        '&& npm run test:tooling:m230-b015-ci-matrix-simplification-and-flake-elimination-integration-closeout-and-gate-sign-off-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-B015-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-B015-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-B015-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-B015-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-B015-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-B015-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
