#!/usr/bin/env python3
"""Fail-closed checker for M230-C002 Documentation generation as source-of-truth contract freeze."""
...
MODE = "m230-c002-documentation-generation-as-source-of-truth-modular-split-and-scaffolding-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_c002_documentation_generation_as_source_of_truth_modular_split_and_scaffolding_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-C002-DOC-EXP-01",
        "# M230 Documentation generation as source-of-truth Contract and Architecture Freeze Expectations (C001)",
    ),
    SnippetCheck(
        "M230-C002-DOC-EXP-02",
        "Contract ID: `objc3c-documentation-generation-as-source-of-truth/m230-c002-v1`",
    ),
    SnippetCheck("M230-C002-DOC-EXP-03", "Issue: `#5423`"),
    SnippetCheck("M230-C002-DOC-EXP-04", "Dependencies: `M230-C001`"),
    SnippetCheck(
        "M230-C002-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-C002-DOC-EXP-06",
        "`check:objc3c:m230-c002-lane-c-readiness`",
    ),
    SnippetCheck(
        "M230-C002-DOC-EXP-07",
        "`tmp/reports/m230/M230-C002/documentation_generation_as_source_of_truth_modular_split_and_scaffolding_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-C002-DOC-PKT-01",
        "# M230-C002 Documentation generation as source-of-truth Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-C002-DOC-PKT-02", "Packet: `M230-C002`"),
    SnippetCheck("M230-C002-DOC-PKT-03", "Issue: `#5423`"),
    SnippetCheck("M230-C002-DOC-PKT-04", "Dependencies: `M230-C001`"),
    SnippetCheck(
        "M230-C002-DOC-PKT-05",
        "check:objc3c:m230-c002-documentation-generation-as-source-of-truth-modular-split-and-scaffolding-contract",
    ),
    SnippetCheck(
        "M230-C002-DOC-PKT-06",
        "tmp/reports/m230/M230-C002/documentation_generation_as_source_of_truth_modular_split_and_scaffolding_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-C002-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-C002-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-C002-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-C002-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-C002-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-C002-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
