#!/usr/bin/env python3
"""Fail-closed checker for M231-D008 Frontend/runtime declaration metadata linkage contract freeze."""
...
MODE = "m231-d008-frontend-runtime-declaration-metadata-linkage-integration-closeout-and-gate-sign-off-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_d008_frontend_runtime_declaration_metadata_linkage_integration_closeout_and_gate_sign_off_packet.md"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M231-D008-PKG-03",
        '"check:objc3c:m231-d008-lane-d-readiness": '
        '"npm run check:objc3c:m231-d007-lane-d-readiness && npm run check:objc3c:m231-d008-frontend-runtime-declaration-metadata-linkage-integration-closeout-and-gate-sign-off-contract '
        '&& npm run test:tooling:m231-d008-frontend-runtime-declaration-metadata-linkage-integration-closeout-and-gate-sign-off-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-D008-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-D008-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-D008-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-D008-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-D008-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-D008-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
