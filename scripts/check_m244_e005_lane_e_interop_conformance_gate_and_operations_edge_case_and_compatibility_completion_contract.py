#!/usr/bin/env python3
"""Fail-closed contract checker for M244-E005 interop conformance edge-case and compatibility completion."""
...
MODE = "m244-e005-lane-e-interop-conformance-gate-operations-edge-case-and-compatibility-completion-contract-v1"

ARTIFACTS: dict[str, Path] = {
    "expectations_doc": ROOT
    / "docs"
    / "contracts"
    / "m244_lane_e_interop_conformance_gate_and_operations_edge_case_and_compatibility_completion_e005_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m244"
    / "m244_e005_lane_e_interop_conformance_gate_and_operations_edge_case_and_compatibility_completion_packet.md",
...
EXISTENCE_CHECK_IDS: dict[str, str] = {
    "expectations_doc": "M244-E005-DOC-EXP-EXISTS",
    "packet_doc": "M244-E005-DOC-PKT-EXISTS",
    "architecture_doc": "M244-E005-ARCH-EXISTS",
    "lowering_spec": "M244-E005-SPC-EXISTS",
    "metadata_spec": "M244-E005-META-EXISTS",
    "package_json": "M244-E005-PKG-EXISTS",
}

REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "expectations_doc": (
        (
            "M244-E005-DOC-EXP-01",
            "# M244 Lane E Interop Conformance Gate and Operations Edge-Case and Compatibility Completion Expectations (E005)",
        ),
        (
            "M244-E005-DOC-EXP-02",
        ...
        ("M244-E005-DOC-EXP-11", "`check:objc3c:m244-e005-lane-e-readiness`"),
        ("M244-E005-DOC-EXP-12", "`test:objc3c:diagnostics-replay-proof`"),
        ("M244-E005-DOC-EXP-13", "`test:objc3c:execution-replay-proof`"),
        (
            "M244-E005-DOC-EXP-14",
            "tmp/reports/m244/M244-E005/lane_e_interop_conformance_gate_operations_edge_case_compatibility_completion_summary.json",
        ),
    ),
    "packet_doc": (
        (
            "M244-E005-DOC-PKT-01",
            "# M244-E005 Lane-E Interop Conformance Gate and Operations Edge-Case and Compatibility Completion Packet",
        ),
        ("M244-E005-DOC-PKT-02", "Packet: `M244-E005`"),
        ("M244-E005-DOC-PKT-03", "Issue: `#6599`"),
        (
            "M244-E005-DOC-PKT-04",
            "Dependencies: `M244-E004`, `M244-A004`, `M244-B006`, `M244-C007`, `M244-D006`",
        ),
        (
            "M244-E005-DOC-PKT-05",
        ...
        (
            "M244-E005-DOC-PKT-06",
            "scripts/check_m244_e005_lane_e_interop_conformance_gate_and_operations_edge_case_and_compatibility_completion_contract.py",
        ),
        (
            "M244-E005-DOC-PKT-07",
            "tests/tooling/test_check_m244_e005_lane_e_interop_conformance_gate_and_operations_edge_case_and_compatibility_completion_contract.py",
        ),
        (
            "M244-E005-DOC-PKT-08",
            "including code/spec anchors and milestone",
        ),
        (
            "M244-E005-DOC-PKT-09",
            "`npm run --if-present check:objc3c:m244-b006-lane-b-readiness`",
        ),
        (
            "M244-E005-DOC-PKT-10",
            "`npm run --if-present check:objc3c:m244-c007-lane-c-readiness`",
        ),
        (
            "M244-E005-DOC-PKT-11",
            "`npm run --if-present check:objc3c:m244-d006-lane-d-readiness`",
        ),
        ("M244-E005-DOC-PKT-12", "`test:objc3c:diagnostics-replay-proof`"),
        ("M244-E005-DOC-PKT-13", "`test:objc3c:execution-replay-proof`"),
        (
            "M244-E005-DOC-PKT-14",
            "tmp/reports/m244/M244-E005/lane_e_interop_conformance_gate_operations_edge_case_compatibility_completion_summary.json",
        ),
    ),
    "architecture_doc": (
        ...
        (
            "M244-E005-ARCH-02",
            "(`M244-E004`, `M244-A004`, `M244-B006`, `M244-C007`, and `M244-D006`)",
        ),
        (
            "M244-E005-ARCH-03",
            "docs/contracts/m244_lane_e_interop_conformance_gate_and_operations_edge_case_and_compatibility_completion_e005_expectations.md",
    ...
    "package_json": (
        ...
        (
            ...
            '&& npm run --if-present check:objc3c:m244-c007-lane-c-readiness '
            '&& npm run --if-present check:objc3c:m244-d006-lane-d-readiness '
            '&& npm run check:objc3c:m244-e005-lane-e-interop-conformance-gate-operations-edge-case-and-compatibility-completion-contract '
            '&& npm run test:tooling:m244-e005-lane-e-interop-conformance-gate-operations-edge-case-and-compatibility-completion-contract"',
        ),
        (
            "M244-E005-PKG-04",
