#!/usr/bin/env python3
"""Fail-closed checker for M227-D008 runtime-facing type metadata recovery/determinism hardening."""
...
MODE = "m227-d008-runtime-facing-type-metadata-recovery-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_runtime_facing_type_metadata_recovery_determinism_hardening_d008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_d008_runtime_facing_type_metadata_recovery_determinism_hardening_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-D008-DOC-EXP-08",
        "tmp/reports/m227/M227-D008/runtime_facing_type_metadata_recovery_determinism_hardening_contract_summary.json",
    ),
    SnippetCheck(
        "M227-D008-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M227-D008-DOC-PKT-01", "Packet: `M227-D008`"),
    SnippetCheck("M227-D008-DOC-PKT-02", "Issue: `#5154`"),
    SnippetCheck("M227-D008-DOC-PKT-03", "Dependencies: `M227-D007`"),
    SnippetCheck(
        "M227-D008-DOC-PKT-04",
        "`scripts/check_m227_d008_runtime_facing_type_metadata_recovery_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M227-D008-DOC-PKT-05",
        "`tests/tooling/test_check_m227_d008_runtime_facing_type_metadata_recovery_determinism_hardening_contract.py`",
    ),
    SnippetCheck("M227-D008-DOC-PKT-06", "`check:objc3c:m227-d008-lane-d-readiness`"),
    SnippetCheck(
        "M227-D008-DOC-PKT-07",
        "`python scripts/check_m227_d008_runtime_facing_type_metadata_recovery_determinism_hardening_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M227-D008-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

FRONTEND_TYPES_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M227-D008-TYP-01", "bool typed_recovery_determinism_consistent = false;"),
    SnippetCheck("M227-D008-TYP-02", "bool typed_recovery_determinism_ready = false;"),
    SnippetCheck("M227-D008-TYP-03", "std::string typed_recovery_determinism_key;"),
    SnippetCheck("M227-D008-TYP-04", "bool typed_sema_recovery_determinism_consistent = false;"),
    SnippetCheck("M227-D008-TYP-05", "bool typed_sema_recovery_determinism_ready = false;"),
    SnippetCheck("M227-D008-TYP-06", "std::string typed_sema_recovery_determinism_key;"),
)

TYPED_SURFACE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M227-D008-SUR-01", "surface.typed_recovery_determinism_consistent ="),
    SnippetCheck("M227-D008-SUR-02", "surface.typed_recovery_determinism_ready ="),
    SnippetCheck("M227-D008-SUR-03", "surface.typed_recovery_determinism_key ="),
    SnippetCheck("M227-D008-SUR-04", "const bool typed_recovery_determinism_key_ready ="),
    SnippetCheck(
        "M227-D008-SUR-05",
...
PARSE_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M227-D008-REA-01", "surface.typed_sema_recovery_determinism_consistent ="),
    SnippetCheck("M227-D008-REA-02", "surface.typed_sema_recovery_determinism_ready ="),
    SnippetCheck("M227-D008-REA-03", "surface.typed_sema_recovery_determinism_key ="),
    SnippetCheck(
        "M227-D008-REA-04",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-D008-CFG-03", "check:objc3c:m227-d008-lane-d-readiness"),
    PackageScriptKeyCheck("M227-D008-CFG-04", "check:objc3c:m227-d007-lane-d-readiness"),
    PackageScriptKeyCheck("M227-D008-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M227-D008-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M227-D008-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-D008-CFG-11", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m227-d007-lane-d-readiness && npm run check:objc3c:m227-d008-runtime-facing-type-metadata-recovery-determinism-hardening-contract && npm run test:tooling:m227-d008-runtime-facing-type-metadata-recovery-determinism-hardening-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-D008-SPC-01",
        "runtime-facing type metadata recovery/determinism hardening governance shall preserve explicit lane-D dependency anchors (`M227-D008`, `M227-D007`)",
    ),
    SnippetCheck(
        "M227-D008-SPC-02",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-D008-META-02",
        "explicit `M227-D007` dependency continuity and fail-closed recovery-determinism evidence continuity",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M227-D008-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M227-D008-DOC-PKT-00",
    ...
    frontend_checks, frontend_findings = check_doc_contract(
        ...
        exists_check_id="M227-D008-TYP-00",
    ...
    typed_checks, typed_findings = check_doc_contract(
        ...
        exists_check_id="M227-D008-SUR-00",
    ...
    readiness_checks, readiness_findings = check_doc_contract(
        ...
        exists_check_id="M227-D008-REA-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M227-D008-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M227-D008-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M227-D008-META-00",
