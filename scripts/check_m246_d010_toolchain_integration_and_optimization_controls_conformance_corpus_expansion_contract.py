#!/usr/bin/env python3
"""Fail-closed checker for M246-D010 toolchain integration/optimization controls conformance corpus expansion."""
...
MODE = "m246-d010-toolchain-integration-optimization-controls-conformance-corpus-expansion-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_d010_lane_d_readiness.py"
DEFAULT_D009_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m246_toolchain_integration_and_optimization_controls_conformance_matrix_implementation_d009_expectations.md"
)
DEFAULT_D009_PACKET_DOC = (
    ...
    / "compiler"
    / "m246"
    / "m246_d009_toolchain_integration_and_optimization_controls_conformance_matrix_implementation_packet.md"
)
DEFAULT_D009_CHECKER = (
    ROOT
    / "scripts"
    / "check_m246_d009_toolchain_integration_and_optimization_controls_conformance_matrix_implementation_contract.py"
)
DEFAULT_D009_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m246_d009_toolchain_integration_and_optimization_controls_conformance_matrix_implementation_contract.py"
)
DEFAULT_D009_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_d009_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D010-DOC-PKT-01",
        "# M246-D010 Toolchain Integration and Optimization Controls Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M246-D010-DOC-PKT-02", "Packet: `M246-D010`"),
    SnippetCheck("M246-D010-DOC-PKT-03", "Issue: `#6689`"),
    SnippetCheck("M246-D010-DOC-PKT-04", "Dependencies: `M246-D009`"),
    SnippetCheck("M246-D010-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-D010-DOC-PKT-06", "Dependency anchors from `M246-D009`:"),
    SnippetCheck(
        "M246-D010-DOC-PKT-07",
        "scripts/run_m246_d010_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M246-D010-DOC-PKT-08",
    ...
    SnippetCheck(
        "M246-D010-DOC-PKT-09",
        "`D009 readiness -> D010 checker -> D010 pytest`",
    ),
    SnippetCheck(
        "M246-D010-DOC-PKT-10",
        "tmp/reports/m246/M246-D010/toolchain_integration_optimization_controls_conformance_corpus_expansion_contract_summary.json",
    ),
)
...
D009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D010-D009-DOC-01",
        "Contract ID: `objc3c-toolchain-integration-optimization-controls-conformance-matrix-implementation/m246-d009-v1`",
    ),
    SnippetCheck(
        "M246-D010-D009-DOC-02",
        "Dependencies: `M246-D008`",
    ),
    SnippetCheck(
        "M246-D010-D009-DOC-03",
        "Issue `#6688` defines canonical lane-D conformance matrix implementation scope.",
    ),
)

D009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D010-D009-PKT-01", "Packet: `M246-D009`"),
    SnippetCheck("M246-D010-D009-PKT-02", "Issue: `#6688`"),
    SnippetCheck("M246-D010-D009-PKT-03", "Dependencies: `M246-D008`"),
    SnippetCheck("M246-D010-D009-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D010-RDY-01", 'DEPENDENCY_TOKEN = "M246-D009"'),
    SnippetCheck(
        "M246-D010-RDY-02",
    ...
    SnippetCheck("M246-D010-RDY-05", "[ok] M246-D010 lane-D readiness chain completed"),
)

D009_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D010-D009-RDY-01", 'DEPENDENCY_TOKEN = "M246-D008"'),
    SnippetCheck(
        "M246-D010-D009-RDY-02",
        "scripts/run_m246_d008_lane_d_readiness.py",
    ),
    SnippetCheck("M246-D010-D009-RDY-03", "[ok] M246-D009 lane-D readiness chain completed"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--d009-readiness-script", type=Path, default=DEFAULT_D009_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-D010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-D010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d009_expectations_doc, "M246-D010-D009-DOC-EXISTS", D009_EXPECTATIONS_SNIPPETS),
        (args.d009_packet_doc, "M246-D010-D009-PKT-EXISTS", D009_PACKET_SNIPPETS),
        (args.readiness_script, "M246-D010-RDY-EXISTS", READINESS_SNIPPETS),
        (args.d009_readiness_script, "M246-D010-D009-RDY-EXISTS", D009_READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d009_checker, "M246-D010-DEP-D009-ARG-01"),
        (args.d009_test, "M246-D010-DEP-D009-ARG-02"),
    ):
    ...
    if not summary_ok:
        print(
            f"[M246-D010-SUMMARY-WRITE-01] {display_path(summary_path)}: {summary_error}",
            file=sys.stderr,
        )
        return 1
