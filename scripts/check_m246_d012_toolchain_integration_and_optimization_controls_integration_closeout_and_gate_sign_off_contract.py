#!/usr/bin/env python3
"""Fail-closed checker for M246-D012 toolchain integration/optimization controls integration closeout and gate sign-off."""
...
MODE = "m246-d012-toolchain-integration-optimization-controls-integration-closeout-and-gate-sign-off-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_d012_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D012-DOC-PKT-01",
        "# M246-D012 Toolchain Integration and Optimization Controls Integration Closeout and Gate Sign-off Packet",
    ),
    SnippetCheck("M246-D012-DOC-PKT-02", "Packet: `M246-D012`"),
    SnippetCheck("M246-D012-DOC-PKT-03", "Issue: `#6691`"),
    SnippetCheck("M246-D012-DOC-PKT-04", "Dependencies: `M246-D011`"),
    SnippetCheck("M246-D012-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-D012-DOC-PKT-06", "Dependency anchors from `M246-D011`:"),
    SnippetCheck(
        "M246-D012-DOC-PKT-07",
        "scripts/run_m246_d012_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M246-D012-DOC-PKT-08",
    ...
    SnippetCheck(
        "M246-D012-DOC-PKT-09",
        "`D011 readiness -> D012 checker -> D012 pytest`",
    ),
    SnippetCheck(
        "M246-D012-DOC-PKT-10",
        "tmp/reports/m246/M246-D012/toolchain_integration_optimization_controls_integration_closeout_and_gate_sign_off_contract_summary.json",
    ),
)
...
D011_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D012-D011-DOC-01",
        "Contract ID: `objc3c-toolchain-integration-optimization-controls-performance-and-quality-guardrails/m246-d011-v1`",
    ),
    SnippetCheck(
        "M246-D012-D011-DOC-02",
        "Dependencies: `M246-D010`",
    ),
    SnippetCheck(
        "M246-D012-D011-DOC-03",
        "Issue `#6690` defines canonical lane-D performance and quality guardrails scope.",
    ),
)

D011_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D012-D011-PKT-01", "Packet: `M246-D011`"),
    SnippetCheck("M246-D012-D011-PKT-02", "Issue: `#6690`"),
    SnippetCheck("M246-D012-D011-PKT-03", "Dependencies: `M246-D010`"),
    SnippetCheck("M246-D012-D011-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D012-RDY-01", 'DEPENDENCY_TOKEN = "M246-D011"'),
    SnippetCheck(
        "M246-D012-RDY-02",
    ...
    SnippetCheck("M246-D012-RDY-05", "[ok] M246-D012 lane-D readiness chain completed"),
)

D011_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D012-D011-RDY-01", 'DEPENDENCY_TOKEN = "M246-D010"'),
    SnippetCheck(
        "M246-D012-D011-RDY-02",
        "scripts/run_m246_d010_lane_d_readiness.py",
    ),
    SnippetCheck("M246-D012-D011-RDY-03", "[ok] M246-D011 lane-D readiness chain completed"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-D012-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-D012-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d011_expectations_doc, "M246-D012-D011-DOC-EXISTS", D011_EXPECTATIONS_SNIPPETS),
        (args.d011_packet_doc, "M246-D012-D011-PKT-EXISTS", D011_PACKET_SNIPPETS),
        (args.readiness_script, "M246-D012-RDY-EXISTS", READINESS_SNIPPETS),
        (args.d011_readiness_script, "M246-D012-D011-RDY-EXISTS", D011_READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d011_checker, "M246-D012-DEP-D011-ARG-01"),
        (args.d011_test, "M246-D012-DEP-D011-ARG-02"),
    ):
    ...
    if not summary_ok:
        print(
            f"[M246-D012-SUMMARY-WRITE-01] {display_path(summary_path)}: {summary_error}",
            file=sys.stderr,
        )
        return 1
