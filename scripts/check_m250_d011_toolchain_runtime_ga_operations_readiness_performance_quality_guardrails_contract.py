#!/usr/bin/env python3
"""Fail-closed validator for M250-D011 toolchain/runtime GA performance guardrails."""
...
MODE = "m250-toolchain-runtime-ga-operations-readiness-performance-quality-guardrails-contract-d011-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m250"
    / "m250_d011_toolchain_runtime_ga_operations_readiness_performance_quality_guardrails_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "architecture_doc": (
        ("M250-D011-ARC-01", "M250 lane-D D011 performance and quality guardrails"),
        ("M250-D011-ARC-02", "toolchain/runtime performance/quality guardrail"),
    ),
    "d010_contract_doc": (
        (
            "M250-D011-DEP-01",
    ...
    "contract_doc": (
        ...
        (
            "M250-D011-DOC-04",
            "scripts/check_m250_d011_toolchain_runtime_ga_operations_readiness_performance_quality_guardrails_contract.py",
        ),
        (
            "M250-D011-DOC-05",
            "tests/tooling/test_check_m250_d011_toolchain_runtime_ga_operations_readiness_performance_quality_guardrails_contract.py",
        ),
        ("M250-D011-DOC-06", "npm run check:objc3c:m250-d011-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M250-D011-PKT-01", "Packet: `M250-D011`"),
        ("M250-D011-PKT-02", "Dependencies: `M250-D010`"),
        (
            "M250-D011-PKT-03",
            "scripts/check_m250_d011_toolchain_runtime_ga_operations_readiness_performance_quality_guardrails_contract.py",
        ),
    ...
    "package_json": (
        (
            "M250-D011-CFG-01",
            '"check:objc3c:m250-d011-toolchain-runtime-ga-operations-readiness-performance-quality-guardrails-contract"',
        ),
        (
            "M250-D011-CFG-02",
            '"test:tooling:m250-d011-toolchain-runtime-ga-operations-readiness-performance-quality-guardrails-contract"',
        ),
        ("M250-D011-CFG-03", '"check:objc3c:m250-d011-lane-d-readiness"'),
    ),
}
