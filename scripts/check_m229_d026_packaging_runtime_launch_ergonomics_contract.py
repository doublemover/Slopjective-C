#!/usr/bin/env python3
"""Fail-closed checker for M229-D026 packaging and runtime launch ergonomics contract freeze."""
...
MODE = "m229-d026-packaging-runtime-launch-ergonomics-advanced-performance-workpack-shard-2-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_d026_packaging_runtime_launch_ergonomics_advanced_performance_workpack_shard_2_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-D026-DOC-PKT-01",
        "# M229-D026 Packaging and runtime launch ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-D026-DOC-PKT-02", "Packet: `M229-D026`"),
    SnippetCheck("M229-D026-DOC-PKT-03", "Issue: `#5376`"),
    SnippetCheck("M229-D026-DOC-PKT-04", "Dependencies: `M229-D025`"),
    SnippetCheck(
        "M229-D026-DOC-PKT-05",
        "check:objc3c:m229-d026-packaging-runtime-launch-ergonomics-advanced-performance-workpack-shard-2-contract",
    ),
    SnippetCheck(
        "M229-D026-DOC-PKT-06",
        "tmp/reports/m229/M229-D026/packaging_runtime_launch_ergonomics_advanced_performance_workpack_shard_2_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-D026-PKG-03",
        '"check:objc3c:m229-d026-lane-d-readiness": '
        '"npm run check:objc3c:m229-d025-lane-d-readiness && npm run check:objc3c:m229-d026-packaging-runtime-launch-ergonomics-advanced-performance-workpack-shard-2-contract '
        '&& npm run test:tooling:m229-d026-packaging-runtime-launch-ergonomics-advanced-performance-workpack-shard-2-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-D026-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-D026-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-D026-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-D026-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-D026-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-D026-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
