#!/usr/bin/env python3
"""Fail-closed checker for M233-E015 conformance corpus and gate closeout advanced core workpack (shard 1)."""
...
MODE = "m233-e015-lane-e-conformance-corpus-gate-closeout-advanced-core-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_lane_e_conformance_corpus_and_gate_closeout_advanced_core_workpack_shard1_e015_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_e015_lane_e_conformance_corpus_and_gate_closeout_advanced_core_workpack_shard1_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E015-DOC-EXP-01",
        "# M233 Lane E Conformance Corpus and Gate Closeout Advanced Core Workpack (Shard 1) Expectations (E015)",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-conformance-corpus-gate-closeout-cross-lane-integration-sync/m233-e015-v1`",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-03",
        "Issue `#5668` defines canonical lane-E advanced core workpack (shard 1) scope.",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-04",
        "Dependencies: `M233-E014`, `M233-A011`, `M233-B015`, `M233-C019`, `M233-D025`",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-05",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_performance_and_quality_guardrails_e011_expectations.md",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-06",
        "`M233-A011`",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-07",
        "`M233-B015`",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-08",
        "`M233-C019`",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-09",
        "`M233-D025`",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-10",
        "advanced core workpack (shard 1) traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-11",
        "Predecessor anchor: `M233-E014` release-candidate and replay dry-run continuity is the mandatory baseline for E015.",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-12",
        "`scripts/check_m233_e015_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-13",
        "`tests/tooling/test_check_m233_e015_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M233-E015-DOC-EXP-14",
        "`tmp/reports/m233/M233-E015/lane_e_conformance_corpus_gate_closeout_advanced_core_workpack_shard1_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E015-DOC-PKT-01",
        "# M233-E015 Lane-E Conformance Corpus and Gate Closeout Advanced Core Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M233-E015-DOC-PKT-02", "Packet: `M233-E015`"),
    SnippetCheck("M233-E015-DOC-PKT-03", "Issue: `#5668`"),
    SnippetCheck(
        "M233-E015-DOC-PKT-04",
        "Dependencies: `M233-E014`, `M233-A011`, `M233-B015`, `M233-C019`, `M233-D025`",
    ),
    SnippetCheck("M233-E015-DOC-PKT-05", "Predecessor: `M233-E014`"),
    SnippetCheck("M233-E015-DOC-PKT-06", "Theme: advanced core workpack (shard 1)"),
    SnippetCheck(
        "M233-E015-DOC-PKT-07",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_advanced_core_workpack_shard1_e015_expectations.md",
    ),
    SnippetCheck(
        "M233-E015-DOC-PKT-08",
        "scripts/check_m233_e015_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M233-E015-DOC-PKT-09",
        "tests/tooling/test_check_m233_e015_lane_e_conformance_corpus_and_gate_closeout_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M233-E015-DOC-PKT-10",
    ...
    SnippetCheck(
        "M233-E015-DOC-PKT-11",
        "advanced core workpack (shard 1) traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E015-DOC-PKT-12",
        "tmp/reports/m233/M233-E015/lane_e_conformance_corpus_gate_closeout_advanced_core_workpack_shard1_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-E015-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M233-E015-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M233-E015-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-E015-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-E015-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-E015-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M233-E015-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
