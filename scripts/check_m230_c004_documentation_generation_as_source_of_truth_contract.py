#!/usr/bin/env python3
"""Fail-closed checker for M230-C004 Documentation generation as source-of-truth contract freeze."""
...
MODE = "m230-c004-documentation-generation-as-source-of-truth-core-feature-expansion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_c004_documentation_generation_as_source_of_truth_core_feature_expansion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-C004-DOC-PKT-01",
        "# M230-C004 Documentation generation as source-of-truth Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-C004-DOC-PKT-02", "Packet: `M230-C004`"),
    SnippetCheck("M230-C004-DOC-PKT-03", "Issue: `#5425`"),
    SnippetCheck("M230-C004-DOC-PKT-04", "Dependencies: `M230-C003`"),
    SnippetCheck(
        "M230-C004-DOC-PKT-05",
        "check:objc3c:m230-c004-documentation-generation-as-source-of-truth-core-feature-expansion-contract",
    ),
    SnippetCheck(
        "M230-C004-DOC-PKT-06",
        "tmp/reports/m230/M230-C004/documentation_generation_as_source_of_truth_core_feature_expansion_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-C004-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-C004-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-C004-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-C004-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-C004-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-C004-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
