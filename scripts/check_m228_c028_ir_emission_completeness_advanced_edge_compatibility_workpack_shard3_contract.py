#!/usr/bin/env python3
"""Fail-closed validator for M228-C028 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c027_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c027_ir_emission_completeness_advanced_core_workpack_shard3_contract.py",
    "c027_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c027_ir_emission_completeness_advanced_core_workpack_shard3_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C028-RUN-04", "npm run check:objc3c:m228-c028-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C028-ARC-01",
    ...
    "package_json": (
        ("M228-C028-PKG-01", '"check:objc3c:m228-c027-lane-c-readiness"'),
        (
            "M228-C028-PKG-02",
            '"check:objc3c:m228-c028-ir-emission-completeness-advanced-edge-compatibility-workpack-shard3-contract"',
        ),
        (
            "M228-C028-PKG-03",
            '"test:tooling:m228-c028-ir-emission-completeness-advanced-edge-compatibility-workpack-shard3-contract"',
        ),
        ("M228-C028-PKG-04", '"check:objc3c:m228-c028-lane-c-readiness"'),
        (
            "M228-C028-PKG-05",
    ...
    "c027_checker": (
        (
            "M228-C028-DEP-02",
            'MODE = "m228-c027-ir-emission-completeness-advanced-core-workpack-shard3-contract-v1"',
        ),
    ),
    "c027_tooling_test": (
        ("M228-C028-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c027_packet_doc": (
        ("M228-C028-DEP-04", "Packet: `M228-C027`"),
        ("M228-C028-DEP-05", "Issue: `#5253`"),
    ),
    "contract_doc": (
        (
            "M228-C028-DOC-01",
        ...
        ("M228-C028-DOC-02", "Execute issue `#5254`"),
        ("M228-C028-DOC-03", "Dependencies: `M228-C027`"),
        (
            "M228-C028-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        (
            "M228-C028-PKT-01",
            "# M228-C028 IR Emission Completeness Advanced Edge Compatibility Workpack (Shard 3) Packet",
        ),
        ("M228-C028-PKT-02", "Packet: `M228-C028`"),
        ("M228-C028-PKT-03", "Issue: `#5254`"),
        ("M228-C028-PKT-04", "Dependencies: `M228-C027`"),
        (
            "M228-C028-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C028-FORB-01",
            '"check:objc3c:m228-c028-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C028/"
            "ir_emission_completeness_advanced_edge_compatibility_workpack_shard3_contract_summary.json"
        ),
    )
