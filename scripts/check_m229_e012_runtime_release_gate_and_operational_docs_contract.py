#!/usr/bin/env python3
"""Fail-closed checker for M229-E012 runtime release gate and operational docs contract freeze."""
...
MODE = "m229-e012-runtime-release-gate-and-operational-docs-cross-lane-integration-sync-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_e012_runtime_release_gate_and_operational_docs_cross_lane_integration_sync_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-E012-DOC-PKT-01",
        "# M229-E012 Runtime release gate and operational docs Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-E012-DOC-PKT-02", "Packet: `M229-E012`"),
    SnippetCheck("M229-E012-DOC-PKT-03", "Issue: `#5389`"),
    SnippetCheck("M229-E012-DOC-PKT-04", "Dependencies: `M229-E011`"),
    SnippetCheck(
        "M229-E012-DOC-PKT-05",
        "check:objc3c:m229-e012-runtime-release-gate-and-operational-docs-cross-lane-integration-sync-contract",
    ),
    SnippetCheck(
        "M229-E012-DOC-PKT-06",
        "tmp/reports/m229/M229-E012/runtime_release_gate_and_operational_docs_cross_lane_integration_sync_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-E012-PKG-03",
        '"check:objc3c:m229-e012-lane-e-readiness": '
        '"npm run check:objc3c:m229-e011-lane-e-readiness && npm run check:objc3c:m229-e012-runtime-release-gate-and-operational-docs-cross-lane-integration-sync-contract '
        '&& npm run test:tooling:m229-e012-runtime-release-gate-and-operational-docs-cross-lane-integration-sync-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-E012-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-E012-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-E012-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-E012-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-E012-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-E012-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
