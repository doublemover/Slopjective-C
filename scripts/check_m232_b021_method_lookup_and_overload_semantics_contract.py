#!/usr/bin/env python3
"""Fail-closed checker for M232-B021 method lookup and overload semantics contract freeze."""
...
MODE = "m232-b021-method-lookup-and-overload-semantics-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m232"
    / "m232_b021_method_lookup_and_overload_semantics_advanced_core_workpack_shard_2_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-B021-DOC-PKT-01",
        "# M232-B021 Runtime Selector Binding Integration Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M232-B021-DOC-PKT-02", "Packet: `M232-B021`"),
    SnippetCheck("M232-B021-DOC-PKT-03", "Issue: `#5601`"),
    SnippetCheck("M232-B021-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M232-B021-DOC-PKT-05",
        "check:objc3c:m232-b021-method-lookup-and-overload-semantics-contract",
    ),
    SnippetCheck(
        "M232-B021-DOC-PKT-06",
        "tmp/reports/m232/M232-B021/method_lookup_and_overload_semantics_contract_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M232-B021-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M232-B021-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M232-B021-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M232-B021-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M232-B021-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M232-B021-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
