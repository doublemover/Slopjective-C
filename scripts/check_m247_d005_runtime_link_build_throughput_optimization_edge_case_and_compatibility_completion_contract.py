#!/usr/bin/env python3
"""Fail-closed checker for M247-D005 runtime/link/build throughput optimization edge-case and compatibility completion contract."""
...
MODE = "m247-d005-runtime-link-build-throughput-optimization-edge-case-and-compatibility-completion-contract-v1"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D005-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-build-throughput-optimization-edge-case-compatibility-completion/m247-d005-v1`",
    ),
    SnippetCheck("M247-D005-DOC-EXP-02", "Dependencies: `M247-D004`"),
    SnippetCheck(
        "M247-D005-DOC-EXP-03",
        "Issue `#6763` defines canonical lane-D edge-case and compatibility completion scope.",
    ),
    SnippetCheck("M247-D005-DOC-EXP-04", "`check:objc3c:m247-d005-lane-d-readiness`"),
    SnippetCheck("M247-D005-DOC-EXP-05", "`check:objc3c:m247-d004-lane-d-readiness`"),
    SnippetCheck("M247-D005-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M247-D005-DOC-EXP-07",
        "tmp/reports/m247/M247-D005/runtime_link_build_throughput_optimization_edge_case_and_compatibility_completion_contract_summary.json",
    ),
    SnippetCheck(
        "M247-D005-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D005-DOC-PKT-01", "Packet: `M247-D005`"),
    SnippetCheck("M247-D005-DOC-PKT-02", "Issue: `#6763`"),
    SnippetCheck("M247-D005-DOC-PKT-03", "Dependencies: `M247-D004`"),
    SnippetCheck("M247-D005-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-D005-DOC-PKT-05",
        "`scripts/check_m247_d005_runtime_link_build_throughput_optimization_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M247-D005-DOC-PKT-06",
    ...
    SnippetCheck("M247-D005-DOC-PKT-07", "`check:objc3c:m247-d005-lane-d-readiness`"),
    SnippetCheck(
        "M247-D005-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M247-D005-CFG-03", "check:objc3c:m247-d005-lane-d-readiness"),
    PackageScriptKeyCheck("M247-D005-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M247-D005-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M247-D005-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-D005-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m247-d004-lane-d-readiness && npm run check:objc3c:m247-d005-runtime-link-build-throughput-optimization-edge-case-and-compatibility-completion-contract && npm run test:tooling:m247-d005-runtime-link-build-throughput-optimization-edge-case-and-compatibility-completion-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-D005-ARCH-03",
        "and fail-closed against `M247-D004` dependency drift.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-D005-SPC-02", "lane-D dependency anchor (`M247-D004`)"),
    SnippetCheck(
        "M247-D005-SPC-03",
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-D005-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-D005-DOC-PKT-00", PACKET_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M247-D005-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M247-D005-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M247-D005-META-00", METADATA_SPEC_SNIPPETS),
    ):
