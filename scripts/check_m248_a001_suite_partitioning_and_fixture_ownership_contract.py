#!/usr/bin/env python3
"""Fail-closed contract checker for the M248-A001 suite partitioning/fixture ownership freeze."""
...
MODE = "m248-a001-suite-partitioning-fixture-ownership-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-A001-DOC-PKT-01",
        "# M248-A001 Suite Partitioning and Fixture Ownership Contract Freeze Packet",
    ),
    SnippetCheck("M248-A001-DOC-PKT-02", "Packet: `M248-A001`"),
    SnippetCheck("M248-A001-DOC-PKT-03", "Dependencies: none"),
    SnippetCheck(
        "M248-A001-DOC-PKT-04",
        "`check:objc3c:m248-a001-suite-partitioning-fixture-ownership-contract`",
    ),
    SnippetCheck(
        "M248-A001-DOC-PKT-05",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-A001-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M248-A001-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-A001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-A001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M248-A001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-A001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-A001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-A001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
