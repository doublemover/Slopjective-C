...
INTEGRATION_SUMMARY = ROOT / "tmp/reports/developer-tooling/integration-summary.json"
OUT_DIR = ROOT / "tmp/reports/developer-tooling/boundary-inventory"
...
def main() -> int:
    ...
    payload = {
        "contract_id": "objc3c.developer.tooling.boundary.inventory.summary.v1",
