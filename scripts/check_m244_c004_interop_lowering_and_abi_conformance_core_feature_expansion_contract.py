#!/usr/bin/env python3
"""Fail-closed checker for M244-C004 interop lowering/ABI core-feature expansion contract."""
...
MODE = "m244-c004-interop-lowering-and-abi-conformance-core-feature-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_core_feature_expansion_c004_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c004_interop_lowering_and_abi_conformance_core_feature_expansion_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C004/"
    "interop_lowering_and_abi_conformance_core_feature_expansion_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-C004-C003-01",
        "M244-C003",
        Path("docs/contracts/m244_interop_lowering_and_abi_conformance_core_feature_implementation_c003_expectations.md"),
    ),
    AssetCheck(
        "M244-C004-C003-02",
        "M244-C003",
        Path("spec/planning/compiler/m244/m244_c003_interop_lowering_and_abi_conformance_core_feature_implementation_packet.md"),
    ),
    AssetCheck(
        "M244-C004-C003-03",
        "M244-C003",
        Path("scripts/check_m244_c003_interop_lowering_and_abi_conformance_core_feature_implementation_contract.py"),
    ),
    AssetCheck(
        "M244-C004-C003-04",
        "M244-C003",
        Path("tests/tooling/test_check_m244_c003_interop_lowering_and_abi_conformance_core_feature_implementation_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C004-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-core-feature-expansion/m244-c004-v1`",
    ),
    SnippetCheck("M244-C004-DOC-EXP-02", "Dependencies: `M244-C003`"),
    SnippetCheck("M244-C004-DOC-EXP-03", "Issue `#6553` defines canonical lane-C core-feature expansion scope."),
    SnippetCheck("M244-C004-DOC-EXP-04", "`check:objc3c:m244-c004-lane-c-readiness`"),
    SnippetCheck("M244-C004-DOC-EXP-05", "`check:objc3c:m244-c003-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C004-DOC-PKT-01", "Packet: `M244-C004`"),
    SnippetCheck("M244-C004-DOC-PKT-02", "Issue: `#6553`"),
    SnippetCheck("M244-C004-DOC-PKT-03", "Dependencies: `M244-C003`"),
    SnippetCheck(
        "M244-C004-DOC-PKT-04",
        "`scripts/check_m244_c004_interop_lowering_and_abi_conformance_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M244-C004-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C004-CFG-03", "check:objc3c:m244-c004-lane-c-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c003-lane-c-readiness && npm run check:objc3c:m244-c004-interop-lowering-abi-conformance-core-feature-expansion-contract && npm run test:tooling:m244-c004-interop-lowering-abi-conformance-core-feature-expansion-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C004-ARCH-02", "`M244-C003` dependency continuity and core-feature expansion evidence remain fail-closed."),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C004-SPC-02", "lane-C dependency anchor (`M244-C003`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C004-META-02",
        "explicit `M244-C003` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C004-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C004-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C004-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C004-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C004-META-00",
