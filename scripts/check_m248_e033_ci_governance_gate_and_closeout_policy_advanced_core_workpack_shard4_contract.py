#!/usr/bin/env python3
"""Fail-closed checker for M248-E033 lane-E CI governance advanced core workpack shard4."""
...
MODE = "m248-e033-lane-e-ci-governance-gate-closeout-policy-advanced-core-workpack-shard4-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_lane_e_ci_governance_gate_and_closeout_policy_advanced_core_workpack_shard4_e033_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_e033_ci_governance_gate_and_closeout_policy_advanced_core_workpack_shard4_packet.md"
)
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m248_e033_lane_e_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M248-E033-B015-01",
        "M248-B015",
        Path("docs/contracts/m248_semantic_lowering_test_architecture_advanced_core_workpack_shard1_b015_expectations.md"),
    ),
    AssetCheck(
        "M248-E033-B015-02",
        "M248-B015",
        Path("spec/planning/compiler/m248/m248_b015_semantic_lowering_test_architecture_advanced_core_workpack_shard1_packet.md"),
    ),
    AssetCheck(
        "M248-E033-B015-03",
        "M248-B015",
        Path("scripts/check_m248_b015_semantic_lowering_test_architecture_advanced_core_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M248-E033-B015-04",
        "M248-B015",
        Path("tests/tooling/test_check_m248_b015_semantic_lowering_test_architecture_advanced_core_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M248-E033-B015-05",
        "M248-B015",
        Path("scripts/run_m248_b015_lane_b_readiness.py"),
    ),
    AssetCheck(
        "M248-E033-C018-01",
        "M248-C018",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-E033-DOC-EXP-01",
        "# M248 Lane E CI Governance Gate and Closeout Policy Advanced Core Workpack (Shard 4) Expectations (E033)",
    ),
    SnippetCheck(
        "M248-E033-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-ci-governance-gate-closeout-policy-advanced-core-workpack-shard4/m248-e033-v1`",
    ),
    SnippetCheck(
        "M248-E033-DOC-EXP-03",
        "Dependencies: `M248-E032`, `M248-A012`, `M248-B015`, `M248-C018`, `M248-D024`",
    ),
    SnippetCheck("M248-E033-DOC-EXP-04", "- Issue: `#6893`"),
    SnippetCheck("M248-E033-DOC-EXP-05", "`check:objc3c:m248-e032-lane-e-readiness`"),
    SnippetCheck("M248-E033-DOC-EXP-06", "`check:objc3c:m248-a012-lane-a-readiness`"),
    SnippetCheck("M248-E033-DOC-EXP-07", "`check:objc3c:m248-b015-lane-b-readiness`"),
    SnippetCheck("M248-E033-DOC-EXP-08", "`check:objc3c:m248-c018-lane-c-readiness`"),
    SnippetCheck("M248-E033-DOC-EXP-09", "`check:objc3c:m248-d024-lane-d-readiness`"),
    SnippetCheck(
        "M248-E033-DOC-EXP-10",
        "`scripts/check_m248_e033_ci_governance_gate_and_closeout_policy_advanced_core_workpack_shard4_contract.py`",
    ),
    SnippetCheck(
        "M248-E033-DOC-EXP-11",
        "`tests/tooling/test_check_m248_e033_ci_governance_gate_and_closeout_policy_advanced_core_workpack_shard4_contract.py`",
    ),
    SnippetCheck(
        "M248-E033-DOC-EXP-12",
        "`tmp/reports/m248/M248-E033/lane_e_ci_governance_gate_closeout_policy_advanced_core_workpack_shard4_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-E033-DOC-PKT-01",
        "# M248-E033 CI Governance Gate and Closeout Policy Advanced Core Workpack (Shard 4) Packet",
    ),
    SnippetCheck("M248-E033-DOC-PKT-02", "Packet: `M248-E033`"),
    SnippetCheck("M248-E033-DOC-PKT-03", "Issue: `#6893`"),
    SnippetCheck(
        "M248-E033-DOC-PKT-04",
        "Dependencies: `M248-E032`, `M248-A012`, `M248-B015`, `M248-C018`, `M248-D024`",
    ),
    SnippetCheck(
        "M248-E033-DOC-PKT-05",
        "scripts/check_m248_e033_ci_governance_gate_and_closeout_policy_advanced_core_workpack_shard4_contract.py",
    ),
    SnippetCheck(
        "M248-E033-DOC-PKT-06",
        "tests/tooling/test_check_m248_e033_ci_governance_gate_and_closeout_policy_advanced_core_workpack_shard4_contract.py",
    ),
    SnippetCheck("M248-E033-DOC-PKT-07", "scripts/run_m248_e033_lane_e_readiness.py"),
    SnippetCheck(
        "M248-E033-DOC-PKT-08",
        "Chains through `check:objc3c:m248-e032-lane-e-readiness` before E033 checks.",
    ),
    SnippetCheck(
        "M248-E033-DOC-PKT-09",
        "including advanced core improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M248-E033-DOC-PKT-10",
        "tmp/reports/m248/M248-E033/lane_e_ci_governance_gate_closeout_policy_advanced_core_workpack_shard4_summary.json",
    ),
)
...
READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-E033-RUN-02", "check:objc3c:m248-e032-lane-e-readiness"),
    SnippetCheck("M248-E033-RUN-03", "check:objc3c:m248-a012-lane-a-readiness"),
    SnippetCheck("M248-E033-RUN-04", "check:objc3c:m248-b015-lane-b-readiness"),
    SnippetCheck("M248-E033-RUN-05", "check:objc3c:m248-c018-lane-c-readiness"),
    SnippetCheck("M248-E033-RUN-06", "check:objc3c:m248-d024-lane-d-readiness"),
    SnippetCheck(
        "M248-E033-RUN-07",
        "scripts/check_m248_e033_ci_governance_gate_and_closeout_policy_advanced_core_workpack_shard4_contract.py",
    ),
    ...
    SnippetCheck("M248-E033-RUN-09", "[ok] M248-E033 lane-E readiness chain completed"),
)

FORBIDDEN_READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-E033-RUN-FORB-01", "check:objc3c:m248-e029-lane-e-readiness"),
    SnippetCheck("M248-E033-RUN-FORB-02", "scripts/run_m248_e029_lane_e_readiness.py"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    text_contracts: tuple[tuple[Path, str, tuple[SnippetCheck, ...], tuple[SnippetCheck, ...]], ...] = (
        (args.expectations_doc, "M248-E033-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS, ()),
        (args.packet_doc, "M248-E033-DOC-PKT-EXISTS", PACKET_SNIPPETS, ()),
        (
            args.readiness_runner,
            "M248-E033-RUN-EXISTS",
