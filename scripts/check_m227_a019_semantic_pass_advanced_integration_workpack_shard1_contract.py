#!/usr/bin/env python3
"""Fail-closed validator for M227-A019 semantic pass advanced integration shard1 contract."""
...
MODE = "m227-semantic-pass-advanced-integration-workpack-shard1-contract-a019-v1"

ARTIFACTS: dict[str, Path] = {
    "a018_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m227_semantic_pass_advanced_conformance_workpack_shard1_expectations.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m227_semantic_pass_advanced_integration_workpack_shard1_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m227"
    / "m227_a019_semantic_pass_advanced_integration_workpack_shard1_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        ...
        ("M227-A019-DOC-02", "Dependencies: `M227-A018`"),
        ("M227-A019-DOC-03", "toolchain_runtime_ga_operations_advanced_integration_consistent"),
        ("M227-A019-DOC-04", "toolchain_runtime_ga_operations_advanced_integration_ready"),
        ("M227-A019-DOC-05", "toolchain_runtime_ga_operations_advanced_integration_key"),
        (
            "M227-A019-DOC-06",
        ...
        ("M227-A019-DOC-08", "npm run check:objc3c:m227-a019-lane-a-readiness"),
    ),
    "packet_doc": (
        ("M227-A019-PKT-01", "Packet: `M227-A019`"),
        ("M227-A019-PKT-02", "Dependencies: `M227-A018`"),
        ("M227-A019-PKT-03", "objc3_parse_lowering_readiness_surface.h"),
        (
            "M227-A019-PKT-04",
            "scripts/check_m227_a019_semantic_pass_advanced_integration_workpack_shard1_contract.py",
        ),
    ...
    "parse_surface": (
        ("M227-A019-SUR-01", "IsObjc3ToolchainRuntimeGaOperationsAdvancedIntegrationConsistent("),
        ("M227-A019-SUR-02", "IsObjc3ToolchainRuntimeGaOperationsAdvancedIntegrationReady("),
        ("M227-A019-SUR-03", "BuildObjc3ToolchainRuntimeGaOperationsAdvancedIntegrationKey("),
        (
            "M227-A019-SUR-04",
    ...
    "runbook": (
        ...
        ("M227-A019-RBK-04", "npm run check:objc3c:m227-a019-lane-a-readiness"),
    ),
    "package_json": (
        (
            "M227-A019-CFG-01",
            '"check:objc3c:m227-a019-semantic-pass-advanced-integration-workpack-shard1-contract"',
        ),
        (
            "M227-A019-CFG-02",
            '"test:tooling:m227-a019-semantic-pass-advanced-integration-workpack-shard1-contract"',
        ),
        ("M227-A019-CFG-03", '"check:objc3c:m227-a019-lane-a-readiness"'),
        ("M227-A019-CFG-04", "check:objc3c:m227-a018-lane-a-readiness"),
    ),
    "architecture_doc": (
        (
            "M227-A019-ARC-01",
