#!/usr/bin/env python3
"""Fail-closed checker for M243-E015 lane-E diagnostics gate/replay-policy cross-lane integration sync."""
...
MODE = "m243-e015-lane-e-diagnostics-quality-gate-replay-policy-advanced-core-workpack-shard-1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m243_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_core_workpack_shard_1_e015_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m243"
    / "m243_e015_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_core_workpack_shard_1_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M243-E015-DOC-EXP-01",
        "Contract ID: `objc3c-lane-e-diagnostics-quality-gate-replay-policy-advanced-core-workpack-shard-1/m243-e015-v1`",
    ),
    SnippetCheck(
        "M243-E015-DOC-EXP-02",
        "Dependencies: `M243-E014`, `M243-A012`, `M243-B012`, `M243-C011`, `M243-D012`",
    ),
    SnippetCheck("M243-E015-DOC-EXP-03", "Issue `#6501` defines the canonical lane-E dependency chain for E012."),
    SnippetCheck("M243-E015-DOC-EXP-04", "E011 contract anchors remain mandatory prerequisites:"),
    SnippetCheck("M243-E015-DOC-EXP-05", "`check:objc3c:m243-e012-lane-e-readiness`"),
    SnippetCheck("M243-E015-DOC-EXP-06", "`check:objc3c:m243-e011-lane-e-readiness`"),
    SnippetCheck("M243-E015-DOC-EXP-07", "`check:objc3c:m243-a012-lane-a-readiness`"),
    SnippetCheck("M243-E015-DOC-EXP-08", "`check:objc3c:m243-b012-lane-b-readiness`"),
    SnippetCheck("M243-E015-DOC-EXP-09", "`check:objc3c:m243-c011-lane-c-readiness`"),
    SnippetCheck("M243-E015-DOC-EXP-10", "`check:objc3c:m243-d012-lane-d-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M243-E015-DOC-PKT-01", "Packet: `M243-E015`"),
    SnippetCheck("M243-E015-DOC-PKT-02", "Issue: `#6501`"),
    SnippetCheck(
        "M243-E015-DOC-PKT-03",
        "Dependencies: `M243-E014`, `M243-A012`, `M243-B012`, `M243-C011`, `M243-D012`",
    ),
    SnippetCheck(
        "M243-E015-DOC-PKT-04",
        "`scripts/check_m243_e015_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_core_workpack_shard_1_contract.py`",
    ),
    SnippetCheck(
        "M243-E015-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M243-E015-CFG-03", "check:objc3c:m243-e012-lane-e-readiness"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M243-E015-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M243-E015-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M243-E015-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M243-E015-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M243-E015-META-00",
