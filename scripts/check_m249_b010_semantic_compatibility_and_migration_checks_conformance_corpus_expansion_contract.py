#!/usr/bin/env python3
"""Fail-closed contract checker for the M249-B010 semantic compatibility conformance corpus expansion packet."""
...
MODE = "m249-b010-semantic-compatibility-migration-checks-conformance-corpus-expansion-contract-v1"
...
DEFAULT_B009_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m249_b009_semantic_compatibility_and_migration_checks_conformance_matrix_implementation_contract.py"
)
DEFAULT_B009_READINESS_RUNNER = ROOT / "scripts" / "run_m249_b009_lane_b_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m249_b010_lane_b_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-B010-DOC-PKT-01",
        "# M249-B010 Semantic Compatibility and Migration Checks Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M249-B010-DOC-PKT-02", "Packet: `M249-B010`"),
    SnippetCheck("M249-B010-DOC-PKT-03", "Issue: `#6914`"),
    SnippetCheck("M249-B010-DOC-PKT-04", "Dependencies: `M249-B009`"),
    SnippetCheck(
        "M249-B010-DOC-PKT-05",
        "`scripts/check_m249_b010_semantic_compatibility_and_migration_checks_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M249-B010-DOC-PKT-06",
        "`scripts/run_m249_b010_lane_b_readiness.py`",
    ),
    SnippetCheck(
        "M249-B010-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M249-B010-DOC-PKT-08",
        "conformance corpus expansion governance",
    ),
    SnippetCheck(
        "M249-B010-DOC-PKT-09",
...
B009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-B010-B009-DOC-01",
        "Contract ID: `objc3c-semantic-compatibility-and-migration-checks-conformance-matrix-implementation/m249-b009-v1`",
    ),
    SnippetCheck("M249-B010-B009-DOC-02", "Dependencies: `M249-B008`"),
    SnippetCheck(
        "M249-B010-B009-DOC-03",
        "scripts/check_m249_b009_semantic_compatibility_and_migration_checks_conformance_matrix_implementation_contract.py",
    ),
)

B009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-B010-B009-PKT-01", "Packet: `M249-B009`"),
    SnippetCheck("M249-B010-B009-PKT-02", "Dependencies: `M249-B008`"),
    SnippetCheck(
        "M249-B010-B009-PKT-03",
        "scripts/check_m249_b009_semantic_compatibility_and_migration_checks_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M249-B010-B009-PKT-04",
        "tmp/reports/m249/M249-B009/semantic_compatibility_and_migration_checks_conformance_matrix_implementation_summary.json",
    ),
)

B009_READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-B010-B009-RUN-01", '"""Run M249-B009 lane-B readiness checks without deep npm nesting."""'),
    SnippetCheck("M249-B010-B009-RUN-02", "scripts/run_m249_b008_lane_b_readiness.py"),
    SnippetCheck(
        "M249-B010-B009-RUN-03",
        "scripts/check_m249_b009_semantic_compatibility_and_migration_checks_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M249-B010-B009-RUN-04",
...
READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-B010-RUN-01", '"""Run M249-B010 lane-B readiness checks without deep npm nesting."""'),
    SnippetCheck(
        "M249-B010-RUN-02",
    ...
    SnippetCheck("M249-B010-RUN-05", "[ok] M249-B010 lane-B readiness chain completed"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--b009-readiness-runner", type=Path, default=DEFAULT_B009_READINESS_RUNNER)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-B010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-B010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b009_expectations_doc, "M249-B010-B009-DOC-EXISTS", B009_EXPECTATIONS_SNIPPETS),
        (args.b009_packet_doc, "M249-B010-B009-PKT-EXISTS", B009_PACKET_SNIPPETS),
        (args.b009_readiness_runner, "M249-B010-B009-RUN-EXISTS", B009_READINESS_RUNNER_SNIPPETS),
        (args.readiness_runner, "M249-B010-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-B010-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-B010-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-B010-META-EXISTS", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b009_checker, "M249-B010-DEP-B009-ARG-01"),
        (args.b009_test, "M249-B010-DEP-B009-ARG-02"),
        (args.b009_readiness_runner, "M249-B010-DEP-B009-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
