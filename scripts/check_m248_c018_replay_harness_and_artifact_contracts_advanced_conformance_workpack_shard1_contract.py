#!/usr/bin/env python3
"""Fail-closed checker for M248-C018 replay harness/artifact advanced conformance workpack (shard 1)."""
...
MODE = "m248-c018-replay-harness-and-artifact-contracts-advanced-conformance-workpack-shard1-contract-v1"
...
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m248_c018_lane_c_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-C018-DOC-EXP-05",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M248-C018-DOC-EXP-06",
        "`check:objc3c:m248-c018-replay-harness-artifact-contracts-advanced-conformance-workpack-shard1-contract`",
    ),
    SnippetCheck(
        "M248-C018-DOC-EXP-07",
        "`test:tooling:m248-c018-replay-harness-artifact-contracts-advanced-conformance-workpack-shard1-contract`",
    ),
    SnippetCheck("M248-C018-DOC-EXP-08", "`check:objc3c:m248-c018-lane-c-readiness`"),
    SnippetCheck("M248-C018-DOC-EXP-09", "python scripts/run_m248_c017_lane_c_readiness.py"),
    SnippetCheck(
        "M248-C018-DOC-EXP-10",
    ...
    SnippetCheck(
        "M248-C018-DOC-EXP-11",
        "tmp/reports/m248/M248-C018/replay_harness_and_artifact_contracts_advanced_conformance_workpack_shard1_contract_summary.json",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C018-DOC-PKT-01", "Packet: `M248-C018`"),
    SnippetCheck("M248-C018-DOC-PKT-02", "Issue: `#6834`"),
    SnippetCheck("M248-C018-DOC-PKT-03", "Dependencies: `M248-C017`"),
    SnippetCheck(
        "M248-C018-DOC-PKT-04",
        "`scripts/check_m248_c018_replay_harness_and_artifact_contracts_advanced_conformance_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M248-C018-DOC-PKT-05",
    ...
    SnippetCheck("M248-C018-DOC-PKT-06", "`scripts/run_m248_c018_lane_c_readiness.py`"),
    SnippetCheck("M248-C018-DOC-PKT-07", "`python scripts/run_m248_c017_lane_c_readiness.py`"),
    SnippetCheck(
        "M248-C018-DOC-PKT-08",
        "`check:objc3c:m248-c018-replay-harness-artifact-contracts-advanced-conformance-workpack-shard1-contract`",
    ),
    SnippetCheck(
        "M248-C018-DOC-PKT-09",
        "`test:tooling:m248-c018-replay-harness-artifact-contracts-advanced-conformance-workpack-shard1-contract`",
    ),
    SnippetCheck("M248-C018-DOC-PKT-10", "`check:objc3c:m248-c018-lane-c-readiness`"),
    SnippetCheck(
        "M248-C018-DOC-PKT-11",
        "`tmp/reports/m248/M248-C018/replay_harness_and_artifact_contracts_advanced_conformance_workpack_shard1_contract_summary.json`",
    ),
)
...
PACKAGE_JSON_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-C018-PKG-03", '"check:objc3c:m248-c018-lane-c-readiness"'),
    SnippetCheck("M248-C018-PKG-04", "python scripts/run_m248_c018_lane_c_readiness.py"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C018-RUN-01", "scripts/run_m248_c017_lane_c_readiness.py"),
    SnippetCheck(
        "M248-C018-RUN-02",
        "scripts/check_m248_c018_replay_harness_and_artifact_contracts_advanced_conformance_workpack_shard1_contract.py",
    ),
    ...
    SnippetCheck("M248-C018-RUN-04", "[ok] M248-C018 lane-C readiness chain completed"),
)

READINESS_RUNNER_FORBIDDEN_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C018-RUN-FORB-01", "npm run "),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    checks, findings = check_text_contract(
        ...
        exists_check_id="M248-C018-DOC-EXP-EXISTS",
    ...
    checks, findings = check_text_contract(
        ...
        exists_check_id="M248-C018-DOC-PKT-EXISTS",
    ...
    checks, findings = check_text_contract(
        ...
        exists_check_id="M248-C018-PKG-EXISTS",
    ...
    checks, findings = check_text_contract(
        ...
        exists_check_id="M248-C018-RUN-EXISTS",
