#!/usr/bin/env python3
"""Fail-closed checker for M235-E005 qualifier/generic conformance gate edge-case and compatibility completion."""
...
MODE = "m235-e005-qualifier-generic-conformance-gate-edge-case-and-compatibility-completion-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_generic_conformance_gate_edge_case_and_compatibility_completion_e005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_e005_qualifier_generic_conformance_gate_edge_case_and_compatibility_completion_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m235/M235-E005/local_check_summary.json")
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-E005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-E005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
