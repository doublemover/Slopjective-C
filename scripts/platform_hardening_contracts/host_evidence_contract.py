...
HOST_EVIDENCE_REVIEWED_SOURCE_PROPOSAL_SUFFIX = (
    "reviewed-source-inputs.proposed.json"
)
HOST_EVIDENCE_REVIEW_STAGING_SUMMARY_SUFFIX = (
...
HOST_EVIDENCE_REVIEWED_SOURCE_PROPOSAL_PATH_TEMPLATE = (
    f"{HOST_EVIDENCE_REPORT_ROOT}/<platform>/"
    f"{HOST_EVIDENCE_REVIEWED_SOURCE_PROPOSAL_SUFFIX}"
)
HOST_EVIDENCE_REVIEW_STAGING_SUMMARY_PATH_TEMPLATE = (
    f"{HOST_EVIDENCE_REPORT_ROOT}/<platform>/"
    f"{HOST_EVIDENCE_REVIEW_STAGING_SUMMARY_SUFFIX}"
)
...
HOST_EVIDENCE_REVIEW_OUTPUT_SUFFIXES: frozenset[str] = frozenset(
    {
        "ingestion-summary.json",
        HOST_EVIDENCE_REVIEWED_SOURCE_PROPOSAL_SUFFIX,
        HOST_EVIDENCE_REVIEW_STAGING_SUMMARY_SUFFIX,
...
HOST_EVIDENCE_REQUIRED_REVIEW_INPUT_SUFFIXES: tuple[str, ...] = tuple(
    ...
    if suffix not in HOST_EVIDENCE_REVIEW_OUTPUT_SUFFIXES
)
...
__all__ = [
    ...
    "HOST_EVIDENCE_REVIEW_STAGING_SUMMARY_SUFFIX",
    "HOST_EVIDENCE_REVIEW_STAGING_SUMMARY_PATH_TEMPLATE",
    "HOST_EVIDENCE_REVIEW_OUTPUT_SUFFIXES",
