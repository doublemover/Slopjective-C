#!/usr/bin/env python3
"""Fail-closed checker for M230-C012 Documentation generation as source-of-truth contract freeze."""
...
MODE = "m230-c012-documentation-generation-as-source-of-truth-cross-lane-integration-sync-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_c012_documentation_generation_as_source_of_truth_cross_lane_integration_sync_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-C012-DOC-PKT-01",
        "# M230-C012 Documentation generation as source-of-truth Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-C012-DOC-PKT-02", "Packet: `M230-C012`"),
    SnippetCheck("M230-C012-DOC-PKT-03", "Issue: `#5433`"),
    SnippetCheck("M230-C012-DOC-PKT-04", "Dependencies: `M230-C011`"),
    SnippetCheck(
        "M230-C012-DOC-PKT-05",
        "check:objc3c:m230-c012-documentation-generation-as-source-of-truth-cross-lane-integration-sync-contract",
    ),
    SnippetCheck(
        "M230-C012-DOC-PKT-06",
        "tmp/reports/m230/M230-C012/documentation_generation_as_source_of_truth_cross_lane_integration_sync_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-C012-PKG-03",
        '"check:objc3c:m230-c012-lane-c-readiness": '
        '"npm run check:objc3c:m230-c011-lane-c-readiness && npm run check:objc3c:m230-c012-documentation-generation-as-source-of-truth-cross-lane-integration-sync-contract '
        '&& npm run test:tooling:m230-c012-documentation-generation-as-source-of-truth-cross-lane-integration-sync-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-C012-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-C012-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-C012-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-C012-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-C012-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-C012-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
