#!/usr/bin/env python3
"""Fail-closed checker for M231-C012 Declaration lowering contract updates contract freeze."""
...
MODE = "m231-c012-declaration-lowering-contract-updates-cross-lane-integration-sync-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_c012_declaration_lowering_contract_updates_cross_lane_integration_sync_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M231-C012-DOC-EXP-01",
        "# M231 Declaration Grammar Expansion and Normalization Contract and Architecture Freeze Expectations (A001)",
    ),
    SnippetCheck(
        "M231-C012-DOC-EXP-02",
        "Contract ID: `objc3c-declaration-lowering-contract-updates/m231-c012-v1`",
    ),
    SnippetCheck("M231-C012-DOC-EXP-03", "Issue: `#5515`"),
    SnippetCheck("M231-C012-DOC-EXP-04", "Dependencies: `M231-C011`"),
    SnippetCheck(
        "M231-C012-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M231-C012-DOC-EXP-06",
        "`check:objc3c:m231-c012-lane-c-readiness`",
    ),
    SnippetCheck(
        "M231-C012-DOC-EXP-07",
        "`tmp/reports/m231/M231-C012/declaration_lowering_contract_updates_cross_lane_integration_sync_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M231-C012-DOC-PKT-01",
        "# M231-C012 Declaration Grammar Expansion and Normalization Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M231-C012-DOC-PKT-02", "Packet: `M231-C012`"),
    SnippetCheck("M231-C012-DOC-PKT-03", "Issue: `#5515`"),
    SnippetCheck("M231-C012-DOC-PKT-04", "Dependencies: `M231-C011`"),
    SnippetCheck(
        "M231-C012-DOC-PKT-05",
        "check:objc3c:m231-c012-declaration-lowering-contract-updates-cross-lane-integration-sync-contract",
    ),
    SnippetCheck(
        "M231-C012-DOC-PKT-06",
        "tmp/reports/m231/M231-C012/declaration_lowering_contract_updates_cross_lane_integration_sync_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M231-C012-PKG-03",
        '"check:objc3c:m231-c012-lane-c-readiness": '
        '"npm run check:objc3c:m231-c011-lane-c-readiness && npm run check:objc3c:m231-c012-declaration-lowering-contract-updates-cross-lane-integration-sync-contract '
        '&& npm run test:tooling:m231-c012-declaration-lowering-contract-updates-cross-lane-integration-sync-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-C012-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-C012-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-C012-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-C012-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-C012-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-C012-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
