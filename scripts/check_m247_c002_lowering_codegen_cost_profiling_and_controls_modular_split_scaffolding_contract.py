#!/usr/bin/env python3
"""Fail-closed checker for M247-C002 lowering/codegen modular split and scaffolding."""
...
MODE = "m247-c002-lowering-codegen-cost-profiling-controls-modular-split-scaffolding-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c002_lane_c_readiness.py"
...
DEFAULT_C001_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m247_c001_lowering_codegen_cost_profiling_and_controls_contract_and_architecture_freeze_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C002-DOC-EXP-01",
        "Contract ID: `objc3c-lane-c-lowering-codegen-cost-profiling-controls-modular-split-scaffolding-contract/m247-c002-v1`",
    ),
    SnippetCheck("M247-C002-DOC-EXP-02", "Dependencies: `M247-C001`"),
    SnippetCheck(
        "M247-C002-DOC-EXP-03",
        "Issue `#6743` defines canonical lane-C modular split/scaffolding scope.",
    ),
    SnippetCheck(
        "M247-C002-DOC-EXP-04",
        "scripts/check_m247_c001_lowering_codegen_cost_profiling_and_controls_contract_and_architecture_freeze_contract.py",
    ),
    SnippetCheck(
        "M247-C002-DOC-EXP-05",
        "scripts/run_m247_c002_lane_c_readiness.py",
    ),
    SnippetCheck("M247-C002-DOC-EXP-06", "`check:objc3c:m247-c002-lane-c-readiness`"),
    SnippetCheck("M247-C002-DOC-EXP-07", "`check:objc3c:m247-c001-lane-c-readiness`"),
    SnippetCheck("M247-C002-DOC-EXP-08", "`C001 readiness -> C002 checker -> C002 pytest`."),
    SnippetCheck(
        "M247-C002-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C002-DOC-EXP-10",
        "tmp/reports/m247/M247-C002/lowering_codegen_cost_profiling_and_controls_modular_split_scaffolding_contract_summary.json",
    ),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C002-C001-DOC-01",
        "Contract ID: `objc3c-lane-c-lowering-codegen-cost-profiling-controls-contract/m247-c001-v1`",
    ),
    SnippetCheck("M247-C002-C001-DOC-02", "Dependencies: none"),
    SnippetCheck(
        "M247-C002-C001-DOC-03",
        "Issue `#6742` defines canonical lane-C contract and architecture freeze scope.",
    ),
)

C001_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C002-C001-PKT-01", "Packet: `M247-C001`"),
    SnippetCheck("M247-C002-C001-PKT-02", "Issue: `#6742`"),
    SnippetCheck("M247-C002-C001-PKT-03", "Dependencies: none"),
    SnippetCheck("M247-C002-C001-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C002-RUN-01", 'DEPENDENCY_TOKEN = "M247-C001"'),
    SnippetCheck("M247-C002-RUN-02", "check:objc3c:m247-c001-lane-c-readiness"),
    SnippetCheck(
        "M247-C002-RUN-03",
        "scripts/check_m247_c002_lowering_codegen_cost_profiling_and_controls_modular_split_scaffolding_contract.py",
    ),
    ...
    SnippetCheck("M247-C002-RUN-05", "[ok] M247-C002 lane-C readiness chain completed"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C002-SPC-01",
        "lowering/codegen modular split/scaffolding wiring shall preserve explicit lane-C dependency anchor (`M247-C001`)",
    ),
    SnippetCheck(
        "M247-C002-SPC-02",
        "modular split/scaffolding evidence commands drift",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-C002-META-02",
        "explicit `M247-C001` dependency continuity and fail-closed modular split evidence continuity",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M247-C002-CFG-03", "check:objc3c:m247-c002-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C002-CFG-04", "check:objc3c:m247-c001-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C002-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M247-C002-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M247-C002-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-C002-CFG-11", "test:objc3c:perf-budget"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-C002-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-C002-DOC-PKT-00", PACKET_SNIPPETS),
        ("c001_expectations_doc", args.c001_expectations_doc, "M247-C002-C001-DOC-00", C001_EXPECTATIONS_SNIPPETS),
        ("c001_packet_doc", args.c001_packet_doc, "M247-C002-C001-PKT-00", C001_PACKET_SNIPPETS),
        ("readiness_script", args.readiness_script, "M247-C002-RUN-00", READINESS_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M247-C002-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M247-C002-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M247-C002-META-00", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c001_checker, "M247-C002-DEP-01"),
        (args.c001_test, "M247-C002-DEP-02"),
    ):
