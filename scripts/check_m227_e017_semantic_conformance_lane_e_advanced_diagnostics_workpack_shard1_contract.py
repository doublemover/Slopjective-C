#!/usr/bin/env python3
"""Fail-closed validator for M227-E017 semantic conformance lane-E advanced diagnostics workpack (shard 1)."""
...
MODE = "m227-e017-semantic-conformance-lane-e-advanced-diagnostics-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_lane_e_semantic_conformance_advanced_diagnostics_workpack_shard1_e017_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_e017_semantic_conformance_lane_e_advanced_diagnostics_workpack_shard1_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-E017-E005-01",
        "M227-E016",
        Path("docs/contracts/m227_lane_e_semantic_conformance_advanced_edge_compatibility_workpack_shard1_e016_expectations.md"),
    ),
    AssetCheck(
        "M227-E017-E005-02",
        "M227-E016",
        Path("scripts/check_m227_e016_semantic_conformance_lane_e_advanced_edge_compatibility_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E017-E005-03",
        "M227-E016",
        Path("tests/tooling/test_check_m227_e016_semantic_conformance_lane_e_advanced_edge_compatibility_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E017-E005-04",
        "M227-E016",
        Path("spec/planning/compiler/m227/m227_e016_semantic_conformance_lane_e_advanced_edge_compatibility_workpack_shard1_packet.md"),
    ),
    AssetCheck(
        "M227-E017-A006-01",
        "M227-A018",
        Path("docs/contracts/m227_semantic_pass_advanced_conformance_workpack_shard1_expectations.md"),
    ),
    AssetCheck(
        "M227-E017-A006-02",
        "M227-A018",
        Path("scripts/check_m227_a018_semantic_pass_advanced_conformance_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E017-A006-03",
        "M227-A018",
        Path("tests/tooling/test_check_m227_a018_semantic_pass_advanced_conformance_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E017-A006-04",
        "M227-A018",
        Path("spec/planning/compiler/m227/m227_a018_semantic_pass_advanced_conformance_workpack_shard1_packet.md"),
    ),
    AssetCheck(
        "M227-E017-B006-01",
        "M227-B033",
        Path("docs/contracts/m227_type_system_objc3_forms_advanced_core_workpack_shard4_b033_expectations.md"),
    ),
    AssetCheck(
        "M227-E017-B006-02",
        "M227-B033",
        Path("scripts/check_m227_b033_type_system_objc3_forms_advanced_core_workpack_shard4_contract.py"),
    ),
    AssetCheck(
        "M227-E017-B006-03",
        "M227-B033",
        Path("tests/tooling/test_check_m227_b033_type_system_objc3_forms_advanced_core_workpack_shard4_contract.py"),
    ),
    AssetCheck(
        "M227-E017-B006-04",
        "M227-B033",
        Path("spec/planning/compiler/m227/m227_b033_type_system_objc3_forms_advanced_core_workpack_shard4_packet.md"),
    ),
    AssetCheck(
        "M227-E017-C006-01",
        "M227-C022",
        Path("docs/contracts/m227_typed_sema_to_lowering_advanced_edge_compatibility_shard2_c022_expectations.md"),
    ),
    AssetCheck(
        "M227-E017-C006-02",
        "M227-C022",
        Path("scripts/check_m227_c022_typed_sema_to_lowering_advanced_edge_compatibility_shard2_contract.py"),
    ),
    AssetCheck(
        "M227-E017-C006-03",
        "M227-C022",
        Path("tests/tooling/test_check_m227_c022_typed_sema_to_lowering_advanced_edge_compatibility_shard2_contract.py"),
    ),
    AssetCheck(
        "M227-E017-C006-04",
        "M227-C022",
        Path("spec/planning/compiler/m227/m227_c022_typed_sema_to_lowering_advanced_edge_compatibility_shard2_packet.md"),
    ),
    AssetCheck(
        "M227-E017-D006-01",
        "M227-D010",
        Path("docs/contracts/m227_runtime_facing_type_metadata_conformance_corpus_expansion_d010_expectations.md"),
    ),
    AssetCheck(
        "M227-E017-D006-02",
        "M227-D010",
        Path("scripts/check_m227_d010_runtime_facing_type_metadata_conformance_corpus_expansion_contract.py"),
    ),
    AssetCheck(
        "M227-E017-D006-03",
        "M227-D010",
        Path("tests/tooling/test_check_m227_d010_runtime_facing_type_metadata_conformance_corpus_expansion_contract.py"),
    ),
    AssetCheck(
        "M227-E017-D006-04",
        "M227-D010",
        Path("spec/planning/compiler/m227/m227_d010_runtime_facing_type_metadata_conformance_corpus_expansion_packet.md"),
    ),
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E017-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-E017-EXP-08",
        "checker `scripts/check_m227_e016_semantic_conformance_lane_e_advanced_edge_compatibility_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M227-E017-EXP-09",
        "checker `scripts/check_m227_a018_semantic_pass_advanced_conformance_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M227-E017-EXP-10",
        "checker `scripts/check_m227_b033_type_system_objc3_forms_advanced_core_workpack_shard4_contract.py`",
    ),
    SnippetCheck(
        "M227-E017-EXP-11",
        "checker `scripts/check_m227_c022_typed_sema_to_lowering_advanced_edge_compatibility_shard2_contract.py`",
    ),
    SnippetCheck(
        "M227-E017-EXP-12",
        "checker `scripts/check_m227_d010_runtime_facing_type_metadata_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M227-E017-EXP-13",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E017-PKT-04", "Packet: `M227-E017`"),
    SnippetCheck("M227-E017-PKT-05", "Issue: `#5175`"),
    SnippetCheck("M227-E017-PKT-06", "Scaffold date: `2026-03-05`"),
    SnippetCheck(
        "M227-E017-PKT-07",
        "Dependencies: `M227-E016`, `M227-A018`, `M227-B033`, `M227-C022`, `M227-D010`",
    ),
    SnippetCheck("M227-E017-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-E017-PKT-09",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-E017-ARCH-01",
        "M227 lane-E E017 semantic conformance advanced diagnostics workpack (shard 1) anchors dependency references",
    ),
    SnippetCheck(
        "M227-E017-ARCH-02",
        "(`M227-E016`, `M227-A018`, `M227-B033`, `M227-C022`, and `M227-D010`)",
    ),
    SnippetCheck(
        "M227-E017-ARCH-03",
        "check:objc3c:m227-e017-lane-e-readiness",
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E017-SPC-03",
        "lane-E advanced diagnostics workpack (shard 1) evidence drift.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E017-META-03",
        "semantic conformance lane-E advanced diagnostics workpack (shard 1) metadata governance drift fails closed.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-E017-CFG-03", "check:objc3c:m227-e017-lane-e-readiness"),
    PackageScriptKeyCheck("M227-E017-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M227-E017-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M227-E017-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-E017-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        "M227-E017-CFG-06",
        "check:objc3c:m227-e017-lane-e-readiness",
        "python scripts/check_m227_e016_semantic_conformance_lane_e_advanced_edge_compatibility_workpack_shard1_contract.py && python -m pytest tests/tooling/test_check_m227_e016_semantic_conformance_lane_e_advanced_edge_compatibility_workpack_shard1_contract.py -q && python scripts/check_m227_a018_semantic_pass_advanced_conformance_workpack_shard1_contract.py && python -m pytest tests/tooling/test_check_m227_a018_semantic_pass_advanced_conformance_workpack_shard1_contract.py -q && npm run check:objc3c:m227-b033-lane-b-readiness && npm run check:objc3c:m227-c022-lane-c-readiness && python scripts/check_m227_d010_runtime_facing_type_metadata_conformance_corpus_expansion_contract.py && python -m pytest tests/tooling/test_check_m227_d010_runtime_facing_type_metadata_conformance_corpus_expansion_contract.py -q && npm run check:objc3c:m227-e017-semantic-conformance-lane-e-advanced-diagnostics-workpack-shard1-contract && npm run test:tooling:m227-e017-semantic-conformance-lane-e-advanced-diagnostics-workpack-shard1-contract",
    ),
)
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-E016": "scripts/check_m227_e016_semantic_conformance_lane_e_advanced_edge_compatibility_workpack_shard1_contract.py",
    "M227-A018": "scripts/check_m227_a018_semantic_pass_advanced_conformance_workpack_shard1_contract.py",
    "M227-B033": "scripts/check_m227_b033_type_system_objc3_forms_advanced_core_workpack_shard4_contract.py",
    "M227-C022": "scripts/check_m227_c022_typed_sema_to_lowering_advanced_edge_compatibility_shard2_contract.py",
    "M227-D010": "scripts/check_m227_d010_runtime_facing_type_metadata_conformance_corpus_expansion_contract.py",
}
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_text = check_document(
        ...
        exists_check_id="M227-E017-EXP-01",
        utf8_check_id="M227-E017-EXP-02",
        snippets=EXPECTATIONS_SNIPPETS,
    )
    packet_text = check_document(
        path=args.packet_doc,
        artifact="packet_doc",
        exists_check_id="M227-E017-PKT-01",
        utf8_check_id="M227-E017-PKT-02",
        snippets=PACKET_SNIPPETS,
    )
    check_document(
        path=args.architecture_doc,
        artifact="architecture_doc",
        exists_check_id="M227-E017-ARCH-00",
        utf8_check_id="M227-E017-ARCH-UTF8",
        snippets=ARCHITECTURE_SNIPPETS,
    )
    check_document(
        path=args.lowering_spec,
        artifact="lowering_spec",
        exists_check_id="M227-E017-SPC-00",
        utf8_check_id="M227-E017-SPC-UTF8",
        snippets=LOWERING_SPEC_SNIPPETS,
    )
    check_document(
        path=args.metadata_spec,
        artifact="metadata_spec",
        exists_check_id="M227-E017-META-00",
        utf8_check_id="M227-E017-META-UTF8",
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-E017-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if isinstance(package_payload, dict):
        ...
        check(
            artifact="package_json",
            check_id="M227-E017-CFG-SCRIPTS",
    ...
    if findings:
        if not args.emit_json:
            print(
                "m227-e017-semantic-conformance-lane-e-advanced-diagnostics-workpack-shard1: "
    ...
    if not args.emit_json:
        print("m227-e017-semantic-conformance-lane-e-advanced-diagnostics-workpack-shard1: OK")
        print(f"- mode={MODE}")
