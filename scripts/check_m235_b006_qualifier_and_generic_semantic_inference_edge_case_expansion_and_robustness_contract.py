#!/usr/bin/env python3
"""Fail-closed checker for M235-B006 qualifier/generic semantic inference edge-case expansion and robustness."""
...
MODE = "m235-b006-qualifier-and-generic-semantic-inference-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_B005_CHECKER = (
    ROOT / "scripts" / "check_m235_b005_qualifier_and_generic_semantic_inference_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_B005_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_b005_qualifier_and_generic_semantic_inference_edge_case_and_compatibility_completion_contract.py"
)
...
B005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B006-B005-PKT-01", "Packet: `M235-B005`"),
    SnippetCheck("M235-B006-B005-PKT-02", "Dependencies: `M235-B004`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B006-META-02",
        "explicit `M235-B005` dependency continuity so edge-case expansion and robustness drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-B006-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B006-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b005_expectations_doc, "M235-B006-B005-DOC-EXISTS", B005_EXPECTATIONS_SNIPPETS),
        (args.b005_packet_doc, "M235-B006-B005-PKT-EXISTS", B005_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b005_checker, "M235-B006-DEP-B005-ARG-01"),
        (args.b005_test, "M235-B006-DEP-B005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
