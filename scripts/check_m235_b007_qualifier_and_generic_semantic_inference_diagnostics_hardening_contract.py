#!/usr/bin/env python3
"""Fail-closed checker for M235-B007 qualifier/generic semantic inference diagnostics hardening."""
...
MODE = "m235-b007-qualifier-and-generic-semantic-inference-diagnostics-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_diagnostics_hardening_b007_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_b007_qualifier_and_generic_semantic_inference_diagnostics_hardening_packet.md"
)
DEFAULT_B006_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_edge_case_expansion_and_robustness_b006_expectations.md"
)
DEFAULT_B006_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_b006_qualifier_and_generic_semantic_inference_edge_case_expansion_and_robustness_packet.md"
)
DEFAULT_B006_CHECKER = (
    ROOT / "scripts" / "check_m235_b006_qualifier_and_generic_semantic_inference_edge_case_expansion_and_robustness_contract.py"
)
DEFAULT_B006_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_b006_qualifier_and_generic_semantic_inference_edge_case_expansion_and_robustness_contract.py"
)
...
B006_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B007-B006-PKT-01", "Packet: `M235-B006`"),
    SnippetCheck("M235-B007-B006-PKT-02", "Dependencies: `M235-B005`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B007-META-02",
        "explicit `M235-B006` dependency continuity so diagnostics hardening drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-B007-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B007-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B007-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B007-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b006_expectations_doc, "M235-B007-B006-DOC-EXISTS", B006_EXPECTATIONS_SNIPPETS),
        (args.b006_packet_doc, "M235-B007-B006-PKT-EXISTS", B006_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B007-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B007-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B007-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B007-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b006_checker, "M235-B007-DEP-B006-ARG-01"),
        (args.b006_test, "M235-B007-DEP-B006-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
