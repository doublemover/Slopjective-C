#!/usr/bin/env python3
"""Fail-closed checker for M231-E009 Declaration coverage gate and docs contract freeze."""
...
MODE = "m231-e009-declaration-coverage-gate-and-docs-conformance-matrix-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_e009_declaration_coverage_gate_and_docs_conformance_matrix_implementation_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M231-E009-DOC-PKT-01",
        "# M231-E009 Declaration Grammar Expansion and Normalization Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M231-E009-DOC-PKT-02", "Packet: `M231-E009`"),
    SnippetCheck("M231-E009-DOC-PKT-03", "Issue: `#5515`"),
    SnippetCheck("M231-E009-DOC-PKT-04", "Dependencies: `M231-E008`"),
    SnippetCheck(
        "M231-E009-DOC-PKT-05",
        "check:objc3c:m231-e009-declaration-coverage-gate-and-docs-conformance-matrix-implementation-contract",
    ),
    SnippetCheck(
        "M231-E009-DOC-PKT-06",
        "tmp/reports/m231/M231-E009/declaration_coverage_gate_and_docs_conformance_matrix_implementation_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M231-E009-PKG-03",
        '"check:objc3c:m231-e009-lane-e-readiness": '
        '"npm run check:objc3c:m231-e008-lane-e-readiness && npm run check:objc3c:m231-e009-declaration-coverage-gate-and-docs-conformance-matrix-implementation-contract '
        '&& npm run test:tooling:m231-e009-declaration-coverage-gate-and-docs-conformance-matrix-implementation-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-E009-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-E009-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-E009-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-E009-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-E009-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-E009-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
