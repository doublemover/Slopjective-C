...
def validate_semantic_policy(
    *,
    ...
    if concurrency_semantics.get("public_task_group_api") != (
        "objc3_task_group_run_two enters a two-child task-group scope and objc3_task_group_run_bounded accepts a caller-provided child count; both drain through objc3_concurrency_task_group_scope_depth and negative counts fail closed through cancellation"
    ):
