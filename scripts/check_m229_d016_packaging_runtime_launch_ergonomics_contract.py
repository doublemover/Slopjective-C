#!/usr/bin/env python3
"""Fail-closed checker for M229-D016 packaging and runtime launch ergonomics contract freeze."""
...
MODE = "m229-d016-packaging-runtime-launch-ergonomics-advanced-edge-compatibility-workpack-shard-1-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_d016_packaging_runtime_launch_ergonomics_advanced_edge_compatibility_workpack_shard_1_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-D016-DOC-PKT-01",
        "# M229-D016 Packaging and runtime launch ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-D016-DOC-PKT-02", "Packet: `M229-D016`"),
    SnippetCheck("M229-D016-DOC-PKT-03", "Issue: `#5366`"),
    SnippetCheck("M229-D016-DOC-PKT-04", "Dependencies: `M229-D015`"),
    SnippetCheck(
        "M229-D016-DOC-PKT-05",
        "check:objc3c:m229-d016-packaging-runtime-launch-ergonomics-advanced-edge-compatibility-workpack-shard-1-contract",
    ),
    SnippetCheck(
        "M229-D016-DOC-PKT-06",
        "tmp/reports/m229/M229-D016/packaging_runtime_launch_ergonomics_advanced_edge_compatibility_workpack_shard_1_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-D016-PKG-03",
        '"check:objc3c:m229-d016-lane-d-readiness": '
        '"npm run check:objc3c:m229-d015-lane-d-readiness && npm run check:objc3c:m229-d016-packaging-runtime-launch-ergonomics-advanced-edge-compatibility-workpack-shard-1-contract '
        '&& npm run test:tooling:m229-d016-packaging-runtime-launch-ergonomics-advanced-edge-compatibility-workpack-shard-1-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-D016-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-D016-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-D016-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-D016-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-D016-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-D016-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
