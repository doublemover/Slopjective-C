#!/usr/bin/env python3
"""Fail-closed checker for M243-E009 lane-E diagnostics gate/replay-policy conformance matrix implementation."""
...
MODE = "m243-e009-lane-e-diagnostics-quality-gate-replay-policy-conformance-matrix-implementation-contract-v1"
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m243/M243-E009/"
    "lane_e_diagnostics_quality_gate_and_replay_policy_conformance_matrix_implementation_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M243-E009-DOC-EXP-01",
        "Contract ID: `objc3c-lane-e-diagnostics-quality-gate-replay-policy-conformance-matrix-implementation/m243-e009-v1`",
    ),
    SnippetCheck(
        "M243-E009-DOC-EXP-02",
        "Dependencies: `M243-E008`, `M243-A003`, `M243-B004`, `M243-C005`, `M243-D006`",
    ),
    SnippetCheck("M243-E009-DOC-EXP-03", "Issue `#6495` defines the canonical lane-E dependency chain for E009."),
    SnippetCheck("M243-E009-DOC-EXP-04", "E008 contract anchors remain mandatory prerequisites:"),
    SnippetCheck("M243-E009-DOC-EXP-05", "`check:objc3c:m243-e009-lane-e-readiness`"),
    SnippetCheck("M243-E009-DOC-EXP-06", "`compile:objc3c`"),
    SnippetCheck("M243-E009-DOC-EXP-07", "`proof:objc3c`"),
    SnippetCheck("M243-E009-DOC-EXP-08", "`test:objc3c:diagnostics-replay-proof`"),
    SnippetCheck("M243-E009-DOC-EXP-09", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M243-E009-DOC-EXP-10", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M243-E009-DOC-PKT-01", "Packet: `M243-E009`"),
    SnippetCheck("M243-E009-DOC-PKT-02", "Issue: `#6495`"),
    SnippetCheck(
        "M243-E009-DOC-PKT-03",
        "Dependencies: `M243-E008`, `M243-A003`, `M243-B004`, `M243-C005`, `M243-D006`",
    ),
    SnippetCheck(
        "M243-E009-DOC-PKT-04",
        "`scripts/check_m243_e009_lane_e_diagnostics_quality_gate_and_replay_policy_conformance_matrix_implementation_contract.py`",
    ),
    SnippetCheck(
        "M243-E009-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M243-E009-CFG-03", "check:objc3c:m243-e009-lane-e-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m243-e008-lane-e-readiness && npm run check:objc3c:m243-a003-lane-a-readiness && npm run check:objc3c:m243-b004-lane-b-readiness && npm run check:objc3c:m243-c005-lane-c-readiness && npm run check:objc3c:m243-d006-lane-d-readiness && npm run check:objc3c:m243-e009-lane-e-diagnostics-quality-gate-replay-policy-conformance-matrix-implementation-contract && npm run test:tooling:m243-e009-lane-e-diagnostics-quality-gate-replay-policy-conformance-matrix-implementation-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M243-E009-ARCH-02",
        "(`M243-E008`, `M243-A003`, `M243-B004`, `M243-C005`, and `M243-D006`)",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M243-E009-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M243-E009-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M243-E009-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M243-E009-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M243-E009-META-00",
