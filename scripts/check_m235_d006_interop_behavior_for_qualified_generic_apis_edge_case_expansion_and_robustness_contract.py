#!/usr/bin/env python3
"""Fail-closed checker for M235-D006 interop behavior edge-case expansion and robustness."""
...
MODE = "m235-d006-interop-behavior-for-qualified-generic-apis-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_D005_CHECKER = (
    ROOT / "scripts" / "check_m235_d005_interop_behavior_for_qualified_generic_apis_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_D005_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_d005_interop_behavior_for_qualified_generic_apis_edge_case_and_compatibility_completion_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M235-D006-DEP-D005-01",
        Path("docs/contracts/m235_interop_behavior_for_qualified_generic_apis_edge_case_and_compatibility_completion_d005_expectations.md"),
    ),
    AssetCheck(
        "M235-D006-DEP-D005-02",
        Path("spec/planning/compiler/m235/m235_d005_interop_behavior_for_qualified_generic_apis_edge_case_and_compatibility_completion_packet.md"),
    ),
    AssetCheck(
        "M235-D006-DEP-D005-03",
        Path("scripts/check_m235_d005_interop_behavior_for_qualified_generic_apis_edge_case_and_compatibility_completion_contract.py"),
    ),
    AssetCheck(
        "M235-D006-DEP-D005-04",
        Path("tests/tooling/test_check_m235_d005_interop_behavior_for_qualified_generic_apis_edge_case_and_compatibility_completion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-D006-DOC-EXP-01",
        "# M235 Interop Behavior for Qualified Generic APIs Edge-case Expansion and Robustness Expectations (D006)",
    ),
    SnippetCheck(
        "M235-D006-DOC-EXP-02",
        "Contract ID: `objc3c-interop-behavior-for-qualified-generic-apis-edge-case-expansion-and-robustness/m235-d006-v1`",
    ),
    SnippetCheck(
        "M235-D006-DOC-EXP-03",
        "Issue `#5836` defines canonical lane-D edge-case expansion and robustness scope.",
    ),
    SnippetCheck("M235-D006-DOC-EXP-04", "Dependencies: `M235-D005`"),
    SnippetCheck(
        "M235-D006-DOC-EXP-05",
        "milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-D006-DOC-EXP-06",
    ...
    SnippetCheck("M235-D006-DOC-EXP-09", "`check:objc3c:m235-d005-lane-d-readiness`"),
    SnippetCheck(
        "M235-D006-DOC-EXP-10",
        "`check:objc3c:m235-d006-interop-behavior-for-qualified-generic-apis-edge-case-expansion-and-robustness-contract`",
    ),
    SnippetCheck(
        "M235-D006-DOC-EXP-11",
        "`check:objc3c:m235-d006-lane-d-readiness`",
    ),
    SnippetCheck("M235-D006-DOC-EXP-12", "`compile:objc3c`"),
    SnippetCheck(
        "M235-D006-DOC-EXP-13",
        "`tmp/reports/m235/M235-D006/interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-D006-DOC-PKT-01",
        "# M235-D006 Interop Behavior for Qualified Generic APIs Edge-case Expansion and Robustness Packet",
    ),
    SnippetCheck("M235-D006-DOC-PKT-02", "Packet: `M235-D006`"),
    SnippetCheck("M235-D006-DOC-PKT-03", "Issue: `#5836`"),
    SnippetCheck("M235-D006-DOC-PKT-04", "Dependencies: `M235-D005`"),
    SnippetCheck(
        "M235-D006-DOC-PKT-05",
        "including code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M235-D006-DOC-PKT-06",
        "docs/contracts/m235_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_d006_expectations.md",
    ),
    SnippetCheck(
        "M235-D006-DOC-PKT-07",
        "scripts/check_m235_d006_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M235-D006-DOC-PKT-08",
    ...
    SnippetCheck("M235-D006-DOC-PKT-09", "`npm run check:objc3c:m235-d005-lane-d-readiness`"),
    SnippetCheck(
        "M235-D006-DOC-PKT-10",
        "`tmp/reports/m235/M235-D006/interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_contract_summary.json`",
    ),
    SnippetCheck(
        "M235-D006-DOC-PKT-11",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-D006-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-D006-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-D006-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-D006-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-D006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-D006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d005_expectations_doc, "M235-D006-D005-DOC-EXISTS", D005_EXPECTATIONS_SNIPPETS),
        (args.d005_packet_doc, "M235-D006-D005-PKT-EXISTS", D005_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-D006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-D006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-D006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-D006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d005_checker, "M235-D006-DEP-D005-ARG-01"),
        (args.d005_test, "M235-D006-DEP-D005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
