#!/usr/bin/env python3
"""Fail-closed checker for M230-E014 Program control and release readiness governance contract freeze."""
...
MODE = "m230-e014-program-control-and-release-readiness-governance-release-candidate-and-replay-dry-run-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_e014_program_control_and_release_readiness_governance_release_candidate_and_replay_dry_run_packet.md"
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-E014-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-E014-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-E014-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-E014-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-E014-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-E014-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
