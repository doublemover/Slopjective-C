#!/usr/bin/env python3
"""Fail-closed validator for M248-D021 runner/platform advanced core workpack (shard 2)."""
...
MODE = "m248-runner-reliability-platform-operations-advanced-core-workpack-shard2-contract-d021-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    "d020_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m248_runner_reliability_and_platform_operations_advanced_performance_workpack_shard1_d020_expectations.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m248_runner_reliability_and_platform_operations_advanced_core_workpack_shard2_d021_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m248"
    / "m248_d021_runner_reliability_and_platform_operations_advanced_core_workpack_shard2_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        (
            "M248-D021-DOC-01",
            "Contract ID: `objc3c-runner-reliability-platform-operations-advanced-core-workpack-shard2/m248-d021-v1`",
        ),
        (
            "M248-D021-DOC-02",
            "IsObjc3ToolchainRuntimeGaOperationsAdvancedCoreShard2Consistent",
        ...
        ("M248-D021-DOC-06", "npm run check:objc3c:m248-d021-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M248-D021-PKT-01", "Packet: `M248-D021`"),
        ("M248-D021-PKT-02", "Dependencies: `M248-D020`"),
        ("M248-D021-PKT-03", "Issue: `#6856`"),
        (
            "M248-D021-PKT-04",
            "scripts/check_m248_d021_runner_reliability_and_platform_operations_advanced_core_workpack_shard2_contract.py",
        ),
    ...
    "package_json": (
        (
            "M248-D021-CFG-01",
            "\"check:objc3c:m248-d021-runner-reliability-platform-operations-advanced-core-workpack-shard2-contract\"",
        ),
        (
            "M248-D021-CFG-02",
            "\"test:tooling:m248-d021-runner-reliability-platform-operations-advanced-core-workpack-shard2-contract\"",
        ),
        ("M248-D021-CFG-03", "\"check:objc3c:m248-d021-lane-d-readiness\""),
        ("M248-D021-CFG-04", "python scripts/run_m248_d021_lane_d_readiness.py"),
    ),
}
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "parse_surface_header": (
        (
            "M248-D021-FORB-01",
            "toolchain_runtime_ga_operations_advanced_core_shard2_consistent = true;",
        ),
    ),
}
