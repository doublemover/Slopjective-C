#!/usr/bin/env python3
"""Fail-closed checker for M249-A003 feature packaging core feature implementation."""
...
MODE = "m249-a003-feature-packaging-surface-compatibility-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_feature_packaging_surface_and_compatibility_contracts_core_feature_implementation_a003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_a003_feature_packaging_surface_and_compatibility_contracts_core_feature_implementation_packet.md"
)
DEFAULT_A002_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_feature_packaging_surface_and_compatibility_contracts_modular_split_scaffolding_a002_expectations.md"
)
DEFAULT_A002_PACKET_DOC = (
    ...
    / "compiler"
    / "m249"
    / "m249_a002_feature_packaging_surface_and_compatibility_contracts_modular_split_scaffolding_packet.md"
)
DEFAULT_A002_CHECKER = (
    ROOT / "scripts" / "check_m249_a002_feature_packaging_surface_and_compatibility_contracts_modular_split_scaffolding_contract.py"
)
DEFAULT_A002_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m249_a002_feature_packaging_surface_and_compatibility_contracts_modular_split_scaffolding_contract.py"
)
...
A002_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-A003-A002-PKT-01", "Packet: `M249-A002`"),
    SnippetCheck("M249-A003-A002-PKT-02", "Dependencies: `M249-A001`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m249-a003-feature-packaging-surface-compatibility-core-feature-implementation-contract '
        '&& npm run test:tooling:m249-a003-feature-packaging-surface-compatibility-core-feature-implementation-contract"',
    ),
    SnippetCheck("M249-A003-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M249-A003-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-A003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-A003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a002_expectations_doc, "M249-A003-A002-DOC-EXISTS", A002_EXPECTATIONS_SNIPPETS),
        (args.a002_packet_doc, "M249-A003-A002-PKT-EXISTS", A002_PACKET_SNIPPETS),
        (args.architecture_doc, "M249-A003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-A003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-A003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-A003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a002_checker, "M249-A003-DEP-A002-ARG-01"),
        (args.a002_test, "M249-A003-DEP-A002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
