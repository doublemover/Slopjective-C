#!/usr/bin/env python3
"""Fail-closed checker for M230-E026 Program control and release readiness governance contract freeze."""
...
MODE = "m230-e026-program-control-and-release-readiness-governance-advanced-performance-workpack-shard-2-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_e026_program_control_and_release_readiness_governance_advanced_performance_workpack_shard_2_packet.md"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-E026-PKG-03",
        '"check:objc3c:m230-e026-lane-e-readiness": '
        '"npm run check:objc3c:m230-e025-lane-e-readiness && npm run check:objc3c:m230-e026-program-control-and-release-readiness-governance-advanced-performance-workpack-shard-2-contract '
        '&& npm run test:tooling:m230-e026-program-control-and-release-readiness-governance-advanced-performance-workpack-shard-2-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-E026-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-E026-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-E026-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-E026-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-E026-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-E026-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
