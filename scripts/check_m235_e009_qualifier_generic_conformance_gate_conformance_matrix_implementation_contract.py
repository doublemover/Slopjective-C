#!/usr/bin/env python3
"""Fail-closed checker for M235-E009 qualifier/generic conformance gate conformance matrix implementation."""
...
MODE = "m235-e009-qualifier-generic-conformance-gate-conformance-matrix-implementation-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_generic_conformance_gate_conformance_matrix_implementation_e009_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_e009_qualifier_generic_conformance_gate_conformance_matrix_implementation_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m235/M235-E009/local_check_summary.json")
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-E009-DOC-EXP-01",
        "# M235 Qualifier Generic Conformance Gate Conformance Matrix Implementation Expectations (E003)",
    ),
    SnippetCheck(
        "M235-E009-DOC-EXP-02",
        "Contract ID: `objc3c-qualifier-generic-conformance-gate-core-feature-implementation/m235-e003-v1`",
    ),
    SnippetCheck("M235-E009-DOC-EXP-03", "Issue: `#5848`"),
    SnippetCheck(
        "M235-E009-DOC-EXP-04",
        "Dependencies: `M235-E008`, `M235-A003`, `M235-B006`, `M235-C004`, `M235-D002`",
    ),
    SnippetCheck(
        "M235-E009-DOC-EXP-05",
        "dependency carry-forward from E002",
    ),
    SnippetCheck(
        "M235-E009-DOC-EXP-06",
        "Issue `#5848` governs lane-E core feature implementation scope and dependency continuity from E002.",
    ),
    SnippetCheck("M235-E009-DOC-EXP-07", "| `M235-E008` |"),
    SnippetCheck("M235-E009-DOC-EXP-08", "| `M235-A003` |"),
    SnippetCheck("M235-E009-DOC-EXP-09", "| `M235-B006` |"),
    SnippetCheck("M235-E009-DOC-EXP-10", "| `M235-C004` |"),
    SnippetCheck("M235-E009-DOC-EXP-11", "| `M235-D002` |"),
    SnippetCheck(
        "M235-E009-DOC-EXP-12",
        "scripts/check_m235_e009_qualifier_generic_conformance_gate_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M235-E009-DOC-EXP-13",
        "tests/tooling/test_check_m235_e009_qualifier_generic_conformance_gate_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M235-E009-DOC-EXP-14",
        "tmp/reports/m235/M235-E009/local_check_summary.json",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-E009-DOC-PKT-01",
        "# M235-E009 Qualifier Generic Conformance Gate Conformance Matrix Implementation Packet",
    ),
    SnippetCheck("M235-E009-DOC-PKT-02", "Packet: `M235-E009`"),
    SnippetCheck("M235-E009-DOC-PKT-03", "Issue: `#5848`"),
    SnippetCheck(
        "M235-E009-DOC-PKT-04",
        "Dependencies: `M235-E008`, `M235-A003`, `M235-B006`, `M235-C004`, `M235-D002`",
    ),
    SnippetCheck(
        "M235-E009-DOC-PKT-05",
        "Dependency continuity from E002 remains fail-closed through these anchors:",
    ),
    SnippetCheck(
        "M235-E009-DOC-PKT-06",
        "docs/contracts/m235_qualifier_generic_conformance_gate_conformance_matrix_implementation_e009_expectations.md",
    ),
    SnippetCheck(
        "M235-E009-DOC-PKT-07",
        "scripts/check_m235_e009_qualifier_generic_conformance_gate_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M235-E009-DOC-PKT-08",
        "tests/tooling/test_check_m235_e009_qualifier_generic_conformance_gate_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M235-E009-DOC-PKT-09",
        "python scripts/check_m235_e009_qualifier_generic_conformance_gate_conformance_matrix_implementation_contract.py --summary-out tmp/reports/m235/M235-E009/local_check_summary.json",
    ),
    SnippetCheck(
        "M235-E009-DOC-PKT-10",
        "python -m pytest tests/tooling/test_check_m235_e009_qualifier_generic_conformance_gate_conformance_matrix_implementation_contract.py -q",
    ),
    SnippetCheck(
        "M235-E009-DOC-PKT-11",
        "tmp/reports/m235/M235-E009/local_check_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-E009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-E009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
