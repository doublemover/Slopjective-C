#!/usr/bin/env python3
"""Fail-closed contract checker for M248-B005 semantic/lowering edge-case and compatibility completion."""
...
MODE = "m248-b005-semantic-lowering-test-architecture-edge-case-and-compatibility-completion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_semantic_lowering_test_architecture_edge_case_and_compatibility_completion_b005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_b005_semantic_lowering_test_architecture_edge_case_and_compatibility_completion_packet.md"
)
...
DEFAULT_B004_CHECKER = (
    ROOT / "scripts" / "check_m248_b004_semantic_lowering_test_architecture_core_feature_expansion_contract.py"
)
DEFAULT_B004_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m248_b004_semantic_lowering_test_architecture_core_feature_expansion_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B005-DOC-PKT-01",
        "# M248-B005 Semantic/Lowering Test Architecture Edge-Case and Compatibility Completion Packet",
    ),
    SnippetCheck("M248-B005-DOC-PKT-02", "Packet: `M248-B005`"),
    SnippetCheck("M248-B005-DOC-PKT-03", "Issue: `#6805`"),
    SnippetCheck("M248-B005-DOC-PKT-04", "Dependencies: `M248-B004`"),
    SnippetCheck(
        "M248-B005-DOC-PKT-05",
        "`scripts/check_m248_b005_semantic_lowering_test_architecture_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M248-B005-DOC-PKT-06",
        "`check:objc3c:m248-b005-lane-b-readiness`",
    ),
    SnippetCheck(
        "M248-B005-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M248-B005-DOC-PKT-08",
...
B004_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B005-B004-DOC-01",
        "Contract ID: `objc3c-semantic-lowering-test-architecture-core-feature-expansion/m248-b004-v1`",
    ),
    SnippetCheck("M248-B005-B004-DOC-02", "- Dependencies: `M248-B003`"),
    SnippetCheck(
        "M248-B005-B004-DOC-03",
        "scripts/check_m248_b004_semantic_lowering_test_architecture_core_feature_expansion_contract.py",
    ),
)

B004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-B005-B004-PKT-01", "Packet: `M248-B004`"),
    SnippetCheck("M248-B005-B004-PKT-02", "Dependencies: `M248-B003`"),
    SnippetCheck(
        "M248-B005-B004-PKT-03",
        "`scripts/check_m248_b004_semantic_lowering_test_architecture_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M248-B005-B004-PKT-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        "&& npm run check:objc3c:m248-b005-semantic-lowering-test-architecture-edge-case-and-compatibility-completion-contract "
        '&& npm run test:tooling:m248-b005-semantic-lowering-test-architecture-edge-case-and-compatibility-completion-contract"',
    ),
    SnippetCheck("M248-B005-PKG-04", '"check:objc3c:m248-b004-lane-b-readiness": '),
    SnippetCheck("M248-B005-PKG-05", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M248-B005-PKG-06", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b004_expectations_doc, "M248-B005-B004-DOC-EXISTS", B004_EXPECTATIONS_SNIPPETS),
        (args.b004_packet_doc, "M248-B005-B004-PKT-EXISTS", B004_PACKET_SNIPPETS),
        (args.architecture_doc, "M248-B005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-B005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b004_checker, "M248-B005-DEP-B004-ARG-01"),
        (args.b004_test, "M248-B005-DEP-B004-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
