#!/usr/bin/env python3
"""Fail-closed checker for M244-C003 interop lowering/ABI core-feature implementation contract."""
...
MODE = "m244-c003-interop-lowering-and-abi-conformance-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_core_feature_implementation_c003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c003_interop_lowering_and_abi_conformance_core_feature_implementation_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C003/"
    "interop_lowering_and_abi_conformance_core_feature_implementation_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-C003-C002-01",
        "M244-C002",
        Path("docs/contracts/m244_interop_lowering_and_abi_conformance_modular_split_scaffolding_c002_expectations.md"),
    ),
    AssetCheck(
        "M244-C003-C002-02",
        "M244-C002",
        Path("spec/planning/compiler/m244/m244_c002_interop_lowering_and_abi_conformance_modular_split_scaffolding_packet.md"),
    ),
    AssetCheck(
        "M244-C003-C002-03",
        "M244-C002",
        Path("scripts/check_m244_c002_interop_lowering_and_abi_conformance_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M244-C003-C002-04",
        "M244-C002",
        Path("tests/tooling/test_check_m244_c002_interop_lowering_and_abi_conformance_modular_split_scaffolding_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C003-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-core-feature-implementation/m244-c003-v1`",
    ),
    SnippetCheck("M244-C003-DOC-EXP-02", "Dependencies: `M244-C002`"),
    SnippetCheck("M244-C003-DOC-EXP-03", "Issue `#6552` defines canonical lane-C core-feature implementation scope."),
    SnippetCheck("M244-C003-DOC-EXP-04", "`check:objc3c:m244-c003-lane-c-readiness`"),
    SnippetCheck("M244-C003-DOC-EXP-05", "`check:objc3c:m244-c002-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C003-DOC-PKT-01", "Packet: `M244-C003`"),
    SnippetCheck("M244-C003-DOC-PKT-02", "Issue: `#6552`"),
    SnippetCheck("M244-C003-DOC-PKT-03", "Dependencies: `M244-C002`"),
    SnippetCheck(
        "M244-C003-DOC-PKT-04",
        "`scripts/check_m244_c003_interop_lowering_and_abi_conformance_core_feature_implementation_contract.py`",
    ),
    SnippetCheck(
        "M244-C003-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C003-CFG-03", "check:objc3c:m244-c003-lane-c-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c002-lane-c-readiness && npm run check:objc3c:m244-c003-interop-lowering-abi-conformance-core-feature-implementation-contract && npm run test:tooling:m244-c003-interop-lowering-abi-conformance-core-feature-implementation-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C003-ARCH-02", "`M244-C002` dependency continuity and core-feature evidence remain fail-closed."),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C003-SPC-02", "lane-C dependency anchor (`M244-C002`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C003-META-02",
        "explicit `M244-C002` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C003-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C003-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C003-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C003-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C003-META-00",
