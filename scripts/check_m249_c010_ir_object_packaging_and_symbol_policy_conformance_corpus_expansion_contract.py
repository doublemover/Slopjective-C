#!/usr/bin/env python3
"""Fail-closed checker for M249-C010 IR/object packaging conformance corpus expansion contract."""
...
MODE = "m249-c010-ir-object-packaging-and-symbol-policy-conformance-corpus-expansion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m249"
    / "m249_c010_ir_object_packaging_and_symbol_policy_conformance_corpus_expansion_packet.md"
)
DEFAULT_C009_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_ir_object_packaging_and_symbol_policy_conformance_matrix_implementation_c009_expectations.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m249/M249-C010/"
    "ir_object_packaging_and_symbol_policy_conformance_corpus_expansion_contract_summary.json"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-C010-DOC-PKT-01", "Packet: `M249-C010`"),
    SnippetCheck("M249-C010-DOC-PKT-02", "Issue: `#6925`"),
    SnippetCheck("M249-C010-DOC-PKT-03", "Dependencies: `M249-C009`"),
    SnippetCheck("M249-C010-DOC-PKT-04", "## Dependency Anchors (M249-C009)"),
    SnippetCheck(
        "M249-C010-DOC-PKT-05",
        "`scripts/check_m249_c010_ir_object_packaging_and_symbol_policy_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M249-C010-DOC-PKT-06",
        "`tests/tooling/test_check_m249_c010_ir_object_packaging_and_symbol_policy_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck("M249-C010-DOC-PKT-07", "`check:objc3c:m249-c010-lane-c-readiness`"),
)

C009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-C010-C009-DOC-01",
        "Contract ID: `objc3c-ir-object-packaging-symbol-policy-conformance-matrix-implementation/m249-c009-v1`",
    ),
    SnippetCheck("M249-C010-C009-DOC-02", "Dependencies: `M249-C008`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M249-C010-CFG-03", "check:objc3c:m249-c010-lane-c-readiness"),
    PackageScriptKeyCheck("M249-C010-CFG-04", "check:objc3c:m249-c009-lane-c-readiness"),
    PackageScriptKeyCheck("M249-C010-CFG-05", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M249-C010-CFG-06", "test:objc3c:execution-replay-proof"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m249-c009-lane-c-readiness && npm run check:objc3c:m249-c010-ir-object-packaging-symbol-policy-conformance-corpus-expansion-contract && npm run test:tooling:m249-c010-ir-object-packaging-symbol-policy-conformance-corpus-expansion-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M249-C010-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M249-C010-DOC-PKT-00",
    ...
    c009_checks, c009_findings = check_doc_contract(
        ...
        exists_check_id="M249-C010-C009-DOC-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M249-C010-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M249-C010-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M249-C010-META-00",
