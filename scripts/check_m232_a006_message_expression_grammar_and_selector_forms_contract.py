#!/usr/bin/env python3
"""Fail-closed checker for M232-A006 message expression grammar and selector forms contract freeze."""
...
MODE = "m232-a006-message-expression-grammar-and-selector-forms-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m232"
    / "m232_a006_message_expression_grammar_and_selector_forms_edge_case_expansion_and_robustness_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-A006-DOC-EXP-01",
        "# M232 Message Expression Grammar and Selector Forms Contract and Architecture Freeze Expectations (A006)",
    ),
    SnippetCheck(
        "M232-A006-DOC-EXP-02",
        "Contract ID: `objc3c-message-expression-grammar-and-selector-forms/m232-a006-v1`",
    ),
    SnippetCheck("M232-A006-DOC-EXP-03", "Issue: `#5570`"),
    SnippetCheck("M232-A006-DOC-EXP-04", "Dependencies: none"),
    SnippetCheck(
        "M232-A006-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M232-A006-DOC-EXP-06",
        "`check:objc3c:m232-a006-lane-a-readiness`",
    ),
    SnippetCheck(
        "M232-A006-DOC-EXP-07",
        "`tmp/reports/m232/M232-A006/message_expression_grammar_and_selector_forms_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-A006-DOC-PKT-01",
        "# M232-A006 Message Expression Grammar and Selector Forms Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M232-A006-DOC-PKT-02", "Packet: `M232-A006`"),
    SnippetCheck("M232-A006-DOC-PKT-03", "Issue: `#5570`"),
    SnippetCheck("M232-A006-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M232-A006-DOC-PKT-05",
        "check:objc3c:m232-a006-message-expression-grammar-and-selector-forms-contract",
    ),
    SnippetCheck(
        "M232-A006-DOC-PKT-06",
        "tmp/reports/m232/M232-A006/message_expression_grammar_and_selector_forms_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M232-A006-PKG-03",
        '"check:objc3c:m232-a006-lane-a-readiness": '
        '"npm run check:objc3c:m232-a006-message-expression-grammar-and-selector-forms-contract '
        '&& npm run test:tooling:m232-a006-message-expression-grammar-and-selector-forms-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M232-A006-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M232-A006-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M232-A006-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M232-A006-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M232-A006-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M232-A006-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
