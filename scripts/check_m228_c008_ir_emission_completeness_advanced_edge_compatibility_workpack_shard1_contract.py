#!/usr/bin/env python3
"""Fail-closed validator for M228-C016 IR-emission advanced edge compatibility shard1 contract."""
...
MODE = "m228-c016-ir-emission-completeness-advanced-edge-compatibility-workpack-shard1-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c015_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_core_workpack_shard1_c015_expectations.md",
    "c015_checker": ROOT
    / "scripts"
    / "check_m228_c015_ir_emission_completeness_advanced_core_workpack_shard1_contract.py",
    "c015_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c015_ir_emission_completeness_advanced_core_workpack_shard1_contract.py",
    "c015_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    ...
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_edge_compatibility_workpack_shard1_c016_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c016_ir_emission_completeness_advanced_edge_compatibility_workpack_shard1_packet.md",
}
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "core_surface_header": (
        ...
        (
            "M228-C016-SUR-22",
            "inline bool IsObjc3IREmissionCoreFeatureAdvancedEdgeCompatibilityShard1Ready(",
        ),
        (
            "M228-C016-SUR-23",
    ...
    "artifacts_source": (
        (
            "M228-C016-ART-01",
            "IsObjc3IREmissionCoreFeatureAdvancedEdgeCompatibilityShard1Ready(",
        ),
        ("M228-C016-ART-02", '"O3L334"'),
        (
            "M228-C016-ART-03",
            "IR emission core feature advanced edge compatibility shard 1 check failed",
        ),
        (
            "M228-C016-ART-04",
    ...
    "runbook_doc": (
        ...
        ("M228-C016-RUN-04", "npm run check:objc3c:m228-c016-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C016-ARC-01",
    ...
    "lowering_spec": (
        ...
        (
            "M228-C016-SPC-02",
            "lane-C dependency anchors (`M228-C016`, `M228-C015`)",
        ),
    ),
    "metadata_spec": (
        (
    ...
    "package_json": (
        ("M228-C016-PKG-01", '"check:objc3c:m228-c015-lane-c-readiness"'),
        (
            "M228-C016-PKG-02",
            '"check:objc3c:m228-c016-ir-emission-completeness-advanced-edge-compatibility-workpack-shard1-contract"',
        ),
        (
            "M228-C016-PKG-03",
            '"test:tooling:m228-c016-ir-emission-completeness-advanced-edge-compatibility-workpack-shard1-contract"',
        ),
        ("M228-C016-PKG-04", '"check:objc3c:m228-c016-lane-c-readiness"'),
        (
            "M228-C016-PKG-05",
            '"check:objc3c:m228-c016-lane-c-readiness": "npm run check:objc3c:m228-c015-lane-c-readiness &&',
        ),
    ),
    "c015_contract_doc": (
        (
    ...
    "c015_tooling_test": (
        ("M228-C016-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c015_packet_doc": (
        ("M228-C016-DEP-04", "Packet: `M228-C015`"),
        ("M228-C016-DEP-05", "Issue: `#5241`"),
    ),
    "contract_doc": (
        (
            "M228-C016-DOC-01",
        ...
        ("M228-C016-DOC-02", "Execute issue `#5242`"),
        ("M228-C016-DOC-03", "Dependencies: `M228-C015`"),
        (
            "M228-C016-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedEdgeCompatibilityShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C016-PKT-02", "Packet: `M228-C016`"),
        ("M228-C016-PKT-03", "Issue: `#5242`"),
        ("M228-C016-PKT-04", "Dependencies: `M228-C015`"),
        (
            "M228-C016-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C016-FORB-01",
            '"check:objc3c:m228-c016-lane-c-readiness": "npm run check:objc3c:m228-c014-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C016/"
            "ir_emission_completeness_advanced_edge_compatibility_workpack_shard1_contract_summary.json"
        ),
    )
