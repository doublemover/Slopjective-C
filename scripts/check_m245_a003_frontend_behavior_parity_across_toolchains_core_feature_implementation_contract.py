#!/usr/bin/env python3
"""Fail-closed checker for M245-A003 frontend behavior parity core feature implementation."""
...
MODE = "m245-a003-frontend-behavior-parity-toolchains-core-feature-implementation-contract-v1"
...
DEFAULT_A002_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m245_frontend_behavior_parity_across_toolchains_modular_split_scaffolding_a002_expectations.md"
)
DEFAULT_A002_PACKET_DOC = (
    ...
    / "compiler"
    / "m245"
    / "m245_a002_frontend_behavior_parity_across_toolchains_modular_split_scaffolding_packet.md"
)
DEFAULT_A002_CHECKER = (
    ROOT / "scripts" / "check_m245_a002_frontend_behavior_parity_across_toolchains_modular_split_scaffolding_contract.py"
)
DEFAULT_A002_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_a002_frontend_behavior_parity_across_toolchains_modular_split_scaffolding_contract.py"
)
...
A002_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-A003-A002-PKT-01", "Packet: `M245-A002`"),
    SnippetCheck("M245-A003-A002-PKT-02", "Dependencies: `M245-A001`"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-A003-SPC-01",
        "frontend behavior parity core feature implementation governance shall preserve explicit",
    ),
    SnippetCheck(
        "M245-A003-SPC-02",
        "lane-A dependency anchors (`M245-A002`) and fail closed on core-feature evidence drift",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-A003-META-02",
        "explicit `M245-A002` dependency continuity so core feature implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-A003-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M245-A003-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-A003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-A003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a002_expectations_doc, "M245-A003-A002-DOC-EXISTS", A002_EXPECTATIONS_SNIPPETS),
        (args.a002_packet_doc, "M245-A003-A002-PKT-EXISTS", A002_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-A003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-A003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-A003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-A003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a002_checker, "M245-A003-DEP-A002-ARG-01"),
        (args.a002_test, "M245-A003-DEP-A002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
