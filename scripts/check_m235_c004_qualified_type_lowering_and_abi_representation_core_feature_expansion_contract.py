#!/usr/bin/env python3
"""Fail-closed checker for M235-C004 qualified type core feature expansion."""
...
MODE = "m235-c004-qualified-type-lowering-and-abi-representation-core-feature-expansion-contract-v1"
...
DEFAULT_C003_CHECKER = (
    ROOT / "scripts" / "check_m235_c003_qualified_type_lowering_and_abi_representation_core_feature_implementation_contract.py"
)
DEFAULT_C003_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c003_qualified_type_lowering_and_abi_representation_core_feature_implementation_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-C004-DOC-EXP-09", "`C003 readiness -> C004 checker -> C004 pytest`."),
    SnippetCheck(
        "M235-C004-DOC-EXP-10",
        "`tmp/reports/m235/M235-C004/qualified_type_lowering_and_abi_representation_core_feature_expansion_contract_summary.json`",
    ),
)
...
C003_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C004-C003-DOC-01",
        "# M235 Qualified Type Lowering and ABI Representation Core Feature Implementation Expectations (C003)",
    ),
    SnippetCheck(
        "M235-C004-C003-DOC-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-core-feature-implementation/m235-c003-v1`",
    ),
    SnippetCheck("M235-C004-C003-DOC-03", "Dependencies: `M235-C002`"),
    SnippetCheck(
        "M235-C004-C003-DOC-04",
        "Issue `#5813` defines canonical lane-C core feature implementation scope.",
    ),
)

C003_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-C004-C003-PKT-01", "Packet: `M235-C003`"),
    SnippetCheck("M235-C004-C003-PKT-02", "Issue: `#5813`"),
    SnippetCheck("M235-C004-C003-PKT-03", "Dependencies: `M235-C002`"),
    SnippetCheck("M235-C004-C003-PKT-04", "Freeze date: `2026-03-05`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C004-PKG-01",
        '"check:objc3c:m235-c003-qualified-type-lowering-and-abi-representation-core-feature-implementation-contract": '
        '"python scripts/check_m235_c003_qualified_type_lowering_and_abi_representation_core_feature_implementation_contract.py"',
    ),
    SnippetCheck(
        "M235-C004-PKG-02",
        '"test:tooling:m235-c003-qualified-type-lowering-and-abi-representation-core-feature-implementation-contract": '
    ...
    SnippetCheck(
        "M235-C004-PKG-03",
        '"check:objc3c:m235-c003-lane-c-readiness": '
        '"npm run check:objc3c:m235-c002-lane-c-readiness '
        '&& npm run check:objc3c:m235-c003-qualified-type-lowering-and-abi-representation-core-feature-implementation-contract '
        '&& npm run test:tooling:m235-c003-qualified-type-lowering-and-abi-representation-core-feature-implementation-contract"',
    ),
    SnippetCheck(
        "M235-C004-PKG-04",
    ...
    SnippetCheck("M235-C004-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-C004-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-C004-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C004-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c003_expectations_doc, "M235-C004-C003-DOC-EXISTS", C003_EXPECTATIONS_SNIPPETS),
        (args.c003_packet_doc, "M235-C004-C003-PKT-EXISTS", C003_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C004-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c003_checker, "M235-C004-DEP-C003-ARG-01"),
        (args.c003_test, "M235-C004-DEP-C003-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
