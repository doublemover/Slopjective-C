#!/usr/bin/env python3
"""Fail-closed checker for M247-A006 frontend profiling/hot-path edge-case expansion and robustness."""
...
MODE = "m247-a006-frontend-profiling-hot-path-decomposition-edge-case-expansion-and-robustness-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m247_frontend_profiling_and_hot_path_decomposition_edge_case_expansion_and_robustness_a006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m247"
    / "m247_a006_frontend_profiling_and_hot_path_decomposition_edge_case_expansion_and_robustness_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m247/M247-A006/"
    "frontend_profiling_and_hot_path_decomposition_edge_case_expansion_and_robustness_contract_summary.json"
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-A006-ARCH-02", "(`M247-A005`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-A006-META-02", "metadata anchors for `M247-A006`"),
    SnippetCheck("M247-A006-META-03", "`M247-A005` dependency continuity"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-A006-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M247-A006-PKG-05", '"test:objc3c:perf-budget": '),
    SnippetCheck("M247-A006-PKG-06", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M247-A006-PKG-07", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-A006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-A006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M247-A006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M247-A006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M247-A006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M247-A006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
