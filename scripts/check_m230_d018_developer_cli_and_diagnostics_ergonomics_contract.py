#!/usr/bin/env python3
"""Fail-closed checker for M230-D018 Developer CLI and diagnostics ergonomics contract freeze."""
...
MODE = "m230-d018-developer-cli-and-diagnostics-ergonomics-advanced-conformance-workpack-shard-1-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_d018_developer_cli_and_diagnostics_ergonomics_advanced_conformance_workpack_shard_1_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-D018-DOC-EXP-01",
        "# M230 Developer CLI and diagnostics ergonomics Contract and Architecture Freeze Expectations (A001)",
    ),
    SnippetCheck(
        "M230-D018-DOC-EXP-02",
        "Contract ID: `objc3c-developer-cli-and-diagnostics-ergonomics/m230-d018-v1`",
    ),
    SnippetCheck("M230-D018-DOC-EXP-03", "Issue: `#5457`"),
    SnippetCheck("M230-D018-DOC-EXP-04", "Dependencies: `M230-D017`"),
    SnippetCheck(
        "M230-D018-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-D018-DOC-EXP-06",
        "`check:objc3c:m230-d018-lane-d-readiness`",
    ),
    SnippetCheck(
        "M230-D018-DOC-EXP-07",
        "`tmp/reports/m230/M230-D018/developer_cli_and_diagnostics_ergonomics_advanced_conformance_workpack_shard_1_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-D018-DOC-PKT-01",
        "# M230-D018 Developer CLI and diagnostics ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-D018-DOC-PKT-02", "Packet: `M230-D018`"),
    SnippetCheck("M230-D018-DOC-PKT-03", "Issue: `#5457`"),
    SnippetCheck("M230-D018-DOC-PKT-04", "Dependencies: `M230-D017`"),
    SnippetCheck(
        "M230-D018-DOC-PKT-05",
        "check:objc3c:m230-d018-developer-cli-and-diagnostics-ergonomics-advanced-conformance-workpack-shard-1-contract",
    ),
    SnippetCheck(
        "M230-D018-DOC-PKT-06",
        "tmp/reports/m230/M230-D018/developer_cli_and_diagnostics_ergonomics_advanced_conformance_workpack_shard_1_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-D018-PKG-03",
        '"check:objc3c:m230-d018-lane-d-readiness": '
        '"npm run check:objc3c:m230-d017-lane-d-readiness && npm run check:objc3c:m230-d018-developer-cli-and-diagnostics-ergonomics-advanced-conformance-workpack-shard-1-contract '
        '&& npm run test:tooling:m230-d018-developer-cli-and-diagnostics-ergonomics-advanced-conformance-workpack-shard-1-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-D018-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-D018-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-D018-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-D018-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-D018-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-D018-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
