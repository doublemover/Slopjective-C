#!/usr/bin/env python3
"""Fail-closed contract checker for M244-E012 cross-lane integration sync."""
...
MODE = "m244-e012-lane-e-interop-conformance-gate-operations-cross-lane-integration-sync-contract-v1"

ARTIFACTS: dict[str, Path] = {
    "expectations_doc": ROOT
    / "docs"
    / "contracts"
    / "m244_lane_e_interop_conformance_gate_and_operations_cross_lane_integration_sync_e012_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m244"
    / "m244_e012_lane_e_interop_conformance_gate_and_operations_cross_lane_integration_sync_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "expectations_doc": (
        ...
        ("M244-E012-DOC-EXP-11", "`check:objc3c:m244-e009-lane-e-readiness`"),
        ("M244-E012-DOC-EXP-12", "`compile:objc3c`"),
        ("M244-E012-DOC-EXP-13", "`proof:objc3c`"),
        ("M244-E012-DOC-EXP-14", "`test:objc3c:diagnostics-replay-proof`"),
        ("M244-E012-DOC-EXP-15", "`test:objc3c:execution-replay-proof`"),
        ("M244-E012-DOC-EXP-16", "`test:objc3c:perf-budget`"),
        (
            "M244-E012-DOC-EXP-17",
            "tmp/reports/m244/M244-E012/lane_e_interop_conformance_gate_operations_conformance_matrix_implementation_summary.json",
        ),
    ),
    "packet_doc": (
        (
            "M244-E012-DOC-PKT-01",
            "# M244-E012 Lane-E Interop Conformance Gate and Operations Cross-lane Integration Sync Packet",
        ),
        ("M244-E012-DOC-PKT-02", "Packet: `M244-E012`"),
        ("M244-E012-DOC-PKT-03", "Issue: `#6606`"),
        (
            "M244-E012-DOC-PKT-04",
            "Dependencies: `M244-E011`, `M244-A007`, `M244-B010`, `M244-C012`, `M244-D012`",
        ),
        (
            "M244-E012-DOC-PKT-05",
            "docs/contracts/m244_lane_e_interop_conformance_gate_and_operations_cross_lane_integration_sync_e012_expectations.md",
        ),
        (
            "M244-E012-DOC-PKT-06",
            "scripts/check_m244_e012_lane_e_interop_conformance_gate_and_operations_cross_lane_integration_sync_contract.py",
        ),
        (
            "M244-E012-DOC-PKT-07",
            "tests/tooling/test_check_m244_e012_lane_e_interop_conformance_gate_and_operations_cross_lane_integration_sync_contract.py",
        ),
        (
            "M244-E012-DOC-PKT-08",
            "including code/spec anchors and milestone",
        ),
        (
            "M244-E012-DOC-PKT-09",
            "`npm run --if-present check:objc3c:m244-b010-lane-b-readiness`",
        ),
        (
            "M244-E012-DOC-PKT-10",
            "`npm run --if-present check:objc3c:m244-c012-lane-c-readiness`",
        ),
        (
            "M244-E012-DOC-PKT-11",
            "`npm run --if-present check:objc3c:m244-d012-lane-d-readiness`",
        ),
        ("M244-E012-DOC-PKT-12", "`compile:objc3c`"),
        ("M244-E012-DOC-PKT-13", "`proof:objc3c`"),
        ("M244-E012-DOC-PKT-14", "`test:objc3c:diagnostics-replay-proof`"),
        ("M244-E012-DOC-PKT-15", "`test:objc3c:execution-replay-proof`"),
        ("M244-E012-DOC-PKT-16", "`test:objc3c:perf-budget`"),
        (
            "M244-E012-DOC-PKT-17",
            "tmp/reports/m244/M244-E012/lane_e_interop_conformance_gate_operations_conformance_matrix_implementation_summary.json",
        ),
    ),
    "lowering_spec": (
