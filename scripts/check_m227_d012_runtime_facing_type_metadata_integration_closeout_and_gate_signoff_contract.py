#!/usr/bin/env python3
"""Fail-closed checker for M227-D012 runtime-facing type metadata integration closeout and gate sign-off."""
...
MODE = "m227-d012-runtime-facing-type-metadata-integration-closeout-and-gate-signoff-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_d012_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-D012-DOC-EXP-08",
        "tmp/reports/m227/M227-D012/runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract_summary.json",
    ),
    SnippetCheck(
        "M227-D012-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M227-D012-DOC-PKT-01", "Packet: `M227-D012`"),
    SnippetCheck("M227-D012-DOC-PKT-02", "Issue: `#5158`"),
    SnippetCheck("M227-D012-DOC-PKT-03", "Dependencies: `M227-D011`"),
    SnippetCheck(
        "M227-D012-DOC-PKT-04",
        "`scripts/check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M227-D012-DOC-PKT-05",
        "`tests/tooling/test_check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck("M227-D012-DOC-PKT-06", "`check:objc3c:m227-d012-lane-d-readiness`"),
    SnippetCheck(
        "M227-D012-DOC-PKT-07",
        "`python scripts/check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M227-D012-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

FRONTEND_TYPES_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M227-D012-TYP-01", "bool typed_integration_closeout_signoff_consistent = false;"),
    SnippetCheck("M227-D012-TYP-02", "bool typed_integration_closeout_signoff_ready = false;"),
    SnippetCheck("M227-D012-TYP-03", "std::string typed_integration_closeout_signoff_key;"),
    SnippetCheck("M227-D012-TYP-04", "bool typed_sema_integration_closeout_signoff_consistent = false;"),
    SnippetCheck("M227-D012-TYP-05", "bool typed_sema_integration_closeout_signoff_ready = false;"),
    SnippetCheck("M227-D012-TYP-06", "std::string typed_sema_integration_closeout_signoff_key;"),
)

TYPED_SURFACE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-D012-SUR-01",
        "BuildObjc3TypedSemaToLoweringIntegrationCloseoutSignoffKey(",
    ),
    SnippetCheck("M227-D012-SUR-02", "surface.typed_integration_closeout_signoff_consistent ="),
    SnippetCheck("M227-D012-SUR-03", "surface.typed_integration_closeout_signoff_ready ="),
    SnippetCheck("M227-D012-SUR-04", "surface.typed_integration_closeout_signoff_key ="),
    SnippetCheck("M227-D012-SUR-05", "const bool typed_integration_closeout_signoff_key_ready ="),
    SnippetCheck(
        "M227-D012-SUR-06",
...
PARSE_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M227-D012-REA-01", "surface.typed_sema_integration_closeout_signoff_consistent ="),
    SnippetCheck("M227-D012-REA-02", "surface.typed_sema_integration_closeout_signoff_ready ="),
    SnippetCheck("M227-D012-REA-03", "surface.typed_sema_integration_closeout_signoff_key ="),
    SnippetCheck(
        "M227-D012-REA-04",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-D012-CFG-03", "check:objc3c:m227-d012-lane-d-readiness"),
    PackageScriptKeyCheck("M227-D012-CFG-04", "check:objc3c:m227-d011-lane-d-readiness"),
    PackageScriptKeyCheck("M227-D012-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M227-D012-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M227-D012-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-D012-CFG-11", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m227-d011-lane-d-readiness && npm run check:objc3c:m227-d012-runtime-facing-type-metadata-integration-closeout-and-gate-signoff-contract && npm run test:tooling:m227-d012-runtime-facing-type-metadata-integration-closeout-and-gate-signoff-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-D012-SPC-01",
        "runtime-facing type metadata integration closeout and gate sign-off governance shall preserve explicit lane-D dependency anchors (`M227-D012`, `M227-D011`)",
    ),
    SnippetCheck(
        "M227-D012-SPC-02",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-D012-META-02",
        "explicit `M227-D011` dependency continuity and fail-closed integration-closeout-signoff evidence continuity",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M227-D012-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M227-D012-DOC-PKT-00",
    ...
    frontend_checks, frontend_findings = check_doc_contract(
        ...
        exists_check_id="M227-D012-TYP-00",
    ...
    typed_checks, typed_findings = check_doc_contract(
        ...
        exists_check_id="M227-D012-SUR-00",
    ...
    readiness_checks, readiness_findings = check_doc_contract(
        ...
        exists_check_id="M227-D012-REA-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M227-D012-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M227-D012-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M227-D012-META-00",
