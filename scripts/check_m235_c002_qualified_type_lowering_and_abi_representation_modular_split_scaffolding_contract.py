#!/usr/bin/env python3
"""Fail-closed checker for M235-C002 qualified type modular split/scaffolding."""
...
MODE = "m235-c002-qualified-type-lowering-and-abi-representation-modular-split-scaffolding-contract-v1"
...
DEFAULT_C001_CHECKER = ROOT / "scripts" / "check_m235_c001_qualified_type_lowering_and_abi_representation_contract.py"
DEFAULT_C001_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c001_qualified_type_lowering_and_abi_representation_contract.py"
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C002-C001-DOC-01",
        "# M235 Qualified Type Lowering and ABI Representation Contract and Architecture Freeze Expectations (C001)",
    ),
    SnippetCheck(
        "M235-C002-C001-DOC-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-contract/m235-c001-v1`",
    ),
    SnippetCheck("M235-C002-C001-DOC-03", "Dependencies: none"),
    SnippetCheck(
        "M235-C002-C001-DOC-04",
        "Issue `#5811` defines canonical lane-C contract and architecture freeze scope.",
    ),
)

C001_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-C002-C001-PKT-01", "Packet: `M235-C001`"),
    SnippetCheck("M235-C002-C001-PKT-02", "Issue: `#5811`"),
    SnippetCheck("M235-C002-C001-PKT-03", "Dependencies: none"),
    SnippetCheck("M235-C002-C001-PKT-04", "Freeze date: `2026-03-05`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-C002-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M235-C002-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M235-C002-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C002-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M235-C002-C001-DOC-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c001_packet_doc, "M235-C002-C001-PKT-EXISTS", C001_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c001_checker, "M235-C002-DEP-C001-ARG-01"),
        (args.c001_test, "M235-C002-DEP-C001-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
