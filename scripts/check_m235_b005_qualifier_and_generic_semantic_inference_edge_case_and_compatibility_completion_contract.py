#!/usr/bin/env python3
"""Fail-closed checker for M235-B005 qualifier/generic semantic inference edge-case and compatibility completion."""
...
MODE = "m235-b005-qualifier-and-generic-semantic-inference-edge-case-and-compatibility-completion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_edge_case_and_compatibility_completion_b005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_b005_qualifier_and_generic_semantic_inference_edge_case_and_compatibility_completion_packet.md"
)
DEFAULT_B004_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_core_feature_expansion_b004_expectations.md"
)
DEFAULT_B004_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_b004_qualifier_and_generic_semantic_inference_core_feature_expansion_packet.md"
)
DEFAULT_B004_CHECKER = (
    ROOT / "scripts" / "check_m235_b004_qualifier_and_generic_semantic_inference_core_feature_expansion_contract.py"
)
DEFAULT_B004_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_b004_qualifier_and_generic_semantic_inference_core_feature_expansion_contract.py"
)
...
B004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B005-B004-PKT-01", "Packet: `M235-B004`"),
    SnippetCheck("M235-B005-B004-PKT-02", "Dependencies: `M235-B003`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B005-META-02",
        "explicit `M235-B004` dependency continuity so edge-case and compatibility completion drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B005-PKG-03",
        '"check:objc3c:m235-b005-lane-b-readiness": '
        '"npm run check:objc3c:m235-b004-lane-b-readiness '
        '&& npm run check:objc3c:m235-b005-qualifier-and-generic-semantic-inference-edge-case-and-compatibility-completion-contract '
        '&& npm run test:tooling:m235-b005-qualifier-and-generic-semantic-inference-edge-case-and-compatibility-completion-contract"',
    ),
    SnippetCheck("M235-B005-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B005-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b004_expectations_doc, "M235-B005-B004-DOC-EXISTS", B004_EXPECTATIONS_SNIPPETS),
        (args.b004_packet_doc, "M235-B005-B004-PKT-EXISTS", B004_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b004_checker, "M235-B005-DEP-B004-ARG-01"),
        (args.b004_test, "M235-B005-DEP-B004-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
