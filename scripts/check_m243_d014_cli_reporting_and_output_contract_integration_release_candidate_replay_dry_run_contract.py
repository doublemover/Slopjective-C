#!/usr/bin/env python3
"""Fail-closed checker for M243-D014 CLI/reporting output docs/runbook synchronization."""
...
MODE = (
    "m243-d014-cli-reporting-output-contract-integration-"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "tests"
    / "tooling"
    / "test_check_m243_d013_cli_reporting_and_output_contract_integration_docs_operator_runbook_synchronization_contract.py",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "expectations_doc": (
        ...
        ("M243-D014-DOC-02", "- Dependencies: `M243-D013`"),
        ("M243-D014-DOC-03", "docs_runbook_sync_consistent"),
        ("M243-D014-DOC-04", "docs_runbook_sync_ready"),
        ("M243-D014-DOC-05", "docs_runbook_sync_key_ready"),
        (
            "M243-D014-DOC-06",
        ...
        ("M243-D014-DOC-10", "npm run check:objc3c:m243-d014-lane-d-readiness"),
        ("M243-D014-DOC-11", "Issue `#6478`"),
    ),
    "packet_doc": (
        ("M243-D014-PKT-01", "Packet: `M243-D014`"),
        ("M243-D014-PKT-02", "Dependencies: `M243-D013`"),
        (
            "M243-D014-PKT-03",
            "scripts/check_m243_d014_cli_reporting_and_output_contract_integration_release_candidate_replay_dry_run_contract.py",
        ),
        ...
        ("M243-D014-PKT-05", "check:objc3c:m243-d014-lane-d-readiness"),
        (
            "M243-D014-PKT-06",
            "python scripts/check_m243_d014_cli_reporting_and_output_contract_integration_release_candidate_replay_dry_run_contract.py --emit-json",
        ),
    ...
    "d013_packet_doc": (
        ("M243-D014-DEP-02", "Packet: `M243-D013`"),
        ("M243-D014-DEP-03", "Dependencies: `M243-D012`"),
    ),
    "d013_checker": (
        (
            "M243-D014-DEP-04",
    ...
    "package_json": (
        ...
        ("M243-D014-PKG-03", '"check:objc3c:m243-d014-lane-d-readiness"'),
        (
            "M243-D014-PKG-04",
            "npm run check:objc3c:m243-d013-lane-d-readiness && npm run check:objc3c:m243-d014-cli-reporting-output-contract-integration-release-candidate-replay-dry-run-contract && npm run test:tooling:m243-d014-cli-reporting-output-contract-integration-release-candidate-replay-dry-run-contract",
        ),
    ),
}
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M243-D014-FORB-01",
            '"check:objc3c:m243-d014-lane-d-readiness": "npm run check:objc3c:m243-d012-lane-d-readiness',
        ),
    ),
}
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact, path in ARTIFACTS.items():
        ...
        try:
            ...
            findings.append(Finding(artifact, f"M243-D014-MISSING-{artifact.upper()}", str(exc)))
            continue
