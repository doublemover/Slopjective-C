...
def make_probe_specs(args: argparse.Namespace) -> tuple[ProbeSpec, ...]:
    return (
        ProbeSpec(
            ...
            expected_property_descriptor_count=3,
            expected_ivar_descriptor_count=1,
            expected_graph_method_nodes=5,
            expected_graph_property_nodes=3,
            expected_graph_ivar_nodes=1,
        ...
        ProbeSpec(
            ...
            expected_method_entry_count=3,
            expected_property_descriptor_count=3,
            expected_ivar_descriptor_count=1,
            expected_graph_method_nodes=3,
            expected_graph_property_nodes=3,
            expected_graph_ivar_nodes=1,
