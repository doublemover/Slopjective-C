...
MD_OUT = OUT_DIR / "language_server_capability_publication_policy_summary.md"
...
def main() -> int:
    ...
    checks = {
        ...
        "runbook_mentions_unpublished_capabilities": all(capability in runbook_text for capability in ["references", "rename", "semantic tokens", "code actions"]),
        "runbook_mentions_statement_level_stepping_status": "statement-level debugger stepping" in runbook_text,
    }

    summary = {
        "issue": "developer-tooling-language-server-capability-publication-policy",
        "contract_id": contract["contract_id"],
        "surface_kind": contract["surface_kind"],
        "capability_class_count": len(contract["capability_classes"]),
        "unpublished_capability_class_count": len(contract["unpublished_capability_classes"]),
    ...
    MD_OUT.write_text(
        ...
        f"- Unpublished capability classes: `{summary['unpublished_capability_class_count']}`\n"
