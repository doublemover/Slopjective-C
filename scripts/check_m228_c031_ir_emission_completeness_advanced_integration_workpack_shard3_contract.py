#!/usr/bin/env python3
"""Fail-closed validator for M228-C031 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c030_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c030_ir_emission_completeness_advanced_conformance_workpack_shard3_contract.py",
    "c030_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c030_ir_emission_completeness_advanced_conformance_workpack_shard3_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C031-RUN-04", "npm run check:objc3c:m228-c031-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C031-ARC-01",
    ...
    "package_json": (
        ("M228-C031-PKG-01", '"check:objc3c:m228-c030-lane-c-readiness"'),
        (
            "M228-C031-PKG-02",
            '"check:objc3c:m228-c031-ir-emission-completeness-advanced-integration-workpack-shard3-contract"',
        ),
        (
            "M228-C031-PKG-03",
            '"test:tooling:m228-c031-ir-emission-completeness-advanced-integration-workpack-shard3-contract"',
        ),
        ("M228-C031-PKG-04", '"check:objc3c:m228-c031-lane-c-readiness"'),
        (
            "M228-C031-PKG-05",
            '"check:objc3c:m228-c031-lane-c-readiness": "npm run check:objc3c:m228-c030-lane-c-readiness &&',
        ),
    ),
    "c030_contract_doc": (
        (
    ...
    "c030_checker": (
        (
            "M228-C031-DEP-02",
            'MODE = "m228-c030-ir-emission-completeness-advanced-conformance-workpack-shard3-contract-v1"',
        ),
    ),
    "c030_tooling_test": (
        ("M228-C031-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c030_packet_doc": (
        ("M228-C031-DEP-04", "Packet: `M228-C030`"),
        ("M228-C031-DEP-05", "Issue: `#5256`"),
    ),
    "contract_doc": (
        (
            "M228-C031-DOC-01",
        ...
        ("M228-C031-DOC-02", "Execute issue `#5257`"),
        ("M228-C031-DOC-03", "Dependencies: `M228-C030`"),
        (
            "M228-C031-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        (
            "M228-C031-PKT-01",
            "# M228-C031 IR Emission Completeness Advanced Integration Workpack (Shard 3) Packet",
        ),
        ("M228-C031-PKT-02", "Packet: `M228-C031`"),
        ("M228-C031-PKT-03", "Issue: `#5257`"),
        ("M228-C031-PKT-04", "Dependencies: `M228-C030`"),
        (
            "M228-C031-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C031-FORB-01",
            '"check:objc3c:m228-c031-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C031/"
            "ir_emission_completeness_advanced_integration_workpack_shard3_contract_summary.json"
        ),
    )
