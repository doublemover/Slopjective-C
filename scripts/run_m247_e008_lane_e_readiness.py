...
BASELINE_DEPENDENCIES = ("M247-E007",)
PENDING_SEEDED_DEPENDENCY_TOKENS = ("M247-A008", "M247-B008", "M247-C008", "M247-D008")
...
def run_chain() -> int:
    ...
    print("[ok] M247-E008 lane-E readiness chain completed")
    return 0
