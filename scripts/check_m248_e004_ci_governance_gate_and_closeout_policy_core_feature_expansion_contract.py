#!/usr/bin/env python3
"""Fail-closed checker for M248-E004 lane-E CI governance gate/core closeout policy expansion."""
...
MODE = "m248-e004-lane-e-ci-governance-gate-closeout-policy-core-feature-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_lane_e_ci_governance_gate_and_closeout_policy_core_feature_expansion_e004_expectations.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-E004-DOC-EXP-01",
        "# M248 Lane E CI Governance Gate and Closeout Policy Core Feature Expansion Expectations (E004)",
    ),
    SnippetCheck(
        "M248-E004-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-ci-governance-gate-closeout-policy-core-feature-expansion/m248-e004-v1`",
    ),
    SnippetCheck("M248-E004-DOC-EXP-03", "Issue `#6864` defines canonical lane-E core feature expansion scope."),
    SnippetCheck(
        "M248-E004-DOC-EXP-04",
        "Dependencies: `M248-E003`, `M248-A004`, `M248-B004`, `M248-C004`, `M248-D004`",
    ),
    SnippetCheck(
        "M248-E004-DOC-EXP-05",
        "Fail closed unless M248 lane-E core feature expansion dependency anchors",
    ),
    SnippetCheck(
        "M248-E004-DOC-EXP-06",
        "Readiness command chain enforces E003 and lane A/B/C/D core-feature",
    ),
    SnippetCheck(
        "M248-E004-DOC-EXP-07",
        "expansion prerequisites before E004 evidence checks run.",
    ),
    SnippetCheck(
        "M248-E004-DOC-EXP-08",
        "`check:objc3c:m248-e004-ci-governance-gate-closeout-policy-core-feature-expansion-contract`",
    ),
    SnippetCheck("M248-E004-DOC-EXP-09", "`check:objc3c:m248-e004-lane-e-readiness`"),
    SnippetCheck("M248-E004-DOC-EXP-10", "`compile:objc3c`"),
    SnippetCheck("M248-E004-DOC-EXP-11", "`proof:objc3c`"),
    SnippetCheck("M248-E004-DOC-EXP-12", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M248-E004-DOC-EXP-13", "`test:objc3c:perf-budget`"),
    SnippetCheck(
        "M248-E004-DOC-EXP-14",
        "`tmp/reports/m248/M248-E004/lane_e_ci_governance_gate_closeout_policy_core_feature_expansion_summary.json`",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-E004-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M248-E004-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M248-E004-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M248-E004-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-E004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.package_json, "M248-E004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
