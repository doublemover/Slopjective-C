#!/usr/bin/env python3
"""Fail-closed contract checker for M249-E001 release gate/docs/runbooks freeze."""
...
MODE = "m249-e001-lane-e-release-gate-docs-runbooks-contract-architecture-freeze-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m249"
    / "m249_e001_lane_e_release_gate_docs_and_runbooks_contract_and_architecture_freeze_packet.md"
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-E001-META-02",
        "`M249-A001`, `M249-B001`, `M249-C001`, and `M249-D001`",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-E001-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M249-E001-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-E001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-E001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M249-E001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-E001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-E001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-E001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
