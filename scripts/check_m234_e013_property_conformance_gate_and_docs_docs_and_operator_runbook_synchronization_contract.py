#!/usr/bin/env python3
"""Fail-closed checker for M234-E013 property conformance gate and docs docs and operator runbook synchronization."""
...
MODE = "m234-e013-property-conformance-gate-docs-docs-and-operator-runbook-synchronization-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_property_conformance_gate_and_docs_docs_and_operator_runbook_synchronization_e013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_e013_property_conformance_gate_and_docs_docs_and_operator_runbook_synchronization_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-E013-DOC-PKT-01",
        "# M234-E013 Property Conformance Gate and Docs Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M234-E013-DOC-PKT-02", "Packet: `M234-E013`"),
    SnippetCheck("M234-E013-DOC-PKT-03", "Issue: `#5760`"),
    SnippetCheck(
        "M234-E013-DOC-PKT-04",
        "Dependencies: `M234-E012`, `M234-A013`, `M234-B014`, `M234-C014`, `M234-D010`",
    ),
    SnippetCheck("M234-E013-DOC-PKT-05", "Predecessor: `M234-E012`"),
    SnippetCheck("M234-E013-DOC-PKT-06", "Theme: docs and operator runbook synchronization"),
    SnippetCheck(
        "M234-E013-DOC-PKT-07",
        "docs/contracts/m234_property_conformance_gate_and_docs_docs_and_operator_runbook_synchronization_e013_expectations.md",
    ),
    SnippetCheck(
        "M234-E013-DOC-PKT-08",
        "scripts/check_m234_e013_property_conformance_gate_and_docs_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M234-E013-DOC-PKT-09",
        "tests/tooling/test_check_m234_e013_property_conformance_gate_and_docs_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M234-E013-DOC-PKT-10",
        "spec/planning/compiler/m234/m234_e012_property_conformance_gate_and_docs_cross_lane_integration_sync_packet.md",
    ),
    SnippetCheck(
        "M234-E013-DOC-PKT-11",
        "docs and operator runbook synchronization traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M234-E013-DOC-PKT-12",
        "tmp/reports/m234/M234-E013/property_conformance_gate_docs_docs_and_operator_runbook_synchronization_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-E013-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M234-E013-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M234-E013-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-E013-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-E013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-E013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M234-E013-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
