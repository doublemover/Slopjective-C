#!/usr/bin/env python3
"""Fail-closed checker for M244-D008 runtime/link bridge-path recovery and determinism hardening contract."""
...
MODE = "m244-d008-runtime-link-bridge-path-recovery-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_runtime_link_bridge_path_recovery_determinism_hardening_d008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_d008_runtime_link_bridge_path_recovery_determinism_hardening_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-D008-D007-01",
        "M244-D007",
        Path("docs/contracts/m244_runtime_link_bridge_path_diagnostics_hardening_d007_expectations.md"),
    ),
    AssetCheck(
        "M244-D008-D007-02",
        "M244-D007",
        Path("spec/planning/compiler/m244/m244_d007_runtime_link_bridge_path_diagnostics_hardening_packet.md"),
    ),
    AssetCheck(
        "M244-D008-D007-03",
        "M244-D007",
        Path("scripts/check_m244_d007_runtime_link_bridge_path_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M244-D008-D007-04",
        "M244-D007",
        Path("tests/tooling/test_check_m244_d007_runtime_link_bridge_path_diagnostics_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D008-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-bridge-path-recovery-determinism-hardening/m244-d008-v1`",
    ),
    SnippetCheck("M244-D008-DOC-EXP-02", "Dependencies: `M244-D007`"),
    SnippetCheck("M244-D008-DOC-EXP-03", "Issue `#6580` defines canonical lane-D recovery and determinism hardening scope."),
    SnippetCheck("M244-D008-DOC-EXP-04", "`check:objc3c:m244-d008-lane-d-readiness`"),
    SnippetCheck("M244-D008-DOC-EXP-05", "`check:objc3c:m244-d007-lane-d-readiness`"),
    SnippetCheck("M244-D008-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M244-D008-DOC-EXP-07",
        "tmp/reports/m244/M244-D008/runtime_link_bridge_path_recovery_determinism_hardening_contract_summary.json",
    ),
    SnippetCheck(
        "M244-D008-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-D008-DOC-PKT-01", "Packet: `M244-D008`"),
    SnippetCheck("M244-D008-DOC-PKT-02", "Issue: `#6580`"),
    SnippetCheck("M244-D008-DOC-PKT-03", "Dependencies: `M244-D007`"),
    SnippetCheck(
        "M244-D008-DOC-PKT-04",
        "`scripts/check_m244_d008_runtime_link_bridge_path_recovery_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M244-D008-DOC-PKT-05",
        "`tests/tooling/test_check_m244_d008_runtime_link_bridge_path_recovery_determinism_hardening_contract.py`",
    ),
    SnippetCheck("M244-D008-DOC-PKT-06", "`check:objc3c:m244-d008-lane-d-readiness`"),
    SnippetCheck(
        "M244-D008-DOC-PKT-07",
        "`python scripts/check_m244_d008_runtime_link_bridge_path_recovery_determinism_hardening_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M244-D008-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-D008-CFG-03", "check:objc3c:m244-d008-lane-d-readiness"),
    PackageScriptKeyCheck("M244-D008-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M244-D008-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M244-D008-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-D008-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-d007-lane-d-readiness && npm run check:objc3c:m244-d008-runtime-link-bridge-path-recovery-determinism-hardening-contract && npm run test:tooling:m244-d008-runtime-link-bridge-path-recovery-determinism-hardening-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D008-SPC-01",
        "runtime/link bridge-path recovery and determinism hardening governance shall preserve explicit lane-D dependency anchors (`M244-D007`)",
    ),
    SnippetCheck(
        "M244-D008-SPC-02",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-D008-META-02",
        "explicit `M244-D007` dependency continuity and fail-closed evidence continuity",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-D008-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-D008-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-D008-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-D008-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-D008-META-00",
