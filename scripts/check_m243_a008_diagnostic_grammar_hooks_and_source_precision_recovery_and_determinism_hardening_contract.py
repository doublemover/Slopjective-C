#!/usr/bin/env python3
"""Fail-closed checker for M243-A008 diagnostic grammar-hooks recovery/determinism hardening."""
...
MODE = (
    "m243-a008-diagnostic-grammar-hooks-and-source-precision-"
    "recovery-and-determinism-hardening-contract-v1"
)
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m243"
    / "m243_a008_diagnostic_grammar_hooks_and_source_precision_recovery_and_determinism_hardening_packet.md",
    "frontend_types": ROOT
    / "native"
    / "objc3c"
    / "src"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "packet_doc": (
        ("M243-A008-PKT-01", "Packet: `M243-A008`"),
        ("M243-A008-PKT-02", "Dependencies: `M243-A007`"),
        (
            "M243-A008-PKT-03",
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m243/M243-A008/"
            "diagnostic_grammar_hooks_and_source_precision_recovery_and_determinism_hardening_contract_summary.json"
        ),
    )
    parser.add_argument(
        "--emit-json",
