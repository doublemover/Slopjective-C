#!/usr/bin/env python3
"""Fail-closed checker for M234-D004 runtime property metadata integration core feature expansion."""
...
MODE = "m234-d004-runtime-property-metadata-integration-core-feature-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_runtime_property_metadata_integration_core_feature_expansion_d004_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_d004_runtime_property_metadata_integration_core_feature_expansion_packet.md"
)
...
DEFAULT_D003_CHECKER = (
    ROOT / "scripts" / "check_m234_d003_runtime_property_metadata_integration_core_feature_implementation_contract.py"
)
DEFAULT_D003_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m234_d003_runtime_property_metadata_integration_core_feature_implementation_contract.py"
)
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m234_d004_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-D004-DOC-PKT-01",
        "# M234-D004 Runtime Property Metadata Integration Core Feature Expansion Packet",
    ),
    SnippetCheck("M234-D004-DOC-PKT-02", "Packet: `M234-D004`"),
    SnippetCheck("M234-D004-DOC-PKT-03", "Dependencies: `M234-D003`"),
    SnippetCheck(
        "M234-D004-DOC-PKT-04",
        "scripts/check_m234_d004_runtime_property_metadata_integration_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M234-D004-DOC-PKT-05",
        "scripts/run_m234_d004_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M234-D004-DOC-PKT-06",
        "check:objc3c:m234-d003-lane-d-readiness",
    ),
    SnippetCheck(
        "M234-D004-DOC-PKT-07",
        "python scripts/run_m234_d004_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M234-D004-DOC-PKT-08",
        "code/spec anchors and milestone",
    ),
    SnippetCheck(
        "M234-D004-DOC-PKT-09",
...
D003_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-D004-D003-DOC-01",
        "Contract ID: `objc3c-runtime-property-metadata-integration-core-feature-implementation/m234-d003-v1`",
    ),
    SnippetCheck(
        "M234-D004-D003-DOC-02",
        "Dependencies: `M234-D002`",
    ),
)

D003_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-D004-D003-PKT-01", "Packet: `M234-D003`"),
    SnippetCheck("M234-D004-D003-PKT-02", "Dependencies: `M234-D002`"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-D004-RUN-01", '"""Run M234-D004 lane-D readiness checks without deep npm nesting."""'),
    SnippetCheck("M234-D004-RUN-02", 'NPM_EXECUTABLE = "npm.cmd" if sys.platform == "win32" else "npm"'),
    SnippetCheck("M234-D004-RUN-03", "check:objc3c:m234-d003-lane-d-readiness"),
    SnippetCheck(
        "M234-D004-RUN-04",
        "scripts/check_m234_d004_runtime_property_metadata_integration_core_feature_expansion_contract.py",
    ),
    ...
    SnippetCheck("M234-D004-RUN-06", "[ok] M234-D004 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-D004-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M234-D004-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M234-D004-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-D004-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-D004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-D004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d003_expectations_doc, "M234-D004-D003-DOC-EXISTS", D003_EXPECTATIONS_SNIPPETS),
        (args.d003_packet_doc, "M234-D004-D003-PKT-EXISTS", D003_PACKET_SNIPPETS),
        (args.readiness_runner, "M234-D004-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M234-D004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-D004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-D004-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-D004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d003_checker, "M234-D004-DEP-D003-ARG-01"),
        (args.d003_test, "M234-D004-DEP-D003-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
