#!/usr/bin/env python3
"""Fail-closed checker for M243-D013 CLI/reporting output docs/runbook synchronization."""
...
MODE = (
    "m243-d013-cli-reporting-output-contract-integration-"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "docs"
    / "contracts"
    / "m243_cli_reporting_and_output_contract_integration_docs_operator_runbook_synchronization_d013_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m243"
    / "m243_d013_cli_reporting_and_output_contract_integration_docs_operator_runbook_synchronization_packet.md",
    ...
    "d012_checker": ROOT
    / "scripts"
    / "check_m243_d012_cli_reporting_and_output_contract_integration_cross_lane_integration_sync_contract.py",
    "d012_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m243_d012_cli_reporting_and_output_contract_integration_cross_lane_integration_sync_contract.py",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "expectations_doc": (
        ...
        ("M243-D013-DOC-02", "- Dependencies: `M243-D012`"),
        ("M243-D013-DOC-03", "docs_runbook_sync_consistent"),
        ("M243-D013-DOC-04", "docs_runbook_sync_ready"),
        ("M243-D013-DOC-05", "docs_runbook_sync_key_ready"),
        (
            "M243-D013-DOC-06",
        ...
        ("M243-D013-DOC-10", "npm run check:objc3c:m243-d013-lane-d-readiness"),
        ("M243-D013-DOC-11", "Issue `#6477`"),
    ),
    "packet_doc": (
        ("M243-D013-PKT-01", "Packet: `M243-D013`"),
        ("M243-D013-PKT-02", "Dependencies: `M243-D012`"),
        (
            "M243-D013-PKT-03",
            "scripts/check_m243_d013_cli_reporting_and_output_contract_integration_docs_operator_runbook_synchronization_contract.py",
        ),
        ...
        ("M243-D013-PKT-05", "check:objc3c:m243-d013-lane-d-readiness"),
        (
            "M243-D013-PKT-06",
            "python scripts/check_m243_d013_cli_reporting_and_output_contract_integration_docs_operator_runbook_synchronization_contract.py --emit-json",
        ),
    ...
    "d012_packet_doc": (
        ("M243-D013-DEP-02", "Packet: `M243-D012`"),
        ("M243-D013-DEP-03", "Dependencies: `M243-D011`"),
    ),
    "d012_checker": (
        (
            "M243-D013-DEP-04",
    ...
    "d012_tooling_test": (
        (
            "M243-D013-DEP-05",
            "check_m243_d012_cli_reporting_and_output_contract_integration_cross_lane_integration_sync_contract",
        ),
    ),
    "architecture_doc": (
        (
    ...
    "package_json": (
        ...
        ("M243-D013-PKG-03", '"check:objc3c:m243-d013-lane-d-readiness"'),
        (
            "M243-D013-PKG-04",
            "npm run check:objc3c:m243-d012-lane-d-readiness && npm run check:objc3c:m243-d013-cli-reporting-output-contract-integration-docs-operator-runbook-synchronization-contract && npm run test:tooling:m243-d013-cli-reporting-output-contract-integration-docs-operator-runbook-synchronization-contract",
        ),
    ),
}
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M243-D013-FORB-01",
            '"check:objc3c:m243-d013-lane-d-readiness": "npm run check:objc3c:m243-d011-lane-d-readiness',
        ),
    ),
}
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact, path in ARTIFACTS.items():
        ...
        try:
            ...
            findings.append(Finding(artifact, f"M243-D013-MISSING-{artifact.upper()}", str(exc)))
            continue
