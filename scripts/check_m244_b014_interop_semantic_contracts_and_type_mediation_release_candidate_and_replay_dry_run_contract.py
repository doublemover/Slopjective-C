#!/usr/bin/env python3
"""Fail-closed checker for M244-B014 interop semantic/type mediation release-candidate/replay dry-run contract."""
...
MODE = "m244-b014-interop-semantic-contracts-and-type-mediation-release-candidate-and-replay-dry-run-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_semantic_contracts_and_type_mediation_release_candidate_and_replay_dry_run_b014_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_b014_interop_semantic_contracts_and_type_mediation_release_candidate_and_replay_dry_run_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B014/"
    "interop_semantic_contracts_and_type_mediation_release_candidate_and_replay_dry_run_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B014-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-release-candidate-and-replay-dry-run/m244-b014-v1`",
    ),
    SnippetCheck("M244-B014-DOC-EXP-02", "Dependencies: `M244-B013`"),
    SnippetCheck(
        "M244-B014-DOC-EXP-03",
        "Issue `#6544` defines canonical lane-B release-candidate and replay dry-run scope.",
    ),
    SnippetCheck(
        "M244-B014-DOC-EXP-04",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck("M244-B014-DOC-EXP-05", "`check:objc3c:m244-b014-lane-b-readiness`"),
    SnippetCheck("M244-B014-DOC-EXP-06", "`compile:objc3c`"),
    SnippetCheck("M244-B014-DOC-EXP-07", "`proof:objc3c`"),
    SnippetCheck("M244-B014-DOC-EXP-08", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M244-B014-DOC-EXP-09", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B014-DOC-PKT-01", "Packet: `M244-B014`"),
    SnippetCheck("M244-B014-DOC-PKT-02", "Issue: `#6544`"),
    SnippetCheck("M244-B014-DOC-PKT-03", "Dependencies: `M244-B013`"),
    SnippetCheck(
        "M244-B014-DOC-PKT-04",
        "`scripts/check_m244_b014_interop_semantic_contracts_and_type_mediation_release_candidate_and_replay_dry_run_contract.py`",
    ),
    SnippetCheck(
        "M244-B014-DOC-PKT-05",
    ...
    SnippetCheck("M244-B014-DOC-PKT-06", "`compile:objc3c`"),
    SnippetCheck("M244-B014-DOC-PKT-07", "`proof:objc3c`"),
    SnippetCheck("M244-B014-DOC-PKT-08", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M244-B014-DOC-PKT-09", "`test:objc3c:perf-budget`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B014-CFG-03", "check:objc3c:m244-b014-lane-b-readiness"),
    PackageScriptKeyCheck("M244-B014-CFG-04", "compile:objc3c"),
    PackageScriptKeyCheck("M244-B014-CFG-05", "proof:objc3c"),
    PackageScriptKeyCheck("M244-B014-CFG-06", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-B014-CFG-07", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b013-lane-b-readiness && npm run check:objc3c:m244-b014-interop-semantic-contracts-type-mediation-release-candidate-and-replay-dry-run-contract && npm run test:tooling:m244-b014-interop-semantic-contracts-type-mediation-release-candidate-and-replay-dry-run-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B014-ARCH-01",
        "M244 lane-B B014 interop semantic/type mediation release-candidate and replay dry-run anchors",
    ),
    SnippetCheck(
        "M244-B014-ARCH-02",
        "`M244-B013` dependency continuity and release-candidate/replay dry-run evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B014-SPC-01",
        "interop semantic/type mediation release-candidate and replay dry-run governance shall preserve explicit",
    ),
    SnippetCheck("M244-B014-SPC-02", "lane-B dependency anchor (`M244-B013`)"),
)

METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B014-META-01",
        "deterministic lane-B interop semantic/type mediation release-candidate/replay dry-run metadata anchors for `M244-B014`",
    ),
    SnippetCheck(
        "M244-B014-META-02",
        "with explicit `M244-B013` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B014-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B014-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-B014-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-B014-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-B014-META-00",
