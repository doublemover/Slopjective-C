#!/usr/bin/env python3
"""Fail-closed validator for M227-A016 semantic pass advanced edge-compatibility shard1 contract."""
...
MODE = "m227-semantic-pass-advanced-edge-compatibility-workpack-shard1-contract-a016-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "docs"
    / "contracts"
    / "m227_semantic_pass_advanced_edge_compatibility_workpack_shard1_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m227"
    / "m227_a016_semantic_pass_advanced_edge_compatibility_workpack_shard1_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        ...
        ("M227-A016-DOC-02", "Dependencies: `M227-A015`"),
        ("M227-A016-DOC-03", "toolchain_runtime_ga_operations_advanced_edge_compatibility_consistent"),
        ("M227-A016-DOC-04", "toolchain_runtime_ga_operations_advanced_edge_compatibility_ready"),
        ("M227-A016-DOC-05", "toolchain_runtime_ga_operations_advanced_edge_compatibility_key"),
        (
            "M227-A016-DOC-06",
            "scripts/check_m227_a016_semantic_pass_advanced_edge_compatibility_workpack_shard1_contract.py",
        ),
        (
            "M227-A016-DOC-07",
            "tests/tooling/test_check_m227_a016_semantic_pass_advanced_edge_compatibility_workpack_shard1_contract.py",
        ),
        ("M227-A016-DOC-08", "npm run check:objc3c:m227-a016-lane-a-readiness"),
    ),
    "packet_doc": (
        ("M227-A016-PKT-01", "Packet: `M227-A016`"),
        ("M227-A016-PKT-02", "Dependencies: `M227-A015`"),
        ("M227-A016-PKT-03", "objc3_parse_lowering_readiness_surface.h"),
        (
            "M227-A016-PKT-04",
            "scripts/check_m227_a016_semantic_pass_advanced_edge_compatibility_workpack_shard1_contract.py",
        ),
    ...
    "parse_surface": (
        ("M227-A016-SUR-01", "IsObjc3ToolchainRuntimeGaOperationsAdvancedEdgeCompatibilityConsistent("),
        ("M227-A016-SUR-02", "IsObjc3ToolchainRuntimeGaOperationsAdvancedEdgeCompatibilityReady("),
        ("M227-A016-SUR-03", "BuildObjc3ToolchainRuntimeGaOperationsAdvancedEdgeCompatibilityKey("),
        (
            "M227-A016-SUR-04",
    ...
    "runbook": (
        ...
        ("M227-A016-RBK-04", "npm run check:objc3c:m227-a016-lane-a-readiness"),
    ),
    "package_json": (
        (
            "M227-A016-CFG-01",
            '"check:objc3c:m227-a016-semantic-pass-advanced-edge-compatibility-workpack-shard1-contract"',
        ),
        (
            "M227-A016-CFG-02",
            '"test:tooling:m227-a016-semantic-pass-advanced-edge-compatibility-workpack-shard1-contract"',
        ),
        ("M227-A016-CFG-03", '"check:objc3c:m227-a016-lane-a-readiness"'),
        ("M227-A016-CFG-04", "check:objc3c:m227-a015-lane-a-readiness"),
    ),
    "architecture_doc": (
        (
            "M227-A016-ARC-01",
    ...
    "metadata_spec": (
        (
            "M227-A016-META-01",
            "deterministic lane-A semantic-pass advanced edge compatibility workpack (shard 1) metadata anchors for `M227-A016`",
        ),
    ),
}
