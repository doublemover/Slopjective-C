#!/usr/bin/env python3
"""Fail-closed validator for M243-C003 lowering/runtime diagnostics surfacing core feature implementation."""
...
MODE = "m243-lowering-runtime-diagnostics-surfacing-core-feature-implementation-contract-c003-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "src"
    / "pipeline"
    / "objc3_lowering_runtime_diagnostics_surfacing_core_feature_implementation_surface.h",
    ...
    / "compiler"
    / "m243"
    / "m243_c003_lowering_runtime_diagnostics_surfacing_core_feature_implementation_packet.md",
    "package_json": ROOT / "package.json",
}

REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "frontend_types": (
        ("M243-C003-TYP-01", "struct Objc3LoweringRuntimeDiagnosticsSurfacingCoreFeatureImplementationSurface {"),
        ("M243-C003-TYP-02", "bool core_feature_impl_ready = false;"),
        ("M243-C003-TYP-03", "Objc3LoweringRuntimeDiagnosticsSurfacingCoreFeatureImplementationSurface"),
        ("M243-C003-TYP-04", "lowering_runtime_diagnostics_surfacing_core_feature_implementation_surface;"),
    ),
    "core_surface_header": (
        (
            "M243-C003-SUR-01",
        ...
        ("M243-C003-SUR-03", "surface.diagnostics_hardening_consistent ="),
        ("M243-C003-SUR-04", "surface.replay_keys_ready ="),
        ("M243-C003-SUR-05", "surface.core_feature_impl_ready ="),
        (
            "M243-C003-SUR-06",
    ...
    "frontend_artifacts_source": (
        ...
        (
            "M243-C003-ART-03",
            "lowering/runtime diagnostics surfacing core feature check failed: ",
        ),
        ("M243-C003-ART-04", '"O3L321"'),
    ),
    "c001_contract_doc": (
        (
            "M243-C003-DEP-01",
    ...
    "contract_doc": (
        ...
        ("M243-C003-DOC-05", "npm run check:objc3c:m243-c003-lane-c-readiness"),
        (
            "M243-C003-DOC-06",
    ...
    "packet_doc": (
        ("M243-C003-PKT-01", "Packet: `M243-C003`"),
        ("M243-C003-PKT-02", "Lane: `C`"),
        ("M243-C003-PKT-03", "Dependencies: `M243-C001`, `M243-C002`"),
        (
            "M243-C003-PKT-04",
    ...
    "package_json": (
        (
            "M243-C003-CFG-01",
            '"check:objc3c:m243-c003-lowering-runtime-diagnostics-surfacing-core-feature-implementation-contract"',
        ),
        (
            "M243-C003-CFG-02",
            '"test:tooling:m243-c003-lowering-runtime-diagnostics-surfacing-core-feature-implementation-contract"',
        ),
        ("M243-C003-CFG-03", '"check:objc3c:m243-c003-lane-c-readiness"'),
    ),
}

FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "core_surface_header": (
        ("M243-C003-FORB-01", "surface.core_feature_impl_ready = true;"),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m243/M243-C003/"
            "lowering_runtime_diagnostics_surfacing_core_feature_implementation_contract_summary.json"
        ),
    )
