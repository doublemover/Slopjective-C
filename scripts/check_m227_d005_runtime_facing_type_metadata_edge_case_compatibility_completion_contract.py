#!/usr/bin/env python3
"""Fail-closed validator for M227-D005 runtime-facing type metadata edge-case compatibility completion."""
...
MODE = "m227-d005-runtime-facing-type-metadata-edge-case-compatibility-completion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_runtime_facing_type_metadata_edge_case_compatibility_completion_d005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_d005_runtime_facing_type_metadata_edge_case_compatibility_completion_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-D005-D004-01",
        "M227-D004",
        Path("docs/contracts/m227_runtime_facing_type_metadata_core_feature_expansion_d004_expectations.md"),
    ),
    AssetCheck(
        "M227-D005-D004-02",
        "M227-D004",
        Path("scripts/check_m227_d004_runtime_facing_type_metadata_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M227-D005-D004-03",
        "M227-D004",
        Path("tests/tooling/test_check_m227_d004_runtime_facing_type_metadata_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M227-D005-D004-04",
        "M227-D004",
        Path("spec/planning/compiler/m227/m227_d004_runtime_facing_type_metadata_core_feature_expansion_packet.md"),
    ),
    AssetCheck(
        "M227-D005-A005-01",
        "M227-A005",
        Path("docs/contracts/m227_semantic_pass_edge_compat_completion_expectations.md"),
    ),
    AssetCheck(
        "M227-D005-A005-02",
        "M227-A005",
        Path("scripts/check_m227_a005_semantic_pass_edge_compat_completion_contract.py"),
    ),
    AssetCheck(
        "M227-D005-A005-03",
        "M227-A005",
        Path("tests/tooling/test_check_m227_a005_semantic_pass_edge_compat_completion_contract.py"),
    ),
    AssetCheck(
        "M227-D005-A005-04",
        "M227-A005",
        Path("spec/planning/compiler/m227/m227_a005_semantic_pass_edge_compat_completion_packet.md"),
    ),
    AssetCheck(
        "M227-D005-B005-01",
        "M227-B005",
        Path("docs/contracts/m227_type_system_objc3_forms_edge_compat_b005_expectations.md"),
    ),
    AssetCheck(
        "M227-D005-B005-02",
        "M227-B005",
        Path("scripts/check_m227_b005_type_system_objc3_forms_edge_compat_contract.py"),
    ),
    AssetCheck(
        "M227-D005-B005-03",
        "M227-B005",
        Path("tests/tooling/test_check_m227_b005_type_system_objc3_forms_edge_compat_contract.py"),
    ),
    AssetCheck(
        "M227-D005-B005-04",
        "M227-B005",
        Path("spec/planning/compiler/m227/m227_b005_type_system_objc3_forms_edge_compat_packet.md"),
    ),
    AssetCheck(
        "M227-D005-C005-01",
        "M227-C005",
        Path("docs/contracts/m227_typed_sema_to_lowering_edge_case_compatibility_completion_c005_expectations.md"),
    ),
    AssetCheck(
        "M227-D005-C005-02",
        "M227-C005",
        Path("scripts/check_m227_c005_typed_sema_to_lowering_edge_case_compatibility_completion_contract.py"),
    ),
    AssetCheck(
        "M227-D005-C005-03",
        "M227-C005",
        Path("tests/tooling/test_check_m227_c005_typed_sema_to_lowering_edge_case_compatibility_completion_contract.py"),
    ),
    AssetCheck(
        "M227-D005-C005-04",
        "M227-C005",
        Path("spec/planning/compiler/m227/m227_c005_typed_sema_to_lowering_edge_case_compatibility_completion_packet.md"),
    ),
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-D005-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-D005-EXP-08",
        "checker `scripts/check_m227_d004_runtime_facing_type_metadata_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M227-D005-EXP-09",
    ...
    SnippetCheck(
        "M227-D005-EXP-11",
        "checker `scripts/check_m227_c005_typed_sema_to_lowering_edge_case_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M227-D005-EXP-12",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-D005-PKT-04", "Packet: `M227-D005`"),
    SnippetCheck("M227-D005-PKT-05", "Issue: `#5151`"),
    SnippetCheck("M227-D005-PKT-06", "Scaffold date: `2026-03-03`"),
    SnippetCheck(
        "M227-D005-PKT-07",
        "Dependencies: `M227-D004`, `M227-A005`, `M227-B005`, `M227-C005`",
    ),
    SnippetCheck("M227-D005-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-D005-PKT-09",
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-D004": "scripts/check_m227_d004_runtime_facing_type_metadata_core_feature_expansion_contract.py",
    "M227-A005": "scripts/check_m227_a005_semantic_pass_edge_compat_completion_contract.py",
    "M227-B005": "scripts/check_m227_b005_type_system_objc3_forms_edge_compat_contract.py",
    "M227-C005": "scripts/check_m227_c005_typed_sema_to_lowering_edge_case_compatibility_completion_contract.py",
}
...
def run(argv: Sequence[str]) -> int:
    ...
    try:
        ...
        check(
            ...
            check_id="M227-D005-EXP-01",
            condition=True,
            detail="",
        )
        check(
            artifact="expectations_doc",
            check_id="M227-D005-EXP-02",
            condition=True,
            detail="",
        )
    ...
    try:
        ...
        check(
            artifact="packet_doc",
            check_id="M227-D005-PKT-01",
            condition=True,
            detail="",
        )
        check(
            artifact="packet_doc",
            check_id="M227-D005-PKT-02",
            condition=True,
            detail="",
        )
    except ValueError as exc:
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-D005-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if findings:
        print(
            "m227-d005-runtime-facing-type-metadata-edge-case-compatibility-completion: "
    ...
    print("m227-d005-runtime-facing-type-metadata-edge-case-compatibility-completion: OK")
    print(f"- mode={MODE}")
