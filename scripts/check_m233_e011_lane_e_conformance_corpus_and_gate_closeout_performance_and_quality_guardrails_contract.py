#!/usr/bin/env python3
"""Fail-closed checker for M233-E011 conformance corpus and gate closeout performance and quality guardrails."""
...
MODE = "m233-e011-lane-e-conformance-corpus-gate-closeout-performance-and-quality-guardrails-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_lane_e_conformance_corpus_and_gate_closeout_performance_and_quality_guardrails_e011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_e011_lane_e_conformance_corpus_and_gate_closeout_performance_and_quality_guardrails_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M233-E011-DEP-E010-01",
        Path("docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_e010_expectations.md"),
    ),
    AssetCheck(
        "M233-E011-DEP-E010-02",
        Path("spec/planning/compiler/m233/m233_e010_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_packet.md"),
    ),
    AssetCheck(
        "M233-E011-DEP-E010-03",
        Path("scripts/check_m233_e010_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_contract.py"),
    ),
    AssetCheck(
        "M233-E011-DEP-E010-04",
        Path("tests/tooling/test_check_m233_e010_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E011-DOC-EXP-01",
        "# M233 Lane E Conformance Corpus and Gate Closeout Performance and Quality Guardrails Expectations (E011)",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-conformance-corpus-gate-closeout-performance-and-quality-guardrails/m233-e011-v1`",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-03",
        "Issue `#5664` defines canonical lane-E performance and quality guardrails scope.",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-04",
        "Dependencies: `M233-E010`, `M233-A008`, `M233-B011`, `M233-C014`, `M233-D018`",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-05",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_e010_expectations.md",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-06",
        "`M233-A008`",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-07",
        "`M233-B011`",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-08",
        "`M233-C014`",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-09",
        "`M233-D018`",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-10",
        "performance and quality guardrails traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-11",
        "Predecessor anchor: `M233-E010` conformance corpus expansion continuity is the mandatory baseline for E011.",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-12",
        "`scripts/check_m233_e011_lane_e_conformance_corpus_and_gate_closeout_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M233-E011-DOC-EXP-13",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E011-DOC-PKT-01",
        "# M233-E011 Lane-E Conformance Corpus and Gate Closeout Performance and Quality Guardrails Packet",
    ),
    SnippetCheck("M233-E011-DOC-PKT-02", "Packet: `M233-E011`"),
    SnippetCheck("M233-E011-DOC-PKT-03", "Issue: `#5664`"),
    SnippetCheck(
        "M233-E011-DOC-PKT-04",
        "Dependencies: `M233-E010`, `M233-A008`, `M233-B011`, `M233-C014`, `M233-D018`",
    ),
    SnippetCheck("M233-E011-DOC-PKT-05", "Predecessor: `M233-E010`"),
    SnippetCheck("M233-E011-DOC-PKT-06", "Theme: performance and quality guardrails"),
    SnippetCheck(
        "M233-E011-DOC-PKT-07",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_performance_and_quality_guardrails_e011_expectations.md",
    ),
    SnippetCheck(
        "M233-E011-DOC-PKT-08",
        "scripts/check_m233_e011_lane_e_conformance_corpus_and_gate_closeout_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M233-E011-DOC-PKT-09",
        "tests/tooling/test_check_m233_e011_lane_e_conformance_corpus_and_gate_closeout_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M233-E011-DOC-PKT-10",
        "spec/planning/compiler/m233/m233_e010_lane_e_conformance_corpus_and_gate_closeout_conformance_corpus_expansion_packet.md",
    ),
    SnippetCheck(
        "M233-E011-DOC-PKT-11",
        "performance and quality guardrails traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E011-DOC-PKT-12",
        "tmp/reports/m233/M233-E011/lane_e_conformance_corpus_gate_closeout_performance_and_quality_guardrails_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-E011-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M233-E011-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M233-E011-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-E011-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-E011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-E011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M233-E011-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
