...
from .constants import (
    ...
    SANITIZER_VALIDATION_CHECK,
    SANITIZER_VALIDATION_SUMMARY,
    LANGUAGE_RUNTIME_THREAT_MODEL_CHECK,
...
REQUIRED_REPORTS = {
    ...
    "sanitizer_validation": (SANITIZER_VALIDATION_SUMMARY, SANITIZER_VALIDATION_CHECK),
    "language_runtime_threat_model": (
        LANGUAGE_RUNTIME_THREAT_MODEL_SUMMARY,
        LANGUAGE_RUNTIME_THREAT_MODEL_CHECK,
    ),
}
