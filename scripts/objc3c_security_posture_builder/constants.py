...
SANITIZER_VALIDATION_CHECK = ROOT / "scripts" / "check_security_sanitizer_validation.py"
LANGUAGE_RUNTIME_THREAT_MODEL_CHECK = ROOT / "scripts" / "check_security_language_runtime_threat_model.py"
