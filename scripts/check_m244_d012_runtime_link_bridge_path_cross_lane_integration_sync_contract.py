#!/usr/bin/env python3
"""Fail-closed checker for M244-D012 runtime/link bridge-path cross-lane integration sync contract."""
...
MODE = "m244-d012-runtime-link-bridge-path-cross-lane-integration-sync-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_runtime_link_bridge_path_cross_lane_integration_sync_d012_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_d012_runtime_link_bridge_path_cross_lane_integration_sync_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-D012-D011-01",
        "M244-D011",
        Path("docs/contracts/m244_runtime_link_bridge_path_performance_and_quality_guardrails_d011_expectations.md"),
    ),
    AssetCheck(
        "M244-D012-D011-02",
        "M244-D011",
        Path("spec/planning/compiler/m244/m244_d011_runtime_link_bridge_path_performance_and_quality_guardrails_packet.md"),
    ),
    AssetCheck(
        "M244-D012-D011-03",
        "M244-D011",
        Path("scripts/check_m244_d011_runtime_link_bridge_path_performance_and_quality_guardrails_contract.py"),
    ),
    AssetCheck(
        "M244-D012-D011-04",
        "M244-D011",
        Path("tests/tooling/test_check_m244_d011_runtime_link_bridge_path_performance_and_quality_guardrails_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D012-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-bridge-path-cross-lane-integration-sync/m244-d012-v1`",
    ),
    SnippetCheck("M244-D012-DOC-EXP-02", "Dependencies: `M244-D011`"),
    SnippetCheck("M244-D012-DOC-EXP-03", "Issue `#6584` defines canonical lane-D cross-lane integration sync scope."),
    SnippetCheck("M244-D012-DOC-EXP-04", "`check:objc3c:m244-d012-lane-d-readiness`"),
    SnippetCheck("M244-D012-DOC-EXP-05", "`check:objc3c:m244-d011-lane-d-readiness`"),
    SnippetCheck("M244-D012-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M244-D012-DOC-EXP-07",
        "tmp/reports/m244/M244-D012/runtime_link_bridge_path_cross_lane_integration_sync_contract_summary.json",
    ),
    SnippetCheck(
        "M244-D012-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-D012-DOC-PKT-01", "Packet: `M244-D012`"),
    SnippetCheck("M244-D012-DOC-PKT-02", "Issue: `#6584`"),
    SnippetCheck("M244-D012-DOC-PKT-03", "Dependencies: `M244-D011`"),
    SnippetCheck(
        "M244-D012-DOC-PKT-04",
        "`scripts/check_m244_d012_runtime_link_bridge_path_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M244-D012-DOC-PKT-05",
        "`tests/tooling/test_check_m244_d012_runtime_link_bridge_path_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck("M244-D012-DOC-PKT-06", "`check:objc3c:m244-d012-lane-d-readiness`"),
    SnippetCheck(
        "M244-D012-DOC-PKT-07",
        "`python scripts/check_m244_d012_runtime_link_bridge_path_cross_lane_integration_sync_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M244-D012-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-D012-CFG-03", "check:objc3c:m244-d012-lane-d-readiness"),
    PackageScriptKeyCheck("M244-D012-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M244-D012-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M244-D012-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-D012-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-d011-lane-d-readiness && npm run check:objc3c:m244-d012-runtime-link-bridge-path-cross-lane-integration-sync-contract && npm run test:tooling:m244-d012-runtime-link-bridge-path-cross-lane-integration-sync-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-D012-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-D012-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-D012-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-D012-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-D012-META-00",
