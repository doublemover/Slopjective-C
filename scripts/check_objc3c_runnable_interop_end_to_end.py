...
def main() -> int:
    ...
    compile_probe(clangxx, packaging_probe, packaging_probe_exe, cwd=package_root, runtime_library=runtime_library)
    ...
    compile_probe(clangxx, bridge_probe, bridge_probe_exe, cwd=package_root, runtime_library=runtime_library)
