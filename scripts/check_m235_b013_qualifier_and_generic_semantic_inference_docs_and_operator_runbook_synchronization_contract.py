#!/usr/bin/env python3
"""Fail-closed checker for M235-B013 qualifier/generic semantic inference docs/operator runbook synchronization."""
...
MODE = "m235-b013-qualifier-and-generic-semantic-inference-docs-and-operator-runbook-synchronization-contract-v1"
...
DEFAULT_B012_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m235_b012_qualifier_and_generic_semantic_inference_cross_lane_integration_sync_contract.py"
)
...
B012_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-B013-B012-DOC-01",
        "# M235 Qualifier/Generic Semantic Inference Cross-Lane Integration Sync Expectations (B012)",
    ),
    SnippetCheck(
        "M235-B013-B012-DOC-02",
        "Contract ID: `objc3c-qualifier-and-generic-semantic-inference-cross-lane-integration-sync/m235-b012-v1`",
    ),
    SnippetCheck("M235-B013-B012-DOC-03", "Dependencies: `M235-B011`"),
)

B012_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B013-B012-PKT-01", "Packet: `M235-B012`"),
    SnippetCheck("M235-B013-B012-PKT-02", "Issue: `#5792`"),
    SnippetCheck("M235-B013-B012-PKT-03", "Dependencies: `M235-B011`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B013-META-02",
        "explicit `M235-B012` dependency continuity so docs and operator runbook synchronization drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-B013-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M235-B013-PKG-05", '"test:objc3c:perf-budget": '),
    SnippetCheck("M235-B013-PKG-06", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B013-PKG-07", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b012_expectations_doc, "M235-B013-B012-DOC-EXISTS", B012_EXPECTATIONS_SNIPPETS),
        (args.b012_packet_doc, "M235-B013-B012-PKT-EXISTS", B012_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B013-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B013-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B013-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B013-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b012_checker, "M235-B013-DEP-B012-ARG-01"),
        (args.b012_test, "M235-B013-DEP-B012-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
