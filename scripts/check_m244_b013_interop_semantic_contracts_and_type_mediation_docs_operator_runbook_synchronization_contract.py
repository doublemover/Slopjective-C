#!/usr/bin/env python3
"""Fail-closed checker for M244-B013 interop semantic/type mediation docs/runbook synchronization contract."""
...
MODE = "m244-b013-interop-semantic-contracts-and-type-mediation-docs-operator-runbook-synchronization-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_semantic_contracts_and_type_mediation_docs_operator_runbook_synchronization_b013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_b013_interop_semantic_contracts_and_type_mediation_docs_operator_runbook_synchronization_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B013/"
    "interop_semantic_contracts_and_type_mediation_docs_operator_runbook_synchronization_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B013-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-docs-operator-runbook-synchronization/m244-b013-v1`",
    ),
    SnippetCheck("M244-B013-DOC-EXP-02", "Dependencies: `M244-B012`"),
    SnippetCheck(
        "M244-B013-DOC-EXP-03",
        "Issue `#6543` defines canonical lane-B docs and operator runbook synchronization scope.",
    ),
    SnippetCheck(
        "M244-B013-DOC-EXP-04",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck("M244-B013-DOC-EXP-05", "`check:objc3c:m244-b013-lane-b-readiness`"),
    SnippetCheck("M244-B013-DOC-EXP-06", "`test:objc3c:sema-pass-manager-diagnostics-bus`"),
    SnippetCheck("M244-B013-DOC-EXP-07", "`test:objc3c:lowering-regression`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B013-DOC-PKT-01", "Packet: `M244-B013`"),
    SnippetCheck("M244-B013-DOC-PKT-02", "Issue: `#6543`"),
    SnippetCheck("M244-B013-DOC-PKT-03", "Dependencies: `M244-B012`"),
    SnippetCheck(
        "M244-B013-DOC-PKT-04",
        "`scripts/check_m244_b013_interop_semantic_contracts_and_type_mediation_docs_operator_runbook_synchronization_contract.py`",
    ),
    SnippetCheck(
        "M244-B013-DOC-PKT-05",
    ...
    SnippetCheck("M244-B013-DOC-PKT-06", "`test:objc3c:sema-pass-manager-diagnostics-bus`"),
    SnippetCheck("M244-B013-DOC-PKT-07", "`test:objc3c:lowering-regression`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B013-CFG-03", "check:objc3c:m244-b013-lane-b-readiness"),
    PackageScriptKeyCheck("M244-B013-CFG-04", "test:objc3c:sema-pass-manager-diagnostics-bus"),
    PackageScriptKeyCheck("M244-B013-CFG-05", "test:objc3c:lowering-regression"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b012-lane-b-readiness && npm run check:objc3c:m244-b013-interop-semantic-contracts-type-mediation-docs-operator-runbook-synchronization-contract && npm run test:tooling:m244-b013-interop-semantic-contracts-type-mediation-docs-operator-runbook-synchronization-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-B013-ARCH-02",
        "`M244-B012` dependency continuity and docs/runbook synchronization evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B013-SPC-02", "lane-B dependency anchor (`M244-B012`)"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B013-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B013-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-B013-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-B013-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-B013-META-00",
