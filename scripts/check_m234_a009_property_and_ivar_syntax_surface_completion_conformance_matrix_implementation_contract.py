#!/usr/bin/env python3
"""Fail-closed checker for M234-A009 property and ivar syntax surface completion conformance matrix implementation."""
...
MODE = "m234-a009-property-and-ivar-syntax-surface-completion-conformance-matrix-implementation-contract-v1"
...
DEFAULT_A008_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m234_property_and_ivar_syntax_surface_completion_recovery_and_determinism_hardening_a008_expectations.md"
)
DEFAULT_A008_PACKET_DOC = (
    ...
    / "compiler"
    / "m234"
    / "m234_a008_property_and_ivar_syntax_surface_completion_recovery_and_determinism_hardening_packet.md"
)
DEFAULT_A008_CHECKER = (
    ROOT / "scripts" / "check_m234_a008_property_and_ivar_syntax_surface_completion_recovery_and_determinism_hardening_contract.py"
)
DEFAULT_A008_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_a008_property_and_ivar_syntax_surface_completion_recovery_and_determinism_hardening_contract.py"
)
...
A008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-A009-A008-PKT-01", "Packet: `M234-A008`"),
    SnippetCheck("M234-A009-A008-PKT-02", "Dependencies: `M234-A007`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A009-META-02",
        "explicit `M234-A008` dependency continuity so conformance matrix implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A009-PKG-03",
        '"check:objc3c:m234-a009-lane-a-readiness": '
        '"npm run check:objc3c:m234-a008-lane-a-readiness '
        '&& npm run check:objc3c:m234-a009-property-and-ivar-syntax-surface-completion-conformance-matrix-implementation-contract '
        '&& npm run test:tooling:m234-a009-property-and-ivar-syntax-surface-completion-conformance-matrix-implementation-contract"',
    ),
    SnippetCheck("M234-A009-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M234-A009-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-A009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-A009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a008_expectations_doc, "M234-A009-A008-DOC-EXISTS", A008_EXPECTATIONS_SNIPPETS),
        (args.a008_packet_doc, "M234-A009-A008-PKT-EXISTS", A008_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-A009-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-A009-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-A009-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-A009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a008_checker, "M234-A009-DEP-A008-ARG-01"),
        (args.a008_test, "M234-A009-DEP-A008-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
