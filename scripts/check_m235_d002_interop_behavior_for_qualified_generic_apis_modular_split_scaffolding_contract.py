#!/usr/bin/env python3
"""Fail-closed checker for M235-D002 interop behavior modular split/scaffolding."""
...
MODE = "m235-d002-interop-behavior-for-qualified-generic-apis-modular-split-scaffolding-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_interop_behavior_for_qualified_generic_apis_modular_split_scaffolding_d002_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_d002_interop_behavior_for_qualified_generic_apis_modular_split_scaffolding_packet.md"
)
DEFAULT_D001_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_interop_behavior_for_qualified_generic_apis_contract_and_architecture_freeze_d001_expectations.md"
)
DEFAULT_D001_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_d001_interop_behavior_for_qualified_generic_apis_contract_and_architecture_freeze_packet.md"
)
DEFAULT_D001_CHECKER = ROOT / "scripts" / "check_m235_d001_interop_behavior_for_qualified_generic_apis_contract.py"
DEFAULT_D001_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_d001_interop_behavior_for_qualified_generic_apis_contract.py"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m235-d001-interop-behavior-for-qualified-generic-apis-contract '
        '&& npm run test:tooling:m235-d001-interop-behavior-for-qualified-generic-apis-contract"',
    ),
    SnippetCheck("M235-D002-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M235-D002-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M235-D002-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-D002-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-D002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-D002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d001_expectations_doc, "M235-D002-D001-DOC-EXISTS", D001_EXPECTATIONS_SNIPPETS),
        (args.d001_packet_doc, "M235-D002-D001-PKT-EXISTS", D001_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-D002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-D002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-D002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-D002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d001_checker, "M235-D002-DEP-D001-ARG-01"),
        (args.d001_test, "M235-D002-DEP-D001-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
