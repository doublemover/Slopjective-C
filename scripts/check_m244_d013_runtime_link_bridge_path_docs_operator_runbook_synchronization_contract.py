#!/usr/bin/env python3
"""Fail-closed checker for M244-D013 runtime/link bridge-path docs and operator runbook synchronization contract."""
...
MODE = "m244-d013-runtime-link-bridge-path-docs-operator-runbook-synchronization-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_runtime_link_bridge_path_docs_operator_runbook_synchronization_d013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_d013_runtime_link_bridge_path_docs_operator_runbook_synchronization_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-D013-D012-01",
        "M244-D012",
        Path("docs/contracts/m244_runtime_link_bridge_path_cross_lane_integration_sync_d012_expectations.md"),
    ),
    AssetCheck(
        "M244-D013-D012-02",
        "M244-D012",
        Path("spec/planning/compiler/m244/m244_d012_runtime_link_bridge_path_cross_lane_integration_sync_packet.md"),
    ),
    AssetCheck(
        "M244-D013-D012-03",
        "M244-D012",
        Path("scripts/check_m244_d012_runtime_link_bridge_path_cross_lane_integration_sync_contract.py"),
    ),
    AssetCheck(
        "M244-D013-D012-04",
        "M244-D012",
        Path("tests/tooling/test_check_m244_d012_runtime_link_bridge_path_cross_lane_integration_sync_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D013-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-bridge-path-docs-operator-runbook-synchronization/m244-d013-v1`",
    ),
    SnippetCheck("M244-D013-DOC-EXP-02", "Dependencies: `M244-D012`"),
    SnippetCheck("M244-D013-DOC-EXP-03", "Issue `#6585` defines canonical lane-D docs and operator runbook synchronization scope."),
    SnippetCheck("M244-D013-DOC-EXP-04", "`check:objc3c:m244-d013-lane-d-readiness`"),
    SnippetCheck("M244-D013-DOC-EXP-05", "`check:objc3c:m244-d012-lane-d-readiness`"),
    SnippetCheck("M244-D013-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M244-D013-DOC-EXP-07",
        "tmp/reports/m244/M244-D013/runtime_link_bridge_path_docs_operator_runbook_synchronization_contract_summary.json",
    ),
    SnippetCheck(
        "M244-D013-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-D013-DOC-PKT-01", "Packet: `M244-D013`"),
    SnippetCheck("M244-D013-DOC-PKT-02", "Issue: `#6585`"),
    SnippetCheck("M244-D013-DOC-PKT-03", "Dependencies: `M244-D012`"),
    SnippetCheck(
        "M244-D013-DOC-PKT-04",
        "`scripts/check_m244_d013_runtime_link_bridge_path_docs_operator_runbook_synchronization_contract.py`",
    ),
    SnippetCheck(
        "M244-D013-DOC-PKT-05",
        "`tests/tooling/test_check_m244_d013_runtime_link_bridge_path_docs_operator_runbook_synchronization_contract.py`",
    ),
    SnippetCheck("M244-D013-DOC-PKT-06", "`check:objc3c:m244-d013-lane-d-readiness`"),
    SnippetCheck(
        "M244-D013-DOC-PKT-07",
        "`python scripts/check_m244_d013_runtime_link_bridge_path_docs_operator_runbook_synchronization_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M244-D013-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-D013-CFG-03", "check:objc3c:m244-d013-lane-d-readiness"),
    PackageScriptKeyCheck("M244-D013-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M244-D013-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M244-D013-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-D013-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-d012-lane-d-readiness && npm run check:objc3c:m244-d013-runtime-link-bridge-path-docs-operator-runbook-synchronization-contract && npm run test:tooling:m244-d013-runtime-link-bridge-path-docs-operator-runbook-synchronization-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-D013-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-D013-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-D013-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-D013-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-D013-META-00",
