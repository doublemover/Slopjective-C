#!/usr/bin/env python3
"""Fail-closed checker for M248-C017 replay harness/artifact advanced diagnostics workpack (shard 1)."""
...
MODE = "m248-c017-replay-harness-and-artifact-contracts-advanced-diagnostics-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_replay_harness_and_artifact_contracts_advanced_diagnostics_workpack_shard1_c017_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_c017_replay_harness_and_artifact_contracts_advanced_diagnostics_workpack_shard1_packet.md"
)
DEFAULT_PACKAGE_JSON = ROOT / "package.json"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m248_c017_lane_c_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-C017-DOC-EXP-05",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M248-C017-DOC-EXP-06",
        "`check:objc3c:m248-c017-replay-harness-artifact-contracts-advanced-diagnostics-workpack-shard1-contract`",
    ),
    SnippetCheck(
        "M248-C017-DOC-EXP-07",
        "`test:tooling:m248-c017-replay-harness-artifact-contracts-advanced-diagnostics-workpack-shard1-contract`",
    ),
    SnippetCheck("M248-C017-DOC-EXP-08", "`check:objc3c:m248-c017-lane-c-readiness`"),
    SnippetCheck("M248-C017-DOC-EXP-09", "python scripts/run_m248_c016_lane_c_readiness.py"),
    SnippetCheck(
        "M248-C017-DOC-EXP-10",
    ...
    SnippetCheck(
        "M248-C017-DOC-EXP-11",
        "tmp/reports/m248/M248-C017/replay_harness_and_artifact_contracts_advanced_diagnostics_workpack_shard1_contract_summary.json",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C017-DOC-PKT-01", "Packet: `M248-C017`"),
    SnippetCheck("M248-C017-DOC-PKT-02", "Issue: `#6833`"),
    SnippetCheck("M248-C017-DOC-PKT-03", "Dependencies: `M248-C016`"),
    SnippetCheck(
        "M248-C017-DOC-PKT-04",
        "`scripts/check_m248_c017_replay_harness_and_artifact_contracts_advanced_diagnostics_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M248-C017-DOC-PKT-05",
    ...
    SnippetCheck("M248-C017-DOC-PKT-06", "`scripts/run_m248_c017_lane_c_readiness.py`"),
    SnippetCheck("M248-C017-DOC-PKT-07", "`python scripts/run_m248_c016_lane_c_readiness.py`"),
    SnippetCheck(
        "M248-C017-DOC-PKT-08",
        "`check:objc3c:m248-c017-replay-harness-artifact-contracts-advanced-diagnostics-workpack-shard1-contract`",
    ),
    SnippetCheck(
        "M248-C017-DOC-PKT-09",
        "`test:tooling:m248-c017-replay-harness-artifact-contracts-advanced-diagnostics-workpack-shard1-contract`",
    ),
    SnippetCheck("M248-C017-DOC-PKT-10", "`check:objc3c:m248-c017-lane-c-readiness`"),
    SnippetCheck(
        "M248-C017-DOC-PKT-11",
        "`tmp/reports/m248/M248-C017/replay_harness_and_artifact_contracts_advanced_diagnostics_workpack_shard1_contract_summary.json`",
    ),
)
...
PACKAGE_JSON_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-C017-PKG-03", '"check:objc3c:m248-c017-lane-c-readiness"'),
    SnippetCheck("M248-C017-PKG-04", "python scripts/run_m248_c017_lane_c_readiness.py"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C017-RUN-01", "scripts/run_m248_c016_lane_c_readiness.py"),
    SnippetCheck(
        "M248-C017-RUN-02",
        "scripts/check_m248_c017_replay_harness_and_artifact_contracts_advanced_diagnostics_workpack_shard1_contract.py",
    ),
    ...
    SnippetCheck("M248-C017-RUN-04", "[ok] M248-C017 lane-C readiness chain completed"),
)

READINESS_RUNNER_FORBIDDEN_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C017-RUN-FORB-01", "npm run "),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    checks, findings = check_text_contract(
        ...
        exists_check_id="M248-C017-DOC-EXP-EXISTS",
    ...
    checks, findings = check_text_contract(
        ...
        exists_check_id="M248-C017-DOC-PKT-EXISTS",
    ...
    checks, findings = check_text_contract(
        ...
        exists_check_id="M248-C017-PKG-EXISTS",
    ...
    checks, findings = check_text_contract(
        ...
        exists_check_id="M248-C017-RUN-EXISTS",
