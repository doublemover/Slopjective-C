#!/usr/bin/env python3
"""Fail-closed checker for M234-E007 property conformance gate and docs diagnostics hardening."""
...
MODE = "m234-e007-property-conformance-gate-docs-diagnostics-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_property_conformance_gate_and_docs_diagnostics_hardening_e007_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_e007_property_conformance_gate_and_docs_diagnostics_hardening_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M234-E007-DEP-E006-03",
        Path(
            "scripts/"
            "check_m234_e006_property_conformance_gate_and_docs_edge_case_expansion_and_robustness_contract.py"
        ),
    ),
    AssetCheck(
        "M234-E007-DEP-E006-04",
        Path(
            "tests/tooling/"
            "test_check_m234_e006_property_conformance_gate_and_docs_edge_case_expansion_and_robustness_contract.py"
        ),
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-E007-DOC-PKT-01",
        "# M234-E007 Property Conformance Gate and Docs Diagnostics Hardening Packet",
    ),
    SnippetCheck("M234-E007-DOC-PKT-02", "Packet: `M234-E007`"),
    SnippetCheck("M234-E007-DOC-PKT-03", "Issue: `#5754`"),
    SnippetCheck(
        "M234-E007-DOC-PKT-04",
        "Dependencies: `M234-E006`, `M234-A007`, `M234-B007`, `M234-C007`, `M234-D005`",
    ),
    SnippetCheck(
        "M234-E007-DOC-PKT-05",
        "docs/contracts/m234_property_conformance_gate_and_docs_diagnostics_hardening_e007_expectations.md",
    ),
    SnippetCheck(
        "M234-E007-DOC-PKT-06",
        "scripts/check_m234_e007_property_conformance_gate_and_docs_diagnostics_hardening_contract.py",
    ),
    SnippetCheck(
        "M234-E007-DOC-PKT-07",
        "tests/tooling/test_check_m234_e007_property_conformance_gate_and_docs_diagnostics_hardening_contract.py",
    ),
    SnippetCheck(
        "M234-E007-DOC-PKT-08",
        "spec/planning/compiler/m234/m234_e006_property_conformance_gate_and_docs_edge_case_expansion_and_robustness_packet.md",
    ),
    SnippetCheck(
        "M234-E007-DOC-PKT-09",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M234-E007-DOC-PKT-10",
        "tmp/reports/m234/M234-E007/property_conformance_gate_docs_diagnostics_hardening_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-E007-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M234-E007-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M234-E007-PKG-03", '"test:objc3c:diagnostics-replay-proof": '),
    SnippetCheck("M234-E007-PKG-04", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-E007-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-E007-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M234-E007-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
