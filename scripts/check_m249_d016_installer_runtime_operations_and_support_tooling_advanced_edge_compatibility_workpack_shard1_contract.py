#!/usr/bin/env python3
"""Fail-closed checker for M249-D016 installer/runtime advanced edge compatibility workpack (shard 1)."""
...
MODE = "m249-d016-installer-runtime-operations-support-tooling-advanced-edge-compatibility-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_installer_runtime_operations_and_support_tooling_advanced_edge_compatibility_workpack_shard1_d016_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_d016_installer_runtime_operations_and_support_tooling_advanced_edge_compatibility_workpack_shard1_packet.md"
)
...
DEFAULT_D014_CHECKER = (
    ROOT
    / "scripts"
    / "check_m249_d015_installer_runtime_operations_and_support_tooling_advanced_core_workpack_shard1_contract.py"
)
DEFAULT_D014_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m249_d015_installer_runtime_operations_and_support_tooling_advanced_core_workpack_shard1_contract.py"
)
DEFAULT_D014_READINESS_RUNNER = ROOT / "scripts" / "run_m249_d015_lane_d_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m249_d016_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D016-DOC-PKT-01",
        "# M249-D016 Installer/Runtime Operations and Support Tooling Advanced Edge Compatibility Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M249-D016-DOC-PKT-02", "Packet: `M249-D016`"),
    SnippetCheck("M249-D016-DOC-PKT-03", "Issue: `#6943`"),
    SnippetCheck("M249-D016-DOC-PKT-04", "Dependencies: `M249-D015`"),
    SnippetCheck(
        "M249-D016-DOC-PKT-05",
        "scripts/check_m249_d015_installer_runtime_operations_and_support_tooling_advanced_core_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M249-D016-DOC-PKT-06",
        "python scripts/run_m249_d015_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M249-D016-DOC-PKT-07",
...
D014_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D016-D014-DOC-01",
        "Contract ID: `objc3c-installer-runtime-operations-support-tooling-advanced-core-workpack-shard1/m249-d015-v1`",
    ),
    SnippetCheck("M249-D016-D014-DOC-02", "Dependencies: `M249-D014`"),
)

D014_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-D016-D014-PKT-01", "Packet: `M249-D015`"),
    SnippetCheck("M249-D016-D014-PKT-02", "Issue: `#6942`"),
    SnippetCheck("M249-D016-D014-PKT-03", "Dependencies"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D016-RUN-01",
        '"""Run M249-D016 lane-D readiness checks without deep npm nesting."""',
    ),
    SnippetCheck("M249-D016-RUN-02", "scripts/run_m249_d015_lane_d_readiness.py"),
    SnippetCheck(
        "M249-D016-RUN-03",
    ...
    SnippetCheck("M249-D016-RUN-05", "[ok] M249-D016 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-D016-PKG-03",
        '"check:objc3c:m249-d016-lane-d-readiness": "python scripts/run_m249_d016_lane_d_readiness.py"',
    ),
    SnippetCheck("M249-D016-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M249-D016-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M249-D016-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M249-D016-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-D016-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-D016-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d014_expectations_doc, "M249-D016-D014-DOC-EXISTS", D014_EXPECTATIONS_SNIPPETS),
        (args.d014_packet_doc, "M249-D016-D014-PKT-EXISTS", D014_PACKET_SNIPPETS),
        (args.readiness_runner, "M249-D016-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-D016-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-D016-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-D016-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-D016-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d014_checker, "M249-D016-DEP-D014-ARG-01"),
        (args.d014_test, "M249-D016-DEP-D014-ARG-02"),
        (args.d014_readiness_runner, "M249-D016-DEP-D014-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
