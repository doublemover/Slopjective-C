#!/usr/bin/env python3
"""Fail-closed contract checker for the M249-D002 installer/runtime modular split scaffolding packet."""
...
MODE = "m249-d002-installer-runtime-operations-support-tooling-modular-split-scaffolding-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_installer_runtime_operations_and_support_tooling_modular_split_scaffolding_d002_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_d002_installer_runtime_operations_and_support_tooling_modular_split_scaffolding_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D002-DOC-PKT-01",
        "# M249-D002 Installer/Runtime Operations and Support Tooling Modular Split and Scaffolding Packet",
    ),
    SnippetCheck("M249-D002-DOC-PKT-02", "Packet: `M249-D002`"),
    SnippetCheck("M249-D002-DOC-PKT-03", "Dependencies: `M249-D001`"),
    SnippetCheck(
        "M249-D002-DOC-PKT-04",
        "`scripts/check_m249_d001_installer_runtime_operations_and_support_tooling_contract.py`",
    ),
    SnippetCheck(
        "M249-D002-DOC-PKT-05",
        "`check:objc3c:m249-d002-lane-d-readiness`",
    ),
    SnippetCheck(
        "M249-D002-DOC-PKT-06",
        "`test:objc3c:execution-replay-proof`",
    ),
    SnippetCheck(
        "M249-D002-DOC-PKT-07",
        "code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M249-D002-DOC-PKT-08",
        "improvements as mandatory scope inputs.",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m249-d002-installer-runtime-operations-support-tooling-modular-split-scaffolding-contract '
        '&& npm run test:tooling:m249-d002-installer-runtime-operations-support-tooling-modular-split-scaffolding-contract"',
    ),
    SnippetCheck("M249-D002-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M249-D002-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M249-D002-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M249-D002-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-D002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-D002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M249-D002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-D002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-D002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-D002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
