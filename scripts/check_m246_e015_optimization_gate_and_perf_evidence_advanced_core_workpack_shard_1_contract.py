#!/usr/bin/env python3
"""Fail-closed checker for M246-E015 optimization gate/perf evidence advanced core workpack shard 1."""
...
MODE = "m246-e015-optimization-gate-perf-evidence-advanced-core-workpack-shard-1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m246_optimization_gate_and_perf_evidence_advanced_core_workpack_shard_1_e015_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m246"
    / "m246_e015_optimization_gate_and_perf_evidence_advanced_core_workpack_shard_1_packet.md"
)
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_e015_lane_e_readiness.py"
...
DEFAULT_E014_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_e014_lane_e_readiness.py"
...
DEFAULT_B016_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m246_b016_semantic_invariants_for_optimization_legality_advanced_edge_compatibility_workpack_shard_1_contract.py"
)
DEFAULT_B016_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_b016_lane_b_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M246-E015-DEP-A011-05",
        Path("scripts/run_m246_a011_lane_a_readiness.py"),
    ),
    AssetCheck(
        "M246-E015-DEP-B016-01",
        Path("docs/contracts/m246_semantic_invariants_for_optimization_legality_advanced_edge_compatibility_workpack_shard_1_b016_expectations.md"),
    ),
    AssetCheck(
        "M246-E015-DEP-B016-02",
        Path("spec/planning/compiler/m246/m246_b016_semantic_invariants_for_optimization_legality_advanced_edge_compatibility_workpack_shard_1_packet.md"),
    ),
    AssetCheck(
        "M246-E015-DEP-B016-03",
        Path("scripts/check_m246_b016_semantic_invariants_for_optimization_legality_advanced_edge_compatibility_workpack_shard_1_contract.py"),
    ),
    AssetCheck(
        "M246-E015-DEP-B016-04",
        Path("tests/tooling/test_check_m246_b016_semantic_invariants_for_optimization_legality_advanced_edge_compatibility_workpack_shard_1_contract.py"),
    ),
    AssetCheck(
        "M246-E015-DEP-B016-05",
        Path("scripts/run_m246_b016_lane_b_readiness.py"),
    ),
    AssetCheck(
        "M246-E015-DEP-D011-01",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-E015-DOC-PKT-01",
        "# M246-E015 Optimization Gate and Perf Evidence Advanced Core Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M246-E015-DOC-PKT-02", "Packet: `M246-E015`"),
    SnippetCheck("M246-E015-DOC-PKT-03", "Issue: `#6706`"),
    SnippetCheck(
        "M246-E015-DOC-PKT-04",
        "Dependencies: `M246-E014`, `M246-A011`, `M246-B016`, `M246-C027`, `M246-D011`",
    ),
    SnippetCheck("M246-E015-DOC-PKT-05", "Theme: advanced core workpack (shard 1)"),
    SnippetCheck("M246-E015-DOC-PKT-06", "Pending seeded dependency tokens:"),
    SnippetCheck("M246-E015-DOC-PKT-07", "- `M246-C027`"),
    SnippetCheck("M246-E015-DOC-PKT-08", "Real readiness dependency anchors:"),
    SnippetCheck("M246-E015-DOC-PKT-09", "- `M246-B016`"),
    SnippetCheck("M246-E015-DOC-PKT-10", "- `M246-D011`"),
    SnippetCheck(
        "M246-E015-DOC-PKT-11",
        "python scripts/run_m246_e014_lane_e_readiness.py",
    ),
    SnippetCheck(
        "M246-E015-DOC-PKT-12",
        "python scripts/run_m246_a011_lane_a_readiness.py",
    ),
    SnippetCheck(
        "M246-E015-DOC-PKT-13",
        "python scripts/run_m246_b016_lane_b_readiness.py",
    ),
    SnippetCheck(
        "M246-E015-DOC-PKT-14",
        "npm run --if-present check:objc3c:m246-c027-lane-c-readiness",
    ),
    SnippetCheck(
        "M246-E015-DOC-PKT-15",
        "python scripts/run_m246_d011_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M246-E015-DOC-PKT-16",
        "python scripts/check_m246_e015_optimization_gate_and_perf_evidence_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M246-E015-DOC-PKT-17",
    ...
    SnippetCheck(
        "M246-E015-DOC-PKT-18",
        "tmp/reports/m246/M246-E015/optimization_gate_perf_evidence_advanced_core_workpack_shard_1_summary.json",
    ),
    SnippetCheck("M246-E015-DOC-PKT-19", "Predecessor: `M246-E014`"),
    SnippetCheck(
        "M246-E015-DOC-PKT-20",
...
READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-E015-RUN-07", "check:objc3c:m246-c027-lane-c-readiness"),
    SnippetCheck("M246-E015-RUN-08", "scripts/run_m246_d011_lane_d_readiness.py"),
    SnippetCheck(
        "M246-E015-RUN-09",
        "scripts/check_m246_e015_optimization_gate_and_perf_evidence_advanced_core_workpack_shard_1_contract.py",
    ),
...
E014_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-E015-E014-PKT-01", "Packet: `M246-E014`"),
    SnippetCheck("M246-E015-E014-PKT-02", "Issue: `#6705`"),
    SnippetCheck(
        "M246-E015-E014-PKT-03",
...
D011_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-E015-D011-PKT-01", "Packet: `M246-D011`"),
    SnippetCheck("M246-E015-D011-PKT-02", "Issue: `#6690`"),
    SnippetCheck("M246-E015-D011-PKT-03", "Dependencies: `M246-D010`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-E015-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M246-E015-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M246-E015-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-E015-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-E015-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-E015-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.readiness_script, "M246-E015-RUN-EXISTS", READINESS_SNIPPETS),
        (args.e014_expectations_doc, "M246-E015-E014-DOC-EXISTS", E014_EXPECTATIONS_SNIPPETS),
        (args.e014_packet_doc, "M246-E015-E014-PKT-EXISTS", E014_PACKET_SNIPPETS),
        (args.a011_expectations_doc, "M246-E015-A011-DOC-EXISTS", A011_EXPECTATIONS_SNIPPETS),
        (args.a011_packet_doc, "M246-E015-A011-PKT-EXISTS", A011_PACKET_SNIPPETS),
        (args.b016_expectations_doc, "M246-E015-B016-DOC-EXISTS", B016_EXPECTATIONS_SNIPPETS),
        (args.b016_packet_doc, "M246-E015-B016-PKT-EXISTS", B016_PACKET_SNIPPETS),
        (args.d011_expectations_doc, "M246-E015-D011-DOC-EXISTS", D011_EXPECTATIONS_SNIPPETS),
        (args.d011_packet_doc, "M246-E015-D011-PKT-EXISTS", D011_PACKET_SNIPPETS),
        (args.architecture_doc, "M246-E015-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M246-E015-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M246-E015-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M246-E015-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.e014_checker, "M246-E015-DEP-E014-ARG-01"),
        (args.e014_test, "M246-E015-DEP-E014-ARG-02"),
        (args.e014_readiness_script, "M246-E015-DEP-E014-ARG-03"),
        (args.a011_checker, "M246-E015-DEP-A011-ARG-01"),
        (args.a011_test, "M246-E015-DEP-A011-ARG-02"),
        (args.a011_readiness_script, "M246-E015-DEP-A011-ARG-03"),
        (args.b016_checker, "M246-E015-DEP-B016-ARG-01"),
        (args.b016_test, "M246-E015-DEP-B016-ARG-02"),
        (args.b016_readiness_script, "M246-E015-DEP-B016-ARG-03"),
        (args.d011_checker, "M246-E015-DEP-D011-ARG-01"),
        (args.d011_test, "M246-E015-DEP-D011-ARG-02"),
        (args.d011_readiness_script, "M246-E015-DEP-D011-ARG-03"),
    ):
