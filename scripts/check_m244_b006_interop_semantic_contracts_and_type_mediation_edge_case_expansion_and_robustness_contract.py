#!/usr/bin/env python3
"""Fail-closed checker for M244-B006 interop semantic/type mediation edge-case expansion and robustness contract."""
...
MODE = "m244-b006-interop-semantic-contracts-and-type-mediation-edge-case-expansion-and-robustness-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_semantic_contracts_and_type_mediation_edge_case_expansion_and_robustness_b006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_b006_interop_semantic_contracts_and_type_mediation_edge_case_expansion_and_robustness_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B006/"
    "interop_semantic_contracts_and_type_mediation_edge_case_expansion_and_robustness_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M244-B006-B005-03",
        "M244-B005",
        Path("scripts/check_m244_b005_interop_semantic_contracts_and_type_mediation_edge_case_and_compatibility_completion_contract.py"),
    ),
    AssetCheck(
        "M244-B006-B005-04",
        "M244-B005",
        Path("tests/tooling/test_check_m244_b005_interop_semantic_contracts_and_type_mediation_edge_case_and_compatibility_completion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B006-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-edge-case-expansion-and-robustness/m244-b006-v1`",
    ),
    SnippetCheck("M244-B006-DOC-EXP-02", "Dependencies: `M244-B005`"),
    SnippetCheck("M244-B006-DOC-EXP-03", "Issue `#6536` defines canonical lane-B edge-case expansion and robustness scope."),
    SnippetCheck("M244-B006-DOC-EXP-04", "`check:objc3c:m244-b006-lane-b-readiness`"),
    SnippetCheck("M244-B006-DOC-EXP-05", "`check:objc3c:m244-b005-lane-b-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B006-DOC-PKT-01", "Packet: `M244-B006`"),
    SnippetCheck("M244-B006-DOC-PKT-02", "Issue: `#6536`"),
    SnippetCheck("M244-B006-DOC-PKT-03", "Dependencies: `M244-B005`"),
    SnippetCheck(
        "M244-B006-DOC-PKT-04",
        "`scripts/check_m244_b006_interop_semantic_contracts_and_type_mediation_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M244-B006-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B006-CFG-03", "check:objc3c:m244-b006-lane-b-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b005-lane-b-readiness && npm run check:objc3c:m244-b006-interop-semantic-contracts-type-mediation-edge-case-expansion-and-robustness-contract && npm run test:tooling:m244-b006-interop-semantic-contracts-type-mediation-edge-case-expansion-and-robustness-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B006-ARCH-02", "`M244-B005` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B006-SPC-02", "lane-B dependency anchor (`M244-B005`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-B006-META-02",
        "explicit `M244-B005` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B006-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B006-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-B006-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-B006-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-B006-META-00",
