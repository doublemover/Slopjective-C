#!/usr/bin/env python3
"""Fail-closed checker for M248-C011 replay harness/artifact performance and quality guardrails contract."""
...
MODE = "m248-c011-replay-harness-and-artifact-contracts-performance-and-quality-guardrails-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_replay_harness_and_artifact_contracts_performance_and_quality_guardrails_c011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_c011_replay_harness_and_artifact_contracts_performance_and_quality_guardrails_packet.md"
)
DEFAULT_C010_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_replay_harness_and_artifact_contracts_conformance_corpus_expansion_c010_expectations.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-C011/"
    "replay_harness_and_artifact_contracts_performance_and_quality_guardrails_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-C011-DOC-EXP-09",
        "`docs/contracts/m248_replay_harness_and_artifact_contracts_conformance_corpus_expansion_c010_expectations.md`",
    ),
    SnippetCheck(
        "M248-C011-DOC-EXP-10",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M248-C011-DOC-EXP-11",
        "## Milestone Optimization Inputs (Mandatory Scope Inputs)",
    ),
    SnippetCheck("M248-C011-DOC-EXP-12", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C011-DOC-PKT-01", "Packet: `M248-C011`"),
    SnippetCheck("M248-C011-DOC-PKT-02", "Issue: `#6827`"),
    SnippetCheck("M248-C011-DOC-PKT-03", "Dependencies: `M248-C010`"),
    SnippetCheck("M248-C011-DOC-PKT-03A", "## Dependency Anchors (M248-C010)"),
    SnippetCheck(
        "M248-C011-DOC-PKT-04",
        "`scripts/check_m248_c011_replay_harness_and_artifact_contracts_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M248-C011-DOC-PKT-05",
        "`tests/tooling/test_check_m248_c011_replay_harness_and_artifact_contracts_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck("M248-C011-DOC-PKT-06", "`check:objc3c:m248-c011-lane-c-readiness`"),
    SnippetCheck(
        "M248-C011-DOC-PKT-07",
        "`tmp/reports/m248/M248-C011/replay_harness_and_artifact_contracts_performance_and_quality_guardrails_contract_summary.json`",
    ),
    SnippetCheck("M248-C011-DOC-PKT-08", "## Scope Anchors"),
    SnippetCheck("M248-C011-DOC-PKT-09", "- Architecture/spec anchors:"),
    SnippetCheck("M248-C011-DOC-PKT-10", "## Milestone Optimization Inputs"),
    SnippetCheck("M248-C011-DOC-PKT-11", "`test:objc3c:perf-budget`"),
)

C010_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-C011-C010-DOC-01",
        "Contract ID: `objc3c-replay-harness-artifact-contracts-conformance-corpus-expansion/m248-c010-v1`",
    ),
    SnippetCheck("M248-C011-C010-DOC-02", "Dependencies: `M248-C009`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-C011-CFG-03", "check:objc3c:m248-c011-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C011-CFG-04", "check:objc3c:m248-c010-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C011-CFG-05", "compile:objc3c"),
    PackageScriptKeyCheck("M248-C011-CFG-06", "proof:objc3c"),
    PackageScriptKeyCheck("M248-C011-CFG-07", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M248-C011-CFG-08", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M248-C011-CFG-09", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-c010-lane-c-readiness && npm run check:objc3c:m248-c011-replay-harness-artifact-contracts-performance-and-quality-guardrails-contract && npm run test:tooling:m248-c011-replay-harness-artifact-contracts-performance-and-quality-guardrails-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M248-C011-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M248-C011-DOC-PKT-00",
        snippets=PACKET_SNIPPETS,
    )
    checks_total += packet_checks
    findings.extend(packet_findings)

    c010_checks, c010_findings = check_doc_contract(
        artifact_name="c010_expectations_doc",
        path=args.c010_expectations_doc,
        exists_check_id="M248-C011-C010-DOC-00",
        snippets=C010_EXPECTATIONS_SNIPPETS,
    )
    checks_total += c010_checks
    findings.extend(c010_findings)
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M248-C011-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M248-C011-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M248-C011-META-00",
