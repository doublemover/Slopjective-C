#!/usr/bin/env python3
"""Fail-closed checker for M230-D013 Developer CLI and diagnostics ergonomics contract freeze."""
...
MODE = "m230-d013-developer-cli-and-diagnostics-ergonomics-docs-and-operator-runbook-synchronization-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_d013_developer_cli_and_diagnostics_ergonomics_docs_and_operator_runbook_synchronization_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-D013-DOC-PKT-01",
        "# M230-D013 Developer CLI and diagnostics ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-D013-DOC-PKT-02", "Packet: `M230-D013`"),
    SnippetCheck("M230-D013-DOC-PKT-03", "Issue: `#5452`"),
    SnippetCheck("M230-D013-DOC-PKT-04", "Dependencies: `M230-D012`"),
    SnippetCheck(
        "M230-D013-DOC-PKT-05",
        "check:objc3c:m230-d013-developer-cli-and-diagnostics-ergonomics-docs-and-operator-runbook-synchronization-contract",
    ),
    SnippetCheck(
        "M230-D013-DOC-PKT-06",
        "tmp/reports/m230/M230-D013/developer_cli_and_diagnostics_ergonomics_docs_and_operator_runbook_synchronization_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-D013-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-D013-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-D013-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-D013-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-D013-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-D013-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
