#!/usr/bin/env python3
"""Fail-closed checker for M244-B009 interop semantic/type mediation conformance matrix implementation contract."""
...
MODE = "m244-b009-interop-semantic-contracts-and-type-mediation-conformance-matrix-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m244"
    / "m244_b009_interop_semantic_contracts_and_type_mediation_conformance_matrix_implementation_packet.md"
)
DEFAULT_PACKAGE_JSON = ROOT / "package.json"
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B009/"
    "interop_semantic_contracts_and_type_mediation_conformance_matrix_implementation_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B009-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-conformance-matrix-implementation/m244-b009-v1`",
    ),
    SnippetCheck("M244-B009-DOC-EXP-02", "Dependencies: `M244-B008`"),
    SnippetCheck("M244-B009-DOC-EXP-03", "Issue `#6539` defines canonical lane-B conformance matrix implementation scope."),
    SnippetCheck("M244-B009-DOC-EXP-04", "`check:objc3c:m244-b009-lane-b-readiness`"),
    SnippetCheck("M244-B009-DOC-EXP-05", "`check:objc3c:m244-b008-lane-b-readiness`"),
    SnippetCheck("M244-B009-DOC-EXP-06", "Milestone optimization improvements are mandatory scope inputs."),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B009-DOC-PKT-01", "Packet: `M244-B009`"),
    SnippetCheck("M244-B009-DOC-PKT-02", "Issue: `#6539`"),
    SnippetCheck("M244-B009-DOC-PKT-03", "Dependencies: `M244-B008`"),
    SnippetCheck(
        "M244-B009-DOC-PKT-04",
        "`scripts/check_m244_b009_interop_semantic_contracts_and_type_mediation_conformance_matrix_implementation_contract.py`",
    ),
    SnippetCheck(
        "M244-B009-DOC-PKT-05",
    ...
    SnippetCheck("M244-B009-DOC-PKT-06", "`test:objc3c:sema-pass-manager-diagnostics-bus`"),
    SnippetCheck("M244-B009-DOC-PKT-07", "`test:objc3c:lowering-regression`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B009-CFG-03", "check:objc3c:m244-b009-lane-b-readiness"),
    PackageScriptKeyCheck("M244-B009-CFG-04", "test:objc3c:sema-pass-manager-diagnostics-bus"),
    PackageScriptKeyCheck("M244-B009-CFG-05", "test:objc3c:lowering-regression"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b008-lane-b-readiness && npm run check:objc3c:m244-b009-interop-semantic-contracts-type-mediation-conformance-matrix-implementation-contract && npm run test:tooling:m244-b009-interop-semantic-contracts-type-mediation-conformance-matrix-implementation-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B009-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B009-DOC-PKT-00",
