#!/usr/bin/env python3
"""Fail-closed validator for M228-C023 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c022_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c022_ir_emission_completeness_advanced_edge_compatibility_workpack_shard2_contract.py",
    "c022_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c022_ir_emission_completeness_advanced_edge_compatibility_workpack_shard2_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C023-RUN-04", "npm run check:objc3c:m228-c023-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C023-ARC-01",
    ...
    "package_json": (
        ("M228-C023-PKG-01", '"check:objc3c:m228-c022-lane-c-readiness"'),
        (
            "M228-C023-PKG-02",
            '"check:objc3c:m228-c023-ir-emission-completeness-advanced-diagnostics-workpack-shard2-contract"',
        ),
        (
            "M228-C023-PKG-03",
            '"test:tooling:m228-c023-ir-emission-completeness-advanced-diagnostics-workpack-shard2-contract"',
        ),
        ("M228-C023-PKG-04", '"check:objc3c:m228-c023-lane-c-readiness"'),
        (
            "M228-C023-PKG-05",
            '"check:objc3c:m228-c023-lane-c-readiness": "npm run check:objc3c:m228-c022-lane-c-readiness &&',
        ),
    ),
    "c022_contract_doc": (
        (
            "M228-C023-DEP-01",
            "Contract ID: `objc3c-ir-emission-completeness-advanced-edge-compatibility-workpack-shard2/m228-c022-v1`",
        ),
    ),
    "c022_checker": (
        (
            "M228-C023-DEP-02",
            'MODE = "m228-c022-ir-emission-completeness-advanced-edge-compatibility-workpack-shard2-contract-v1"',
        ),
    ),
    "c022_tooling_test": (
        ("M228-C023-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c022_packet_doc": (
        ("M228-C023-DEP-04", "Packet: `M228-C022`"),
        ("M228-C023-DEP-05", "Issue: `#5248`"),
    ),
    "contract_doc": (
        (
            "M228-C023-DOC-01",
        ...
        ("M228-C023-DOC-02", "Execute issue `#5249`"),
        ("M228-C023-DOC-03", "Dependencies: `M228-C022`"),
        (
            "M228-C023-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C023-PKT-02", "Packet: `M228-C023`"),
        ("M228-C023-PKT-03", "Issue: `#5249`"),
        ("M228-C023-PKT-04", "Dependencies: `M228-C022`"),
        (
            "M228-C023-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C023-FORB-01",
            '"check:objc3c:m228-c023-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C023/"
            "ir_emission_completeness_advanced_diagnostics_workpack_shard2_contract_summary.json"
        ),
    )
