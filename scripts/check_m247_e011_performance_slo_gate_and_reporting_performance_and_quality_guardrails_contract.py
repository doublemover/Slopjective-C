#!/usr/bin/env python3
"""Fail-closed checker for M247-E011 performance SLO performance and quality guardrails."""
...
MODE = "m247-e011-performance-slo-gate-reporting-performance-and-quality-guardrails-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_e011_lane_e_readiness.py"
...
DEFAULT_E010_CHECKER = (
    ROOT
    / "scripts"
    / "check_m247_e010_performance_slo_gate_and_reporting_conformance_corpus_expansion_contract.py"
)
DEFAULT_E010_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m247_e010_performance_slo_gate_and_reporting_conformance_corpus_expansion_contract.py"
)
DEFAULT_E010_RUNNER = ROOT / "scripts" / "run_m247_e010_lane_e_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-E011-DOC-EXP-01",
        "# M247 Lane E Performance SLO Gate and Reporting Performance and Quality Guardrails Expectations (E011)",
    ),
    SnippetCheck(
        "M247-E011-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-performance-slo-gate-reporting-performance-and-quality-guardrails-contract/m247-e011-v1`",
    ),
    SnippetCheck(
        "M247-E011-DOC-EXP-03",
        "Dependencies: `M247-E010`, `M247-A011`, `M247-B012`, `M247-C012`, `M247-D009`",
    ),
    SnippetCheck("M247-E011-DOC-EXP-04", "Issue `#6782` defines canonical lane-E"),
    SnippetCheck("M247-E011-DOC-EXP-05", "`python scripts/run_m247_e010_lane_e_readiness.py`"),
    SnippetCheck("M247-E011-DOC-EXP-06", "`check:objc3c:m247-d009-lane-d-readiness`"),
    SnippetCheck(
        "M247-E011-DOC-EXP-07",
        "`tmp/reports/m247/M247-E011/performance_slo_gate_and_reporting_performance_and_quality_guardrails_contract_summary.json`",
    ),
)
...
E010_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-E011-E010-PKT-01", "Packet: `M247-E010`"),
    SnippetCheck("M247-E011-E010-PKT-02", "Issue: `#6781`"),
)

D009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-E011-D009-DOC-01",
...
D009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-E011-D009-PKT-01", "Packet: `M247-D009`"),
    SnippetCheck("M247-E011-D009-PKT-02", "Issue: `#6767`"),
)
...
READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-E011-RUN-02", 'BASELINE_DEPENDENCIES = ("M247-E010",)'),
    SnippetCheck("M247-E011-RUN-03", 'PENDING_SEEDED_DEPENDENCY_TOKENS = ("M247-A011", "M247-B012", "M247-C012", "M247-D009")'),
    SnippetCheck("M247-E011-RUN-04", "scripts/run_m247_e010_lane_e_readiness.py"),
    SnippetCheck("M247-E011-RUN-05", "check:objc3c:m247-a011-lane-a-readiness"),
    SnippetCheck("M247-E011-RUN-06", "check:objc3c:m247-b012-lane-b-readiness"),
    SnippetCheck("M247-E011-RUN-07", "check:objc3c:m247-c012-lane-c-readiness"),
    SnippetCheck("M247-E011-RUN-08", "check:objc3c:m247-d009-lane-d-readiness"),
    SnippetCheck("M247-E011-RUN-09", "[ok] M247-E011 lane-E readiness chain completed"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--e010-runner", type=Path, default=DEFAULT_E010_RUNNER)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-E011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-E011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.e010_expectations_doc, "M247-E011-E010-DOC-EXISTS", E010_EXPECTATIONS_SNIPPETS),
        (args.e010_packet_doc, "M247-E011-E010-PKT-EXISTS", E010_PACKET_SNIPPETS),
        (args.d009_expectations_doc, "M247-E011-D009-DOC-EXISTS", D009_EXPECTATIONS_SNIPPETS),
        (args.d009_packet_doc, "M247-E011-D009-PKT-EXISTS", D009_PACKET_SNIPPETS),
        (args.readiness_script, "M247-E011-RUN-EXISTS", READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.e010_checker, "M247-E011-DEP-E010-ARG-01"),
        (args.e010_test, "M247-E011-DEP-E010-ARG-02"),
        (args.e010_runner, "M247-E011-DEP-E010-ARG-03"),
        (args.d009_checker, "M247-E011-DEP-D009-ARG-01"),
        (args.d009_test, "M247-E011-DEP-D009-ARG-02"),
        (args.d009_runner, "M247-E011-DEP-D009-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
