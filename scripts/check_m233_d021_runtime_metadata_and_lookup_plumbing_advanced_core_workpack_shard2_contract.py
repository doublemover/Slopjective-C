#!/usr/bin/env python3
"""Fail-closed validator for M233-D021 runtime metadata and lookup advanced core workpack (shard 2)."""
...
MODE = "m233-installer-runtime-operations-lookup-plumbing-advanced-core-workpack-shard2-contract-d021-v1"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        ...
        ("M233-D021-DOC-06", "npm run check:objc3c:m233-d021-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M233-D021-PKT-01", "Packet: `M233-D021`"),
        ("M233-D021-PKT-02", "Dependencies: `M233-D020`"),
        ("M233-D021-PKT-03", "Issue: `#6856`"),
        (
            "M233-D021-PKT-04",
            "scripts/check_m233_d021_runtime_metadata_and_lookup_plumbing_advanced_core_workpack_shard2_contract.py",
        ),
    ...
    "package_json": (
        (
            "M233-D021-CFG-01",
            "\"check:objc3c:m233-d021-installer-runtime-operations-lookup-plumbing-advanced-core-workpack-shard2-contract\"",
        ),
        (
            "M233-D021-CFG-02",
            "\"test:tooling:m233-d021-installer-runtime-operations-lookup-plumbing-advanced-core-workpack-shard2-contract\"",
        ),
        ("M233-D021-CFG-03", "\"check:objc3c:m233-d021-lane-d-readiness\""),
        ("M233-D021-CFG-04", "python scripts/run_m233_d021_lane_d_readiness.py"),
    ),
}
