#!/usr/bin/env python3
"""Fail-closed checker for M231-D005 Frontend/runtime declaration metadata linkage contract freeze."""
...
MODE = "m231-d005-frontend-runtime-declaration-metadata-linkage-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_d005_frontend_runtime_declaration_metadata_linkage_edge_case_and_compatibility_completion_packet.md"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M231-D005-PKG-03",
        '"check:objc3c:m231-d005-lane-d-readiness": '
        '"npm run check:objc3c:m231-d004-lane-d-readiness && npm run check:objc3c:m231-d005-frontend-runtime-declaration-metadata-linkage-edge-case-and-compatibility-completion-contract '
        '&& npm run test:tooling:m231-d005-frontend-runtime-declaration-metadata-linkage-edge-case-and-compatibility-completion-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-D005-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-D005-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-D005-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-D005-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-D005-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-D005-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
