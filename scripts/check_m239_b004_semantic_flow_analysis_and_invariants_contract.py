#!/usr/bin/env python3
"""Fail-closed checker for M239-B004 semantic flow analysis and invariants contract freeze."""
...
MODE = "m239-b004-semantic-flow-analysis-and-invariants-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m239"
    / "m239_b004_semantic_flow_analysis_and_invariants_core_feature_expansion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M239-B004-DOC-PKT-01",
        "# M239-B004 Semantic flow analysis and invariants Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M239-B004-DOC-PKT-02", "Packet: `M239-B004`"),
    SnippetCheck("M239-B004-DOC-PKT-03", "Issue: `#4952`"),
    SnippetCheck("M239-B004-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M239-B004-DOC-PKT-05",
        "check:objc3c:m239-b004-semantic-flow-analysis-and-invariants-contract",
    ),
    SnippetCheck(
        "M239-B004-DOC-PKT-06",
        "tmp/reports/m239/M239-B004/semantic_flow_analysis_and_invariants_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M239-B004-PKG-03",
        '"check:objc3c:m239-b004-lane-b-readiness": '
        '"npm run check:objc3c:m239-b004-semantic-flow-analysis-and-invariants-contract '
        '&& npm run test:tooling:m239-b004-semantic-flow-analysis-and-invariants-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M239-B004-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M239-B004-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M239-B004-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M239-B004-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M239-B004-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M239-B004-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
