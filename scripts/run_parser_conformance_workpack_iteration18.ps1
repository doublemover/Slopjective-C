param(
  ...
  [string]$ReportRoot = "tmp/reports/parser_build/parser_conformance_shard1"
)
...
$summary = [ordered]@{
  contract_id = "objc3c-parser-advanced-conformance-workpack-contract/parser_build-conformance-workpack-iteration18-v1"
