#!/usr/bin/env python3
"""Fail-closed checker for M246-B006 semantic invariants edge-case expansion and robustness."""
...
MODE = "m246-b006-semantic-invariants-optimization-legality-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_B005_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m246_b005_semantic_invariants_for_optimization_legality_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m246_b006_lane_b_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-B006-DOC-EXP-09",
        "scripts/run_m246_b006_lane_b_readiness.py",
    ),
    SnippetCheck(
        "M246-B006-DOC-EXP-10",
        "edge-case expansion and robustness dependency anchors remain explicit, deterministic, and traceable",
    ),
    SnippetCheck(
        "M246-B006-DOC-EXP-11",
        "tmp/reports/m246/M246-B006/semantic_invariants_optimization_legality_edge_case_expansion_and_robustness_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-B006-DOC-PKT-01",
        "# M246-B006 Semantic Invariants for Optimization Legality Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M246-B006-DOC-PKT-02", "Packet: `M246-B006`"),
    SnippetCheck("M246-B006-DOC-PKT-03", "Issue: `#5065`"),
    SnippetCheck("M246-B006-DOC-PKT-04", "Dependencies: `M246-B005`"),
    SnippetCheck("M246-B006-DOC-PKT-05", "Theme: `edge-case expansion and robustness`"),
    SnippetCheck(
        "M246-B006-DOC-PKT-06",
        "scripts/check_m246_b006_semantic_invariants_for_optimization_legality_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M246-B006-DOC-PKT-07",
        "tests/tooling/test_check_m246_b006_semantic_invariants_for_optimization_legality_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M246-B006-DOC-PKT-08",
        "scripts/run_m246_b006_lane_b_readiness.py",
    ),
    SnippetCheck(
        "M246-B006-DOC-PKT-09",
        "scripts/check_m246_b005_semantic_invariants_for_optimization_legality_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M246-B006-DOC-PKT-10",
        "tests/tooling/test_check_m246_b005_semantic_invariants_for_optimization_legality_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M246-B006-DOC-PKT-11",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-B006-DOC-PKT-12",
        "tmp/reports/m246/M246-B006/semantic_invariants_optimization_legality_edge_case_expansion_and_robustness_summary.json",
    ),
)
...
B005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-B006-B005-PKT-01", "Packet: `M246-B005`"),
    SnippetCheck("M246-B006-B005-PKT-02", "Issue: `#5064`"),
    SnippetCheck("M246-B006-B005-PKT-03", "Dependencies: `M246-B004`"),
    SnippetCheck(
        "M246-B006-B005-PKT-04",
        "scripts/check_m246_b005_semantic_invariants_for_optimization_legality_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M246-B006-B005-PKT-05",
        "tests/tooling/test_check_m246_b005_semantic_invariants_for_optimization_legality_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M246-B006-B005-PKT-06",
        "scripts/run_m246_b005_lane_b_readiness.py",
    ),
    SnippetCheck(
        "M246-B006-B005-PKT-07",
        "tmp/reports/m246/M246-B005/semantic_invariants_optimization_legality_edge_case_and_compatibility_completion_summary.json",
    ),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-B006-RUN-01", '"""Run M246-B006 lane-B readiness checks without deep npm nesting."""'),
    SnippetCheck("M246-B006-RUN-02", "scripts/run_m246_b005_lane_b_readiness.py"),
    SnippetCheck(
        "M246-B006-RUN-03",
        "scripts/check_m246_b006_semantic_invariants_for_optimization_legality_edge_case_expansion_and_robustness_contract.py",
    ),
    ...
    SnippetCheck("M246-B006-RUN-05", "[ok] M246-B006 lane-B readiness chain completed"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-B006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-B006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b005_expectations_doc, "M246-B006-B005-DOC-EXISTS", B005_EXPECTATIONS_SNIPPETS),
        (args.b005_packet_doc, "M246-B006-B005-PKT-EXISTS", B005_PACKET_SNIPPETS),
        (args.readiness_runner, "M246-B006-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b005_checker, "M246-B006-DEP-B005-ARG-01"),
        (args.b005_test, "M246-B006-DEP-B005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
