#!/usr/bin/env python3
"""Fail-closed validator for M226-E004 lane-E integration gate evidence core feature expansion."""
...
MODE = "m226-e004-lane-e-integration-gate-evidence-core-feature-expansion-contract-v1"

DEFAULT_CONTRACT_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m226_lane_e_integration_gate_e004_evidence_core_feature_expansion_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m226"
    / "m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_packet.md"
)
DEFAULT_EVIDENCE_DOC = (
    ...
    / "compiler"
    / "m226"
    / "m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_scaffold.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M226-E004-ASSET-01",
        Path("docs/contracts/m226_lane_e_integration_gate_expectations.md"),
    ),
    AssetCheck(
        "M226-E004-ASSET-02",
        Path("scripts/check_m226_e001_lane_e_integration_gate_contract.py"),
    ),
    AssetCheck(
        "M226-E004-ASSET-03",
        Path("tests/tooling/test_check_m226_e001_lane_e_integration_gate_contract.py"),
    ),
    AssetCheck(
        "M226-E004-ASSET-04",
        Path("docs/contracts/m226_lane_e_integration_gate_e002_evidence_modular_split_expectations.md"),
    ),
    AssetCheck(
        "M226-E004-ASSET-05",
        Path("scripts/check_m226_e002_lane_e_integration_gate_evidence_modular_split_contract.py"),
    ),
    AssetCheck(
        "M226-E004-ASSET-06",
        Path("tests/tooling/test_check_m226_e002_lane_e_integration_gate_evidence_modular_split_contract.py"),
    ),
    AssetCheck(
        "M226-E004-ASSET-07",
        Path("docs/contracts/m226_lane_e_integration_gate_e003_core_evidence_expectations.md"),
    ),
    AssetCheck(
        "M226-E004-ASSET-08",
        Path("scripts/check_m226_e003_lane_e_integration_gate_core_evidence_contract.py"),
    ),
    AssetCheck(
        "M226-E004-ASSET-09",
        Path("tests/tooling/test_check_m226_e003_lane_e_integration_gate_core_evidence_contract.py"),
    ),
    AssetCheck(
        "M226-E004-ASSET-10",
        Path("docs/contracts/m226_lane_e_integration_gate_e004_evidence_core_feature_expansion_expectations.md"),
    ),
    AssetCheck(
        "M226-E004-ASSET-11",
        Path("spec/planning/compiler/m226/m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_packet.md"),
    ),
    AssetCheck(
        "M226-E004-ASSET-12",
        Path("spec/planning/compiler/m226/m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_scaffold.md"),
    ),
    AssetCheck(
        "M226-E004-ASSET-13",
        Path("scripts/check_m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M226-E004-ASSET-14",
        Path("tests/tooling/test_check_m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract.py"),
    ),
)

CONTRACT_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E004-DOC-CON-02",
        "# M226 Lane E Integration Gate Evidence Core Feature Expansion Expectations (E004)",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-03",
        "Contract ID: `objc3c-lane-e-integration-gate-evidence-core-feature-expansion-contract/m226-e004-v1`",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-04",
        "`spec/planning/compiler/m226/m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_packet.md`",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-05",
        "`spec/planning/compiler/m226/m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_scaffold.md`",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-06",
        "Required top-level keys: `packet`, `generated_at_utc`, `upstream_packets`, `artifacts`, `milestone_gate`, `feature_matrix`.",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-07",
        "`milestone_gate` required keys: `milestone_id`, `gate_status`, `validated_by`.",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-08",
        "`feature_matrix` required entries: `core_index`, `milestone_gate`, `validation_transcripts`.",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-09",
        "`tmp/reports/m226/m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract_summary.json`",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-10",
        "`tmp/reports/m226/e004/evidence_index.json`",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-11",
        "`python scripts/check_m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M226-E004-DOC-CON-12",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E004-DOC-PKT-02",
        "# M226 Lane E Integration Gate Evidence Core Feature Expansion Packet (E004)",
    ),
    SnippetCheck("M226-E004-DOC-PKT-03", "Packet: `M226-E004`"),
    SnippetCheck("M226-E004-DOC-PKT-04", "Upstream packet dependency: `M226-E003`"),
    SnippetCheck(
        "M226-E004-DOC-PKT-05",
        "The evidence index metadata expands to include `milestone_gate` and",
    ),
    SnippetCheck(
        "M226-E004-DOC-PKT-06",
        "`scripts/check_m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M226-E004-DOC-PKT-07",
        "`python scripts/check_m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M226-E004-DOC-PKT-08",
...
EVIDENCE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E004-DOC-EVI-02",
        "# M226 Lane E Integration Gate Evidence Core Feature Expansion Scaffold (E004)",
    ),
    SnippetCheck(
        "M226-E004-DOC-EVI-03",
        "Path: `tmp/reports/m226/m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract_summary.json`",
    ),
    SnippetCheck("M226-E004-DOC-EVI-04", "Status: `pending`"),
    SnippetCheck(
        "M226-E004-DOC-EVI-05",
    ...
    SnippetCheck(
        "M226-E004-DOC-EVI-11",
        "Path: `tmp/reports/m226/e004/evidence_index.json`",
    ),
    SnippetCheck(
        "M226-E004-DOC-EVI-12",
        "- `generated_at_utc` format: RFC3339 UTC with trailing `Z`.",
    ),
)

FREEZE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M226-E004-DOC-FRZ-02", "# M226 Lane E Contract Freeze (2026-03-02)"),
    SnippetCheck(
        "M226-E004-DOC-FRZ-03",
        "| `M226-E004` | `objc3c-lane-e-integration-gate-evidence-core-feature-expansion-contract/m226-e004-v1` |",
    ),
    SnippetCheck("M226-E004-DOC-FRZ-04", "## Packet: `M226-E004`"),
    SnippetCheck(
        "M226-E004-DOC-FRZ-05",
        "`docs/contracts/m226_lane_e_integration_gate_e004_evidence_core_feature_expansion_expectations.md`",
    ),
    SnippetCheck(
        "M226-E004-DOC-FRZ-06",
        "`scripts/check_m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M226-E004-DOC-FRZ-07",
        "`tests/tooling/test_check_m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M226-E004-DOC-FRZ-08",
        "`python scripts/check_m226_e004_lane_e_integration_gate_evidence_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M226-E004-DOC-FRZ-09",
        "`tmp/reports/m226/e004/evidence_index.json`",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    contract_checks, contract_findings = check_doc_contract(
        ...
        exists_check_id="M226-E004-DOC-CON-01",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M226-E004-DOC-PKT-01",
    ...
    evidence_checks, evidence_findings = check_doc_contract(
        ...
        exists_check_id="M226-E004-DOC-EVI-01",
    ...
    freeze_checks, freeze_findings = check_doc_contract(
        ...
        exists_check_id="M226-E004-DOC-FRZ-01",
    ...
    try:
        ...
        print(
            "m226-e004-lane-e-integration-gate-evidence-core-feature-expansion-contract: "
    ...
    if not findings:
        print("m226-e004-lane-e-integration-gate-evidence-core-feature-expansion-contract: OK")
        return 0

    print(
        "m226-e004-lane-e-integration-gate-evidence-core-feature-expansion-contract: contract drift detected "
