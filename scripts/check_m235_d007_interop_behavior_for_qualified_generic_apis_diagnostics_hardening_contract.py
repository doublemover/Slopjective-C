#!/usr/bin/env python3
"""Fail-closed checker for M235-D007 interop behavior diagnostics hardening."""
...
MODE = "m235-d007-interop-behavior-for-qualified-generic-apis-diagnostics-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_interop_behavior_for_qualified_generic_apis_diagnostics_hardening_d007_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_d007_interop_behavior_for_qualified_generic_apis_diagnostics_hardening_packet.md"
)
DEFAULT_D006_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_d006_expectations.md"
)
DEFAULT_D006_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_d006_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_packet.md"
)
DEFAULT_D006_CHECKER = (
    ROOT / "scripts" / "check_m235_d006_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_contract.py"
)
DEFAULT_D006_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_d006_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M235-D007-DEP-D006-01",
        Path("docs/contracts/m235_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_d006_expectations.md"),
    ),
    AssetCheck(
        "M235-D007-DEP-D006-02",
        Path("spec/planning/compiler/m235/m235_d006_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_packet.md"),
    ),
    AssetCheck(
        "M235-D007-DEP-D006-03",
        Path("scripts/check_m235_d006_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_contract.py"),
    ),
    AssetCheck(
        "M235-D007-DEP-D006-04",
        Path("tests/tooling/test_check_m235_d006_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-D007-DOC-EXP-01",
        "# M235 Interop Behavior for Qualified Generic APIs Diagnostics Hardening Expectations (D007)",
    ),
    SnippetCheck(
        "M235-D007-DOC-EXP-02",
        "Contract ID: `objc3c-interop-behavior-for-qualified-generic-apis-diagnostics-hardening/m235-d007-v1`",
    ),
    SnippetCheck(
        "M235-D007-DOC-EXP-03",
        "Issue `#5837` defines canonical lane-D diagnostics hardening scope.",
    ),
    SnippetCheck("M235-D007-DOC-EXP-04", "Dependencies: `M235-D006`"),
    SnippetCheck(
        "M235-D007-DOC-EXP-05",
        "milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-D007-DOC-EXP-06",
        "docs/contracts/m235_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_d006_expectations.md",
    ),
    SnippetCheck(
        "M235-D007-DOC-EXP-07",
        "scripts/check_m235_d006_interop_behavior_for_qualified_generic_apis_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M235-D007-DOC-EXP-08",
    ...
    SnippetCheck("M235-D007-DOC-EXP-09", "`check:objc3c:m235-d006-lane-d-readiness`"),
    SnippetCheck(
        "M235-D007-DOC-EXP-10",
        "`check:objc3c:m235-d007-interop-behavior-for-qualified-generic-apis-diagnostics-hardening-contract`",
    ),
    SnippetCheck(
        "M235-D007-DOC-EXP-11",
        "`check:objc3c:m235-d007-lane-d-readiness`",
    ),
    SnippetCheck("M235-D007-DOC-EXP-12", "`compile:objc3c`"),
    SnippetCheck(
        "M235-D007-DOC-EXP-13",
        "`tmp/reports/m235/M235-D007/interop_behavior_for_qualified_generic_apis_diagnostics_hardening_contract_summary.json`",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-D007-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-D007-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-D007-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-D007-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-D007-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-D007-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d006_expectations_doc, "M235-D007-D006-DOC-EXISTS", D006_EXPECTATIONS_SNIPPETS),
        (args.d006_packet_doc, "M235-D007-D006-PKT-EXISTS", D006_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-D007-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-D007-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-D007-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-D007-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d006_checker, "M235-D007-DEP-D006-ARG-01"),
        (args.d006_test, "M235-D007-DEP-D006-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
