#!/usr/bin/env python3
"""Fail-closed checker for M235-B003 qualifier/generic semantic inference core feature implementation."""
...
MODE = "m235-b003-qualifier-and-generic-semantic-inference-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_core_feature_implementation_b003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_b003_qualifier_and_generic_semantic_inference_core_feature_implementation_packet.md"
)
...
DEFAULT_B002_CHECKER = (
    ROOT / "scripts" / "check_m235_b002_qualifier_and_generic_semantic_inference_modular_split_scaffolding_contract.py"
)
DEFAULT_B002_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_b002_qualifier_and_generic_semantic_inference_modular_split_scaffolding_contract.py"
)
...
B002_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B003-B002-PKT-01", "Packet: `M235-B002`"),
    SnippetCheck("M235-B003-B002-PKT-02", "Dependencies: `M235-B001`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B003-META-02",
        "explicit `M235-B002` dependency continuity so core feature implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B003-PKG-03",
        '"check:objc3c:m235-b003-lane-b-readiness": '
        '"npm run check:objc3c:m235-b002-lane-b-readiness '
        '&& npm run check:objc3c:m235-b003-qualifier-and-generic-semantic-inference-core-feature-implementation-contract '
        '&& npm run test:tooling:m235-b003-qualifier-and-generic-semantic-inference-core-feature-implementation-contract"',
    ),
    SnippetCheck("M235-B003-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B003-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b002_expectations_doc, "M235-B003-B002-DOC-EXISTS", B002_EXPECTATIONS_SNIPPETS),
        (args.b002_packet_doc, "M235-B003-B002-PKT-EXISTS", B002_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b002_checker, "M235-B003-DEP-B002-ARG-01"),
        (args.b002_test, "M235-B003-DEP-B002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
