#!/usr/bin/env python3
"""Fail-closed checker for M245-D016 build/link/runtime reproducibility advanced edge compatibility workpack shard 1."""
...
MODE = "m245-d016-build-link-runtime-reproducibility-operations-advanced-edge-compatibility-workpack-shard1-contract-v1"
...
DEFAULT_D015_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m245_d015_build_link_runtime_reproducibility_operations_advanced_core_workpack_shard1_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D016-DOC-PKT-01",
        "# M245-D016 Build/Link/Runtime Reproducibility Operations Advanced Edge Compatibility Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M245-D016-DOC-PKT-02", "Packet: `M245-D016`"),
    SnippetCheck("M245-D016-DOC-PKT-03", "Issue: `#6667`"),
    SnippetCheck("M245-D016-DOC-PKT-04", "Dependencies: `M245-D015`"),
    SnippetCheck("M245-D016-DOC-PKT-05", "Theme: `advanced edge compatibility workpack (shard 1)`"),
    SnippetCheck(
        "M245-D016-DOC-PKT-06",
        "dependency continuity and code/spec anchors as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D016-DOC-PKT-07",
    ...
    SnippetCheck(
        "M245-D016-DOC-PKT-08",
        "tests/tooling/test_check_m245_d016_build_link_runtime_reproducibility_operations_advanced_edge_compatibility_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D016-DOC-PKT-09",
    ...
    SnippetCheck("M245-D016-DOC-PKT-10", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-D016-DOC-PKT-11",
        "`python scripts/check_m245_d016_build_link_runtime_reproducibility_operations_advanced_edge_compatibility_workpack_shard1_contract.py --emit-json`",
    ),
)

D015_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D016-D015-DOC-01",
        "# M245 Build/Link/Runtime Reproducibility Operations Advanced Core Workpack (Shard 1) Expectations (D015)",
    ),
    SnippetCheck(
        "M245-D016-D015-DOC-02",
        "Contract ID: `objc3c-build-link-runtime-reproducibility-operations-advanced-core-workpack-shard1/m245-d015-v1`",
    ),
    SnippetCheck("M245-D016-D015-DOC-03", "Dependencies: `M245-D014`"),
)

D015_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-D016-D015-PKT-01", "Packet: `M245-D015`"),
    SnippetCheck("M245-D016-D015-PKT-02", "Issue: `#6666`"),
    SnippetCheck("M245-D016-D015-PKT-03", "Dependencies: `M245-D014`"),
    SnippetCheck("M245-D016-D015-PKT-04", "Freeze date: `2026-03-04`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D016-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D016-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D016-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D016-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--d015-expectations-doc", type=Path, default=DEFAULT_D015_EXPECTATIONS_DOC)
    parser.add_argument("--d015-packet-doc", type=Path, default=DEFAULT_D015_PACKET_DOC)
    parser.add_argument("--d015-checker", type=Path, default=DEFAULT_D015_CHECKER)
    parser.add_argument("--d015-test", type=Path, default=DEFAULT_D015_TEST)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D016-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D016-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d015_expectations_doc, "M245-D016-D015-DOC-EXISTS", D015_EXPECTATIONS_SNIPPETS),
        (args.d015_packet_doc, "M245-D016-D015-PKT-EXISTS", D015_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D016-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D016-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D016-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D016-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d015_checker, "M245-D016-DEP-D015-ARG-01"),
        (args.d015_test, "M245-D016-DEP-D015-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
