...
JSON_OUT = ROOT / "tmp" / "reports" / "m264" / "M264-E002" / "release_runtime_claim_matrix.json"
MD_OUT = ROOT / "tmp" / "reports" / "m264" / "M264-E002" / "release_runtime_claim_matrix.md"
...
def publish_matrix(json_out: Path, md_out: Path) -> None:
    ...
    ensure_summary = ROOT / "tmp" / "reports" / "m264" / "M264-E002" / "ensure_build_summary.json"
    build = run([
        "python",
    ...
    native_dir = ROOT / "tmp" / "artifacts" / "compilation" / "objc3c-native" / "m264" / "e002" / "native"
    ...
    validate_dir = ROOT / "tmp" / "artifacts" / "compilation" / "objc3c-native" / "m264" / "e002" / "validate"
    ...
    runner_dir = ROOT / "tmp" / "artifacts" / "compilation" / "objc3c-native" / "m264" / "e002" / "frontend-runner"
    ...
    strict_dir = ROOT / "tmp" / "artifacts" / "compilation" / "objc3c-native" / "m264" / "e002" / "strict-reject"
    ...
    yaml_dir = ROOT / "tmp" / "artifacts" / "compilation" / "objc3c-native" / "m264" / "e002" / "yaml-reject"
