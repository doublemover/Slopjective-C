#!/usr/bin/env python3
"""Run M253-E002 lane-E readiness checks without nested npm recursion."""
...
DEPENDENCY_TOKEN = "M253-A002 + M253-B003 + M253-C006 + M253-D003 + M253-E001"
...
def run_chain() -> int:
    print(
        ...
        f"{DEPENDENCY_TOKEN} (source graph, object-format policy, binary inspection, archive/static-link discovery, and metadata emission gate)"
    )
    ...
    print("[ok] M253-E002 lane-E readiness chain completed")
    return 0
