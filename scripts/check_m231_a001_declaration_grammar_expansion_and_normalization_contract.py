#!/usr/bin/env python3
"""Fail-closed checker for M231-A001 declaration grammar expansion and normalization contract freeze."""
...
MODE = "m231-a001-declaration-grammar-expansion-and-normalization-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M231-A001-DOC-PKT-01",
        "# M231-A001 Declaration Grammar Expansion and Normalization Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M231-A001-DOC-PKT-02", "Packet: `M231-A001`"),
    SnippetCheck("M231-A001-DOC-PKT-03", "Issue: `#5493`"),
    SnippetCheck("M231-A001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M231-A001-DOC-PKT-05",
        "check:objc3c:m231-a001-declaration-grammar-expansion-and-normalization-contract",
    ),
    SnippetCheck(
        "M231-A001-DOC-PKT-06",
        "tmp/reports/m231/M231-A001/declaration_grammar_expansion_and_normalization_contract_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-A001-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-A001-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-A001-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-A001-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-A001-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-A001-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
