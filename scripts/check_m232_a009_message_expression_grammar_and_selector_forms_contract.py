#!/usr/bin/env python3
"""Fail-closed checker for M232-A009 message expression grammar and selector forms contract freeze."""
...
MODE = "m232-a009-message-expression-grammar-and-selector-forms-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m232"
    / "m232_a009_message_expression_grammar_and_selector_forms_conformance_matrix_implementation_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-A009-DOC-EXP-01",
        "# M232 Message Expression Grammar and Selector Forms Contract and Architecture Freeze Expectations (A009)",
    ),
    SnippetCheck(
        "M232-A009-DOC-EXP-02",
        "Contract ID: `objc3c-message-expression-grammar-and-selector-forms/m232-a009-v1`",
    ),
    SnippetCheck("M232-A009-DOC-EXP-03", "Issue: `#5573`"),
    SnippetCheck("M232-A009-DOC-EXP-04", "Dependencies: none"),
    SnippetCheck(
        "M232-A009-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M232-A009-DOC-EXP-06",
        "`check:objc3c:m232-a009-lane-a-readiness`",
    ),
    SnippetCheck(
        "M232-A009-DOC-EXP-07",
        "`tmp/reports/m232/M232-A009/message_expression_grammar_and_selector_forms_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-A009-DOC-PKT-01",
        "# M232-A009 Message Expression Grammar and Selector Forms Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M232-A009-DOC-PKT-02", "Packet: `M232-A009`"),
    SnippetCheck("M232-A009-DOC-PKT-03", "Issue: `#5573`"),
    SnippetCheck("M232-A009-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M232-A009-DOC-PKT-05",
        "check:objc3c:m232-a009-message-expression-grammar-and-selector-forms-contract",
    ),
    SnippetCheck(
        "M232-A009-DOC-PKT-06",
        "tmp/reports/m232/M232-A009/message_expression_grammar_and_selector_forms_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M232-A009-PKG-03",
        '"check:objc3c:m232-a009-lane-a-readiness": '
        '"npm run check:objc3c:m232-a009-message-expression-grammar-and-selector-forms-contract '
        '&& npm run test:tooling:m232-a009-message-expression-grammar-and-selector-forms-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M232-A009-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M232-A009-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M232-A009-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M232-A009-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M232-A009-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M232-A009-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
