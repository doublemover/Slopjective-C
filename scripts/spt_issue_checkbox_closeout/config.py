...
from .models import CloseToolingConfig
...
def load_close_tooling_config(config_path: Path | None) -> CloseToolingConfig:
    ...
    if config_path is not None:
        resolved_config = resolve_root_path(config_path)
    ...
    catalog_default = resolve_root_path(Path(_expect_str(merged, "catalog_default", context)))
