#!/usr/bin/env python3
"""Fail-closed checker for M247-C007 lowering/codegen diagnostics hardening."""
...
MODE = "m247-c007-lowering-codegen-cost-profiling-controls-diagnostics-hardening-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c007_lane_c_readiness.py"
DEFAULT_C006_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m247_lane_c_lowering_codegen_cost_profiling_and_controls_edge_case_expansion_and_robustness_c006_expectations.md"
)
DEFAULT_C006_PACKET_DOC = (
    ...
    / "compiler"
    / "m247"
    / "m247_c006_lowering_codegen_cost_profiling_and_controls_edge_case_expansion_and_robustness_packet.md"
)
DEFAULT_C006_CHECKER = (
    ROOT
    / "scripts"
    / "check_m247_c006_lowering_codegen_cost_profiling_and_controls_edge_case_expansion_and_robustness_contract.py"
)
DEFAULT_C006_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m247_c006_lowering_codegen_cost_profiling_and_controls_edge_case_expansion_and_robustness_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C007-DOC-EXP-01",
        "Contract ID: `objc3c-lane-c-lowering-codegen-cost-profiling-controls-diagnostics-hardening-contract/m247-c007-v1`",
    ),
    SnippetCheck("M247-C007-DOC-EXP-02", "Dependencies: `M247-C006`"),
    SnippetCheck(
        "M247-C007-DOC-EXP-03",
        "Issue `#6748` defines canonical lane-C diagnostics hardening scope.",
    ),
    SnippetCheck(
        "M247-C007-DOC-EXP-04",
        "scripts/check_m247_c006_lowering_codegen_cost_profiling_and_controls_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M247-C007-DOC-EXP-05",
        "scripts/run_m247_c007_lane_c_readiness.py",
    ),
    SnippetCheck("M247-C007-DOC-EXP-06", "`check:objc3c:m247-c007-lane-c-readiness`"),
    SnippetCheck("M247-C007-DOC-EXP-07", "`check:objc3c:m247-c006-lane-c-readiness`"),
    SnippetCheck("M247-C007-DOC-EXP-08", "`C006 readiness -> C007 checker -> C007 pytest`."),
    SnippetCheck(
        "M247-C007-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C007-DOC-EXP-10",
        "tmp/reports/m247/M247-C007/lowering_codegen_cost_profiling_and_controls_diagnostics_hardening_contract_summary.json",
    ),
)
...
C006_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-C007-C006-DOC-02", "Dependencies: `M247-C005`"),
    SnippetCheck(
        "M247-C007-C006-DOC-03",
        "Issue `#6747` defines canonical lane-C edge-case expansion and robustness scope.",
    ),
)

C006_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C007-C006-PKT-01", "Packet: `M247-C006`"),
    SnippetCheck("M247-C007-C006-PKT-02", "Issue: `#6747`"),
    SnippetCheck("M247-C007-C006-PKT-03", "Dependencies: `M247-C005`"),
    SnippetCheck("M247-C007-C006-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C007-RUN-01", 'DEPENDENCY_TOKEN = "M247-C006"'),
    SnippetCheck("M247-C007-RUN-02", "check:objc3c:m247-c006-lane-c-readiness"),
    SnippetCheck(
        "M247-C007-RUN-03",
        "scripts/check_m247_c007_lowering_codegen_cost_profiling_and_controls_diagnostics_hardening_contract.py",
    ),
    ...
    SnippetCheck("M247-C007-RUN-05", "[ok] M247-C007 lane-C readiness chain completed"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C007-SPC-01",
        "lowering/codegen diagnostics hardening wiring shall preserve explicit lane-C dependency anchor (`M247-C006`)",
    ),
    SnippetCheck(
        "M247-C007-SPC-02",
        "edge-case robustness evidence commands drift",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-C007-META-02",
        "explicit `M247-C006` dependency continuity and fail-closed edge-case robustness evidence continuity",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M247-C007-CFG-03", "check:objc3c:m247-c007-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C007-CFG-04", "check:objc3c:m247-c006-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C007-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M247-C007-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M247-C007-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-C007-CFG-11", "test:objc3c:perf-budget"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-C007-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-C007-DOC-PKT-00", PACKET_SNIPPETS),
        ("c006_expectations_doc", args.c006_expectations_doc, "M247-C007-C006-DOC-00", C006_EXPECTATIONS_SNIPPETS),
        ("c006_packet_doc", args.c006_packet_doc, "M247-C007-C006-PKT-00", C006_PACKET_SNIPPETS),
        ("readiness_script", args.readiness_script, "M247-C007-RUN-00", READINESS_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M247-C007-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M247-C007-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M247-C007-META-00", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c006_checker, "M247-C007-DEP-01"),
        (args.c006_test, "M247-C007-DEP-02"),
    ):
