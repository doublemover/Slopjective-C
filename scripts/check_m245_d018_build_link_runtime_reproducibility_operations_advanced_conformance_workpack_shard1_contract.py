#!/usr/bin/env python3
"""Fail-closed checker for M245-D018 build/link/runtime reproducibility advanced conformance workpack shard 1."""
...
MODE = "m245-d018-build-link-runtime-reproducibility-operations-advanced-conformance-workpack-shard1-contract-v1"
...
DEFAULT_D017_CHECKER = (
    ROOT
    / "scripts"
    / "check_m245_d017_build_link_runtime_reproducibility_operations_advanced_diagnostics_workpack_shard1_contract.py"
)
DEFAULT_D017_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_d017_build_link_runtime_reproducibility_operations_advanced_diagnostics_workpack_shard1_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D018-DOC-PKT-01",
        "# M245-D018 Build/Link/Runtime Reproducibility Operations Advanced Conformance Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M245-D018-DOC-PKT-02", "Packet: `M245-D018`"),
    SnippetCheck("M245-D018-DOC-PKT-03", "Issue: `#6669`"),
    SnippetCheck("M245-D018-DOC-PKT-04", "Dependencies: `M245-D017`"),
    SnippetCheck("M245-D018-DOC-PKT-05", "Theme: `advanced conformance workpack (shard 1)`"),
    SnippetCheck(
        "M245-D018-DOC-PKT-06",
        "dependency continuity and code/spec anchors as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D018-DOC-PKT-07",
        "scripts/check_m245_d018_build_link_runtime_reproducibility_operations_advanced_conformance_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D018-DOC-PKT-08",
        "tests/tooling/test_check_m245_d018_build_link_runtime_reproducibility_operations_advanced_conformance_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D018-DOC-PKT-09",
    ...
    SnippetCheck("M245-D018-DOC-PKT-10", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-D018-DOC-PKT-11",
        "`python scripts/check_m245_d018_build_link_runtime_reproducibility_operations_advanced_conformance_workpack_shard1_contract.py --emit-json`",
    ),
)
...
D017_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D018-D017-DOC-01",
        "# M245 Build/Link/Runtime Reproducibility Operations Advanced Diagnostics Workpack (Shard 1) Expectations (D017)",
    ),
    SnippetCheck(
        "M245-D018-D017-DOC-02",
        "Contract ID: `objc3c-build-link-runtime-reproducibility-operations-advanced-diagnostics-workpack-shard1/m245-d017-v1`",
    ),
    SnippetCheck("M245-D018-D017-DOC-03", "Dependencies: `M245-D016`"),
)

D017_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-D018-D017-PKT-01", "Packet: `M245-D017`"),
    SnippetCheck("M245-D018-D017-PKT-02", "Issue: `#6668`"),
    SnippetCheck("M245-D018-D017-PKT-03", "Dependencies: `M245-D016`"),
    SnippetCheck("M245-D018-D017-PKT-04", "Freeze date: `2026-03-04`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D018-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D018-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D018-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D018-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D018-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D018-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d017_expectations_doc, "M245-D018-D017-DOC-EXISTS", D017_EXPECTATIONS_SNIPPETS),
        (args.d017_packet_doc, "M245-D018-D017-PKT-EXISTS", D017_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D018-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D018-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D018-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D018-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d017_checker, "M245-D018-DEP-D017-ARG-01"),
        (args.d017_test, "M245-D018-DEP-D017-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
