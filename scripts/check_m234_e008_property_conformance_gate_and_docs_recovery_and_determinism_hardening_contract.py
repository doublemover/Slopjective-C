#!/usr/bin/env python3
"""Fail-closed checker for M234-E008 property conformance gate and docs recovery and determinism hardening."""
...
MODE = "m234-e008-property-conformance-gate-docs-recovery-and-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_property_conformance_gate_and_docs_recovery_and_determinism_hardening_e008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_e008_property_conformance_gate_and_docs_recovery_and_determinism_hardening_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M234-E008-DEP-E007-01",
        Path("docs/contracts/m234_property_conformance_gate_and_docs_diagnostics_hardening_e007_expectations.md"),
    ),
    AssetCheck(
        "M234-E008-DEP-E007-02",
        Path("spec/planning/compiler/m234/m234_e007_property_conformance_gate_and_docs_diagnostics_hardening_packet.md"),
    ),
    AssetCheck(
        "M234-E008-DEP-E007-03",
        Path("scripts/check_m234_e007_property_conformance_gate_and_docs_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M234-E008-DEP-E007-04",
        Path("tests/tooling/test_check_m234_e007_property_conformance_gate_and_docs_diagnostics_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-E008-DOC-EXP-01",
        "# M234 Property Conformance Gate and Docs Recovery and Determinism Hardening Expectations (E008)",
    ),
    SnippetCheck(
        "M234-E008-DOC-EXP-02",
        "Contract ID: `objc3c-property-conformance-gate-docs-recovery-and-determinism-hardening/m234-e008-v1`",
    ),
    SnippetCheck(
        "M234-E008-DOC-EXP-03",
        "Issue `#5755` defines canonical lane-E recovery and determinism hardening scope.",
    ),
    SnippetCheck(
        "M234-E008-DOC-EXP-04",
        "Dependencies: `M234-E007`, `M234-A008`, `M234-B009`, `M234-C009`, `M234-D006`",
    ),
    SnippetCheck(
        "M234-E008-DOC-EXP-05",
        "docs/contracts/m234_property_conformance_gate_and_docs_diagnostics_hardening_e007_expectations.md",
    ),
    SnippetCheck(
        "M234-E008-DOC-EXP-06",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M234-E008-DOC-EXP-07",
        "`scripts/check_m234_e008_property_conformance_gate_and_docs_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M234-E008-DOC-EXP-08",
        "`tests/tooling/test_check_m234_e008_property_conformance_gate_and_docs_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M234-E008-DOC-EXP-09",
        "`tmp/reports/m234/M234-E008/property_conformance_gate_docs_recovery_and_determinism_hardening_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-E008-DOC-PKT-01",
        "# M234-E008 Property Conformance Gate and Docs Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M234-E008-DOC-PKT-02", "Packet: `M234-E008`"),
    SnippetCheck("M234-E008-DOC-PKT-03", "Issue: `#5755`"),
    SnippetCheck(
        "M234-E008-DOC-PKT-04",
        "Dependencies: `M234-E007`, `M234-A008`, `M234-B009`, `M234-C009`, `M234-D006`",
    ),
    SnippetCheck("M234-E008-DOC-PKT-05", "Theme: recovery and determinism hardening"),
    SnippetCheck(
        "M234-E008-DOC-PKT-06",
        "docs/contracts/m234_property_conformance_gate_and_docs_recovery_and_determinism_hardening_e008_expectations.md",
    ),
    SnippetCheck(
        "M234-E008-DOC-PKT-07",
        "scripts/check_m234_e008_property_conformance_gate_and_docs_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M234-E008-DOC-PKT-08",
        "tests/tooling/test_check_m234_e008_property_conformance_gate_and_docs_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M234-E008-DOC-PKT-09",
        "spec/planning/compiler/m234/m234_e007_property_conformance_gate_and_docs_diagnostics_hardening_packet.md",
    ),
    SnippetCheck(
        "M234-E008-DOC-PKT-10",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M234-E008-DOC-PKT-11",
        "tmp/reports/m234/M234-E008/property_conformance_gate_docs_recovery_and_determinism_hardening_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-E008-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M234-E008-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M234-E008-PKG-03", '"test:objc3c:diagnostics-replay-proof": '),
    SnippetCheck("M234-E008-PKG-04", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-E008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-E008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M234-E008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
