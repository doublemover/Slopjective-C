#!/usr/bin/env python3
"""Fail-closed checker for M246-B004 semantic invariants core feature expansion."""
...
MODE = "m246-b004-semantic-invariants-optimization-legality-core-feature-expansion-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_b004_lane_b_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M246-B004-DEP-B003-01",
        Path("docs/contracts/m246_semantic_invariants_for_optimization_legality_core_feature_implementation_b003_expectations.md"),
    ),
    AssetCheck(
        "M246-B004-DEP-B003-02",
        Path("spec/planning/compiler/m246/m246_b003_semantic_invariants_for_optimization_legality_core_feature_implementation_packet.md"),
    ),
    AssetCheck(
        "M246-B004-DEP-B003-03",
        Path("scripts/check_m246_b003_semantic_invariants_for_optimization_legality_core_feature_implementation_contract.py"),
    ),
    AssetCheck(
        "M246-B004-DEP-B003-04",
        Path("tests/tooling/test_check_m246_b003_semantic_invariants_for_optimization_legality_core_feature_implementation_contract.py"),
    ),
    AssetCheck(
        "M246-B004-OWN-01",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-B004-DOC-PKT-01",
        "# M246-B004 Semantic Invariants for Optimization Legality Core Feature Expansion Packet",
    ),
    SnippetCheck("M246-B004-DOC-PKT-02", "Packet: `M246-B004`"),
    SnippetCheck("M246-B004-DOC-PKT-03", "Issue: `#5063`"),
    SnippetCheck("M246-B004-DOC-PKT-04", "Dependencies: `M246-B003`"),
    SnippetCheck(
        "M246-B004-DOC-PKT-05",
        "scripts/check_m246_b004_semantic_invariants_for_optimization_legality_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-B004-DOC-PKT-06",
        "tests/tooling/test_check_m246_b004_semantic_invariants_for_optimization_legality_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-B004-DOC-PKT-07",
        "scripts/run_m246_b004_lane_b_readiness.py",
    ),
    SnippetCheck(
        "M246-B004-DOC-PKT-08",
        "scripts/check_m246_b003_semantic_invariants_for_optimization_legality_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M246-B004-DOC-PKT-09",
        "tests/tooling/test_check_m246_b003_semantic_invariants_for_optimization_legality_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M246-B004-DOC-PKT-10",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-B004-DOC-PKT-11",
        "tmp/reports/m246/M246-B004/semantic_invariants_optimization_legality_core_feature_expansion_summary.json",
    ),
    SnippetCheck(
        "M246-B004-DOC-PKT-12",
        "deterministic sorted failures and `--emit-json` support",
    ),
    SnippetCheck(
        "M246-B004-DOC-PKT-13",
        "`python scripts/check_m246_b004_semantic_invariants_for_optimization_legality_core_feature_expansion_contract.py --emit-json --summary-out tmp/reports/m246/M246-B004/semantic_invariants_optimization_legality_core_feature_expansion_summary.json`",
    ),
)
...
READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-B004-RUN-05", "[ok] M246-B004 lane-B readiness chain completed"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-B004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-B004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.readiness_script, "M246-B004-RUN-EXISTS", READINESS_SNIPPETS),
    ):
