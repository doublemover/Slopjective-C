#!/usr/bin/env python3
"""Fail-closed contract checker for M244-E007 interop conformance diagnostics hardening."""
...
MODE = "m244-e007-lane-e-interop-conformance-gate-operations-diagnostics-hardening-contract-v1"

ARTIFACTS: dict[str, Path] = {
    "expectations_doc": ROOT
    / "docs"
    / "contracts"
    / "m244_lane_e_interop_conformance_gate_and_operations_diagnostics_hardening_e007_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m244"
    / "m244_e007_lane_e_interop_conformance_gate_and_operations_diagnostics_hardening_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "architecture_doc": (
        ...
        (
            "M244-E007-ARCH-02",
            "(`M244-E006`, `M244-A005`, `M244-B008`, `M244-C009`, and `M244-D009`)",
        ),
        (
            "M244-E007-ARCH-03",
            "docs/contracts/m244_lane_e_interop_conformance_gate_and_operations_diagnostics_hardening_e007_expectations.md",
    ...
    "package_json": (
        ...
        (
            ...
            '&& npm run --if-present check:objc3c:m244-c009-lane-c-readiness '
            '&& npm run --if-present check:objc3c:m244-d009-lane-d-readiness '
            '&& npm run check:objc3c:m244-e007-lane-e-interop-conformance-gate-operations-diagnostics-hardening-contract '
            '&& npm run test:tooling:m244-e007-lane-e-interop-conformance-gate-operations-diagnostics-hardening-contract"',
        ),
        (
            "M244-E007-PKG-04",
