#!/usr/bin/env python3
"""Fail-closed checker for M230-A009 conformance corpus governance/sharding conformance matrix implementation."""
...
MODE = "m230-a009-conformance-corpus-governance-and-sharding-conformance-matrix-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_a009_conformance_corpus_governance_and_sharding_conformance_matrix_implementation_packet.md"
)
...
DEFAULT_A008_CHECKER = (
    ROOT / "scripts" / "check_m230_a008_conformance_corpus_governance_and_sharding_recovery_and_determinism_hardening_contract.py"
)
DEFAULT_A008_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m230_a008_conformance_corpus_governance_and_sharding_recovery_and_determinism_hardening_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[tuple[str, Path], ...] = (
    (
        "M230-A009-DEP-A008-01",
        Path("docs/contracts/m230_conformance_corpus_governance_and_sharding_recovery_and_determinism_hardening_a008_expectations.md"),
    ),
    (
        "M230-A009-DEP-A008-02",
        Path("spec/planning/compiler/m230/m230_a008_conformance_corpus_governance_and_sharding_recovery_and_determinism_hardening_packet.md"),
    ),
    (
        "M230-A009-DEP-A008-03",
        Path("scripts/check_m230_a008_conformance_corpus_governance_and_sharding_recovery_and_determinism_hardening_contract.py"),
    ),
    (
        "M230-A009-DEP-A008-04",
        Path("tests/tooling/test_check_m230_a008_conformance_corpus_governance_and_sharding_recovery_and_determinism_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-A009-DOC-EXP-01",
        "# M230 Conformance Corpus Governance and Sharding Conformance Matrix Implementation Expectations (A009)",
    ),
    SnippetCheck(
        "M230-A009-DOC-EXP-02",
        "Contract ID: `objc3c-conformance-corpus-governance-and-sharding-conformance-matrix-implementation/m230-a009-v1`",
    ),
    SnippetCheck("M230-A009-DOC-EXP-03", "Dependencies: `M230-A008`"),
    SnippetCheck(
        "M230-A009-DOC-EXP-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-A009-DOC-EXP-05",
        "check:objc3c:m230-a009-conformance-corpus-governance-and-sharding-conformance-matrix-implementation-contract",
    ),
    SnippetCheck(
        "M230-A009-DOC-EXP-06",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-A009-DOC-PKT-01",
        "# M230-A009 Conformance Corpus Governance and Sharding Conformance Matrix Implementation Packet",
    ),
    SnippetCheck("M230-A009-DOC-PKT-02", "Packet: `M230-A009`"),
    SnippetCheck("M230-A009-DOC-PKT-03", "Dependencies: `M230-A008`"),
    SnippetCheck(
        "M230-A009-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-A009-DOC-PKT-05",
...
A008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M230-A009-A008-PKT-01", "Packet: `M230-A008`"),
    SnippetCheck("M230-A009-A008-PKT-02", "Dependencies: `M230-A007`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m230-a009-conformance-corpus-governance-and-sharding-conformance-matrix-implementation-contract '
        '&& npm run test:tooling:m230-a009-conformance-corpus-governance-and-sharding-conformance-matrix-implementation-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M230-A009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M230-A009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a008_expectations_doc, "M230-A009-A008-EXP-EXISTS", A008_EXPECTATIONS_SNIPPETS),
        (args.a008_packet_doc, "M230-A009-A008-PKT-EXISTS", A008_PACKET_SNIPPETS),
        (args.architecture_doc, "M230-A009-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M230-A009-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M230-A009-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M230-A009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
