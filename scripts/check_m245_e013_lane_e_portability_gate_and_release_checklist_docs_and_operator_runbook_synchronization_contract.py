#!/usr/bin/env python3
"""Fail-closed checker for M245-E013 portability gate/release checklist docs and operator runbook synchronization."""
...
MODE = "m245-e013-lane-e-portability-gate-release-checklist-docs-and-operator-runbook-synchronization-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_lane_e_portability_gate_and_release_checklist_docs_and_operator_runbook_synchronization_e013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_e013_lane_e_portability_gate_and_release_checklist_docs_and_operator_runbook_synchronization_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M245-E013-DEP-E012-01",
        "M245-E012",
        Path("docs/contracts/m245_lane_e_portability_gate_and_release_checklist_cross_lane_integration_sync_e012_expectations.md"),
    ),
    AssetCheck(
        "M245-E013-DEP-E012-02",
        "M245-E012",
        Path("spec/planning/compiler/m245/m245_e012_lane_e_portability_gate_and_release_checklist_cross_lane_integration_sync_packet.md"),
    ),
    AssetCheck(
        "M245-E013-DEP-E012-03",
        "M245-E012",
        Path("scripts/check_m245_e012_lane_e_portability_gate_and_release_checklist_cross_lane_integration_sync_contract.py"),
    ),
    AssetCheck(
        "M245-E013-DEP-E012-04",
        "M245-E012",
        Path("tests/tooling/test_check_m245_e012_lane_e_portability_gate_and_release_checklist_cross_lane_integration_sync_contract.py"),
    ),
    AssetCheck(
        "M245-E013-DEP-A005-01",
        "M245-A005",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-E013-DOC-PKT-01",
        "# M245-E013 Lane-E Portability Gate and Release Checklist Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M245-E013-DOC-PKT-02", "Packet: `M245-E013`"),
    SnippetCheck("M245-E013-DOC-PKT-03", "Issue: `#5031`"),
    SnippetCheck(
        "M245-E013-DOC-PKT-04",
        "Dependencies: `M245-E012`, `M245-A005`, `M245-B006`, `M245-C007`, `M245-D009`",
    ),
    SnippetCheck("M245-E013-DOC-PKT-05", "Predecessor: `M245-E012`"),
    SnippetCheck("M245-E013-DOC-PKT-06", "Theme: docs and operator runbook synchronization"),
    SnippetCheck(
        "M245-E013-DOC-PKT-07",
    ...
    SnippetCheck(
        "M245-E013-DOC-PKT-08",
        "scripts/check_m245_e013_lane_e_portability_gate_and_release_checklist_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M245-E013-DOC-PKT-09",
        "tests/tooling/test_check_m245_e013_lane_e_portability_gate_and_release_checklist_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M245-E013-DOC-PKT-10",
    ...
    SnippetCheck("M245-E013-DOC-PKT-11", "check:objc3c:m245-e012-lane-e-readiness"),
    SnippetCheck("M245-E013-DOC-PKT-12", "check:objc3c:m245-a005-lane-a-readiness"),
    SnippetCheck("M245-E013-DOC-PKT-13", "check:objc3c:m245-b006-lane-b-readiness"),
    SnippetCheck("M245-E013-DOC-PKT-14", "check:objc3c:m245-c007-lane-c-readiness"),
    SnippetCheck("M245-E013-DOC-PKT-15", "check:objc3c:m245-d009-lane-d-readiness"),
    SnippetCheck(
        "M245-E013-DOC-PKT-16",
        "tmp/reports/m245/M245-E013/lane_e_portability_gate_release_checklist_docs_operator_runbook_synchronization_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-E013-PKG-01", '"check:objc3c:m245-e012-lane-e-readiness": '),
    SnippetCheck("M245-E013-PKG-02", '"check:objc3c:m245-a005-lane-a-readiness": '),
    SnippetCheck("M245-E013-PKG-03", '"check:objc3c:m245-b006-lane-b-readiness": '),
    SnippetCheck("M245-E013-PKG-04", '"check:objc3c:m245-c007-lane-c-readiness": '),
    SnippetCheck("M245-E013-PKG-05", '"check:objc3c:m245-d009-lane-d-readiness": '),
    SnippetCheck("M245-E013-PKG-06", '"compile:objc3c": '),
    SnippetCheck("M245-E013-PKG-07", '"proof:objc3c": '),
    SnippetCheck("M245-E013-PKG-08", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-E013-PKG-09", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-E013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-E013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M245-E013-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
