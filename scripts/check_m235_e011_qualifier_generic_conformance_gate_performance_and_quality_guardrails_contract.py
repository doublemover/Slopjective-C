#!/usr/bin/env python3
"""Fail-closed checker for M235-E011 qualifier/generic conformance gate performance and quality guardrails."""
...
MODE = "m235-e011-qualifier-generic-conformance-gate-performance-and-quality-guardrails-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_generic_conformance_gate_performance_and_quality_guardrails_e011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_e011_qualifier_generic_conformance_gate_performance_and_quality_guardrails_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m235/M235-E011/local_check_summary.json")
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-E011-DOC-EXP-01",
        "# M235 Qualifier Generic Conformance Gate Performance and Quality Guardrails Expectations (E003)",
    ),
    SnippetCheck(
        "M235-E011-DOC-EXP-02",
        "Contract ID: `objc3c-qualifier-generic-conformance-gate-core-feature-implementation/m235-e003-v1`",
    ),
    SnippetCheck("M235-E011-DOC-EXP-03", "Issue: `#5850`"),
    SnippetCheck(
        "M235-E011-DOC-EXP-04",
        "Dependencies: `M235-E010`, `M235-A003`, `M235-B006`, `M235-C004`, `M235-D002`",
    ),
    SnippetCheck(
        "M235-E011-DOC-EXP-05",
        "dependency carry-forward from E002",
    ),
    SnippetCheck(
        "M235-E011-DOC-EXP-06",
        "Issue `#5850` governs lane-E core feature implementation scope and dependency continuity from E002.",
    ),
    SnippetCheck("M235-E011-DOC-EXP-07", "| `M235-E010` |"),
    SnippetCheck("M235-E011-DOC-EXP-08", "| `M235-A003` |"),
    SnippetCheck("M235-E011-DOC-EXP-09", "| `M235-B006` |"),
    SnippetCheck("M235-E011-DOC-EXP-10", "| `M235-C004` |"),
    SnippetCheck("M235-E011-DOC-EXP-11", "| `M235-D002` |"),
    SnippetCheck(
        "M235-E011-DOC-EXP-12",
        "scripts/check_m235_e011_qualifier_generic_conformance_gate_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M235-E011-DOC-EXP-13",
        "tests/tooling/test_check_m235_e011_qualifier_generic_conformance_gate_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M235-E011-DOC-EXP-14",
        "tmp/reports/m235/M235-E011/local_check_summary.json",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-E011-DOC-PKT-01",
        "# M235-E011 Qualifier Generic Conformance Gate Performance and Quality Guardrails Packet",
    ),
    SnippetCheck("M235-E011-DOC-PKT-02", "Packet: `M235-E011`"),
    SnippetCheck("M235-E011-DOC-PKT-03", "Issue: `#5850`"),
    SnippetCheck(
        "M235-E011-DOC-PKT-04",
        "Dependencies: `M235-E010`, `M235-A003`, `M235-B006`, `M235-C004`, `M235-D002`",
    ),
    SnippetCheck(
        "M235-E011-DOC-PKT-05",
        "Dependency continuity from E002 remains fail-closed through these anchors:",
    ),
    SnippetCheck(
        "M235-E011-DOC-PKT-06",
        "docs/contracts/m235_qualifier_generic_conformance_gate_performance_and_quality_guardrails_e011_expectations.md",
    ),
    SnippetCheck(
        "M235-E011-DOC-PKT-07",
        "scripts/check_m235_e011_qualifier_generic_conformance_gate_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M235-E011-DOC-PKT-08",
        "tests/tooling/test_check_m235_e011_qualifier_generic_conformance_gate_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M235-E011-DOC-PKT-09",
        "python scripts/check_m235_e011_qualifier_generic_conformance_gate_performance_and_quality_guardrails_contract.py --summary-out tmp/reports/m235/M235-E011/local_check_summary.json",
    ),
    SnippetCheck(
        "M235-E011-DOC-PKT-10",
        "python -m pytest tests/tooling/test_check_m235_e011_qualifier_generic_conformance_gate_performance_and_quality_guardrails_contract.py -q",
    ),
    SnippetCheck(
        "M235-E011-DOC-PKT-11",
        "tmp/reports/m235/M235-E011/local_check_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-E011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-E011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
