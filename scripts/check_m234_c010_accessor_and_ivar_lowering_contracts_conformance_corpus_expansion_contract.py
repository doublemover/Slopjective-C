#!/usr/bin/env python3
"""Fail-closed checker for M234-C010 accessor and ivar lowering conformance corpus expansion."""
...
MODE = "m234-c010-accessor-and-ivar-lowering-contracts-conformance-corpus-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_accessor_and_ivar_lowering_contracts_conformance_corpus_expansion_c010_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_c010_accessor_and_ivar_lowering_contracts_conformance_corpus_expansion_packet.md"
)
DEFAULT_C009_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_accessor_and_ivar_lowering_contracts_conformance_matrix_implementation_c009_expectations.md"
)
DEFAULT_C009_PACKET_DOC = (
    ...
    / "compiler"
    / "m234"
    / "m234_c009_accessor_and_ivar_lowering_contracts_conformance_matrix_implementation_packet.md"
)
DEFAULT_C009_CHECKER = (
    ROOT / "scripts" / "check_m234_c009_accessor_and_ivar_lowering_contracts_conformance_matrix_implementation_contract.py"
)
DEFAULT_C009_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_c009_accessor_and_ivar_lowering_contracts_conformance_matrix_implementation_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-C010-DOC-PKT-01",
        "# M234-C010 Accessor and Ivar Lowering Contracts Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M234-C010-DOC-PKT-02", "Packet: `M234-C010`"),
    SnippetCheck("M234-C010-DOC-PKT-03", "Issue: `#5728`"),
    SnippetCheck("M234-C010-DOC-PKT-04", "Dependencies: `M234-C009`"),
    SnippetCheck(
        "M234-C010-DOC-PKT-05",
        "scripts/check_m234_c010_accessor_and_ivar_lowering_contracts_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M234-C010-DOC-PKT-06",
        "tests/tooling/test_check_m234_c010_accessor_and_ivar_lowering_contracts_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck("M234-C010-DOC-PKT-07", "`npm run check:objc3c:m234-c010-lane-c-readiness`"),
)

C009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-C010-C009-DOC-01",
        "# M234 Accessor and Ivar Lowering Contracts Conformance Matrix Implementation Expectations (C009)",
    ),
    SnippetCheck(
        "M234-C010-C009-DOC-02",
...
C009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-C010-C009-PKT-01", "Packet: `M234-C009`"),
    SnippetCheck("M234-C010-C009-PKT-02", "Dependencies: `M234-C008`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-C010-META-02",
        "explicit `M234-C009` dependency continuity so conformance corpus expansion drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-C010-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-C010-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-C010-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-C010-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str] | None = None) -> int:
    ...
    for path, exists_id, snippets in (
        (args.expectations_doc, "M234-C010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-C010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c009_expectations_doc, "M234-C010-C009-DOC-EXISTS", C009_EXPECTATIONS_SNIPPETS),
        (args.c009_packet_doc, "M234-C010-C009-PKT-EXISTS", C009_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-C010-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-C010-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-C010-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-C010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c009_checker, "M234-C010-C009-CHECKER-EXISTS"),
        (args.c009_test, "M234-C010-C009-TEST-EXISTS"),
    ):
