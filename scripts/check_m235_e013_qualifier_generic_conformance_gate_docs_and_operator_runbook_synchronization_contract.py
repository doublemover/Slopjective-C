#!/usr/bin/env python3
"""Fail-closed checker for M235-E013 qualifier/generic conformance gate docs and operator runbook synchronization."""
...
MODE = "m235-e013-qualifier-generic-conformance-gate-docs-and-operator-runbook-synchronization-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_generic_conformance_gate_docs_and_operator_runbook_synchronization_e013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_e013_qualifier_generic_conformance_gate_docs_and_operator_runbook_synchronization_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m235/M235-E013/local_check_summary.json")
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-E013-DOC-PKT-01",
        "# M235-E013 Qualifier Generic Conformance Gate Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M235-E013-DOC-PKT-02", "Packet: `M235-E013`"),
    SnippetCheck("M235-E013-DOC-PKT-03", "Issue: `#5852`"),
    SnippetCheck(
        "M235-E013-DOC-PKT-04",
        "Dependencies: `M235-E012`, `M235-A003`, `M235-B006`, `M235-C004`, `M235-D002`",
    ),
    SnippetCheck(
        "M235-E013-DOC-PKT-05",
        "Dependency continuity from E002 remains fail-closed through these anchors:",
    ),
    SnippetCheck(
        "M235-E013-DOC-PKT-06",
        "docs/contracts/m235_qualifier_generic_conformance_gate_docs_and_operator_runbook_synchronization_e013_expectations.md",
    ),
    SnippetCheck(
        "M235-E013-DOC-PKT-07",
        "scripts/check_m235_e013_qualifier_generic_conformance_gate_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M235-E013-DOC-PKT-08",
        "tests/tooling/test_check_m235_e013_qualifier_generic_conformance_gate_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M235-E013-DOC-PKT-09",
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-E013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-E013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
