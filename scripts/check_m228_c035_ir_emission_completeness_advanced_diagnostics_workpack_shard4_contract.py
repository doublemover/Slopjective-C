#!/usr/bin/env python3
"""Fail-closed validator for M228-C035 IR-emission advanced integration shard1 contract."""
...
MODE = "m228-c035-ir-emission-completeness-advanced-diagnostics-workpack-shard4-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c034_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c034_ir_emission_completeness_advanced_edge_compatibility_workpack_shard4_contract.py",
    "c034_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    ...
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_diagnostics_workpack_shard4_c035_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c035_ir_emission_completeness_advanced_diagnostics_workpack_shard4_packet.md",
}
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C035-RUN-04", "npm run check:objc3c:m228-c035-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C035-ARC-01",
    ...
    "package_json": (
        ("M228-C035-PKG-01", '"check:objc3c:m228-c034-lane-c-readiness"'),
        (
            "M228-C035-PKG-02",
            '"check:objc3c:m228-c035-ir-emission-completeness-advanced-diagnostics-workpack-shard4-contract"',
        ),
        (
            "M228-C035-PKG-03",
            '"test:tooling:m228-c035-ir-emission-completeness-advanced-diagnostics-workpack-shard4-contract"',
        ),
        ("M228-C035-PKG-04", '"check:objc3c:m228-c035-lane-c-readiness"'),
        (
            "M228-C035-PKG-05",
            '"check:objc3c:m228-c035-lane-c-readiness": "npm run check:objc3c:m228-c034-lane-c-readiness &&',
        ),
    ),
    "c034_contract_doc": (
        (
    ...
    "c034_tooling_test": (
        ("M228-C035-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c034_packet_doc": (
        ("M228-C035-DEP-04", "Packet: `M228-C034`"),
        ("M228-C035-DEP-05", "Issue: `#5260`"),
    ),
    "contract_doc": (
        (
            "M228-C035-DOC-01",
            "Contract ID: `objc3c-ir-emission-completeness-advanced-diagnostics-workpack-shard4/m228-c035-v1`",
        ),
        ("M228-C035-DOC-02", "Execute issue `#5261`"),
        ("M228-C035-DOC-03", "Dependencies: `M228-C034`"),
        (
            "M228-C035-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C035-PKT-02", "Packet: `M228-C035`"),
        ("M228-C035-PKT-03", "Issue: `#5261`"),
        ("M228-C035-PKT-04", "Dependencies: `M228-C034`"),
        (
            "M228-C035-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C035-FORB-01",
            '"check:objc3c:m228-c035-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C035/"
            "ir_emission_completeness_advanced_diagnostics_workpack_shard4_contract_summary.json"
        ),
    )
