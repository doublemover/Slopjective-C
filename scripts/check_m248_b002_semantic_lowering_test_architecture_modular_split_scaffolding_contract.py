#!/usr/bin/env python3
"""Fail-closed contract checker for the M248-B002 semantic/lowering modular split scaffolding packet."""
...
MODE = "m248-b002-semantic-lowering-test-architecture-modular-split-scaffolding-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B002-DOC-PKT-01",
        "# M248-B002 Semantic/Lowering Test Architecture Modular Split and Scaffolding Packet",
    ),
    SnippetCheck("M248-B002-DOC-PKT-02", "Packet: `M248-B002`"),
    SnippetCheck("M248-B002-DOC-PKT-03", "Dependencies: `M248-B001`"),
    SnippetCheck(
        "M248-B002-DOC-PKT-04",
        "`scripts/check_m248_b001_semantic_lowering_test_architecture_contract.py`",
    ),
    SnippetCheck(
        "M248-B002-DOC-PKT-05",
        "`check:objc3c:m248-b002-lane-b-readiness`",
    ),
    SnippetCheck(
        "M248-B002-DOC-PKT-06",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M248-B002-DOC-PKT-07",
        "code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M248-B002-DOC-PKT-08",
        "improvements as mandatory scope inputs.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-B002-META-02",
        "semantic fixture ownership evidence and lowering replay continuity so",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m248-b002-semantic-lowering-test-architecture-modular-split-scaffolding-contract '
        '&& npm run test:tooling:m248-b002-semantic-lowering-test-architecture-modular-split-scaffolding-contract"',
    ),
    SnippetCheck("M248-B002-PKG-04", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M248-B002-PKG-05", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M248-B002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-B002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
