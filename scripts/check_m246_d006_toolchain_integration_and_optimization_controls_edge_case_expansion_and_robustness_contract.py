#!/usr/bin/env python3
"""Fail-closed checker for M246-D006 toolchain integration/optimization controls edge-case expansion and robustness."""
...
MODE = "m246-d006-toolchain-integration-optimization-controls-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_d006_lane_d_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-D006-DOC-EXP-13",
        "tmp/reports/m246/M246-D006/toolchain_integration_optimization_controls_edge_case_expansion_and_robustness_contract_summary.json",
    ),
    SnippetCheck(
        "M246-D006-DOC-EXP-14",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D006-DOC-PKT-01",
        "# M246-D006 Toolchain Integration and Optimization Controls Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M246-D006-DOC-PKT-02", "Packet: `M246-D006`"),
    SnippetCheck("M246-D006-DOC-PKT-03", "Issue: `#6685`"),
    SnippetCheck("M246-D006-DOC-PKT-04", "Dependencies: `M246-D005`"),
    SnippetCheck("M246-D006-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-D006-DOC-PKT-06", "## Issue Anchor"),
    SnippetCheck(
        "M246-D006-DOC-PKT-07",
        "Canonical issue: `#6685`",
    ),
    SnippetCheck(
        "M246-D006-DOC-PKT-08",
        "Dependency anchors from `M246-D005`:",
    ),
    SnippetCheck(
        "M246-D006-DOC-PKT-09",
        "scripts/run_m246_d006_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M246-D006-DOC-PKT-10",
        "python scripts/check_m246_d006_toolchain_integration_and_optimization_controls_edge_case_expansion_and_robustness_contract.py --emit-json --summary-out tmp/reports/m246/M246-D006/toolchain_integration_optimization_controls_edge_case_expansion_and_robustness_contract_summary.json",
    ),
    SnippetCheck(
        "M246-D006-DOC-PKT-11",
    ...
    SnippetCheck(
        "M246-D006-DOC-PKT-12",
        "including dependency chain",
    ),
    SnippetCheck(
        "M246-D006-DOC-PKT-13",
        "tmp/reports/m246/M246-D006/toolchain_integration_optimization_controls_edge_case_expansion_and_robustness_contract_summary.json",
    ),
    SnippetCheck(
        "M246-D006-DOC-PKT-14",
...
D005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D006-D005-DOC-01",
        "Contract ID: `objc3c-toolchain-integration-optimization-controls-edge-case-and-compatibility-completion/m246-d005-v1`",
    ),
    SnippetCheck(
        "M246-D006-D005-DOC-02",
        "Dependencies: `M246-D004`",
    ),
    SnippetCheck(
        "M246-D006-D005-DOC-03",
        "Canonical issue: `#5110`",
    ),
)

D005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D006-D005-PKT-01", "Packet: `M246-D005`"),
    SnippetCheck("M246-D006-D005-PKT-02", "Issue: `#5110`"),
    SnippetCheck("M246-D006-D005-PKT-03", "Dependencies: `M246-D004`"),
    SnippetCheck("M246-D006-D005-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D006-RDY-01", 'DEPENDENCY_TOKEN = "M246-D005"'),
    SnippetCheck(
        "M246-D006-RDY-02",
    ...
    SnippetCheck("M246-D006-RDY-05", "[ok] M246-D006 lane-D readiness chain completed"),
)

D005_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D006-D005-RDY-01", 'DEPENDENCY_TOKEN = "M246-D004"'),
    SnippetCheck(
        "M246-D006-D005-RDY-02",
        "scripts/run_m246_d004_lane_d_readiness.py",
    ),
    SnippetCheck("M246-D006-D005-RDY-03", "[ok] M246-D005 lane-D readiness chain completed"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-D006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-D006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d005_expectations_doc, "M246-D006-D005-DOC-EXISTS", D005_EXPECTATIONS_SNIPPETS),
        (args.d005_packet_doc, "M246-D006-D005-PKT-EXISTS", D005_PACKET_SNIPPETS),
        (args.readiness_script, "M246-D006-RDY-EXISTS", READINESS_SNIPPETS),
        (args.d005_readiness_script, "M246-D006-D005-RDY-EXISTS", D005_READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d005_checker, "M246-D006-DEP-D005-ARG-01"),
        (args.d005_test, "M246-D006-DEP-D005-ARG-02"),
    ):
    ...
    if not summary_ok:
        print(
            f"[M246-D006-SUMMARY-WRITE-01] {display_path(summary_path)}: {summary_error}",
            file=sys.stderr,
        )
        return 1
