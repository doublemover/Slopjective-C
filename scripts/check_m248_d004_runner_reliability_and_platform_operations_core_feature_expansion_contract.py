#!/usr/bin/env python3
"""Fail-closed checker for M248-D004 runner/platform operations core feature expansion contract."""
...
MODE = "m248-d004-runner-reliability-platform-operations-core-feature-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_runner_reliability_and_platform_operations_core_feature_expansion_d004_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_d004_runner_reliability_and_platform_operations_core_feature_expansion_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M248-D004-D003-02",
        "M248-D003",
        Path("spec/planning/compiler/m248/m248_d003_runner_reliability_and_platform_operations_core_feature_implementation_packet.md"),
    ),
    AssetCheck(
        "M248-D004-D003-03",
        "M248-D003",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-D004-DOC-EXP-01",
        "Contract ID: `objc3c-runner-reliability-platform-operations-core-feature-expansion/m248-d004-v1`",
    ),
    SnippetCheck("M248-D004-DOC-EXP-02", "Dependencies: `M248-D003`"),
    SnippetCheck("M248-D004-DOC-EXP-03", "Issue `#6839` defines canonical lane-D core-feature expansion scope."),
    SnippetCheck("M248-D004-DOC-EXP-04", "`check:objc3c:m248-d004-lane-d-readiness`"),
    SnippetCheck("M248-D004-DOC-EXP-05", "`check:objc3c:m248-d003-lane-d-readiness`"),
    SnippetCheck("M248-D004-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M248-D004-DOC-EXP-07",
        "tmp/reports/m248/M248-D004/runner_reliability_and_platform_operations_core_feature_expansion_contract_summary.json",
    ),
    SnippetCheck(
        "M248-D004-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-D004-DOC-PKT-01", "Packet: `M248-D004`"),
    SnippetCheck("M248-D004-DOC-PKT-02", "Issue: `#6839`"),
    SnippetCheck("M248-D004-DOC-PKT-03", "Dependencies"),
    SnippetCheck("M248-D004-DOC-PKT-04", "`M248-D003`"),
    SnippetCheck(
        "M248-D004-DOC-PKT-05",
        "`scripts/check_m248_d004_runner_reliability_and_platform_operations_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M248-D004-DOC-PKT-06",
        "`tests/tooling/test_check_m248_d004_runner_reliability_and_platform_operations_core_feature_expansion_contract.py`",
    ),
    SnippetCheck("M248-D004-DOC-PKT-07", "`check:objc3c:m248-d004-lane-d-readiness`"),
    SnippetCheck(
        "M248-D004-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-D004-CFG-03", "check:objc3c:m248-d004-lane-d-readiness"),
    PackageScriptKeyCheck("M248-D004-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M248-D004-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M248-D004-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M248-D004-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-d003-lane-d-readiness && npm run check:objc3c:m248-d004-runner-reliability-platform-operations-core-feature-expansion-contract && npm run test:tooling:m248-d004-runner-reliability-platform-operations-core-feature-expansion-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-D004-SPC-02",
        "core-feature expansion evidence drift before downstream",
    ),
    SnippetCheck("M248-D004-SPC-03", "platform replay and lane-e gate integration advances."),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-D004-META-02",
        "explicit `M248-D003` dependency continuity and fail-closed expansion evidence continuity",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M248-D004-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M248-D004-DOC-PKT-00", PACKET_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M248-D004-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M248-D004-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M248-D004-META-00", METADATA_SPEC_SNIPPETS),
    ):
