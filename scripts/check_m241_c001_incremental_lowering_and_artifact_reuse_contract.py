#!/usr/bin/env python3
"""Fail-closed contract checker for M241-C001 qualified type lowering and ABI representation."""
...
MODE = "m241-c001-incremental-lowering-and-artifact-reuse-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m241"
    / "m241_c001_incremental_lowering_and_artifact_reuse_contract_and_architecture_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M241-C001-DOC-PKT-01",
        "# M241-C001 Qualified Type Lowering and ABI Representation Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M241-C001-DOC-PKT-02", "Packet: `M241-C001`"),
    SnippetCheck("M241-C001-DOC-PKT-03", "Issue: `#5811`"),
    SnippetCheck("M241-C001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M241-C001-DOC-PKT-05",
        "`check:objc3c:m241-c001-incremental-lowering-and-artifact-reuse-contract`",
    ),
    SnippetCheck("M241-C001-DOC-PKT-06", "`compile:objc3c`"),
    SnippetCheck("M241-C001-DOC-PKT-07", "`proof:objc3c`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M241-C001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M241-C001-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M241-C001-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M241-C001-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M241-C001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M241-C001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M241-C001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M241-C001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M241-C001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M241-C001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
