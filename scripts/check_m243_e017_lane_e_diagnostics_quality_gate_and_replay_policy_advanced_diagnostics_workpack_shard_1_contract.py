#!/usr/bin/env python3
"""Fail-closed checker for M243-E017 lane-E diagnostics gate/replay-policy cross-lane integration sync."""
...
MODE = "m243-e017-lane-e-diagnostics-quality-gate-replay-policy-advanced-diagnostics-workpack-shard-1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m243_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_1_e017_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m243"
    / "m243_e017_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_1_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        ...
        "M243-E016",
        Path(
            "scripts/check_m243_e016_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_edge_compatibility_workpack_shard_1_contract.py"
        ),
    ),
    AssetCheck(
        "M243-E017-E011-03",
        "M243-E016",
        Path(
            "tests/tooling/test_check_m243_e016_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_edge_compatibility_workpack_shard_1_contract.py"
        ),
    ),
    AssetCheck(
        "M243-E017-E011-04",
        "M243-E016",
        Path(
            "spec/planning/compiler/m243/m243_e016_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_edge_compatibility_workpack_shard_1_packet.md"
        ),
    ),
    AssetCheck(
        "M243-E017-A012-01",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M243-E017-DOC-EXP-01",
        "Contract ID: `objc3c-lane-e-diagnostics-quality-gate-replay-policy-advanced-diagnostics-workpack-shard-1/m243-e017-v1`",
    ),
    SnippetCheck(
        "M243-E017-DOC-EXP-02",
        "Dependencies: `M243-E016`, `M243-A012`, `M243-B012`, `M243-C011`, `M243-D012`",
    ),
    SnippetCheck("M243-E017-DOC-EXP-03", "Issue `#6503` defines the canonical lane-E dependency chain for E012."),
    SnippetCheck("M243-E017-DOC-EXP-04", "E011 contract anchors remain mandatory prerequisites:"),
    SnippetCheck("M243-E017-DOC-EXP-05", "`check:objc3c:m243-e012-lane-e-readiness`"),
    SnippetCheck("M243-E017-DOC-EXP-06", "`check:objc3c:m243-e011-lane-e-readiness`"),
    SnippetCheck("M243-E017-DOC-EXP-07", "`check:objc3c:m243-a012-lane-a-readiness`"),
    SnippetCheck("M243-E017-DOC-EXP-08", "`check:objc3c:m243-b012-lane-b-readiness`"),
    SnippetCheck("M243-E017-DOC-EXP-09", "`check:objc3c:m243-c011-lane-c-readiness`"),
    SnippetCheck("M243-E017-DOC-EXP-10", "`check:objc3c:m243-d012-lane-d-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M243-E017-DOC-PKT-01", "Packet: `M243-E017`"),
    SnippetCheck("M243-E017-DOC-PKT-02", "Issue: `#6503`"),
    SnippetCheck(
        "M243-E017-DOC-PKT-03",
        "Dependencies: `M243-E016`, `M243-A012`, `M243-B012`, `M243-C011`, `M243-D012`",
    ),
    SnippetCheck(
        "M243-E017-DOC-PKT-04",
        "`scripts/check_m243_e017_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_1_contract.py`",
    ),
    SnippetCheck(
        "M243-E017-DOC-PKT-05",
        "`tests/tooling/test_check_m243_e017_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_1_contract.py`",
    ),
    SnippetCheck(
        "M243-E017-DOC-PKT-06",
        "`tmp/reports/m243/M243-E017/lane_e_diagnostics_quality_gate_and_replay_policy_cross_lane_integration_sync_contract_summary.json`",
    ),
    SnippetCheck(
        "M243-E017-DOC-PKT-07",
        "`docs/contracts/m243_lane_e_diagnostics_quality_gate_and_replay_policy_performance_quality_guardrails_e011_expectations.md`",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    PackageScriptKeyCheck(
        "M243-E017-CFG-01",
        "check:objc3c:m243-e017-lane-e-diagnostics-quality-gate-replay-policy-advanced-diagnostics-workpack-shard-1-contract",
    ),
    PackageScriptKeyCheck(
        "M243-E017-CFG-02",
        "test:tooling:m243-e017-lane-e-diagnostics-quality-gate-replay-policy-advanced-diagnostics-workpack-shard-1-contract",
    ),
    PackageScriptKeyCheck("M243-E017-CFG-03", "check:objc3c:m243-e012-lane-e-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    PackageScriptCheck(
        "M243-E017-CFG-04",
        "check:objc3c:m243-e017-lane-e-diagnostics-quality-gate-replay-policy-advanced-diagnostics-workpack-shard-1-contract",
        "python scripts/check_m243_e017_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_1_contract.py",
    ),
    PackageScriptCheck(
        "M243-E017-CFG-05",
        "test:tooling:m243-e017-lane-e-diagnostics-quality-gate-replay-policy-advanced-diagnostics-workpack-shard-1-contract",
        "python -m pytest tests/tooling/test_check_m243_e017_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_1_contract.py -q",
    ),
    PackageScriptCheck(
        "M243-E017-CFG-06",
        "check:objc3c:m243-e012-lane-e-readiness",
        "npm run check:objc3c:m243-e011-lane-e-readiness && npm run check:objc3c:m243-a012-lane-a-readiness && npm run check:objc3c:m243-b012-lane-b-readiness && npm run check:objc3c:m243-c011-lane-c-readiness && npm run check:objc3c:m243-d012-lane-d-readiness && npm run check:objc3c:m243-e017-lane-e-diagnostics-quality-gate-replay-policy-advanced-diagnostics-workpack-shard-1-contract && npm run test:tooling:m243-e017-lane-e-diagnostics-quality-gate-replay-policy-advanced-diagnostics-workpack-shard-1-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M243-E017-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M243-E017-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M243-E017-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M243-E017-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M243-E017-META-00",
