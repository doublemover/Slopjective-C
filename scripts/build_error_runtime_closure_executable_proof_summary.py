...
CONTRACT_PATH = ROOT / "tests/tooling/fixtures/error_runtime_closure/executable_proof_abi_contract.json"
OUT_DIR = ROOT / "tmp/reports/error-runtime-closure/executable-proof-abi"
...
def main() -> int:
    ...
    checks = {
        "summary_script_link_matches": contract["summary_script"] == "scripts/build_error_runtime_closure_executable_proof_summary.py",
    ...
    summary = {
        "issue": "error-runtime-closure-executable-proof-abi-contract",
    ...
    MD_OUT.write_text(
        "# Error Runtime Closure Executable Proof ABI Summary\n\n"
