#!/usr/bin/env python3
"""Fail-closed checker for M244-B012 interop semantic/type mediation cross-lane integration sync contract."""
...
MODE = "m244-b012-interop-semantic-contracts-and-type-mediation-cross-lane-integration-sync-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_semantic_contracts_and_type_mediation_cross_lane_integration_sync_b012_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_b012_interop_semantic_contracts_and_type_mediation_cross_lane_integration_sync_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B012/"
    "interop_semantic_contracts_and_type_mediation_cross_lane_integration_sync_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B012-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-cross-lane-integration-sync/m244-b012-v1`",
    ),
    SnippetCheck("M244-B012-DOC-EXP-02", "Dependencies: `M244-B011`"),
    SnippetCheck(
        "M244-B012-DOC-EXP-03",
        "Issue `#6542` defines canonical lane-B cross-lane integration sync scope.",
    ),
    SnippetCheck(
        "M244-B012-DOC-EXP-04",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck("M244-B012-DOC-EXP-05", "`check:objc3c:m244-b012-lane-b-readiness`"),
    SnippetCheck("M244-B012-DOC-EXP-06", "`test:objc3c:sema-pass-manager-diagnostics-bus`"),
    SnippetCheck("M244-B012-DOC-EXP-07", "`test:objc3c:lowering-regression`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B012-DOC-PKT-01", "Packet: `M244-B012`"),
    SnippetCheck("M244-B012-DOC-PKT-02", "Issue: `#6542`"),
    SnippetCheck("M244-B012-DOC-PKT-03", "Dependencies: `M244-B011`"),
    SnippetCheck(
        "M244-B012-DOC-PKT-04",
        "`scripts/check_m244_b012_interop_semantic_contracts_and_type_mediation_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M244-B012-DOC-PKT-05",
        "`tests/tooling/test_check_m244_b012_interop_semantic_contracts_and_type_mediation_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck("M244-B012-DOC-PKT-06", "`test:objc3c:sema-pass-manager-diagnostics-bus`"),
    SnippetCheck("M244-B012-DOC-PKT-07", "`test:objc3c:lowering-regression`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B012-CFG-03", "check:objc3c:m244-b012-lane-b-readiness"),
    PackageScriptKeyCheck("M244-B012-CFG-04", "test:objc3c:sema-pass-manager-diagnostics-bus"),
    PackageScriptKeyCheck("M244-B012-CFG-05", "test:objc3c:lowering-regression"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b011-lane-b-readiness && npm run check:objc3c:m244-b012-interop-semantic-contracts-type-mediation-cross-lane-integration-sync-contract && npm run test:tooling:m244-b012-interop-semantic-contracts-type-mediation-cross-lane-integration-sync-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-B012-ARCH-02",
        "`M244-B011` dependency continuity and cross-lane integration evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B012-SPC-02", "lane-B dependency anchor (`M244-B011`)"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B012-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B012-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-B012-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-B012-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-B012-META-00",
