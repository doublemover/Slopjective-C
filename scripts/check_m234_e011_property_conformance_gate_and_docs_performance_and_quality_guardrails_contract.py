#!/usr/bin/env python3
"""Fail-closed checker for M234-E011 property conformance gate and docs performance and quality guardrails."""
...
MODE = "m234-e011-property-conformance-gate-docs-performance-and-quality-guardrails-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_property_conformance_gate_and_docs_performance_and_quality_guardrails_e011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_e011_property_conformance_gate_and_docs_performance_and_quality_guardrails_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-E011-DOC-PKT-01",
        "# M234-E011 Property Conformance Gate and Docs Performance and Quality Guardrails Packet",
    ),
    SnippetCheck("M234-E011-DOC-PKT-02", "Packet: `M234-E011`"),
    SnippetCheck("M234-E011-DOC-PKT-03", "Issue: `#5758`"),
    SnippetCheck(
        "M234-E011-DOC-PKT-04",
        "Dependencies: `M234-E010`, `M234-A011`, `M234-B012`, `M234-C012`, `M234-D008`",
    ),
    SnippetCheck("M234-E011-DOC-PKT-05", "Predecessor: `M234-E010`"),
    SnippetCheck("M234-E011-DOC-PKT-06", "Theme: performance and quality guardrails"),
    SnippetCheck(
        "M234-E011-DOC-PKT-07",
        "docs/contracts/m234_property_conformance_gate_and_docs_performance_and_quality_guardrails_e011_expectations.md",
    ),
    SnippetCheck(
        "M234-E011-DOC-PKT-08",
        "scripts/check_m234_e011_property_conformance_gate_and_docs_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M234-E011-DOC-PKT-09",
        "tests/tooling/test_check_m234_e011_property_conformance_gate_and_docs_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck(
        "M234-E011-DOC-PKT-10",
        "spec/planning/compiler/m234/m234_e010_property_conformance_gate_and_docs_conformance_corpus_expansion_packet.md",
    ),
    SnippetCheck(
        "M234-E011-DOC-PKT-11",
        "performance and quality guardrails traceability, and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M234-E011-DOC-PKT-12",
        "tmp/reports/m234/M234-E011/property_conformance_gate_docs_performance_and_quality_guardrails_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-E011-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M234-E011-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M234-E011-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-E011-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-E011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-E011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M234-E011-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
