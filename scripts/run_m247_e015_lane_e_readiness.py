...
BASELINE_DEPENDENCIES = ("M247-E014",)
...
INITIAL_COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    (
        ...
        "run",
        "--if-present",
        "check:objc3c:m247-e014-lane-e-readiness",
    ),
    (
        NPM_EXECUTABLE,
        "run",
    ...
    (
        ...
        "run",
        "--if-present",
        "check:objc3c:m247-c016-lane-c-readiness",
    ),
    (
        NPM_EXECUTABLE,
        "run",
        "--if-present",
        "check:objc3c:m247-d012-lane-d-readiness",
    ),
)
...
def run_chain() -> int:
    ...
    if RUN_TRANSITIVE_DEPENDENCIES:
        ...
        print(
            ...
            "lane-isolated E015 readiness validation"
        )
    ...
    print("[ok] M247-E015 lane-E readiness chain completed")
    return 0
