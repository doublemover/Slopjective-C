#!/usr/bin/env python3
"""Fail-closed checker for M244-D022 runtime/link bridge-path integration closeout and gate sign-off contract."""
...
MODE = "m244-d022-runtime-link-bridge-path-integration-closeout-and-gate-sign-off-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_runtime_link_bridge_path_integration_closeout_and_gate_sign_off_d022_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_d022_runtime_link_bridge_path_integration_closeout_and_gate_sign_off_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-D022-D021-01",
        "M244-D021",
        Path("docs/contracts/m244_runtime_link_bridge_path_advanced_core_workpack_shard2_d021_expectations.md"),
    ),
    AssetCheck(
        "M244-D022-D021-02",
        "M244-D021",
        Path("spec/planning/compiler/m244/m244_d021_runtime_link_bridge_path_advanced_core_workpack_shard2_packet.md"),
    ),
    AssetCheck(
        "M244-D022-D021-03",
        "M244-D021",
        Path("scripts/check_m244_d021_runtime_link_bridge_path_advanced_core_workpack_shard2_contract.py"),
    ),
    AssetCheck(
        "M244-D022-D021-04",
        "M244-D021",
        Path("tests/tooling/test_check_m244_d021_runtime_link_bridge_path_advanced_core_workpack_shard2_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D022-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-bridge-path-integration-closeout-and-gate-sign-off/m244-d022-v1`",
    ),
    SnippetCheck("M244-D022-DOC-EXP-02", "Dependencies: `M244-D021`"),
    SnippetCheck("M244-D022-DOC-EXP-03", "Issue `#6594` defines canonical lane-D integration closeout and gate sign-off scope."),
    SnippetCheck("M244-D022-DOC-EXP-04", "`check:objc3c:m244-d022-lane-d-readiness`"),
    SnippetCheck("M244-D022-DOC-EXP-05", "`check:objc3c:m244-d021-lane-d-readiness`"),
    SnippetCheck("M244-D022-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M244-D022-DOC-EXP-07",
        "tmp/reports/m244/M244-D022/runtime_link_bridge_path_integration_closeout_and_gate_sign_off_contract_summary.json",
    ),
    SnippetCheck(
        "M244-D022-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-D022-DOC-PKT-01", "Packet: `M244-D022`"),
    SnippetCheck("M244-D022-DOC-PKT-02", "Issue: `#6594`"),
    SnippetCheck("M244-D022-DOC-PKT-03", "Dependencies: `M244-D021`"),
    SnippetCheck(
        "M244-D022-DOC-PKT-04",
        "`scripts/check_m244_d022_runtime_link_bridge_path_integration_closeout_and_gate_sign_off_contract.py`",
    ),
    SnippetCheck(
        "M244-D022-DOC-PKT-05",
        "`tests/tooling/test_check_m244_d022_runtime_link_bridge_path_integration_closeout_and_gate_sign_off_contract.py`",
    ),
    SnippetCheck("M244-D022-DOC-PKT-06", "`check:objc3c:m244-d022-lane-d-readiness`"),
    SnippetCheck(
        "M244-D022-DOC-PKT-07",
        "`python scripts/check_m244_d022_runtime_link_bridge_path_integration_closeout_and_gate_sign_off_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M244-D022-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-D022-CFG-03", "check:objc3c:m244-d022-lane-d-readiness"),
    PackageScriptKeyCheck("M244-D022-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M244-D022-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M244-D022-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-D022-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-d021-lane-d-readiness && npm run check:objc3c:m244-d022-runtime-link-bridge-path-integration-closeout-and-gate-sign-off-contract && npm run test:tooling:m244-d022-runtime-link-bridge-path-integration-closeout-and-gate-sign-off-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-D022-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-D022-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-D022-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-D022-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-D022-META-00",
