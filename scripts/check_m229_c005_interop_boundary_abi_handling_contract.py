#!/usr/bin/env python3
"""Fail-closed checker for M229-C005 interop boundary ABI handling contract freeze."""
...
MODE = "m229-c005-interop-boundary-abi-handling-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_c005_interop_boundary_abi_handling_edge_case_and_compatibility_completion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-C005-DOC-PKT-01",
        "# M229-C005 Interop boundary ABI handling Edge-case and Compatibility Completion Packet",
    ),
    SnippetCheck("M229-C005-DOC-PKT-02", "Packet: `M229-C005`"),
    SnippetCheck("M229-C005-DOC-PKT-03", "Issue: `#5333`"),
    SnippetCheck("M229-C005-DOC-PKT-04", "Dependencies: `M229-C004`"),
    SnippetCheck(
        "M229-C005-DOC-PKT-05",
        "check:objc3c:m229-c005-interop-boundary-abi-handling-edge-case-and-compatibility-completion-contract",
    ),
    SnippetCheck(
        "M229-C005-DOC-PKT-06",
        "tmp/reports/m229/M229-C005/interop_boundary_abi_handling_edge_case_and_compatibility_completion_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-C005-PKG-03",
        '"check:objc3c:m229-c005-lane-c-readiness": '
        '"npm run check:objc3c:m229-c004-lane-c-readiness && npm run check:objc3c:m229-c005-interop-boundary-abi-handling-edge-case-and-compatibility-completion-contract '
        '&& npm run test:tooling:m229-c005-interop-boundary-abi-handling-edge-case-and-compatibility-completion-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-C005-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-C005-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-C005-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-C005-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-C005-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-C005-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
