#!/usr/bin/env python3
"""Fail-closed checker for M248-E001 lane-E CI governance gate/closeout policy freeze."""
...
MODE = "m248-e001-lane-e-ci-governance-gate-closeout-policy-contract-architecture-freeze-contract-v1"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M248-E001-DEP-A001-01",
        Path("docs/contracts/m248_suite_partitioning_and_fixture_ownership_contract_freeze_a001_expectations.md"),
    ),
    AssetCheck(
        "M248-E001-DEP-A001-02",
        Path("scripts/check_m248_a001_suite_partitioning_and_fixture_ownership_contract.py"),
    ),
    AssetCheck(
        "M248-E001-DEP-A001-03",
        Path("tests/tooling/test_check_m248_a001_suite_partitioning_and_fixture_ownership_contract.py"),
    ),
    AssetCheck(
        "M248-E001-DEP-B001-01",
        Path("docs/contracts/m248_semantic_lowering_test_architecture_contract_freeze_b001_expectations.md"),
    ),
    AssetCheck(
        "M248-E001-DEP-B001-02",
        Path("scripts/check_m248_b001_semantic_lowering_test_architecture_contract.py"),
    ),
    AssetCheck(
        "M248-E001-DEP-B001-03",
        Path("tests/tooling/test_check_m248_b001_semantic_lowering_test_architecture_contract.py"),
    ),
    AssetCheck(
        "M248-E001-DEP-C001-01",
        Path("docs/contracts/m248_replay_harness_and_artifact_contracts_contract_freeze_c001_expectations.md"),
    ),
    AssetCheck(
        "M248-E001-DEP-C001-02",
        Path("scripts/check_m248_c001_replay_harness_and_artifact_contracts_contract.py"),
    ),
    AssetCheck(
        "M248-E001-DEP-C001-03",
        Path("tests/tooling/test_check_m248_c001_replay_harness_and_artifact_contracts_contract.py"),
    ),
    AssetCheck(
        "M248-E001-DEP-D001-01",
        Path("docs/contracts/m248_runner_reliability_and_platform_operations_contract_freeze_d001_expectations.md"),
    ),
    AssetCheck(
        "M248-E001-DEP-D001-02",
        Path("scripts/check_m248_d001_runner_reliability_and_platform_operations_contract.py"),
    ),
    AssetCheck(
        "M248-E001-DEP-D001-03",
        Path("tests/tooling/test_check_m248_d001_runner_reliability_and_platform_operations_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-E001-DOC-EXP-01",
        "# M248 Lane E CI Governance Gate and Closeout Policy Contract and Architecture Freeze Expectations (E001)",
    ),
    SnippetCheck(
        "M248-E001-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-ci-governance-gate-closeout-policy-contract-architecture-freeze/m248-e001-v1`",
    ),
    SnippetCheck("M248-E001-DOC-EXP-03", "Issue `#6861` defines canonical lane-E freeze scope."),
    SnippetCheck(
        "M248-E001-DOC-EXP-04",
        "Dependencies: `M248-A001`, `M248-B001`, `M248-C001`, `M248-D001`",
    ),
    SnippetCheck(
        "M248-E001-DOC-EXP-05",
        "anchors remain explicit, deterministic, and traceable across readiness wiring",
    ),
    SnippetCheck(
        "M248-E001-DOC-EXP-06",
        "`check:objc3c:m248-e001-ci-governance-gate-closeout-policy-contract-architecture-freeze-contract`",
    ),
    SnippetCheck("M248-E001-DOC-EXP-07", "`check:objc3c:m248-e001-lane-e-readiness`"),
    SnippetCheck("M248-E001-DOC-EXP-08", "`compile:objc3c`"),
    SnippetCheck("M248-E001-DOC-EXP-09", "`proof:objc3c`"),
    SnippetCheck("M248-E001-DOC-EXP-10", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M248-E001-DOC-EXP-11", "`test:objc3c:perf-budget`"),
    SnippetCheck(
        "M248-E001-DOC-EXP-12",
        "`tmp/reports/m248/M248-E001/lane_e_ci_governance_gate_closeout_policy_contract_and_architecture_freeze_summary.json`",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-E001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M248-E001-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M248-E001-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M248-E001-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-E001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.package_json, "M248-E001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
