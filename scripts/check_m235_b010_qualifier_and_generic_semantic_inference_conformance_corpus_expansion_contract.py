#!/usr/bin/env python3
"""Fail-closed checker for M235-B010 qualifier/generic semantic inference conformance corpus expansion."""
...
MODE = "m235-b010-qualifier-and-generic-semantic-inference-conformance-corpus-expansion-contract-v1"
...
DEFAULT_B009_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m235_b009_qualifier_and_generic_semantic_inference_conformance_matrix_implementation_contract.py"
)
...
B009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B010-B009-PKT-01", "Packet: `M235-B009`"),
    SnippetCheck("M235-B010-B009-PKT-02", "Dependencies: `M235-B008`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B010-META-02",
        "explicit `M235-B009` dependency continuity so conformance corpus expansion drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-B010-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B010-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b009_expectations_doc, "M235-B010-B009-DOC-EXISTS", B009_EXPECTATIONS_SNIPPETS),
        (args.b009_packet_doc, "M235-B010-B009-PKT-EXISTS", B009_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B010-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B010-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B010-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b009_checker, "M235-B010-DEP-B009-ARG-01"),
        (args.b009_test, "M235-B010-DEP-B009-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
