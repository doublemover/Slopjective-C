#!/usr/bin/env python3
"""Fail-closed validator for M227-E005 semantic conformance lane-E edge-case compatibility completion."""
...
MODE = "m227-e005-semantic-conformance-lane-e-edge-case-compatibility-completion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_lane_e_semantic_conformance_edge_case_compatibility_completion_e005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_e005_semantic_conformance_lane_e_edge_case_compatibility_completion_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-E005-E004-01",
        "M227-E004",
        Path("docs/contracts/m227_lane_e_semantic_conformance_core_feature_expansion_e004_expectations.md"),
    ),
    AssetCheck(
        "M227-E005-E004-02",
        "M227-E004",
        Path("scripts/check_m227_e004_semantic_conformance_lane_e_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M227-E005-E004-03",
        "M227-E004",
        Path("tests/tooling/test_check_m227_e004_semantic_conformance_lane_e_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M227-E005-E004-04",
        "M227-E004",
        Path("spec/planning/compiler/m227/m227_e004_semantic_conformance_lane_e_core_feature_expansion_packet.md"),
    ),
    AssetCheck(
        "M227-E005-A005-01",
        "M227-A005",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-E005-EXP-03",
        "# M227 Lane E Semantic Conformance Edge-Case and Compatibility Completion Expectations (E005)",
    ),
    SnippetCheck(
        "M227-E005-EXP-04",
        "Contract ID: `objc3c-lane-e-semantic-conformance-edge-case-compatibility-completion-contract/m227-e005-v1`",
    ),
    SnippetCheck(
        "M227-E005-EXP-05",
    ...
    SnippetCheck(
        "M227-E005-EXP-06",
        "Issue `#5163` governs lane-E edge-case and compatibility completion scope and dependency-token/reference continuity.",
    ),
    SnippetCheck("M227-E005-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-E005-EXP-08",
        "checker `scripts/check_m227_e004_semantic_conformance_lane_e_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M227-E005-EXP-09",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E005-PKT-04", "Packet: `M227-E005`"),
    SnippetCheck("M227-E005-PKT-05", "Issue: `#5163`"),
    SnippetCheck("M227-E005-PKT-06", "Scaffold date: `2026-03-03`"),
    SnippetCheck(
        "M227-E005-PKT-07",
        "Dependencies: `M227-E004`, `M227-A005`, `M227-B005`, `M227-C005`, `M227-D005`",
    ),
    SnippetCheck("M227-E005-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-E005-PKT-09",
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-E004": "scripts/check_m227_e004_semantic_conformance_lane_e_core_feature_expansion_contract.py",
...
def run(argv: Sequence[str]) -> int:
    ...
    try:
        ...
        check(
            ...
            check_id="M227-E005-EXP-01",
            condition=True,
            detail="",
        )
        check(
            artifact="expectations_doc",
            check_id="M227-E005-EXP-02",
            condition=True,
            detail="",
        )
    ...
    try:
        ...
        check(
            artifact="packet_doc",
            check_id="M227-E005-PKT-01",
            condition=True,
            detail="",
        )
        check(
            artifact="packet_doc",
            check_id="M227-E005-PKT-02",
            condition=True,
            detail="",
        )
    except ValueError as exc:
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-E005-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if findings:
        print(
            "m227-e005-semantic-conformance-lane-e-edge-case-compatibility-completion: "
    ...
    print("m227-e005-semantic-conformance-lane-e-edge-case-compatibility-completion: OK")
    print(f"- mode={MODE}")
