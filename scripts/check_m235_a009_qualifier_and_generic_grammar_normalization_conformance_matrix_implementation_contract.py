#!/usr/bin/env python3
"""Fail-closed checker for M235-A009 qualifier/generic grammar normalization conformance matrix implementation."""
...
MODE = "m235-a009-qualifier-and-generic-grammar-normalization-conformance-matrix-implementation-contract-v1"
...
DEFAULT_A008_CHECKER = (
    ROOT / "scripts" / "check_m235_a008_qualifier_and_generic_grammar_normalization_recovery_and_determinism_hardening_contract.py"
)
DEFAULT_A008_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_a008_qualifier_and_generic_grammar_normalization_recovery_and_determinism_hardening_contract.py"
)
...
A008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-A009-A008-PKT-01", "Packet: `M235-A008`"),
    SnippetCheck("M235-A009-A008-PKT-02", "Dependencies: `M235-A007`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-A009-META-02",
        "explicit `M235-A008` dependency continuity so conformance matrix implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m235-a009-qualifier-and-generic-grammar-normalization-conformance-matrix-implementation-contract '
        '&& npm run test:tooling:m235-a009-qualifier-and-generic-grammar-normalization-conformance-matrix-implementation-contract"',
    ),
    SnippetCheck("M235-A009-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-A009-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-A009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-A009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a008_expectations_doc, "M235-A009-A008-DOC-EXISTS", A008_EXPECTATIONS_SNIPPETS),
        (args.a008_packet_doc, "M235-A009-A008-PKT-EXISTS", A008_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-A009-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-A009-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-A009-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-A009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a008_checker, "M235-A009-DEP-A008-ARG-01"),
        (args.a008_test, "M235-A009-DEP-A008-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
