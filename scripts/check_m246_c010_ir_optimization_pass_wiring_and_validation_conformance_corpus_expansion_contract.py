#!/usr/bin/env python3
"""Fail-closed checker for M246-C010 IR optimization pass wiring conformance corpus expansion."""
...
MODE = "m246-c010-ir-optimization-pass-wiring-validation-conformance-corpus-expansion-contract-v1"
...
DEFAULT_C009_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c009_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c010_lane_c_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-C010-DOC-PKT-07",
        "scripts/check_m246_c010_ir_optimization_pass_wiring_and_validation_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-C010-DOC-PKT-08",
        "tests/tooling/test_check_m246_c010_ir_optimization_pass_wiring_and_validation_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-C010-DOC-PKT-09",
        "scripts/run_m246_c010_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C010-DOC-PKT-10",
        "scripts/run_m246_c009_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C010-DOC-PKT-11",
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C010-C001-02", "Dependencies: none"),
)
...
C009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C010-C009-EXP-01",
        "Contract ID: `objc3c-ir-optimization-pass-wiring-validation-conformance-matrix-implementation/m246-c009-v1`",
    ),
    SnippetCheck(
        "M246-C010-C009-EXP-02",
        "Dependencies: `M246-C008`",
    ),
    SnippetCheck(
        "M246-C010-C009-EXP-03",
        "scripts/run_m246_c009_lane_c_readiness.py",
    ),
)

C009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-C010-C009-PKT-01", "Packet: `M246-C009`"),
    SnippetCheck("M246-C010-C009-PKT-02", "Dependencies: `M246-C008`"),
    SnippetCheck("M246-C010-C009-PKT-03", "scripts/run_m246_c009_lane_c_readiness.py"),
)

C009_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C010-C009-RUN-01",
        "scripts/run_m246_c008_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C010-C009-RUN-02",
        "scripts/check_m246_c009_ir_optimization_pass_wiring_and_validation_conformance_matrix_implementation_contract.py",
    ),
    SnippetCheck(
        "M246-C010-C009-RUN-03",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C010-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-C010-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-C010-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C010-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c009-readiness-script", type=Path, default=DEFAULT_C009_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M246-C010-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M246-C010-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.c009_expectations_doc, "M246-C010-C009-EXP-EXISTS", C009_EXPECTATIONS_SNIPPETS),
        (args.c009_packet_doc, "M246-C010-C009-PKT-EXISTS", C009_PACKET_SNIPPETS),
        (args.c009_readiness_script, "M246-C010-C009-RUN-EXISTS", C009_READINESS_SNIPPETS),
        (args.readiness_script, "M246-C010-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M246-C010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
