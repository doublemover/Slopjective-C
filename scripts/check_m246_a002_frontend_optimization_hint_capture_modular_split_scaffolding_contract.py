#!/usr/bin/env python3
"""Fail-closed checker for M246-A002 frontend optimization hint capture modular split/scaffolding."""
...
MODE = "m246-a002-frontend-optimization-hint-capture-modular-split-scaffolding-contract-v1"
...
DEFAULT_A001_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m246_frontend_optimization_hint_capture_contract_and_architecture_freeze_a001_expectations.md"
)
DEFAULT_A001_PACKET_DOC = (
    ...
    / "compiler"
    / "m246"
    / "m246_a001_frontend_optimization_hint_capture_contract_and_architecture_freeze_packet.md"
)
...
DEFAULT_A001_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m246_a001_frontend_optimization_hint_capture_contract_and_architecture_freeze_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-A002-DOC-PKT-01",
        "# M246-A002 Frontend Optimization Hint Capture Modular Split/Scaffolding Packet",
    ),
    SnippetCheck("M246-A002-DOC-PKT-02", "Packet: `M246-A002`"),
    SnippetCheck("M246-A002-DOC-PKT-03", "Issue: `#5049`"),
    SnippetCheck("M246-A002-DOC-PKT-04", "Dependencies: `M246-A001`"),
    SnippetCheck(
        "M246-A002-DOC-PKT-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-A002-DOC-PKT-06",
        "docs/contracts/m246_frontend_optimization_hint_capture_modular_split_scaffolding_a002_expectations.md",
    ),
    SnippetCheck(
        "M246-A002-DOC-PKT-07",
        "scripts/check_m246_a002_frontend_optimization_hint_capture_modular_split_scaffolding_contract.py",
    ),
    SnippetCheck(
        "M246-A002-DOC-PKT-08",
        "tests/tooling/test_check_m246_a002_frontend_optimization_hint_capture_modular_split_scaffolding_contract.py",
    ),
    SnippetCheck(
        "M246-A002-DOC-PKT-09",
        "`python scripts/check_m246_a002_frontend_optimization_hint_capture_modular_split_scaffolding_contract.py --emit-json`",
    ),
    SnippetCheck("M246-A002-DOC-PKT-10", "`npm run check:objc3c:m246-a002-lane-a-readiness`"),
    SnippetCheck(
        "M246-A002-DOC-PKT-11",
        "`tmp/reports/m246/M246-A002/frontend_optimization_hint_capture_modular_split_scaffolding_summary.json`",
    ),
    SnippetCheck(
        "M246-A002-DOC-PKT-12",
...
A001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-A002-A001-DOC-01",
        "# M246 Frontend Optimization Hint Capture Contract and Architecture Freeze Expectations (A001)",
    ),
    SnippetCheck(
        "M246-A002-A001-DOC-02",
        "Contract ID: `objc3c-frontend-optimization-hint-capture/m246-a001-v1`",
    ),
    SnippetCheck("M246-A002-A001-DOC-03", "- Issue: `#5048`"),
    SnippetCheck(
        "M246-A002-A001-DOC-04",
        "optimization improvements as mandatory scope inputs.",
    ),
)

A001_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A002-A001-PKT-01", "Packet: `M246-A001`"),
    SnippetCheck("M246-A002-A001-PKT-02", "Issue: `#5048`"),
    SnippetCheck("M246-A002-A001-PKT-03", "Dependencies: none"),
    SnippetCheck(
        "M246-A002-A001-PKT-04",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-A002-META-02",
        "explicit `M246-A001` dependency continuity so hint-capture scaffolding drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m246-a002-frontend-optimization-hint-capture-modular-split-scaffolding-contract '
        '&& npm run test:tooling:m246-a002-frontend-optimization-hint-capture-modular-split-scaffolding-contract"',
    ),
    SnippetCheck("M246-A002-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M246-A002-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M246-A002-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-A002-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-A002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-A002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a001_expectations_doc, "M246-A002-A001-DOC-EXISTS", A001_EXPECTATIONS_SNIPPETS),
        (args.a001_packet_doc, "M246-A002-A001-PKT-EXISTS", A001_PACKET_SNIPPETS),
        (args.architecture_doc, "M246-A002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M246-A002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M246-A002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M246-A002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a001_checker, "M246-A002-DEP-A001-ARG-01"),
        (args.a001_test, "M246-A002-DEP-A001-ARG-02"),
    ):
        checks_total += 1
        if not path.exists() or not path.is_file():
            failures.append(
