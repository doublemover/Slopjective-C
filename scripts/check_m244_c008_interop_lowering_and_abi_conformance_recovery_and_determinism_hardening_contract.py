#!/usr/bin/env python3
"""Fail-closed checker for M244-C008 interop lowering recovery and determinism hardening contract."""
...
MODE = "m244-c008-interop-lowering-and-abi-conformance-recovery-and-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_recovery_and_determinism_hardening_c008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c008_interop_lowering_and_abi_conformance_recovery_and_determinism_hardening_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C008/"
    "interop_lowering_and_abi_conformance_recovery_and_determinism_hardening_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C008-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-recovery-and-determinism-hardening/m244-c008-v1`",
    ),
    SnippetCheck("M244-C008-DOC-EXP-02", "Dependencies: `M244-C007`"),
    SnippetCheck("M244-C008-DOC-EXP-03", "Issue `#6557` defines canonical lane-C recovery and determinism hardening scope."),
    SnippetCheck("M244-C008-DOC-EXP-04", "`check:objc3c:m244-c008-lane-c-readiness`"),
    SnippetCheck("M244-C008-DOC-EXP-05", "`check:objc3c:m244-c007-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C008-DOC-PKT-01", "Packet: `M244-C008`"),
    SnippetCheck("M244-C008-DOC-PKT-02", "Issue: `#6557`"),
    SnippetCheck("M244-C008-DOC-PKT-03", "Dependencies: `M244-C007`"),
    SnippetCheck(
        "M244-C008-DOC-PKT-04",
        "`scripts/check_m244_c008_interop_lowering_and_abi_conformance_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M244-C008-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C008-CFG-03", "check:objc3c:m244-c008-lane-c-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c007-lane-c-readiness && npm run check:objc3c:m244-c008-interop-lowering-abi-conformance-recovery-determinism-hardening-contract && npm run test:tooling:m244-c008-interop-lowering-abi-conformance-recovery-determinism-hardening-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C008-ARCH-02",
        "`M244-C007` dependency continuity and recovery/determinism evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C008-SPC-02", "lane-C dependency anchor (`M244-C007`)"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C008-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C008-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C008-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C008-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C008-META-00",
