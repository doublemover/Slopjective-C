#!/usr/bin/env python3
"""Fail-closed checker for M245-D004 build/link/runtime reproducibility core feature expansion."""
...
MODE = "m245-d004-build-link-runtime-reproducibility-operations-core-feature-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_core_feature_expansion_d004_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_d004_build_link_runtime_reproducibility_operations_core_feature_expansion_packet.md"
)
DEFAULT_D003_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_core_feature_implementation_d003_expectations.md"
)
DEFAULT_D003_PACKET_DOC = (
    ...
    / "compiler"
    / "m245"
    / "m245_d003_build_link_runtime_reproducibility_operations_core_feature_implementation_packet.md"
)
DEFAULT_D003_CHECKER = (
    ROOT / "scripts" / "check_m245_d003_build_link_runtime_reproducibility_operations_core_feature_implementation_contract.py"
)
DEFAULT_D003_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m245_d003_build_link_runtime_reproducibility_operations_core_feature_implementation_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D004-DOC-PKT-01",
        "# M245-D004 Build/Link/Runtime Reproducibility Operations Core Feature Expansion Packet",
    ),
    SnippetCheck("M245-D004-DOC-PKT-02", "Packet: `M245-D004`"),
    SnippetCheck("M245-D004-DOC-PKT-03", "Issue: `#6655`"),
    SnippetCheck("M245-D004-DOC-PKT-04", "Dependencies: `M245-D003`"),
    SnippetCheck(
        "M245-D004-DOC-PKT-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D004-DOC-PKT-06",
        "scripts/check_m245_d004_build_link_runtime_reproducibility_operations_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-D004-DOC-PKT-07",
        "tests/tooling/test_check_m245_d004_build_link_runtime_reproducibility_operations_core_feature_expansion_contract.py",
    ),
    SnippetCheck("M245-D004-DOC-PKT-08", "`npm run check:objc3c:m245-d004-lane-d-readiness`"),
    SnippetCheck(
        "M245-D004-DOC-PKT-09",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-D004-ARCH-03",
        "and fail-closed against `M245-D003` dependency drift.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-D004-META-02",
        "explicit `M245-D003` dependency continuity so core feature expansion drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-D004-PKG-03",
        '"check:objc3c:m245-d004-lane-d-readiness": '
        '"npm run check:objc3c:m245-d003-lane-d-readiness '
        '&& npm run check:objc3c:m245-d004-build-link-runtime-reproducibility-operations-core-feature-expansion-contract '
        '&& npm run test:tooling:m245-d004-build-link-runtime-reproducibility-operations-core-feature-expansion-contract"',
    ),
    SnippetCheck("M245-D004-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D004-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D004-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D004-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d003_expectations_doc, "M245-D004-D003-DOC-EXISTS", D003_EXPECTATIONS_SNIPPETS),
        (args.d003_packet_doc, "M245-D004-D003-PKT-EXISTS", D003_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D004-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D004-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d003_checker, "M245-D004-DEP-D003-ARG-01"),
        (args.d003_test, "M245-D004-DEP-D003-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
