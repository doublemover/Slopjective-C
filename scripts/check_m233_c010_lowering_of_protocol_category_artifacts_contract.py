#!/usr/bin/env python3
"""Fail-closed checker for M233-C010 lowering of protocol/category artifacts contract freeze."""
...
MODE = "m233-c010-lowering-of-protocol-category-artifacts-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_c010_lowering_of_protocol_category_artifacts_conformance_corpus_expansion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-C010-DOC-PKT-01",
        "# M233-C010 Lowering of protocol/category artifacts Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M233-C010-DOC-PKT-02", "Packet: `M233-C010`"),
    SnippetCheck("M233-C010-DOC-PKT-03", "Issue: `#4935`"),
    SnippetCheck("M233-C010-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M233-C010-DOC-PKT-05",
        "check:objc3c:m233-c010-lowering-of-protocol-category-artifacts-contract",
    ),
    SnippetCheck(
        "M233-C010-DOC-PKT-06",
        "tmp/reports/m233/M233-C010/lowering_of_protocol_category_artifacts_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-C010-PKG-03",
        '"check:objc3c:m233-c010-lane-c-readiness": '
        '"npm run check:objc3c:m233-c010-lowering-of-protocol-category-artifacts-contract '
        '&& npm run test:tooling:m233-c010-lowering-of-protocol-category-artifacts-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M233-C010-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M233-C010-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M233-C010-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M233-C010-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M233-C010-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M233-C010-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
