#!/usr/bin/env python3
"""Run the M256-D003 lane-D readiness chain without recursive npm nesting."""
...
DEPENDENCY_TOKEN = "M256-A001..A003 + M256-B001..B004 + M256-C001..C003 + M256-D001..D003"
...
def run_chain() -> int:
    print(
        ...
        f"{DEPENDENCY_TOKEN} (source closure, object-model sema, executable lowering, realized graph runtime, and category attachment protocol checks must stay aligned without recursive issue runners)"
    )
    ...
    print("[ok] M256-D003 lane-D readiness chain completed")
    return 0
