#!/usr/bin/env python3
"""Fail-closed contract checker for M248-B006 semantic/lowering edge-case expansion and robustness."""
...
MODE = "m248-b006-semantic-lowering-test-architecture-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_B005_CHECKER = (
    ROOT / "scripts" / "check_m248_b005_semantic_lowering_test_architecture_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_B005_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m248_b005_semantic_lowering_test_architecture_edge_case_and_compatibility_completion_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B006-DOC-PKT-01",
        "# M248-B006 Semantic/Lowering Test Architecture Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M248-B006-DOC-PKT-02", "Packet: `M248-B006`"),
    SnippetCheck("M248-B006-DOC-PKT-03", "Issue: `#6806`"),
    SnippetCheck("M248-B006-DOC-PKT-04", "Dependencies: `M248-B005`"),
    SnippetCheck(
        "M248-B006-DOC-PKT-05",
        "`scripts/check_m248_b006_semantic_lowering_test_architecture_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M248-B006-DOC-PKT-06",
        "`check:objc3c:m248-b006-lane-b-readiness`",
    ),
    SnippetCheck(
        "M248-B006-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M248-B006-DOC-PKT-08",
...
B005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B006-B005-DOC-01",
        "Contract ID: `objc3c-semantic-lowering-test-architecture-edge-case-and-compatibility-completion/m248-b005-v1`",
    ),
    SnippetCheck("M248-B006-B005-DOC-02", "- Dependencies: `M248-B004`"),
    SnippetCheck(
        "M248-B006-B005-DOC-03",
        "scripts/check_m248_b005_semantic_lowering_test_architecture_edge_case_and_compatibility_completion_contract.py",
    ),
)

B005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-B006-B005-PKT-01", "Packet: `M248-B005`"),
    SnippetCheck("M248-B006-B005-PKT-02", "Dependencies: `M248-B004`"),
    SnippetCheck(
        "M248-B006-B005-PKT-03",
        "`scripts/check_m248_b005_semantic_lowering_test_architecture_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M248-B006-B005-PKT-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-B006-PKG-04", '"check:objc3c:m248-b005-lane-b-readiness": '),
    SnippetCheck("M248-B006-PKG-05", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M248-B006-PKG-06", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b005_expectations_doc, "M248-B006-B005-DOC-EXISTS", B005_EXPECTATIONS_SNIPPETS),
        (args.b005_packet_doc, "M248-B006-B005-PKT-EXISTS", B005_PACKET_SNIPPETS),
        (args.architecture_doc, "M248-B006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-B006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b005_checker, "M248-B006-DEP-B005-ARG-01"),
        (args.b005_test, "M248-B006-DEP-B005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
