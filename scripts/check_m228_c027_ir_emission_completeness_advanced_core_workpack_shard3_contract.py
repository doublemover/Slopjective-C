#!/usr/bin/env python3
"""Fail-closed validator for M228-C027 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c026_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c026_ir_emission_completeness_advanced_performance_workpack_shard2_contract.py",
    "c026_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C027-RUN-04", "npm run check:objc3c:m228-c027-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C027-ARC-01",
    ...
    "package_json": (
        ("M228-C027-PKG-01", '"check:objc3c:m228-c026-lane-c-readiness"'),
        (
            "M228-C027-PKG-02",
            '"check:objc3c:m228-c027-ir-emission-completeness-advanced-core-workpack-shard3-contract"',
        ),
        (
            "M228-C027-PKG-03",
            '"test:tooling:m228-c027-ir-emission-completeness-advanced-core-workpack-shard3-contract"',
        ),
        ("M228-C027-PKG-04", '"check:objc3c:m228-c027-lane-c-readiness"'),
        (
            "M228-C027-PKG-05",
    ...
    "c026_tooling_test": (
        ("M228-C027-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c026_packet_doc": (
        ("M228-C027-DEP-04", "Packet: `M228-C026`"),
        ("M228-C027-DEP-05", "Issue: `#5252`"),
    ),
    "contract_doc": (
        (
            "M228-C027-DOC-01",
        ...
        ("M228-C027-DOC-02", "Execute issue `#5253`"),
        ("M228-C027-DOC-03", "Dependencies: `M228-C026`"),
        (
            "M228-C027-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C027-PKT-02", "Packet: `M228-C027`"),
        ("M228-C027-PKT-03", "Issue: `#5253`"),
        ("M228-C027-PKT-04", "Dependencies: `M228-C026`"),
        (
            "M228-C027-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C027-FORB-01",
            '"check:objc3c:m228-c027-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C027/"
            "ir_emission_completeness_advanced_core_workpack_shard3_contract_summary.json"
        ),
    )
