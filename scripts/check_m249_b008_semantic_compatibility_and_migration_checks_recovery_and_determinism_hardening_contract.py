#!/usr/bin/env python3
"""Fail-closed contract checker for the M249-B008 semantic compatibility recovery and determinism hardening packet."""
...
MODE = "m249-b008-semantic-compatibility-migration-checks-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_B007_CHECKER = (
    ROOT
    / "scripts"
    / "check_m249_b007_semantic_compatibility_and_migration_checks_diagnostics_hardening_contract.py"
)
DEFAULT_B007_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m249_b007_semantic_compatibility_and_migration_checks_diagnostics_hardening_contract.py"
)
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m249_b008_lane_b_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-B008-DOC-EXP-10",
        "`tmp/reports/m249/M249-B008/semantic_compatibility_and_migration_checks_recovery_and_determinism_hardening_summary.json`",
    ),
    SnippetCheck(
        "M249-B008-DOC-EXP-11",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-B008-DOC-PKT-01",
        "# M249-B008 Semantic Compatibility and Migration Checks Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M249-B008-DOC-PKT-02", "Packet: `M249-B008`"),
    SnippetCheck("M249-B008-DOC-PKT-03", "Dependencies: `M249-B007`"),
    SnippetCheck(
        "M249-B008-DOC-PKT-04",
        "`scripts/check_m249_b008_semantic_compatibility_and_migration_checks_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M249-B008-DOC-PKT-05",
        "`scripts/run_m249_b008_lane_b_readiness.py`",
    ),
    SnippetCheck(
        "M249-B008-DOC-PKT-06",
        "`check:objc3c:m249-b008-lane-b-readiness`",
    ),
    SnippetCheck(
        "M249-B008-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M249-B008-DOC-PKT-08",
        "code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M249-B008-DOC-PKT-09",
        "improvements as mandatory scope inputs.",
    ),
)
...
B007_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-B008-B007-DOC-01",
        "Contract ID: `objc3c-semantic-compatibility-and-migration-checks-diagnostics-hardening/m249-b007-v1`",
    ),
    SnippetCheck("M249-B008-B007-DOC-02", "- Dependencies: `M249-B006`"),
    SnippetCheck(
        "M249-B008-B007-DOC-03",
        "scripts/check_m249_b007_semantic_compatibility_and_migration_checks_diagnostics_hardening_contract.py",
    ),
)

B007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-B008-B007-PKT-01", "Packet: `M249-B007`"),
    SnippetCheck("M249-B008-B007-PKT-02", "Dependencies: `M249-B006`"),
    SnippetCheck(
        "M249-B008-B007-PKT-03",
        "scripts/check_m249_b007_semantic_compatibility_and_migration_checks_diagnostics_hardening_contract.py",
    ),
    SnippetCheck(
        "M249-B008-B007-PKT-04",
...
READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-B008-RUN-01", '"""Run M249-B008 lane-B readiness checks without deep npm nesting."""'),
    SnippetCheck(
        "M249-B008-RUN-02",
    ...
    SnippetCheck("M249-B008-RUN-05", "[ok] M249-B008 lane-B readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-B008-PKG-04", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M249-B008-PKG-05", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-B008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-B008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b007_expectations_doc, "M249-B008-B007-DOC-EXISTS", B007_EXPECTATIONS_SNIPPETS),
        (args.b007_packet_doc, "M249-B008-B007-PKT-EXISTS", B007_PACKET_SNIPPETS),
        (args.readiness_runner, "M249-B008-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-B008-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-B008-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-B008-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-B008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b007_checker, "M249-B008-DEP-B007-ARG-01"),
        (args.b007_test, "M249-B008-DEP-B007-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
