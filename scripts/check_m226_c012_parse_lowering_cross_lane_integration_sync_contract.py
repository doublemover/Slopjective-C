#!/usr/bin/env python3
"""Fail-closed validator for M226-C012 parse/lowering cross-lane integration sync."""
...
MODE = "m226-c012-parse-lowering-cross-lane-integration-sync-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "docs"
    / "contracts"
    / "m226_parse_lowering_performance_quality_guardrails_c011_expectations.md",
    "contract_doc": ROOT / "docs" / "contracts" / "m226_parse_lowering_cross_lane_integration_sync_c012_expectations.md",
}

REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "readiness_surface_header": (
        ("M226-C012-RDY-01", "IsObjc3ToolchainRuntimeGaOperationsCrossLaneIntegrationConsistent("),
        ("M226-C012-RDY-02", "IsObjc3ToolchainRuntimeGaOperationsCrossLaneIntegrationReady("),
        ("M226-C012-RDY-03", "BuildObjc3ToolchainRuntimeGaOperationsCrossLaneIntegrationKey("),
        (
            "M226-C012-RDY-04",
            "surface.toolchain_runtime_ga_operations_cross_lane_integration_consistent =",
        ),
        ("M226-C012-RDY-05", "surface.toolchain_runtime_ga_operations_cross_lane_integration_ready ="),
        ("M226-C012-RDY-06", "surface.toolchain_runtime_ga_operations_cross_lane_integration_key ="),
        (
            "M226-C012-RDY-07",
    ...
    "contract_doc": (
        ...
        ("M226-C012-DOC-03", "IsObjc3ToolchainRuntimeGaOperationsCrossLaneIntegrationConsistent"),
        ("M226-C012-DOC-04", "BuildObjc3ToolchainRuntimeGaOperationsCrossLaneIntegrationKey"),
        ("M226-C012-DOC-05", "python scripts/check_m226_c012_parse_lowering_cross_lane_integration_sync_contract.py"),
        (
            "M226-C012-DOC-06",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "readiness_surface_header": (
        (
            "M226-C012-FORB-01",
            "surface.toolchain_runtime_ga_operations_cross_lane_integration_consistent = true;",
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--summary-out",
        type=Path,
        default=Path("tmp/reports/m226/m226_c012_parse_lowering_cross_lane_integration_sync_contract_summary.json"),
    )
