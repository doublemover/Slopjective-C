...
def main() -> int:
    ...
    checks = {
        "summary_script_link_matches": contract["summary_script"] == "scripts/build_object_model_closure_executable_proof_summary.py",
    ...
    summary = {
        ...
        "private_runtime_query_symbol_count": len(contract["private_runtime_query_boundary"]),
        "checks": checks,
