#!/usr/bin/env python3
"""Fail-closed checker for M235-D009 interop behavior integration closeout and gate sign-off."""
...
MODE = "m235-d009-interop-behavior-for-qualified-generic-apis-integration-closeout-and-gate-sign-off-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_interop_behavior_for_qualified_generic_apis_integration_closeout_and_gate_sign_off_d009_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_d009_interop_behavior_for_qualified_generic_apis_integration_closeout_and_gate_sign_off_packet.md"
)
DEFAULT_D008_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_d008_expectations.md"
)
DEFAULT_D008_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_d008_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_packet.md"
)
DEFAULT_D008_CHECKER = (
    ROOT / "scripts" / "check_m235_d008_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_contract.py"
)
DEFAULT_D008_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_d008_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M235-D009-DEP-D008-01",
        Path("docs/contracts/m235_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_d008_expectations.md"),
    ),
    AssetCheck(
        "M235-D009-DEP-D008-02",
        Path("spec/planning/compiler/m235/m235_d008_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_packet.md"),
    ),
    AssetCheck(
        "M235-D009-DEP-D008-03",
        Path("scripts/check_m235_d008_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M235-D009-DEP-D008-04",
        Path("tests/tooling/test_check_m235_d008_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-D009-DOC-EXP-01",
        "# M235 Interop Behavior for Qualified Generic APIs Integration Closeout and Gate Sign-off Expectations (D009)",
    ),
    SnippetCheck(
        "M235-D009-DOC-EXP-02",
        "Contract ID: `objc3c-interop-behavior-for-qualified-generic-apis-integration-closeout-and-gate-sign-off/m235-d009-v1`",
    ),
    SnippetCheck(
        "M235-D009-DOC-EXP-03",
        "Issue `#5839` defines canonical lane-D integration closeout and gate sign-off scope.",
    ),
    SnippetCheck("M235-D009-DOC-EXP-04", "Dependencies: `M235-D008`"),
    SnippetCheck(
        "M235-D009-DOC-EXP-05",
        "milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-D009-DOC-EXP-06",
        "docs/contracts/m235_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_d008_expectations.md",
    ),
    SnippetCheck(
        "M235-D009-DOC-EXP-07",
        "scripts/check_m235_d008_interop_behavior_for_qualified_generic_apis_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M235-D009-DOC-EXP-08",
    ...
    SnippetCheck("M235-D009-DOC-EXP-09", "`check:objc3c:m235-d008-lane-d-readiness`"),
    SnippetCheck(
        "M235-D009-DOC-EXP-10",
        "`check:objc3c:m235-d009-interop-behavior-for-qualified-generic-apis-integration-closeout-and-gate-sign-off-contract`",
    ),
    SnippetCheck(
        "M235-D009-DOC-EXP-11",
        "`check:objc3c:m235-d009-lane-d-readiness`",
    ),
    SnippetCheck("M235-D009-DOC-EXP-12", "`compile:objc3c`"),
    SnippetCheck(
        "M235-D009-DOC-EXP-13",
        "`tmp/reports/m235/M235-D009/interop_behavior_for_qualified_generic_apis_integration_closeout_and_gate_sign_off_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-D009-DOC-PKT-01",
        "# M235-D009 Interop Behavior for Qualified Generic APIs Integration Closeout and Gate Sign-off Packet",
    ),
    SnippetCheck("M235-D009-DOC-PKT-02", "Packet: `M235-D009`"),
    SnippetCheck("M235-D009-DOC-PKT-03", "Issue: `#5839`"),
    SnippetCheck("M235-D009-DOC-PKT-04", "Dependencies: `M235-D008`"),
    SnippetCheck(
        "M235-D009-DOC-PKT-05",
        "including code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M235-D009-DOC-PKT-06",
    ...
    SnippetCheck("M235-D009-DOC-PKT-09", "`npm run check:objc3c:m235-d008-lane-d-readiness`"),
    SnippetCheck(
        "M235-D009-DOC-PKT-10",
        "`tmp/reports/m235/M235-D009/interop_behavior_for_qualified_generic_apis_integration_closeout_and_gate_sign_off_contract_summary.json`",
    ),
    SnippetCheck(
        "M235-D009-DOC-PKT-11",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-D009-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-D009-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-D009-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-D009-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-D009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-D009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d008_expectations_doc, "M235-D009-D008-DOC-EXISTS", D008_EXPECTATIONS_SNIPPETS),
        (args.d008_packet_doc, "M235-D009-D008-PKT-EXISTS", D008_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-D009-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-D009-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-D009-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-D009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d008_checker, "M235-D009-DEP-D008-ARG-01"),
        (args.d008_test, "M235-D009-DEP-D008-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
