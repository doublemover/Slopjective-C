#!/usr/bin/env python3
"""Fail-closed validator for M227-E018 semantic conformance lane-E advanced conformance workpack (shard 1)."""
...
MODE = "m227-e018-semantic-conformance-lane-e-advanced-conformance-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_lane_e_semantic_conformance_advanced_conformance_workpack_shard1_e018_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_e018_semantic_conformance_lane_e_advanced_conformance_workpack_shard1_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-E018-E005-01",
        "M227-E017",
        Path("docs/contracts/m227_lane_e_semantic_conformance_advanced_diagnostics_workpack_shard1_e017_expectations.md"),
    ),
    AssetCheck(
        "M227-E018-E005-02",
        "M227-E017",
        Path("scripts/check_m227_e017_semantic_conformance_lane_e_advanced_diagnostics_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E018-E005-03",
        "M227-E017",
        Path("tests/tooling/test_check_m227_e017_semantic_conformance_lane_e_advanced_diagnostics_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E018-E005-04",
        "M227-E017",
        Path("spec/planning/compiler/m227/m227_e017_semantic_conformance_lane_e_advanced_diagnostics_workpack_shard1_packet.md"),
    ),
    AssetCheck(
        "M227-E018-A006-01",
        "M227-A019",
        Path("docs/contracts/m227_semantic_pass_advanced_integration_workpack_shard1_expectations.md"),
    ),
    AssetCheck(
        "M227-E018-A006-02",
        "M227-A019",
        Path("scripts/check_m227_a019_semantic_pass_advanced_integration_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E018-A006-03",
        "M227-A019",
        Path("tests/tooling/test_check_m227_a019_semantic_pass_advanced_integration_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E018-A006-04",
        "M227-A019",
        Path("spec/planning/compiler/m227/m227_a019_semantic_pass_advanced_integration_workpack_shard1_packet.md"),
    ),
    AssetCheck(
        "M227-E018-B006-01",
        "M227-B035",
        Path("docs/contracts/m227_type_system_objc3_forms_advanced_diagnostics_workpack_shard4_b035_expectations.md"),
    ),
    AssetCheck(
        "M227-E018-B006-02",
        "M227-B035",
        Path("scripts/check_m227_b035_type_system_objc3_forms_advanced_diagnostics_workpack_shard4_contract.py"),
    ),
    AssetCheck(
        "M227-E018-B006-03",
        "M227-B035",
        Path("tests/tooling/test_check_m227_b035_type_system_objc3_forms_advanced_diagnostics_workpack_shard4_contract.py"),
    ),
    AssetCheck(
        "M227-E018-B006-04",
        "M227-B035",
        Path("spec/planning/compiler/m227/m227_b035_type_system_objc3_forms_advanced_diagnostics_workpack_shard4_packet.md"),
    ),
    AssetCheck(
        "M227-E018-C006-01",
        "M227-C023",
        Path("docs/contracts/m227_typed_sema_to_lowering_advanced_diagnostics_shard2_c023_expectations.md"),
    ),
    AssetCheck(
        "M227-E018-C006-02",
        "M227-C023",
        Path("scripts/check_m227_c023_typed_sema_to_lowering_advanced_diagnostics_shard2_contract.py"),
    ),
    AssetCheck(
        "M227-E018-C006-03",
        "M227-C023",
        Path("tests/tooling/test_check_m227_c023_typed_sema_to_lowering_advanced_diagnostics_shard2_contract.py"),
    ),
    AssetCheck(
        "M227-E018-C006-04",
        "M227-C023",
        Path("spec/planning/compiler/m227/m227_c023_typed_sema_to_lowering_advanced_diagnostics_shard2_packet.md"),
    ),
    AssetCheck(
        "M227-E018-D006-01",
        "M227-D011",
        Path("docs/contracts/m227_runtime_facing_type_metadata_performance_quality_guardrails_d011_expectations.md"),
    ),
    AssetCheck(
        "M227-E018-D006-02",
        "M227-D011",
        Path("scripts/check_m227_d011_runtime_facing_type_metadata_performance_quality_guardrails_contract.py"),
    ),
    AssetCheck(
        "M227-E018-D006-03",
        "M227-D011",
        Path("tests/tooling/test_check_m227_d011_runtime_facing_type_metadata_performance_quality_guardrails_contract.py"),
    ),
    AssetCheck(
        "M227-E018-D006-04",
        "M227-D011",
        Path("spec/planning/compiler/m227/m227_d011_runtime_facing_type_metadata_performance_quality_guardrails_packet.md"),
    ),
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E018-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-E018-EXP-08",
        "checker `scripts/check_m227_e017_semantic_conformance_lane_e_advanced_diagnostics_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M227-E018-EXP-09",
        "checker `scripts/check_m227_a019_semantic_pass_advanced_integration_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M227-E018-EXP-10",
        "checker `scripts/check_m227_b035_type_system_objc3_forms_advanced_diagnostics_workpack_shard4_contract.py`",
    ),
    SnippetCheck(
        "M227-E018-EXP-11",
        "checker `scripts/check_m227_c023_typed_sema_to_lowering_advanced_diagnostics_shard2_contract.py`",
    ),
    SnippetCheck(
        "M227-E018-EXP-12",
        "checker `scripts/check_m227_d011_runtime_facing_type_metadata_performance_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M227-E018-EXP-13",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E018-PKT-04", "Packet: `M227-E018`"),
    SnippetCheck("M227-E018-PKT-05", "Issue: `#5176`"),
    SnippetCheck("M227-E018-PKT-06", "Scaffold date: `2026-03-05`"),
    SnippetCheck(
        "M227-E018-PKT-07",
        "Dependencies: `M227-E017`, `M227-A019`, `M227-B035`, `M227-C023`, `M227-D011`",
    ),
    SnippetCheck("M227-E018-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-E018-PKT-09",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-E018-ARCH-01",
        "M227 lane-E E018 semantic conformance advanced conformance workpack (shard 1) anchors dependency references",
    ),
    SnippetCheck(
        "M227-E018-ARCH-02",
        "(`M227-E017`, `M227-A019`, `M227-B035`, `M227-C023`, and `M227-D011`)",
    ),
    SnippetCheck(
        "M227-E018-ARCH-03",
        "check:objc3c:m227-e018-lane-e-readiness",
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E018-SPC-03",
        "lane-E advanced conformance workpack (shard 1) evidence drift.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E018-META-03",
        "semantic conformance lane-E advanced conformance workpack (shard 1) metadata governance drift fails closed.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-E018-CFG-03", "check:objc3c:m227-e018-lane-e-readiness"),
    PackageScriptKeyCheck("M227-E018-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M227-E018-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M227-E018-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-E018-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        "M227-E018-CFG-06",
        "check:objc3c:m227-e018-lane-e-readiness",
        "python scripts/check_m227_e017_semantic_conformance_lane_e_advanced_diagnostics_workpack_shard1_contract.py && python -m pytest tests/tooling/test_check_m227_e017_semantic_conformance_lane_e_advanced_diagnostics_workpack_shard1_contract.py -q && python scripts/check_m227_a019_semantic_pass_advanced_integration_workpack_shard1_contract.py && python -m pytest tests/tooling/test_check_m227_a019_semantic_pass_advanced_integration_workpack_shard1_contract.py -q && npm run check:objc3c:m227-b035-lane-b-readiness && npm run check:objc3c:m227-c023-lane-c-readiness && python scripts/check_m227_d011_runtime_facing_type_metadata_performance_quality_guardrails_contract.py && python -m pytest tests/tooling/test_check_m227_d011_runtime_facing_type_metadata_performance_quality_guardrails_contract.py -q && npm run check:objc3c:m227-e018-semantic-conformance-lane-e-advanced-conformance-workpack-shard1-contract && npm run test:tooling:m227-e018-semantic-conformance-lane-e-advanced-conformance-workpack-shard1-contract",
    ),
)
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-E017": "scripts/check_m227_e017_semantic_conformance_lane_e_advanced_diagnostics_workpack_shard1_contract.py",
    "M227-A019": "scripts/check_m227_a019_semantic_pass_advanced_integration_workpack_shard1_contract.py",
    "M227-B035": "scripts/check_m227_b035_type_system_objc3_forms_advanced_diagnostics_workpack_shard4_contract.py",
    "M227-C023": "scripts/check_m227_c023_typed_sema_to_lowering_advanced_diagnostics_shard2_contract.py",
    "M227-D011": "scripts/check_m227_d011_runtime_facing_type_metadata_performance_quality_guardrails_contract.py",
}
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_text = check_document(
        ...
        exists_check_id="M227-E018-EXP-01",
        utf8_check_id="M227-E018-EXP-02",
        snippets=EXPECTATIONS_SNIPPETS,
    )
    packet_text = check_document(
        path=args.packet_doc,
        artifact="packet_doc",
        exists_check_id="M227-E018-PKT-01",
        utf8_check_id="M227-E018-PKT-02",
        snippets=PACKET_SNIPPETS,
    )
    check_document(
        path=args.architecture_doc,
        artifact="architecture_doc",
        exists_check_id="M227-E018-ARCH-00",
        utf8_check_id="M227-E018-ARCH-UTF8",
        snippets=ARCHITECTURE_SNIPPETS,
    )
    check_document(
        path=args.lowering_spec,
        artifact="lowering_spec",
        exists_check_id="M227-E018-SPC-00",
        utf8_check_id="M227-E018-SPC-UTF8",
        snippets=LOWERING_SPEC_SNIPPETS,
    )
    check_document(
        path=args.metadata_spec,
        artifact="metadata_spec",
        exists_check_id="M227-E018-META-00",
        utf8_check_id="M227-E018-META-UTF8",
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-E018-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if isinstance(package_payload, dict):
        ...
        check(
            artifact="package_json",
            check_id="M227-E018-CFG-SCRIPTS",
    ...
    if findings:
        if not args.emit_json:
            print(
                "m227-e018-semantic-conformance-lane-e-advanced-conformance-workpack-shard1: "
    ...
    if not args.emit_json:
        print("m227-e018-semantic-conformance-lane-e-advanced-conformance-workpack-shard1: OK")
        print(f"- mode={MODE}")
