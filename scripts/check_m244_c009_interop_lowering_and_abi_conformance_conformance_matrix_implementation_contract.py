#!/usr/bin/env python3
"""Fail-closed checker for M244-C009 interop lowering conformance matrix implementation contract."""
...
MODE = "m244-c009-interop-lowering-and-abi-conformance-conformance-matrix-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_conformance_matrix_implementation_c009_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c009_interop_lowering_and_abi_conformance_conformance_matrix_implementation_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C009/"
    "interop_lowering_and_abi_conformance_conformance_matrix_implementation_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C009-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-conformance-matrix-implementation/m244-c009-v1`",
    ),
    SnippetCheck("M244-C009-DOC-EXP-02", "Dependencies: `M244-C008`"),
    SnippetCheck("M244-C009-DOC-EXP-03", "Issue `#6558` defines canonical lane-C conformance matrix implementation scope."),
    SnippetCheck("M244-C009-DOC-EXP-04", "`check:objc3c:m244-c009-lane-c-readiness`"),
    SnippetCheck("M244-C009-DOC-EXP-05", "`check:objc3c:m244-c008-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C009-DOC-PKT-01", "Packet: `M244-C009`"),
    SnippetCheck("M244-C009-DOC-PKT-02", "Issue: `#6558`"),
    SnippetCheck("M244-C009-DOC-PKT-03", "Dependencies: `M244-C008`"),
    SnippetCheck(
        "M244-C009-DOC-PKT-04",
        "`scripts/check_m244_c009_interop_lowering_and_abi_conformance_conformance_matrix_implementation_contract.py`",
    ),
    SnippetCheck(
        "M244-C009-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C009-CFG-03", "check:objc3c:m244-c009-lane-c-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c008-lane-c-readiness && npm run check:objc3c:m244-c009-interop-lowering-abi-conformance-conformance-matrix-implementation-contract && npm run test:tooling:m244-c009-interop-lowering-abi-conformance-conformance-matrix-implementation-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C009-ARCH-02",
        "`M244-C008` dependency continuity and conformance matrix evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C009-SPC-02", "lane-C dependency anchor (`M244-C008`)"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C009-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C009-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C009-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C009-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C009-META-00",
