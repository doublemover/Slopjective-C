#!/usr/bin/env python3
"""Fail-closed checker for M233-D018 runtime metadata and lookup advanced conformance workpack (shard 1)."""
...
MODE = "m233-d018-installer-runtime-operations-lookup-plumbing-advanced-conformance-workpack-shard1-contract-v1"
...
DEFAULT_D017_CHECKER = (
    ROOT
    / "scripts"
    / "check_m233_d017_runtime_metadata_and_lookup_plumbing_advanced_diagnostics_workpack_shard1_contract.py"
)
DEFAULT_D017_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m233_d017_runtime_metadata_and_lookup_plumbing_advanced_diagnostics_workpack_shard1_contract.py"
)
DEFAULT_D017_READINESS_RUNNER = ROOT / "scripts" / "run_m233_d017_lane_d_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m233_d018_lane_d_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D018-DOC-EXP-01",
        "# M233 Runtime Metadata and Lookup Plumbing Advanced Conformance Workpack (Shard 1) Expectations (D018)",
    ),
    SnippetCheck(
        "M233-D018-DOC-EXP-02",
        "Contract ID: `objc3c-installer-runtime-operations-lookup-plumbing-advanced-conformance-workpack-shard1/m233-d018-v1`",
    ),
    SnippetCheck("M233-D018-DOC-EXP-03", "Dependencies: `M233-D017`"),
    SnippetCheck("M233-D018-DOC-EXP-04", "Issue: `#6945`"),
    SnippetCheck(
        "M233-D018-DOC-EXP-05",
        "scripts/check_m233_d017_runtime_metadata_and_lookup_plumbing_advanced_diagnostics_workpack_shard1_contract.py",
    ),
    SnippetCheck("M233-D018-DOC-EXP-06", "scripts/run_m233_d018_lane_d_readiness.py"),
    SnippetCheck("M233-D018-DOC-EXP-07", "code/spec anchors and milestone optimization"),
    SnippetCheck(
        "M233-D018-DOC-EXP-08",
        "tmp/reports/m233/M233-D018/runtime_metadata_and_lookup_plumbing_advanced_conformance_workpack_shard1_contract_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D018-DOC-PKT-01",
        "# M233-D018 Runtime Metadata and Lookup Plumbing Advanced Conformance Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M233-D018-DOC-PKT-02", "Packet: `M233-D018`"),
    SnippetCheck("M233-D018-DOC-PKT-03", "Issue: `#6945`"),
    SnippetCheck("M233-D018-DOC-PKT-04", "Dependencies: `M233-D017`"),
    SnippetCheck(
        "M233-D018-DOC-PKT-05",
        "scripts/check_m233_d017_runtime_metadata_and_lookup_plumbing_advanced_diagnostics_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M233-D018-DOC-PKT-06",
        "python scripts/run_m233_d017_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M233-D018-DOC-PKT-07",
...
D017_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D018-D017-DOC-01",
        "Contract ID: `objc3c-installer-runtime-operations-lookup-plumbing-advanced-diagnostics-workpack-shard1/m233-d017-v1`",
    ),
    SnippetCheck("M233-D018-D017-DOC-02", "Dependencies: `M233-D016`"),
)

D017_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-D018-D017-PKT-01", "Packet: `M233-D017`"),
    SnippetCheck("M233-D018-D017-PKT-02", "Issue: `#6944`"),
    SnippetCheck("M233-D018-D017-PKT-03", "Dependencies"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D018-RUN-01",
        '"""Run M233-D018 lane-D readiness checks without deep npm nesting."""',
    ),
    SnippetCheck("M233-D018-RUN-02", "scripts/run_m233_d017_lane_d_readiness.py"),
    SnippetCheck(
        "M233-D018-RUN-03",
    ...
    SnippetCheck("M233-D018-RUN-05", "[ok] M233-D018 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-D018-PKG-03",
        '"check:objc3c:m233-d018-lane-d-readiness": "python scripts/run_m233_d018_lane_d_readiness.py"',
    ),
    SnippetCheck("M233-D018-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M233-D018-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M233-D018-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-D018-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-D018-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-D018-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d017_expectations_doc, "M233-D018-D017-DOC-EXISTS", D017_EXPECTATIONS_SNIPPETS),
        (args.d017_packet_doc, "M233-D018-D017-PKT-EXISTS", D017_PACKET_SNIPPETS),
        (args.readiness_runner, "M233-D018-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M233-D018-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M233-D018-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M233-D018-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M233-D018-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d017_checker, "M233-D018-DEP-D017-ARG-01"),
        (args.d017_test, "M233-D018-DEP-D017-ARG-02"),
        (args.d017_readiness_runner, "M233-D018-DEP-D017-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
