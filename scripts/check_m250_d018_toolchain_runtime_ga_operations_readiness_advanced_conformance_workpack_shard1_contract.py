#!/usr/bin/env python3
"""Fail-closed validator for M250-D018 toolchain/runtime GA advanced conformance workpack (shard 1)."""
...
MODE = "m250-toolchain-runtime-ga-operations-readiness-advanced-conformance-workpack-shard1-contract-d018-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m250"
    / "m250_d018_toolchain_runtime_ga_operations_readiness_advanced_conformance_workpack_shard1_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "architecture_doc": (
        ("M250-D018-ARC-01", "M250 lane-D D018 advanced conformance workpack (shard 1)"),
        (
            "M250-D018-ARC-02",
            "toolchain_runtime_ga_operations_advanced_conformance_*",
        ),
    ),
    "d016_contract_doc": (
        (
    ...
    "contract_doc": (
        ...
        (
            "M250-D018-DOC-04",
            "scripts/check_m250_d018_toolchain_runtime_ga_operations_readiness_advanced_conformance_workpack_shard1_contract.py",
        ),
        (
            "M250-D018-DOC-05",
            "tests/tooling/test_check_m250_d018_toolchain_runtime_ga_operations_readiness_advanced_conformance_workpack_shard1_contract.py",
        ),
        ("M250-D018-DOC-06", "npm run check:objc3c:m250-d018-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M250-D018-PKT-01", "Packet: `M250-D018`"),
        ("M250-D018-PKT-02", "Dependencies: `M250-D017`"),
        (
            "M250-D018-PKT-03",
            "scripts/check_m250_d018_toolchain_runtime_ga_operations_readiness_advanced_conformance_workpack_shard1_contract.py",
        ),
    ...
    "package_json": (
        (
            "M250-D018-CFG-01",
            '"check:objc3c:m250-d018-toolchain-runtime-ga-operations-readiness-advanced-conformance-workpack-shard1-contract"',
        ),
        (
            "M250-D018-CFG-02",
            '"test:tooling:m250-d018-toolchain-runtime-ga-operations-readiness-advanced-conformance-workpack-shard1-contract"',
        ),
        ("M250-D018-CFG-03", '"check:objc3c:m250-d018-lane-d-readiness"'),
    ),
}
