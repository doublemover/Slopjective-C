#!/usr/bin/env python3
"""Fail-closed checker for M247-C017 lowering/codegen advanced edge compatibility workpack shard 1."""
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-C017-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M247-C017-DOC-PKT-05", "Dependencies: `M247-C016`"),
    SnippetCheck(
...
C015_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C017-C015-EXP-01",
        "Contract ID: `objc3c-lane-c-lowering-codegen-cost-profiling-controls-advanced-core-workpack-shard-1/m247-c015-v1`",
    ),
    SnippetCheck(
        "M247-C017-C015-EXP-02",
        "Dependencies: `M247-C016`",
    ),
    SnippetCheck(
        "M247-C017-C015-EXP-03",
        "Issue `#6757` defines canonical lane-C advanced edge compatibility workpack (shard 1) scope.",
    ),
    SnippetCheck(
        "M247-C017-C015-EXP-04",
        "scripts/run_m247_c016_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M247-C017-C015-EXP-05",
        "tmp/reports/m247/M247-C016/lowering_codegen_cost_profiling_and_controls_advanced_core_workpack_shard_1_summary.json",
    ),
)

C015_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C017-C015-PKT-01", "Packet: `M247-C016`"),
    SnippetCheck("M247-C017-C015-PKT-02", "Issue: `#6757`"),
    SnippetCheck("M247-C017-C015-PKT-03", "Dependencies: `M247-C016`"),
    SnippetCheck("M247-C017-C015-PKT-04", "scripts/run_m247_c016_lane_c_readiness.py"),
    SnippetCheck("M247-C017-C015-PKT-05", "scripts/run_m247_c014_lane_c_readiness.py"),
)

C015_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C017-C015-RUN-01",
        "scripts/run_m247_c014_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M247-C017-C015-RUN-02",
        "scripts/check_m247_c015_lowering_codegen_cost_profiling_and_controls_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M247-C017-C015-RUN-03",
        "tests/tooling/test_check_m247_c015_lowering_codegen_cost_profiling_and_controls_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M247-C017-C015-RUN-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-C017-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M247-C017-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M247-C017-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M247-C017-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        ...
        (args.c015_expectations_doc, "M247-C017-C015-EXP-EXISTS", C015_EXPECTATIONS_SNIPPETS),
        (args.c015_packet_doc, "M247-C017-C015-PKT-EXISTS", C015_PACKET_SNIPPETS),
        (args.c015_readiness_script, "M247-C017-C015-RUN-EXISTS", C015_READINESS_SNIPPETS),
