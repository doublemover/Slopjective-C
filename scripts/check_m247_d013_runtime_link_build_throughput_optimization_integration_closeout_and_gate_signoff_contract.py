#!/usr/bin/env python3
"""Fail-closed checker for M247-D013 runtime/link/build throughput optimization integration closeout and gate sign-off."""
...
MODE = "m247-d013-runtime-link-build-throughput-optimization-integration-closeout-and-gate-signoff-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m247_runtime_link_build_throughput_optimization_integration_closeout_and_gate_signoff_d013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m247"
    / "m247_d013_runtime_link_build_throughput_optimization_integration_closeout_and_gate_signoff_packet.md"
)
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m247_d013_lane_d_readiness.py"
...
DEFAULT_D012_READINESS_RUNNER = ROOT / "scripts" / "run_m247_d012_lane_d_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-D013-DOC-EXP-09", "`check:objc3c:m247-d013-lane-d-readiness`"),
    SnippetCheck(
        "M247-D013-DOC-EXP-10",
        "tmp/reports/m247/M247-D013/runtime_link_build_throughput_optimization_integration_closeout_and_gate_signoff_contract_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D013-DOC-PKT-01",
        "# M247-D013 Runtime/Link/Build Throughput Optimization Integration Closeout and Gate Sign-Off Packet",
    ),
    SnippetCheck("M247-D013-DOC-PKT-02", "Packet: `M247-D013`"),
    SnippetCheck("M247-D013-DOC-PKT-03", "Issue: `#6771`"),
    SnippetCheck("M247-D013-DOC-PKT-04", "Dependencies: `M247-D012`"),
    SnippetCheck("M247-D013-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck("M247-D013-DOC-PKT-06", "Dependency anchors from `M247-D012`:"),
    SnippetCheck("M247-D013-DOC-PKT-07", "scripts/run_m247_d013_lane_d_readiness.py"),
    SnippetCheck(
        "M247-D013-DOC-PKT-08",
    ...
    SnippetCheck(
        "M247-D013-DOC-PKT-09",
        "`D012 readiness -> D013 checker -> D013 pytest`",
    ),
    SnippetCheck(
        "M247-D013-DOC-PKT-10",
        "tmp/reports/m247/M247-D013/runtime_link_build_throughput_optimization_integration_closeout_and_gate_signoff_contract_summary.json",
    ),
)
...
D012_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D013-D012-DOC-01",
        "Contract ID: `objc3c-runtime-link-build-throughput-optimization-cross-lane-integration-sync/m247-d012-v1`",
    ),
    SnippetCheck("M247-D013-D012-DOC-02", "Dependencies: `M247-D011`"),
    SnippetCheck(
        "M247-D013-D012-DOC-03",
        "Issue `#6770` defines canonical lane-D cross-lane integration sync scope.",
    ),
)

D012_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D013-D012-PKT-01", "Packet: `M247-D012`"),
    SnippetCheck("M247-D013-D012-PKT-02", "Issue: `#6770`"),
    SnippetCheck("M247-D013-D012-PKT-03", "Dependencies: `M247-D011`"),
    SnippetCheck("M247-D013-D012-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D013-RUN-01", 'DEPENDENCY_TOKEN = "M247-D012"'),
    SnippetCheck("M247-D013-RUN-02", "scripts/run_m247_d012_lane_d_readiness.py"),
    SnippetCheck(
        "M247-D013-RUN-03",
    ...
    SnippetCheck("M247-D013-RUN-05", "[ok] M247-D013 lane-D readiness chain completed"),
)

D012_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D013-D012-RUN-01", 'DEPENDENCY_TOKEN = "M247-D011"'),
    SnippetCheck("M247-D013-D012-RUN-02", "scripts/run_m247_d011_lane_d_readiness.py"),
    SnippetCheck("M247-D013-D012-RUN-03", "[ok] M247-D012 lane-D readiness chain completed"),
)

PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    PackageScriptKeyCheck(
        "M247-D013-PKG-KEY-01",
        "check:objc3c:m247-d013-runtime-link-build-throughput-optimization-integration-closeout-and-gate-signoff-contract",
    ),
    PackageScriptKeyCheck(
        "M247-D013-PKG-KEY-02",
        "test:tooling:m247-d013-runtime-link-build-throughput-optimization-integration-closeout-and-gate-signoff-contract",
    ),
    PackageScriptKeyCheck("M247-D013-PKG-KEY-03", "check:objc3c:m247-d013-lane-d-readiness"),
    PackageScriptKeyCheck("M247-D013-PKG-KEY-04", "compile:objc3c"),
    PackageScriptKeyCheck("M247-D013-PKG-KEY-05", "proof:objc3c"),
    PackageScriptKeyCheck("M247-D013-PKG-KEY-06", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-D013-PKG-KEY-07", "test:objc3c:perf-budget"),
)

PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    PackageScriptCheck(
        "M247-D013-PKG-VAL-01",
        "check:objc3c:m247-d013-runtime-link-build-throughput-optimization-integration-closeout-and-gate-signoff-contract",
    ...
    PackageScriptCheck(
        "M247-D013-PKG-VAL-02",
        "test:tooling:m247-d013-runtime-link-build-throughput-optimization-integration-closeout-and-gate-signoff-contract",
        "python -m pytest tests/tooling/test_check_m247_d013_runtime_link_build_throughput_optimization_integration_closeout_and_gate_signoff_contract.py -q",
    ),
    PackageScriptCheck(
        "M247-D013-PKG-VAL-03",
...
PACKAGE_FORBIDDEN_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D013-PKG-FORB-01",
        '"check:objc3c:m247-d013-lane-d-readiness": "npm run check:objc3c:m247-d012-lane-d-readiness',
    ),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--d012-readiness-runner", type=Path, default=DEFAULT_D012_READINESS_RUNNER)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-D013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-D013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        ("d012_expectations_doc", args.d012_expectations_doc, "M247-D013-D012-DOC-EXISTS", D012_EXPECTATIONS_SNIPPETS),
        ("d012_packet_doc", args.d012_packet_doc, "M247-D013-D012-PKT-EXISTS", D012_PACKET_SNIPPETS),
        ("readiness_runner", args.readiness_runner, "M247-D013-RUN-EXISTS", READINESS_SNIPPETS),
        ("d012_readiness_runner", args.d012_readiness_runner, "M247-D013-D012-RUN-EXISTS", D012_READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d012_checker, "M247-D013-DEP-D012-ARG-01"),
        (args.d012_test, "M247-D013-DEP-D012-ARG-02"),
        (args.d012_readiness_runner, "M247-D013-DEP-D012-ARG-03"),
    ):
    ...
    if not summary_ok:
        print(
            f"[M247-D013-SUMMARY-WRITE-01] {display_path(summary_path)}: {summary_error}",
            file=sys.stderr,
        )
        return 1
