#!/usr/bin/env python3
"""Fail-closed checker for M234-A005 property and ivar syntax surface completion edge-case and compatibility completion."""
...
MODE = "m234-a005-property-and-ivar-syntax-surface-completion-edge-case-and-compatibility-completion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_property_and_ivar_syntax_surface_completion_edge_case_and_compatibility_completion_a005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_a005_property_and_ivar_syntax_surface_completion_edge_case_and_compatibility_completion_packet.md"
)
DEFAULT_A004_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_property_and_ivar_syntax_surface_completion_core_feature_expansion_a004_expectations.md"
)
DEFAULT_A004_PACKET_DOC = (
    ...
    / "compiler"
    / "m234"
    / "m234_a004_property_and_ivar_syntax_surface_completion_core_feature_expansion_packet.md"
)
DEFAULT_A004_CHECKER = (
    ROOT / "scripts" / "check_m234_a004_property_and_ivar_syntax_surface_completion_core_feature_expansion_contract.py"
)
DEFAULT_A004_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_a004_property_and_ivar_syntax_surface_completion_core_feature_expansion_contract.py"
)
...
A004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-A005-A004-PKT-01", "Packet: `M234-A004`"),
    SnippetCheck("M234-A005-A004-PKT-02", "Dependencies: `M234-A003`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A005-META-02",
        "explicit `M234-A004` dependency continuity so edge-case and compatibility completion drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A005-PKG-03",
        '"check:objc3c:m234-a005-lane-a-readiness": '
        '"npm run check:objc3c:m234-a004-lane-a-readiness '
        '&& npm run check:objc3c:m234-a005-property-and-ivar-syntax-surface-completion-edge-case-and-compatibility-completion-contract '
        '&& npm run test:tooling:m234-a005-property-and-ivar-syntax-surface-completion-edge-case-and-compatibility-completion-contract"',
    ),
    SnippetCheck("M234-A005-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M234-A005-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-A005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-A005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a004_expectations_doc, "M234-A005-A004-DOC-EXISTS", A004_EXPECTATIONS_SNIPPETS),
        (args.a004_packet_doc, "M234-A005-A004-PKT-EXISTS", A004_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-A005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-A005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-A005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-A005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a004_checker, "M234-A005-DEP-A004-ARG-01"),
        (args.a004_test, "M234-A005-DEP-A004-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
