...
def validate_payload(payload: dict[str, Any], artifact: str, failures: list[Finding]) -> tuple[int, int]:
    ...
    expected_exact: list[tuple[str, str, Any, str]] = [
        ...
        ("M266-B002-PAYLOAD-03", "semantic_model", "guard-refinement-and-statement-match-binding-plus-exhaustiveness-semantics-are-live-while-defer-cleanup-order-remains-deferred-or-fail-closed", "semantic model drifted"),
    ...
    for check_id, field, expected in [
        ...
        ("M266-B002-PAYLOAD-29", "defer_cleanup_order_deferred", True),
        ("M266-B002-PAYLOAD-30", "defer_nonlocal_exit_deferred", True),
