#!/usr/bin/env python3
"""Fail-closed validator for M248-D023 runner/platform advanced diagnostics workpack (shard 2)."""
...
MODE = "m248-runner-reliability-platform-operations-advanced-diagnostics-workpack-shard2-contract-d023-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m248"
    / "m248_d023_runner_reliability_and_platform_operations_advanced_diagnostics_workpack_shard2_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        ...
        ("M248-D023-DOC-06", "npm run check:objc3c:m248-d023-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M248-D023-PKT-01", "Packet: `M248-D023`"),
        ("M248-D023-PKT-02", "Dependencies: `M248-D022`"),
        ("M248-D023-PKT-03", "Issue: `#6858`"),
        (
            "M248-D023-PKT-04",
            "scripts/check_m248_d023_runner_reliability_and_platform_operations_advanced_diagnostics_workpack_shard2_contract.py",
        ),
    ...
    "package_json": (
        (
            "M248-D023-CFG-01",
            '"check:objc3c:m248-d023-runner-reliability-platform-operations-advanced-diagnostics-workpack-shard2-contract"',
        ),
        (
            "M248-D023-CFG-02",
            '"test:tooling:m248-d023-runner-reliability-platform-operations-advanced-diagnostics-workpack-shard2-contract"',
        ),
        ("M248-D023-CFG-03", '"check:objc3c:m248-d023-lane-d-readiness"'),
        ("M248-D023-CFG-04", "python scripts/run_m248_d023_lane_d_readiness.py"),
    ),
}
