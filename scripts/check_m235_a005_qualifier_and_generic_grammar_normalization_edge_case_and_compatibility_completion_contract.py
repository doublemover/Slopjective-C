#!/usr/bin/env python3
"""Fail-closed checker for M235-A005 qualifier/generic grammar normalization edge-case and compatibility completion."""
...
MODE = "m235-a005-qualifier-and-generic-grammar-normalization-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_A004_CHECKER = (
    ROOT / "scripts" / "check_m235_a004_qualifier_and_generic_grammar_normalization_core_feature_expansion_contract.py"
)
DEFAULT_A004_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_a004_qualifier_and_generic_grammar_normalization_core_feature_expansion_contract.py"
)
...
A004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-A005-A004-PKT-01", "Packet: `M235-A004`"),
    SnippetCheck("M235-A005-A004-PKT-02", "Dependencies: `M235-A003`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-A005-META-02",
        "explicit `M235-A004` dependency continuity so edge-case and compatibility completion drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-A005-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-A005-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-A005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-A005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a004_expectations_doc, "M235-A005-A004-DOC-EXISTS", A004_EXPECTATIONS_SNIPPETS),
        (args.a004_packet_doc, "M235-A005-A004-PKT-EXISTS", A004_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-A005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-A005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-A005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-A005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a004_checker, "M235-A005-DEP-A004-ARG-01"),
        (args.a004_test, "M235-A005-DEP-A004-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
