#!/usr/bin/env python3
"""Fail-closed checker for M246-C008 IR optimization pass wiring recovery and determinism hardening."""
...
MODE = "m246-c008-ir-optimization-pass-wiring-validation-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_C007_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c007_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c008_lane_c_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-C008-DOC-EXP-10",
        "improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-C008-DOC-EXP-11",
        "tmp/reports/m246/M246-C008/ir_optimization_pass_wiring_validation_recovery_and_determinism_hardening_summary.json",
    ),
    SnippetCheck(
        "M246-C008-DOC-EXP-14",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C008-DOC-PKT-01",
        "# M246-C008 IR Optimization Pass Wiring and Validation Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M246-C008-DOC-PKT-02", "Packet: `M246-C008`"),
    SnippetCheck("M246-C008-DOC-PKT-03", "Issue: `#5084`"),
    SnippetCheck("M246-C008-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-C008-DOC-PKT-05", "Dependencies: `M246-C007`"),
    SnippetCheck("M246-C008-DOC-PKT-13", "## Issue Anchor"),
    SnippetCheck("M246-C008-DOC-PKT-14", "Primary issue anchor: `#5084`"),
    SnippetCheck(
        "M246-C008-DOC-PKT-06",
        "Predecessor anchors inherited via `M246-C007`: `M246-C001`, `M246-C002`, `M246-C003`, `M246-C004`, `M246-C005`, `M246-C006`.",
    ),
    SnippetCheck(
        "M246-C008-DOC-PKT-07",
        "scripts/check_m246_c008_ir_optimization_pass_wiring_and_validation_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M246-C008-DOC-PKT-08",
        "tests/tooling/test_check_m246_c008_ir_optimization_pass_wiring_and_validation_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M246-C008-DOC-PKT-09",
        "scripts/run_m246_c008_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C008-DOC-PKT-10",
        "scripts/run_m246_c007_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C008-DOC-PKT-11",
        "treated as mandatory scope",
    ),
    SnippetCheck(
        "M246-C008-DOC-PKT-12",
        "tmp/reports/m246/M246-C008/ir_optimization_pass_wiring_validation_recovery_and_determinism_hardening_summary.json",
    ),
    SnippetCheck(
        "M246-C008-DOC-PKT-15",
        "python scripts/check_m246_c008_ir_optimization_pass_wiring_and_validation_recovery_and_determinism_hardening_contract.py --emit-json --summary-out tmp/reports/m246/M246-C008/ir_optimization_pass_wiring_validation_recovery_and_determinism_hardening_summary.json",
    ),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C008-C001-02", "Dependencies: none"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C008-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-C008-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-C008-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C008-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c007-readiness-script", type=Path, default=DEFAULT_C007_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M246-C008-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M246-C008-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.c007_expectations_doc, "M246-C008-C007-EXP-EXISTS", C007_EXPECTATIONS_SNIPPETS),
        (args.c007_packet_doc, "M246-C008-C007-PKT-EXISTS", C007_PACKET_SNIPPETS),
        (args.c007_readiness_script, "M246-C008-C007-RUN-EXISTS", C007_READINESS_SNIPPETS),
        (args.readiness_script, "M246-C008-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M246-C008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
