#!/usr/bin/env python3
"""Run M248-E013 lane-E readiness checks without deep npm nesting."""
...
COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    (
        sys.executable,
        "scripts/run_m248_e012_lane_e_readiness.py",
    ),
    (
        sys.executable,
        "scripts/run_m248_a013_lane_a_readiness.py",
    ),
    (
        sys.executable,
...
def run_chain() -> int:
    ...
    print("[ok] M248-E013 lane-E readiness chain completed")
    return 0
