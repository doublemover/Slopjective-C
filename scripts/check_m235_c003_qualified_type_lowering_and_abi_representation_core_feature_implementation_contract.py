#!/usr/bin/env python3
"""Fail-closed checker for M235-C003 qualified type core feature implementation."""
...
MODE = "m235-c003-qualified-type-lowering-and-abi-representation-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualified_type_lowering_and_abi_representation_core_feature_implementation_c003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_c003_qualified_type_lowering_and_abi_representation_core_feature_implementation_packet.md"
)
DEFAULT_C002_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualified_type_lowering_and_abi_representation_modular_split_scaffolding_c002_expectations.md"
)
DEFAULT_C002_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_c002_qualified_type_lowering_and_abi_representation_modular_split_scaffolding_packet.md"
)
DEFAULT_C002_CHECKER = ROOT / "scripts" / "check_m235_c002_qualified_type_lowering_and_abi_representation_modular_split_scaffolding_contract.py"
DEFAULT_C002_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c002_qualified_type_lowering_and_abi_representation_modular_split_scaffolding_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-C003-DOC-PKT-08", "`npm run check:objc3c:m235-c002-lane-c-readiness`"),
    SnippetCheck(
        "M235-C003-DOC-PKT-09",
        "`C002 readiness -> C003 checker -> C003 pytest`",
    ),
    SnippetCheck(
        "M235-C003-DOC-PKT-10",
...
C002_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C003-C002-DOC-01",
        "# M235 Qualified Type Lowering and ABI Representation Modular Split/Scaffolding Expectations (C002)",
    ),
    SnippetCheck(
        "M235-C003-C002-DOC-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-modular-split-scaffolding/m235-c002-v1`",
    ),
    SnippetCheck("M235-C003-C002-DOC-03", "Dependencies: `M235-C001`"),
    SnippetCheck(
        "M235-C003-C002-DOC-04",
        "Issue `#5812` defines canonical lane-C modular split and scaffolding scope.",
    ),
)

C002_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-C003-C002-PKT-01", "Packet: `M235-C002`"),
    SnippetCheck("M235-C003-C002-PKT-02", "Issue: `#5812`"),
    SnippetCheck("M235-C003-C002-PKT-03", "Dependencies: `M235-C001`"),
    SnippetCheck("M235-C003-C002-PKT-04", "Freeze date: `2026-03-05`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-C003-PKG-03",
        '"check:objc3c:m235-c002-lane-c-readiness": '
        '"npm run check:objc3c:m235-c001-lane-c-readiness '
        '&& npm run check:objc3c:m235-c002-qualified-type-lowering-and-abi-representation-modular-split-scaffolding-contract '
        '&& npm run test:tooling:m235-c002-qualified-type-lowering-and-abi-representation-modular-split-scaffolding-contract"',
    ),
    SnippetCheck("M235-C003-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M235-C003-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M235-C003-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C003-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c002_expectations_doc, "M235-C003-C002-DOC-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.c002_packet_doc, "M235-C003-C002-PKT-EXISTS", C002_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c002_checker, "M235-C003-DEP-C002-ARG-01"),
        (args.c002_test, "M235-C003-DEP-C002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
