#!/usr/bin/env python3
"""Fail-closed checker for M232-D001 runtime selector binding integration contract freeze."""
...
MODE = "m232-d001-runtime-selector-binding-integration-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m232"
    / "m232_d001_runtime_selector_binding_integration_contract_and_architecture_freeze_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-D001-DOC-EXP-01",
        "# M232 Runtime Selector Binding Integration Contract and Architecture Freeze Expectations (D001)",
    ),
    SnippetCheck(
        "M232-D001-DOC-EXP-02",
        "Contract ID: `objc3c-runtime-selector-binding-integration/m232-d001-v1`",
    ),
    SnippetCheck("M232-D001-DOC-EXP-03", "Issue: `#4873`"),
    SnippetCheck("M232-D001-DOC-EXP-04", "Dependencies: none"),
    SnippetCheck(
        "M232-D001-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M232-D001-DOC-EXP-06",
        "`check:objc3c:m232-d001-lane-d-readiness`",
    ),
    SnippetCheck(
        "M232-D001-DOC-EXP-07",
        "`tmp/reports/m232/M232-D001/runtime_selector_binding_integration_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-D001-DOC-PKT-01",
        "# M232-D001 Runtime Selector Binding Integration Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M232-D001-DOC-PKT-02", "Packet: `M232-D001`"),
    SnippetCheck("M232-D001-DOC-PKT-03", "Issue: `#4873`"),
    SnippetCheck("M232-D001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M232-D001-DOC-PKT-05",
        "check:objc3c:m232-d001-runtime-selector-binding-integration-contract",
    ),
    SnippetCheck(
        "M232-D001-DOC-PKT-06",
        "tmp/reports/m232/M232-D001/runtime_selector_binding_integration_contract_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M232-D001-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M232-D001-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M232-D001-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M232-D001-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M232-D001-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M232-D001-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
