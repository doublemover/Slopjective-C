#!/usr/bin/env python3
"""Fail-closed validator for M248-D017 runner/platform advanced diagnostics workpack (shard 1)."""
...
MODE = "m248-runner-reliability-platform-operations-advanced-diagnostics-workpack-shard1-contract-d017-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "docs"
    / "contracts"
    / "m248_runner_reliability_and_platform_operations_advanced_diagnostics_workpack_shard1_d017_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m248"
    / "m248_d017_runner_reliability_and_platform_operations_advanced_diagnostics_workpack_shard1_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "architecture_doc": (
        ("M248-D017-ARC-01", "M248 lane-D D017 advanced diagnostics workpack (shard 1)"),
        (
            "M248-D017-ARC-02",
            "toolchain_runtime_ga_operations_advanced_diagnostics_*",
        ),
    ),
    "d016_contract_doc": (
        (
    ...
    "contract_doc": (
        ...
        (
            "M248-D017-DOC-04",
            "scripts/check_m248_d017_runner_reliability_and_platform_operations_advanced_diagnostics_workpack_shard1_contract.py",
        ),
        (
            "M248-D017-DOC-05",
            "tests/tooling/test_check_m248_d017_runner_reliability_and_platform_operations_advanced_diagnostics_workpack_shard1_contract.py",
        ),
        ("M248-D017-DOC-06", "npm run check:objc3c:m248-d017-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M248-D017-PKT-01", "Packet: `M248-D017`"),
        ("M248-D017-PKT-02", "Dependencies: `M248-D016`"),
        ("M248-D017-PKT-03", "Issue: `#6852`"),
        (
            "M248-D017-PKT-04",
            "scripts/check_m248_d017_runner_reliability_and_platform_operations_advanced_diagnostics_workpack_shard1_contract.py",
        ),
    ...
    "package_json": (
        (
            "M248-D017-CFG-01",
            '"check:objc3c:m248-d017-runner-reliability-platform-operations-advanced-diagnostics-workpack-shard1-contract"',
        ),
        (
            "M248-D017-CFG-02",
            '"test:tooling:m248-d017-runner-reliability-platform-operations-advanced-diagnostics-workpack-shard1-contract"',
        ),
        ("M248-D017-CFG-03", '"check:objc3c:m248-d017-lane-d-readiness"'),
        ("M248-D017-CFG-04", "python scripts/run_m248_d017_lane_d_readiness.py"),
    ),
}
