#!/usr/bin/env python3
"""Fail-closed contract checker for M244-E017 integration closeout and gate sign-off."""
...
MODE = "m244-e017-lane-e-interop-conformance-gate-operations-integration-closeout-and-gate-sign-off-contract-v1"

ARTIFACTS: dict[str, Path] = {
    "expectations_doc": ROOT
    / "docs"
    / "contracts"
    / "m244_lane_e_interop_conformance_gate_and_operations_integration_closeout_and_gate_sign_off_e017_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m244"
    / "m244_e017_lane_e_interop_conformance_gate_and_operations_integration_closeout_and_gate_sign_off_packet.md",
...
EXISTENCE_CHECK_IDS: dict[str, str] = {
    "expectations_doc": "M244-E017-DOC-EXP-EXISTS",
    "packet_doc": "M244-E017-DOC-PKT-EXISTS",
    "lowering_spec": "M244-E017-SPC-EXISTS",
    "metadata_spec": "M244-E017-META-EXISTS",
    "package_json": "M244-E017-PKG-EXISTS",
}

REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "expectations_doc": (
        (
            "M244-E017-DOC-EXP-01",
            "# M244 Lane E Interop Conformance Gate and Operations Integration Closeout and Gate Sign-off Expectations (E009)",
        ),
        (
            "M244-E017-DOC-EXP-02",
            "Contract ID: `objc3c-lane-e-interop-conformance-gate-operations-integration-closeout-and-gate-sign-off/m244-e017-v1`",
        ),
        (
            "M244-E017-DOC-EXP-03",
            "Dependencies: `M244-E016`, `M244-A007`, `M244-B010`, `M244-C012`, `M244-D012`",
        ),
        (
            "M244-E017-DOC-EXP-04",
            "Issue `#6611` governs lane-E integration closeout and gate sign-off scope and dependency-token/reference continuity.",
        ),
        (
            "M244-E017-DOC-EXP-05",
            "The E009 checker and readiness wiring fail close on dependency token/reference",
        ),
        (
            "M244-E017-DOC-EXP-06",
            "`npm run --if-present check:objc3c:m244-b010-lane-b-readiness`",
        ),
        (
            "M244-E017-DOC-EXP-07",
            "`npm run --if-present check:objc3c:m244-c012-lane-c-readiness`",
        ),
        (
            "M244-E017-DOC-EXP-08",
            "`npm run --if-present check:objc3c:m244-d012-lane-d-readiness`",
        ),
        (
            "M244-E017-DOC-EXP-09",
            "scripts/check_m244_e017_lane_e_interop_conformance_gate_and_operations_integration_closeout_and_gate_sign_off_contract.py",
        ),
        (
            "M244-E017-DOC-EXP-10",
            "tests/tooling/test_check_m244_e017_lane_e_interop_conformance_gate_and_operations_integration_closeout_and_gate_sign_off_contract.py",
        ),
        ("M244-E017-DOC-EXP-11", "`check:objc3c:m244-e009-lane-e-readiness`"),
        ("M244-E017-DOC-EXP-12", "`compile:objc3c`"),
        ("M244-E017-DOC-EXP-13", "`proof:objc3c`"),
        ("M244-E017-DOC-EXP-14", "`test:objc3c:diagnostics-replay-proof`"),
        ("M244-E017-DOC-EXP-15", "`test:objc3c:execution-replay-proof`"),
        ("M244-E017-DOC-EXP-16", "`test:objc3c:perf-budget`"),
        (
            "M244-E017-DOC-EXP-17",
            "tmp/reports/m244/M244-E017/lane_e_interop_conformance_gate_operations_conformance_matrix_implementation_summary.json",
        ),
    ),
    "packet_doc": (
        (
            "M244-E017-DOC-PKT-01",
            "# M244-E017 Lane-E Interop Conformance Gate and Operations Integration Closeout and Gate Sign-off Packet",
        ),
        ("M244-E017-DOC-PKT-02", "Packet: `M244-E017`"),
        ("M244-E017-DOC-PKT-03", "Issue: `#6611`"),
        (
            "M244-E017-DOC-PKT-04",
            "Dependencies: `M244-E016`, `M244-A007`, `M244-B010`, `M244-C012`, `M244-D012`",
        ),
        (
            "M244-E017-DOC-PKT-05",
            "docs/contracts/m244_lane_e_interop_conformance_gate_and_operations_integration_closeout_and_gate_sign_off_e017_expectations.md",
        ),
        (
            "M244-E017-DOC-PKT-06",
            "scripts/check_m244_e017_lane_e_interop_conformance_gate_and_operations_integration_closeout_and_gate_sign_off_contract.py",
        ),
        (
            "M244-E017-DOC-PKT-07",
            "tests/tooling/test_check_m244_e017_lane_e_interop_conformance_gate_and_operations_integration_closeout_and_gate_sign_off_contract.py",
        ),
        (
            "M244-E017-DOC-PKT-08",
            "including code/spec anchors and milestone",
        ),
        (
            "M244-E017-DOC-PKT-09",
            "`npm run --if-present check:objc3c:m244-b010-lane-b-readiness`",
        ),
        (
            "M244-E017-DOC-PKT-10",
            "`npm run --if-present check:objc3c:m244-c012-lane-c-readiness`",
        ),
        (
            "M244-E017-DOC-PKT-11",
            "`npm run --if-present check:objc3c:m244-d012-lane-d-readiness`",
        ),
        ("M244-E017-DOC-PKT-12", "`compile:objc3c`"),
        ("M244-E017-DOC-PKT-13", "`proof:objc3c`"),
        ("M244-E017-DOC-PKT-14", "`test:objc3c:diagnostics-replay-proof`"),
        ("M244-E017-DOC-PKT-15", "`test:objc3c:execution-replay-proof`"),
        ("M244-E017-DOC-PKT-16", "`test:objc3c:perf-budget`"),
        (
            "M244-E017-DOC-PKT-17",
            "tmp/reports/m244/M244-E017/lane_e_interop_conformance_gate_operations_conformance_matrix_implementation_summary.json",
        ),
    ),
    "lowering_spec": (
