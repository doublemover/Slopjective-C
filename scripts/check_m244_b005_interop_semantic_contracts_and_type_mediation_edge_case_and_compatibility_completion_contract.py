#!/usr/bin/env python3
"""Fail-closed checker for M244-B005 interop semantic/type mediation edge-case and compatibility completion contract."""
...
MODE = "m244-b005-interop-semantic-contracts-and-type-mediation-edge-case-and-compatibility-completion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_semantic_contracts_and_type_mediation_edge_case_and_compatibility_completion_b005_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_b005_interop_semantic_contracts_and_type_mediation_edge_case_and_compatibility_completion_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B005/"
    "interop_semantic_contracts_and_type_mediation_edge_case_and_compatibility_completion_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M244-B005-B004-03",
        "M244-B004",
        Path("scripts/check_m244_b004_interop_semantic_contracts_and_type_mediation_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M244-B005-B004-04",
        "M244-B004",
        Path("tests/tooling/test_check_m244_b004_interop_semantic_contracts_and_type_mediation_core_feature_expansion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B005-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-edge-case-and-compatibility-completion/m244-b005-v1`",
    ),
    SnippetCheck("M244-B005-DOC-EXP-02", "Dependencies: `M244-B004`"),
    SnippetCheck("M244-B005-DOC-EXP-03", "Issue `#6535` defines canonical lane-B edge-case and compatibility completion scope."),
    SnippetCheck("M244-B005-DOC-EXP-04", "`check:objc3c:m244-b005-lane-b-readiness`"),
    SnippetCheck("M244-B005-DOC-EXP-05", "`check:objc3c:m244-b004-lane-b-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B005-DOC-PKT-01", "Packet: `M244-B005`"),
    SnippetCheck("M244-B005-DOC-PKT-02", "Issue: `#6535`"),
    SnippetCheck("M244-B005-DOC-PKT-03", "Dependencies: `M244-B004`"),
    SnippetCheck(
        "M244-B005-DOC-PKT-04",
        "`scripts/check_m244_b005_interop_semantic_contracts_and_type_mediation_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M244-B005-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B005-CFG-03", "check:objc3c:m244-b005-lane-b-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b004-lane-b-readiness && npm run check:objc3c:m244-b005-interop-semantic-contracts-type-mediation-edge-case-and-compatibility-completion-contract && npm run test:tooling:m244-b005-interop-semantic-contracts-type-mediation-edge-case-and-compatibility-completion-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B005-ARCH-02", "`M244-B004` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B005-SPC-02", "lane-B dependency anchor (`M244-B004`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-B005-META-02",
        "explicit `M244-B004` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B005-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B005-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-B005-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-B005-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-B005-META-00",
