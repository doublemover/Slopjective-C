#!/usr/bin/env python3
"""Fail-closed checker for M230-C007 Documentation generation as source-of-truth contract freeze."""
...
MODE = "m230-c007-documentation-generation-as-source-of-truth-diagnostics-hardening-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_c007_documentation_generation_as_source_of_truth_diagnostics_hardening_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-C007-DOC-PKT-01",
        "# M230-C007 Documentation generation as source-of-truth Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-C007-DOC-PKT-02", "Packet: `M230-C007`"),
    SnippetCheck("M230-C007-DOC-PKT-03", "Issue: `#5428`"),
    SnippetCheck("M230-C007-DOC-PKT-04", "Dependencies: `M230-C006`"),
    SnippetCheck(
        "M230-C007-DOC-PKT-05",
        "check:objc3c:m230-c007-documentation-generation-as-source-of-truth-diagnostics-hardening-contract",
    ),
    SnippetCheck(
        "M230-C007-DOC-PKT-06",
        "tmp/reports/m230/M230-C007/documentation_generation_as_source_of_truth_diagnostics_hardening_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-C007-PKG-03",
        '"check:objc3c:m230-c007-lane-c-readiness": '
        '"npm run check:objc3c:m230-c006-lane-c-readiness && npm run check:objc3c:m230-c007-documentation-generation-as-source-of-truth-diagnostics-hardening-contract '
        '&& npm run test:tooling:m230-c007-documentation-generation-as-source-of-truth-diagnostics-hardening-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-C007-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-C007-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-C007-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-C007-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-C007-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-C007-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
