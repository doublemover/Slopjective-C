#!/usr/bin/env python3
"""Fail-closed checker for M248-D012 runner/platform operations cross-lane integration sync contract."""
...
MODE = "m248-d012-runner-reliability-platform-operations-cross-lane-integration-sync-contract-v1"
...
DEFAULT_D011_CHECKER = (
    ROOT
    / "scripts"
    / "check_m248_d011_runner_reliability_and_platform_operations_performance_and_quality_guardrails_contract.py"
)
DEFAULT_D011_TOOLING_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m248_d011_runner_reliability_and_platform_operations_performance_and_quality_guardrails_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-D012-DOC-EXP-01",
        "Contract ID: `objc3c-runner-reliability-platform-operations-cross-lane-integration-sync/m248-d012-v1`",
    ),
    SnippetCheck("M248-D012-DOC-EXP-02", "Dependencies: `M248-D011`"),
    SnippetCheck("M248-D012-DOC-EXP-03", "Issue `#6847` defines canonical lane-D cross-lane integration sync scope."),
    SnippetCheck("M248-D012-DOC-EXP-04", "cross_lane_integration_sync_consistent"),
    SnippetCheck("M248-D012-DOC-EXP-05", "cross_lane_integration_sync_ready"),
    SnippetCheck("M248-D012-DOC-EXP-06", "cross_lane_integration_sync_key_ready"),
    SnippetCheck(
        "M248-D012-DOC-EXP-07",
        "scripts/check_m248_d012_runner_reliability_and_platform_operations_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M248-D012-DOC-EXP-08",
        "tests/tooling/test_check_m248_d012_runner_reliability_and_platform_operations_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M248-D012-DOC-EXP-09",
        "tmp/reports/m248/M248-D012/runner_reliability_and_platform_operations_cross_lane_integration_sync_contract_summary.json",
    ),
    SnippetCheck("M248-D012-DOC-EXP-10", "`check:objc3c:m248-d012-lane-d-readiness`"),
    SnippetCheck(
        "M248-D012-DOC-EXP-11",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-D012-DOC-PKT-01", "Packet: `M248-D012`"),
    SnippetCheck("M248-D012-DOC-PKT-02", "Issue: `#6847`"),
    SnippetCheck("M248-D012-DOC-PKT-03", "Dependencies"),
    SnippetCheck("M248-D012-DOC-PKT-04", "`M248-D011`"),
    SnippetCheck(
        "M248-D012-DOC-PKT-05",
        "`scripts/check_m248_d012_runner_reliability_and_platform_operations_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M248-D012-DOC-PKT-06",
        "`tests/tooling/test_check_m248_d012_runner_reliability_and_platform_operations_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck("M248-D012-DOC-PKT-07", "`check:objc3c:m248-d012-lane-d-readiness`"),
    SnippetCheck(
        "M248-D012-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
D011_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-D012-DEP-02", "Packet: `M248-D011`"),
    SnippetCheck("M248-D012-DEP-03", "Dependencies"),
    SnippetCheck("M248-D012-DEP-04", "`M248-D010`"),
)

D011_CHECKER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-D012-DEP-05",
        "m248-d011-runner-reliability-platform-operations-performance-quality-guardrails-contract-v1",
    ),
)

D011_TOOLING_TEST_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-D012-DEP-06",
        "check_m248_d011_runner_reliability_and_platform_operations_performance_and_quality_guardrails_contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-D012-SPC-04", "platform replay and lane-e conformance matrix advances."),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-D012-META-02",
        "explicit `M248-D011` dependency continuity and fail-closed cross-lane integration evidence continuity",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-D012-CFG-03", "check:objc3c:m248-d012-lane-d-readiness"),
    PackageScriptKeyCheck("M248-D012-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M248-D012-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M248-D012-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M248-D012-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-d011-lane-d-readiness && npm run check:objc3c:m248-d012-runner-reliability-platform-operations-cross-lane-integration-sync-contract && npm run test:tooling:m248-d012-runner-reliability-platform-operations-cross-lane-integration-sync-contract",
    ),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--d011-tooling-test", type=Path, default=DEFAULT_D011_TOOLING_TEST)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M248-D012-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M248-D012-DOC-PKT-00", PACKET_SNIPPETS),
        (
            "d011_expectations_doc",
            args.d011_expectations_doc,
            "M248-D012-DEP-00",
            D011_EXPECTATIONS_SNIPPETS,
        ),
        ("d011_packet_doc", args.d011_packet_doc, "M248-D012-DEP-00", D011_PACKET_SNIPPETS),
        ("d011_checker", args.d011_checker, "M248-D012-DEP-00", D011_CHECKER_SNIPPETS),
        ("d011_tooling_test", args.d011_tooling_test, "M248-D012-DEP-00", D011_TOOLING_TEST_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M248-D012-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M248-D012-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M248-D012-META-00", METADATA_SPEC_SNIPPETS),
    ):
