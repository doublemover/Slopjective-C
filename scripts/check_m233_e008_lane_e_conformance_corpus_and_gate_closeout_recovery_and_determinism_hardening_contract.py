#!/usr/bin/env python3
"""Fail-closed checker for M233-E008 conformance corpus and gate closeout recovery and determinism hardening."""
...
MODE = "m233-e008-lane-e-conformance-corpus-gate-closeout-recovery-and-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_e008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_e008_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M233-E008-DEP-E007-01",
        Path("docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_diagnostics_hardening_e007_expectations.md"),
    ),
    AssetCheck(
        "M233-E008-DEP-E007-02",
        Path("spec/planning/compiler/m233/m233_e007_lane_e_conformance_corpus_and_gate_closeout_diagnostics_hardening_packet.md"),
    ),
    AssetCheck(
        "M233-E008-DEP-E007-03",
        Path("scripts/check_m233_e007_lane_e_conformance_corpus_and_gate_closeout_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M233-E008-DEP-E007-04",
        Path("tests/tooling/test_check_m233_e007_lane_e_conformance_corpus_and_gate_closeout_diagnostics_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E008-DOC-EXP-01",
        "# M233 Lane E Conformance Corpus and Gate Closeout Recovery and Determinism Hardening Expectations (E008)",
    ),
    SnippetCheck(
        "M233-E008-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-conformance-corpus-gate-closeout-recovery-and-determinism-hardening/m233-e008-v1`",
    ),
    SnippetCheck(
        "M233-E008-DOC-EXP-03",
        "Issue `#5661` defines canonical lane-E recovery and determinism hardening scope.",
    ),
    SnippetCheck(
        "M233-E008-DOC-EXP-04",
        "Dependencies: `M233-E007`, `M233-A006`, `M233-B008`, `M233-C010`, `M233-D013`",
    ),
    SnippetCheck(
        "M233-E008-DOC-EXP-05",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_diagnostics_hardening_e007_expectations.md",
    ),
    SnippetCheck(
        "M233-E008-DOC-EXP-06",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E008-DOC-EXP-07",
        "`scripts/check_m233_e008_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M233-E008-DOC-EXP-08",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-E008-DOC-PKT-01",
        "# M233-E008 Lane-E Conformance Corpus and Gate Closeout Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M233-E008-DOC-PKT-02", "Packet: `M233-E008`"),
    SnippetCheck("M233-E008-DOC-PKT-03", "Issue: `#5661`"),
    SnippetCheck(
        "M233-E008-DOC-PKT-04",
        "Dependencies: `M233-E007`, `M233-A006`, `M233-B008`, `M233-C010`, `M233-D013`",
    ),
    SnippetCheck("M233-E008-DOC-PKT-05", "Theme: recovery and determinism hardening"),
    SnippetCheck(
        "M233-E008-DOC-PKT-06",
        "docs/contracts/m233_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_e008_expectations.md",
    ),
    SnippetCheck(
        "M233-E008-DOC-PKT-07",
        "scripts/check_m233_e008_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M233-E008-DOC-PKT-08",
        "tests/tooling/test_check_m233_e008_lane_e_conformance_corpus_and_gate_closeout_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M233-E008-DOC-PKT-09",
        "spec/planning/compiler/m233/m233_e007_lane_e_conformance_corpus_and_gate_closeout_diagnostics_hardening_packet.md",
    ),
    SnippetCheck(
        "M233-E008-DOC-PKT-10",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-E008-DOC-PKT-11",
        "tmp/reports/m233/M233-E008/lane_e_conformance_corpus_gate_closeout_recovery_and_determinism_hardening_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-E008-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M233-E008-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M233-E008-PKG-03", '"test:objc3c:diagnostics-replay-proof": '),
    SnippetCheck("M233-E008-PKG-04", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-E008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-E008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M233-E008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
