...
UMBRELLA_READINESS_SCHEMA_ID = "objc3c-umbrella-readiness-v1"
...
UMBRELLA_READINESS_SCHEMA_PATH = schema_path(UMBRELLA_READINESS_SCHEMA_ID)
...
UMBRELLA_READINESS_DOC = ROOT / "docs" / "support" / "umbrella_readiness.md"
...
def capability_truth_owner_contract() -> dict[str, object]:
    return {
        ...
        "umbrella_readiness_owner": {
            "owner_id": "capability-docs.umbrella-readiness-owner",
            "owner_surface": "scripts/capability_docs_validator/umbrella_readiness.py",
            "readiness_path": UMBRELLA_READINESS_PATH.relative_to(ROOT).as_posix(),
            "readiness_schema_path": UMBRELLA_READINESS_SCHEMA_PATH.relative_to(ROOT).as_posix(),
            "readiness_doc": UMBRELLA_READINESS_DOC.relative_to(ROOT).as_posix(),
        },
        "manifest_owner": {
