#!/usr/bin/env python3
"""Run the M258-C002 lane-C readiness chain without deep npm nesting."""
...
DEPENDENCY_TOKEN = "M258-B002 + M258-C001 + M258-C002"
...
def run_chain() -> int:
    print(
        ...
        f"{DEPENDENCY_TOKEN} (M258-C002 emits and reloads the serialized runtime-metadata reuse payload through runtime-import-surface artifacts)"
    )
    ...
    print("[ok] M258-C002 lane-C readiness chain completed")
    return 0
