#!/usr/bin/env python3
"""Fail-closed checker for M235-E015 qualifier/generic conformance gate advanced core workpack (shard 1)."""
...
MODE = "m235-e015-qualifier-generic-conformance-gate-advanced-core-workpack-shard-1-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_generic_conformance_gate_advanced_core_workpack_shard_1_e015_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_e015_qualifier_generic_conformance_gate_advanced_core_workpack_shard_1_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m235/M235-E015/local_check_summary.json")
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-E015-DOC-PKT-01",
        "# M235-E015 Qualifier Generic Conformance Gate Advanced Core Workpack (shard 1) Packet",
    ),
    SnippetCheck("M235-E015-DOC-PKT-02", "Packet: `M235-E015`"),
    SnippetCheck("M235-E015-DOC-PKT-03", "Issue: `#5854`"),
    SnippetCheck(
        "M235-E015-DOC-PKT-04",
        "Dependencies: `M235-E014`, `M235-A003`, `M235-B006`, `M235-C004`, `M235-D002`",
    ),
    SnippetCheck(
        "M235-E015-DOC-PKT-05",
        "Dependency continuity from E002 remains fail-closed through these anchors:",
    ),
    SnippetCheck(
        "M235-E015-DOC-PKT-06",
        "docs/contracts/m235_qualifier_generic_conformance_gate_advanced_core_workpack_shard_1_e015_expectations.md",
    ),
    SnippetCheck(
        "M235-E015-DOC-PKT-07",
        "scripts/check_m235_e015_qualifier_generic_conformance_gate_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M235-E015-DOC-PKT-08",
        "tests/tooling/test_check_m235_e015_qualifier_generic_conformance_gate_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M235-E015-DOC-PKT-09",
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-E015-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-E015-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
