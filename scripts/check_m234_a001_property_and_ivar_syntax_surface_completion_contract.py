#!/usr/bin/env python3
"""Fail-closed contract checker for the M234-A001 property/ivar syntax surface freeze."""
...
MODE = "m234-a001-property-and-ivar-syntax-surface-completion-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-A001-DOC-PKT-01",
        "# M234-A001 Property and Ivar Syntax Surface Completion Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M234-A001-DOC-PKT-02", "Packet: `M234-A001`"),
    SnippetCheck("M234-A001-DOC-PKT-03", "Dependencies: none"),
    SnippetCheck(
        "M234-A001-DOC-PKT-04",
        "`check:objc3c:m234-a001-property-and-ivar-syntax-surface-completion-contract`",
    ),
    SnippetCheck(
        "M234-A001-DOC-PKT-05",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-A001-ARCH-01",
        "M234 lane-A A001 property and ivar syntax surface completion anchors",
    ),
    SnippetCheck(
        "M234-A001-ARCH-02",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A001-PKG-03",
        '"check:objc3c:m234-a001-lane-a-readiness": '
        '"npm run check:objc3c:m234-a001-property-and-ivar-syntax-surface-completion-contract '
        '&& npm run test:tooling:m234-a001-property-and-ivar-syntax-surface-completion-contract"',
    ),
    SnippetCheck("M234-A001-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M234-A001-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-A001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-A001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M234-A001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-A001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-A001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-A001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
