#!/usr/bin/env python3
"""Fail-closed checker for M230-E005 Program control and release readiness governance contract freeze."""
...
MODE = "m230-e005-program-control-and-release-readiness-governance-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_e005_program_control_and_release_readiness_governance_edge_case_and_compatibility_completion_packet.md"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-E005-PKG-03",
        '"check:objc3c:m230-e005-lane-e-readiness": '
        '"npm run check:objc3c:m230-e004-lane-e-readiness && npm run check:objc3c:m230-e005-program-control-and-release-readiness-governance-edge-case-and-compatibility-completion-contract '
        '&& npm run test:tooling:m230-e005-program-control-and-release-readiness-governance-edge-case-and-compatibility-completion-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-E005-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-E005-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-E005-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-E005-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-E005-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-E005-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
