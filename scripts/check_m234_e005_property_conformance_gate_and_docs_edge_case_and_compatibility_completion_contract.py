#!/usr/bin/env python3
"""Fail-closed checker for M234-E005 property conformance gate and docs edge-case and compatibility completion."""
...
MODE = "m234-e005-property-conformance-gate-docs-edge-case-and-compatibility-completion-contract-v1"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M234-E005-DEP-E004-01",
        Path("docs/contracts/m234_property_conformance_gate_and_docs_core_feature_expansion_e004_expectations.md"),
    ),
    AssetCheck(
        "M234-E005-DEP-E004-02",
        Path("spec/planning/compiler/m234/m234_e004_property_conformance_gate_and_docs_core_feature_expansion_packet.md"),
    ),
    AssetCheck(
        "M234-E005-DEP-E004-03",
        Path("scripts/check_m234_e004_property_conformance_gate_and_docs_core_feature_expansion_contract.py"),
    ),
    AssetCheck(
        "M234-E005-DEP-E004-04",
        Path(
            "tests/tooling/"
            "test_check_m234_e004_property_conformance_gate_and_docs_core_feature_expansion_contract.py"
        ),
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-E005-DOC-PKT-01",
        "# M234-E005 Lane-E Conformance Corpus and Gate Closeout Edge-Case and Compatibility Completion Packet",
    ),
    SnippetCheck("M234-E005-DOC-PKT-02", "Packet: `M234-E005`"),
    SnippetCheck("M234-E005-DOC-PKT-03", "Issue: `#5752`"),
    SnippetCheck(
        "M234-E005-DOC-PKT-04",
        "Dependencies: `M234-E004`, `M234-A005`, `M234-B005`, `M234-C005`, `M234-D004`",
    ),
    SnippetCheck(
        "M234-E005-DOC-PKT-05",
        "docs/contracts/m234_property_conformance_gate_and_docs_edge_case_and_compatibility_completion_e005_expectations.md",
    ),
    SnippetCheck(
        "M234-E005-DOC-PKT-06",
        "scripts/check_m234_e005_property_conformance_gate_and_docs_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M234-E005-DOC-PKT-07",
        "tests/tooling/test_check_m234_e005_property_conformance_gate_and_docs_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M234-E005-DOC-PKT-08",
        "spec/planning/compiler/m234/m234_e004_property_conformance_gate_and_docs_core_feature_expansion_packet.md",
    ),
    SnippetCheck(
        "M234-E005-DOC-PKT-09",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M234-E005-DOC-PKT-10",
        "tmp/reports/m234/M234-E005/property_conformance_gate_docs_edge_case_and_compatibility_completion_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-E005-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M234-E005-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M234-E005-PKG-03", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-E005-PKG-04", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-E005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-E005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M234-E005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
