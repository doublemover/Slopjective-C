#!/usr/bin/env python3
"""Fail-closed validator for M228-C024 IR-emission advanced integration shard1 contract."""
...
MODE = "m228-c024-ir-emission-completeness-advanced-conformance-workpack-shard2-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c023_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_diagnostics_workpack_shard2_c023_expectations.md",
    "c023_checker": ROOT
    / "scripts"
    / "check_m228_c023_ir_emission_completeness_advanced_diagnostics_workpack_shard2_contract.py",
    "c023_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c023_ir_emission_completeness_advanced_diagnostics_workpack_shard2_contract.py",
    "c023_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c023_ir_emission_completeness_advanced_diagnostics_workpack_shard2_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_conformance_workpack_shard2_c024_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c024_ir_emission_completeness_advanced_conformance_workpack_shard2_packet.md",
}
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C024-RUN-04", "npm run check:objc3c:m228-c024-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C024-ARC-01",
    ...
    "package_json": (
        ("M228-C024-PKG-01", '"check:objc3c:m228-c023-lane-c-readiness"'),
        (
            "M228-C024-PKG-02",
            '"check:objc3c:m228-c024-ir-emission-completeness-advanced-conformance-workpack-shard2-contract"',
        ),
        (
            "M228-C024-PKG-03",
            '"test:tooling:m228-c024-ir-emission-completeness-advanced-conformance-workpack-shard2-contract"',
        ),
        ("M228-C024-PKG-04", '"check:objc3c:m228-c024-lane-c-readiness"'),
        (
            "M228-C024-PKG-05",
            '"check:objc3c:m228-c024-lane-c-readiness": "npm run check:objc3c:m228-c023-lane-c-readiness &&',
        ),
    ),
    "c023_contract_doc": (
        (
            "M228-C024-DEP-01",
            "Contract ID: `objc3c-ir-emission-completeness-advanced-diagnostics-workpack-shard2/m228-c023-v1`",
        ),
    ),
    "c023_checker": (
        (
            "M228-C024-DEP-02",
            'MODE = "m228-c023-ir-emission-completeness-advanced-diagnostics-workpack-shard2-contract-v1"',
        ),
    ),
    "c023_tooling_test": (
        ("M228-C024-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c023_packet_doc": (
        ("M228-C024-DEP-04", "Packet: `M228-C023`"),
        ("M228-C024-DEP-05", "Issue: `#5249`"),
    ),
    "contract_doc": (
        (
            "M228-C024-DOC-01",
        ...
        ("M228-C024-DOC-02", "Execute issue `#5250`"),
        ("M228-C024-DOC-03", "Dependencies: `M228-C023`"),
        (
            "M228-C024-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C024-PKT-02", "Packet: `M228-C024`"),
        ("M228-C024-PKT-03", "Issue: `#5250`"),
        ("M228-C024-PKT-04", "Dependencies: `M228-C023`"),
        (
            "M228-C024-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C024-FORB-01",
            '"check:objc3c:m228-c024-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C024/"
            "ir_emission_completeness_advanced_conformance_workpack_shard2_contract_summary.json"
        ),
    )
