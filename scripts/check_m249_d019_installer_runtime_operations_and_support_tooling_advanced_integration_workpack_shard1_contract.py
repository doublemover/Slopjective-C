#!/usr/bin/env python3
"""Fail-closed checker for M249-D019 installer/runtime advanced integration workpack (shard 1)."""
...
MODE = "m249-d019-installer-runtime-operations-support-tooling-advanced-integration-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_installer_runtime_operations_and_support_tooling_advanced_integration_workpack_shard1_d019_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D019-DOC-PKT-01",
        "# M249-D019 Installer/Runtime Operations and Support Tooling Advanced Integration Workpack (Shard 1) Packet",
    ),
...
READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-D019-RUN-05", "[ok] M249-D019 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-D019-PKG-03",
        '"check:objc3c:m249-d019-lane-d-readiness": "python scripts/run_m249_d019_lane_d_readiness.py"',
    ),
    SnippetCheck("M249-D019-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M249-D019-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M249-D019-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M249-D019-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        ...
        (args.metadata_spec, "M249-D019-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-D019-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
