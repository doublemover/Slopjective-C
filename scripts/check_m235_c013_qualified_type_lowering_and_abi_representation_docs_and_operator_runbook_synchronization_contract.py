#!/usr/bin/env python3
"""Fail-closed checker for M235-C013 qualified type docs and operator runbook synchronization."""
...
MODE = "m235-c013-qualified-type-lowering-and-abi-representation-docs-and-operator-runbook-synchronization-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_c013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_c013_qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_packet.md"
)
DEFAULT_C012_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_c012_expectations.md"
)
DEFAULT_C012_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_c012_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_packet.md"
)
DEFAULT_C012_CHECKER = (
    ROOT / "scripts" / "check_m235_c012_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_contract.py"
)
DEFAULT_C012_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c012_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M235-C013-DEP-C012-01",
        Path(
            "docs/contracts/m235_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_c012_expectations.md"
        ),
    ),
    AssetCheck(
        "M235-C013-DEP-C012-02",
        Path("spec/planning/compiler/m235/m235_c012_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_packet.md"),
    ),
    AssetCheck(
        "M235-C013-DEP-C012-03",
        Path("scripts/check_m235_c012_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_contract.py"),
    ),
    AssetCheck(
        "M235-C013-DEP-C012-04",
        Path("tests/tooling/test_check_m235_c012_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C013-DOC-EXP-01",
        "# M235 Qualified Type Lowering and ABI Representation Docs and Operator Runbook Synchronization Expectations (C013)",
    ),
    SnippetCheck(
        "M235-C013-DOC-EXP-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-docs-and-operator-runbook-synchronization/m235-c013-v1`",
    ),
    SnippetCheck("M235-C013-DOC-EXP-03", "Dependencies: `M235-C012`"),
    SnippetCheck(
        "M235-C013-DOC-EXP-04",
        "Issue `#5823` defines canonical lane-C docs and operator runbook synchronization scope.",
    ),
    SnippetCheck(
        "M235-C013-DOC-EXP-05",
        "optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-C013-DOC-EXP-06",
        "docs/contracts/m235_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_c012_expectations.md",
    ),
    SnippetCheck(
        "M235-C013-DOC-EXP-07",
        "scripts/check_m235_c012_qualified_type_lowering_and_abi_representation_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M235-C013-DOC-EXP-08",
    ...
    SnippetCheck("M235-C013-DOC-EXP-09", "`C012 readiness -> C013 checker -> C013 pytest`."),
    SnippetCheck(
        "M235-C013-DOC-EXP-10",
        "`tmp/reports/m235/M235-C013/qualified_type_lowering_and_abi_representation_docs_and_operator_runbook_synchronization_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C013-DOC-PKT-01",
        "# M235-C013 Qualified Type Lowering and ABI Representation Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M235-C013-DOC-PKT-02", "Packet: `M235-C013`"),
    SnippetCheck("M235-C013-DOC-PKT-03", "Issue: `#5823`"),
    SnippetCheck("M235-C013-DOC-PKT-04", "Dependencies: `M235-C012`"),
    SnippetCheck(
        "M235-C013-DOC-PKT-05",
        "including code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M235-C013-DOC-PKT-06",
    ...
    SnippetCheck("M235-C013-DOC-PKT-08", "`npm run check:objc3c:m235-c012-lane-c-readiness`"),
    SnippetCheck(
        "M235-C013-DOC-PKT-09",
        "`C012 readiness -> C013 checker -> C013 pytest`",
    ),
    SnippetCheck(
        "M235-C013-DOC-PKT-10",
...
C012_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C013-C012-DOC-01",
        "# M235 Qualified Type Lowering and ABI Representation Cross-lane Integration Sync Expectations (C012)",
    ),
    SnippetCheck(
        "M235-C013-C012-DOC-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-cross-lane-integration-sync/m235-c012-v1`",
    ),
    SnippetCheck("M235-C013-C012-DOC-03", "Dependencies: `M235-C011`"),
    SnippetCheck(
        "M235-C013-C012-DOC-04",
        "Issue `#5822` defines canonical lane-C cross-lane integration sync scope.",
    ),
)

C012_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-C013-C012-PKT-01", "Packet: `M235-C012`"),
    SnippetCheck("M235-C013-C012-PKT-02", "Issue: `#5822`"),
    SnippetCheck("M235-C013-C012-PKT-03", "Dependencies: `M235-C011`"),
    SnippetCheck("M235-C013-C012-PKT-04", "Freeze date: `2026-03-05`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-C013-PKG-03",
        '"check:objc3c:m235-c012-lane-c-readiness": '
        '"npm run check:objc3c:m235-c011-lane-c-readiness '
        '&& npm run check:objc3c:m235-c012-qualified-type-lowering-and-abi-representation-cross-lane-integration-sync-contract '
        '&& npm run test:tooling:m235-c012-qualified-type-lowering-and-abi-representation-cross-lane-integration-sync-contract"',
    ),
    SnippetCheck(
        "M235-C013-PKG-04",
        '"check:objc3c:m235-c013-lane-c-readiness": '
        '"npm run check:objc3c:m235-c012-lane-c-readiness '
        '&& npm run check:objc3c:m235-c013-qualified-type-lowering-and-abi-representation-docs-and-operator-runbook-synchronization-contract '
        '&& npm run test:tooling:m235-c013-qualified-type-lowering-and-abi-representation-docs-and-operator-runbook-synchronization-contract"',
    ),
    SnippetCheck(
        "M235-C013-PKG-05",
    ...
    SnippetCheck("M235-C013-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-C013-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-C013-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C013-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c012_expectations_doc, "M235-C013-C012-DOC-EXISTS", C012_EXPECTATIONS_SNIPPETS),
        (args.c012_packet_doc, "M235-C013-C012-PKT-EXISTS", C012_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C013-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C013-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C013-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C013-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c012_checker, "M235-C013-DEP-C012-ARG-01"),
        (args.c012_test, "M235-C013-DEP-C012-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
