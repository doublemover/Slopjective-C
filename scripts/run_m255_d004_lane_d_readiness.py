#!/usr/bin/env python3
"""Lane-D readiness chain for M255-D004."""
...
COMMANDS: tuple[tuple[str, ...], ...] = (
    ...
    ("python", "scripts/check_m255_d004_protocol_and_category_aware_method_resolution_core_feature_expansion.py"),
    (
        "python",
        "-m",
        "pytest",
...
def main() -> int:
    for command in COMMANDS:
        ...
        if status != 0:
            return status
    print("[ok] M255-D004 lane-D readiness chain completed", flush=True)
    return 0
