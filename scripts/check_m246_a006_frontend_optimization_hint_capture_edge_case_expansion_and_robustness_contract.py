#!/usr/bin/env python3
"""Fail-closed checker for M246-A006 frontend optimization hint edge-case expansion and robustness."""
...
MODE = "m246-a006-frontend-optimization-hint-capture-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_A005_CHECKER = (
    ROOT / "scripts" / "check_m246_a005_frontend_optimization_hint_capture_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_A005_TEST = (
    ROOT
    / "tests"
...
DEFAULT_A005_RUN_SCRIPT = ROOT / "scripts" / "run_m246_a005_lane_a_readiness.py"
DEFAULT_RUN_SCRIPT = ROOT / "scripts" / "run_m246_a006_lane_a_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-A006-DOC-PKT-01",
        "# M246-A006 Frontend Optimization Hint Capture Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M246-A006-DOC-PKT-02", "Packet: `M246-A006`"),
    SnippetCheck("M246-A006-DOC-PKT-03", "Wave: `W40`"),
    SnippetCheck("M246-A006-DOC-PKT-04", "Issue: `#5053`"),
    SnippetCheck("M246-A006-DOC-PKT-05", "Dependencies: `M246-A005`"),
    SnippetCheck(
        "M246-A006-DOC-PKT-06",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-A006-DOC-PKT-07",
        "scripts/check_m246_a006_frontend_optimization_hint_capture_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M246-A006-DOC-PKT-08",
        "tests/tooling/test_check_m246_a006_frontend_optimization_hint_capture_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M246-A006-DOC-PKT-09",
        "`python scripts/check_m246_a006_frontend_optimization_hint_capture_edge_case_expansion_and_robustness_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M246-A006-DOC-PKT-10",
        "scripts/run_m246_a006_lane_a_readiness.py",
    ),
    SnippetCheck(
        "M246-A006-DOC-PKT-11",
        "`tmp/reports/m246/M246-A006/frontend_optimization_hint_capture_edge_case_expansion_and_robustness_summary.json`",
    ),
)
...
A005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-A006-A005-DOC-01",
        "# M246 Frontend Optimization Hint Capture Edge-Case and Compatibility Completion Expectations (A005)",
    ),
    SnippetCheck(
        "M246-A006-A005-DOC-02",
        "Contract ID: `objc3c-frontend-optimization-hint-capture-edge-case-and-compatibility-completion/m246-a005-v1`",
    ),
    SnippetCheck("M246-A006-A005-DOC-03", "Dependencies: `M246-A004`"),
)

A005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A006-A005-PKT-01", "Packet: `M246-A005`"),
    SnippetCheck("M246-A006-A005-PKT-02", "Dependencies: `M246-A004`"),
)

A005_RUN_SCRIPT_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A006-A005-RUN-01", "scripts/run_m246_a004_lane_a_readiness.py"),
    SnippetCheck(
        "M246-A006-A005-RUN-02",
        "scripts/check_m246_a005_frontend_optimization_hint_capture_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M246-A006-A005-RUN-03",
...
RUN_SCRIPT_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A006-RUN-01", "scripts/run_m246_a005_lane_a_readiness.py"),
    SnippetCheck(
        "M246-A006-RUN-02",
        "scripts/check_m246_a006_frontend_optimization_hint_capture_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck("M246-A006-RUN-03", "--emit-json"),
    SnippetCheck(
        "M246-A006-RUN-04",
        "tests/tooling/test_check_m246_a006_frontend_optimization_hint_capture_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck("M246-A006-RUN-05", "M246-A006 lane-A readiness chain completed"),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A006-PKG-01", '"check:objc3c:m246-a002-lane-a-readiness": '),
    SnippetCheck("M246-A006-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-A006-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-A006-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-A006-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--a005-run-script", type=Path, default=DEFAULT_A005_RUN_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-A006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-A006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a005_expectations_doc, "M246-A006-A005-DOC-EXISTS", A005_EXPECTATIONS_SNIPPETS),
        (args.a005_packet_doc, "M246-A006-A005-PKT-EXISTS", A005_PACKET_SNIPPETS),
        (args.a005_run_script, "M246-A006-A005-RUN-EXISTS", A005_RUN_SCRIPT_SNIPPETS),
        (args.run_script, "M246-A006-RUN-EXISTS", RUN_SCRIPT_SNIPPETS),
        (args.package_json, "M246-A006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a005_checker, "M246-A006-DEP-A005-ARG-01"),
        (args.a005_test, "M246-A006-DEP-A005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
