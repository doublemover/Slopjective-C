#!/usr/bin/env python3
"""Fail-closed checker for M245-E008 portability gate/release checklist recovery and determinism hardening."""
...
MODE = "m245-e008-lane-e-portability-gate-release-checklist-recovery-and-determinism-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_lane_e_portability_gate_and_release_checklist_recovery_and_determinism_hardening_e008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_e008_lane_e_portability_gate_and_release_checklist_recovery_and_determinism_hardening_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M245-E008-DEP-E007-01",
        Path("docs/contracts/m245_lane_e_portability_gate_and_release_checklist_diagnostics_hardening_e007_expectations.md"),
    ),
    AssetCheck(
        "M245-E008-DEP-E007-02",
        Path("spec/planning/compiler/m245/m245_e007_lane_e_portability_gate_and_release_checklist_diagnostics_hardening_packet.md"),
    ),
    AssetCheck(
        "M245-E008-DEP-E007-03",
        Path("scripts/check_m245_e007_lane_e_portability_gate_and_release_checklist_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M245-E008-DEP-E007-04",
        Path("tests/tooling/test_check_m245_e007_lane_e_portability_gate_and_release_checklist_diagnostics_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-E008-DOC-EXP-01",
        "# M245 Lane E Portability Gate and Release Checklist Recovery and Determinism Hardening Expectations (E008)",
    ),
    SnippetCheck(
        "M245-E008-DOC-EXP-02",
        "Contract ID: `objc3c-lane-e-portability-gate-release-checklist-recovery-and-determinism-hardening/m245-e008-v1`",
    ),
    SnippetCheck(
        "M245-E008-DOC-EXP-03",
        "Issue `#6680` defines canonical lane-E recovery and determinism hardening scope.",
    ),
    SnippetCheck(
        "M245-E008-DOC-EXP-04",
        "Dependencies: `M245-E007`, `M245-A003`, `M245-B004`, `M245-C004`, `M245-D006`",
    ),
    SnippetCheck(
        "M245-E008-DOC-EXP-05",
        "docs/contracts/m245_lane_e_portability_gate_and_release_checklist_diagnostics_hardening_e007_expectations.md",
    ),
    SnippetCheck(
        "M245-E008-DOC-EXP-06",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-E008-DOC-EXP-07",
        "`scripts/check_m245_e008_lane_e_portability_gate_and_release_checklist_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M245-E008-DOC-EXP-08",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-E008-DOC-PKT-01",
        "# M245-E008 Lane-E Portability Gate and Release Checklist Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M245-E008-DOC-PKT-02", "Packet: `M245-E008`"),
    SnippetCheck("M245-E008-DOC-PKT-03", "Issue: `#6680`"),
    SnippetCheck(
        "M245-E008-DOC-PKT-04",
        "Dependencies: `M245-E007`, `M245-A003`, `M245-B004`, `M245-C004`, `M245-D006`",
    ),
    SnippetCheck("M245-E008-DOC-PKT-05", "Theme: recovery and determinism hardening"),
    SnippetCheck(
        "M245-E008-DOC-PKT-06",
    ...
    SnippetCheck(
        "M245-E008-DOC-PKT-07",
        "scripts/check_m245_e008_lane_e_portability_gate_and_release_checklist_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M245-E008-DOC-PKT-08",
        "tests/tooling/test_check_m245_e008_lane_e_portability_gate_and_release_checklist_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M245-E008-DOC-PKT-09",
        "spec/planning/compiler/m245/m245_e007_lane_e_portability_gate_and_release_checklist_diagnostics_hardening_packet.md",
    ),
    SnippetCheck(
        "M245-E008-DOC-PKT-10",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-E008-DOC-PKT-11",
        "tmp/reports/m245/M245-E008/lane_e_portability_gate_release_checklist_recovery_and_determinism_hardening_summary.json",
    ),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-E008-PKG-01", '"compile:objc3c": '),
    SnippetCheck("M245-E008-PKG-02", '"proof:objc3c": '),
    SnippetCheck("M245-E008-PKG-03", '"test:objc3c:diagnostics-replay-proof": '),
    SnippetCheck("M245-E008-PKG-04", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-E008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-E008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.package_json, "M245-E008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
