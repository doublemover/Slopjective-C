#!/usr/bin/env python3
"""Fail-closed checker for M246-E012 optimization gate/perf evidence cross-lane integration sync."""
...
MODE = "m246-e012-optimization-gate-perf-evidence-cross-lane-integration-sync-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_e012_lane_e_readiness.py"
...
DEFAULT_E011_CHECKER = (
    ROOT
    / "scripts"
    / "check_m246_e011_optimization_gate_and_perf_evidence_performance_and_quality_guardrails_contract.py"
)
DEFAULT_E011_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m246_e011_optimization_gate_and_perf_evidence_performance_and_quality_guardrails_contract.py"
)
DEFAULT_E011_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_e011_lane_e_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M246-E012-DEP-E011-01",
        Path("docs/contracts/m246_optimization_gate_and_perf_evidence_performance_and_quality_guardrails_e011_expectations.md"),
    ),
    AssetCheck(
        "M246-E012-DEP-E011-02",
        Path("spec/planning/compiler/m246/m246_e011_optimization_gate_and_perf_evidence_performance_and_quality_guardrails_packet.md"),
    ),
    AssetCheck(
        "M246-E012-DEP-E011-03",
        Path("scripts/check_m246_e011_optimization_gate_and_perf_evidence_performance_and_quality_guardrails_contract.py"),
    ),
    AssetCheck(
        "M246-E012-DEP-E011-04",
        Path("tests/tooling/test_check_m246_e011_optimization_gate_and_perf_evidence_performance_and_quality_guardrails_contract.py"),
    ),
    AssetCheck(
        "M246-E012-DEP-E011-05",
        Path("scripts/run_m246_e011_lane_e_readiness.py"),
    ),
    AssetCheck(
        "M246-E012-DEP-A008-01",
        Path("docs/contracts/m246_frontend_optimization_hint_capture_recovery_and_determinism_hardening_a008_expectations.md"),
    ),
    AssetCheck(
        "M246-E012-DEP-A008-02",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-E012-DOC-PKT-01",
        "# M246-E012 Optimization Gate and Perf Evidence Cross-Lane Integration Sync Packet",
    ),
    SnippetCheck("M246-E012-DOC-PKT-02", "Packet: `M246-E012`"),
    SnippetCheck("M246-E012-DOC-PKT-03", "Issue: `#6703`"),
    SnippetCheck(
        "M246-E012-DOC-PKT-04",
        "Dependencies: `M246-E011`, `M246-A008`, `M246-B012`, `M246-C020`, `M246-D008`",
    ),
    SnippetCheck("M246-E012-DOC-PKT-05", "Theme: cross-lane integration sync"),
    SnippetCheck("M246-E012-DOC-PKT-06", "Pending seeded dependency tokens:"),
    SnippetCheck("M246-E012-DOC-PKT-07", "- `M246-B012`"),
    SnippetCheck("M246-E012-DOC-PKT-08", "- `M246-C020`"),
    SnippetCheck("M246-E012-DOC-PKT-09", "Real readiness dependency anchor:"),
    SnippetCheck("M246-E012-DOC-PKT-10", "- `M246-D008`"),
    SnippetCheck(
        "M246-E012-DOC-PKT-11",
        "python scripts/run_m246_e011_lane_e_readiness.py",
    ),
    SnippetCheck(
        "M246-E012-DOC-PKT-12",
        "python scripts/run_m246_a008_lane_a_readiness.py",
    ),
    SnippetCheck(
        "M246-E012-DOC-PKT-13",
        "npm run --if-present check:objc3c:m246-b012-lane-b-readiness",
    ),
    SnippetCheck(
        "M246-E012-DOC-PKT-14",
        "npm run --if-present check:objc3c:m246-c020-lane-c-readiness",
    ),
    SnippetCheck(
        "M246-E012-DOC-PKT-15",
        "python scripts/run_m246_d008_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M246-E012-DOC-PKT-16",
        "python scripts/check_m246_e012_optimization_gate_and_perf_evidence_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M246-E012-DOC-PKT-17",
    ...
    SnippetCheck(
        "M246-E012-DOC-PKT-18",
        "tmp/reports/m246/M246-E012/optimization_gate_perf_evidence_cross_lane_integration_sync_summary.json",
    ),
    SnippetCheck("M246-E012-DOC-PKT-19", "Predecessor: `M246-E011`"),
    SnippetCheck(
        "M246-E012-DOC-PKT-20",
...
READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-E012-RUN-06", "check:objc3c:m246-b012-lane-b-readiness"),
    SnippetCheck("M246-E012-RUN-07", "check:objc3c:m246-c020-lane-c-readiness"),
    SnippetCheck("M246-E012-RUN-08", "scripts/run_m246_d008_lane_d_readiness.py"),
    SnippetCheck(
        "M246-E012-RUN-09",
        "scripts/check_m246_e012_optimization_gate_and_perf_evidence_cross_lane_integration_sync_contract.py",
    ),
...
E011_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-E012-E011-PKT-01", "Packet: `M246-E011`"),
    SnippetCheck("M246-E012-E011-PKT-02", "Issue: `#6702`"),
    SnippetCheck(
        "M246-E012-E011-PKT-03",
...
A008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-E012-A008-PKT-01", "Packet: `M246-A008`"),
    SnippetCheck("M246-E012-A008-PKT-02", "Issue: `#5055`"),
    SnippetCheck("M246-E012-A008-PKT-03", "Dependencies: `M246-A007`"),
)

D008_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-E012-D008-DOC-01",
        "# M246 Toolchain Integration and Optimization Controls Recovery and Determinism Hardening Expectations (D008)",
    ),
    SnippetCheck(
        "M246-E012-D008-DOC-02",
...
D008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-E012-D008-PKT-01", "Packet: `M246-D008`"),
    SnippetCheck("M246-E012-D008-PKT-02", "Issue: `#6687`"),
    SnippetCheck("M246-E012-D008-PKT-03", "Dependencies: `M246-D007`"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--e011-readiness-script", type=Path, default=DEFAULT_E011_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-E012-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-E012-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.readiness_script, "M246-E012-RUN-EXISTS", READINESS_SNIPPETS),
        (args.e011_expectations_doc, "M246-E012-E011-DOC-EXISTS", E011_EXPECTATIONS_SNIPPETS),
        (args.e011_packet_doc, "M246-E012-E011-PKT-EXISTS", E011_PACKET_SNIPPETS),
        (args.a008_expectations_doc, "M246-E012-A008-DOC-EXISTS", A008_EXPECTATIONS_SNIPPETS),
        (args.a008_packet_doc, "M246-E012-A008-PKT-EXISTS", A008_PACKET_SNIPPETS),
        (args.d008_expectations_doc, "M246-E012-D008-DOC-EXISTS", D008_EXPECTATIONS_SNIPPETS),
        (args.d008_packet_doc, "M246-E012-D008-PKT-EXISTS", D008_PACKET_SNIPPETS),
        (args.architecture_doc, "M246-E012-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M246-E012-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M246-E012-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M246-E012-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.e011_checker, "M246-E012-DEP-E011-ARG-01"),
        (args.e011_test, "M246-E012-DEP-E011-ARG-02"),
        (args.e011_readiness_script, "M246-E012-DEP-E011-ARG-03"),
        (args.a008_checker, "M246-E012-DEP-A008-ARG-01"),
        (args.a008_test, "M246-E012-DEP-A008-ARG-02"),
        (args.a008_readiness_script, "M246-E012-DEP-A008-ARG-03"),
        (args.d008_checker, "M246-E012-DEP-D008-ARG-01"),
        (args.d008_test, "M246-E012-DEP-D008-ARG-02"),
        (args.d008_readiness_script, "M246-E012-DEP-D008-ARG-03"),
    ):
