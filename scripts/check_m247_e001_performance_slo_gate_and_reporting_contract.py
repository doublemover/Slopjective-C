#!/usr/bin/env python3
"""Fail-closed contract checker for the M247-E001 performance SLO gate/reporting freeze."""
...
MODE = "m247-e001-performance-slo-gate-reporting-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m247_lane_e_performance_slo_gate_and_reporting_e001_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m247"
    / "m247_e001_performance_slo_gate_and_reporting_contract_freeze_packet.md"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-E001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M247-E001-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-E001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-E001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M247-E001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M247-E001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M247-E001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M247-E001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
