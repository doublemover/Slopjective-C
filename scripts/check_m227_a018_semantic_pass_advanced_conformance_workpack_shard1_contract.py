#!/usr/bin/env python3
"""Fail-closed validator for M227-A018 semantic pass advanced conformance shard1 contract."""
...
MODE = "m227-semantic-pass-advanced-conformance-workpack-shard1-contract-a018-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m227"
    / "m227_a018_semantic_pass_advanced_conformance_workpack_shard1_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        ...
        ("M227-A018-DOC-02", "Dependencies: `M227-A017`"),
        ("M227-A018-DOC-03", "toolchain_runtime_ga_operations_advanced_conformance_consistent"),
        ("M227-A018-DOC-04", "toolchain_runtime_ga_operations_advanced_conformance_ready"),
        ("M227-A018-DOC-05", "toolchain_runtime_ga_operations_advanced_conformance_key"),
        (
            "M227-A018-DOC-06",
        ...
        ("M227-A018-DOC-08", "npm run check:objc3c:m227-a018-lane-a-readiness"),
    ),
    "packet_doc": (
        ("M227-A018-PKT-01", "Packet: `M227-A018`"),
        ("M227-A018-PKT-02", "Dependencies: `M227-A017`"),
        ("M227-A018-PKT-03", "objc3_parse_lowering_readiness_surface.h"),
        (
            "M227-A018-PKT-04",
            "scripts/check_m227_a018_semantic_pass_advanced_conformance_workpack_shard1_contract.py",
        ),
    ...
    "parse_surface": (
        ("M227-A018-SUR-01", "IsObjc3ToolchainRuntimeGaOperationsAdvancedConformanceConsistent("),
        ("M227-A018-SUR-02", "IsObjc3ToolchainRuntimeGaOperationsAdvancedConformanceReady("),
        ("M227-A018-SUR-03", "BuildObjc3ToolchainRuntimeGaOperationsAdvancedConformanceKey("),
        (
            "M227-A018-SUR-04",
    ...
    "runbook": (
        ...
        ("M227-A018-RBK-04", "npm run check:objc3c:m227-a018-lane-a-readiness"),
    ),
    "package_json": (
        (
            "M227-A018-CFG-01",
            '"check:objc3c:m227-a018-semantic-pass-advanced-conformance-workpack-shard1-contract"',
        ),
        (
            "M227-A018-CFG-02",
            '"test:tooling:m227-a018-semantic-pass-advanced-conformance-workpack-shard1-contract"',
        ),
        ("M227-A018-CFG-03", '"check:objc3c:m227-a018-lane-a-readiness"'),
        ("M227-A018-CFG-04", "check:objc3c:m227-a017-lane-a-readiness"),
    ),
    "architecture_doc": (
        (
            "M227-A018-ARC-01",
