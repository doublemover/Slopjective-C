#!/usr/bin/env python3
"""Fail-closed contract checker for M241-D013 interop behavior for qualified generic APIs."""
...
MODE = "m241-d013-build-system-and-artifact-orchestration-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m241_build_system_and_artifact_orchestration_docs_and_operator_runbook_synchronization_d013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m241"
    / "m241_d013_build_system_and_artifact_orchestration_docs_and_operator_runbook_synchronization_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M241-D013-DOC-PKT-01",
        "# M241-D013 Interop Behavior for Qualified Generic APIs Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M241-D013-DOC-PKT-02", "Packet: `M241-D013`"),
    SnippetCheck("M241-D013-DOC-PKT-03", "Issue: `#5831`"),
    SnippetCheck("M241-D013-DOC-PKT-04", "Dependencies: `M241-C001`"),
    SnippetCheck(
        "M241-D013-DOC-PKT-05",
        "scripts/check_m241_d013_build_system_and_artifact_orchestration_contract.py",
    ),
    SnippetCheck(
        "M241-D013-DOC-PKT-06",
        "scripts/check_m241_c001_incremental_lowering_and_artifact_reuse_contract.py",
    ),
    SnippetCheck("M241-D013-DOC-PKT-07", "`compile:objc3c`"),
    SnippetCheck("M241-D013-DOC-PKT-08", "`check:objc3c:m241-c001-lane-c-readiness`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M241-D013-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M241-D013-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M241-D013-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M241-D013-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M241-D013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M241-D013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M241-D013-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M241-D013-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M241-D013-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M241-D013-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
