#!/usr/bin/env python3
"""Fail-closed checker for M235-B008 qualifier/generic semantic inference recovery and determinism hardening."""
...
MODE = "m235-b008-qualifier-and-generic-semantic-inference-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_B007_CHECKER = (
    ROOT / "scripts" / "check_m235_b007_qualifier_and_generic_semantic_inference_diagnostics_hardening_contract.py"
)
DEFAULT_B007_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_b007_qualifier_and_generic_semantic_inference_diagnostics_hardening_contract.py"
)
...
B007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B008-B007-PKT-01", "Packet: `M235-B007`"),
    SnippetCheck("M235-B008-B007-PKT-02", "Dependencies: `M235-B006`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B008-META-02",
        "explicit `M235-B007` dependency continuity so recovery and determinism hardening drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B008-PKG-03",
        '"check:objc3c:m235-b008-lane-b-readiness": '
        '"npm run check:objc3c:m235-b007-lane-b-readiness '
        '&& npm run check:objc3c:m235-b008-qualifier-and-generic-semantic-inference-recovery-and-determinism-hardening-contract '
        '&& npm run test:tooling:m235-b008-qualifier-and-generic-semantic-inference-recovery-and-determinism-hardening-contract"',
    ),
    SnippetCheck("M235-B008-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B008-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b007_expectations_doc, "M235-B008-B007-DOC-EXISTS", B007_EXPECTATIONS_SNIPPETS),
        (args.b007_packet_doc, "M235-B008-B007-PKT-EXISTS", B007_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B008-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B008-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B008-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b007_checker, "M235-B008-DEP-B007-ARG-01"),
        (args.b007_test, "M235-B008-DEP-B007-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
