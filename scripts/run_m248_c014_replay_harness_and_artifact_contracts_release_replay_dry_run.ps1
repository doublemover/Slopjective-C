param(
  ...
  [string]$ReportRoot = "tmp/reports/m248/M248-C014"
)
...
$summary = [ordered]@{
  contract_id = "objc3c-replay-harness-and-artifact-contracts-release-candidate-and-replay-dry-run/m248-c014-v1"
