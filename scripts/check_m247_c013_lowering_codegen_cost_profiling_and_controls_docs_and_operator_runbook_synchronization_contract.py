#!/usr/bin/env python3
"""Fail-closed checker for M247-C013 lowering/codegen docs/runbook synchronization."""
...
MODE = "m247-c013-lowering-codegen-cost-profiling-controls-docs-operator-runbook-synchronization-contract-v1"
...
DEFAULT_C012_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c012_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c013_lane_c_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-C013-DOC-EXP-03",
        "Issue `#6754` defines canonical lane-C docs and operator runbook synchronization scope.",
    ),
    SnippetCheck("M247-C013-DOC-EXP-04", "Dependencies: `M247-C012`"),
    SnippetCheck(
        "M247-C013-DOC-EXP-05",
    ...
    SnippetCheck(
        "M247-C013-DOC-EXP-09",
        "tests/tooling/test_check_m247_c013_lowering_codegen_cost_profiling_and_controls_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M247-C013-DOC-EXP-10",
    ...
    SnippetCheck(
        "M247-C013-DOC-EXP-11",
        "Code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C013-DOC-EXP-12",
        "tmp/reports/m247/M247-C013/lowering_codegen_cost_profiling_and_controls_docs_and_operator_runbook_synchronization_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C013-DOC-PKT-01",
        "# M247-C013 Lowering/Codegen Cost Profiling and Controls Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M247-C013-DOC-PKT-02", "Packet: `M247-C013`"),
    SnippetCheck("M247-C013-DOC-PKT-03", "Issue: `#6754`"),
    SnippetCheck("M247-C013-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M247-C013-DOC-PKT-05", "Dependencies: `M247-C012`"),
    SnippetCheck(
        "M247-C013-DOC-PKT-06",
        "Predecessor anchors inherited via `M247-C012`: `M247-C001`, `M247-C002`, `M247-C003`, `M247-C004`, `M247-C005`, `M247-C006`, `M247-C007`, `M247-C008`, `M247-C009`, `M247-C010`, `M247-C011`.",
    ),
    SnippetCheck(
        "M247-C013-DOC-PKT-07",
        "scripts/check_m247_c013_lowering_codegen_cost_profiling_and_controls_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M247-C013-DOC-PKT-08",
        "tests/tooling/test_check_m247_c013_lowering_codegen_cost_profiling_and_controls_docs_and_operator_runbook_synchronization_contract.py",
    ),
    SnippetCheck(
        "M247-C013-DOC-PKT-09",
        "scripts/run_m247_c013_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M247-C013-DOC-PKT-10",
        "scripts/run_m247_c012_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M247-C013-DOC-PKT-11",
        "treated as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C013-DOC-PKT-12",
        "tmp/reports/m247/M247-C013/lowering_codegen_cost_profiling_and_controls_docs_and_operator_runbook_synchronization_summary.json",
    ),
)
...
C012_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C013-C012-PKT-01", "Packet: `M247-C012`"),
    SnippetCheck("M247-C013-C012-PKT-02", "Issue: `#6753`"),
    SnippetCheck("M247-C013-C012-PKT-03", "Dependencies: `M247-C011`"),
    SnippetCheck("M247-C013-C012-PKT-04", "scripts/run_m247_c012_lane_c_readiness.py"),
    SnippetCheck("M247-C013-C012-PKT-05", "scripts/run_m247_c011_lane_c_readiness.py"),
)

C012_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C013-C012-RUN-01",
        "scripts/run_m247_c011_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M247-C013-C012-RUN-02",
        "scripts/check_m247_c012_lowering_codegen_cost_profiling_and_controls_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M247-C013-C012-RUN-03",
        "tests/tooling/test_check_m247_c012_lowering_codegen_cost_profiling_and_controls_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M247-C013-C012-RUN-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-C013-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M247-C013-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M247-C013-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M247-C013-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-C013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-C013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c012_expectations_doc, "M247-C013-C012-EXP-EXISTS", C012_EXPECTATIONS_SNIPPETS),
        (args.c012_packet_doc, "M247-C013-C012-PKT-EXISTS", C012_PACKET_SNIPPETS),
        (args.c012_readiness_script, "M247-C013-C012-RUN-EXISTS", C012_READINESS_SNIPPETS),
        (args.readiness_script, "M247-C013-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M247-C013-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
