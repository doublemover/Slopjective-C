#!/usr/bin/env python3
"""Fail-closed checker for M248-C004 replay harness/artifact core-feature expansion contract."""
...
MODE = "m248-c004-replay-harness-and-artifact-contracts-core-feature-expansion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m248"
    / "m248_c004_replay_harness_and_artifact_contracts_core_feature_expansion_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-C004/"
    "replay_harness_and_artifact_contracts_core_feature_expansion_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-C004-DOC-EXP-01",
        "Contract ID: `objc3c-replay-harness-artifact-contracts-core-feature-expansion/m248-c004-v1`",
    ),
    SnippetCheck("M248-C004-DOC-EXP-02", "Dependencies: `M248-C003`"),
    SnippetCheck("M248-C004-DOC-EXP-03", "Issue `#6820` defines canonical lane-C core-feature expansion scope."),
    SnippetCheck("M248-C004-DOC-EXP-04", "`check:objc3c:m248-c004-lane-c-readiness`"),
    SnippetCheck("M248-C004-DOC-EXP-05", "`check:objc3c:m248-c003-lane-c-readiness`"),
    SnippetCheck(
        "M248-C004-DOC-EXP-06",
        "`tmp/reports/m248/M248-C004/replay_harness_and_artifact_contracts_core_feature_expansion_contract_summary.json`",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C004-DOC-PKT-01", "Packet: `M248-C004`"),
    SnippetCheck("M248-C004-DOC-PKT-02", "Issue: `#6820`"),
    SnippetCheck("M248-C004-DOC-PKT-03", "Dependencies: `M248-C003`"),
    SnippetCheck(
        "M248-C004-DOC-PKT-04",
        "`scripts/check_m248_c004_replay_harness_and_artifact_contracts_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M248-C004-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-C004-CFG-03", "check:objc3c:m248-c004-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C004-CFG-04", "check:objc3c:m248-c003-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C004-CFG-05", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M248-C004-CFG-06", "test:objc3c:execution-replay-proof"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-c003-lane-c-readiness && npm run check:objc3c:m248-c004-replay-harness-artifact-contracts-core-feature-expansion-contract && npm run test:tooling:m248-c004-replay-harness-artifact-contracts-core-feature-expansion-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M248-C004-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M248-C004-DOC-PKT-00",
        snippets=PACKET_SNIPPETS,
    )
    checks_total += packet_checks
    findings.extend(packet_findings)

    c003_checks, c003_findings = check_doc_contract(
        artifact_name="c003_expectations_doc",
        path=args.c003_expectations_doc,
        exists_check_id="M248-C004-C003-DOC-00",
        snippets=C003_EXPECTATIONS_SNIPPETS,
    )
    checks_total += c003_checks
    findings.extend(c003_findings)
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M248-C004-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M248-C004-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M248-C004-META-00",
