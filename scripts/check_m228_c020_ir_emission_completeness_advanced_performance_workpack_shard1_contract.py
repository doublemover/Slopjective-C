#!/usr/bin/env python3
"""Fail-closed validator for M228-C020 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c019_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c019_ir_emission_completeness_advanced_integration_workpack_shard1_contract.py",
    "c019_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c019_ir_emission_completeness_advanced_integration_workpack_shard1_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C020-RUN-04", "npm run check:objc3c:m228-c020-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C020-ARC-01",
    ...
    "package_json": (
        ("M228-C020-PKG-01", '"check:objc3c:m228-c019-lane-c-readiness"'),
        (
            "M228-C020-PKG-02",
            '"check:objc3c:m228-c020-ir-emission-completeness-advanced-performance-workpack-shard1-contract"',
        ),
        (
            "M228-C020-PKG-03",
            '"test:tooling:m228-c020-ir-emission-completeness-advanced-performance-workpack-shard1-contract"',
        ),
        ("M228-C020-PKG-04", '"check:objc3c:m228-c020-lane-c-readiness"'),
        (
            "M228-C020-PKG-05",
            '"check:objc3c:m228-c020-lane-c-readiness": "npm run check:objc3c:m228-c019-lane-c-readiness &&',
        ),
    ),
    "c019_contract_doc": (
        (
    ...
    "c019_checker": (
        (
            "M228-C020-DEP-02",
            'MODE = "m228-c019-ir-emission-completeness-advanced-integration-workpack-shard1-contract-v1"',
        ),
    ),
    "c019_tooling_test": (
        ("M228-C020-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c019_packet_doc": (
        ("M228-C020-DEP-04", "Packet: `M228-C019`"),
        ("M228-C020-DEP-05", "Issue: `#5245`"),
    ),
    "contract_doc": (
        (
            "M228-C020-DOC-01",
        ...
        ("M228-C020-DOC-02", "Execute issue `#5246`"),
        ("M228-C020-DOC-03", "Dependencies: `M228-C019`"),
        (
            "M228-C020-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C020-PKT-02", "Packet: `M228-C020`"),
        ("M228-C020-PKT-03", "Issue: `#5246`"),
        ("M228-C020-PKT-04", "Dependencies: `M228-C019`"),
        (
            "M228-C020-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C020-FORB-01",
            '"check:objc3c:m228-c020-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C020/"
            "ir_emission_completeness_advanced_performance_workpack_shard1_contract_summary.json"
        ),
    )
