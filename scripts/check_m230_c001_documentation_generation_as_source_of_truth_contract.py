...
MODE = "m230-c001-documentation-generation-as-source-of-truth-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_c001_documentation_generation_as_source_of_truth_contract_and_architecture_freeze_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-C001-DOC-EXP-06",
        "`check:objc3c:m230-c001-lane-c-readiness`",
    ),
    SnippetCheck(
        "M230-C001-DOC-EXP-07",
        "`tmp/reports/m230/M230-C001/documentation_generation_as_source_of_truth_contract_summary.json`",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-C001-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-C001-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-C001-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-C001-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-C001-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-C001-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
