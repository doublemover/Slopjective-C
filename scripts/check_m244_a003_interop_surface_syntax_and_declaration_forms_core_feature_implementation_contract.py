#!/usr/bin/env python3
"""Fail-closed checker for M244-A003 interop surface core-feature implementation contract."""
...
MODE = "m244-a003-interop-surface-syntax-and-declaration-forms-core-feature-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m244"
    / "m244_a003_interop_surface_syntax_and_declaration_forms_core_feature_implementation_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-A003/"
    "interop_surface_syntax_and_declaration_forms_core_feature_implementation_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M244-A003-A002-03",
        "M244-A002",
        Path("scripts/check_m244_a002_interop_surface_syntax_and_declaration_forms_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M244-A003-A002-04",
        "M244-A002",
        Path("tests/tooling/test_check_m244_a002_interop_surface_syntax_and_declaration_forms_modular_split_scaffolding_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-A003-DOC-EXP-01",
        "Contract ID: `objc3c-interop-surface-syntax-and-declaration-forms-core-feature-implementation/m244-a003-v1`",
    ),
    SnippetCheck("M244-A003-DOC-EXP-02", "Dependencies: `M244-A002`"),
    SnippetCheck("M244-A003-DOC-EXP-03", "Issue `#6520` defines canonical lane-A core-feature implementation scope."),
    SnippetCheck("M244-A003-DOC-EXP-04", "`check:objc3c:m244-a003-lane-a-readiness`"),
    SnippetCheck("M244-A003-DOC-EXP-05", "`check:objc3c:m244-a002-lane-a-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-A003-DOC-PKT-01", "Packet: `M244-A003`"),
    SnippetCheck("M244-A003-DOC-PKT-02", "Issue: `#6520`"),
    SnippetCheck("M244-A003-DOC-PKT-03", "Dependencies: `M244-A002`"),
    SnippetCheck(
        "M244-A003-DOC-PKT-04",
        "`scripts/check_m244_a003_interop_surface_syntax_and_declaration_forms_core_feature_implementation_contract.py`",
    ),
    SnippetCheck(
        "M244-A003-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-A003-CFG-03", "check:objc3c:m244-a003-lane-a-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-a002-lane-a-readiness && npm run check:objc3c:m244-a003-interop-surface-syntax-declaration-forms-core-feature-implementation-contract && npm run test:tooling:m244-a003-interop-surface-syntax-declaration-forms-core-feature-implementation-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A003-ARCH-02", "`M244-A002` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A003-SPC-02", "lane-A dependency anchor (`M244-A002`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-A003-META-02",
        "explicit `M244-A002` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-A003-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-A003-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-A003-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-A003-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-A003-META-00",
