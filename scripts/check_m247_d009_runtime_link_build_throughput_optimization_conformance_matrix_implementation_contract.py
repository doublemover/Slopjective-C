#!/usr/bin/env python3
"""Fail-closed checker for M247-D009 runtime/link/build throughput optimization conformance matrix implementation."""
...
MODE = "m247-d009-runtime-link-build-throughput-optimization-conformance-matrix-implementation-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_d009_lane_d_readiness.py"
...
DEFAULT_D008_READINESS = ROOT / "scripts" / "run_m247_d008_lane_d_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M247-D009-D008-01",
        "M247-D008",
        Path("docs/contracts/m247_runtime_link_build_throughput_optimization_recovery_and_determinism_hardening_d008_expectations.md"),
    ),
    AssetCheck(
        "M247-D009-D008-02",
        "M247-D008",
        Path("spec/planning/compiler/m247/m247_d008_runtime_link_build_throughput_optimization_recovery_and_determinism_hardening_packet.md"),
    ),
    AssetCheck(
        "M247-D009-D008-03",
        "M247-D008",
        Path("scripts/check_m247_d008_runtime_link_build_throughput_optimization_recovery_and_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M247-D009-D008-04",
        "M247-D008",
        Path("tests/tooling/test_check_m247_d008_runtime_link_build_throughput_optimization_recovery_and_determinism_hardening_contract.py"),
    ),
    AssetCheck(
        "M247-D009-D008-05",
        "M247-D008",
        Path("scripts/run_m247_d008_lane_d_readiness.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D009-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-build-throughput-optimization-conformance-matrix-implementation/m247-d009-v1`",
    ),
    SnippetCheck("M247-D009-DOC-EXP-02", "Dependencies: `M247-D008`"),
    SnippetCheck(
        "M247-D009-DOC-EXP-03",
        "Issue `#6767` defines canonical lane-D conformance matrix implementation scope.",
    ),
    SnippetCheck(
        "M247-D009-DOC-EXP-04",
        "scripts/check_m247_d008_runtime_link_build_throughput_optimization_recovery_and_determinism_hardening_contract.py",
    ),
    SnippetCheck(
        "M247-D009-DOC-EXP-05",
        "scripts/run_m247_d009_lane_d_readiness.py",
    ),
    SnippetCheck("M247-D009-DOC-EXP-06", "`check:objc3c:m247-d009-lane-d-readiness`"),
    SnippetCheck("M247-D009-DOC-EXP-07", "`check:objc3c:m247-d008-lane-d-readiness`"),
    SnippetCheck("M247-D009-DOC-EXP-08", "`D008 readiness -> D009 checker -> D009 pytest`."),
    SnippetCheck(
        "M247-D009-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-D009-DOC-EXP-10",
        "tmp/reports/m247/M247-D009/runtime_link_build_throughput_optimization_conformance_matrix_implementation_contract_summary.json",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D009-DOC-PKT-01", "Packet: `M247-D009`"),
    SnippetCheck("M247-D009-DOC-PKT-02", "Issue: `#6767`"),
    SnippetCheck("M247-D009-DOC-PKT-03", "Dependencies: `M247-D008`"),
    SnippetCheck("M247-D009-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-D009-DOC-PKT-05",
        "`scripts/check_m247_d009_runtime_link_build_throughput_optimization_conformance_matrix_implementation_contract.py`",
    ),
    SnippetCheck(
        "M247-D009-DOC-PKT-06",
    ...
    SnippetCheck(
        "M247-D009-DOC-PKT-07",
        "`scripts/run_m247_d009_lane_d_readiness.py`",
    ),
    SnippetCheck(
        "M247-D009-DOC-PKT-08",
        "`check:objc3c:m247-d009-lane-d-readiness`",
    ),
    SnippetCheck(
        "M247-D009-DOC-PKT-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-D009-DOC-PKT-10",
...
D008_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D009-D008-DOC-01",
        "Contract ID: `objc3c-runtime-link-build-throughput-optimization-recovery-and-determinism-hardening/m247-d008-v1`",
    ),
    SnippetCheck(
        "M247-D009-D008-DOC-02",
        "Dependencies: `M247-D007`",
    ),
    SnippetCheck(
        "M247-D009-D008-DOC-03",
        "Issue `#6766` defines canonical lane-D recovery and determinism hardening scope.",
    ),
)

D008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D009-D008-PKT-01", "Packet: `M247-D008`"),
    SnippetCheck("M247-D009-D008-PKT-02", "Issue: `#6766`"),
    SnippetCheck("M247-D009-D008-PKT-03", "Dependencies: `M247-D007`"),
    SnippetCheck("M247-D009-D008-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D009-RUN-01", 'DEPENDENCY_TOKEN = "M247-D008"'),
    SnippetCheck("M247-D009-RUN-02", "check:objc3c:m247-d008-lane-d-readiness"),
    SnippetCheck(
        "M247-D009-RUN-03",
        "scripts/check_m247_d009_runtime_link_build_throughput_optimization_conformance_matrix_implementation_contract.py",
    ),
    ...
    SnippetCheck("M247-D009-RUN-05", "[ok] M247-D009 lane-D readiness chain completed"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-D009-SPC-02",
        "lane-D dependency anchor (`M247-D008`)",
    ),
    SnippetCheck(
        "M247-D009-SPC-03",
        "throughput conformance-matrix evidence",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-D009-META-02",
        "explicit `M247-D008` dependency continuity and fail-closed conformance matrix evidence continuity",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M247-D009-CFG-03", "check:objc3c:m247-d009-lane-d-readiness"),
    PackageScriptKeyCheck("M247-D009-CFG-04", "check:objc3c:m247-d008-lane-d-readiness"),
    PackageScriptKeyCheck("M247-D009-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M247-D009-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M247-D009-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-D009-CFG-11", "test:objc3c:perf-budget"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--d008-readiness-script", type=Path, default=DEFAULT_D008_READINESS)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-D009-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-D009-DOC-PKT-00", PACKET_SNIPPETS),
        ("d008_expectations_doc", args.d008_expectations_doc, "M247-D009-D008-DOC-00", D008_EXPECTATIONS_SNIPPETS),
        ("d008_packet_doc", args.d008_packet_doc, "M247-D009-D008-PKT-00", D008_PACKET_SNIPPETS),
        ("readiness_script", args.readiness_script, "M247-D009-RUN-00", READINESS_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M247-D009-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M247-D009-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M247-D009-META-00", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d008_checker, "M247-D009-DEP-01"),
        (args.d008_test, "M247-D009-DEP-02"),
        (args.d008_readiness_script, "M247-D009-DEP-03"),
    ):
