#!/usr/bin/env python3
"""Fail-closed checker for M244-C006 interop lowering edge-case expansion and robustness contract."""
...
MODE = "m244-c006-interop-lowering-and-abi-conformance-edge-case-expansion-and-robustness-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_edge_case_expansion_and_robustness_c006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c006_interop_lowering_and_abi_conformance_edge_case_expansion_and_robustness_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C006/"
    "interop_lowering_and_abi_conformance_edge_case_expansion_and_robustness_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-C006-C005-01",
        "M244-C005",
        Path("docs/contracts/m244_interop_lowering_and_abi_conformance_edge_case_and_compatibility_completion_c005_expectations.md"),
    ),
    AssetCheck(
        "M244-C006-C005-02",
        "M244-C005",
        Path("spec/planning/compiler/m244/m244_c005_interop_lowering_and_abi_conformance_edge_case_and_compatibility_completion_packet.md"),
    ),
    AssetCheck(
        "M244-C006-C005-03",
        "M244-C005",
        Path("scripts/check_m244_c005_interop_lowering_and_abi_conformance_edge_case_and_compatibility_completion_contract.py"),
    ),
    AssetCheck(
        "M244-C006-C005-04",
        "M244-C005",
        Path("tests/tooling/test_check_m244_c005_interop_lowering_and_abi_conformance_edge_case_and_compatibility_completion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C006-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-edge-case-expansion-and-robustness/m244-c006-v1`",
    ),
    SnippetCheck("M244-C006-DOC-EXP-02", "Dependencies: `M244-C005`"),
    SnippetCheck("M244-C006-DOC-EXP-03", "Issue `#6555` defines canonical lane-C edge-case expansion and robustness scope."),
    SnippetCheck("M244-C006-DOC-EXP-04", "`check:objc3c:m244-c006-lane-c-readiness`"),
    SnippetCheck("M244-C006-DOC-EXP-05", "`check:objc3c:m244-c005-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C006-DOC-PKT-01", "Packet: `M244-C006`"),
    SnippetCheck("M244-C006-DOC-PKT-02", "Issue: `#6555`"),
    SnippetCheck("M244-C006-DOC-PKT-03", "Dependencies: `M244-C005`"),
    SnippetCheck(
        "M244-C006-DOC-PKT-04",
        "`scripts/check_m244_c006_interop_lowering_and_abi_conformance_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M244-C006-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C006-CFG-03", "check:objc3c:m244-c006-lane-c-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c005-lane-c-readiness && npm run check:objc3c:m244-c006-interop-lowering-abi-conformance-edge-case-expansion-and-robustness-contract && npm run test:tooling:m244-c006-interop-lowering-abi-conformance-edge-case-expansion-and-robustness-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C006-ARCH-02",
        "`M244-C005` dependency continuity and edge-case expansion evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C006-SPC-02", "lane-C dependency anchor (`M244-C005`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C006-META-02",
        "explicit `M244-C005` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C006-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C006-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C006-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C006-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C006-META-00",
