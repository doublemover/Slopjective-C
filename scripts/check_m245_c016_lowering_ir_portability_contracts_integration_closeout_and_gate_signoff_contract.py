#!/usr/bin/env python3
"""Fail-closed contract checker for M245-C016 lowering/IR portability integration closeout and gate sign-off."""
...
MODE = "m245-c016-lowering-ir-portability-contracts-integration-closeout-and-gate-signoff-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_lowering_ir_portability_contracts_integration_closeout_and_gate_signoff_c016_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_c016_lowering_ir_portability_contracts_integration_closeout_and_gate_signoff_packet.md"
)
DEFAULT_C015_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_lowering_ir_portability_contracts_advanced_core_workpack_shard1_c015_expectations.md"
)
DEFAULT_C015_PACKET_DOC = (
    ...
    / "compiler"
    / "m245"
    / "m245_c015_lowering_ir_portability_contracts_advanced_core_workpack_shard1_packet.md"
)
DEFAULT_C015_CHECKER = (
    ROOT
    / "scripts"
    / "check_m245_c015_lowering_ir_portability_contracts_advanced_core_workpack_shard1_contract.py"
)
DEFAULT_C015_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_c015_lowering_ir_portability_contracts_advanced_core_workpack_shard1_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-C016-DOC-PKT-01",
        "# M245-C016 Lowering/IR Portability Contracts Integration Closeout and Gate Sign-Off Packet",
    ),
    SnippetCheck("M245-C016-DOC-PKT-02", "Packet: `M245-C016`"),
    SnippetCheck("M245-C016-DOC-PKT-03", "Issue: `#6651`"),
    SnippetCheck("M245-C016-DOC-PKT-04", "Dependencies: `M245-C015`"),
    SnippetCheck("M245-C016-DOC-PKT-05", "Theme: `integration closeout and gate sign-off`"),
    SnippetCheck("M245-C016-DOC-PKT-06", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-C016-DOC-PKT-07",
        "m245_c015_lowering_ir_portability_contracts_advanced_core_workpack_shard1_packet.md",
    ),
    SnippetCheck(
        "M245-C016-DOC-PKT-08",
        "python scripts/check_m245_c016_lowering_ir_portability_contracts_integration_closeout_and_gate_signoff_contract.py --emit-json",
    ),
    SnippetCheck("M245-C016-DOC-PKT-09", "integration closeout and gate sign-off"),
    SnippetCheck(
        "M245-C016-DOC-PKT-10",
        "tmp/reports/m245/M245-C016/lowering_ir_portability_contracts_integration_closeout_and_gate_signoff_contract_summary.json",
    ),
)
...
C015_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-C016-C015-DOC-01",
        "Contract ID: `objc3c-lowering-ir-portability-contracts-advanced-core-workpack-shard1/m245-c015-v1`",
    ),
    SnippetCheck("M245-C016-C015-DOC-02", "Dependencies: `M245-C014`"),
)

C015_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-C016-C015-PKT-01", "Packet: `M245-C015`"),
    SnippetCheck("M245-C016-C015-PKT-02", "Dependencies: `M245-C014`"),
)

C015_CHECKER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-C016-C015-CHK-01",
        'MODE = "m245-c015-lowering-ir-portability-contracts-advanced-core-workpack-shard1-contract-v1"',
    ),
    SnippetCheck("M245-C016-C015-CHK-02", "DEFAULT_SUMMARY_OUT = Path("),
)

C015_TEST_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-C016-C015-TST-01", "def test_contract_passes_on_repository_sources"),
    SnippetCheck(
        "M245-C016-C015-TST-02",
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M245-C016-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M245-C016-DOC-PKT-00", PACKET_SNIPPETS),
        (
            "c015_expectations_doc",
            args.c015_expectations_doc,
            "M245-C016-C015-DOC-00",
            C015_EXPECTATIONS_SNIPPETS,
        ),
        ("c015_packet_doc", args.c015_packet_doc, "M245-C016-C015-PKT-00", C015_PACKET_SNIPPETS),
        ("c015_checker", args.c015_checker, "M245-C016-C015-CHK-00", C015_CHECKER_SNIPPETS),
        ("c015_test", args.c015_test, "M245-C016-C015-TST-00", C015_TEST_SNIPPETS),
    ):
