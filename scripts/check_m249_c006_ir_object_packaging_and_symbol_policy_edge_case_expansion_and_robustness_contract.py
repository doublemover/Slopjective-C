#!/usr/bin/env python3
"""Fail-closed contract checker for M249-C006 IR/object packaging edge-case expansion robustness."""
...
MODE = "m249-c006-ir-object-packaging-symbol-policy-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m249/M249-C006/"
    "ir_object_packaging_and_symbol_policy_edge_case_expansion_and_robustness_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-C006-DOC-EXP-01",
        "# M249 IR/Object Packaging and Symbol Policy Edge-Case Expansion and Robustness Expectations (C006)",
    ),
    SnippetCheck(
        "M249-C006-DOC-EXP-02",
        "Contract ID: `objc3c-ir-object-packaging-symbol-policy-edge-case-expansion-and-robustness/m249-c006-v1`",
    ),
    SnippetCheck("M249-C006-DOC-EXP-03", "- Dependencies: `M249-C005`"),
    SnippetCheck("M249-C006-DOC-EXP-04", "optimization improvements as mandatory scope inputs."),
    SnippetCheck(
        "M249-C006-DOC-EXP-05",
        "`scripts/check_m249_c006_ir_object_packaging_and_symbol_policy_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck("M249-C006-DOC-EXP-06", "`check:objc3c:m249-c006-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-C006-DOC-PKT-01",
        "# M249-C006 IR/Object Packaging and Symbol Policy Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M249-C006-DOC-PKT-02", "Packet: `M249-C006`"),
    SnippetCheck("M249-C006-DOC-PKT-03", "Dependencies: `M249-C005`"),
    SnippetCheck(
        "M249-C006-DOC-PKT-04",
        "m249_c005_ir_object_packaging_and_symbol_policy_edge_case_and_compatibility_completion_packet.md",
    ),
    SnippetCheck("M249-C006-DOC-PKT-05", "`check:objc3c:m249-c006-lane-c-readiness`"),
    SnippetCheck("M249-C006-DOC-PKT-06", "`test:objc3c:execution-replay-proof`"),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-C006-C001-02", "- Dependencies: none"),
)
...
C005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-C006-C005-02", "- Dependencies: `M249-C004`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m249-c006-ir-object-packaging-symbol-policy-edge-case-expansion-and-robustness-contract '
        '&& npm run test:tooling:m249-c006-ir-object-packaging-symbol-policy-edge-case-expansion-and-robustness-contract"',
    ),
    SnippetCheck("M249-C006-PKG-04", '"test:objc3c:lowering-replay-proof": '),
    SnippetCheck("M249-C006-PKG-05", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-C006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-C006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M249-C006-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c005_expectations_doc, "M249-C006-C005-EXISTS", C005_EXPECTATIONS_SNIPPETS),
        (args.architecture_doc, "M249-C006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-C006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-C006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-C006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
