#!/usr/bin/env python3
"""Fail-closed checker for M235-E006 qualifier/generic conformance gate edge-case expansion and robustness."""
...
MODE = "m235-e006-qualifier-generic-conformance-gate-edge-case-expansion-and-robustness-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_generic_conformance_gate_edge_case_expansion_and_robustness_e006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_e006_qualifier_generic_conformance_gate_edge_case_expansion_and_robustness_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m235/M235-E006/local_check_summary.json")
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-E006-DOC-PKT-01",
        "# M235-E006 Qualifier Generic Conformance Gate Edge-case Expansion and Robustness Packet",
    ),
    SnippetCheck("M235-E006-DOC-PKT-02", "Packet: `M235-E006`"),
    SnippetCheck("M235-E006-DOC-PKT-03", "Issue: `#5845`"),
    SnippetCheck(
        "M235-E006-DOC-PKT-04",
        "Dependencies: `M235-E005`, `M235-A003`, `M235-B006`, `M235-C004`, `M235-D002`",
    ),
    SnippetCheck(
        "M235-E006-DOC-PKT-05",
        "Dependency continuity from E002 remains fail-closed through these anchors:",
    ),
    SnippetCheck(
        "M235-E006-DOC-PKT-06",
        "docs/contracts/m235_qualifier_generic_conformance_gate_edge_case_expansion_and_robustness_e006_expectations.md",
    ),
    SnippetCheck(
        "M235-E006-DOC-PKT-07",
        "scripts/check_m235_e006_qualifier_generic_conformance_gate_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M235-E006-DOC-PKT-08",
        "tests/tooling/test_check_m235_e006_qualifier_generic_conformance_gate_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M235-E006-DOC-PKT-09",
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-E006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-E006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
