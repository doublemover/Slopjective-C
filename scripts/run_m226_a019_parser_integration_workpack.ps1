param(
  [string]$ReportRoot = "tmp/reports/m226/M226-A019"
)
...
$upstream = @(
  @{ packet = "A015"; path = "tmp/reports/m226/M226-A015/parser_advanced_core_workpack_summary.json" },
  @{ packet = "A016"; path = "tmp/reports/m226/M226-A016/parser_advanced_edge_compat_workpack_summary.json" },
  @{ packet = "A017"; path = "tmp/reports/m226/M226-A017/parser_advanced_diagnostics_workpack_summary.json" },
  @{ packet = "A018"; path = "tmp/reports/m226/M226-A018/parser_conformance_summary.json" }
)
...
$summary = [ordered]@{
  contract_id = "objc3c-parser-advanced-integration-workpack-contract/m226-a019-v1"
