#!/usr/bin/env python3
"""Fail-closed checker for M233-B005 conformance checking and diagnostics contract freeze."""
...
MODE = "m233-b005-conformance-checking-and-diagnostics-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_b005_conformance_checking_and_diagnostics_edge_case_and_compatibility_completion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-B005-DOC-PKT-01",
        "# M233-B005 Conformance checking and diagnostics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M233-B005-DOC-PKT-02", "Packet: `M233-B005`"),
    SnippetCheck("M233-B005-DOC-PKT-03", "Issue: `#4913`"),
    SnippetCheck("M233-B005-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M233-B005-DOC-PKT-05",
        "check:objc3c:m233-b005-conformance-checking-and-diagnostics-contract",
    ),
    SnippetCheck(
        "M233-B005-DOC-PKT-06",
        "tmp/reports/m233/M233-B005/conformance_checking_and_diagnostics_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-B005-PKG-03",
        '"check:objc3c:m233-b005-lane-b-readiness": '
        '"npm run check:objc3c:m233-b005-conformance-checking-and-diagnostics-contract '
        '&& npm run test:tooling:m233-b005-conformance-checking-and-diagnostics-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M233-B005-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M233-B005-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M233-B005-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M233-B005-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M233-B005-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M233-B005-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
