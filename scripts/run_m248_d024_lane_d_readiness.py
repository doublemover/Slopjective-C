#!/usr/bin/env python3
"""Run M248-D024 lane-D readiness checks without deep npm nesting."""
...
COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    (
        sys.executable,
        "scripts/run_m248_d023_lane_d_readiness.py",
    ),
    (
        sys.executable,
...
def run_chain() -> int:
    ...
    print("[ok] M248-D024 lane-D readiness chain completed")
    return 0
