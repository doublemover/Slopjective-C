#!/usr/bin/env python3
"""Fail-closed checker for M233-C009 lowering of protocol/category artifacts contract freeze."""
...
MODE = "m233-c009-lowering-of-protocol-category-artifacts-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_c009_lowering_of_protocol_category_artifacts_conformance_matrix_implementation_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-C009-DOC-PKT-01",
        "# M233-C009 Lowering of protocol/category artifacts Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M233-C009-DOC-PKT-02", "Packet: `M233-C009`"),
    SnippetCheck("M233-C009-DOC-PKT-03", "Issue: `#4934`"),
    SnippetCheck("M233-C009-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M233-C009-DOC-PKT-05",
        "check:objc3c:m233-c009-lowering-of-protocol-category-artifacts-contract",
    ),
    SnippetCheck(
        "M233-C009-DOC-PKT-06",
        "tmp/reports/m233/M233-C009/lowering_of_protocol_category_artifacts_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-C009-PKG-03",
        '"check:objc3c:m233-c009-lane-c-readiness": '
        '"npm run check:objc3c:m233-c009-lowering-of-protocol-category-artifacts-contract '
        '&& npm run test:tooling:m233-c009-lowering-of-protocol-category-artifacts-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M233-C009-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M233-C009-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M233-C009-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M233-C009-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M233-C009-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M233-C009-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
