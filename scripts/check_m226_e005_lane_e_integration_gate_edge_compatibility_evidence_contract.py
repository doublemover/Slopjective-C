#!/usr/bin/env python3
"""Fail-closed validator for M226-E005 lane-E edge compatibility evidence."""
...
MODE = "m226-e005-lane-e-integration-gate-edge-compatibility-evidence-contract-v1"

DEFAULT_CONTRACT_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m226_lane_e_integration_gate_e005_edge_compatibility_evidence_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m226"
    / "m226_e005_lane_e_integration_gate_edge_compatibility_evidence_packet.md"
)
DEFAULT_EVIDENCE_DOC = (
    ...
    / "compiler"
    / "m226"
    / "m226_e005_lane_e_integration_gate_edge_compatibility_evidence_scaffold.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M226-E005-ASSET-04",
        Path("docs/contracts/m226_parser_release_candidate_replay_dry_run_expectations.md"),
    ),
    AssetCheck(
        "M226-E005-ASSET-05",
        Path("docs/contracts/m226_parser_sema_edge_compat_handoff_b005_expectations.md"),
    ),
    AssetCheck(
        "M226-E005-ASSET-06",
        Path("docs/contracts/m226_parse_lowering_edge_compatibility_completion_c005_expectations.md"),
    ),
    AssetCheck(
        "M226-E005-ASSET-07",
        Path("docs/contracts/m226_frontend_build_invocation_edge_case_compatibility_d005_expectations.md"),
    ),
    AssetCheck(
        "M226-E005-ASSET-08",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E005-DOC-PKT-02",
        "# M226 Lane E Integration Gate Edge Compatibility Evidence Packet (E005)",
    ),
    SnippetCheck("M226-E005-DOC-PKT-03", "Packet: `M226-E005`"),
    SnippetCheck(
        "M226-E005-DOC-PKT-04",
        "Upstream packet dependencies: `M226-E004`, `M226-A014`, `M226-B005`, `M226-C005`, `M226-D005`",
    ),
    SnippetCheck(
        "M226-E005-DOC-PKT-05",
        "`scripts/check_m226_e005_lane_e_integration_gate_edge_compatibility_evidence_contract.py`",
    ),
)

EVIDENCE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E005-DOC-EVI-02",
        "# M226 Lane E Integration Gate Edge Compatibility Evidence Scaffold (E005)",
    ),
    SnippetCheck(
        "M226-E005-DOC-EVI-03",
        "Path: `tmp/reports/m226/m226_e005_lane_e_integration_gate_edge_compatibility_evidence_contract_summary.json`",
    ),
    SnippetCheck(
        "M226-E005-DOC-EVI-04",
        "Path: `tmp/reports/m226/e005/evidence_index.json`",
    ),
    SnippetCheck(
        "M226-E005-DOC-EVI-05",
        "Required top-level keys: `packet`, `generated_at_utc`, `upstream_packets`, `artifacts`, `milestone_gate`, `feature_matrix`, `edge_compatibility`.",
    ),
    SnippetCheck(
        "M226-E005-DOC-EVI-06",
        "- `edge_compatibility` required keys: `parser_sema`, `parse_lowering`, `build_invocation`, `replay_dry_run`.",
    ),
    SnippetCheck(
        "M226-E005-DOC-EVI-07",
...
FREEZE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M226-E005-DOC-FRZ-02", "# M226 Lane E Contract Freeze (2026-03-02)"),
    SnippetCheck(
        "M226-E005-DOC-FRZ-03",
        "| `M226-E005` | `objc3c-lane-e-integration-gate-edge-compat-evidence-contract/m226-e005-v1` |",
    ),
    SnippetCheck("M226-E005-DOC-FRZ-04", "## Packet: `M226-E005`"),
    SnippetCheck(
        "M226-E005-DOC-FRZ-05",
        "`docs/contracts/m226_lane_e_integration_gate_e005_edge_compatibility_evidence_expectations.md`",
    ),
    SnippetCheck(
        "M226-E005-DOC-FRZ-06",
        "`scripts/check_m226_e005_lane_e_integration_gate_edge_compatibility_evidence_contract.py`",
    ),
    SnippetCheck(
        "M226-E005-DOC-FRZ-07",
        "`tests/tooling/test_check_m226_e005_lane_e_integration_gate_edge_compatibility_evidence_contract.py`",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    contract_checks, contract_findings = check_doc_contract(
        ...
        exists_check_id="M226-E005-DOC-CON-01",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M226-E005-DOC-PKT-01",
    ...
    evidence_checks, evidence_findings = check_doc_contract(
        ...
        exists_check_id="M226-E005-DOC-EVI-01",
    ...
    freeze_checks, freeze_findings = check_doc_contract(
        ...
        exists_check_id="M226-E005-DOC-FRZ-01",
    ...
    try:
        ...
        print(
            "m226-e005-lane-e-integration-gate-edge-compatibility-evidence-contract: "
    ...
    if not findings:
        print("m226-e005-lane-e-integration-gate-edge-compatibility-evidence-contract: OK")
        return 0

    print(
        "m226-e005-lane-e-integration-gate-edge-compatibility-evidence-contract: contract drift detected "
