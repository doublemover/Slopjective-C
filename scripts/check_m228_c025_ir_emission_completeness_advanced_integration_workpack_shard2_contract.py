#!/usr/bin/env python3
"""Fail-closed validator for M228-C025 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c024_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_conformance_workpack_shard2_c024_expectations.md",
    "c024_checker": ROOT
    / "scripts"
    / "check_m228_c024_ir_emission_completeness_advanced_conformance_workpack_shard2_contract.py",
    "c024_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c024_ir_emission_completeness_advanced_conformance_workpack_shard2_contract.py",
    "c024_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C025-RUN-04", "npm run check:objc3c:m228-c025-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C025-ARC-01",
    ...
    "package_json": (
        ("M228-C025-PKG-01", '"check:objc3c:m228-c024-lane-c-readiness"'),
        (
            "M228-C025-PKG-02",
            '"check:objc3c:m228-c025-ir-emission-completeness-advanced-integration-workpack-shard2-contract"',
        ),
        (
            "M228-C025-PKG-03",
            '"test:tooling:m228-c025-ir-emission-completeness-advanced-integration-workpack-shard2-contract"',
        ),
        ("M228-C025-PKG-04", '"check:objc3c:m228-c025-lane-c-readiness"'),
        (
            "M228-C025-PKG-05",
            '"check:objc3c:m228-c025-lane-c-readiness": "npm run check:objc3c:m228-c024-lane-c-readiness &&',
        ),
    ),
    "c024_contract_doc": (
        (
    ...
    "c024_tooling_test": (
        ("M228-C025-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c024_packet_doc": (
        ("M228-C025-DEP-04", "Packet: `M228-C024`"),
        ("M228-C025-DEP-05", "Issue: `#5250`"),
    ),
    "contract_doc": (
        (
            "M228-C025-DOC-01",
        ...
        ("M228-C025-DOC-02", "Execute issue `#5251`"),
        ("M228-C025-DOC-03", "Dependencies: `M228-C024`"),
        (
            "M228-C025-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C025-PKT-02", "Packet: `M228-C025`"),
        ("M228-C025-PKT-03", "Issue: `#5251`"),
        ("M228-C025-PKT-04", "Dependencies: `M228-C024`"),
        (
            "M228-C025-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C025-FORB-01",
            '"check:objc3c:m228-c025-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C025/"
            "ir_emission_completeness_advanced_integration_workpack_shard2_contract_summary.json"
        ),
    )
