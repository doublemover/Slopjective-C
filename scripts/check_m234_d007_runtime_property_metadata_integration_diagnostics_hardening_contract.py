#!/usr/bin/env python3
"""Fail-closed checker for M234-D007 runtime property metadata integration diagnostics hardening."""
...
MODE = "m234-d007-runtime-property-metadata-integration-diagnostics-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_runtime_property_metadata_integration_diagnostics_hardening_d007_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_d007_runtime_property_metadata_integration_diagnostics_hardening_packet.md"
)
...
DEFAULT_D006_CHECKER = (
    ROOT
    / "scripts"
    / "check_m234_d006_runtime_property_metadata_integration_edge_case_expansion_and_robustness_contract.py"
)
DEFAULT_D006_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_d006_runtime_property_metadata_integration_edge_case_expansion_and_robustness_contract.py"
)
DEFAULT_D006_READINESS_RUNNER = ROOT / "scripts" / "run_m234_d006_lane_d_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m234_d007_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-D007-DOC-PKT-01",
        "# M234-D007 Runtime Property Metadata Integration Diagnostics Hardening Packet",
    ),
    SnippetCheck("M234-D007-DOC-PKT-02", "Packet: `M234-D007`"),
    SnippetCheck("M234-D007-DOC-PKT-03", "Dependencies: `M234-D006`"),
    SnippetCheck(
        "M234-D007-DOC-PKT-04",
        "scripts/check_m234_d007_runtime_property_metadata_integration_diagnostics_hardening_contract.py",
    ),
    SnippetCheck(
        "M234-D007-DOC-PKT-05",
        "scripts/run_m234_d007_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M234-D007-DOC-PKT-06",
        "python scripts/run_m234_d006_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M234-D007-DOC-PKT-07",
        "python scripts/run_m234_d007_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M234-D007-DOC-PKT-08",
        "code/spec anchors and milestone",
    ),
    SnippetCheck(
        "M234-D007-DOC-PKT-09",
...
D006_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-D007-D006-DOC-01",
        "Contract ID: `objc3c-runtime-property-metadata-integration-edge-case-expansion-and-robustness/m234-d006-v1`",
    ),
    SnippetCheck(
        "M234-D007-D006-DOC-02",
        "Dependencies: `M234-D005`",
    ),
)

D006_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-D007-D006-PKT-01", "Packet: `M234-D006`"),
    SnippetCheck("M234-D007-D006-PKT-02", "Dependencies: `M234-D005`"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-D007-RUN-01", '"""Run M234-D007 lane-D readiness checks without deep npm nesting."""'),
    SnippetCheck("M234-D007-RUN-02", "scripts/run_m234_d006_lane_d_readiness.py"),
    SnippetCheck(
        "M234-D007-RUN-03",
        "scripts/check_m234_d007_runtime_property_metadata_integration_diagnostics_hardening_contract.py",
    ),
    ...
    SnippetCheck("M234-D007-RUN-05", "[ok] M234-D007 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-D007-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M234-D007-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M234-D007-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-D007-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-D007-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-D007-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d006_expectations_doc, "M234-D007-D006-DOC-EXISTS", D006_EXPECTATIONS_SNIPPETS),
        (args.d006_packet_doc, "M234-D007-D006-PKT-EXISTS", D006_PACKET_SNIPPETS),
        (args.readiness_runner, "M234-D007-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M234-D007-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-D007-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-D007-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-D007-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d006_checker, "M234-D007-DEP-D006-ARG-01"),
        (args.d006_test, "M234-D007-DEP-D006-ARG-02"),
        (args.d006_readiness_runner, "M234-D007-DEP-D006-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
