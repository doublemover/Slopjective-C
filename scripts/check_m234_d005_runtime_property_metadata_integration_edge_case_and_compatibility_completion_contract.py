#!/usr/bin/env python3
"""Fail-closed checker for M234-D005 runtime property metadata integration edge-case compatibility completion."""
...
MODE = "m234-d005-runtime-property-metadata-integration-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_D004_CHECKER = (
    ROOT
    / "scripts"
    / "check_m234_d004_runtime_property_metadata_integration_core_feature_expansion_contract.py"
)
DEFAULT_D004_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_d004_runtime_property_metadata_integration_core_feature_expansion_contract.py"
)
DEFAULT_D004_READINESS_RUNNER = ROOT / "scripts" / "run_m234_d004_lane_d_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m234_d005_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-D005-DOC-PKT-01",
        "# M234-D005 Runtime Property Metadata Integration Edge-Case and Compatibility Completion Packet",
    ),
    SnippetCheck("M234-D005-DOC-PKT-02", "Packet: `M234-D005`"),
    SnippetCheck("M234-D005-DOC-PKT-03", "Dependencies: `M234-D004`"),
    SnippetCheck(
        "M234-D005-DOC-PKT-04",
        "scripts/check_m234_d005_runtime_property_metadata_integration_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M234-D005-DOC-PKT-05",
        "scripts/run_m234_d005_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M234-D005-DOC-PKT-06",
        "check:objc3c:m234-d004-lane-d-readiness",
    ),
    SnippetCheck(
        "M234-D005-DOC-PKT-07",
        "python scripts/run_m234_d005_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M234-D005-DOC-PKT-08",
        "code/spec anchors and milestone",
    ),
    SnippetCheck(
        "M234-D005-DOC-PKT-09",
...
D004_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M234-D005-D004-DOC-01",
        "Contract ID: `objc3c-runtime-property-metadata-integration-core-feature-expansion/m234-d004-v1`",
    ),
    SnippetCheck(
        "M234-D005-D004-DOC-02",
        "Dependencies: `M234-D003`",
    ),
)

D004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-D005-D004-PKT-01", "Packet: `M234-D004`"),
    SnippetCheck("M234-D005-D004-PKT-02", "Dependencies: `M234-D003`"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-D005-RUN-01", '"""Run M234-D005 lane-D readiness checks without deep npm nesting."""'),
    SnippetCheck("M234-D005-RUN-02", 'NPM_EXECUTABLE = "npm.cmd" if sys.platform == "win32" else "npm"'),
    SnippetCheck("M234-D005-RUN-03", "check:objc3c:m234-d004-lane-d-readiness"),
    SnippetCheck(
        "M234-D005-RUN-04",
        "scripts/check_m234_d005_runtime_property_metadata_integration_edge_case_and_compatibility_completion_contract.py",
    ),
    ...
    SnippetCheck("M234-D005-RUN-06", "[ok] M234-D005 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-D005-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M234-D005-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M234-D005-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-D005-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-D005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-D005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d004_expectations_doc, "M234-D005-D004-DOC-EXISTS", D004_EXPECTATIONS_SNIPPETS),
        (args.d004_packet_doc, "M234-D005-D004-PKT-EXISTS", D004_PACKET_SNIPPETS),
        (args.readiness_runner, "M234-D005-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M234-D005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-D005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-D005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-D005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d004_checker, "M234-D005-DEP-D004-ARG-01"),
        (args.d004_test, "M234-D005-DEP-D004-ARG-02"),
        (args.d004_readiness_runner, "M234-D005-DEP-D004-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
