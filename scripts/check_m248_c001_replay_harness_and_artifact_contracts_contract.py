#!/usr/bin/env python3
"""Fail-closed contract checker for the M248-C001 replay harness/artifact freeze."""
...
MODE = "m248-c001-replay-harness-artifact-contracts-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-C001-DOC-PKT-01",
        "# M248-C001 Replay Harness and Artifact Contracts Contract Freeze Packet",
    ),
    SnippetCheck("M248-C001-DOC-PKT-02", "Packet: `M248-C001`"),
    SnippetCheck("M248-C001-DOC-PKT-03", "Dependencies: none"),
    SnippetCheck(
        "M248-C001-DOC-PKT-04",
        "`check:objc3c:m248-c001-replay-harness-artifact-contracts-contract`",
    ),
    SnippetCheck(
        "M248-C001-DOC-PKT-05",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-C001-PKG-03",
        '"check:objc3c:m248-c001-lane-c-readiness": '
        '"npm run check:objc3c:m248-c001-replay-harness-artifact-contracts-contract '
        '&& npm run test:tooling:m248-c001-replay-harness-artifact-contracts-contract"',
    ),
    SnippetCheck("M248-C001-PKG-04", '"test:objc3c:lowering-replay-proof": '),
    SnippetCheck("M248-C001-PKG-05", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-C001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-C001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M248-C001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-C001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-C001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-C001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
