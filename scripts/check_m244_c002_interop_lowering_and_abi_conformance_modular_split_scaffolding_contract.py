#!/usr/bin/env python3
"""Fail-closed checker for M244-C002 interop lowering/ABI modular split/scaffolding contract."""
...
MODE = "m244-c002-interop-lowering-and-abi-conformance-modular-split-scaffolding-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m244"
    / "m244_c002_interop_lowering_and_abi_conformance_modular_split_scaffolding_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C002/"
    "interop_lowering_and_abi_conformance_modular_split_scaffolding_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M244-C002-C001-03",
        "M244-C001",
        Path("scripts/check_m244_c001_interop_lowering_and_abi_conformance_contract.py"),
    ),
    AssetCheck(
        "M244-C002-C001-04",
        "M244-C001",
        Path("tests/tooling/test_check_m244_c001_interop_lowering_and_abi_conformance_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C002-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-modular-split-scaffolding/m244-c002-v1`",
    ),
    SnippetCheck("M244-C002-DOC-EXP-02", "Dependencies: `M244-C001`"),
    SnippetCheck(
        "M244-C002-DOC-EXP-03", "Issue `#6551` defines canonical lane-C modular split/scaffolding scope."
    ),
    SnippetCheck("M244-C002-DOC-EXP-04", "`check:objc3c:m244-c002-lane-c-readiness`"),
    SnippetCheck("M244-C002-DOC-EXP-05", "`check:objc3c:m244-c001-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C002-DOC-PKT-01", "Packet: `M244-C002`"),
    SnippetCheck("M244-C002-DOC-PKT-02", "Issue: `#6551`"),
    SnippetCheck("M244-C002-DOC-PKT-03", "Dependencies: `M244-C001`"),
    SnippetCheck(
        "M244-C002-DOC-PKT-04",
        "`scripts/check_m244_c002_interop_lowering_and_abi_conformance_modular_split_scaffolding_contract.py`",
    ),
    SnippetCheck(
        "M244-C002-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C002-CFG-03", "check:objc3c:m244-c002-lane-c-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c001-lane-c-readiness && npm run check:objc3c:m244-c002-interop-lowering-abi-conformance-modular-split-scaffolding-contract && npm run test:tooling:m244-c002-interop-lowering-abi-conformance-modular-split-scaffolding-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C002-ARCH-02",
        "`M244-C001` dependency continuity and modular split evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C002-SPC-02", "lane-C dependency anchor (`M244-C001`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C002-META-02",
        "explicit `M244-C001` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C002-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C002-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C002-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C002-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C002-META-00",
