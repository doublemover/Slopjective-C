#!/usr/bin/env python3
"""Fail-closed checker for M229-A005 class/protocol/category metadata edge-case and compatibility completion."""
...
MODE = "m229-a005-class-protocol-category-metadata-generation-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_a005_class_protocol_category_metadata_generation_edge_case_and_compatibility_completion_packet.md"
)
DEFAULT_A004_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m229_class_protocol_category_metadata_generation_core_feature_expansion_a004_expectations.md"
)
DEFAULT_A004_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_a004_class_protocol_category_metadata_generation_core_feature_expansion_packet.md"
)
DEFAULT_A004_CHECKER = (
    ROOT / "scripts" / "check_m229_a004_class_protocol_category_metadata_generation_core_feature_expansion_contract.py"
)
DEFAULT_A004_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m229_a004_class_protocol_category_metadata_generation_core_feature_expansion_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[tuple[str, Path], ...] = (
    (
        "M229-A005-DEP-A004-01",
        Path("docs/contracts/m229_class_protocol_category_metadata_generation_core_feature_expansion_a004_expectations.md"),
    ),
    (
        "M229-A005-DEP-A004-02",
        Path("spec/planning/compiler/m229/m229_a004_class_protocol_category_metadata_generation_core_feature_expansion_packet.md"),
    ),
    (
        "M229-A005-DEP-A004-03",
        Path("scripts/check_m229_a004_class_protocol_category_metadata_generation_core_feature_expansion_contract.py"),
    ),
    (
        "M229-A005-DEP-A004-04",
        Path("tests/tooling/test_check_m229_a004_class_protocol_category_metadata_generation_core_feature_expansion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A005-DOC-EXP-01",
        "# M229 Class/Protocol/Category Metadata Generation Edge-case and Compatibility Completion Expectations (A005)",
    ),
    SnippetCheck(
        "M229-A005-DOC-EXP-02",
        "Contract ID: `objc3c-class-protocol-category-metadata-generation-edge-case-and-compatibility-completion/m229-a005-v1`",
    ),
    SnippetCheck("M229-A005-DOC-EXP-03", "Dependencies: `M229-A004`"),
    SnippetCheck(
        "M229-A005-DOC-EXP-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A005-DOC-EXP-05",
        "check:objc3c:m229-a005-class-protocol-category-metadata-generation-edge-case-and-compatibility-completion-contract",
    ),
    SnippetCheck(
        "M229-A005-DOC-EXP-06",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A005-DOC-PKT-01",
        "# M229-A005 Class/Protocol/Category Metadata Generation Edge-case and Compatibility Completion Packet",
    ),
    SnippetCheck("M229-A005-DOC-PKT-02", "Packet: `M229-A005`"),
    SnippetCheck("M229-A005-DOC-PKT-03", "Dependencies: `M229-A004`"),
    SnippetCheck(
        "M229-A005-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A005-DOC-PKT-05",
...
A004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M229-A005-A004-PKT-01", "Packet: `M229-A004`"),
    SnippetCheck("M229-A005-A004-PKT-02", "Dependencies: `M229-A003`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m229-a005-class-protocol-category-metadata-generation-edge-case-and-compatibility-completion-contract '
        '&& npm run test:tooling:m229-a005-class-protocol-category-metadata-generation-edge-case-and-compatibility-completion-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M229-A005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M229-A005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a004_expectations_doc, "M229-A005-A004-EXP-EXISTS", A004_EXPECTATIONS_SNIPPETS),
        (args.a004_packet_doc, "M229-A005-A004-PKT-EXISTS", A004_PACKET_SNIPPETS),
        (args.architecture_doc, "M229-A005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M229-A005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M229-A005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M229-A005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
