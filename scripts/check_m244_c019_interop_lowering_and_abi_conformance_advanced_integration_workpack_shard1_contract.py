#!/usr/bin/env python3
"""Fail-closed checker for m244-c019 interop lowering release-candidate/replay dry-run contract."""
...
MODE = "m244-c019-interop-lowering-and-abi-conformance-advanced-integration-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_advanced_integration_workpack_shard1_c019_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c019_interop_lowering_and_abi_conformance_advanced_integration_workpack_shard1_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/m244-c019/"
    "interop_lowering_and_abi_conformance_advanced_integration_workpack_shard1_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "m244-c019-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-advanced-integration-workpack-shard1/m244-c019-v1`",
    ),
    SnippetCheck("m244-c019-DOC-EXP-02", "Dependencies: `m244-c018`"),
    SnippetCheck(
        "m244-c019-DOC-EXP-03",
        "Issue `#6568` defines canonical lane-C advanced integration workpack (shard 1) scope.",
    ),
    SnippetCheck(
        "m244-c019-DOC-EXP-04",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck("m244-c019-DOC-EXP-05", "`check:objc3c:m244-c019-lane-c-readiness`"),
    SnippetCheck("m244-c019-DOC-EXP-06", "`compile:objc3c`"),
    SnippetCheck("m244-c019-DOC-EXP-07", "`proof:objc3c`"),
    SnippetCheck("m244-c019-DOC-EXP-08", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("m244-c019-DOC-EXP-09", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("m244-c019-DOC-PKT-01", "Packet: `m244-c019`"),
    SnippetCheck("m244-c019-DOC-PKT-02", "Issue: `#6568`"),
    SnippetCheck("m244-c019-DOC-PKT-03", "Dependencies: `m244-c018`"),
    SnippetCheck(
        "m244-c019-DOC-PKT-04",
        "`scripts/check_m244_c019_interop_lowering_and_abi_conformance_advanced_integration_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "m244-c019-DOC-PKT-05",
        "`tests/tooling/test_check_m244_c019_interop_lowering_and_abi_conformance_advanced_integration_workpack_shard1_contract.py`",
    ),
    SnippetCheck("m244-c019-DOC-PKT-06", "`compile:objc3c`"),
    SnippetCheck("m244-c019-DOC-PKT-07", "`proof:objc3c`"),
    SnippetCheck("m244-c019-DOC-PKT-08", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("m244-c019-DOC-PKT-09", "`test:objc3c:perf-budget`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("m244-c019-CFG-03", "check:objc3c:m244-c019-lane-c-readiness"),
    PackageScriptKeyCheck("m244-c019-CFG-04", "compile:objc3c"),
    PackageScriptKeyCheck("m244-c019-CFG-05", "proof:objc3c"),
    PackageScriptKeyCheck("m244-c019-CFG-06", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("m244-c019-CFG-07", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c018-lane-c-readiness && npm run check:objc3c:m244-c019-interop-lowering-abi-conformance-advanced-integration-workpack-shard1-contract && npm run test:tooling:m244-c019-interop-lowering-abi-conformance-advanced-integration-workpack-shard1-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("m244-c019-SPC-02", "lane-C dependency anchor (`M244-C018`)"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="m244-c019-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="m244-c019-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="m244-c019-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="m244-c019-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="m244-c019-META-00",
