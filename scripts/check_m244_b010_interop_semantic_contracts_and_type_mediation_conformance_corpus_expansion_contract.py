#!/usr/bin/env python3
"""Fail-closed checker for M244-B010 interop semantic/type mediation conformance corpus expansion contract."""
...
MODE = "m244-b010-interop-semantic-contracts-and-type-mediation-conformance-corpus-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_semantic_contracts_and_type_mediation_conformance_corpus_expansion_b010_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_b010_interop_semantic_contracts_and_type_mediation_conformance_corpus_expansion_packet.md"
)
DEFAULT_PACKAGE_JSON = ROOT / "package.json"
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B010/"
    "interop_semantic_contracts_and_type_mediation_conformance_corpus_expansion_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B010-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-conformance-corpus-expansion/m244-b010-v1`",
    ),
    SnippetCheck("M244-B010-DOC-EXP-02", "Dependencies: `M244-B009`"),
    SnippetCheck("M244-B010-DOC-EXP-03", "Issue `#6540` defines canonical lane-B conformance corpus expansion scope."),
    SnippetCheck("M244-B010-DOC-EXP-04", "`check:objc3c:m244-b010-lane-b-readiness`"),
    SnippetCheck("M244-B010-DOC-EXP-05", "`check:objc3c:m244-b009-lane-b-readiness`"),
    SnippetCheck("M244-B010-DOC-EXP-06", "Milestone optimization improvements are mandatory scope inputs."),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B010-DOC-PKT-01", "Packet: `M244-B010`"),
    SnippetCheck("M244-B010-DOC-PKT-02", "Issue: `#6540`"),
    SnippetCheck("M244-B010-DOC-PKT-03", "Dependencies: `M244-B009`"),
    SnippetCheck(
        "M244-B010-DOC-PKT-04",
        "`scripts/check_m244_b010_interop_semantic_contracts_and_type_mediation_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M244-B010-DOC-PKT-05",
    ...
    SnippetCheck("M244-B010-DOC-PKT-06", "`test:objc3c:sema-pass-manager-diagnostics-bus`"),
    SnippetCheck("M244-B010-DOC-PKT-07", "`test:objc3c:lowering-regression`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B010-CFG-03", "check:objc3c:m244-b010-lane-b-readiness"),
    PackageScriptKeyCheck("M244-B010-CFG-04", "test:objc3c:sema-pass-manager-diagnostics-bus"),
    PackageScriptKeyCheck("M244-B010-CFG-05", "test:objc3c:lowering-regression"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b009-lane-b-readiness && npm run check:objc3c:m244-b010-interop-semantic-contracts-type-mediation-conformance-corpus-expansion-contract && npm run test:tooling:m244-b010-interop-semantic-contracts-type-mediation-conformance-corpus-expansion-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B010-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B010-DOC-PKT-00",
