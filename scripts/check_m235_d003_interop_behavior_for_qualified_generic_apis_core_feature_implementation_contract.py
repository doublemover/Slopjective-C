#!/usr/bin/env python3
"""Fail-closed checker for M235-D003 interop behavior core feature implementation."""
...
MODE = "m235-d003-interop-behavior-for-qualified-generic-apis-core-feature-implementation-contract-v1"
...
DEFAULT_D002_CHECKER = (
    ROOT / "scripts" / "check_m235_d002_interop_behavior_for_qualified_generic_apis_modular_split_scaffolding_contract.py"
)
DEFAULT_D002_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m235_d002_interop_behavior_for_qualified_generic_apis_modular_split_scaffolding_contract.py"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m235-d002-interop-behavior-for-qualified-generic-apis-modular-split-scaffolding-contract '
        '&& npm run test:tooling:m235-d002-interop-behavior-for-qualified-generic-apis-modular-split-scaffolding-contract"',
    ),
    SnippetCheck("M235-D003-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M235-D003-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M235-D003-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-D003-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-D003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-D003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d002_expectations_doc, "M235-D003-D002-DOC-EXISTS", D002_EXPECTATIONS_SNIPPETS),
        (args.d002_packet_doc, "M235-D003-D002-PKT-EXISTS", D002_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-D003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-D003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-D003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-D003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d002_checker, "M235-D003-DEP-D002-ARG-01"),
        (args.d002_test, "M235-D003-DEP-D002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
