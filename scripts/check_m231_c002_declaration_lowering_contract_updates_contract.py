#!/usr/bin/env python3
"""Fail-closed checker for M231-C002 Declaration lowering contract updates contract freeze."""
...
MODE = "m231-c002-declaration-lowering-contract-updates-modular-split-and-scaffolding-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_c002_declaration_lowering_contract_updates_modular_split_and_scaffolding_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M231-C002-DOC-PKT-01",
        "# M231-C002 Declaration Grammar Expansion and Normalization Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M231-C002-DOC-PKT-02", "Packet: `M231-C002`"),
    SnippetCheck("M231-C002-DOC-PKT-03", "Issue: `#5515`"),
    SnippetCheck("M231-C002-DOC-PKT-04", "Dependencies: `M231-C001`"),
    SnippetCheck(
        "M231-C002-DOC-PKT-05",
        "check:objc3c:m231-c002-declaration-lowering-contract-updates-modular-split-and-scaffolding-contract",
    ),
    SnippetCheck(
        "M231-C002-DOC-PKT-06",
        "tmp/reports/m231/M231-C002/declaration_lowering_contract_updates_modular_split_and_scaffolding_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M231-C002-PKG-03",
        '"check:objc3c:m231-c002-lane-c-readiness": '
        '"npm run check:objc3c:m231-c001-lane-c-readiness && npm run check:objc3c:m231-c002-declaration-lowering-contract-updates-modular-split-and-scaffolding-contract '
        '&& npm run test:tooling:m231-c002-declaration-lowering-contract-updates-modular-split-and-scaffolding-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-C002-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-C002-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-C002-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-C002-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-C002-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-C002-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
