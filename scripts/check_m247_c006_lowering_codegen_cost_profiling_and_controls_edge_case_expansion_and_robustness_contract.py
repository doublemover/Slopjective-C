#!/usr/bin/env python3
"""Fail-closed checker for M247-C006 lowering/codegen edge-case expansion and robustness."""
...
MODE = "m247-c006-lowering-codegen-cost-profiling-controls-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c006_lane_c_readiness.py"
...
DEFAULT_C005_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m247_c005_lowering_codegen_cost_profiling_and_controls_edge_case_and_compatibility_completion_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-C006-DOC-EXP-02", "Dependencies: `M247-C005`"),
    SnippetCheck(
        "M247-C006-DOC-EXP-03",
        "Issue `#6747` defines canonical lane-C edge-case expansion and robustness scope.",
    ),
    SnippetCheck(
        "M247-C006-DOC-EXP-04",
        "scripts/check_m247_c005_lowering_codegen_cost_profiling_and_controls_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M247-C006-DOC-EXP-05",
        "scripts/run_m247_c006_lane_c_readiness.py",
    ),
    SnippetCheck("M247-C006-DOC-EXP-06", "`check:objc3c:m247-c006-lane-c-readiness`"),
    SnippetCheck("M247-C006-DOC-EXP-07", "`check:objc3c:m247-c005-lane-c-readiness`"),
    SnippetCheck("M247-C006-DOC-EXP-08", "`C005 readiness -> C006 checker -> C006 pytest`."),
    SnippetCheck(
        "M247-C006-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C006-DOC-EXP-10",
        "tmp/reports/m247/M247-C006/lowering_codegen_cost_profiling_and_controls_edge_case_expansion_and_robustness_contract_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C006-DOC-PKT-01",
        "# M247-C006 Lowering/Codegen Cost Profiling and Controls Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M247-C006-DOC-PKT-02", "Packet: `M247-C006`"),
    SnippetCheck("M247-C006-DOC-PKT-03", "Issue: `#6747`"),
    SnippetCheck("M247-C006-DOC-PKT-04", "Dependencies: `M247-C005`"),
    SnippetCheck("M247-C006-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-C006-DOC-PKT-06",
        "`scripts/check_m247_c006_lowering_codegen_cost_profiling_and_controls_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M247-C006-DOC-PKT-07",
    ...
    SnippetCheck(
        "M247-C006-DOC-PKT-08",
        "`scripts/run_m247_c006_lane_c_readiness.py`",
    ),
    SnippetCheck(
        "M247-C006-DOC-PKT-09",
        "`check:objc3c:m247-c006-lane-c-readiness`",
    ),
    SnippetCheck(
        "M247-C006-DOC-PKT-10",
...
C005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M247-C006-C005-DOC-02", "Dependencies: `M247-C004`"),
    SnippetCheck(
        "M247-C006-C005-DOC-03",
        "Issue `#6746` defines canonical lane-C edge-case and compatibility completion scope.",
    ),
)

C005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C006-C005-PKT-01", "Packet: `M247-C005`"),
    SnippetCheck("M247-C006-C005-PKT-02", "Issue: `#6746`"),
    SnippetCheck("M247-C006-C005-PKT-03", "Dependencies: `M247-C004`"),
    SnippetCheck("M247-C006-C005-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C006-RUN-01", 'DEPENDENCY_TOKEN = "M247-C005"'),
    SnippetCheck("M247-C006-RUN-02", "check:objc3c:m247-c005-lane-c-readiness"),
    SnippetCheck(
        "M247-C006-RUN-03",
        "scripts/check_m247_c006_lowering_codegen_cost_profiling_and_controls_edge_case_expansion_and_robustness_contract.py",
    ),
    ...
    SnippetCheck("M247-C006-RUN-05", "[ok] M247-C006 lane-C readiness chain completed"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C006-SPC-01",
        "lowering/codegen edge-case expansion and robustness wiring shall preserve explicit lane-C dependency anchor (`M247-C005`)",
    ),
    SnippetCheck(
        "M247-C006-SPC-02",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-C006-META-02",
        "explicit `M247-C005` dependency continuity and fail-closed edge-case compatibility evidence continuity",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M247-C006-CFG-03", "check:objc3c:m247-c006-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C006-CFG-04", "check:objc3c:m247-c005-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C006-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M247-C006-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M247-C006-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-C006-CFG-11", "test:objc3c:perf-budget"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-C006-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-C006-DOC-PKT-00", PACKET_SNIPPETS),
        ("c005_expectations_doc", args.c005_expectations_doc, "M247-C006-C005-DOC-00", C005_EXPECTATIONS_SNIPPETS),
        ("c005_packet_doc", args.c005_packet_doc, "M247-C006-C005-PKT-00", C005_PACKET_SNIPPETS),
        ("readiness_script", args.readiness_script, "M247-C006-RUN-00", READINESS_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M247-C006-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M247-C006-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M247-C006-META-00", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c005_checker, "M247-C006-DEP-01"),
        (args.c005_test, "M247-C006-DEP-02"),
    ):
