...
def main() -> int:
    ...
    checks = {
        ...
        "runtime_implementation_surface_preserves_fail_closed_lookup_model": runtime_impl_surface.get("fail_closed_model") == "missing-realized-layout-or-accessor-records-produce-no-reflection-hit-and-no-storage-retired-route-synthesis",
