...
def main() -> int:
    ...
    checks = {
        ...
        "synthesized_surface_explicit_non_goals_preserve_no_storage_global_retired_route": "no-storage-global-retired-routes-or-sidecar-body-proof" in synthesized_surface.get("explicit_non_goals", []),
        ...
        "runtime_implementation_surface_preserves_runtime_owned_layout_model": runtime_impl_surface.get("implementation_model") == "runtime-registration-realizes-property-accessor-records-from-emitted-descriptors-and-ivar-layout-through-runtime-storage-owners",
        "runtime_implementation_surface_preserves_fail_closed_lookup_model": runtime_impl_surface.get("fail_closed_model") == "missing-realized-layout-or-accessor-records-produce-no-reflection-hit-and-no-synthetic-storage-path",
