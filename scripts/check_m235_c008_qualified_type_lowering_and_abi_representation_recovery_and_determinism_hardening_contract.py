#!/usr/bin/env python3
"""Fail-closed checker for M235-C008 qualified type recovery and determinism hardening."""
...
MODE = "m235-c008-qualified-type-lowering-and-abi-representation-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_C007_CHECKER = (
    ROOT / "scripts" / "check_m235_c007_qualified_type_lowering_and_abi_representation_diagnostics_hardening_contract.py"
)
DEFAULT_C007_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_c007_qualified_type_lowering_and_abi_representation_diagnostics_hardening_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M235-C008-DEP-C007-01",
        Path(
            "docs/contracts/m235_qualified_type_lowering_and_abi_representation_diagnostics_hardening_c007_expectations.md"
        ),
    ),
    AssetCheck(
        "M235-C008-DEP-C007-02",
        Path("spec/planning/compiler/m235/m235_c007_qualified_type_lowering_and_abi_representation_diagnostics_hardening_packet.md"),
    ),
    AssetCheck(
        "M235-C008-DEP-C007-03",
        Path("scripts/check_m235_c007_qualified_type_lowering_and_abi_representation_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M235-C008-DEP-C007-04",
        Path("tests/tooling/test_check_m235_c007_qualified_type_lowering_and_abi_representation_diagnostics_hardening_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C008-DOC-EXP-01",
        "# M235 Qualified Type Lowering and ABI Representation Recovery and Determinism Hardening Expectations (C008)",
    ),
    SnippetCheck(
        "M235-C008-DOC-EXP-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-recovery-and-determinism-hardening/m235-c008-v1`",
    ),
    SnippetCheck("M235-C008-DOC-EXP-03", "Dependencies: `M235-C007`"),
    SnippetCheck(
        "M235-C008-DOC-EXP-04",
        "Issue `#5818` defines canonical lane-C recovery and determinism hardening scope.",
    ),
    SnippetCheck(
        "M235-C008-DOC-EXP-05",
        "optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M235-C008-DOC-EXP-06",
        "docs/contracts/m235_qualified_type_lowering_and_abi_representation_diagnostics_hardening_c007_expectations.md",
    ),
    SnippetCheck(
        "M235-C008-DOC-EXP-07",
        "scripts/check_m235_c007_qualified_type_lowering_and_abi_representation_diagnostics_hardening_contract.py",
    ),
    SnippetCheck(
        "M235-C008-DOC-EXP-08",
        "tests/tooling/test_check_m235_c007_qualified_type_lowering_and_abi_representation_diagnostics_hardening_contract.py",
    ),
    SnippetCheck("M235-C008-DOC-EXP-09", "`C007 readiness -> C008 checker -> C008 pytest`."),
    SnippetCheck(
        "M235-C008-DOC-EXP-10",
        "`tmp/reports/m235/M235-C008/qualified_type_lowering_and_abi_representation_recovery_and_determinism_hardening_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-C008-DOC-PKT-08", "`npm run check:objc3c:m235-c007-lane-c-readiness`"),
    SnippetCheck(
        "M235-C008-DOC-PKT-09",
        "`C007 readiness -> C008 checker -> C008 pytest`",
    ),
    SnippetCheck(
        "M235-C008-DOC-PKT-10",
...
C007_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-C008-C007-DOC-01",
        "# M235 Qualified Type Lowering and ABI Representation Diagnostics Hardening Expectations (C007)",
    ),
    SnippetCheck(
        "M235-C008-C007-DOC-02",
        "Contract ID: `objc3c-qualified-type-lowering-and-abi-representation-diagnostics-hardening/m235-c007-v1`",
    ),
    SnippetCheck("M235-C008-C007-DOC-03", "Dependencies: `M235-C006`"),
    SnippetCheck(
        "M235-C008-C007-DOC-04",
        "Issue `#5817` defines canonical lane-C diagnostics hardening scope.",
    ),
)

C007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-C008-C007-PKT-01", "Packet: `M235-C007`"),
    SnippetCheck("M235-C008-C007-PKT-02", "Issue: `#5817`"),
    SnippetCheck("M235-C008-C007-PKT-03", "Dependencies: `M235-C006`"),
    SnippetCheck("M235-C008-C007-PKT-04", "Freeze date: `2026-03-05`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-C008-PKG-07", '"compile:objc3c": '),
    SnippetCheck("M235-C008-PKG-08", '"proof:objc3c": '),
    SnippetCheck("M235-C008-PKG-09", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-C008-PKG-10", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-C008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-C008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c007_expectations_doc, "M235-C008-C007-DOC-EXISTS", C007_EXPECTATIONS_SNIPPETS),
        (args.c007_packet_doc, "M235-C008-C007-PKT-EXISTS", C007_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-C008-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-C008-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-C008-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-C008-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c007_checker, "M235-C008-DEP-C007-ARG-01"),
        (args.c007_test, "M235-C008-DEP-C007-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
