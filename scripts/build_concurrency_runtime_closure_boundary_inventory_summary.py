...
CONTRACT_PATH = ROOT / "tests/tooling/fixtures/concurrency_runtime_closure/boundary_inventory.json"
OUT_DIR = ROOT / "tmp/reports/concurrency-runtime-closure/boundary-inventory"
JSON_OUT = OUT_DIR / "concurrency_runtime_closure_boundary_inventory_summary.json"
MD_OUT = OUT_DIR / "concurrency_runtime_closure_boundary_inventory_summary.md"
...
def main() -> int:
    ...
    checks = {
        "summary_script_link_matches": contract["summary_implementation_anchor"] == "scripts/build_concurrency_runtime_closure_boundary_inventory_summary.py",
        ...
        "runbook_mentions_private_runtime_helper_constraint": "concurrency behavior stays on the private runtime-owned helper and snapshot surfaces" in runbook_text,
    ...
    summary = {
        "issue": "concurrency-runtime-closure-boundary-inventory",
    ...
    MD_OUT.write_text(
        "# Concurrency Runtime Closure Boundary Inventory Summary\n\n"
