#!/usr/bin/env python3
"""Fail-closed validator for M228-C021 IR-emission advanced integration shard1 contract."""
...
MODE = "m228-c021-ir-emission-completeness-advanced-core-workpack-shard2-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c020_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_performance_workpack_shard1_c020_expectations.md",
    "c020_checker": ROOT
    / "scripts"
    / "check_m228_c020_ir_emission_completeness_advanced_performance_workpack_shard1_contract.py",
    "c020_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c020_ir_emission_completeness_advanced_performance_workpack_shard1_contract.py",
    "c020_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c020_ir_emission_completeness_advanced_performance_workpack_shard1_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
    ...
    / "compiler"
    / "m228"
    / "m228_c021_ir_emission_completeness_advanced_core_workpack_shard2_packet.md",
}
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C021-RUN-04", "npm run check:objc3c:m228-c021-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C021-ARC-01",
    ...
    "package_json": (
        ("M228-C021-PKG-01", '"check:objc3c:m228-c020-lane-c-readiness"'),
        (
            "M228-C021-PKG-02",
            '"check:objc3c:m228-c021-ir-emission-completeness-advanced-core-workpack-shard2-contract"',
        ),
        (
            "M228-C021-PKG-03",
            '"test:tooling:m228-c021-ir-emission-completeness-advanced-core-workpack-shard2-contract"',
        ),
        ("M228-C021-PKG-04", '"check:objc3c:m228-c021-lane-c-readiness"'),
        (
            "M228-C021-PKG-05",
    ...
    "c020_contract_doc": (
        (
            "M228-C021-DEP-01",
            "Contract ID: `objc3c-ir-emission-completeness-advanced-performance-workpack-shard1/m228-c020-v1`",
        ),
    ),
    "c020_checker": (
        (
            "M228-C021-DEP-02",
            'MODE = "m228-c020-ir-emission-completeness-advanced-performance-workpack-shard1-contract-v1"',
        ),
    ),
    "c020_tooling_test": (
        ("M228-C021-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c020_packet_doc": (
        ("M228-C021-DEP-04", "Packet: `M228-C020`"),
        ("M228-C021-DEP-05", "Issue: `#5246`"),
    ),
    "contract_doc": (
        (
            "M228-C021-DOC-01",
            "Contract ID: `objc3c-ir-emission-completeness-advanced-core-workpack-shard2/m228-c021-v1`",
        ),
        ("M228-C021-DOC-02", "Execute issue `#5247`"),
        ("M228-C021-DOC-03", "Dependencies: `M228-C020`"),
        (
            "M228-C021-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C021-PKT-02", "Packet: `M228-C021`"),
        ("M228-C021-PKT-03", "Issue: `#5247`"),
        ("M228-C021-PKT-04", "Dependencies: `M228-C020`"),
        (
            "M228-C021-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C021-FORB-01",
            '"check:objc3c:m228-c021-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C021/"
            "ir_emission_completeness_advanced_core_workpack_shard2_contract_summary.json"
        ),
    )
