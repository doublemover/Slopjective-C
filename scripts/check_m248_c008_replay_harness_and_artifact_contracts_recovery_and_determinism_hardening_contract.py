#!/usr/bin/env python3
"""Fail-closed checker for M248-C008 replay harness/artifact recovery and determinism hardening contract."""
...
MODE = "m248-c008-replay-harness-and-artifact-contracts-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m248"
    / "m248_c008_replay_harness_and_artifact_contracts_recovery_and_determinism_hardening_packet.md"
)
DEFAULT_C007_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_replay_harness_and_artifact_contracts_diagnostics_hardening_c007_expectations.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-C008/"
    "replay_harness_and_artifact_contracts_recovery_and_determinism_hardening_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M248-C008-C007-01",
        "M248-C007",
        Path("docs/contracts/m248_replay_harness_and_artifact_contracts_diagnostics_hardening_c007_expectations.md"),
    ),
    AssetCheck(
        "M248-C008-C007-02",
        "M248-C007",
        Path("scripts/check_m248_c007_replay_harness_and_artifact_contracts_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M248-C008-C007-03",
        "M248-C007",
        Path("tests/tooling/test_check_m248_c007_replay_harness_and_artifact_contracts_diagnostics_hardening_contract.py"),
    ),
    AssetCheck(
        "M248-C008-C007-04",
        "M248-C007",
        Path("spec/planning/compiler/m248/m248_c007_replay_harness_and_artifact_contracts_diagnostics_hardening_packet.md"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-C008-DOC-EXP-01",
        "Contract ID: `objc3c-replay-harness-artifact-contracts-recovery-and-determinism-hardening/m248-c008-v1`",
    ),
    SnippetCheck("M248-C008-DOC-EXP-02", "Dependencies: `M248-C007`"),
    SnippetCheck(
        "M248-C008-DOC-EXP-02A",
        "Scope: lane-C replay harness/artifact recovery and determinism hardening governance with fail-closed continuity from C007.",
    ),
    SnippetCheck(
        "M248-C008-DOC-EXP-03",
        "Issue `#6824` defines canonical lane-C recovery and determinism hardening scope.",
    ),
    SnippetCheck("M248-C008-DOC-EXP-04", "`check:objc3c:m248-c008-lane-c-readiness`"),
    SnippetCheck("M248-C008-DOC-EXP-05", "`check:objc3c:m248-c007-lane-c-readiness`"),
    SnippetCheck(
        "M248-C008-DOC-EXP-06",
        "`scripts/check_m248_c008_replay_harness_and_artifact_contracts_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-C008-DOC-EXP-07",
        "`tests/tooling/test_check_m248_c008_replay_harness_and_artifact_contracts_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-C008-DOC-EXP-08",
    ...
    SnippetCheck(
        "M248-C008-DOC-EXP-09",
        "`docs/contracts/m248_replay_harness_and_artifact_contracts_diagnostics_hardening_c007_expectations.md`",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C008-DOC-PKT-01", "Packet: `M248-C008`"),
    SnippetCheck("M248-C008-DOC-PKT-02", "Issue: `#6824`"),
    SnippetCheck("M248-C008-DOC-PKT-03", "Dependencies: `M248-C007`"),
    SnippetCheck("M248-C008-DOC-PKT-03A", "## Dependency Anchors (M248-C007)"),
    SnippetCheck(
        "M248-C008-DOC-PKT-04",
        "`scripts/check_m248_c008_replay_harness_and_artifact_contracts_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-C008-DOC-PKT-05",
        "`tests/tooling/test_check_m248_c008_replay_harness_and_artifact_contracts_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck("M248-C008-DOC-PKT-06", "`check:objc3c:m248-c008-lane-c-readiness`"),
    SnippetCheck(
        "M248-C008-DOC-PKT-07",
        "`tmp/reports/m248/M248-C008/replay_harness_and_artifact_contracts_recovery_and_determinism_hardening_contract_summary.json`",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-C008-CFG-03", "check:objc3c:m248-c008-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C008-CFG-04", "check:objc3c:m248-c007-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C008-CFG-05", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M248-C008-CFG-06", "test:objc3c:execution-replay-proof"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-c007-lane-c-readiness && npm run check:objc3c:m248-c008-replay-harness-artifact-contracts-recovery-and-determinism-hardening-contract && npm run test:tooling:m248-c008-replay-harness-artifact-contracts-recovery-and-determinism-hardening-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M248-C008-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M248-C008-DOC-PKT-00",
        snippets=PACKET_SNIPPETS,
    )
    checks_total += packet_checks
    findings.extend(packet_findings)

    c007_checks, c007_findings = check_doc_contract(
        artifact_name="c007_expectations_doc",
        path=args.c007_expectations_doc,
        exists_check_id="M248-C008-C007-DOC-00",
        snippets=C007_EXPECTATIONS_SNIPPETS,
    )
    checks_total += c007_checks
    findings.extend(c007_findings)
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M248-C008-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M248-C008-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M248-C008-META-00",
