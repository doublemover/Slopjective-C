#!/usr/bin/env python3
"""Fail-closed checker for M246-E003 optimization gate/perf core feature implementation."""
...
MODE = "m246-e003-optimization-gate-perf-evidence-core-feature-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m246"
    / "m246_e003_optimization_gate_and_perf_evidence_core_feature_implementation_packet.md"
)
DEFAULT_E002_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m246_optimization_gate_and_perf_evidence_modular_split_scaffolding_e002_expectations.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M246-E003-DEP-E002-01",
        Path("docs/contracts/m246_optimization_gate_and_perf_evidence_modular_split_scaffolding_e002_expectations.md"),
    ),
    AssetCheck(
        "M246-E003-DEP-E002-02",
        Path("spec/planning/compiler/m246/m246_e002_optimization_gate_and_perf_evidence_modular_split_scaffolding_packet.md"),
    ),
    AssetCheck(
        "M246-E003-DEP-E002-03",
        Path("scripts/check_m246_e002_optimization_gate_and_perf_evidence_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-E003-DEP-E002-04",
        Path("tests/tooling/test_check_m246_e002_optimization_gate_and_perf_evidence_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-E003-DEP-A002-01",
        Path("docs/contracts/m246_frontend_optimization_hint_capture_modular_split_scaffolding_a002_expectations.md"),
    ),
    AssetCheck(
        "M246-E003-DEP-A002-02",
        Path("spec/planning/compiler/m246/m246_a002_frontend_optimization_hint_capture_modular_split_scaffolding_packet.md"),
    ),
    AssetCheck(
        "M246-E003-DEP-A002-03",
        Path("scripts/check_m246_a002_frontend_optimization_hint_capture_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-E003-DEP-A002-04",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-E003-DOC-PKT-01",
        "# M246-E003 Optimization Gate and Perf Evidence Core Feature Implementation Packet",
    ),
    SnippetCheck("M246-E003-DOC-PKT-02", "Packet: `M246-E003`"),
    SnippetCheck("M246-E003-DOC-PKT-03", "Issue: `#6694`"),
    SnippetCheck(
        "M246-E003-DOC-PKT-04",
        "Dependencies: `M246-E002`, `M246-A002`, `M246-B003`, `M246-C005`, `M246-D002`",
    ),
    SnippetCheck("M246-E003-DOC-PKT-05", "Pending seeded dependency tokens:"),
)

E002_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-E003-E002-01",
...
A002_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-E003-A002-01",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-E003-ARCH-02",
        "`M246-E002`, `M246-A002`, `M246-B003`, `M246-C005`, and `M246-D002`",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-E003-SPC-02",
        "`M246-E002`, `M246-A002`, `M246-B003`,",
    ),
    SnippetCheck(
        "M246-E003-SPC-03",
        "`M246-C005`, and `M246-D002`",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m246-b003-lane-b-readiness '
        '&& npm run check:objc3c:m246-c005-lane-c-readiness '
        '&& npm run check:objc3c:m246-d002-lane-d-readiness '
        '&& npm run check:objc3c:m246-e003-optimization-gate-perf-evidence-core-feature-implementation-contract '
        '&& npm run test:tooling:m246-e003-optimization-gate-perf-evidence-core-feature-implementation-contract"',
    ),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--e002-expectations-doc", type=Path, default=DEFAULT_E002_EXPECTATIONS_DOC)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-E003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-E003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.e002_expectations_doc, "M246-E003-E002-DOC-EXISTS", E002_SNIPPETS),
        (args.a002_expectations_doc, "M246-E003-A002-DOC-EXISTS", A002_SNIPPETS),
        (args.architecture_doc, "M246-E003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M246-E003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M246-E003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M246-E003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
