#!/usr/bin/env python3
"""Fail-closed checker for M230-D010 Developer CLI and diagnostics ergonomics contract freeze."""
...
MODE = "m230-d010-developer-cli-and-diagnostics-ergonomics-conformance-corpus-expansion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_d010_developer_cli_and_diagnostics_ergonomics_conformance_corpus_expansion_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-D010-DOC-PKT-01",
        "# M230-D010 Developer CLI and diagnostics ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-D010-DOC-PKT-02", "Packet: `M230-D010`"),
    SnippetCheck("M230-D010-DOC-PKT-03", "Issue: `#5449`"),
    SnippetCheck("M230-D010-DOC-PKT-04", "Dependencies: `M230-D009`"),
    SnippetCheck(
        "M230-D010-DOC-PKT-05",
        "check:objc3c:m230-d010-developer-cli-and-diagnostics-ergonomics-conformance-corpus-expansion-contract",
    ),
    SnippetCheck(
        "M230-D010-DOC-PKT-06",
        "tmp/reports/m230/M230-D010/developer_cli_and_diagnostics_ergonomics_conformance_corpus_expansion_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-D010-PKG-03",
        '"check:objc3c:m230-d010-lane-d-readiness": '
        '"npm run check:objc3c:m230-d009-lane-d-readiness && npm run check:objc3c:m230-d010-developer-cli-and-diagnostics-ergonomics-conformance-corpus-expansion-contract '
        '&& npm run test:tooling:m230-d010-developer-cli-and-diagnostics-ergonomics-conformance-corpus-expansion-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-D010-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-D010-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-D010-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-D010-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-D010-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-D010-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
