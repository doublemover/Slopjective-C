#!/usr/bin/env python3
"""Fail-closed checker for M246-A011 frontend optimization hint performance and quality guardrails."""
...
MODE = "m246-a011-frontend-optimization-hint-capture-performance-and-quality-guardrails-contract-v1"
...
DEFAULT_A010_CHECKER = (
    ROOT / "scripts" / "check_m246_a010_frontend_optimization_hint_capture_conformance_corpus_expansion_contract.py"
)
DEFAULT_A010_TEST = (
    ROOT
    / "tests"
...
DEFAULT_A010_RUN_SCRIPT = ROOT / "scripts" / "run_m246_a010_lane_a_readiness.py"
DEFAULT_RUN_SCRIPT = ROOT / "scripts" / "run_m246_a011_lane_a_readiness.py"
...
A010_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-A011-A010-DOC-01",
        "# M246 Frontend Optimization Hint Capture Conformance Corpus Expansion Expectations (A010)",
    ),
    SnippetCheck(
        "M246-A011-A010-DOC-02",
        "Contract ID: `objc3c-frontend-optimization-hint-capture-conformance-corpus-expansion/m246-a010-v1`",
    ),
    SnippetCheck("M246-A011-A010-DOC-03", "Dependencies: `M246-A009`"),
)

A010_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A011-A010-PKT-01", "Packet: `M246-A010`"),
    SnippetCheck("M246-A011-A010-PKT-02", "Dependencies: `M246-A009`"),
)

A010_RUN_SCRIPT_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A011-A010-RUN-01", "scripts/run_m246_a009_lane_a_readiness.py"),
    SnippetCheck(
        "M246-A011-A010-RUN-02",
        "scripts/check_m246_a010_frontend_optimization_hint_capture_conformance_corpus_expansion_contract.py",
    ),
    SnippetCheck(
        "M246-A011-A010-RUN-03",
...
RUN_SCRIPT_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A011-RUN-01", "scripts/run_m246_a010_lane_a_readiness.py"),
    SnippetCheck(
        "M246-A011-RUN-02",
        "scripts/check_m246_a011_frontend_optimization_hint_capture_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck("M246-A011-RUN-03", "--emit-json"),
    SnippetCheck(
        "M246-A011-RUN-04",
        "tests/tooling/test_check_m246_a011_frontend_optimization_hint_capture_performance_and_quality_guardrails_contract.py",
    ),
    SnippetCheck("M246-A011-RUN-05", "M246-A011 lane-A readiness chain completed"),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-A011-PKG-01", '"check:objc3c:m246-a002-lane-a-readiness": '),
    SnippetCheck("M246-A011-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-A011-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-A011-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-A011-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--a010-run-script", type=Path, default=DEFAULT_A010_RUN_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-A011-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-A011-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a010_expectations_doc, "M246-A011-A010-DOC-EXISTS", A010_EXPECTATIONS_SNIPPETS),
        (args.a010_packet_doc, "M246-A011-A010-PKT-EXISTS", A010_PACKET_SNIPPETS),
        (args.a010_run_script, "M246-A011-A010-RUN-EXISTS", A010_RUN_SCRIPT_SNIPPETS),
        (args.run_script, "M246-A011-RUN-EXISTS", RUN_SCRIPT_SNIPPETS),
        (args.package_json, "M246-A011-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a010_checker, "M246-A011-DEP-A010-ARG-01"),
        (args.a010_test, "M246-A011-DEP-A010-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
