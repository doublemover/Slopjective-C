#!/usr/bin/env python3
"""Fail-closed contract checker for M244-A001 interop surface syntax/declaration freeze."""
...
MODE = "m244-a001-interop-surface-syntax-and-declaration-forms-contract-v1"

ARTIFACTS: dict[str, Path] = {
    "expectations_doc": ROOT
    / "docs"
    / "contracts"
    / "m244_interop_surface_syntax_and_declaration_forms_contract_and_architecture_freeze_a001_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m244"
    / "m244_a001_interop_surface_syntax_and_declaration_forms_contract_and_architecture_freeze_packet.md",
...
EXISTENCE_CHECK_IDS: dict[str, str] = {
    "expectations_doc": "M244-A001-DOC-EXISTS",
    "packet_doc": "M244-A001-PKT-EXISTS",
    "architecture_doc": "M244-A001-ARCH-EXISTS",
    "lowering_spec": "M244-A001-SPC-EXISTS",
    "metadata_spec": "M244-A001-META-EXISTS",
    "package_json": "M244-A001-PKG-EXISTS",
}
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "expectations_doc": (
        ...
        ("M244-A001-DOC-03", "Dependencies: none"),
        (
            "M244-A001-DOC-04",
        ...
        ("M244-A001-DOC-07", "`check:objc3c:m244-a001-lane-a-readiness`"),
        (
            "M244-A001-DOC-08",
    ...
    "packet_doc": (
        ...
        ("M244-A001-PKT-02", "Packet: `M244-A001`"),
        ("M244-A001-PKT-03", "Freeze date: `2026-03-03`"),
        ("M244-A001-PKT-04", "Dependencies: none"),
        (
            "M244-A001-PKT-05",
    ...
    "lowering_spec": (
        ...
        (
            "M244-A001-SPC-03",
            "fail closed on declaration-form boundary drift",
        ),
    ),
    "metadata_spec": (
        (
