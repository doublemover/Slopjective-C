#!/usr/bin/env python3
"""Fail-closed checker for M245-D017 build/link/runtime reproducibility advanced diagnostics workpack shard 1."""
...
MODE = "m245-d017-build-link-runtime-reproducibility-operations-advanced-diagnostics-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_advanced_diagnostics_workpack_shard1_d017_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_d017_build_link_runtime_reproducibility_operations_advanced_diagnostics_workpack_shard1_packet.md"
)
DEFAULT_D016_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_advanced_edge_compatibility_workpack_shard1_d016_expectations.md"
)
DEFAULT_D016_PACKET_DOC = (
    ...
    / "compiler"
    / "m245"
    / "m245_d016_build_link_runtime_reproducibility_operations_advanced_edge_compatibility_workpack_shard1_packet.md"
)
...
DEFAULT_D016_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m245_d016_build_link_runtime_reproducibility_operations_advanced_edge_compatibility_workpack_shard1_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D017-DOC-PKT-01",
        "# M245-D017 Build/Link/Runtime Reproducibility Operations Advanced Diagnostics Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M245-D017-DOC-PKT-02", "Packet: `M245-D017`"),
    SnippetCheck("M245-D017-DOC-PKT-03", "Issue: `#6668`"),
    SnippetCheck("M245-D017-DOC-PKT-04", "Dependencies: `M245-D016`"),
    SnippetCheck("M245-D017-DOC-PKT-05", "Theme: `advanced diagnostics workpack (shard 1)`"),
    SnippetCheck(
        "M245-D017-DOC-PKT-06",
        "dependency continuity and code/spec anchors as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D017-DOC-PKT-07",
        "scripts/check_m245_d017_build_link_runtime_reproducibility_operations_advanced_diagnostics_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D017-DOC-PKT-08",
        "tests/tooling/test_check_m245_d017_build_link_runtime_reproducibility_operations_advanced_diagnostics_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D017-DOC-PKT-09",
    ...
    SnippetCheck("M245-D017-DOC-PKT-10", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-D017-DOC-PKT-11",
        "`python scripts/check_m245_d017_build_link_runtime_reproducibility_operations_advanced_diagnostics_workpack_shard1_contract.py --emit-json`",
    ),
)
...
D016_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D017-D016-DOC-01",
        "# M245 Build/Link/Runtime Reproducibility Operations Advanced Edge Compatibility Workpack (Shard 1) Expectations (D016)",
    ),
    SnippetCheck(
        "M245-D017-D016-DOC-02",
        "Contract ID: `objc3c-build-link-runtime-reproducibility-operations-advanced-edge-compatibility-workpack-shard1/m245-d016-v1`",
    ),
    SnippetCheck("M245-D017-D016-DOC-03", "Dependencies: `M245-D015`"),
)

D016_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-D017-D016-PKT-01", "Packet: `M245-D016`"),
    SnippetCheck("M245-D017-D016-PKT-02", "Issue: `#6667`"),
    SnippetCheck("M245-D017-D016-PKT-03", "Dependencies: `M245-D015`"),
    SnippetCheck("M245-D017-D016-PKT-04", "Freeze date: `2026-03-04`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D017-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D017-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D017-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D017-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D017-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D017-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d016_expectations_doc, "M245-D017-D016-DOC-EXISTS", D016_EXPECTATIONS_SNIPPETS),
        (args.d016_packet_doc, "M245-D017-D016-PKT-EXISTS", D016_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D017-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D017-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D017-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D017-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d016_checker, "M245-D017-DEP-D016-ARG-01"),
        (args.d016_test, "M245-D017-DEP-D016-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
