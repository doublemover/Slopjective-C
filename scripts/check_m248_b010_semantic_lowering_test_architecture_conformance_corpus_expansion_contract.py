#!/usr/bin/env python3
"""Fail-closed contract checker for M248-B010 semantic/lowering conformance corpus expansion."""
...
MODE = "m248-b010-semantic-lowering-test-architecture-conformance-corpus-expansion-contract-v1"
...
DEFAULT_B009_CHECKER = (
    ROOT / "scripts" / "check_m248_b009_semantic_lowering_test_architecture_conformance_matrix_implementation_contract.py"
)
DEFAULT_B009_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m248_b009_semantic_lowering_test_architecture_conformance_matrix_implementation_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B010-DOC-PKT-01",
        "# M248-B010 Semantic/Lowering Test Architecture Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M248-B010-DOC-PKT-02", "Packet: `M248-B010`"),
    SnippetCheck("M248-B010-DOC-PKT-03", "Issue: `#6810`"),
    SnippetCheck("M248-B010-DOC-PKT-04", "Dependencies: `M248-B009`"),
    SnippetCheck(
        "M248-B010-DOC-PKT-05",
        "`scripts/check_m248_b010_semantic_lowering_test_architecture_conformance_corpus_expansion_contract.py`",
    ),
    SnippetCheck(
        "M248-B010-DOC-PKT-06",
        "`check:objc3c:m248-b010-lane-b-readiness`",
    ),
    SnippetCheck(
        "M248-B010-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M248-B010-DOC-PKT-08",
...
B009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B010-B009-DOC-01",
        "Contract ID: `objc3c-semantic-lowering-test-architecture-conformance-matrix-implementation/m248-b009-v1`",
    ),
    SnippetCheck("M248-B010-B009-DOC-02", "- Dependencies: `M248-B008`"),
    SnippetCheck(
        "M248-B010-B009-DOC-03",
        "scripts/check_m248_b009_semantic_lowering_test_architecture_conformance_matrix_implementation_contract.py",
    ),
)

B009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-B010-B009-PKT-01", "Packet: `M248-B009`"),
    SnippetCheck("M248-B010-B009-PKT-02", "Dependencies: `M248-B008`"),
    SnippetCheck(
        "M248-B010-B009-PKT-03",
        "`scripts/check_m248_b009_semantic_lowering_test_architecture_conformance_matrix_implementation_contract.py`",
    ),
    SnippetCheck(
        "M248-B010-B009-PKT-04",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        "&& npm run check:objc3c:m248-b010-semantic-lowering-test-architecture-conformance-corpus-expansion-contract "
        '&& npm run test:tooling:m248-b010-semantic-lowering-test-architecture-conformance-corpus-expansion-contract"',
    ),
    SnippetCheck("M248-B010-PKG-04", '"check:objc3c:m248-b009-lane-b-readiness": '),
    SnippetCheck("M248-B010-PKG-05", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M248-B010-PKG-06", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b009_expectations_doc, "M248-B010-B009-DOC-EXISTS", B009_EXPECTATIONS_SNIPPETS),
        (args.b009_packet_doc, "M248-B010-B009-PKT-EXISTS", B009_PACKET_SNIPPETS),
        (args.architecture_doc, "M248-B010-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B010-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B010-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M248-B010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b009_checker, "M248-B010-DEP-B009-ARG-01"),
        (args.b009_test, "M248-B010-DEP-B009-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
