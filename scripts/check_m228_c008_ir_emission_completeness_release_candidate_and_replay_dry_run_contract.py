#!/usr/bin/env python3
"""Fail-closed validator for M228-C014 IR-emission release/replay dry-run contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c013_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_docs_operator_runbook_sync_c013_expectations.md",
    "c013_checker": ROOT
    / "scripts"
    / "check_m228_c013_ir_emission_completeness_docs_operator_runbook_sync_contract.py",
    "c013_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c013_ir_emission_completeness_docs_operator_runbook_sync_contract.py",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "contract_doc": (
        ...
        ("M228-C014-DOC-02", "Execute issue `#5230`"),
        ("M228-C014-DOC-03", "Dependencies: `M228-C013`"),
        (
            "M228-C014-DOC-04",
            "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
        ),
        ("M228-C014-DOC-05", "`docs/runbooks/m228_wave_execution_runbook.md`"),
        (
            "M228-C014-DOC-06",
        ...
        ("M228-C014-DOC-09", "`npm run check:objc3c:m228-c014-lane-c-readiness`"),
        (
            "M228-C014-DOC-10",
    ...
    "runbook_doc": (
        ...
        ("M228-C014-RUN-07", "npm run check:objc3c:m228-c014-lane-c-readiness"),
        ("M228-C014-RUN-08", "tmp/reports/m228/"),
    ),
    "planning_packet": (
        ("M228-C014-PKT-01", "Packet: `M228-C014`"),
        ("M228-C014-PKT-02", "Issue: `#5230`"),
        ("M228-C014-PKT-03", "Dependencies: `M228-C013`"),
        ("M228-C014-PKT-04", "docs/runbooks/m228_wave_execution_runbook.md"),
        (
            "M228-C014-PKT-05",
            "scripts/check_m228_c014_ir_emission_completeness_release_candidate_and_replay_dry_run_contract.py",
        ),
        ...
        ("M228-C014-PKT-08", "check:objc3c:m228-c014-lane-c-readiness"),
        (
            "M228-C014-PKT-09",
            "tmp/reports/m228/M228-C014/ir_emission_completeness_release_candidate_and_replay_dry_run_contract_summary.json",
        ),
    ...
    "c013_tooling_test": (
        ("M228-C014-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c013_packet_doc": (
        ("M228-C014-DEP-04", "Packet: `M228-C013`"),
        ("M228-C014-DEP-05", "Issue: `#5229`"),
    ),
    "package_json": (
        ("M228-C014-PKG-01", '"check:objc3c:m228-c013-lane-c-readiness"'),
        (
            "M228-C014-PKG-02",
        ...
        ("M228-C014-PKG-05", '"check:objc3c:m228-c014-lane-c-readiness"'),
        (
            "M228-C014-PKG-06",
            '"check:objc3c:m228-c014-lane-c-readiness": "npm run check:objc3c:m228-c013-lane-c-readiness &&',
        ),
        (
            "M228-C014-PKG-07",
            "npm run run:objc3c:m228-c014-ir-emission-completeness-release-replay-dry-run",
        ),
        ("M228-C014-PKG-08", '"compile:objc3c"'),
        ("M228-C014-PKG-09", '"proof:objc3c"'),
        ("M228-C014-PKG-10", '"test:objc3c:execution-smoke"'),
        ("M228-C014-PKG-11", '"test:objc3c:lowering-replay-proof"'),
    ),
    "architecture_doc": (
        (
            "M228-C014-ARC-01",
    ...
    "lowering_spec": (
        (
            "M228-C014-SPC-01",
            "IR-emission release-candidate and replay dry-run governance",
        ),
        (
            "M228-C014-SPC-02",
            "lane-C dependency anchors (`M228-C014`, `M228-C013`)",
        ),
    ),
    "metadata_spec": (
        (
        ...
        ("M228-C014-META-02", "metadata anchors for `M228-C014`"),
        (
            "M228-C014-META-03",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C014-FORB-01",
            '"check:objc3c:m228-c014-lane-c-readiness": "npm run check:objc3c:m228-c012-lane-c-readiness',
        ),
    ),
}
