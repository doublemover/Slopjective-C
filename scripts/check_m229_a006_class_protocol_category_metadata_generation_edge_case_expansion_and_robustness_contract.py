#!/usr/bin/env python3
"""Fail-closed checker for M229-A006 class/protocol/category metadata edge-case expansion and robustness."""
...
MODE = "m229-a006-class-protocol-category-metadata-generation-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_A005_CHECKER = (
    ROOT / "scripts" / "check_m229_a005_class_protocol_category_metadata_generation_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_A005_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m229_a005_class_protocol_category_metadata_generation_edge_case_and_compatibility_completion_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[tuple[str, Path], ...] = (
    (
        "M229-A006-DEP-A005-01",
        Path("docs/contracts/m229_class_protocol_category_metadata_generation_edge_case_and_compatibility_completion_a005_expectations.md"),
    ),
    (
        "M229-A006-DEP-A005-02",
        Path("spec/planning/compiler/m229/m229_a005_class_protocol_category_metadata_generation_edge_case_and_compatibility_completion_packet.md"),
    ),
    (
        "M229-A006-DEP-A005-03",
        Path("scripts/check_m229_a005_class_protocol_category_metadata_generation_edge_case_and_compatibility_completion_contract.py"),
    ),
    (
        "M229-A006-DEP-A005-04",
        Path("tests/tooling/test_check_m229_a005_class_protocol_category_metadata_generation_edge_case_and_compatibility_completion_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A006-DOC-EXP-01",
        "# M229 Class/Protocol/Category Metadata Generation Edge-case Expansion and Robustness Expectations (A006)",
    ),
    SnippetCheck(
        "M229-A006-DOC-EXP-02",
        "Contract ID: `objc3c-class-protocol-category-metadata-generation-edge-case-expansion-and-robustness/m229-a006-v1`",
    ),
    SnippetCheck("M229-A006-DOC-EXP-03", "Dependencies: `M229-A005`"),
    SnippetCheck(
        "M229-A006-DOC-EXP-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A006-DOC-EXP-05",
        "check:objc3c:m229-a006-class-protocol-category-metadata-generation-edge-case-expansion-and-robustness-contract",
    ),
    SnippetCheck(
        "M229-A006-DOC-EXP-06",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A006-DOC-PKT-01",
        "# M229-A006 Class/Protocol/Category Metadata Generation Edge-case Expansion and Robustness Packet",
    ),
    SnippetCheck("M229-A006-DOC-PKT-02", "Packet: `M229-A006`"),
    SnippetCheck("M229-A006-DOC-PKT-03", "Dependencies: `M229-A005`"),
    SnippetCheck(
        "M229-A006-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A006-DOC-PKT-05",
...
A005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M229-A006-A005-PKT-01", "Packet: `M229-A005`"),
    SnippetCheck("M229-A006-A005-PKT-02", "Dependencies: `M229-A004`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m229-a006-class-protocol-category-metadata-generation-edge-case-expansion-and-robustness-contract '
        '&& npm run test:tooling:m229-a006-class-protocol-category-metadata-generation-edge-case-expansion-and-robustness-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M229-A006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M229-A006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a005_expectations_doc, "M229-A006-A005-EXP-EXISTS", A005_EXPECTATIONS_SNIPPETS),
        (args.a005_packet_doc, "M229-A006-A005-PKT-EXISTS", A005_PACKET_SNIPPETS),
        (args.architecture_doc, "M229-A006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M229-A006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M229-A006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M229-A006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
