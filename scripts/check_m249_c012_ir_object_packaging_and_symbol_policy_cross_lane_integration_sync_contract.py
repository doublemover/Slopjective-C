#!/usr/bin/env python3
"""Fail-closed checker for M249-C012 IR/object packaging cross-lane integration sync contract."""
...
MODE = "m249-c012-ir-object-packaging-and-symbol-policy-cross-lane-integration-sync-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_ir_object_packaging_and_symbol_policy_cross_lane_integration_sync_c012_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_c012_ir_object_packaging_and_symbol_policy_cross_lane_integration_sync_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m249/M249-C012/"
    "ir_object_packaging_and_symbol_policy_cross_lane_integration_sync_contract_summary.json"
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M249-C012-CFG-03", "check:objc3c:m249-c012-lane-c-readiness"),
    PackageScriptKeyCheck("M249-C012-CFG-04", "check:objc3c:m249-c011-lane-c-readiness"),
    PackageScriptKeyCheck("M249-C012-CFG-05", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M249-C012-CFG-06", "test:objc3c:execution-replay-proof"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m249-c011-lane-c-readiness && npm run check:objc3c:m249-c012-ir-object-packaging-symbol-policy-cross-lane-integration-sync-contract && npm run test:tooling:m249-c012-ir-object-packaging-symbol-policy-cross-lane-integration-sync-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M249-C012-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M249-C012-DOC-PKT-00",
    ...
    c011_checks, c011_findings = check_doc_contract(
        ...
        exists_check_id="M249-C012-C011-DOC-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M249-C012-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M249-C012-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M249-C012-META-00",
