#!/usr/bin/env python3
"""Fail-closed contract checker for the M249-B002 semantic compatibility/migration modular split scaffolding packet."""
...
MODE = "m249-b002-semantic-compatibility-migration-checks-modular-split-scaffolding-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-B002-DOC-PKT-01",
        "# M249-B002 Semantic Compatibility and Migration Checks Modular Split and Scaffolding Packet",
    ),
    SnippetCheck("M249-B002-DOC-PKT-02", "Packet: `M249-B002`"),
    SnippetCheck("M249-B002-DOC-PKT-03", "Dependencies: `M249-B001`"),
    SnippetCheck(
        "M249-B002-DOC-PKT-04",
        "`scripts/check_m249_b001_semantic_compatibility_and_migration_checks_contract.py`",
    ),
    SnippetCheck(
        "M249-B002-DOC-PKT-05",
        "`check:objc3c:m249-b002-lane-b-readiness`",
    ),
    SnippetCheck(
        "M249-B002-DOC-PKT-06",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M249-B002-DOC-PKT-07",
        "code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M249-B002-DOC-PKT-08",
        "improvements as mandatory scope inputs.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-B002-SPC-02",
        "lane-B dependency anchors (`M249-B001`) and fail closed on",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-B002-PKG-04", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M249-B002-PKG-05", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-B002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-B002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M249-B002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-B002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-B002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-B002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
