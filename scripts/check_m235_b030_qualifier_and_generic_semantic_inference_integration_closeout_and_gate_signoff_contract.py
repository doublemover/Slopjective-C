#!/usr/bin/env python3
"""Fail-closed checker for M235-B030 qualifier/generic semantic inference integration closeout and gate signoff."""
...
MODE = "m235-b030-qualifier-and-generic-semantic-inference-integration-closeout-and-gate-signoff-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_integration_closeout_and_gate_signoff_b030_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_b030_qualifier_and_generic_semantic_inference_integration_closeout_and_gate_signoff_packet.md"
)
...
DEFAULT_CONTRACT_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m235_b030_qualifier_and_generic_semantic_inference_integration_closeout_and_gate_signoff_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-B030-DOC-EXP-09", "integration_closeout_and_gate_signoff_consistent"),
    SnippetCheck("M235-B030-DOC-EXP-10", "integration_closeout_and_gate_signoff_key"),
    SnippetCheck(
        "M235-B030-DOC-EXP-11",
        "`tmp/reports/m235/M235-B030/qualifier_and_generic_semantic_inference_integration_closeout_and_gate_signoff_contract_summary.json`",
    ),
    SnippetCheck(
        "M235-B030-DOC-EXP-12",
...
EXPECTATIONS_FORBIDDEN_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B030-DOC-EXP-FORB-01", "Dependencies: `M235-B027`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-B030-DOC-PKT-01",
        "# M235-B030 Qualifier/Generic Semantic Inference Integration Closeout and Gate Sign-off Packet",
    ),
    SnippetCheck("M235-B030-DOC-PKT-02", "Packet: `M235-B030`"),
    SnippetCheck("M235-B030-DOC-PKT-03", "Issue: `#5810`"),
    SnippetCheck("M235-B030-DOC-PKT-04", "Dependencies: `M235-B029`"),
    SnippetCheck("M235-B030-DOC-PKT-05", "Theme: `integration closeout and gate signoff`"),
    SnippetCheck(
        "M235-B030-DOC-PKT-06",
        "`scripts/check_m235_b029_qualifier_and_generic_semantic_inference_advanced_diagnostics_workpack_shard_3_contract.py`",
    ),
    SnippetCheck(
        "M235-B030-DOC-PKT-07",
        "`scripts/check_m235_b030_qualifier_and_generic_semantic_inference_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M235-B030-DOC-PKT-08",
        "`tests/tooling/test_check_m235_b030_qualifier_and_generic_semantic_inference_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M235-B030-DOC-PKT-09",
    ...
    SnippetCheck(
        "M235-B030-DOC-PKT-10",
        "`tmp/reports/m235/M235-B030/qualifier_and_generic_semantic_inference_integration_closeout_and_gate_signoff_contract_summary.json`",
    ),
)

PACKET_FORBIDDEN_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B030-DOC-PKT-FORB-01", "Dependencies: `M235-B027`"),
)

CHECKER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-B030-SRC-CHK-01",
        'MODE = "m235-b030-qualifier-and-generic-semantic-inference-integration-closeout-and-gate-signoff-contract-v1"',
    ),
    SnippetCheck(
        "M235-B030-SRC-CHK-02",
        '"tmp/reports/m235/M235-B030/qualifier_and_generic_semantic_inference_integration_closeout_and_gate_signoff_contract_summary.json"',
    ),
)

TEST_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M235-B030-SRC-TST-01", "def test_contract_passes_on_repository_sources"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets, forbidden in (
        (
            ...
            "M235-B030-DOC-EXP-EXISTS",
            EXPECTATIONS_SNIPPETS,
            EXPECTATIONS_FORBIDDEN_SNIPPETS,
        ),
        (
            args.packet_doc,
            "M235-B030-DOC-PKT-EXISTS",
            PACKET_SNIPPETS,
            PACKET_FORBIDDEN_SNIPPETS,
        ),
        (args.contract_checker, "M235-B030-SRC-CHK-EXISTS", CHECKER_SNIPPETS, ()),
        (args.contract_test, "M235-B030-SRC-TST-EXISTS", TEST_SNIPPETS, ()),
    ):
    ...
    for path, check_id in (
        (args.contract_checker, "M235-B030-DEP-B029-ARG-01"),
        (args.contract_test, "M235-B030-DEP-B029-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
