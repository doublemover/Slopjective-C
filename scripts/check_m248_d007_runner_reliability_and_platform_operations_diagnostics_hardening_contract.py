#!/usr/bin/env python3
"""Fail-closed checker for M248-D007 runner/platform operations diagnostics hardening contract."""
...
MODE = "m248-d007-runner-reliability-platform-operations-diagnostics-hardening-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_runner_reliability_and_platform_operations_diagnostics_hardening_d007_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_d007_runner_reliability_and_platform_operations_diagnostics_hardening_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-D007-DOC-EXP-01",
        "Contract ID: `objc3c-runner-reliability-platform-operations-diagnostics-hardening/m248-d007-v1`",
    ),
    SnippetCheck("M248-D007-DOC-EXP-02", "Dependencies: `M248-D006`"),
    SnippetCheck("M248-D007-DOC-EXP-03", "Issue `#6842` defines canonical lane-D diagnostics hardening scope."),
    SnippetCheck("M248-D007-DOC-EXP-04", "`check:objc3c:m248-d007-lane-d-readiness`"),
    SnippetCheck("M248-D007-DOC-EXP-05", "`check:objc3c:m248-d006-lane-d-readiness`"),
    SnippetCheck("M248-D007-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M248-D007-DOC-EXP-07",
        "tmp/reports/m248/M248-D007/runner_reliability_and_platform_operations_diagnostics_hardening_contract_summary.json",
    ),
    SnippetCheck(
        "M248-D007-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-D007-DOC-PKT-01", "Packet: `M248-D007`"),
    SnippetCheck("M248-D007-DOC-PKT-02", "Issue: `#6842`"),
    SnippetCheck("M248-D007-DOC-PKT-03", "Dependencies"),
    SnippetCheck("M248-D007-DOC-PKT-04", "`M248-D006`"),
    SnippetCheck(
        "M248-D007-DOC-PKT-05",
        "`scripts/check_m248_d007_runner_reliability_and_platform_operations_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-D007-DOC-PKT-06",
        "`tests/tooling/test_check_m248_d007_runner_reliability_and_platform_operations_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck("M248-D007-DOC-PKT-07", "`check:objc3c:m248-d007-lane-d-readiness`"),
    SnippetCheck(
        "M248-D007-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    PackageScriptKeyCheck(
        "M248-D007-CFG-01",
        "check:objc3c:m248-d007-runner-reliability-platform-operations-diagnostics-hardening-contract",
    ),
    PackageScriptKeyCheck(
        "M248-D007-CFG-02",
        "test:tooling:m248-d007-runner-reliability-platform-operations-diagnostics-hardening-contract",
    ),
    PackageScriptKeyCheck("M248-D007-CFG-03", "check:objc3c:m248-d007-lane-d-readiness"),
    PackageScriptKeyCheck("M248-D007-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M248-D007-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M248-D007-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M248-D007-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-d006-lane-d-readiness && npm run check:objc3c:m248-d007-runner-reliability-platform-operations-diagnostics-hardening-contract && npm run test:tooling:m248-d007-runner-reliability-platform-operations-diagnostics-hardening-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-D007-ARCH-01",
        "M248 lane-D D007 runner/platform operations diagnostics hardening",
    ),
    SnippetCheck(
        "M248-D007-ARCH-02",
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-D007-SPC-03", "closed on diagnostics hardening evidence drift before downstream platform"),
    SnippetCheck("M248-D007-SPC-04", "replay and lane-e recovery and determinism hardening advances."),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-D007-META-02",
        "explicit `M248-D006` dependency continuity and fail-closed diagnostics evidence continuity",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M248-D007-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M248-D007-DOC-PKT-00", PACKET_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M248-D007-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M248-D007-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M248-D007-META-00", METADATA_SPEC_SNIPPETS),
    ):
