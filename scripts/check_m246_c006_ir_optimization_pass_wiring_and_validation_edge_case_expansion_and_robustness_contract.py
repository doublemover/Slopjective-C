#!/usr/bin/env python3
"""Fail-closed checker for M246-C006 IR optimization pass wiring edge-case expansion and robustness."""
...
MODE = "m246-c006-ir-optimization-pass-wiring-validation-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_C005_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m246_ir_optimization_pass_wiring_and_validation_edge_case_and_compatibility_completion_c005_expectations.md"
)
DEFAULT_C005_PACKET_DOC = (
    ...
    / "compiler"
    / "m246"
    / "m246_c005_ir_optimization_pass_wiring_and_validation_edge_case_and_compatibility_completion_packet.md"
)
DEFAULT_C005_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c005_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c006_lane_c_readiness.py"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M246-C006-DEP-C002-03",
        Path("scripts/check_m246_c002_ir_optimization_pass_wiring_and_validation_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-C006-DEP-C002-04",
        Path("tests/tooling/test_check_m246_c002_ir_optimization_pass_wiring_and_validation_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M246-C006-DEP-C005-01",
        Path("docs/contracts/m246_ir_optimization_pass_wiring_and_validation_edge_case_and_compatibility_completion_c005_expectations.md"),
    ),
    AssetCheck(
        "M246-C006-DEP-C005-02",
        Path("spec/planning/compiler/m246/m246_c005_ir_optimization_pass_wiring_and_validation_edge_case_and_compatibility_completion_packet.md"),
    ),
    AssetCheck(
        "M246-C006-DEP-C005-03",
        Path("scripts/check_m246_c005_ir_optimization_pass_wiring_and_validation_edge_case_and_compatibility_completion_contract.py"),
    ),
    AssetCheck(
        "M246-C006-DEP-C005-04",
        Path("tests/tooling/test_check_m246_c005_ir_optimization_pass_wiring_and_validation_edge_case_and_compatibility_completion_contract.py"),
    ),
    AssetCheck(
        "M246-C006-DEP-C005-05",
        Path("scripts/run_m246_c005_lane_c_readiness.py"),
    ),
    AssetCheck(
        "M246-C006-OWN-01",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-C006-DOC-EXP-10",
        "improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-C006-DOC-EXP-11",
        "tmp/reports/m246/M246-C006/ir_optimization_pass_wiring_validation_edge_case_expansion_and_robustness_summary.json",
    ),
    SnippetCheck(
        "M246-C006-DOC-EXP-14",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C006-DOC-PKT-01",
        "# M246-C006 IR Optimization Pass Wiring and Validation Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M246-C006-DOC-PKT-02", "Packet: `M246-C006`"),
    SnippetCheck("M246-C006-DOC-PKT-03", "Issue: `#5082`"),
    SnippetCheck("M246-C006-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-C006-DOC-PKT-05", "Dependencies: `M246-C005`"),
    SnippetCheck("M246-C006-DOC-PKT-13", "## Issue Anchor"),
    SnippetCheck("M246-C006-DOC-PKT-14", "Primary issue anchor: `#5082`"),
    SnippetCheck(
        "M246-C006-DOC-PKT-06",
        "Predecessor anchors inherited via `M246-C005`: `M246-C001`, `M246-C002`, `M246-C003`, `M246-C004`.",
    ),
    SnippetCheck(
        "M246-C006-DOC-PKT-07",
        "scripts/check_m246_c006_ir_optimization_pass_wiring_and_validation_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M246-C006-DOC-PKT-08",
        "tests/tooling/test_check_m246_c006_ir_optimization_pass_wiring_and_validation_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M246-C006-DOC-PKT-09",
        "scripts/run_m246_c006_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C006-DOC-PKT-10",
        "scripts/run_m246_c005_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C006-DOC-PKT-11",
        "treated as mandatory scope",
    ),
    SnippetCheck(
        "M246-C006-DOC-PKT-12",
        "tmp/reports/m246/M246-C006/ir_optimization_pass_wiring_validation_edge_case_expansion_and_robustness_summary.json",
    ),
    SnippetCheck(
        "M246-C006-DOC-PKT-15",
        "python scripts/check_m246_c006_ir_optimization_pass_wiring_and_validation_edge_case_expansion_and_robustness_contract.py --emit-json --summary-out tmp/reports/m246/M246-C006/ir_optimization_pass_wiring_validation_edge_case_expansion_and_robustness_summary.json",
    ),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C006-C001-02", "Dependencies: none"),
)
...
C005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C006-C005-EXP-01",
        "Contract ID: `objc3c-ir-optimization-pass-wiring-validation-edge-case-and-compatibility-completion/m246-c005-v1`",
    ),
    SnippetCheck(
        "M246-C006-C005-EXP-02",
        "Dependencies: `M246-C004`",
    ),
    SnippetCheck(
        "M246-C006-C005-EXP-03",
        "scripts/run_m246_c005_lane_c_readiness.py",
    ),
)

C005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-C006-C005-PKT-01", "Packet: `M246-C005`"),
    SnippetCheck("M246-C006-C005-PKT-02", "Dependencies: `M246-C004`"),
    SnippetCheck("M246-C006-C005-PKT-03", "scripts/run_m246_c005_lane_c_readiness.py"),
)

C005_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C006-C005-RUN-01",
        "scripts/run_m246_c004_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C006-C005-RUN-02",
        "scripts/check_m246_c005_ir_optimization_pass_wiring_and_validation_edge_case_and_compatibility_completion_contract.py",
    ),
    SnippetCheck(
        "M246-C006-C005-RUN-03",
    ...
    SnippetCheck(
        "M246-C006-C005-RUN-04",
        "[ok] M246-C005 lane-C readiness chain completed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C006-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-C006-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-C006-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C006-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c005-readiness-script", type=Path, default=DEFAULT_C005_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M246-C006-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M246-C006-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.c005_expectations_doc, "M246-C006-C005-EXP-EXISTS", C005_EXPECTATIONS_SNIPPETS),
        (args.c005_packet_doc, "M246-C006-C005-PKT-EXISTS", C005_PACKET_SNIPPETS),
        (args.c005_readiness_script, "M246-C006-C005-RUN-EXISTS", C005_READINESS_SNIPPETS),
        (args.readiness_script, "M246-C006-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M246-C006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
