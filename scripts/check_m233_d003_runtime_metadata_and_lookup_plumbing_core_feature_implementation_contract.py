#!/usr/bin/env python3
"""Fail-closed checker for M233-D003 runtime metadata and lookup plumbing core feature implementation."""
...
MODE = "m233-d003-installer-runtime-operations-lookup-plumbing-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_runtime_metadata_and_lookup_plumbing_core_feature_implementation_d003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m233"
    / "m233_d003_runtime_metadata_and_lookup_plumbing_core_feature_implementation_packet.md"
)
DEFAULT_D002_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m233_runtime_metadata_and_lookup_plumbing_modular_split_scaffolding_d002_expectations.md"
)
DEFAULT_D002_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_d002_runtime_metadata_and_lookup_plumbing_modular_split_scaffolding_packet.md"
)
DEFAULT_D002_CHECKER = (
    ROOT / "scripts" / "check_m233_d002_runtime_metadata_and_lookup_plumbing_modular_split_scaffolding_contract.py"
)
DEFAULT_D002_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m233_d002_runtime_metadata_and_lookup_plumbing_modular_split_scaffolding_contract.py"
)
...
D002_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M233-D003-D002-PKT-01", "Packet: `M233-D002`"),
    SnippetCheck("M233-D003-D002-PKT-02", "Dependencies: `M233-D001`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-D003-META-02",
        "explicit `M233-D002` dependency continuity so core feature implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m233-d003-installer-runtime-operations-lookup-plumbing-core-feature-implementation-contract '
        '&& npm run test:tooling:m233-d003-installer-runtime-operations-lookup-plumbing-core-feature-implementation-contract"',
    ),
    SnippetCheck("M233-D003-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M233-D003-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M233-D003-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-D003-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-D003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-D003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d002_expectations_doc, "M233-D003-D002-DOC-EXISTS", D002_EXPECTATIONS_SNIPPETS),
        (args.d002_packet_doc, "M233-D003-D002-PKT-EXISTS", D002_PACKET_SNIPPETS),
        (args.architecture_doc, "M233-D003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M233-D003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M233-D003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M233-D003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d002_checker, "M233-D003-DEP-D002-ARG-01"),
        (args.d002_test, "M233-D003-DEP-D002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
