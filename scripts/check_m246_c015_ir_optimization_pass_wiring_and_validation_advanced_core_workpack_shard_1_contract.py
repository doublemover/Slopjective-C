#!/usr/bin/env python3
"""Fail-closed checker for M246-C015 IR optimization pass wiring release/replay dry-run."""
...
MODE = "m246-c015-ir-optimization-pass-wiring-validation-advanced-core-workpack-shard-1-contract-v1"
...
DEFAULT_C014_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c014_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c015_lane_c_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C015-DOC-PKT-01",
        "# M246-C015 IR Optimization Pass Wiring and Validation Advanced Core Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M246-C015-DOC-PKT-02", "Packet: `M246-C015`"),
    SnippetCheck("M246-C015-DOC-PKT-03", "Issue: `#5091`"),
    SnippetCheck("M246-C015-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-C015-DOC-PKT-05", "Dependencies: `M246-C014`"),
    SnippetCheck(
        "M246-C015-DOC-PKT-06",
        "Predecessor anchors inherited via `M246-C014`: `M246-C001`, `M246-C002`, `M246-C003`, `M246-C004`, `M246-C005`, `M246-C006`, `M246-C007`, `M246-C008`, `M246-C009`, `M246-C010`, `M246-C011`, `M246-C012`.",
    ),
    SnippetCheck(
        "M246-C015-DOC-PKT-07",
        "scripts/check_m246_c015_ir_optimization_pass_wiring_and_validation_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M246-C015-DOC-PKT-08",
        "tests/tooling/test_check_m246_c015_ir_optimization_pass_wiring_and_validation_advanced_core_workpack_shard_1_contract.py",
    ),
    SnippetCheck(
        "M246-C015-DOC-PKT-09",
        "scripts/run_m246_c015_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C015-DOC-PKT-10",
        "scripts/run_m246_c014_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C015-DOC-PKT-11",
        "treated as mandatory scope",
    ),
    SnippetCheck(
        "M246-C015-DOC-PKT-12",
        "tmp/reports/m246/M246-C015/ir_optimization_pass_wiring_validation_advanced_core_workpack_shard_1_summary.json",
    ),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C015-C001-02", "Dependencies: none"),
)
...
C014_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C015-C014-EXP-01",
        "Contract ID: `objc3c-ir-optimization-pass-wiring-validation-release-candidate-and-replay-dry-run/m246-c014-v1`",
    ),
    SnippetCheck(
        "M246-C015-C014-EXP-02",
        "Dependencies: `M246-C013`",
    ),
    SnippetCheck(
        "M246-C015-C014-EXP-03",
        "scripts/run_m246_c014_lane_c_readiness.py",
    ),
)

C014_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-C015-C014-PKT-01", "Packet: `M246-C014`"),
    SnippetCheck("M246-C015-C014-PKT-02", "Dependencies: `M246-C013`"),
    SnippetCheck("M246-C015-C014-PKT-03", "scripts/run_m246_c014_lane_c_readiness.py"),
)

C014_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C015-C014-RUN-01",
        "scripts/run_m246_c013_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C015-C014-RUN-02",
        "scripts/check_m246_c014_ir_optimization_pass_wiring_and_validation_release_candidate_and_replay_dry_run_contract.py",
    ),
    SnippetCheck(
        "M246-C015-C014-RUN-03",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C015-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-C015-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-C015-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C015-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c014-readiness-script", type=Path, default=DEFAULT_C014_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C015-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C015-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M246-C015-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M246-C015-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.c014_expectations_doc, "M246-C015-C014-EXP-EXISTS", C014_EXPECTATIONS_SNIPPETS),
        (args.c014_packet_doc, "M246-C015-C014-PKT-EXISTS", C014_PACKET_SNIPPETS),
        (args.c014_readiness_script, "M246-C015-C014-RUN-EXISTS", C014_READINESS_SNIPPETS),
        (args.readiness_script, "M246-C015-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M246-C015-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
