#!/usr/bin/env python3
"""Fail-closed checker for M231-D001 Frontend/runtime declaration metadata linkage contract freeze."""
...
MODE = "m231-d001-frontend-runtime-declaration-metadata-linkage-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_d001_frontend_runtime_declaration_metadata_linkage_contract_and_architecture_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M231-D001-DOC-PKT-01",
        "# M231-D001 Declaration Grammar Expansion and Normalization Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M231-D001-DOC-PKT-02", "Packet: `M231-D001`"),
    SnippetCheck("M231-D001-DOC-PKT-03", "Issue: `#5515`"),
    SnippetCheck("M231-D001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M231-D001-DOC-PKT-05",
        "check:objc3c:m231-d001-frontend-runtime-declaration-metadata-linkage-contract",
    ),
    SnippetCheck(
        "M231-D001-DOC-PKT-06",
        "tmp/reports/m231/M231-D001/frontend_runtime_declaration_metadata_linkage_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M231-D001-PKG-03",
        '"check:objc3c:m231-d001-lane-d-readiness": '
        '"npm run check:objc3c:m231-d001-frontend-runtime-declaration-metadata-linkage-contract '
        '&& npm run test:tooling:m231-d001-frontend-runtime-declaration-metadata-linkage-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-D001-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-D001-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-D001-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-D001-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-D001-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-D001-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
