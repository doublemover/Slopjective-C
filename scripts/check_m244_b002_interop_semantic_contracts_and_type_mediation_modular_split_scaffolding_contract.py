#!/usr/bin/env python3
"""Fail-closed checker for M244-B002 interop semantic/type mediation modular split/scaffolding contract."""
...
MODE = "m244-b002-interop-semantic-contracts-and-type-mediation-modular-split-scaffolding-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_semantic_contracts_and_type_mediation_modular_split_scaffolding_b002_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_b002_interop_semantic_contracts_and_type_mediation_modular_split_scaffolding_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B002/"
    "interop_semantic_contracts_and_type_mediation_modular_split_scaffolding_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-B002-B001-01",
        "M244-B001",
        Path("docs/contracts/m244_interop_semantic_contracts_and_type_mediation_contract_freeze_b001_expectations.md"),
    ),
    AssetCheck(
        "M244-B002-B001-02",
        "M244-B001",
        Path(
            "spec/planning/compiler/m244/"
    ...
    AssetCheck(
        "M244-B002-B001-03",
        "M244-B001",
        Path("scripts/check_m244_b001_interop_semantic_contracts_and_type_mediation_contract.py"),
    ),
    AssetCheck(
        "M244-B002-B001-04",
        "M244-B001",
        Path("tests/tooling/test_check_m244_b001_interop_semantic_contracts_and_type_mediation_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B002-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-modular-split-scaffolding/m244-b002-v1`",
    ),
    SnippetCheck("M244-B002-DOC-EXP-02", "Dependencies: `M244-B001`"),
    SnippetCheck("M244-B002-DOC-EXP-03", "Issue `#6532` defines canonical lane-B modular split/scaffolding scope."),
    SnippetCheck("M244-B002-DOC-EXP-04", "`check:objc3c:m244-b002-lane-b-readiness`"),
    SnippetCheck("M244-B002-DOC-EXP-05", "`check:objc3c:m244-b001-lane-b-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B002-DOC-PKT-01", "Packet: `M244-B002`"),
    SnippetCheck("M244-B002-DOC-PKT-02", "Issue: `#6532`"),
    SnippetCheck("M244-B002-DOC-PKT-03", "Dependencies: `M244-B001`"),
    SnippetCheck(
        "M244-B002-DOC-PKT-04",
        "`scripts/check_m244_b002_interop_semantic_contracts_and_type_mediation_modular_split_scaffolding_contract.py`",
    ),
    SnippetCheck(
        "M244-B002-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B002-CFG-03", "check:objc3c:m244-b002-lane-b-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b001-lane-b-readiness && npm run check:objc3c:m244-b002-interop-semantic-contracts-type-mediation-modular-split-scaffolding-contract && npm run test:tooling:m244-b002-interop-semantic-contracts-type-mediation-modular-split-scaffolding-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-B002-ARCH-02",
        "`M244-B001` dependency continuity and modular split evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B002-SPC-02", "lane-B dependency anchor (`M244-B001`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-B002-META-02",
        "explicit `M244-B001` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B002-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B002-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-B002-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-B002-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-B002-META-00",
