#!/usr/bin/env python3
"""Fail-closed validator for M226-E002 lane-E integration gate evidence modular split."""
...
MODE = "m226-e002-lane-e-integration-gate-evidence-modular-split-contract-v1"

DEFAULT_CONTRACT_DOC = (
    ROOT / "docs" / "contracts" / "m226_lane_e_integration_gate_e002_evidence_modular_split_expectations.md"
)
DEFAULT_PACKET_DOC = ROOT / "spec" / "planning" / "compiler" / "m226" / "m226_e002_lane_e_integration_gate_evidence_packet.md"
DEFAULT_EVIDENCE_DOC = (
    ROOT / "spec" / "planning" / "compiler" / "m226" / "m226_e002_lane_e_integration_gate_evidence_scaffold.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M226-E002-ASSET-05",
        Path("spec/planning/compiler/m226/m226_e002_lane_e_integration_gate_evidence_packet.md"),
    ),
    AssetCheck(
        "M226-E002-ASSET-06",
        Path("spec/planning/compiler/m226/m226_e002_lane_e_integration_gate_evidence_scaffold.md"),
    ),
    AssetCheck(
        "M226-E002-ASSET-07",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E002-DOC-PKT-02",
        "# M226 Lane E Integration Gate Evidence Packet (E002)",
    ),
    SnippetCheck("M226-E002-DOC-PKT-03", "Packet: `M226-E002`"),
    SnippetCheck("M226-E002-DOC-PKT-04", "Upstream packet dependency: `M226-E001`"),
    SnippetCheck(
        "M226-E002-DOC-PKT-05",
        "`python scripts/check_m226_e002_lane_e_integration_gate_evidence_modular_split_contract.py`",
    ),
    SnippetCheck(
        "M226-E002-DOC-PKT-06",
...
EVIDENCE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E002-DOC-EVI-02",
        "# M226 Lane E Integration Gate Evidence Scaffold (E002)",
    ),
    SnippetCheck(
        "M226-E002-DOC-EVI-03",
        "Path: `tmp/reports/m226/m226_e002_lane_e_integration_gate_evidence_modular_split_contract_summary.json`",
    ),
    SnippetCheck("M226-E002-DOC-EVI-04", "Status: `pending`"),
    SnippetCheck(
        "M226-E002-DOC-EVI-05",
        "Path: `tmp/reports/m226/e002/validation/pytest_check_m226_e002_lane_e_integration_gate_evidence_modular_split_contract.txt`",
    ),
    SnippetCheck(
        "M226-E002-DOC-EVI-06",
        "Path: `tmp/reports/m226/e002/evidence_index.json`",
    ),
)

FREEZE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M226-E002-DOC-FRZ-02", "# M226 Lane E Contract Freeze (2026-03-02)"),
    SnippetCheck(
        "M226-E002-DOC-FRZ-03",
        "| `M226-E002` | `objc3c-lane-e-integration-gate-evidence-modular-split-contract/m226-e002-v1` |",
    ),
    SnippetCheck("M226-E002-DOC-FRZ-04", "## Packet: `M226-E002`"),
    SnippetCheck(
        "M226-E002-DOC-FRZ-05",
        "`docs/contracts/m226_lane_e_integration_gate_e002_evidence_modular_split_expectations.md`",
    ),
    SnippetCheck(
        "M226-E002-DOC-FRZ-06",
        "`scripts/check_m226_e002_lane_e_integration_gate_evidence_modular_split_contract.py`",
    ),
    SnippetCheck(
        "M226-E002-DOC-FRZ-07",
        "`tmp/reports/m226/e002/evidence_index.json`",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    contract_checks, contract_findings = check_doc_contract(
        ...
        exists_check_id="M226-E002-DOC-CON-01",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M226-E002-DOC-PKT-01",
    ...
    evidence_checks, evidence_findings = check_doc_contract(
        ...
        exists_check_id="M226-E002-DOC-EVI-01",
    ...
    freeze_checks, freeze_findings = check_doc_contract(
        ...
        exists_check_id="M226-E002-DOC-FRZ-01",
    ...
    try:
        ...
        print(
            "m226-e002-lane-e-integration-gate-evidence-modular-split-contract: "
    ...
    if not findings:
        print("m226-e002-lane-e-integration-gate-evidence-modular-split-contract: OK")
        return 0

    print(
        "m226-e002-lane-e-integration-gate-evidence-modular-split-contract: contract drift detected "
