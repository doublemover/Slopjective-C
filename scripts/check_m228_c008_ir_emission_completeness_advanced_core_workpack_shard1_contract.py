#!/usr/bin/env python3
"""Fail-closed validator for M228-C015 IR-emission advanced core shard1 contract."""
...
MODE = "m228-c015-ir-emission-completeness-advanced-core-workpack-shard1-contract-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c014_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_release_candidate_and_replay_dry_run_c014_expectations.md",
    "c014_checker": ROOT
    / "scripts"
    / "check_m228_c014_ir_emission_completeness_release_candidate_and_replay_dry_run_contract.py",
    "c014_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c014_ir_emission_completeness_release_candidate_and_replay_dry_run_contract.py",
    "c014_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c014_ir_emission_completeness_release_candidate_and_replay_dry_run_packet.md",
    "contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ir_emission_completeness_advanced_core_workpack_shard1_c015_expectations.md",
    "packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
    / "m228_c015_ir_emission_completeness_advanced_core_workpack_shard1_packet.md",
}

REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "core_surface_header": (
        ("M228-C015-SUR-01", "bool pass_graph_advanced_core_shard1_ready = false;"),
        (
            "M228-C015-SUR-02",
        ...
        ("M228-C015-SUR-04", "bool advanced_core_shard1_consistent = false;"),
        (
            "M228-C015-SUR-05",
            "bool advanced_core_shard1_key_transport_ready = false;",
        ),
        ("M228-C015-SUR-06", "bool core_feature_advanced_core_shard1_ready = false;"),
        ("M228-C015-SUR-07", "std::string pass_graph_advanced_core_shard1_key;"),
        (
            "M228-C015-SUR-08",
        ...
        ("M228-C015-SUR-10", "std::string advanced_core_shard1_key;"),
        (
            "M228-C015-SUR-11",
        ...
        (
            "M228-C015-SUR-12",
            "BuildObjc3IREmissionCoreFeatureAdvancedCoreShard1Key(",
        ),
        (
            "M228-C015-SUR-13",
        ...
        ("M228-C015-SUR-15", "surface.advanced_core_shard1_consistent ="),
        (
            "M228-C015-SUR-16",
        ...
        ("M228-C015-SUR-18", "surface.advanced_core_shard1_key ="),
        (
            "M228-C015-SUR-19",
        ...
        (
            "M228-C015-SUR-22",
            "inline bool IsObjc3IREmissionCoreFeatureAdvancedCoreShard1Ready(",
        ),
        ("M228-C015-SUR-23", "!surface.advanced_core_shard1_key.empty())"),
    ),
    "artifacts_source": (
        (
            "M228-C015-ART-01",
            "IsObjc3IREmissionCoreFeatureAdvancedCoreShard1Ready(",
        ),
        ("M228-C015-ART-02", '"O3L333"'),
        (
            "M228-C015-ART-03",
            "IR emission core feature advanced core shard 1 check failed",
        ),
        (
            "M228-C015-ART-04",
    ...
    "runbook_doc": (
        ...
        ("M228-C015-RUN-04", "npm run check:objc3c:m228-c015-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C015-ARC-01",
    ...
    "lowering_spec": (
        ...
        (
            "M228-C015-SPC-02",
            "lane-C dependency anchors (`M228-C015`, `M228-C014`)",
        ),
    ),
    "metadata_spec": (
        (
    ...
    "package_json": (
        ("M228-C015-PKG-01", '"check:objc3c:m228-c014-lane-c-readiness"'),
        (
            "M228-C015-PKG-02",
            '"check:objc3c:m228-c015-ir-emission-completeness-advanced-core-workpack-shard1-contract"',
        ),
        (
            "M228-C015-PKG-03",
            '"test:tooling:m228-c015-ir-emission-completeness-advanced-core-workpack-shard1-contract"',
        ),
        ("M228-C015-PKG-04", '"check:objc3c:m228-c015-lane-c-readiness"'),
        (
            "M228-C015-PKG-05",
            '"check:objc3c:m228-c015-lane-c-readiness": "npm run check:objc3c:m228-c014-lane-c-readiness &&',
        ),
    ),
    "c014_contract_doc": (
        (
    ...
    "c014_checker": (
        (
            "M228-C015-DEP-02",
            'MODE = "m228-c014-ir-emission-completeness-release-candidate-and-replay-dry-run-contract-v1"',
        ),
    ),
    "c014_tooling_test": (
        ("M228-C015-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c014_packet_doc": (
        ("M228-C015-DEP-04", "Packet: `M228-C014`"),
        ("M228-C015-DEP-05", "Issue: `#5230`"),
    ),
    "contract_doc": (
        (
            "M228-C015-DOC-01",
        ...
        ("M228-C015-DOC-02", "Execute issue `#5241`"),
        ("M228-C015-DOC-03", "Dependencies: `M228-C014`"),
        (
            "M228-C015-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedCoreShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C015-PKT-02", "Packet: `M228-C015`"),
        ("M228-C015-PKT-03", "Issue: `#5241`"),
        ("M228-C015-PKT-04", "Dependencies: `M228-C014`"),
        (
            "M228-C015-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C015-FORB-01",
            '"check:objc3c:m228-c015-lane-c-readiness": "npm run check:objc3c:m228-c013-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C015/"
            "ir_emission_completeness_advanced_core_workpack_shard1_contract_summary.json"
        ),
    )
