#!/usr/bin/env python3
"""Fail-closed checker for M230-E009 Program control and release readiness governance contract freeze."""
...
MODE = "m230-e009-program-control-and-release-readiness-governance-conformance-matrix-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_e009_program_control_and_release_readiness_governance_conformance_matrix_implementation_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-E009-DOC-EXP-01",
        "# M230 Program control and release readiness governance Contract and Architecture Freeze Expectations (A001)",
    ),
    SnippetCheck(
        "M230-E009-DOC-EXP-02",
        "Contract ID: `objc3c-program-control-and-release-readiness-governance/m230-e009-v1`",
    ),
    SnippetCheck("M230-E009-DOC-EXP-03", "Issue: `#5470`"),
    SnippetCheck("M230-E009-DOC-EXP-04", "Dependencies: `M230-E008`"),
    SnippetCheck(
        "M230-E009-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-E009-DOC-EXP-06",
        "`check:objc3c:m230-e009-lane-e-readiness`",
    ),
    SnippetCheck(
        "M230-E009-DOC-EXP-07",
        "`tmp/reports/m230/M230-E009/program_control_and_release_readiness_governance_conformance_matrix_implementation_summary.json`",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-E009-PKG-03",
        '"check:objc3c:m230-e009-lane-e-readiness": '
        '"npm run check:objc3c:m230-e008-lane-e-readiness && npm run check:objc3c:m230-e009-program-control-and-release-readiness-governance-conformance-matrix-implementation-contract '
        '&& npm run test:tooling:m230-e009-program-control-and-release-readiness-governance-conformance-matrix-implementation-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-E009-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-E009-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-E009-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-E009-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-E009-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-E009-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
