#!/usr/bin/env python3
"""Fail-closed checker for M238-E008 exception conformance gate and documentation contract freeze."""
...
MODE = "m238-e008-exception-conformance-gate-and-documentation-recovery-and-determinism-hardening-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m238_exception_conformance_gate_and_documentation_recovery_and_determinism_hardening_e008_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m238"
    / "m238_e008_exception_conformance_gate_and_documentation_recovery_and_determinism_hardening_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m238/M238-E008/local_check_summary.json")
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M238-E008-DOC-PKT-01",
        "# M238-E008 Exception conformance gate and documentation Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M238-E008-DOC-PKT-02", "Packet: `M238-E008`"),
    SnippetCheck("M238-E008-DOC-PKT-03", "Issue: `#6122`"),
    SnippetCheck(
        "M238-E008-DOC-PKT-04",
        "Dependencies: `M238-A001`, `M238-B001`, `M238-C001`",
    ),
    SnippetCheck(
        "M238-E008-DOC-PKT-05",
        "currently-closed early lane steps",
    ),
    SnippetCheck(
        "M238-E008-DOC-PKT-06",
        "docs/contracts/m238_exception_conformance_gate_and_documentation_recovery_and_determinism_hardening_e008_expectations.md",
    ),
    SnippetCheck(
        "M238-E008-DOC-PKT-07",
        "scripts/check_m238_e008_exception_conformance_gate_and_documentation_contract.py",
    ),
    SnippetCheck(
        "M238-E008-DOC-PKT-08",
        "tests/tooling/test_check_m238_e008_exception_conformance_gate_and_documentation_contract.py",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M238-E008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M238-E008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
