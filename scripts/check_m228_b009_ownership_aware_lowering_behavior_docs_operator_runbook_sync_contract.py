#!/usr/bin/env python3
"""Fail-closed validator for M228-B013 ownership-aware lowering docs/operator runbook synchronization contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "tests"
    / "tooling"
    / "test_check_m228_b012_ownership_aware_lowering_behavior_cross_lane_integration_sync_contract.py",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "contract_doc": (
        ...
        ("M228-B013-DOC-02", "Execute issue `#5207`"),
        ("M228-B013-DOC-03", "Dependencies: `M228-B012`"),
        (
            "M228-B013-DOC-04",
            "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
        ),
        ("M228-B013-DOC-05", "`docs/runbooks/m228_wave_execution_runbook.md`"),
        (
            "M228-B013-DOC-06",
        ...
        ("M228-B013-DOC-08", "`npm run check:objc3c:m228-b013-lane-b-readiness`"),
        (
            "M228-B013-DOC-09",
    ...
    "runbook_doc": (
        ...
        ("M228-B013-RUN-06", "npm run check:objc3c:m228-b013-lane-b-readiness"),
        ("M228-B013-RUN-07", "tmp/reports/m228/"),
    ),
    "planning_packet": (
        ("M228-B013-PKT-01", "Packet: `M228-B013`"),
        ("M228-B013-PKT-02", "Issue: `#5207`"),
        ("M228-B013-PKT-03", "Dependencies: `M228-B012`"),
        ("M228-B013-PKT-04", "docs/runbooks/m228_wave_execution_runbook.md"),
        (
            "M228-B013-PKT-05",
            "scripts/check_m228_b013_ownership_aware_lowering_behavior_docs_operator_runbook_sync_contract.py",
        ),
        ...
        ("M228-B013-PKT-07", "check:objc3c:m228-b013-lane-b-readiness"),
        (
            "M228-B013-PKT-08",
            "tmp/reports/m228/M228-B013/ownership_aware_lowering_behavior_docs_operator_runbook_sync_contract_summary.json",
        ),
    ...
    "b012_tooling_test": (
        ("M228-B013-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "b012_packet_doc": (
        ("M228-B013-DEP-04", "Packet: `M228-B012`"),
        ("M228-B013-DEP-05", "Issue: `#5206`"),
    ),
    "package_json": (
        (
            "M228-B013-PKG-01",
        ...
        ("M228-B013-PKG-04", '"check:objc3c:m228-b013-lane-b-readiness"'),
        (
            "M228-B013-PKG-05",
        ...
        (
            "M228-B013-PKG-07",
            "tests/tooling/test_check_m228_b013_ownership_aware_lowering_behavior_docs_operator_runbook_sync_contract.py -q",
        ),
        ("M228-B013-PKG-08", '"test:objc3c:lowering-replay-proof"'),
    ),
    "architecture_doc": (
        (
            "M228-B013-ARC-01",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-B013-FORB-01",
            '"check:objc3c:m228-b013-lane-b-readiness": "npm run check:objc3c:m228-b011-lane-b-readiness',
        ),
    ),
}
