#!/usr/bin/env python3
"""Run M246-E012 lane-E readiness checks without deep npm nesting."""
...
BASELINE_DEPENDENCIES = ("M246-E011", "M246-A008", "M246-D008")
PENDING_SEEDED_DEPENDENCY_TOKENS = ("M246-B012", "M246-C020")
D008_REAL_READINESS_SCRIPT = "scripts/run_m246_d008_lane_d_readiness.py"
...
INITIAL_COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    ...
    (
        ...
        "run",
        "--if-present",
        "check:objc3c:m246-b012-lane-b-readiness",
    ),
    (
        NPM_EXECUTABLE,
        "run",
        "--if-present",
        "check:objc3c:m246-c020-lane-c-readiness",
    ),
    (
        sys.executable,
        D008_REAL_READINESS_SCRIPT,
    ),
)
...
def run_chain() -> int:
    ...
    print("[ok] M246-E012 lane-E readiness chain completed")
    return 0
