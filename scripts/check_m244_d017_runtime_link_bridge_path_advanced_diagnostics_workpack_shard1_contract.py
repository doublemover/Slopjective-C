#!/usr/bin/env python3
"""Fail-closed checker for M244-D017 runtime/link bridge-path advanced diagnostics workpack (shard 1) contract."""
...
MODE = "m244-d017-runtime-link-bridge-path-advanced-diagnostics-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_runtime_link_bridge_path_advanced_diagnostics_workpack_shard1_d017_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_d017_runtime_link_bridge_path_advanced_diagnostics_workpack_shard1_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-D017-D016-01",
        "M244-D016",
        Path("docs/contracts/m244_runtime_link_bridge_path_advanced_edge_compatibility_workpack_shard1_d016_expectations.md"),
    ),
    AssetCheck(
        "M244-D017-D016-02",
        "M244-D016",
        Path("spec/planning/compiler/m244/m244_d016_runtime_link_bridge_path_advanced_edge_compatibility_workpack_shard1_packet.md"),
    ),
    AssetCheck(
        "M244-D017-D016-03",
        "M244-D016",
        Path("scripts/check_m244_d016_runtime_link_bridge_path_advanced_edge_compatibility_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M244-D017-D016-04",
        "M244-D016",
        Path("tests/tooling/test_check_m244_d016_runtime_link_bridge_path_advanced_edge_compatibility_workpack_shard1_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D017-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-bridge-path-advanced-diagnostics-workpack-shard1/m244-d017-v1`",
    ),
    SnippetCheck("M244-D017-DOC-EXP-02", "Dependencies: `M244-D016`"),
    SnippetCheck("M244-D017-DOC-EXP-03", "Issue `#6589` defines canonical lane-D advanced diagnostics workpack (shard 1) scope."),
    SnippetCheck("M244-D017-DOC-EXP-04", "`check:objc3c:m244-d017-lane-d-readiness`"),
    SnippetCheck("M244-D017-DOC-EXP-05", "`check:objc3c:m244-d016-lane-d-readiness`"),
    SnippetCheck("M244-D017-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M244-D017-DOC-EXP-07",
        "tmp/reports/m244/M244-D017/runtime_link_bridge_path_advanced_diagnostics_workpack_shard1_contract_summary.json",
    ),
    SnippetCheck(
        "M244-D017-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-D017-DOC-PKT-01", "Packet: `M244-D017`"),
    SnippetCheck("M244-D017-DOC-PKT-02", "Issue: `#6589`"),
    SnippetCheck("M244-D017-DOC-PKT-03", "Dependencies: `M244-D016`"),
    SnippetCheck(
        "M244-D017-DOC-PKT-04",
        "`scripts/check_m244_d017_runtime_link_bridge_path_advanced_diagnostics_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M244-D017-DOC-PKT-05",
        "`tests/tooling/test_check_m244_d017_runtime_link_bridge_path_advanced_diagnostics_workpack_shard1_contract.py`",
    ),
    SnippetCheck("M244-D017-DOC-PKT-06", "`check:objc3c:m244-d017-lane-d-readiness`"),
    SnippetCheck(
        "M244-D017-DOC-PKT-07",
        "`python scripts/check_m244_d017_runtime_link_bridge_path_advanced_diagnostics_workpack_shard1_contract.py --emit-json`",
    ),
    SnippetCheck(
        "M244-D017-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-D017-CFG-03", "check:objc3c:m244-d017-lane-d-readiness"),
    PackageScriptKeyCheck("M244-D017-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M244-D017-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M244-D017-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-D017-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-d016-lane-d-readiness && npm run check:objc3c:m244-d017-runtime-link-bridge-path-advanced-diagnostics-workpack-shard1-contract && npm run test:tooling:m244-d017-runtime-link-bridge-path-advanced-diagnostics-workpack-shard1-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-D017-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-D017-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-D017-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-D017-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-D017-META-00",
