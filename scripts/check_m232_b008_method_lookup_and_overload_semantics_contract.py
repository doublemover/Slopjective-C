#!/usr/bin/env python3
"""Fail-closed checker for M232-B008 method lookup and overload semantics contract freeze."""
...
MODE = "m232-b008-method-lookup-and-overload-semantics-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m232"
    / "m232_b008_method_lookup_and_overload_semantics_recovery_and_determinism_hardening_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-B008-DOC-EXP-01",
        "# M232 Runtime Selector Binding Integration Contract and Architecture Freeze Expectations (B008)",
    ),
    SnippetCheck(
        "M232-B008-DOC-EXP-02",
        "Contract ID: `objc3c-method-lookup-and-overload-semantics/m232-b008-v1`",
    ),
    SnippetCheck("M232-B008-DOC-EXP-03", "Issue: `#5588`"),
    SnippetCheck("M232-B008-DOC-EXP-04", "Dependencies: none"),
    SnippetCheck(
        "M232-B008-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M232-B008-DOC-EXP-06",
        "`check:objc3c:m232-b008-lane-b-readiness`",
    ),
    SnippetCheck(
        "M232-B008-DOC-EXP-07",
        "`tmp/reports/m232/M232-B008/method_lookup_and_overload_semantics_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-B008-DOC-PKT-01",
        "# M232-B008 Runtime Selector Binding Integration Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M232-B008-DOC-PKT-02", "Packet: `M232-B008`"),
    SnippetCheck("M232-B008-DOC-PKT-03", "Issue: `#5588`"),
    SnippetCheck("M232-B008-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M232-B008-DOC-PKT-05",
        "check:objc3c:m232-b008-method-lookup-and-overload-semantics-contract",
    ),
    SnippetCheck(
        "M232-B008-DOC-PKT-06",
        "tmp/reports/m232/M232-B008/method_lookup_and_overload_semantics_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M232-B008-PKG-03",
        '"check:objc3c:m232-b008-lane-b-readiness": '
        '"npm run check:objc3c:m232-b008-method-lookup-and-overload-semantics-contract '
        '&& npm run test:tooling:m232-b008-method-lookup-and-overload-semantics-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M232-B008-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M232-B008-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M232-B008-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M232-B008-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M232-B008-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M232-B008-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
