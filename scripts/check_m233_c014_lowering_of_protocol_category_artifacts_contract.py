#!/usr/bin/env python3
"""Fail-closed checker for M233-C014 lowering of protocol/category artifacts contract freeze."""
...
MODE = "m233-c014-lowering-of-protocol-category-artifacts-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_c014_lowering_of_protocol_category_artifacts_release_candidate_and_replay_dry_run_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-C014-DOC-PKT-01",
        "# M233-C014 Lowering of protocol/category artifacts Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M233-C014-DOC-PKT-02", "Packet: `M233-C014`"),
    SnippetCheck("M233-C014-DOC-PKT-03", "Issue: `#4939`"),
    SnippetCheck("M233-C014-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M233-C014-DOC-PKT-05",
        "check:objc3c:m233-c014-lowering-of-protocol-category-artifacts-contract",
    ),
    SnippetCheck(
        "M233-C014-DOC-PKT-06",
        "tmp/reports/m233/M233-C014/lowering_of_protocol_category_artifacts_contract_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M233-C014-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M233-C014-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M233-C014-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M233-C014-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M233-C014-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M233-C014-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
