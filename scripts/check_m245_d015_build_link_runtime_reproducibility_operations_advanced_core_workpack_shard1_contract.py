#!/usr/bin/env python3
"""Fail-closed checker for M245-D015 build/link/runtime reproducibility advanced core workpack shard 1."""
...
MODE = "m245-d015-build-link-runtime-reproducibility-operations-advanced-core-workpack-shard1-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m245_build_link_runtime_reproducibility_operations_advanced_core_workpack_shard1_d015_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m245"
    / "m245_d015_build_link_runtime_reproducibility_operations_advanced_core_workpack_shard1_packet.md"
)
...
DEFAULT_D014_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m245_d014_build_link_runtime_reproducibility_operations_release_candidate_and_replay_dry_run_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D015-DOC-PKT-01",
        "# M245-D015 Build/Link/Runtime Reproducibility Operations Advanced Core Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M245-D015-DOC-PKT-02", "Packet: `M245-D015`"),
    SnippetCheck("M245-D015-DOC-PKT-03", "Issue: `#6666`"),
    SnippetCheck("M245-D015-DOC-PKT-04", "Dependencies: `M245-D014`"),
    SnippetCheck("M245-D015-DOC-PKT-05", "Theme: `advanced core workpack (shard 1)`"),
    SnippetCheck(
        "M245-D015-DOC-PKT-06",
        "dependency continuity and code/spec anchors as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-D015-DOC-PKT-07",
        "scripts/check_m245_d015_build_link_runtime_reproducibility_operations_advanced_core_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D015-DOC-PKT-08",
        "tests/tooling/test_check_m245_d015_build_link_runtime_reproducibility_operations_advanced_core_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M245-D015-DOC-PKT-09",
    ...
    SnippetCheck("M245-D015-DOC-PKT-10", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-D015-DOC-PKT-11",
        "`python scripts/check_m245_d015_build_link_runtime_reproducibility_operations_advanced_core_workpack_shard1_contract.py --emit-json`",
    ),
)
...
D014_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-D015-D014-DOC-01",
        "# M245 Build/Link/Runtime Reproducibility Operations Release-Candidate and Replay Dry-Run Expectations (D014)",
    ),
    SnippetCheck(
        "M245-D015-D014-DOC-02",
        "Contract ID: `objc3c-build-link-runtime-reproducibility-operations-release-candidate-and-replay-dry-run/m245-d014-v1`",
    ),
    SnippetCheck("M245-D015-D014-DOC-03", "Dependencies: `M245-D013`"),
)

D014_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-D015-D014-PKT-01", "Packet: `M245-D014`"),
    SnippetCheck("M245-D015-D014-PKT-02", "Issue: `#6665`"),
    SnippetCheck("M245-D015-D014-PKT-03", "Dependencies: `M245-D013`"),
    SnippetCheck("M245-D015-D014-PKT-04", "Freeze date: `2026-03-04`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D015-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D015-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D015-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D015-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D015-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D015-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d014_expectations_doc, "M245-D015-D014-DOC-EXISTS", D014_EXPECTATIONS_SNIPPETS),
        (args.d014_packet_doc, "M245-D015-D014-PKT-EXISTS", D014_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D015-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D015-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D015-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D015-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d014_checker, "M245-D015-DEP-D014-ARG-01"),
        (args.d014_test, "M245-D015-DEP-D014-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
