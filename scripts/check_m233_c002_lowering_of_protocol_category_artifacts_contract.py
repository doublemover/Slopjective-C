#!/usr/bin/env python3
"""Fail-closed checker for M233-C002 lowering of protocol/category artifacts contract freeze."""
...
MODE = "m233-c002-lowering-of-protocol-category-artifacts-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m233"
    / "m233_c002_lowering_of_protocol_category_artifacts_modular_split_and_scaffolding_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-C002-DOC-EXP-01",
        "# M233 Lowering of protocol/category artifacts Contract and Architecture Freeze Expectations (C002)",
    ),
    SnippetCheck(
        "M233-C002-DOC-EXP-02",
        "Contract ID: `objc3c-lowering-of-protocol-category-artifacts/m233-c002-v1`",
    ),
    SnippetCheck("M233-C002-DOC-EXP-03", "Issue: `#4927`"),
    SnippetCheck("M233-C002-DOC-EXP-04", "Dependencies: none"),
    SnippetCheck(
        "M233-C002-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M233-C002-DOC-EXP-06",
        "`check:objc3c:m233-c002-lane-c-readiness`",
    ),
    SnippetCheck(
        "M233-C002-DOC-EXP-07",
        "`tmp/reports/m233/M233-C002/lowering_of_protocol_category_artifacts_contract_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-C002-DOC-PKT-01",
        "# M233-C002 Lowering of protocol/category artifacts Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M233-C002-DOC-PKT-02", "Packet: `M233-C002`"),
    SnippetCheck("M233-C002-DOC-PKT-03", "Issue: `#4927`"),
    SnippetCheck("M233-C002-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M233-C002-DOC-PKT-05",
        "check:objc3c:m233-c002-lowering-of-protocol-category-artifacts-contract",
    ),
    SnippetCheck(
        "M233-C002-DOC-PKT-06",
        "tmp/reports/m233/M233-C002/lowering_of_protocol_category_artifacts_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M233-C002-PKG-03",
        '"check:objc3c:m233-c002-lane-c-readiness": '
        '"npm run check:objc3c:m233-c002-lowering-of-protocol-category-artifacts-contract '
        '&& npm run test:tooling:m233-c002-lowering-of-protocol-category-artifacts-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M233-C002-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M233-C002-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M233-C002-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M233-C002-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M233-C002-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M233-C002-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
