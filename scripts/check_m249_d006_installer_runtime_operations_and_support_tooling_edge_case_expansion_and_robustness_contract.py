#!/usr/bin/env python3
"""Fail-closed checker for M249-D006 installer/runtime edge-case expansion robustness."""
...
MODE = "m249-d006-installer-runtime-operations-support-tooling-edge-case-expansion-and-robustness-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_installer_runtime_operations_and_support_tooling_edge_case_expansion_and_robustness_d006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_d006_installer_runtime_operations_and_support_tooling_edge_case_expansion_and_robustness_packet.md"
)
...
DEFAULT_D005_CHECKER = (
    ROOT
    / "scripts"
    / "check_m249_d005_installer_runtime_operations_and_support_tooling_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_D005_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m249_d005_installer_runtime_operations_and_support_tooling_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_D005_READINESS_RUNNER = ROOT / "scripts" / "run_m249_d005_lane_d_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m249_d006_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D006-DOC-PKT-01",
        "# M249-D006 Installer/Runtime Operations and Support Tooling Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M249-D006-DOC-PKT-02", "Packet: `M249-D006`"),
    SnippetCheck("M249-D006-DOC-PKT-03", "Dependencies: `M249-D005`"),
    SnippetCheck(
        "M249-D006-DOC-PKT-04",
        "scripts/check_m249_d006_installer_runtime_operations_and_support_tooling_edge_case_expansion_and_robustness_contract.py",
    ),
    SnippetCheck(
        "M249-D006-DOC-PKT-05",
        "scripts/run_m249_d006_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M249-D006-DOC-PKT-06",
        "python scripts/run_m249_d005_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M249-D006-DOC-PKT-07",
        "python scripts/run_m249_d006_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M249-D006-DOC-PKT-08",
        "code/spec anchors and milestone",
    ),
    SnippetCheck(
        "M249-D006-DOC-PKT-09",
...
D005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D006-D005-DOC-01",
        "Contract ID: `objc3c-installer-runtime-operations-support-tooling-edge-case-and-compatibility-completion/m249-d005-v1`",
    ),
    SnippetCheck(
        "M249-D006-D005-DOC-02",
        "Dependencies: `M249-D004`",
    ),
)

D005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-D006-D005-PKT-01", "Packet: `M249-D005`"),
    SnippetCheck("M249-D006-D005-PKT-02", "Dependencies: `M249-D004`"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-D006-RUN-01", '"""Run M249-D006 lane-D readiness checks without deep npm nesting."""'),
    SnippetCheck("M249-D006-RUN-02", "scripts/run_m249_d005_lane_d_readiness.py"),
    SnippetCheck(
        "M249-D006-RUN-03",
        "scripts/check_m249_d006_installer_runtime_operations_and_support_tooling_edge_case_expansion_and_robustness_contract.py",
    ),
    ...
    SnippetCheck("M249-D006-RUN-05", "[ok] M249-D006 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-D006-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M249-D006-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M249-D006-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M249-D006-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-D006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-D006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d005_expectations_doc, "M249-D006-D005-DOC-EXISTS", D005_EXPECTATIONS_SNIPPETS),
        (args.d005_packet_doc, "M249-D006-D005-PKT-EXISTS", D005_PACKET_SNIPPETS),
        (args.readiness_runner, "M249-D006-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-D006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-D006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-D006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-D006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d005_checker, "M249-D006-DEP-D005-ARG-01"),
        (args.d005_test, "M249-D006-DEP-D005-ARG-02"),
        (args.d005_readiness_runner, "M249-D006-DEP-D005-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
