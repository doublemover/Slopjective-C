#!/usr/bin/env python3
"""Fail-closed checker for M228-E014 replay/performance closeout release-candidate and replay dry-run."""
...
MODE = "m228-e014-replay-proof-performance-closeout-gate-release-candidate-and-replay-dry-run-contract-v1"
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m228/M228-E014/"
    "replay_proof_and_performance_closeout_gate_release_candidate_and_replay_dry_run_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M228-E014-A009-01",
        "M228-A009",
        Path("docs/contracts/m228_lowering_pipeline_decomposition_pass_graph_release_candidate_and_replay_dry_run_a009_expectations.md"),
    ),
    AssetCheck(
        "M228-E014-A009-02",
        "M228-A009",
    ...
    AssetCheck(
        "M228-E014-B009-01",
        "M228-B009",
        Path("docs/contracts/m228_ownership_aware_lowering_behavior_release_candidate_and_replay_dry_run_b009_expectations.md"),
    ),
    AssetCheck(
        "M228-E014-B009-02",
        "M228-B009",
        Path("scripts/check_m228_b009_ownership_aware_lowering_behavior_release_candidate_and_replay_dry_run_contract.py"),
    ),
    AssetCheck(
        "M228-E014-B009-03",
        "M228-B009",
        Path("tests/tooling/test_check_m228_b009_ownership_aware_lowering_behavior_release_candidate_and_replay_dry_run_contract.py"),
    ),
    AssetCheck(
        "M228-E014-C008-01",
        "M228-C008",
        Path("docs/contracts/m228_ir_emission_completeness_docs_operator_runbook_sync_c008_expectations.md"),
    ),
    AssetCheck(
        "M228-E014-C008-02",
        "M228-C008",
        Path("scripts/check_m228_c008_ir_emission_completeness_docs_operator_runbook_sync_contract.py"),
    ),
    AssetCheck(
        "M228-E014-C008-03",
        "M228-C008",
        Path("tests/tooling/test_check_m228_c008_ir_emission_completeness_docs_operator_runbook_sync_contract.py"),
    ),
    AssetCheck(
        "M228-E014-D009-01",
        "M228-D009",
        Path("docs/contracts/m228_object_emission_link_path_reliability_release_candidate_and_replay_dry_run_d009_expectations.md"),
    ),
    AssetCheck(
        "M228-E014-D009-02",
        "M228-D009",
        Path("scripts/check_m228_d009_object_emission_link_path_reliability_release_candidate_and_replay_dry_run_contract.py"),
    ),
    AssetCheck(
        "M228-E014-D009-03",
        "M228-D009",
        Path("tests/tooling/test_check_m228_d009_object_emission_link_path_reliability_release_candidate_and_replay_dry_run_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M228-E014-DOC-EXP-01",
    ...
    SnippetCheck("M228-E014-DOC-EXP-02", "`M228-E013`"),
    SnippetCheck("M228-E014-DOC-EXP-03", "`M228-A009`"),
    SnippetCheck("M228-E014-DOC-EXP-04", "`M228-B009`"),
    SnippetCheck("M228-E014-DOC-EXP-05", "`M228-C008`"),
    SnippetCheck("M228-E014-DOC-EXP-06", "`M228-D009`"),
    SnippetCheck(
        "M228-E014-DOC-EXP-07",
        "Issue `#5294` dependency list includes `M228-A007`, `M228-B010`,",
    ),
    SnippetCheck("M228-E014-DOC-EXP-08", "`M228-C017`, and `M228-D007`."),
    SnippetCheck(
        "M228-E014-DOC-EXP-09",
        "`M228-A007`, `M228-B010`, `M228-C017`, and `M228-D007` are preserved as",
    ),
    SnippetCheck(
        "M228-E014-DOC-EXP-10",
        "pending-lane continuity tokens for lane-E closeout metadata continuity.",
    ),
    SnippetCheck("M228-E014-DOC-EXP-11", "`check:objc3c:m228-e014-lane-e-readiness`"),
    SnippetCheck("M228-E014-DOC-EXP-12", "`test:objc3c:lowering-replay-proof`"),
    SnippetCheck("M228-E014-DOC-EXP-13", "`test:objc3c:perf-budget`"),
    SnippetCheck(
        "M228-E014-DOC-EXP-14",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M228-E014-DOC-PKT-01", "Packet: `M228-E014`"),
    SnippetCheck(
        "M228-E014-DOC-PKT-02",
        "Dependencies: `M228-E013`, `M228-A009`, `M228-B009`, `M228-C008`, `M228-D009`",
    ),
    SnippetCheck("M228-E014-DOC-PKT-03", "Issue dependency continuity tokens:"),
    SnippetCheck("M228-E014-DOC-PKT-04", "`M228-A007`"),
    SnippetCheck("M228-E014-DOC-PKT-05", "`M228-B010`"),
    SnippetCheck("M228-E014-DOC-PKT-06", "`M228-C017`"),
    SnippetCheck("M228-E014-DOC-PKT-07", "`M228-D007`"),
    SnippetCheck(
        "M228-E014-DOC-PKT-08",
        "`scripts/check_m228_e014_replay_proof_and_performance_closeout_gate_release_candidate_and_replay_dry_run_contract.py`",
    ),
    SnippetCheck(
        "M228-E014-DOC-PKT-09",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M228-E014-CFG-03", "check:objc3c:m228-e014-lane-e-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m228-e013-lane-e-readiness && npm run check:objc3c:m228-a009-lane-a-readiness && npm run check:objc3c:m228-b009-lane-b-readiness && npm run check:objc3c:m228-c008-lane-c-readiness && npm run check:objc3c:m228-d009-lane-d-readiness && npm run check:objc3c:m228-e014-replay-proof-performance-closeout-gate-release-candidate-and-replay-dry-run-contract && npm run test:tooling:m228-e014-replay-proof-performance-closeout-gate-release-candidate-and-replay-dry-run-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M228-E014-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M228-E014-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M228-E014-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M228-E014-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M228-E014-META-00",
    ...
    if not findings:
        print("m228-e014-replay-proof-performance-closeout-gate-release-candidate-and-replay-dry-run-contract: OK")
        return 0

    print(
        "m228-e014-replay-proof-performance-closeout-gate-release-candidate-and-replay-dry-run-contract: "
