#!/usr/bin/env python3
"""Fail-closed checker for M244-C013 interop lowering docs/runbook synchronization contract."""
...
MODE = "m244-c013-interop-lowering-and-abi-conformance-docs-operator-runbook-synchronization-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_docs_operator_runbook_synchronization_c013_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c013_interop_lowering_and_abi_conformance_docs_operator_runbook_synchronization_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C013/"
    "interop_lowering_and_abi_conformance_docs_operator_runbook_synchronization_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C013-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-docs-operator-runbook-synchronization/m244-c013-v1`",
    ),
    SnippetCheck("M244-C013-DOC-EXP-02", "Dependencies: `M244-C012`"),
    SnippetCheck(
        "M244-C013-DOC-EXP-03",
        "Issue `#6562` defines canonical lane-C docs and operator runbook synchronization scope.",
    ),
    SnippetCheck(
        "M244-C013-DOC-EXP-04",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck("M244-C013-DOC-EXP-05", "`check:objc3c:m244-c013-lane-c-readiness`"),
    SnippetCheck("M244-C013-DOC-EXP-06", "`compile:objc3c`"),
    SnippetCheck("M244-C013-DOC-EXP-07", "`proof:objc3c`"),
    SnippetCheck("M244-C013-DOC-EXP-08", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M244-C013-DOC-EXP-09", "`test:objc3c:perf-budget`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C013-DOC-PKT-01", "Packet: `M244-C013`"),
    SnippetCheck("M244-C013-DOC-PKT-02", "Issue: `#6562`"),
    SnippetCheck("M244-C013-DOC-PKT-03", "Dependencies: `M244-C012`"),
    SnippetCheck(
        "M244-C013-DOC-PKT-04",
        "`scripts/check_m244_c013_interop_lowering_and_abi_conformance_docs_operator_runbook_synchronization_contract.py`",
    ),
    SnippetCheck(
        "M244-C013-DOC-PKT-05",
    ...
    SnippetCheck("M244-C013-DOC-PKT-06", "`compile:objc3c`"),
    SnippetCheck("M244-C013-DOC-PKT-07", "`proof:objc3c`"),
    SnippetCheck("M244-C013-DOC-PKT-08", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck("M244-C013-DOC-PKT-09", "`test:objc3c:perf-budget`"),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C013-CFG-03", "check:objc3c:m244-c013-lane-c-readiness"),
    PackageScriptKeyCheck("M244-C013-CFG-04", "compile:objc3c"),
    PackageScriptKeyCheck("M244-C013-CFG-05", "proof:objc3c"),
    PackageScriptKeyCheck("M244-C013-CFG-06", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-C013-CFG-07", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c012-lane-c-readiness && npm run check:objc3c:m244-c013-interop-lowering-abi-conformance-docs-operator-runbook-synchronization-contract && npm run test:tooling:m244-c013-interop-lowering-abi-conformance-docs-operator-runbook-synchronization-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C013-ARCH-02",
        "`M244-C012` dependency continuity and docs/runbook synchronization evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C013-SPC-02", "lane-C dependency anchor (`M244-C012`)"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C013-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C013-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C013-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C013-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C013-META-00",
