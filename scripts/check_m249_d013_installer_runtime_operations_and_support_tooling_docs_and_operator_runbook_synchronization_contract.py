#!/usr/bin/env python3
"""Fail-closed checker for M249-D013 installer/runtime docs and operator runbook synchronization."""
...
MODE = "m249-d013-installer-runtime-operations-support-tooling-docs-and-operator-runbook-synchronization-contract-v1"
...
DEFAULT_D012_CHECKER = (
    ROOT
    / "scripts"
    / "check_m249_d012_installer_runtime_operations_and_support_tooling_cross_lane_integration_sync_contract.py"
)
DEFAULT_D012_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m249_d012_installer_runtime_operations_and_support_tooling_cross_lane_integration_sync_contract.py"
)
DEFAULT_D012_READINESS_RUNNER = ROOT / "scripts" / "run_m249_d012_lane_d_readiness.py"
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m249_d013_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D013-DOC-PKT-01",
        "# M249-D013 Installer/Runtime Operations and Support Tooling Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M249-D013-DOC-PKT-02", "Packet: `M249-D013`"),
    SnippetCheck("M249-D013-DOC-PKT-03", "Dependencies: `M249-D012`"),
    SnippetCheck(
        "M249-D013-DOC-PKT-04",
        "scripts/check_m249_d012_installer_runtime_operations_and_support_tooling_cross_lane_integration_sync_contract.py",
    ),
    SnippetCheck(
        "M249-D013-DOC-PKT-05",
        "scripts/run_m249_d013_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M249-D013-DOC-PKT-06",
        "python scripts/run_m249_d012_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M249-D013-DOC-PKT-07",
        "python scripts/run_m249_d013_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M249-D013-DOC-PKT-08",
        "code/spec anchors and milestone",
    ),
    SnippetCheck(
        "M249-D013-DOC-PKT-09",
...
D012_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D013-D012-DOC-01",
        "Contract ID: `objc3c-installer-runtime-operations-support-tooling-cross-lane-integration-sync/m249-d012-v1`",
    ),
    SnippetCheck(
        "M249-D013-D012-DOC-02",
        "Dependencies: `M249-D011`",
    ),
)

D012_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-D013-D012-PKT-01", "Packet: `M249-D012`"),
    SnippetCheck("M249-D013-D012-PKT-02", "Dependencies: `M249-D011`"),
)

READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-D013-RUN-01", '"""Run M249-D013 lane-D readiness checks without deep npm nesting."""'),
    SnippetCheck("M249-D013-RUN-02", "scripts/run_m249_d012_lane_d_readiness.py"),
    SnippetCheck(
        "M249-D013-RUN-03",
    ...
    SnippetCheck("M249-D013-RUN-05", "[ok] M249-D013 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-D013-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M249-D013-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M249-D013-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M249-D013-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-D013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-D013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d012_expectations_doc, "M249-D013-D012-DOC-EXISTS", D012_EXPECTATIONS_SNIPPETS),
        (args.d012_packet_doc, "M249-D013-D012-PKT-EXISTS", D012_PACKET_SNIPPETS),
        (args.readiness_runner, "M249-D013-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-D013-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-D013-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-D013-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-D013-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d012_checker, "M249-D013-DEP-D012-ARG-01"),
        (args.d012_test, "M249-D013-DEP-D012-ARG-02"),
        (args.d012_readiness_runner, "M249-D013-DEP-D012-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
