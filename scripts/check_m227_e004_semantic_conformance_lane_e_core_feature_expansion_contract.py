#!/usr/bin/env python3
"""Fail-closed validator for M227-E004 semantic conformance lane-E core feature expansion."""
...
MODE = "m227-e004-semantic-conformance-lane-e-core-feature-expansion-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_lane_e_semantic_conformance_core_feature_expansion_e004_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_e004_semantic_conformance_lane_e_core_feature_expansion_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-E004-E003-01",
        "M227-E003",
        Path("docs/contracts/m227_lane_e_semantic_conformance_core_feature_implementation_e003_expectations.md"),
    ),
    AssetCheck(
        "M227-E004-E003-02",
        "M227-E003",
        Path("scripts/check_m227_e003_semantic_conformance_quality_gate_core_feature_contract.py"),
    ),
    AssetCheck(
        "M227-E004-E003-03",
        "M227-E003",
        Path("tests/tooling/test_check_m227_e003_semantic_conformance_quality_gate_core_feature_contract.py"),
    ),
    AssetCheck(
        "M227-E004-E003-04",
        "M227-E003",
        Path("spec/planning/compiler/m227/m227_e003_semantic_conformance_lane_e_core_feature_packet.md"),
    ),
    AssetCheck(
        "M227-E004-A004-01",
        "M227-A004",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E004-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-E004-EXP-08",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E004-PKT-04", "Packet: `M227-E004`"),
    SnippetCheck("M227-E004-PKT-05", "Issue: `#5162`"),
    SnippetCheck("M227-E004-PKT-06", "Scaffold date: `2026-03-03`"),
    SnippetCheck(
        "M227-E004-PKT-07",
        "Dependencies: `M227-E003`, `M227-A004`, `M227-B004`, `M227-C004`, `M227-D004`",
    ),
    SnippetCheck("M227-E004-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-E004-PKT-09",
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-E003": "scripts/check_m227_e003_semantic_conformance_quality_gate_core_feature_contract.py",
...
def run(argv: Sequence[str]) -> int:
    ...
    try:
        ...
        check(
            ...
            check_id="M227-E004-EXP-01",
            condition=True,
            detail="",
        )
        check(
            artifact="expectations_doc",
            check_id="M227-E004-EXP-02",
            condition=True,
            detail="",
        )
    ...
    try:
        ...
        check(
            artifact="packet_doc",
            check_id="M227-E004-PKT-01",
            condition=True,
            detail="",
        )
        check(
            artifact="packet_doc",
            check_id="M227-E004-PKT-02",
            condition=True,
            detail="",
        )
    except ValueError as exc:
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-E004-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if findings:
        print(
            "m227-e004-semantic-conformance-lane-e-core-feature-expansion: "
    ...
    print("m227-e004-semantic-conformance-lane-e-core-feature-expansion: OK")
    print(f"- mode={MODE}")
