#!/usr/bin/env python3
"""Fail-closed checker for M246-C025 IR optimization pass wiring release/replay dry-run."""
...
MODE = "m246-c025-ir-optimization-pass-wiring-validation-advanced-integration-workpack-shard-2-contract-v1"
...
DEFAULT_C024_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c024_lane_c_readiness.py"
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_c025_lane_c_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-C025-DOC-EXP-10",
        "improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M246-C025-DOC-EXP-11",
        "tmp/reports/m246/M246-C025/ir_optimization_pass_wiring_validation_advanced_integration_workpack_shard_2_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C025-DOC-PKT-01",
        "# M246-C025 IR Optimization Pass Wiring and Validation Advanced Integration Workpack (Shard 2) Packet",
    ),
    SnippetCheck("M246-C025-DOC-PKT-02", "Packet: `M246-C025`"),
    SnippetCheck("M246-C025-DOC-PKT-03", "Issue: `#5101`"),
    SnippetCheck("M246-C025-DOC-PKT-04", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-C025-DOC-PKT-05", "Dependencies: `M246-C024`"),
    SnippetCheck(
        "M246-C025-DOC-PKT-06",
        "Predecessor anchors inherited via `M246-C024`: `M246-C001`, `M246-C002`, `M246-C003`, `M246-C004`, `M246-C005`, `M246-C006`, `M246-C007`, `M246-C008`, `M246-C009`, `M246-C010`, `M246-C011`, `M246-C012`.",
    ),
    SnippetCheck(
        "M246-C025-DOC-PKT-07",
        "scripts/check_m246_c025_ir_optimization_pass_wiring_and_validation_advanced_integration_workpack_shard_2_contract.py",
    ),
    SnippetCheck(
        "M246-C025-DOC-PKT-08",
        "tests/tooling/test_check_m246_c025_ir_optimization_pass_wiring_and_validation_advanced_integration_workpack_shard_2_contract.py",
    ),
    SnippetCheck(
        "M246-C025-DOC-PKT-09",
        "scripts/run_m246_c025_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C025-DOC-PKT-10",
        "scripts/run_m246_c024_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C025-DOC-PKT-11",
        "treated as mandatory scope",
    ),
    SnippetCheck(
        "M246-C025-DOC-PKT-12",
        "tmp/reports/m246/M246-C025/ir_optimization_pass_wiring_validation_advanced_integration_workpack_shard_2_summary.json",
    ),
)
...
C001_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C025-C001-02", "Dependencies: none"),
)
...
C024_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C025-C024-EXP-01",
        "Contract ID: `objc3c-ir-optimization-pass-wiring-validation-advanced-conformance-workpack-shard-2/m246-c024-v1`",
    ),
    SnippetCheck(
        "M246-C025-C024-EXP-02",
        "Dependencies: `M246-C023`",
    ),
    SnippetCheck(
        "M246-C025-C024-EXP-03",
        "scripts/run_m246_c023_lane_c_readiness.py",
    ),
)

C024_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-C025-C024-PKT-01", "Packet: `M246-C024`"),
    SnippetCheck("M246-C025-C024-PKT-02", "Dependencies: `M246-C023`"),
    SnippetCheck("M246-C025-C024-PKT-03", "scripts/run_m246_c023_lane_c_readiness.py"),
)

C024_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-C025-C024-RUN-01",
        "scripts/run_m246_c023_lane_c_readiness.py",
    ),
    SnippetCheck(
        "M246-C025-C024-RUN-02",
        "scripts/check_m246_c024_ir_optimization_pass_wiring_and_validation_advanced_conformance_workpack_shard_2_contract.py",
    ),
    SnippetCheck(
        "M246-C025-C024-RUN-03",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M246-C025-PKG-02", '"compile:objc3c": '),
    SnippetCheck("M246-C025-PKG-03", '"proof:objc3c": '),
    SnippetCheck("M246-C025-PKG-04", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-C025-PKG-05", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c024-expectations-doc", type=Path, default=DEFAULT_C024_EXPECTATIONS_DOC)
    parser.add_argument("--c024-packet-doc", type=Path, default=DEFAULT_C024_PACKET_DOC)
    parser.add_argument("--c024-readiness-script", type=Path, default=DEFAULT_C024_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-C025-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-C025-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M246-C025-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M246-C025-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.c024_expectations_doc, "M246-C025-C024-EXP-EXISTS", C024_EXPECTATIONS_SNIPPETS),
        (args.c024_packet_doc, "M246-C025-C024-PKT-EXISTS", C024_PACKET_SNIPPETS),
        (args.c024_readiness_script, "M246-C025-C024-RUN-EXISTS", C024_READINESS_SNIPPETS),
        (args.readiness_script, "M246-C025-RUN-EXISTS", READINESS_SNIPPETS),
        (args.package_json, "M246-C025-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
