#!/usr/bin/env python3
"""Run the focused M261-B003 lane-B readiness chain."""
...
def main() -> int:
    ...
    run([
        ...
        "-m",
        "pytest",
        "tests/tooling/test_check_m261_b003_byref_mutation_copy_dispose_eligibility_and_object_capture_ownership_core_feature_expansion.py",
        "-q",
    ])
    return 0
