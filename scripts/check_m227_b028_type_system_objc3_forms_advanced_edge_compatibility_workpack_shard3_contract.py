#!/usr/bin/env python3
"""Fail-closed validator for M227-B028 ObjC3 type-form advanced edge compatibility workpack (shard 3) contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "b027_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m227_b027_type_system_objc3_forms_advanced_core_workpack_shard3_contract.py",
    "b027_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m227"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "contract_doc": (
        ...
        ("M227-B028-DOC-02", "Execute issue `#4869`"),
        ("M227-B028-DOC-03", "Dependencies: `M227-B027`"),
        (
            "M227-B028-DOC-04",
            "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
        ),
        ("M227-B028-DOC-05", "`docs/runbooks/m227_wave_execution_runbook.md`"),
        (
            "M227-B028-DOC-06",
        ...
        ("M227-B028-DOC-08", "`npm run check:objc3c:m227-b028-lane-b-readiness`"),
        (
            "M227-B028-DOC-09",
    ...
    "runbook_doc": (
        ...
        ("M227-B028-RUN-06", "npm run check:objc3c:m227-b028-lane-b-readiness"),
        ("M227-B028-RUN-07", "tmp/reports/m227/"),
    ),
    "planning_packet": (
        ("M227-B028-PKT-01", "Packet: `M227-B028`"),
        ("M227-B028-PKT-02", "Issue: `#4869`"),
        ("M227-B028-PKT-03", "Dependencies: `M227-B027`"),
        ("M227-B028-PKT-04", "docs/runbooks/m227_wave_execution_runbook.md"),
        (
            "M227-B028-PKT-05",
            "scripts/check_m227_b028_type_system_objc3_forms_advanced_edge_compatibility_workpack_shard3_contract.py",
        ),
        ...
        ("M227-B028-PKT-07", "check:objc3c:m227-b028-lane-b-readiness"),
        (
            "M227-B028-PKT-08",
            "tmp/reports/m227/M227-B028/type_system_objc3_forms_advanced_edge_compatibility_workpack_shard3_contract_summary.json",
        ),
    ...
    "b027_tooling_test": (
        ("M227-B028-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "b027_packet_doc": (
        ("M227-B028-DEP-04", "Packet: `M227-B027`"),
        ("M227-B028-DEP-05", "Issue: `#4868`"),
    ),
    "package_json": (
        ("M227-B028-PKG-01", '"check:objc3c:m227-b027-lane-b-readiness"'),
        (
            "M227-B028-PKG-02",
        ...
        ("M227-B028-PKG-04", '"check:objc3c:m227-b028-lane-b-readiness"'),
        (
            "M227-B028-PKG-05",
        ...
        (
            "M227-B028-PKG-07",
            "tests/tooling/test_check_m227_b028_type_system_objc3_forms_advanced_edge_compatibility_workpack_shard3_contract.py -q",
        ),
        ("M227-B028-PKG-08", '"compile:objc3c"'),
        ("M227-B028-PKG-09", '"proof:objc3c"'),
        ("M227-B028-PKG-10", '"test:objc3c:execution-replay-proof"'),
        ("M227-B028-PKG-11", '"test:objc3c:perf-budget"'),
    ),
    "architecture_doc": (
        (
            "M227-B028-ARC-01",
    ...
    "lowering_spec": (
        (
            "M227-B028-SPC-01",
            "type-system advanced edge compatibility workpack (shard 3) governance shall preserve explicit lane-B dependency anchors (`M227-B028`, `M227-B027`)",
        ),
    ),
    "metadata_spec": (
        (
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M227-B028-FORB-01",
            '"check:objc3c:m227-b028-lane-b-readiness": "npm run check:objc3c:m227-b021-lane-b-readiness',
        ),
    ),
}
