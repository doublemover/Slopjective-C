...
function Get-CoreRecoveryFoundationCaseDefinitions {
  return @(
    ...
    @{
      ...
      CaseName = "objc3_dispatch_surface_canonical_symbol_argslots"
      RequireLl = $true
      ExtraArgs = @("--objc3-max-message-args", "6")
      RequiredLlTokens = @("declare i32 @objc3_runtime_dispatch_i32(i32, ptr, i32, i32, i32, i32, i32, i32)", "call i32 @objc3_runtime_dispatch_i32(", "define i32 @objc3c_entry")
      RequiredManifestTokens = @('"runtime_dispatch_symbol":"objc3_runtime_dispatch_i32"', '"runtime_dispatch_arg_slots":6', '"selector_global_ordering":"lexicographic"')
      RequireObjc3ManifestSurface = $true
    }
  )
}
