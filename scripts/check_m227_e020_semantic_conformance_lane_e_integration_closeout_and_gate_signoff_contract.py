#!/usr/bin/env python3
"""Fail-closed validator for M227-E020 semantic conformance lane-E integration closeout and gate sign-off."""
...
MODE = "m227-e020-semantic-conformance-lane-e-integration-closeout-and-gate-signoff-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_lane_e_semantic_conformance_integration_closeout_and_gate_signoff_e020_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_e020_semantic_conformance_lane_e_integration_closeout_and_gate_signoff_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-E020-E007-01",
        "M227-E019",
        Path("docs/contracts/m227_lane_e_semantic_conformance_advanced_integration_workpack_shard1_e019_expectations.md"),
    ),
    AssetCheck(
        "M227-E020-E007-02",
        "M227-E019",
        Path("scripts/check_m227_e019_semantic_conformance_lane_e_advanced_integration_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E020-E007-03",
        "M227-E019",
        Path("tests/tooling/test_check_m227_e019_semantic_conformance_lane_e_advanced_integration_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E020-E007-04",
        "M227-E019",
        Path("spec/planning/compiler/m227/m227_e019_semantic_conformance_lane_e_advanced_integration_workpack_shard1_packet.md"),
    ),
    AssetCheck(
        "M227-E020-A008-01",
        "M227-A021",
        Path("docs/contracts/m227_semantic_pass_integration_closeout_and_gate_signoff_expectations.md"),
    ),
    AssetCheck(
        "M227-E020-A008-02",
        "M227-A021",
        Path("scripts/check_m227_a021_semantic_pass_integration_closeout_and_gate_signoff_contract.py"),
    ),
    AssetCheck(
        "M227-E020-A008-03",
        "M227-A021",
        Path("tests/tooling/test_check_m227_a021_semantic_pass_integration_closeout_and_gate_signoff_contract.py"),
    ),
    AssetCheck(
        "M227-E020-A008-04",
        "M227-A021",
        Path("spec/planning/compiler/m227/m227_a021_semantic_pass_integration_closeout_and_gate_signoff_packet.md"),
    ),
    AssetCheck(
        "M227-E020-B008-01",
        "M227-B039",
        Path("docs/contracts/m227_type_system_objc3_forms_integration_closeout_and_gate_signoff_b039_expectations.md"),
    ),
    AssetCheck(
        "M227-E020-B008-02",
        "M227-B039",
        Path("scripts/check_m227_b039_type_system_objc3_forms_integration_closeout_and_gate_signoff_contract.py"),
    ),
    AssetCheck(
        "M227-E020-B008-03",
        "M227-B039",
        Path("tests/tooling/test_check_m227_b039_type_system_objc3_forms_integration_closeout_and_gate_signoff_contract.py"),
    ),
    AssetCheck(
        "M227-E020-B008-04",
        "M227-B039",
        Path("spec/planning/compiler/m227/m227_b039_type_system_objc3_forms_integration_closeout_and_gate_signoff_packet.md"),
    ),
    AssetCheck(
        "M227-E020-C008-01",
        "M227-C026",
        Path("docs/contracts/m227_typed_sema_to_lowering_integration_closeout_and_gate_signoff_c026_expectations.md"),
    ),
    AssetCheck(
        "M227-E020-C008-02",
        "M227-C026",
        Path("scripts/check_m227_c026_typed_sema_to_lowering_integration_closeout_and_gate_signoff_contract.py"),
    ),
    AssetCheck(
        "M227-E020-C008-03",
        "M227-C026",
        Path("tests/tooling/test_check_m227_c026_typed_sema_to_lowering_integration_closeout_and_gate_signoff_contract.py"),
    ),
    AssetCheck(
        "M227-E020-C008-04",
        "M227-C026",
        Path("spec/planning/compiler/m227/m227_c026_typed_sema_to_lowering_integration_closeout_and_gate_signoff_packet.md"),
    ),
    AssetCheck(
        "M227-E020-D008-01",
        "M227-D012",
        Path("docs/contracts/m227_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_d012_expectations.md"),
    ),
    AssetCheck(
        "M227-E020-D008-02",
        "M227-D012",
        Path("scripts/check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py"),
    ),
    AssetCheck(
        "M227-E020-D008-03",
        "M227-D012",
        Path("tests/tooling/test_check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py"),
    ),
    AssetCheck(
        "M227-E020-D008-04",
        "M227-D012",
        Path("spec/planning/compiler/m227/m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_packet.md"),
    ),
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E020-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-E020-EXP-08",
        "checker `scripts/check_m227_e019_semantic_conformance_lane_e_advanced_integration_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M227-E020-EXP-09",
        "checker `scripts/check_m227_a021_semantic_pass_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M227-E020-EXP-10",
        "checker `scripts/check_m227_b039_type_system_objc3_forms_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M227-E020-EXP-11",
        "checker `scripts/check_m227_c026_typed_sema_to_lowering_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M227-E020-EXP-12",
        "checker `scripts/check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py`",
    ),
    SnippetCheck(
        "M227-E020-EXP-13",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E020-PKT-04", "Packet: `M227-E020`"),
    SnippetCheck("M227-E020-PKT-05", "Issue: `#5178`"),
    SnippetCheck("M227-E020-PKT-06", "Scaffold date: `2026-03-05`"),
    SnippetCheck(
        "M227-E020-PKT-07",
        "Dependencies: `M227-E019`, `M227-A021`, `M227-B039`, `M227-C026`, `M227-D012`",
    ),
    SnippetCheck("M227-E020-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-E020-PKT-09",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-E020-ARCH-01",
        "M227 lane-E E020 semantic conformance integration closeout and gate sign-off anchors dependency references",
    ),
    SnippetCheck(
        "M227-E020-ARCH-02",
        "(`M227-E019`, `M227-A021`, `M227-B039`, `M227-C026`, and `M227-D012`)",
    ),
    SnippetCheck(
        "M227-E020-ARCH-03",
        "check:objc3c:m227-e020-lane-e-readiness",
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E020-SPC-03",
        "lane-E integration closeout and gate sign-off evidence drift.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E020-META-03",
        "semantic conformance lane-E integration closeout and gate sign-off metadata governance drift fails closed.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-E020-CFG-03", "check:objc3c:m227-e020-lane-e-readiness"),
    PackageScriptKeyCheck("M227-E020-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M227-E020-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M227-E020-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-E020-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        "M227-E020-CFG-06",
        "check:objc3c:m227-e020-lane-e-readiness",
        "python scripts/check_m227_e019_semantic_conformance_lane_e_advanced_integration_workpack_shard1_contract.py && python -m pytest tests/tooling/test_check_m227_e019_semantic_conformance_lane_e_advanced_integration_workpack_shard1_contract.py -q && python scripts/check_m227_a021_semantic_pass_integration_closeout_and_gate_signoff_contract.py && python -m pytest tests/tooling/test_check_m227_a021_semantic_pass_integration_closeout_and_gate_signoff_contract.py -q && npm run check:objc3c:m227-b039-lane-b-readiness && npm run check:objc3c:m227-c026-lane-c-readiness && python scripts/check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py && python -m pytest tests/tooling/test_check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py -q && npm run check:objc3c:m227-e020-semantic-conformance-lane-e-integration-closeout-and-gate-signoff-contract && npm run test:tooling:m227-e020-semantic-conformance-lane-e-integration-closeout-and-gate-signoff-contract",
    ),
)
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-E019": "scripts/check_m227_e019_semantic_conformance_lane_e_advanced_integration_workpack_shard1_contract.py",
    "M227-A021": "scripts/check_m227_a021_semantic_pass_integration_closeout_and_gate_signoff_contract.py",
    "M227-B039": "scripts/check_m227_b039_type_system_objc3_forms_integration_closeout_and_gate_signoff_contract.py",
    "M227-C026": "scripts/check_m227_c026_typed_sema_to_lowering_integration_closeout_and_gate_signoff_contract.py",
    "M227-D012": "scripts/check_m227_d012_runtime_facing_type_metadata_integration_closeout_and_gate_signoff_contract.py",
}
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_text = check_document(
        ...
        exists_check_id="M227-E020-EXP-01",
        utf8_check_id="M227-E020-EXP-02",
        snippets=EXPECTATIONS_SNIPPETS,
    )
    packet_text = check_document(
        path=args.packet_doc,
        artifact="packet_doc",
        exists_check_id="M227-E020-PKT-01",
        utf8_check_id="M227-E020-PKT-02",
        snippets=PACKET_SNIPPETS,
    )
    check_document(
        path=args.architecture_doc,
        artifact="architecture_doc",
        exists_check_id="M227-E020-ARCH-00",
        utf8_check_id="M227-E020-ARCH-UTF8",
        snippets=ARCHITECTURE_SNIPPETS,
    )
    check_document(
        path=args.lowering_spec,
        artifact="lowering_spec",
        exists_check_id="M227-E020-SPC-00",
        utf8_check_id="M227-E020-SPC-UTF8",
        snippets=LOWERING_SPEC_SNIPPETS,
    )
    check_document(
        path=args.metadata_spec,
        artifact="metadata_spec",
        exists_check_id="M227-E020-META-00",
        utf8_check_id="M227-E020-META-UTF8",
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-E020-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if isinstance(package_payload, dict):
        ...
        check(
            artifact="package_json",
            check_id="M227-E020-CFG-SCRIPTS",
    ...
    if findings:
        if not args.emit_json:
            print(
                "m227-e020-semantic-conformance-lane-e-integration-closeout-and-gate-signoff: "
    ...
    if not args.emit_json:
        print("m227-e020-semantic-conformance-lane-e-integration-closeout-and-gate-signoff: OK")
        print(f"- mode={MODE}")
