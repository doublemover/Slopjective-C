#!/usr/bin/env python3
"""Fail-closed checker for M237-E001 block conformance and replay gate contract freeze."""
...
DEFAULT_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m237_block_conformance_and_replay_gate_contract_and_architecture_freeze_e001_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m237"
    / "m237_e001_block_conformance_and_replay_gate_contract_and_architecture_freeze_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m237/M237-E001/local_check_summary.json")
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M237-E001-DOC-EXP-05",
        "currently-closed early lane steps",
    ),
    SnippetCheck("M237-E001-DOC-EXP-06", "| `M237-A001` |"),
    SnippetCheck("M237-E001-DOC-EXP-07", "| `M237-B001` |"),
    SnippetCheck("M237-E001-DOC-EXP-08", "| `M237-C001` |"),
    SnippetCheck(
        "M237-E001-DOC-EXP-09",
        "scripts/check_m237_e001_block_conformance_and_replay_gate_contract.py",
    ),
    SnippetCheck(
        "M237-E001-DOC-EXP-10",
        "tests/tooling/test_check_m237_e001_block_conformance_and_replay_gate_contract.py",
    ),
    SnippetCheck(
        "M237-E001-DOC-EXP-11",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M237-E001-DOC-PKT-05",
        "currently-closed early lane steps",
    ),
    SnippetCheck(
        "M237-E001-DOC-PKT-06",
        "docs/contracts/m237_block_conformance_and_replay_gate_contract_and_architecture_freeze_e001_expectations.md",
    ),
    SnippetCheck(
        "M237-E001-DOC-PKT-07",
        "scripts/check_m237_e001_block_conformance_and_replay_gate_contract.py",
    ),
    SnippetCheck(
        "M237-E001-DOC-PKT-08",
        "tests/tooling/test_check_m237_e001_block_conformance_and_replay_gate_contract.py",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M237-E001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M237-E001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
