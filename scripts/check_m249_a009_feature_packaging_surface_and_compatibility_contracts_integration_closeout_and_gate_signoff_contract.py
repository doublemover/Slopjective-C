#!/usr/bin/env python3
"""Fail-closed checker for M249-A009 feature packaging integration closeout and signoff."""
...
MODE = "m249-a009-feature-packaging-surface-compatibility-integration-closeout-and-gate-signoff-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_feature_packaging_surface_and_compatibility_contracts_integration_closeout_and_gate_signoff_a009_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_a009_feature_packaging_surface_and_compatibility_contracts_integration_closeout_and_gate_signoff_packet.md"
)
...
DEFAULT_A008_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m249_a008_feature_packaging_surface_and_compatibility_contracts_recovery_determinism_hardening_contract.py"
)
DEFAULT_RUNNER_SCRIPT = ROOT / "scripts" / "run_m249_a009_lane_a_readiness.py"
DEFAULT_ARCHITECTURE_DOC = ROOT / "native" / "objc3c" / "src" / "ARCHITECTURE.md"
DEFAULT_LOWERING_SPEC = ROOT / "spec" / "LOWERING_AND_RUNTIME_CONTRACTS.md"
DEFAULT_METADATA_SPEC = ROOT / "spec" / "MODULE_METADATA_AND_ABI_TABLES.md"
DEFAULT_PACKAGE_JSON = ROOT / "package.json"
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m249/M249-A009/"
    "feature_packaging_surface_and_compatibility_contracts_integration_closeout_and_gate_signoff_summary.json"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-A009-DOC-PKT-01",
        "# M249-A009 Feature Packaging Surface and Compatibility Contracts Integration Closeout and Gate Signoff Packet",
    ),
    SnippetCheck("M249-A009-DOC-PKT-02", "Packet: `M249-A009`"),
    SnippetCheck("M249-A009-DOC-PKT-03", "Issue: `#6904`"),
    SnippetCheck("M249-A009-DOC-PKT-04", "Dependencies: `M249-A008`"),
    SnippetCheck(
        "M249-A009-DOC-PKT-05",
        "integration closeout and gate signoff prerequisites",
    ),
    SnippetCheck(
        "M249-A009-DOC-PKT-06",
    ...
    SnippetCheck(
        "M249-A009-DOC-PKT-08",
        "scripts/run_m249_a009_lane_a_readiness.py",
    ),
    SnippetCheck("M249-A009-DOC-PKT-09", "`npm run check:objc3c:m249-a009-lane-a-readiness`"),
    SnippetCheck("M249-A009-DOC-PKT-10", "`check:objc3c:m249-a008-lane-a-readiness`"),
)

A008_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-A009-A008-DOC-01",
        "# M249 Feature Packaging Surface and Compatibility Contracts Recovery and Determinism Hardening Expectations (A008)",
    ),
    SnippetCheck(
        "M249-A009-A008-DOC-02",
        "Contract ID: `objc3c-feature-packaging-surface-compatibility-contracts-recovery-determinism-hardening/m249-a008-v1`",
    ),
    SnippetCheck("M249-A009-A008-DOC-03", "Dependencies: `M249-A007`"),
)

A008_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-A009-A008-PKT-01", "Packet: `M249-A008`"),
    SnippetCheck("M249-A009-A008-PKT-02", "Dependencies: `M249-A007`"),
    SnippetCheck("M249-A009-A008-PKT-03", "scripts/run_m249_a008_lane_a_readiness.py"),
)
...
RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-A009-RUN-04",
        "M249-A009 lane-A readiness chain completed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-A009-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M249-A009-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-A009-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-A009-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a008_expectations_doc, "M249-A009-A008-DOC-EXISTS", A008_EXPECTATIONS_SNIPPETS),
        (args.a008_packet_doc, "M249-A009-A008-PKT-EXISTS", A008_PACKET_SNIPPETS),
        (args.runner_script, "M249-A009-RUN-EXISTS", RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-A009-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-A009-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-A009-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-A009-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a008_checker, "M249-A009-DEP-A008-ARG-01"),
        (args.a008_test, "M249-A009-DEP-A008-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
