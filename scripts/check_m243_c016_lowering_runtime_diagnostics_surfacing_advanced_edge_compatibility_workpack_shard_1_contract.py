#!/usr/bin/env python3
"""Fail-closed checker for M243-C016 lowering/runtime diagnostics surfacing advanced edge compatibility workpack (shard 1)."""
...
MODE = (
    "m243-c016-lowering-runtime-diagnostics-surfacing-"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "tests"
    / "tooling"
    / "test_check_m243_c015_lowering_runtime_diagnostics_surfacing_advanced_core_workpack_shard_1_contract.py",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "expectations_doc": (
        ...
        ("M243-C016-DOC-02", "- Dependencies: `M243-C015`"),
        ("M243-C016-DOC-03", "advanced_edge_compatibility_workpack_shard_1_consistent"),
        ("M243-C016-DOC-04", "advanced_edge_compatibility_workpack_shard_1_ready"),
        ("M243-C016-DOC-05", "advanced_edge_compatibility_workpack_shard_1_key_ready"),
        (
            "M243-C016-DOC-06",
        ...
        ("M243-C016-DOC-10", "npm run check:objc3c:m243-c016-lane-c-readiness"),
    ),
    "packet_doc": (
        ("M243-C016-PKT-01", "Packet: `M243-C016`"),
        ("M243-C016-PKT-02", "Dependencies: `M243-C015`"),
        (
            "M243-C016-PKT-03",
            "scripts/check_m243_c016_lowering_runtime_diagnostics_surfacing_advanced_edge_compatibility_workpack_shard_1_contract.py",
        ),
        ...
        ("M243-C016-PKT-05", "check:objc3c:m243-c016-lane-c-readiness"),
        (
            "M243-C016-PKT-06",
            "python scripts/check_m243_c016_lowering_runtime_diagnostics_surfacing_advanced_edge_compatibility_workpack_shard_1_contract.py --emit-json",
        ),
    ...
    "c015_packet_doc": (
        ("M243-C016-DEP-02", "Packet: `M243-C015`"),
        ("M243-C016-DEP-03", "Dependencies: `M243-C014`"),
    ),
    "c015_checker": (
        (
            "M243-C016-DEP-04",
    ...
    "lowering_spec": (
        ...
        ("M243-C016-SPC-02", "lane-C dependency anchors (`M243-C015`)"),
    ),
    "metadata_spec": (
        (
            "M243-C016-META-01",
        ...
        ("M243-C016-META-02", "`M243-C015` dependency continuity"),
    ),
    "package_json": (
        (
            "M243-C016-PKG-01",
        ...
        ("M243-C016-PKG-03", '"check:objc3c:m243-c016-lane-c-readiness"'),
        (
            "M243-C016-PKG-04",
            "npm run check:objc3c:m243-c015-lane-c-readiness && npm run check:objc3c:m243-c016-lowering-runtime-diagnostics-surfacing-advanced-edge-compatibility-workpack-shard-1-contract && npm run test:tooling:m243-c016-lowering-runtime-diagnostics-surfacing-advanced-edge-compatibility-workpack-shard-1-contract",
        ),
    ),
}
