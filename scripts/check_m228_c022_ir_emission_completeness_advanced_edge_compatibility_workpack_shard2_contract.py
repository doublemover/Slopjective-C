#!/usr/bin/env python3
"""Fail-closed validator for M228-C022 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c021_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c021_ir_emission_completeness_advanced_core_workpack_shard2_contract.py",
    "c021_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C022-RUN-04", "npm run check:objc3c:m228-c022-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C022-ARC-01",
    ...
    "package_json": (
        ("M228-C022-PKG-01", '"check:objc3c:m228-c021-lane-c-readiness"'),
        (
            "M228-C022-PKG-02",
            '"check:objc3c:m228-c022-ir-emission-completeness-advanced-edge-compatibility-workpack-shard2-contract"',
        ),
        (
            "M228-C022-PKG-03",
            '"test:tooling:m228-c022-ir-emission-completeness-advanced-edge-compatibility-workpack-shard2-contract"',
        ),
        ("M228-C022-PKG-04", '"check:objc3c:m228-c022-lane-c-readiness"'),
        (
            "M228-C022-PKG-05",
    ...
    "c021_tooling_test": (
        ("M228-C022-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c021_packet_doc": (
        ("M228-C022-DEP-04", "Packet: `M228-C021`"),
        ("M228-C022-DEP-05", "Issue: `#5247`"),
    ),
    "contract_doc": (
        (
            "M228-C022-DOC-01",
        ...
        ("M228-C022-DOC-02", "Execute issue `#5248`"),
        ("M228-C022-DOC-03", "Dependencies: `M228-C021`"),
        (
            "M228-C022-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C022-PKT-02", "Packet: `M228-C022`"),
        ("M228-C022-PKT-03", "Issue: `#5248`"),
        ("M228-C022-PKT-04", "Dependencies: `M228-C021`"),
        (
            "M228-C022-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C022-FORB-01",
            '"check:objc3c:m228-c022-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C022/"
            "ir_emission_completeness_advanced_edge_compatibility_workpack_shard2_contract_summary.json"
        ),
    )
