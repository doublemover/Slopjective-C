#!/usr/bin/env python3
"""Fail-closed contract checker for the M245-B003 semantic parity/platform constraints core feature packet."""
...
MODE = "m245-b003-semantic-parity-platform-constraints-core-feature-implementation-contract-v1"
...
DEFAULT_B002_CHECKER = (
    ROOT / "scripts" / "check_m245_b002_semantic_parity_and_platform_constraints_modular_split_scaffolding_contract.py"
)
DEFAULT_B002_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m245_b002_semantic_parity_and_platform_constraints_modular_split_scaffolding_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B003-DOC-PKT-01",
        "# M245-B003 Semantic Parity and Platform Constraints Core Feature Implementation Packet",
    ),
    SnippetCheck("M245-B003-DOC-PKT-02", "Packet: `M245-B003`"),
    SnippetCheck("M245-B003-DOC-PKT-03", "Dependencies: `M245-B002`"),
    SnippetCheck(
        "M245-B003-DOC-PKT-04",
        "`scripts/check_m245_b003_semantic_parity_and_platform_constraints_core_feature_implementation_contract.py`",
    ),
    SnippetCheck(
        "M245-B003-DOC-PKT-05",
        "`check:objc3c:m245-b003-lane-b-readiness`",
    ),
    SnippetCheck(
        "M245-B003-DOC-PKT-06",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M245-B003-DOC-PKT-07",
        "architecture/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M245-B003-DOC-PKT-08",
        "improvements as mandatory scope inputs.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-B003-SPC-02",
        "lane-B dependency anchors (`M245-B002`) and fail closed on core-feature evidence drift",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m245-b003-semantic-parity-platform-constraints-core-feature-implementation-contract '
        '&& npm run test:tooling:m245-b003-semantic-parity-platform-constraints-core-feature-implementation-contract"',
    ),
    SnippetCheck("M245-B003-PKG-04", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M245-B003-PKG-05", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-B003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-B003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b002_expectations_doc, "M245-B003-B002-DOC-EXISTS", B002_EXPECTATIONS_SNIPPETS),
        (args.b002_packet_doc, "M245-B003-B002-PKT-EXISTS", B002_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-B003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-B003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-B003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-B003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b002_checker, "M245-B003-DEP-B002-ARG-01"),
        (args.b002_test, "M245-B003-DEP-B002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
