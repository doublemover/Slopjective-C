#!/usr/bin/env python3
"""Fail-closed contract checker for the M249-C001 IR/object packaging freeze."""
...
MODE = "m249-c001-ir-object-packaging-symbol-policy-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m249"
    / "m249_c001_ir_object_packaging_and_symbol_policy_contract_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-C001-DOC-PKT-01",
        "# M249-C001 IR/Object Packaging and Symbol Policy Contract Freeze Packet",
    ),
    SnippetCheck("M249-C001-DOC-PKT-02", "Packet: `M249-C001`"),
    SnippetCheck("M249-C001-DOC-PKT-03", "Dependencies: none"),
    SnippetCheck(
        "M249-C001-DOC-PKT-04",
        "`check:objc3c:m249-c001-ir-object-packaging-symbol-policy-contract`",
    ),
    SnippetCheck(
        "M249-C001-DOC-PKT-05",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-C001-PKG-03",
        '"check:objc3c:m249-c001-lane-c-readiness": '
        '"npm run check:objc3c:m249-c001-ir-object-packaging-symbol-policy-contract '
        '&& npm run test:tooling:m249-c001-ir-object-packaging-symbol-policy-contract"',
    ),
    SnippetCheck("M249-C001-PKG-04", '"test:objc3c:lowering-replay-proof": '),
    SnippetCheck("M249-C001-PKG-05", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-C001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-C001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M249-C001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-C001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-C001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-C001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
