#!/usr/bin/env python3
"""Fail-closed checker for M230-C018 Documentation generation as source-of-truth contract freeze."""
...
MODE = "m230-c018-documentation-generation-as-source-of-truth-integration-closeout-and-gate-sign-off-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m230"
    / "m230_c018_documentation_generation_as_source_of_truth_integration_closeout_and_gate_sign_off_packet.md"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-C018-DOC-EXP-01",
        "# M230 Documentation generation as source-of-truth Contract and Architecture Freeze Expectations (C017)",
    ),
    SnippetCheck(
        "M230-C018-DOC-EXP-02",
        "Contract ID: `objc3c-documentation-generation-as-source-of-truth/m230-c018-v1`",
    ),
    SnippetCheck("M230-C018-DOC-EXP-03", "Issue: `#5439`"),
    SnippetCheck("M230-C018-DOC-EXP-04", "Dependencies: `M230-C017`"),
    SnippetCheck(
        "M230-C018-DOC-EXP-05",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M230-C018-DOC-EXP-06",
        "`check:objc3c:m230-c018-lane-c-readiness`",
    ),
    SnippetCheck(
        "M230-C018-DOC-EXP-07",
        "`tmp/reports/m230/M230-C018/documentation_generation_as_source_of_truth_integration_closeout_and_gate_sign_off_summary.json`",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M230-C018-DOC-PKT-01",
        "# M230-C018 Documentation generation as source-of-truth Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M230-C018-DOC-PKT-02", "Packet: `M230-C018`"),
    SnippetCheck("M230-C018-DOC-PKT-03", "Issue: `#5439`"),
    SnippetCheck("M230-C018-DOC-PKT-04", "Dependencies: `M230-C017`"),
    SnippetCheck(
        "M230-C018-DOC-PKT-05",
        "check:objc3c:m230-c018-documentation-generation-as-source-of-truth-integration-closeout-and-gate-sign-off-contract",
    ),
    SnippetCheck(
        "M230-C018-DOC-PKT-06",
        "tmp/reports/m230/M230-C018/documentation_generation_as_source_of_truth_integration_closeout_and_gate_sign_off_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M230-C018-PKG-03",
        '"check:objc3c:m230-c018-lane-c-readiness": '
        '"npm run check:objc3c:m230-c017-lane-c-readiness && npm run check:objc3c:m230-c018-documentation-generation-as-source-of-truth-integration-closeout-and-gate-sign-off-contract '
        '&& npm run test:tooling:m230-c018-documentation-generation-as-source-of-truth-integration-closeout-and-gate-sign-off-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M230-C018-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M230-C018-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M230-C018-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M230-C018-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M230-C018-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M230-C018-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
