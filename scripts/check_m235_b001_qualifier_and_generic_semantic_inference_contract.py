#!/usr/bin/env python3
"""Fail-closed contract checker for M235-B001 qualifier/generic semantic inference."""
...
MODE = "m235-b001-qualifier-and-generic-semantic-inference-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-B001-DOC-PKT-01",
        "# M235-B001 Qualifier/Generic Semantic Inference Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M235-B001-DOC-PKT-02", "Packet: `M235-B001`"),
    SnippetCheck("M235-B001-DOC-PKT-03", "Issue: `#5781`"),
    SnippetCheck("M235-B001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M235-B001-DOC-PKT-05",
        "`check:objc3c:m235-b001-qualifier-and-generic-semantic-inference-contract`",
    ),
    SnippetCheck(
        "M235-B001-DOC-PKT-06",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-B001-ARCH-01",
        "M235 lane-B B001 qualifier/generic semantic inference anchors",
    ),
    SnippetCheck(
        "M235-B001-ARCH-02",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B001-PKG-03",
        '"check:objc3c:m235-b001-lane-b-readiness": '
        '"npm run check:objc3c:m235-b001-qualifier-and-generic-semantic-inference-contract '
        '&& npm run test:tooling:m235-b001-qualifier-and-generic-semantic-inference-contract"',
    ),
    SnippetCheck("M235-B001-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B001-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
