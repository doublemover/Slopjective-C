#!/usr/bin/env python3
"""Fail-closed contract checker for M243-B004 semantic diagnostic taxonomy core feature expansion."""
...
DEFAULT_B003_CHECKER = (
    ROOT / "scripts" / "check_m243_b003_semantic_diagnostic_taxonomy_and_fix_it_synthesis_core_feature_implementation_contract.py"
)
DEFAULT_B003_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m243_b003_semantic_diagnostic_taxonomy_and_fix_it_synthesis_core_feature_implementation_contract.py"
)
DEFAULT_FRONTEND_TYPES = ROOT / "native" / "objc3c" / "src" / "pipeline" / "objc3_frontend_types.h"
DEFAULT_EXPANSION_SURFACE_HEADER = (
    ROOT
    / "native"
    / "objc3c"
    / "src"
    / "pipeline"
    / "objc3_semantic_diagnostic_taxonomy_and_fix_it_synthesis_core_feature_expansion_surface.h"
)
...
B003_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M243-B004-B003-PKT-01", "Packet: `M243-B003`"),
    SnippetCheck("M243-B004-B003-PKT-02", "Dependencies: `M243-B002`"),
    SnippetCheck(
        "M243-B004-B003-PKT-03",
        "scripts/check_m243_b003_semantic_diagnostic_taxonomy_and_fix_it_synthesis_core_feature_implementation_contract.py",
    ),
)
...
FRONTEND_TYPES_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M243-B004-TYP-02", "bool core_feature_expansion_ready = false;"),
    SnippetCheck(
        "M243-B004-TYP-03",
...
EXPANSION_SURFACE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M243-B004-SUR-01",
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M243-B004-SPC-02",
        "lane-B dependency anchors (`M243-B003`) and fail closed on",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M243-B004-META-02",
        "`M243-B004` with explicit `M243-B003`",
    ),
    SnippetCheck(
        "M243-B004-META-03",
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m243-b004-semantic-diagnostic-taxonomy-and-fix-it-synthesis-core-feature-expansion-contract '
        '&& npm run test:tooling:m243-b004-semantic-diagnostic-taxonomy-and-fix-it-synthesis-core-feature-expansion-contract"',
    ),
    SnippetCheck("M243-B004-PKG-04", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M243-B004-PKG-05", '"test:objc3c:lowering-regression": '),
)

FORBIDDEN_EXPANSION_SURFACE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M243-B004-FORB-01", "surface.core_feature_expansion_ready = true;"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--expansion-surface-header", type=Path, default=DEFAULT_EXPANSION_SURFACE_HEADER)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets, forbidden in (
        (args.expectations_doc, "M243-B004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS, ()),
        (args.packet_doc, "M243-B004-DOC-PKT-EXISTS", PACKET_SNIPPETS, ()),
        (args.b003_expectations_doc, "M243-B004-B003-DOC-EXISTS", B003_EXPECTATIONS_SNIPPETS, ()),
        (args.b003_packet_doc, "M243-B004-B003-PKT-EXISTS", B003_PACKET_SNIPPETS, ()),
        (args.frontend_types, "M243-B004-TYP-EXISTS", FRONTEND_TYPES_SNIPPETS, ()),
        (
            args.expansion_surface_header,
            "M243-B004-SUR-EXISTS",
            EXPANSION_SURFACE_SNIPPETS,
            FORBIDDEN_EXPANSION_SURFACE_SNIPPETS,
        ),
        (args.frontend_pipeline_source, "M243-B004-PIP-EXISTS", FRONTEND_PIPELINE_SNIPPETS, ()),
        (args.architecture_doc, "M243-B004-ARCH-EXISTS", ARCHITECTURE_SNIPPETS, ()),
        (args.lowering_spec, "M243-B004-SPC-EXISTS", LOWERING_SPEC_SNIPPETS, ()),
        (args.metadata_spec, "M243-B004-META-EXISTS", METADATA_SPEC_SNIPPETS, ()),
        (args.package_json, "M243-B004-PKG-EXISTS", PACKAGE_SNIPPETS, ()),
    ):
    ...
    for path, check_id in (
        (args.b003_checker, "M243-B004-DEP-B003-ARG-01"),
        (args.b003_test, "M243-B004-DEP-B003-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
