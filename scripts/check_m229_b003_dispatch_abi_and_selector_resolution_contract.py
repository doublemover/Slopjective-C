#!/usr/bin/env python3
"""Fail-closed checker for M229-B003 dispatch ABI and selector resolution contract freeze."""
...
MODE = "m229-b003-dispatch-abi-and-selector-resolution-core-feature-implementation-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_b003_dispatch_abi_and_selector_resolution_core_feature_implementation_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-B003-DOC-PKT-01",
        "# M229-B003 Dispatch ABI and selector resolution Core Feature Implementation Packet",
    ),
    SnippetCheck("M229-B003-DOC-PKT-02", "Packet: `M229-B003`"),
    SnippetCheck("M229-B003-DOC-PKT-03", "Issue: `#5314`"),
    SnippetCheck("M229-B003-DOC-PKT-04", "Dependencies: `M229-B002`"),
    SnippetCheck(
        "M229-B003-DOC-PKT-05",
        "check:objc3c:m229-b003-dispatch-abi-and-selector-resolution-core-feature-implementation-contract",
    ),
    SnippetCheck(
        "M229-B003-DOC-PKT-06",
        "tmp/reports/m229/M229-B003/dispatch_abi_and_selector_resolution_core_feature_implementation_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-B003-PKG-03",
        '"check:objc3c:m229-b003-lane-b-readiness": '
        '"npm run check:objc3c:m229-b002-lane-b-readiness && npm run check:objc3c:m229-b003-dispatch-abi-and-selector-resolution-core-feature-implementation-contract '
        '&& npm run test:tooling:m229-b003-dispatch-abi-and-selector-resolution-core-feature-implementation-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-B003-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-B003-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-B003-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-B003-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-B003-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-B003-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
