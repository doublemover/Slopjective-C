#!/usr/bin/env python3
"""Fail-closed contract checker for M248-B013 semantic/lowering docs/runbook synchronization."""
...
MODE = "m248-b013-semantic-lowering-test-architecture-docs-operator-runbook-synchronization-contract-v1"
...
DEFAULT_B012_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m248_semantic_lowering_test_architecture_cross_lane_integration_sync_b012_expectations.md"
)
DEFAULT_B012_PACKET_DOC = (
    ...
    / "compiler"
    / "m248"
    / "m248_b012_semantic_lowering_test_architecture_cross_lane_integration_sync_packet.md"
)
...
DEFAULT_B012_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m248_b012_semantic_lowering_test_architecture_cross_lane_integration_sync_contract.py"
)
DEFAULT_ARCHITECTURE_DOC = ROOT / "native" / "objc3c" / "src" / "ARCHITECTURE.md"
DEFAULT_LOWERING_SPEC = ROOT / "spec" / "LOWERING_AND_RUNTIME_CONTRACTS.md"
DEFAULT_METADATA_SPEC = ROOT / "spec" / "MODULE_METADATA_AND_ABI_TABLES.md"
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-B013/"
    "semantic_lowering_test_architecture_docs_and_operator_runbook_synchronization_contract_summary.json"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B013-DOC-PKT-01",
        "# M248-B013 Semantic/Lowering Test Architecture Docs and Operator Runbook Synchronization Packet",
    ),
    SnippetCheck("M248-B013-DOC-PKT-02", "Packet: `M248-B013`"),
    SnippetCheck("M248-B013-DOC-PKT-03", "Issue: `#6813`"),
    SnippetCheck("M248-B013-DOC-PKT-04", "Dependencies: `M248-B012`"),
    SnippetCheck(
        "M248-B013-DOC-PKT-05",
        "`scripts/check_m248_b013_semantic_lowering_test_architecture_docs_and_operator_runbook_synchronization_contract.py`",
    ),
    SnippetCheck(
        "M248-B013-DOC-PKT-06",
    ...
    SnippetCheck(
        "M248-B013-DOC-PKT-07",
        "`scripts/check_m248_b012_semantic_lowering_test_architecture_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck(
        "M248-B013-DOC-PKT-08",
        "`check:objc3c:m248-b013-semantic-lowering-test-architecture-docs-operator-runbook-synchronization-contract`",
    ),
    SnippetCheck(
        "M248-B013-DOC-PKT-09",
        "`test:tooling:m248-b013-semantic-lowering-test-architecture-docs-operator-runbook-synchronization-contract`",
    ),
    SnippetCheck("M248-B013-DOC-PKT-10", "`check:objc3c:m248-b013-lane-b-readiness`"),
    SnippetCheck("M248-B013-DOC-PKT-11", "`check:objc3c:m248-b012-lane-b-readiness`"),
    SnippetCheck(
        "M248-B013-DOC-PKT-12",
        "python scripts/check_m248_b013_semantic_lowering_test_architecture_docs_and_operator_runbook_synchronization_contract.py --emit-json",
    ),
    SnippetCheck(
        "M248-B013-DOC-PKT-13",
        "improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M248-B013-DOC-PKT-14",
        "`tmp/reports/m248/M248-B013/semantic_lowering_test_architecture_docs_and_operator_runbook_synchronization_contract_summary.json`",
    ),
)
...
B012_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-B013-B012-DOC-01",
        "Contract ID: `objc3c-semantic-lowering-test-architecture-cross-lane-integration-sync/m248-b012-v1`",
    ),
    SnippetCheck("M248-B013-B012-DOC-02", "- Dependencies: `M248-B011`"),
    SnippetCheck(
        "M248-B013-B012-DOC-03",
        "scripts/check_m248_b012_semantic_lowering_test_architecture_cross_lane_integration_sync_contract.py",
    ),
)

B012_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-B013-B012-PKT-01", "Packet: `M248-B012`"),
    SnippetCheck("M248-B013-B012-PKT-02", "Issue: `#6812`"),
    SnippetCheck("M248-B013-B012-PKT-03", "Dependencies: `M248-B011`"),
    SnippetCheck(
        "M248-B013-B012-PKT-04",
        "`scripts/check_m248_b012_semantic_lowering_test_architecture_cross_lane_integration_sync_contract.py`",
    ),
    SnippetCheck("M248-B013-B012-PKT-05", "`check:objc3c:m248-b012-lane-b-readiness`"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M248-B013-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M248-B013-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b012_expectations_doc, "M248-B013-B012-DOC-EXISTS", B012_EXPECTATIONS_SNIPPETS),
        (args.b012_packet_doc, "M248-B013-B012-PKT-EXISTS", B012_PACKET_SNIPPETS),
        (args.architecture_doc, "M248-B013-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M248-B013-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M248-B013-META-EXISTS", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b012_checker, "M248-B013-DEP-B012-ARG-01"),
        (args.b012_test, "M248-B013-DEP-B012-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
