#!/usr/bin/env python3
"""Fail-closed checker for M228-E007 replay/performance closeout diagnostics hardening."""
...
MODE = "m228-e007-replay-proof-performance-closeout-gate-diagnostics-hardening-contract-v1"
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M228-E007-A007-01",
        "M228-A007",
        Path("docs/contracts/m228_lowering_pipeline_decomposition_pass_graph_diagnostics_hardening_a007_expectations.md"),
    ),
    AssetCheck(
        "M228-E007-B007-01",
        "M228-B007",
        Path("docs/contracts/m228_ownership_aware_lowering_behavior_diagnostics_hardening_b007_expectations.md"),
    ),
    AssetCheck(
        "M228-E007-D007-01",
        "M228-D007",
        Path("docs/contracts/m228_object_emission_link_path_reliability_diagnostics_hardening_d007_expectations.md"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M228-E007-DOC-EXP-01",
        "Contract ID: `objc3c-lane-e-replay-proof-performance-closeout-gate-diagnostics-hardening-contract/m228-e007-v1`",
    ),
    SnippetCheck("M228-E007-DOC-EXP-02", "`M228-E006`"),
    SnippetCheck("M228-E007-DOC-EXP-03", "`M228-A007`"),
    SnippetCheck("M228-E007-DOC-EXP-04", "`M228-B007`"),
    SnippetCheck("M228-E007-DOC-EXP-05", "`M228-D007`"),
    SnippetCheck("M228-E007-DOC-EXP-06", "Issue `#5287` dependency list includes pending-lane token `M228-C007`."),
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M228-E007-DOC-PKT-01", "Packet: `M228-E007`"),
    SnippetCheck(
        "M228-E007-DOC-PKT-02",
        "Dependencies: `M228-E006`, `M228-A007`, `M228-B007`, `M228-D007`",
    ),
    SnippetCheck("M228-E007-DOC-PKT-03", "Issue dependency continuity tokens:"),
    SnippetCheck("M228-E007-DOC-PKT-04", "`M228-C007`"),
    SnippetCheck(
        "M228-E007-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M228-E007-CFG-03", "check:objc3c:m228-e007-lane-e-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m228-e006-lane-e-readiness && npm run check:objc3c:m228-a007-lane-a-readiness && npm run check:objc3c:m228-b007-lane-b-readiness && npm run check:objc3c:m228-c007-lane-c-readiness && npm run check:objc3c:m228-d007-lane-d-readiness && npm run check:objc3c:m228-e007-replay-proof-performance-closeout-gate-diagnostics-hardening-contract && npm run test:tooling:m228-e007-replay-proof-performance-closeout-gate-diagnostics-hardening-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M228-E007-SPC-01",
        "replay-proof/performance diagnostics hardening closeout wiring",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M228-E007-META-01",
        "deterministic lane-E diagnostics hardening dependency anchors",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M228-E007-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M228-E007-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M228-E007-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M228-E007-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M228-E007-META-00",
    ...
    if not findings:
        print("m228-e007-replay-proof-performance-closeout-gate-diagnostics-hardening-contract: OK")
        return 0

    print(
        "m228-e007-replay-proof-performance-closeout-gate-diagnostics-hardening-contract: "
