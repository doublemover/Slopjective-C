...
def run_dynamic_probes(args: argparse.Namespace, failures: list[Finding]) -> tuple[list[dict[str, object]], int, int]:
    ...
    if compile_result.returncode == 0 and ir_path.exists() and object_path.exists():
        ...
        compile_case["ir_contains_zero_count_class_aggregate"] = '@__objc3_sec_class_descriptors = internal global { i64 } { i64 0 }, section "objc3.runtime.class_descriptors", align 8' in ir_text
        compile_case["ir_contains_zero_count_protocol_aggregate"] = '@__objc3_sec_protocol_descriptors = internal global { i64 } { i64 0 }, section "objc3.runtime.protocol_descriptors", align 8' in ir_text
        compile_case["ir_contains_zero_count_category_aggregate"] = '@__objc3_sec_category_descriptors = internal global { i64 } { i64 0 }, section "objc3.runtime.category_descriptors", align 8' in ir_text
        compile_case["ir_contains_zero_count_property_aggregate"] = '@__objc3_sec_property_descriptors = internal global { i64 } { i64 0 }, section "objc3.runtime.property_descriptors", align 8' in ir_text
        compile_case["ir_contains_zero_count_ivar_aggregate"] = '@__objc3_sec_ivar_descriptors = internal global { i64 } { i64 0 }, section "objc3.runtime.ivar_descriptors", align 8' in ir_text
