#!/usr/bin/env python3
"""Fail-closed checker for M247-D003 runtime/link/build throughput optimization core feature implementation."""
...
MODE = "m247-d003-runtime-link-build-throughput-optimization-core-feature-implementation-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_d003_lane_d_readiness.py"
...
DEFAULT_D002_TEST = (
    ...
    / "tests"
    / "tooling"
    / "test_check_m247_d002_runtime_link_build_throughput_optimization_modular_split_scaffolding_contract.py"
)
DEFAULT_D002_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_d002_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D003-DOC-PKT-01",
        "# M247-D003 Runtime/Link/Build Throughput Optimization Core Feature Implementation Packet",
    ),
    SnippetCheck("M247-D003-DOC-PKT-02", "Packet: `M247-D003`"),
    SnippetCheck("M247-D003-DOC-PKT-03", "Issue: `#6761`"),
    SnippetCheck("M247-D003-DOC-PKT-04", "Dependencies: `M247-D002`"),
    SnippetCheck("M247-D003-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M247-D003-DOC-PKT-06",
        "scripts/check_m247_d003_runtime_link_build_throughput_optimization_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M247-D003-DOC-PKT-07",
        "tests/tooling/test_check_m247_d003_runtime_link_build_throughput_optimization_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M247-D003-DOC-PKT-08",
        "scripts/run_m247_d003_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M247-D003-DOC-PKT-09",
        "`D002 readiness -> D003 checker -> D003 pytest`",
    ),
    SnippetCheck(
        "M247-D003-DOC-PKT-10",
        "tmp/reports/m247/M247-D003/runtime_link_build_throughput_optimization_core_feature_implementation_contract_summary.json",
    ),
)
...
D002_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-D003-D002-DOC-01",
        "Contract ID: `objc3c-runtime-link-build-throughput-optimization-modular-split-scaffolding/m247-d002-v1`",
    ),
    SnippetCheck(
        "M247-D003-D002-DOC-02",
        "Dependencies: `M247-D001`",
    ),
    SnippetCheck(
        "M247-D003-D002-DOC-03",
        "Issue `#6760` defines canonical lane-D modular split and scaffolding scope.",
    ),
)

D002_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D003-D002-PKT-01", "Packet: `M247-D002`"),
    SnippetCheck("M247-D003-D002-PKT-02", "Issue: `#6760`"),
    SnippetCheck("M247-D003-D002-PKT-03", "Dependencies: `M247-D001`"),
    SnippetCheck("M247-D003-D002-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D003-RUN-01", 'DEPENDENCY_TOKEN = "M247-D002"'),
    SnippetCheck("M247-D003-RUN-02", "scripts/run_m247_d002_lane_d_readiness.py"),
    SnippetCheck(
        "M247-D003-RUN-03",
        "scripts/check_m247_d003_runtime_link_build_throughput_optimization_core_feature_implementation_contract.py",
    ),
    ...
    SnippetCheck("M247-D003-RUN-05", "[ok] M247-D003 lane-D readiness chain completed"),
)

D002_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D003-D002-RUN-01", 'DEPENDENCY_TOKEN = "M247-D001"'),
    SnippetCheck(
        "M247-D003-D002-RUN-02",
        "scripts/check_m247_d002_runtime_link_build_throughput_optimization_modular_split_scaffolding_contract.py",
    ),
    SnippetCheck(
        "M247-D003-D002-RUN-03",
        "tests/tooling/test_check_m247_d002_runtime_link_build_throughput_optimization_modular_split_scaffolding_contract.py",
    ),
    SnippetCheck("M247-D003-D002-RUN-04", "[ok] M247-D002 lane-D readiness chain completed"),
)

PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-D003-PKG-01", '"check:objc3c:m247-d004-lane-d-readiness": '),
    SnippetCheck("M247-D003-PKG-02", "npm run --if-present check:objc3c:m247-d003-lane-d-readiness"),
    SnippetCheck("M247-D003-PKG-03", '"compile:objc3c": '),
    SnippetCheck("M247-D003-PKG-04", '"proof:objc3c": '),
    SnippetCheck("M247-D003-PKG-05", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M247-D003-PKG-06", '"test:objc3c:perf-budget": '),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--d002-readiness-script", type=Path, default=DEFAULT_D002_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M247-D003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M247-D003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d002_expectations_doc, "M247-D003-D002-DOC-EXISTS", D002_EXPECTATIONS_SNIPPETS),
        (args.d002_packet_doc, "M247-D003-D002-PKT-EXISTS", D002_PACKET_SNIPPETS),
        (args.readiness_script, "M247-D003-RUN-EXISTS", READINESS_SNIPPETS),
        (args.d002_readiness_script, "M247-D003-D002-RUN-EXISTS", D002_READINESS_SNIPPETS),
        (args.package_json, "M247-D003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d002_checker, "M247-D003-DEP-D002-ARG-01"),
        (args.d002_test, "M247-D003-DEP-D002-ARG-02"),
    ):
    ...
    if not summary_ok:
        print(
            f"[M247-D003-SUMMARY-WRITE-01] {display_path(summary_path)}: {summary_error}",
            file=sys.stderr,
        )
        return 1
