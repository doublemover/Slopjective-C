#!/usr/bin/env python3
"""Fail-closed checker for M248-D008 runner/platform operations recovery and determinism hardening contract."""
...
MODE = "m248-d008-runner-reliability-platform-operations-recovery-and-determinism-hardening-contract-v1"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-D008-DOC-EXP-01",
        "Contract ID: `objc3c-runner-reliability-platform-operations-recovery-and-determinism-hardening/m248-d008-v1`",
    ),
    SnippetCheck("M248-D008-DOC-EXP-02", "Dependencies: `M248-D007`"),
    SnippetCheck("M248-D008-DOC-EXP-03", "Issue `#6843` defines canonical lane-D recovery and determinism hardening scope."),
    SnippetCheck("M248-D008-DOC-EXP-04", "`check:objc3c:m248-d008-lane-d-readiness`"),
    SnippetCheck("M248-D008-DOC-EXP-05", "`check:objc3c:m248-d007-lane-d-readiness`"),
    SnippetCheck("M248-D008-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M248-D008-DOC-EXP-07",
        "tmp/reports/m248/M248-D008/runner_reliability_and_platform_operations_recovery_and_determinism_hardening_contract_summary.json",
    ),
    SnippetCheck(
        "M248-D008-DOC-EXP-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-D008-DOC-PKT-01", "Packet: `M248-D008`"),
    SnippetCheck("M248-D008-DOC-PKT-02", "Issue: `#6843`"),
    SnippetCheck("M248-D008-DOC-PKT-03", "Dependencies"),
    SnippetCheck("M248-D008-DOC-PKT-04", "`M248-D007`"),
    SnippetCheck(
        "M248-D008-DOC-PKT-05",
        "`scripts/check_m248_d008_runner_reliability_and_platform_operations_recovery_and_determinism_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-D008-DOC-PKT-06",
    ...
    SnippetCheck("M248-D008-DOC-PKT-07", "`check:objc3c:m248-d008-lane-d-readiness`"),
    SnippetCheck(
        "M248-D008-DOC-PKT-08",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-D008-CFG-03", "check:objc3c:m248-d008-lane-d-readiness"),
    PackageScriptKeyCheck("M248-D008-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M248-D008-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M248-D008-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M248-D008-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-d007-lane-d-readiness && npm run check:objc3c:m248-d008-runner-reliability-platform-operations-recovery-and-determinism-hardening-contract && npm run test:tooling:m248-d008-runner-reliability-platform-operations-recovery-and-determinism-hardening-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M248-D008-SPC-03", "closed on recovery and determinism hardening evidence drift before downstream"),
    SnippetCheck("M248-D008-SPC-04", "replay and lane-e conformance matrix advances."),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M248-D008-META-02",
        "explicit `M248-D007` dependency continuity and fail-closed recovery/determinism evidence continuity",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M248-D008-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M248-D008-DOC-PKT-00", PACKET_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M248-D008-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M248-D008-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M248-D008-META-00", METADATA_SPEC_SNIPPETS),
    ):
