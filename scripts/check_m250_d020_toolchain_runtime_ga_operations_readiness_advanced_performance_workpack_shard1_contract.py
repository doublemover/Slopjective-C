#!/usr/bin/env python3
"""Fail-closed validator for M250-D020 toolchain/runtime GA advanced performance workpack (shard 1)."""
...
MODE = "m250-toolchain-runtime-ga-operations-readiness-advanced-performance-workpack-shard1-contract-d020-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m250"
    / "m250_d020_toolchain_runtime_ga_operations_readiness_advanced_performance_workpack_shard1_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "architecture_doc": (
        ("M250-D020-ARC-01", "M250 lane-D D020 advanced performance workpack (shard 1)"),
        (
            "M250-D020-ARC-02",
            "toolchain_runtime_ga_operations_advanced_performance_*",
        ),
    ),
    "d019_contract_doc": (
        (
    ...
    "contract_doc": (
        ...
        (
            "M250-D020-DOC-04",
            "scripts/check_m250_d020_toolchain_runtime_ga_operations_readiness_advanced_performance_workpack_shard1_contract.py",
        ),
        (
            "M250-D020-DOC-05",
            "tests/tooling/test_check_m250_d020_toolchain_runtime_ga_operations_readiness_advanced_performance_workpack_shard1_contract.py",
        ),
        ("M250-D020-DOC-06", "npm run check:objc3c:m250-d020-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M250-D020-PKT-01", "Packet: `M250-D020`"),
        ("M250-D020-PKT-02", "Dependencies: `M250-D019`"),
        (
            "M250-D020-PKT-03",
            "scripts/check_m250_d020_toolchain_runtime_ga_operations_readiness_advanced_performance_workpack_shard1_contract.py",
        ),
    ...
    "package_json": (
        (
            "M250-D020-CFG-01",
            '"check:objc3c:m250-d020-toolchain-runtime-ga-operations-readiness-advanced-performance-workpack-shard1-contract"',
        ),
        (
            "M250-D020-CFG-02",
            '"test:tooling:m250-d020-toolchain-runtime-ga-operations-readiness-advanced-performance-workpack-shard1-contract"',
        ),
        ("M250-D020-CFG-03", '"check:objc3c:m250-d020-lane-d-readiness"'),
    ),
}
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "parse_surface_header": (
        (
            "M250-D020-FORB-01",
            "toolchain_runtime_ga_operations_advanced_performance_consistent = true;",
        ),
    ),
}
