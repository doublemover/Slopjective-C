#!/usr/bin/env python3
"""Fail-closed checker for M249-D003 installer/runtime operations core feature implementation."""
...
MODE = "m249-d003-installer-runtime-operations-support-tooling-core-feature-implementation-contract-v1"
...
DEFAULT_D002_CHECKER = (
    ROOT / "scripts" / "check_m249_d002_installer_runtime_operations_and_support_tooling_modular_split_scaffolding_contract.py"
)
DEFAULT_D002_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m249_d002_installer_runtime_operations_and_support_tooling_modular_split_scaffolding_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D003-DOC-PKT-01",
        "# M249-D003 Installer/Runtime Operations and Support Tooling Core Feature Implementation Packet",
    ),
    SnippetCheck("M249-D003-DOC-PKT-02", "Packet: `M249-D003`"),
    SnippetCheck("M249-D003-DOC-PKT-03", "Dependencies: `M249-D002`"),
    SnippetCheck(
        "M249-D003-DOC-PKT-04",
        "code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M249-D003-DOC-PKT-05",
        "improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M249-D003-DOC-PKT-06",
        "scripts/check_m249_d003_installer_runtime_operations_and_support_tooling_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M249-D003-DOC-PKT-07",
...
D002_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-D003-D002-PKT-01", "Packet: `M249-D002`"),
    SnippetCheck("M249-D003-D002-PKT-02", "Dependencies: `M249-D001`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-D003-META-02",
        "explicit `M249-D002` dependency continuity so core feature implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-D003-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M249-D003-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M249-D003-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M249-D003-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-D003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-D003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d002_expectations_doc, "M249-D003-D002-DOC-EXISTS", D002_EXPECTATIONS_SNIPPETS),
        (args.d002_packet_doc, "M249-D003-D002-PKT-EXISTS", D002_PACKET_SNIPPETS),
        (args.architecture_doc, "M249-D003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-D003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-D003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-D003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d002_checker, "M249-D003-DEP-D002-ARG-01"),
        (args.d002_test, "M249-D003-DEP-D002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
