#!/usr/bin/env python3
"""Fail-closed contract checker for M235-D001 interop behavior for qualified generic APIs."""
...
MODE = "m235-d001-interop-behavior-for-qualified-generic-apis-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M235-D001-DOC-PKT-01",
        "# M235-D001 Interop Behavior for Qualified Generic APIs Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M235-D001-DOC-PKT-02", "Packet: `M235-D001`"),
    SnippetCheck("M235-D001-DOC-PKT-03", "Issue: `#5831`"),
    SnippetCheck("M235-D001-DOC-PKT-04", "Dependencies: `M235-C001`"),
    SnippetCheck(
        "M235-D001-DOC-PKT-05",
        "scripts/check_m235_d001_interop_behavior_for_qualified_generic_apis_contract.py",
    ),
    SnippetCheck(
        "M235-D001-DOC-PKT-06",
        "scripts/check_m235_c001_qualified_type_lowering_and_abi_representation_contract.py",
    ),
    SnippetCheck("M235-D001-DOC-PKT-07", "`compile:objc3c`"),
    SnippetCheck("M235-D001-DOC-PKT-08", "`check:objc3c:m235-c001-lane-c-readiness`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M235-D001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M235-D001-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M235-D001-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M235-D001-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-D001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-D001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M235-D001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-D001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-D001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-D001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
