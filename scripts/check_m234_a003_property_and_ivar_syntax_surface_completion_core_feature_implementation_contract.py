#!/usr/bin/env python3
"""Fail-closed checker for M234-A003 property and ivar syntax surface completion core feature implementation."""
...
MODE = "m234-a003-property-and-ivar-syntax-surface-completion-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_property_and_ivar_syntax_surface_completion_core_feature_implementation_a003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_a003_property_and_ivar_syntax_surface_completion_core_feature_implementation_packet.md"
)
...
DEFAULT_A002_CHECKER = (
    ROOT / "scripts" / "check_m234_a002_property_and_ivar_syntax_surface_completion_modular_split_scaffolding_contract.py"
)
DEFAULT_A002_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_a002_property_and_ivar_syntax_surface_completion_modular_split_scaffolding_contract.py"
)
...
A002_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-A003-A002-PKT-01", "Packet: `M234-A002`"),
    SnippetCheck("M234-A003-A002-PKT-02", "Dependencies: `M234-A001`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-A003-META-02",
        "explicit `M234-A002` dependency continuity so core feature implementation drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M234-A003-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M234-A003-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M234-A003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-A003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a002_expectations_doc, "M234-A003-A002-DOC-EXISTS", A002_EXPECTATIONS_SNIPPETS),
        (args.a002_packet_doc, "M234-A003-A002-PKT-EXISTS", A002_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-A003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-A003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-A003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-A003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a002_checker, "M234-A003-DEP-A002-ARG-01"),
        (args.a002_test, "M234-A003-DEP-A002-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
