#!/usr/bin/env python3
"""Fail-closed checker for M244-B003 interop semantic/type mediation core-feature implementation contract."""
...
MODE = "m244-b003-interop-semantic-contracts-and-type-mediation-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_semantic_contracts_and_type_mediation_core_feature_implementation_b003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_b003_interop_semantic_contracts_and_type_mediation_core_feature_implementation_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-B003/"
    "interop_semantic_contracts_and_type_mediation_core_feature_implementation_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M244-B003-B002-03",
        "M244-B002",
        Path("scripts/check_m244_b002_interop_semantic_contracts_and_type_mediation_modular_split_scaffolding_contract.py"),
    ),
    AssetCheck(
        "M244-B003-B002-04",
        "M244-B002",
        Path("tests/tooling/test_check_m244_b002_interop_semantic_contracts_and_type_mediation_modular_split_scaffolding_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-B003-DOC-EXP-01",
        "Contract ID: `objc3c-interop-semantic-contracts-and-type-mediation-core-feature-implementation/m244-b003-v1`",
    ),
    SnippetCheck("M244-B003-DOC-EXP-02", "Dependencies: `M244-B002`"),
    SnippetCheck("M244-B003-DOC-EXP-03", "Issue `#6533` defines canonical lane-B core-feature implementation scope."),
    SnippetCheck("M244-B003-DOC-EXP-04", "`check:objc3c:m244-b003-lane-b-readiness`"),
    SnippetCheck("M244-B003-DOC-EXP-05", "`check:objc3c:m244-b002-lane-b-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-B003-DOC-PKT-01", "Packet: `M244-B003`"),
    SnippetCheck("M244-B003-DOC-PKT-02", "Issue: `#6533`"),
    SnippetCheck("M244-B003-DOC-PKT-03", "Dependencies: `M244-B002`"),
    SnippetCheck(
        "M244-B003-DOC-PKT-04",
        "`scripts/check_m244_b003_interop_semantic_contracts_and_type_mediation_core_feature_implementation_contract.py`",
    ),
    SnippetCheck(
        "M244-B003-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-B003-CFG-03", "check:objc3c:m244-b003-lane-b-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-b002-lane-b-readiness && npm run check:objc3c:m244-b003-interop-semantic-contracts-type-mediation-core-feature-implementation-contract && npm run test:tooling:m244-b003-interop-semantic-contracts-type-mediation-core-feature-implementation-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B003-ARCH-02", "`M244-B002` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-B003-SPC-02", "lane-B dependency anchor (`M244-B002`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-B003-META-02",
        "explicit `M244-B002` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-B003-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-B003-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-B003-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-B003-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-B003-META-00",
