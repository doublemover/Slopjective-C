#!/usr/bin/env python3
"""Fail-closed checker for M247-C004 lowering/codegen core feature expansion."""
...
MODE = "m247-c004-lowering-codegen-cost-profiling-controls-core-feature-expansion-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m247_c004_lane_c_readiness.py"
...
DEFAULT_C003_CHECKER = (
    ROOT
    / "scripts"
    / "check_m247_c003_lowering_codegen_cost_profiling_and_controls_core_feature_implementation_contract.py"
)
DEFAULT_C003_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m247_c003_lowering_codegen_cost_profiling_and_controls_core_feature_implementation_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C004-DOC-EXP-01",
        "Contract ID: `objc3c-lane-c-lowering-codegen-cost-profiling-controls-core-feature-expansion-contract/m247-c004-v1`",
    ),
    SnippetCheck("M247-C004-DOC-EXP-02", "Dependencies: `M247-C003`"),
    SnippetCheck(
        "M247-C004-DOC-EXP-03",
        "Issue `#6745` defines canonical lane-C core feature expansion scope.",
    ),
    SnippetCheck(
        "M247-C004-DOC-EXP-04",
        "scripts/check_m247_c003_lowering_codegen_cost_profiling_and_controls_core_feature_implementation_contract.py",
    ),
    SnippetCheck(
        "M247-C004-DOC-EXP-05",
        "scripts/run_m247_c004_lane_c_readiness.py",
    ),
    SnippetCheck("M247-C004-DOC-EXP-06", "`check:objc3c:m247-c004-lane-c-readiness`"),
    SnippetCheck("M247-C004-DOC-EXP-07", "`check:objc3c:m247-c003-lane-c-readiness`"),
    SnippetCheck("M247-C004-DOC-EXP-08", "`C003 readiness -> C004 checker -> C004 pytest`."),
    SnippetCheck(
        "M247-C004-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M247-C004-DOC-EXP-10",
        "tmp/reports/m247/M247-C004/lowering_codegen_cost_profiling_and_controls_core_feature_expansion_contract_summary.json",
    ),
)
...
C003_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C004-C003-DOC-01",
        "Contract ID: `objc3c-lane-c-lowering-codegen-cost-profiling-controls-core-feature-implementation-contract/m247-c003-v1`",
    ),
    SnippetCheck("M247-C004-C003-DOC-02", "Dependencies: `M247-C002`"),
    SnippetCheck(
        "M247-C004-C003-DOC-03",
        "Issue `#6744` defines canonical lane-C core feature implementation scope.",
    ),
)

C003_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C004-C003-PKT-01", "Packet: `M247-C003`"),
    SnippetCheck("M247-C004-C003-PKT-02", "Issue: `#6744`"),
    SnippetCheck("M247-C004-C003-PKT-03", "Dependencies: `M247-C002`"),
    SnippetCheck("M247-C004-C003-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M247-C004-RUN-01", 'DEPENDENCY_TOKEN = "M247-C003"'),
    SnippetCheck("M247-C004-RUN-02", "check:objc3c:m247-c003-lane-c-readiness"),
    SnippetCheck(
        "M247-C004-RUN-03",
        "scripts/check_m247_c004_lowering_codegen_cost_profiling_and_controls_core_feature_expansion_contract.py",
    ),
    ...
    SnippetCheck("M247-C004-RUN-05", "[ok] M247-C004 lane-C readiness chain completed"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M247-C004-SPC-01",
        "lowering/codegen core feature expansion wiring shall preserve explicit lane-C dependency anchor (`M247-C003`)",
    ),
    SnippetCheck(
        "M247-C004-SPC-02",
        "core feature expansion evidence commands drift",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M247-C004-META-02",
        "explicit `M247-C003` dependency continuity and fail-closed core feature expansion evidence continuity",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M247-C004-CFG-03", "check:objc3c:m247-c004-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C004-CFG-04", "check:objc3c:m247-c003-lane-c-readiness"),
    PackageScriptKeyCheck("M247-C004-CFG-08", "compile:objc3c"),
    PackageScriptKeyCheck("M247-C004-CFG-09", "proof:objc3c"),
    PackageScriptKeyCheck("M247-C004-CFG-10", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M247-C004-CFG-11", "test:objc3c:perf-budget"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--c003-checker", type=Path, default=DEFAULT_C003_CHECKER)
    parser.add_argument("--c003-test", type=Path, default=DEFAULT_C003_TEST)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M247-C004-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M247-C004-DOC-PKT-00", PACKET_SNIPPETS),
        ("c002_expectations_doc", args.c003_expectations_doc, "M247-C004-C003-DOC-00", C003_EXPECTATIONS_SNIPPETS),
        ("c002_packet_doc", args.c003_packet_doc, "M247-C004-C003-PKT-00", C003_PACKET_SNIPPETS),
        ("readiness_script", args.readiness_script, "M247-C004-RUN-00", READINESS_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M247-C004-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M247-C004-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M247-C004-META-00", METADATA_SPEC_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c003_checker, "M247-C004-DEP-01"),
        (args.c003_test, "M247-C004-DEP-02"),
    ):
