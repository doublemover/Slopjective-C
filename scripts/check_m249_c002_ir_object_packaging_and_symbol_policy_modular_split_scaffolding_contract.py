#!/usr/bin/env python3
"""Fail-closed contract checker for M249-C002 IR/object packaging modular split scaffolding."""
...
MODE = "m249-c002-ir-object-packaging-symbol-policy-modular-split-scaffolding-contract-v1"
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m249/M249-C002/"
    "ir_object_packaging_and_symbol_policy_modular_split_scaffolding_contract_summary.json"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m249-c002-ir-object-packaging-symbol-policy-modular-split-scaffolding-contract '
        '&& npm run test:tooling:m249-c002-ir-object-packaging-symbol-policy-modular-split-scaffolding-contract"',
    ),
    SnippetCheck("M249-C002-PKG-04", '"test:objc3c:lowering-replay-proof": '),
    SnippetCheck("M249-C002-PKG-05", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-C002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-C002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M249-C002-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.architecture_doc, "M249-C002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-C002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-C002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-C002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
