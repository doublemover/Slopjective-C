#!/usr/bin/env python3
"""Fail-closed contract checker for M245-C010 lowering/IR portability conformance corpus expansion."""
...
DEFAULT_C009_CHECKER = (
    ROOT
    / "scripts"
    / "check_m245_c009_lowering_ir_portability_contracts_conformance_matrix_implementation_contract.py"
)
DEFAULT_C009_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m245_c009_lowering_ir_portability_contracts_conformance_matrix_implementation_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-C010-DOC-PKT-01",
        "# M245-C010 Lowering/IR Portability Contracts Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M245-C010-DOC-PKT-02", "Packet: `M245-C010`"),
    SnippetCheck("M245-C010-DOC-PKT-03", "Issue: `#6645`"),
    SnippetCheck("M245-C010-DOC-PKT-04", "Dependencies: `M245-C009`"),
    SnippetCheck("M245-C010-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck(
        "M245-C010-DOC-PKT-06",
        "m245_c009_lowering_ir_portability_contracts_conformance_matrix_implementation_packet.md",
    ),
    SnippetCheck(
        "M245-C010-DOC-PKT-07",
        "package.json` lane-C readiness chain (shared-owner follow-up)",
    ),
    SnippetCheck(
        "M245-C010-DOC-PKT-08",
        "python scripts/check_m245_c010_lowering_ir_portability_contracts_conformance_corpus_expansion_contract.py --emit-json",
    ),
    SnippetCheck(
        "M245-C010-DOC-PKT-09",
        "improvements are mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-C010-DOC-PKT-10",
        "tmp/reports/m245/M245-C010/lowering_ir_portability_contracts_conformance_corpus_expansion_summary.json",
    ),
)
...
C009_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-C010-C009-02", "Dependencies: `M245-C008`"),
)

C009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-C010-C009-PKT-01", "Packet: `M245-C009`"),
    SnippetCheck("M245-C010-C009-PKT-02", "Dependencies: `M245-C008`"),
)

C009_CHECKER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-C010-C009-CHK-01",
        'MODE = "m245-c009-lowering-ir-portability-contracts-conformance-matrix-implementation-contract-v1"',
    ),
    SnippetCheck(
        "M245-C010-C009-CHK-02",
        "DEFAULT_SUMMARY_OUT = Path(",
    ),
)

C009_TEST_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-C010-C009-TST-01", "def test_contract_passes_on_repository_sources"),
    SnippetCheck(
        "M245-C010-C009-TST-02",
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-C010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-C010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c009_expectations_doc, "M245-C010-C009-EXISTS", C009_EXPECTATIONS_SNIPPETS),
        (args.c009_packet_doc, "M245-C010-C009-PKT-EXISTS", C009_PACKET_SNIPPETS),
        (args.c009_checker, "M245-C010-C009-CHK-EXISTS", C009_CHECKER_SNIPPETS),
        (args.c009_test, "M245-C010-C009-TST-EXISTS", C009_TEST_SNIPPETS),
    ):
