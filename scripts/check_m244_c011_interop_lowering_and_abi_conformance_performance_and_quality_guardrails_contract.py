#!/usr/bin/env python3
"""Fail-closed checker for M244-C011 interop lowering performance and quality guardrails contract."""
...
MODE = "m244-c011-interop-lowering-and-abi-conformance-performance-and-quality-guardrails-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_lowering_and_abi_conformance_performance_and_quality_guardrails_c011_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_c011_interop_lowering_and_abi_conformance_performance_and_quality_guardrails_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-C011/"
    "interop_lowering_and_abi_conformance_performance_and_quality_guardrails_contract_summary.json"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-C011-DOC-EXP-01",
        "Contract ID: `objc3c-interop-lowering-and-abi-conformance-performance-and-quality-guardrails/m244-c011-v1`",
    ),
    SnippetCheck("M244-C011-DOC-EXP-02", "Dependencies: `M244-C010`"),
    SnippetCheck("M244-C011-DOC-EXP-03", "Issue `#6560` defines canonical lane-C performance and quality guardrails scope."),
    SnippetCheck("M244-C011-DOC-EXP-04", "`check:objc3c:m244-c011-lane-c-readiness`"),
    SnippetCheck("M244-C011-DOC-EXP-05", "`check:objc3c:m244-c010-lane-c-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-C011-DOC-PKT-01", "Packet: `M244-C011`"),
    SnippetCheck("M244-C011-DOC-PKT-02", "Issue: `#6560`"),
    SnippetCheck("M244-C011-DOC-PKT-03", "Dependencies: `M244-C010`"),
    SnippetCheck(
        "M244-C011-DOC-PKT-04",
        "`scripts/check_m244_c011_interop_lowering_and_abi_conformance_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M244-C011-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-C011-CFG-03", "check:objc3c:m244-c011-lane-c-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-c010-lane-c-readiness && npm run check:objc3c:m244-c011-interop-lowering-abi-conformance-performance-and-quality-guardrails-contract && npm run test:tooling:m244-c011-interop-lowering-abi-conformance-performance-and-quality-guardrails-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-C011-ARCH-02",
        "`M244-C010` dependency continuity and performance/quality evidence remain fail-closed.",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-C011-SPC-02", "lane-C dependency anchor (`M244-C010`)"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-C011-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-C011-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-C011-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-C011-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-C011-META-00",
