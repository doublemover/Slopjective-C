#!/usr/bin/env python3
"""Fail-closed checker for M244-D002 runtime/link bridge-path modular split scaffolding contract."""
...
MODE = "m244-d002-runtime-link-bridge-path-modular-split-scaffolding-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_runtime_link_bridge_path_modular_split_scaffolding_d002_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_d002_runtime_link_bridge_path_modular_split_scaffolding_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M244-D002-D001-01",
        "M244-D001",
        Path("docs/contracts/m244_runtime_link_bridge_path_contract_and_architecture_freeze_d001_expectations.md"),
    ),
    AssetCheck(
        "M244-D002-D001-02",
        "M244-D001",
        Path("spec/planning/compiler/m244/m244_d001_runtime_link_bridge_path_contract_and_architecture_freeze_packet.md"),
    ),
    AssetCheck(
        "M244-D002-D001-03",
        "M244-D001",
        Path("scripts/check_m244_d001_runtime_link_bridge_path_contract.py"),
    ),
    AssetCheck(
        "M244-D002-D001-04",
        "M244-D001",
        Path("tests/tooling/test_check_m244_d001_runtime_link_bridge_path_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D002-DOC-EXP-01",
        "Contract ID: `objc3c-runtime-link-bridge-path-modular-split-scaffolding/m244-d002-v1`",
    ),
    SnippetCheck("M244-D002-DOC-EXP-02", "Dependencies: `M244-D001`"),
    SnippetCheck("M244-D002-DOC-EXP-03", "Issue `#6574` defines canonical lane-D modular split/scaffolding scope."),
    SnippetCheck("M244-D002-DOC-EXP-04", "`check:objc3c:m244-d002-lane-d-readiness`"),
    SnippetCheck("M244-D002-DOC-EXP-05", "`check:objc3c:m244-d001-lane-d-readiness`"),
    SnippetCheck("M244-D002-DOC-EXP-06", "`test:objc3c:execution-replay-proof`"),
    SnippetCheck(
        "M244-D002-DOC-EXP-07",
        "tmp/reports/m244/M244-D002/runtime_link_bridge_path_modular_split_scaffolding_contract_summary.json",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-D002-DOC-PKT-01", "Packet: `M244-D002`"),
    SnippetCheck("M244-D002-DOC-PKT-02", "Issue: `#6574`"),
    SnippetCheck("M244-D002-DOC-PKT-03", "Dependencies: `M244-D001`"),
    SnippetCheck(
        "M244-D002-DOC-PKT-04",
        "`scripts/check_m244_d002_runtime_link_bridge_path_modular_split_scaffolding_contract.py`",
    ),
    SnippetCheck(
        "M244-D002-DOC-PKT-05",
        "`tests/tooling/test_check_m244_d002_runtime_link_bridge_path_modular_split_scaffolding_contract.py`",
    ),
    SnippetCheck("M244-D002-DOC-PKT-06", "`check:objc3c:m244-d002-lane-d-readiness`"),
    SnippetCheck(
        "M244-D002-DOC-PKT-07",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-D002-CFG-03", "check:objc3c:m244-d002-lane-d-readiness"),
    PackageScriptKeyCheck("M244-D002-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M244-D002-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M244-D002-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M244-D002-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-d001-lane-d-readiness && npm run check:objc3c:m244-d002-runtime-link-bridge-path-modular-split-scaffolding-contract && npm run test:tooling:m244-d002-runtime-link-bridge-path-modular-split-scaffolding-contract",
    ),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-D002-SPC-01",
        "runtime/link bridge-path modular split scaffolding governance shall preserve explicit lane-D dependency anchors (`M244-D001`)",
    ),
    SnippetCheck(
        "M244-D002-SPC-02",
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-D002-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-D002-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-D002-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-D002-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-D002-META-00",
