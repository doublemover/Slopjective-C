...
COMMANDS = [
    ...
    [sys.executable, "-m", "pytest", "tests/tooling/test_check_m265_b003_generic_erasure_and_key_path_legality_completion_edge_case_and_compatibility_completion.py", "-q"],
]
...
print("[ok] M265-B003 lane-B readiness chain completed")
