#!/usr/bin/env python3
"""Fail-closed validator for M248-D018 runner/platform advanced conformance workpack (shard 1)."""
...
MODE = "m248-runner-reliability-platform-operations-advanced-conformance-workpack-shard1-contract-d018-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m248"
    / "m248_d018_runner_reliability_and_platform_operations_advanced_conformance_workpack_shard1_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        ...
        ("M248-D018-DOC-06", "npm run check:objc3c:m248-d018-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M248-D018-PKT-01", "Packet: `M248-D018`"),
        ("M248-D018-PKT-02", "Dependencies: `M248-D017`"),
        ("M248-D018-PKT-03", "Issue: `#6853`"),
        (
            "M248-D018-PKT-04",
            "scripts/check_m248_d018_runner_reliability_and_platform_operations_advanced_conformance_workpack_shard1_contract.py",
        ),
    ...
    "package_json": (
        (
            "M248-D018-CFG-01",
            '"check:objc3c:m248-d018-runner-reliability-platform-operations-advanced-conformance-workpack-shard1-contract"',
        ),
        (
            "M248-D018-CFG-02",
            '"test:tooling:m248-d018-runner-reliability-platform-operations-advanced-conformance-workpack-shard1-contract"',
        ),
        ("M248-D018-CFG-03", '"check:objc3c:m248-d018-lane-d-readiness"'),
        ("M248-D018-CFG-04", "python scripts/run_m248_d018_lane_d_readiness.py"),
    ),
}
