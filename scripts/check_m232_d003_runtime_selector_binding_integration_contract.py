#!/usr/bin/env python3
"""Fail-closed checker for M232-D003 runtime selector binding integration contract freeze."""
...
MODE = "m232-d003-runtime-selector-binding-integration-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m232"
    / "m232_d003_runtime_selector_binding_integration_core_feature_implementation_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-D003-DOC-PKT-01",
        "# M232-D003 Runtime Selector Binding Integration Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M232-D003-DOC-PKT-02", "Packet: `M232-D003`"),
    SnippetCheck("M232-D003-DOC-PKT-03", "Issue: `#4875`"),
    SnippetCheck("M232-D003-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M232-D003-DOC-PKT-05",
        "check:objc3c:m232-d003-runtime-selector-binding-integration-contract",
    ),
    SnippetCheck(
        "M232-D003-DOC-PKT-06",
        "tmp/reports/m232/M232-D003/runtime_selector_binding_integration_contract_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M232-D003-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M232-D003-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M232-D003-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M232-D003-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M232-D003-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M232-D003-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
