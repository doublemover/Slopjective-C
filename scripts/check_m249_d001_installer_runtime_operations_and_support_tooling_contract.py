#!/usr/bin/env python3
"""Fail-closed contract checker for the M249-D001 installer/runtime tooling freeze."""
...
MODE = "m249-d001-installer-runtime-operations-support-tooling-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_installer_runtime_operations_and_support_tooling_contract_and_architecture_freeze_d001_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_d001_installer_runtime_operations_and_support_tooling_contract_and_architecture_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D001-DOC-PKT-01",
        "# M249-D001 Installer/Runtime Operations and Support Tooling Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M249-D001-DOC-PKT-02", "Packet: `M249-D001`"),
    SnippetCheck("M249-D001-DOC-PKT-03", "Dependencies: none"),
    SnippetCheck(
        "M249-D001-DOC-PKT-04",
        "`check:objc3c:m249-d001-installer-runtime-operations-support-tooling-contract`",
    ),
    SnippetCheck(
        "M249-D001-DOC-PKT-05",
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-D001-META-02",
        "runtime-route evidence and support-tooling continuity",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-D001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M249-D001-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M249-D001-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M249-D001-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-D001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-D001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M249-D001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-D001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-D001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-D001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
