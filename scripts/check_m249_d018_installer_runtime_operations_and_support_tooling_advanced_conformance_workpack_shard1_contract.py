#!/usr/bin/env python3
"""Fail-closed checker for M249-D018 installer/runtime advanced conformance workpack (shard 1)."""
...
MODE = "m249-d018-installer-runtime-operations-support-tooling-advanced-conformance-workpack-shard1-contract-v1"
...
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m249_d018_lane_d_readiness.py"
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-D018-DOC-EXP-06", "scripts/run_m249_d018_lane_d_readiness.py"),
    SnippetCheck("M249-D018-DOC-EXP-07", "code/spec anchors and milestone optimization"),
    SnippetCheck(
        "M249-D018-DOC-EXP-08",
        "tmp/reports/m249/M249-D018/installer_runtime_operations_and_support_tooling_advanced_conformance_workpack_shard1_contract_summary.json",
    ),
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D018-DOC-PKT-01",
        "# M249-D018 Installer/Runtime Operations and Support Tooling Advanced Conformance Workpack (Shard 1) Packet",
    ),
    SnippetCheck("M249-D018-DOC-PKT-02", "Packet: `M249-D018`"),
    SnippetCheck("M249-D018-DOC-PKT-03", "Issue: `#6945`"),
    SnippetCheck("M249-D018-DOC-PKT-04", "Dependencies: `M249-D017`"),
    SnippetCheck(
        "M249-D018-DOC-PKT-05",
        "scripts/check_m249_d017_installer_runtime_operations_and_support_tooling_advanced_diagnostics_workpack_shard1_contract.py",
    ),
    SnippetCheck(
        "M249-D018-DOC-PKT-06",
        "python scripts/run_m249_d017_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M249-D018-DOC-PKT-07",
...
D017_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-D018-D017-DOC-01",
        "Contract ID: `objc3c-installer-runtime-operations-support-tooling-advanced-diagnostics-workpack-shard1/m249-d017-v1`",
    ),
    SnippetCheck("M249-D018-D017-DOC-02", "Dependencies: `M249-D016`"),
)

D017_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-D018-D017-PKT-01", "Packet: `M249-D017`"),
    SnippetCheck("M249-D018-D017-PKT-02", "Issue: `#6944`"),
    SnippetCheck("M249-D018-D017-PKT-03", "Dependencies"),
)
...
READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M249-D018-RUN-02", "scripts/run_m249_d017_lane_d_readiness.py"),
    SnippetCheck(
        "M249-D018-RUN-03",
    ...
    SnippetCheck("M249-D018-RUN-05", "[ok] M249-D018 lane-D readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-D018-PKG-03",
        '"check:objc3c:m249-d018-lane-d-readiness": "python scripts/run_m249_d018_lane_d_readiness.py"',
    ),
    SnippetCheck("M249-D018-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M249-D018-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M249-D018-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M249-D018-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-D018-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-D018-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d017_expectations_doc, "M249-D018-D017-DOC-EXISTS", D017_EXPECTATIONS_SNIPPETS),
        (args.d017_packet_doc, "M249-D018-D017-PKT-EXISTS", D017_PACKET_SNIPPETS),
        (args.readiness_runner, "M249-D018-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-D018-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-D018-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-D018-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-D018-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d017_checker, "M249-D018-DEP-D017-ARG-01"),
        (args.d017_test, "M249-D018-DEP-D017-ARG-02"),
        (args.d017_readiness_runner, "M249-D018-DEP-D017-ARG-03"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
