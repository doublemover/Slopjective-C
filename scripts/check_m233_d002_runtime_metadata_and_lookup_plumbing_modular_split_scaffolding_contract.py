#!/usr/bin/env python3
"""Fail-closed contract checker for the M233-D002 installer/runtime modular split scaffolding packet."""
...
MODE = "m233-d002-installer-runtime-operations-lookup-plumbing-modular-split-scaffolding-contract-v1"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M233-D002-DOC-PKT-01",
        "# M233-D002 Runtime Metadata and Lookup Plumbing Modular Split and Scaffolding Packet",
    ),
    SnippetCheck("M233-D002-DOC-PKT-02", "Packet: `M233-D002`"),
    SnippetCheck("M233-D002-DOC-PKT-03", "Dependencies: `M233-D001`"),
    SnippetCheck(
        "M233-D002-DOC-PKT-04",
        "`scripts/check_m233_d001_runtime_metadata_and_lookup_plumbing_contract.py`",
    ),
    SnippetCheck(
        "M233-D002-DOC-PKT-05",
        "`check:objc3c:m233-d002-lane-d-readiness`",
    ),
    SnippetCheck(
        "M233-D002-DOC-PKT-06",
        "`test:objc3c:execution-replay-proof`",
    ),
    SnippetCheck(
        "M233-D002-DOC-PKT-07",
        "code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M233-D002-DOC-PKT-08",
        "improvements as mandatory scope inputs.",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m233-d002-installer-runtime-operations-lookup-plumbing-modular-split-scaffolding-contract '
        '&& npm run test:tooling:m233-d002-installer-runtime-operations-lookup-plumbing-modular-split-scaffolding-contract"',
    ),
    SnippetCheck("M233-D002-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M233-D002-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M233-D002-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M233-D002-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M233-D002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M233-D002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M233-D002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M233-D002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M233-D002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M233-D002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
