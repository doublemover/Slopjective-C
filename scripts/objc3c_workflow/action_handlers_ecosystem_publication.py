...
ECOSYSTEM_PUBLICATION_ACTION_HANDLERS: dict[str, ActionHandler] = {
    ...
    "validate-package-security-hardening": ecosystem_publication.action_validate_package_security_hardening,
    "package-publish": ecosystem_publication.action_package_publish,
    "package-install": ecosystem_publication.action_package_install,
    "package-update": ecosystem_publication.action_package_update,
    "package-uninstall": ecosystem_publication.action_package_uninstall,
    "package-rollback": ecosystem_publication.action_package_rollback,
    ...
    "validate-direct-import-module-syntax": ecosystem_publication.action_validate_direct_import_module_syntax,
    ...
    "validate-package-network-publication": ecosystem_publication.action_validate_package_network_publication,
    ...
    "validate-package-operations": ecosystem_publication.action_validate_package_operations,
