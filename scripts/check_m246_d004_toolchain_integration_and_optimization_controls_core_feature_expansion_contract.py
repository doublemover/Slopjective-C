#!/usr/bin/env python3
"""Fail-closed checker for M246-D004 toolchain integration/optimization controls core feature expansion."""
...
MODE = "m246-d004-toolchain-integration-optimization-controls-core-feature-expansion-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_d004_lane_d_readiness.py"
...
DEFAULT_D003_CHECKER = (
    ROOT / "scripts" / "check_m246_d003_toolchain_integration_and_optimization_controls_core_feature_implementation_contract.py"
)
DEFAULT_D003_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m246_d003_toolchain_integration_and_optimization_controls_core_feature_implementation_contract.py"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D004-DOC-PKT-01",
        "# M246-D004 Toolchain Integration and Optimization Controls Core Feature Expansion Packet",
    ),
    SnippetCheck("M246-D004-DOC-PKT-02", "Packet: `M246-D004`"),
    SnippetCheck("M246-D004-DOC-PKT-03", "Issue: `#5109`"),
    SnippetCheck("M246-D004-DOC-PKT-04", "Dependencies: `M246-D003`"),
    SnippetCheck("M246-D004-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-D004-DOC-PKT-06", "Dependency anchors from `M246-D003`:"),
    SnippetCheck(
        "M246-D004-DOC-PKT-07",
        "scripts/run_m246_d004_lane_d_readiness.py",
    ),
    SnippetCheck(
...
D003_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D004-D003-DOC-01",
        "Contract ID: `objc3c-toolchain-integration-optimization-controls-core-feature-implementation/m246-d003-v1`",
    ),
    SnippetCheck(
        "M246-D004-D003-DOC-02",
        "Dependencies: `M246-D002`",
    ),
)

D003_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D004-D003-PKT-01", "Packet: `M246-D003`"),
    SnippetCheck("M246-D004-D003-PKT-02", "Issue: `#5108`"),
    SnippetCheck("M246-D004-D003-PKT-03", "Dependencies: `M246-D002`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D004-RDY-01", 'DEPENDENCY_TOKEN = "M246-D003"'),
    SnippetCheck(
        "M246-D004-RDY-02",
    ...
    SnippetCheck("M246-D004-RDY-05", "[ok] M246-D004 lane-D readiness chain completed"),
)

D003_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D004-D003-RDY-01", 'DEPENDENCY_TOKEN = "M246-D002"'),
    SnippetCheck("M246-D004-D003-RDY-02", "[ok] M246-D003 lane-D readiness chain completed"),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-D004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-D004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d003_expectations_doc, "M246-D004-D003-DOC-EXISTS", D003_EXPECTATIONS_SNIPPETS),
        (args.d003_packet_doc, "M246-D004-D003-PKT-EXISTS", D003_PACKET_SNIPPETS),
        (args.readiness_script, "M246-D004-RDY-EXISTS", READINESS_SNIPPETS),
        (args.d003_readiness_script, "M246-D004-D003-RDY-EXISTS", D003_READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d003_checker, "M246-D004-DEP-D003-ARG-01"),
        (args.d003_test, "M246-D004-DEP-D003-ARG-02"),
    ):
