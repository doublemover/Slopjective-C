param(
  [string]$ReportRoot = "tmp/reports/m226/M226-A031"
)
...
$upstream = @(
  @{ packet = "A027"; path = "tmp/reports/m226/M226-A027/parser_advanced_core_workpack_summary.json" },
  @{ packet = "A028"; path = "tmp/reports/m226/M226-A028/parser_advanced_edge_compat_workpack_summary.json" },
  @{ packet = "A029"; path = "tmp/reports/m226/M226-A029/parser_advanced_diagnostics_workpack_summary.json" },
  @{ packet = "A030"; path = "tmp/reports/m226/M226-A030/parser_conformance_shard3_summary.json" }
)
...
$summary = [ordered]@{
  contract_id = "objc3c-parser-advanced-integration-workpack-contract/m226-a031-v1"
