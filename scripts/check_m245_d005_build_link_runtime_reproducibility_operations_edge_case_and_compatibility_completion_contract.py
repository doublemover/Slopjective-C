#!/usr/bin/env python3
"""Fail-closed checker for M245-D005 build/link/runtime reproducibility edge-case and compatibility completion."""
...
MODE = "m245-d005-build-link-runtime-reproducibility-operations-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_D004_CHECKER = (
    ROOT / "scripts" / "check_m245_d004_build_link_runtime_reproducibility_operations_core_feature_expansion_contract.py"
)
DEFAULT_D004_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m245_d004_build_link_runtime_reproducibility_operations_core_feature_expansion_contract.py"
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M245-D005-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M245-D005-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M245-D005-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M245-D005-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-D005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-D005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d004_expectations_doc, "M245-D005-D004-DOC-EXISTS", D004_EXPECTATIONS_SNIPPETS),
        (args.d004_packet_doc, "M245-D005-D004-PKT-EXISTS", D004_PACKET_SNIPPETS),
        (args.architecture_doc, "M245-D005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M245-D005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M245-D005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M245-D005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d004_checker, "M245-D005-DEP-D004-ARG-01"),
        (args.d004_test, "M245-D005-DEP-D004-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
