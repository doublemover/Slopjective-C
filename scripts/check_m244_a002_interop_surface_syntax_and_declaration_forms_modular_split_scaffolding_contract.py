#!/usr/bin/env python3
"""Fail-closed checker for M244-A002 interop surface modular split/scaffolding contract."""
...
MODE = "m244-a002-interop-surface-syntax-and-declaration-forms-modular-split-scaffolding-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m244_interop_surface_syntax_and_declaration_forms_modular_split_scaffolding_a002_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m244"
    / "m244_a002_interop_surface_syntax_and_declaration_forms_modular_split_scaffolding_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m244/M244-A002/"
    "interop_surface_syntax_and_declaration_forms_modular_split_scaffolding_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        "M244-A002-A001-03",
        "M244-A001",
        Path("scripts/check_m244_a001_interop_surface_syntax_and_declaration_forms_contract.py"),
    ),
    AssetCheck(
        "M244-A002-A001-04",
        "M244-A001",
        Path("tests/tooling/test_check_m244_a001_interop_surface_syntax_and_declaration_forms_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M244-A002-DOC-EXP-01",
        "Contract ID: `objc3c-interop-surface-syntax-and-declaration-forms-modular-split-scaffolding/m244-a002-v1`",
    ),
    SnippetCheck("M244-A002-DOC-EXP-02", "Dependencies: `M244-A001`"),
    SnippetCheck("M244-A002-DOC-EXP-03", "Issue `#6519` defines canonical lane-A modular split/scaffolding scope."),
    SnippetCheck("M244-A002-DOC-EXP-04", "`check:objc3c:m244-a002-lane-a-readiness`"),
    SnippetCheck("M244-A002-DOC-EXP-05", "`check:objc3c:m244-a001-lane-a-readiness`"),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M244-A002-DOC-PKT-01", "Packet: `M244-A002`"),
    SnippetCheck("M244-A002-DOC-PKT-02", "Issue: `#6519`"),
    SnippetCheck("M244-A002-DOC-PKT-03", "Dependencies: `M244-A001`"),
    SnippetCheck(
        "M244-A002-DOC-PKT-04",
        "`scripts/check_m244_a002_interop_surface_syntax_and_declaration_forms_modular_split_scaffolding_contract.py`",
    ),
    SnippetCheck(
        "M244-A002-DOC-PKT-05",
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M244-A002-CFG-03", "check:objc3c:m244-a002-lane-a-readiness"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m244-a001-lane-a-readiness && npm run check:objc3c:m244-a002-interop-surface-syntax-declaration-forms-modular-split-scaffolding-contract && npm run test:tooling:m244-a002-interop-surface-syntax-declaration-forms-modular-split-scaffolding-contract",
    ),
)
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A002-ARCH-02", "`M244-A001` dependency continuity"),
)
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M244-A002-SPC-02", "lane-A dependency anchor (`M244-A001`)"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M244-A002-META-02",
        "explicit `M244-A001` dependency continuity and fail-closed evidence",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M244-A002-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M244-A002-DOC-PKT-00",
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M244-A002-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M244-A002-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M244-A002-META-00",
