#!/usr/bin/env python3
"""Run M247-E003 lane-E readiness checks without deep npm nesting."""
...
BASELINE_DEPENDENCIES = ("M247-E002",)
PENDING_SEEDED_DEPENDENCY_TOKENS = ("M247-A003", "M247-B003", "M247-C003", "M247-D002")
...
INITIAL_COMMAND_CHAIN: tuple[Sequence[str], ...] = (
    ...
    (
        ...
        "run",
        "--if-present",
        "check:objc3c:m247-a003-lane-a-readiness",
    ),
    (
        NPM_EXECUTABLE,
        "run",
        "--if-present",
        "check:objc3c:m247-b003-lane-b-readiness",
    ),
    (
        NPM_EXECUTABLE,
        "run",
    ...
    (
        ...
        "run",
        "--if-present",
        "check:objc3c:m247-d002-lane-d-readiness",
    ),
)
...
def run_chain() -> int:
    ...
    print("[ok] M247-E003 lane-E readiness chain completed")
    return 0
