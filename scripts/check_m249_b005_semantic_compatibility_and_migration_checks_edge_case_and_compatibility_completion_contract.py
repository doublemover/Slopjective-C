#!/usr/bin/env python3
"""Fail-closed contract checker for the M249-B005 semantic compatibility edge-case and compatibility completion packet."""
...
MODE = "m249-b005-semantic-compatibility-migration-checks-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_B004_CHECKER = (
    ROOT / "scripts" / "check_m249_b004_semantic_compatibility_and_migration_checks_core_feature_expansion_contract.py"
)
DEFAULT_B004_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m249_b004_semantic_compatibility_and_migration_checks_core_feature_expansion_contract.py"
)
DEFAULT_READINESS_RUNNER = ROOT / "scripts" / "run_m249_b005_lane_b_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-B005-DOC-PKT-01",
        "# M249-B005 Semantic Compatibility and Migration Checks Edge-Case and Compatibility Completion Packet",
    ),
    SnippetCheck("M249-B005-DOC-PKT-02", "Packet: `M249-B005`"),
    SnippetCheck("M249-B005-DOC-PKT-03", "Dependencies: `M249-B004`"),
    SnippetCheck(
        "M249-B005-DOC-PKT-04",
        "`scripts/check_m249_b005_semantic_compatibility_and_migration_checks_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M249-B005-DOC-PKT-05",
        "`scripts/run_m249_b005_lane_b_readiness.py`",
    ),
    SnippetCheck(
        "M249-B005-DOC-PKT-06",
        "`check:objc3c:m249-b005-lane-b-readiness`",
    ),
    SnippetCheck(
        "M249-B005-DOC-PKT-07",
        "`test:objc3c:lowering-regression`",
    ),
    SnippetCheck(
        "M249-B005-DOC-PKT-08",
        "code/spec anchors and milestone optimization",
    ),
    SnippetCheck(
        "M249-B005-DOC-PKT-09",
        "improvements as mandatory scope inputs.",
    ),
)
...
B004_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-B005-B004-DOC-01",
        "Contract ID: `objc3c-semantic-compatibility-and-migration-checks-core-feature-expansion/m249-b004-v1`",
    ),
    SnippetCheck("M249-B005-B004-DOC-02", "- Dependencies: `M249-B003`"),
    SnippetCheck(
        "M249-B005-B004-DOC-03",
        "scripts/check_m249_b004_semantic_compatibility_and_migration_checks_core_feature_expansion_contract.py",
    ),
)

B004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-B005-B004-PKT-01", "Packet: `M249-B004`"),
    SnippetCheck("M249-B005-B004-PKT-02", "Dependencies: `M249-B003`"),
    SnippetCheck(
        "M249-B005-B004-PKT-03",
        "scripts/check_m249_b004_semantic_compatibility_and_migration_checks_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M249-B005-B004-PKT-04",
...
READINESS_RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-B005-RUN-01", '"""Run M249-B005 lane-B readiness checks without deep npm nesting."""'),
    SnippetCheck(
        "M249-B005-RUN-02",
    ...
    SnippetCheck("M249-B005-RUN-05", "[ok] M249-B005 lane-B readiness chain completed"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-B005-PKG-03",
        '"check:objc3c:m249-b005-lane-b-readiness": "python scripts/run_m249_b005_lane_b_readiness.py"',
    ),
    SnippetCheck("M249-B005-PKG-04", '"test:objc3c:sema-pass-manager-diagnostics-bus": '),
    SnippetCheck("M249-B005-PKG-05", '"test:objc3c:lowering-regression": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-B005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-B005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b004_expectations_doc, "M249-B005-B004-DOC-EXISTS", B004_EXPECTATIONS_SNIPPETS),
        (args.b004_packet_doc, "M249-B005-B004-PKT-EXISTS", B004_PACKET_SNIPPETS),
        (args.readiness_runner, "M249-B005-RUN-EXISTS", READINESS_RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-B005-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-B005-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-B005-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-B005-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b004_checker, "M249-B005-DEP-B004-ARG-01"),
        (args.b004_test, "M249-B005-DEP-B004-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
