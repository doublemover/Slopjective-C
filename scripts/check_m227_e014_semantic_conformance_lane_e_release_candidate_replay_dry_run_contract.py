#!/usr/bin/env python3
"""Fail-closed validator for M227-E014 semantic conformance lane-E release-candidate and replay dry-run."""
...
MODE = "m227-e014-semantic-conformance-lane-e-release-candidate-replay-dry-run-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m227_lane_e_semantic_conformance_release_candidate_replay_dry_run_e014_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m227"
    / "m227_e014_semantic_conformance_lane_e_release_candidate_replay_dry_run_packet.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M227-E014-E005-01",
        "M227-E013",
        Path("docs/contracts/m227_lane_e_semantic_conformance_docs_operator_runbook_sync_e013_expectations.md"),
    ),
    AssetCheck(
        "M227-E014-E005-02",
        "M227-E013",
        Path("scripts/check_m227_e013_semantic_conformance_lane_e_docs_operator_runbook_sync_contract.py"),
    ),
    AssetCheck(
        "M227-E014-E005-03",
        "M227-E013",
        Path("tests/tooling/test_check_m227_e013_semantic_conformance_lane_e_docs_operator_runbook_sync_contract.py"),
    ),
    AssetCheck(
        "M227-E014-E005-04",
        "M227-E013",
        Path("spec/planning/compiler/m227/m227_e013_semantic_conformance_lane_e_docs_operator_runbook_sync_packet.md"),
    ),
    AssetCheck(
        "M227-E014-A006-01",
        "M227-A015",
        Path("docs/contracts/m227_semantic_pass_advanced_core_workpack_shard1_expectations.md"),
    ),
    AssetCheck(
        "M227-E014-A006-02",
        "M227-A015",
        Path("scripts/check_m227_a015_semantic_pass_advanced_core_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E014-A006-03",
        "M227-A015",
        Path("tests/tooling/test_check_m227_a015_semantic_pass_advanced_core_workpack_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E014-A006-04",
        "M227-A015",
        Path("spec/planning/compiler/m227/m227_a015_semantic_pass_advanced_core_workpack_shard1_packet.md"),
    ),
    AssetCheck(
        "M227-E014-B006-01",
        "M227-B027",
        Path("docs/contracts/m227_type_system_objc3_forms_advanced_core_workpack_shard3_b027_expectations.md"),
    ),
    AssetCheck(
        "M227-E014-B006-02",
        "M227-B027",
        Path("scripts/check_m227_b027_type_system_objc3_forms_advanced_core_workpack_shard3_contract.py"),
    ),
    AssetCheck(
        "M227-E014-B006-03",
        "M227-B027",
        Path("tests/tooling/test_check_m227_b027_type_system_objc3_forms_advanced_core_workpack_shard3_contract.py"),
    ),
    AssetCheck(
        "M227-E014-B006-04",
        "M227-B027",
        Path("spec/planning/compiler/m227/m227_b027_type_system_objc3_forms_advanced_core_workpack_shard3_packet.md"),
    ),
    AssetCheck(
        "M227-E014-C006-01",
        "M227-C018",
        Path("docs/contracts/m227_typed_sema_to_lowering_advanced_conformance_shard1_c018_expectations.md"),
    ),
    AssetCheck(
        "M227-E014-C006-02",
        "M227-C018",
        Path("scripts/check_m227_c018_typed_sema_to_lowering_advanced_conformance_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E014-C006-03",
        "M227-C018",
        Path("tests/tooling/test_check_m227_c018_typed_sema_to_lowering_advanced_conformance_shard1_contract.py"),
    ),
    AssetCheck(
        "M227-E014-C006-04",
        "M227-C018",
        Path("spec/planning/compiler/m227/m227_c018_typed_sema_to_lowering_advanced_conformance_shard1_packet.md"),
    ),
    AssetCheck(
        "M227-E014-D006-01",
        "M227-D008",
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E014-EXP-07", "## Prerequisite Dependency Matrix"),
    SnippetCheck(
        "M227-E014-EXP-08",
        "checker `scripts/check_m227_e013_semantic_conformance_lane_e_docs_operator_runbook_sync_contract.py`",
    ),
    SnippetCheck(
        "M227-E014-EXP-09",
        "checker `scripts/check_m227_a015_semantic_pass_advanced_core_workpack_shard1_contract.py`",
    ),
    SnippetCheck(
        "M227-E014-EXP-10",
        "checker `scripts/check_m227_b027_type_system_objc3_forms_advanced_core_workpack_shard3_contract.py`",
    ),
    SnippetCheck(
        "M227-E014-EXP-11",
        "checker `scripts/check_m227_c018_typed_sema_to_lowering_advanced_conformance_shard1_contract.py`",
    ),
    SnippetCheck(
        "M227-E014-EXP-12",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck("M227-E014-PKT-04", "Packet: `M227-E014`"),
    SnippetCheck("M227-E014-PKT-05", "Issue: `#5172`"),
    SnippetCheck("M227-E014-PKT-06", "Scaffold date: `2026-03-05`"),
    SnippetCheck(
        "M227-E014-PKT-07",
        "Dependencies: `M227-E013`, `M227-A015`, `M227-B027`, `M227-C018`, `M227-D008`",
    ),
    SnippetCheck("M227-E014-PKT-08", "## Frozen Dependency Tokens and References"),
    SnippetCheck(
        "M227-E014-PKT-09",
...
ARCHITECTURE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M227-E014-ARCH-01",
        "M227 lane-E E014 semantic conformance release-candidate and replay dry-run anchors dependency references",
    ),
    SnippetCheck(
        "M227-E014-ARCH-02",
        "(`M227-E013`, `M227-A015`, `M227-B027`, `M227-C018`, and `M227-D008`)",
    ),
    SnippetCheck(
        "M227-E014-ARCH-03",
        "check:objc3c:m227-e014-lane-e-readiness",
...
LOWERING_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E014-SPC-03",
        "lane-E release-candidate and replay dry-run evidence drift.",
    ),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M227-E014-META-03",
        "semantic conformance lane-E release-candidate and replay dry-run metadata governance drift fails closed.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M227-E014-CFG-03", "check:objc3c:m227-e014-lane-e-readiness"),
    PackageScriptKeyCheck("M227-E014-CFG-07", "compile:objc3c"),
    PackageScriptKeyCheck("M227-E014-CFG-08", "proof:objc3c"),
    PackageScriptKeyCheck("M227-E014-CFG-09", "test:objc3c:execution-replay-proof"),
    PackageScriptKeyCheck("M227-E014-CFG-10", "test:objc3c:perf-budget"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        "M227-E014-CFG-06",
        "check:objc3c:m227-e014-lane-e-readiness",
        "python scripts/check_m227_e013_semantic_conformance_lane_e_docs_operator_runbook_sync_contract.py && python -m pytest tests/tooling/test_check_m227_e013_semantic_conformance_lane_e_docs_operator_runbook_sync_contract.py -q && python scripts/check_m227_a015_semantic_pass_advanced_core_workpack_shard1_contract.py && python -m pytest tests/tooling/test_check_m227_a015_semantic_pass_advanced_core_workpack_shard1_contract.py -q && npm run check:objc3c:m227-b027-lane-b-readiness && npm run check:objc3c:m227-c018-lane-c-readiness && python scripts/check_m227_d008_runtime_facing_type_metadata_recovery_determinism_hardening_contract.py && python -m pytest tests/tooling/test_check_m227_d008_runtime_facing_type_metadata_recovery_determinism_hardening_contract.py -q && npm run check:objc3c:m227-e014-semantic-conformance-lane-e-release-candidate-replay-dry-run-contract && npm run test:tooling:m227-e014-semantic-conformance-lane-e-release-candidate-replay-dry-run-contract",
    ),
)
...
DEPENDENCY_REFERENCE_TOKENS: dict[str, str] = {
    "M227-E013": "scripts/check_m227_e013_semantic_conformance_lane_e_docs_operator_runbook_sync_contract.py",
    "M227-A015": "scripts/check_m227_a015_semantic_pass_advanced_core_workpack_shard1_contract.py",
    "M227-B027": "scripts/check_m227_b027_type_system_objc3_forms_advanced_core_workpack_shard3_contract.py",
    "M227-C018": "scripts/check_m227_c018_typed_sema_to_lowering_advanced_conformance_shard1_contract.py",
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_text = check_document(
        ...
        exists_check_id="M227-E014-EXP-01",
        utf8_check_id="M227-E014-EXP-02",
        snippets=EXPECTATIONS_SNIPPETS,
    )
    packet_text = check_document(
        path=args.packet_doc,
        artifact="packet_doc",
        exists_check_id="M227-E014-PKT-01",
        utf8_check_id="M227-E014-PKT-02",
        snippets=PACKET_SNIPPETS,
    )
    check_document(
        path=args.architecture_doc,
        artifact="architecture_doc",
        exists_check_id="M227-E014-ARCH-00",
        utf8_check_id="M227-E014-ARCH-UTF8",
        snippets=ARCHITECTURE_SNIPPETS,
    )
    check_document(
        path=args.lowering_spec,
        artifact="lowering_spec",
        exists_check_id="M227-E014-SPC-00",
        utf8_check_id="M227-E014-SPC-UTF8",
        snippets=LOWERING_SPEC_SNIPPETS,
    )
    check_document(
        path=args.metadata_spec,
        artifact="metadata_spec",
        exists_check_id="M227-E014-META-00",
        utf8_check_id="M227-E014-META-UTF8",
    ...
    for index, task in enumerate(DEPENDENCY_ORDER, start=1):
        ...
        check(
            ...
            check_id=f"M227-E014-SEM-MATCH-{index:02d}",
            condition=(
    ...
    if isinstance(package_payload, dict):
        ...
        check(
            artifact="package_json",
            check_id="M227-E014-CFG-SCRIPTS",
    ...
    if findings:
        if not args.emit_json:
            print(
                "m227-e014-semantic-conformance-lane-e-release-candidate-replay-dry-run: "
    ...
    if not args.emit_json:
        print("m227-e014-semantic-conformance-lane-e-release-candidate-replay-dry-run: OK")
        print(f"- mode={MODE}")
