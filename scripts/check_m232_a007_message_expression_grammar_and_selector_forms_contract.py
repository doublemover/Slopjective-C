#!/usr/bin/env python3
"""Fail-closed checker for M232-A007 message expression grammar and selector forms contract freeze."""
...
MODE = "m232-a007-message-expression-grammar-and-selector-forms-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m232"
    / "m232_a007_message_expression_grammar_and_selector_forms_diagnostics_hardening_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M232-A007-DOC-PKT-01",
        "# M232-A007 Message Expression Grammar and Selector Forms Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M232-A007-DOC-PKT-02", "Packet: `M232-A007`"),
    SnippetCheck("M232-A007-DOC-PKT-03", "Issue: `#5571`"),
    SnippetCheck("M232-A007-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M232-A007-DOC-PKT-05",
        "check:objc3c:m232-a007-message-expression-grammar-and-selector-forms-contract",
    ),
    SnippetCheck(
        "M232-A007-DOC-PKT-06",
        "tmp/reports/m232/M232-A007/message_expression_grammar_and_selector_forms_contract_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M232-A007-PKG-03",
        '"check:objc3c:m232-a007-lane-a-readiness": '
        '"npm run check:objc3c:m232-a007-message-expression-grammar-and-selector-forms-contract '
        '&& npm run test:tooling:m232-a007-message-expression-grammar-and-selector-forms-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M232-A007-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M232-A007-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M232-A007-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M232-A007-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M232-A007-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M232-A007-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
