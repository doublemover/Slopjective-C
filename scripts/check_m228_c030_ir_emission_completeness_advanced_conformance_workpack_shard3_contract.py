#!/usr/bin/env python3
"""Fail-closed validator for M228-C030 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c029_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c029_ir_emission_completeness_advanced_diagnostics_workpack_shard3_contract.py",
    "c029_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C030-RUN-04", "npm run check:objc3c:m228-c030-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C030-ARC-01",
    ...
    "package_json": (
        ("M228-C030-PKG-01", '"check:objc3c:m228-c029-lane-c-readiness"'),
        (
            "M228-C030-PKG-02",
            '"check:objc3c:m228-c030-ir-emission-completeness-advanced-conformance-workpack-shard3-contract"',
        ),
        (
            "M228-C030-PKG-03",
            '"test:tooling:m228-c030-ir-emission-completeness-advanced-conformance-workpack-shard3-contract"',
        ),
        ("M228-C030-PKG-04", '"check:objc3c:m228-c030-lane-c-readiness"'),
        (
            "M228-C030-PKG-05",
    ...
    "c029_tooling_test": (
        ("M228-C030-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c029_packet_doc": (
        ("M228-C030-DEP-04", "Packet: `M228-C029`"),
        ("M228-C030-DEP-05", "Issue: `#5255`"),
    ),
    "contract_doc": (
        (
            "M228-C030-DOC-01",
        ...
        ("M228-C030-DOC-02", "Execute issue `#5256`"),
        ("M228-C030-DOC-03", "Dependencies: `M228-C029`"),
        (
            "M228-C030-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        (
            "M228-C030-PKT-01",
            "# M228-C030 IR Emission Completeness Advanced Conformance Workpack (Shard 3) Packet",
        ),
        ("M228-C030-PKT-02", "Packet: `M228-C030`"),
        ("M228-C030-PKT-03", "Issue: `#5256`"),
        ("M228-C030-PKT-04", "Dependencies: `M228-C029`"),
        (
            "M228-C030-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C030-FORB-01",
            '"check:objc3c:m228-c030-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C030/"
            "ir_emission_completeness_advanced_conformance_workpack_shard3_contract_summary.json"
        ),
    )
