#!/usr/bin/env python3
"""Fail-closed checker for M246-D008 toolchain integration/optimization controls recovery and determinism hardening."""
...
MODE = "m246-d008-toolchain-integration-optimization-controls-recovery-and-determinism-hardening-contract-v1"
...
DEFAULT_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_d008_lane_d_readiness.py"
...
DEFAULT_D007_CHECKER = (
    ROOT
    / "scripts"
    / "check_m246_d007_toolchain_integration_and_optimization_controls_diagnostics_hardening_contract.py"
)
DEFAULT_D007_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m246_d007_toolchain_integration_and_optimization_controls_diagnostics_hardening_contract.py"
)
DEFAULT_D007_READINESS_SCRIPT = ROOT / "scripts" / "run_m246_d007_lane_d_readiness.py"
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D008-DOC-PKT-01",
        "# M246-D008 Toolchain Integration and Optimization Controls Recovery and Determinism Hardening Packet",
    ),
    SnippetCheck("M246-D008-DOC-PKT-02", "Packet: `M246-D008`"),
    SnippetCheck("M246-D008-DOC-PKT-03", "Issue: `#6687`"),
    SnippetCheck("M246-D008-DOC-PKT-04", "Dependencies: `M246-D007`"),
    SnippetCheck("M246-D008-DOC-PKT-05", "Freeze date: `2026-03-04`"),
    SnippetCheck("M246-D008-DOC-PKT-06", "Dependency anchors from `M246-D007`:"),
    SnippetCheck(
        "M246-D008-DOC-PKT-07",
        "scripts/run_m246_d008_lane_d_readiness.py",
    ),
    SnippetCheck(
        "M246-D008-DOC-PKT-08",
    ...
    SnippetCheck(
        "M246-D008-DOC-PKT-09",
        "`D007 readiness -> D008 checker -> D008 pytest`",
    ),
    SnippetCheck(
        "M246-D008-DOC-PKT-10",
        "tmp/reports/m246/M246-D008/toolchain_integration_optimization_controls_recovery_and_determinism_hardening_contract_summary.json",
    ),
)
...
D007_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-D008-D007-DOC-01",
        "Contract ID: `objc3c-toolchain-integration-optimization-controls-diagnostics-hardening/m246-d007-v1`",
    ),
    SnippetCheck(
        "M246-D008-D007-DOC-02",
        "Dependencies: `M246-D006`",
    ),
    SnippetCheck(
        "M246-D008-D007-DOC-03",
        "Issue `#6686` defines canonical lane-D diagnostics hardening scope.",
    ),
)

D007_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D008-D007-PKT-01", "Packet: `M246-D007`"),
    SnippetCheck("M246-D008-D007-PKT-02", "Issue: `#6686`"),
    SnippetCheck("M246-D008-D007-PKT-03", "Dependencies: `M246-D006`"),
    SnippetCheck("M246-D008-D007-PKT-04", "Freeze date: `2026-03-04`"),
)

READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D008-RDY-01", 'DEPENDENCY_TOKEN = "M246-D007"'),
    SnippetCheck(
        "M246-D008-RDY-02",
    ...
    SnippetCheck("M246-D008-RDY-05", "[ok] M246-D008 lane-D readiness chain completed"),
)

D007_READINESS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M246-D008-D007-RDY-01", 'DEPENDENCY_TOKEN = "M246-D006"'),
    SnippetCheck(
        "M246-D008-D007-RDY-02",
        "scripts/run_m246_d006_lane_d_readiness.py",
    ),
    SnippetCheck("M246-D008-D007-RDY-03", "[ok] M246-D007 lane-D readiness chain completed"),
)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--d007-readiness-script", type=Path, default=DEFAULT_D007_READINESS_SCRIPT)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-D008-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-D008-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.d007_expectations_doc, "M246-D008-D007-DOC-EXISTS", D007_EXPECTATIONS_SNIPPETS),
        (args.d007_packet_doc, "M246-D008-D007-PKT-EXISTS", D007_PACKET_SNIPPETS),
        (args.readiness_script, "M246-D008-RDY-EXISTS", READINESS_SNIPPETS),
        (args.d007_readiness_script, "M246-D008-D007-RDY-EXISTS", D007_READINESS_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.d007_checker, "M246-D008-DEP-D007-ARG-01"),
        (args.d007_test, "M246-D008-DEP-D007-ARG-02"),
    ):
    ...
    if not summary_ok:
        print(
            f"[M246-D008-SUMMARY-WRITE-01] {display_path(summary_path)}: {summary_error}",
            file=sys.stderr,
        )
        return 1
