#!/usr/bin/env python3
"""Fail-closed checker for M235-E004 qualifier/generic conformance gate core feature expansion."""
...
MODE = "m235-e004-qualifier-generic-conformance-gate-core-feature-expansion-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_generic_conformance_gate_core_feature_expansion_e004_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_e004_qualifier_generic_conformance_gate_core_feature_expansion_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m235/M235-E004/local_check_summary.json")
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-E004-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-E004-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
