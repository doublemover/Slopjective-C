#!/usr/bin/env python3
"""Run M257-B003 lane-B readiness while preserving the live summary."""
...
def run_chain() -> int:
    print(
        ...
        f"{DEPENDENCY_TOKEN} (native build is refreshed first, then the B002 synthesis proof is replayed before the live B003 legality proof rewrites the final summary)",
        flush=True,
    )
    ...
    print("[ok] M257-B003 lane-B readiness chain completed", flush=True)
    return 0
