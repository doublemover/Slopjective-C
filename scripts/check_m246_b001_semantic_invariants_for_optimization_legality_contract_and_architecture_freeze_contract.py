#!/usr/bin/env python3
"""Fail-closed contract checker for the M246-B001 semantic invariants freeze."""
...
MODE = "m246-b001-semantic-invariants-optimization-legality-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m246_semantic_invariants_for_optimization_legality_contract_and_architecture_freeze_b001_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m246"
    / "m246_b001_semantic_invariants_for_optimization_legality_contract_and_architecture_freeze_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M246-B001-DOC-PKT-01",
        "# M246-B001 Semantic Invariants for Optimization Legality Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M246-B001-DOC-PKT-02", "Packet: `M246-B001`"),
    SnippetCheck("M246-B001-DOC-PKT-03", "Issue: `#5060`"),
    SnippetCheck("M246-B001-DOC-PKT-04", "Dependencies: none"),
    SnippetCheck(
        "M246-B001-DOC-PKT-05",
        "`check:objc3c:m246-b001-semantic-invariants-optimization-legality-contract`",
    ),
    SnippetCheck("M246-B001-DOC-PKT-06", "`compile:objc3c`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-B001-META-02",
        "semantic legality evidence and optimizer replay-budget continuity",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M246-B001-PKG-03",
        '"check:objc3c:m246-b001-lane-b-readiness": '
        '"npm run check:objc3c:m246-b001-semantic-invariants-optimization-legality-contract '
        '&& npm run test:tooling:m246-b001-semantic-invariants-optimization-legality-contract"',
    ),
    SnippetCheck("M246-B001-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M246-B001-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M246-B001-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M246-B001-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M246-B001-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M246-B001-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.architecture_doc, "M246-B001-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M246-B001-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M246-B001-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M246-B001-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
