#!/usr/bin/env python3
"""Fail-closed checker for M248-C006 replay harness/artifact edge-case expansion and robustness contract."""
...
MODE = "m248-c006-replay-harness-and-artifact-contracts-edge-case-expansion-and-robustness-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_c006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m248"
    / "m248_c006_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_packet.md"
)
DEFAULT_C005_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_replay_harness_and_artifact_contracts_edge_case_and_compatibility_completion_c005_expectations.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-C006/"
    "replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_contract_summary.json"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C006-DOC-PKT-01", "Packet: `M248-C006`"),
    SnippetCheck("M248-C006-DOC-PKT-02", "Issue: `#6822`"),
    SnippetCheck("M248-C006-DOC-PKT-03", "Dependencies: `M248-C005`"),
    SnippetCheck(
        "M248-C006-DOC-PKT-04",
        "`scripts/check_m248_c006_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck(
        "M248-C006-DOC-PKT-05",
        "`tests/tooling/test_check_m248_c006_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_contract.py`",
    ),
    SnippetCheck("M248-C006-DOC-PKT-06", "`check:objc3c:m248-c006-lane-c-readiness`"),
    SnippetCheck(
        "M248-C006-DOC-PKT-07",
        "`tmp/reports/m248/M248-C006/replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_contract_summary.json`",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-C006-CFG-03", "check:objc3c:m248-c006-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C006-CFG-04", "check:objc3c:m248-c005-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C006-CFG-05", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M248-C006-CFG-06", "test:objc3c:execution-replay-proof"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-c005-lane-c-readiness && npm run check:objc3c:m248-c006-replay-harness-artifact-contracts-edge-case-expansion-robustness-contract && npm run test:tooling:m248-c006-replay-harness-artifact-contracts-edge-case-expansion-robustness-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M248-C006-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M248-C006-DOC-PKT-00",
        snippets=PACKET_SNIPPETS,
    )
    checks_total += packet_checks
    findings.extend(packet_findings)

    c005_checks, c005_findings = check_doc_contract(
        artifact_name="c005_expectations_doc",
        path=args.c005_expectations_doc,
        exists_check_id="M248-C006-C005-DOC-00",
        snippets=C005_EXPECTATIONS_SNIPPETS,
    )
    checks_total += c005_checks
    findings.extend(c005_findings)
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M248-C006-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M248-C006-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M248-C006-META-00",
