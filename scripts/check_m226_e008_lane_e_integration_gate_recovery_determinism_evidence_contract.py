#!/usr/bin/env python3
"""Fail-closed validator for M226-E008 lane-E recovery determinism evidence."""
...
MODE = "m226-e008-lane-e-integration-gate-recovery-determinism-evidence-contract-v1"

DEFAULT_CONTRACT_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m226_lane_e_integration_gate_e008_recovery_determinism_evidence_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m226"
    / "m226_e008_lane_e_integration_gate_recovery_determinism_evidence_packet.md"
)
DEFAULT_EVIDENCE_DOC = (
    ...
    / "compiler"
    / "m226"
    / "m226_e008_lane_e_integration_gate_recovery_determinism_evidence_scaffold.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M226-E008-ASSET-01",
        Path("docs/contracts/m226_lane_e_integration_gate_e007_diagnostics_hardening_evidence_expectations.md"),
    ),
    AssetCheck(
        "M226-E008-ASSET-02",
        Path("docs/contracts/m226_parser_advanced_conformance_workpack_a024_expectations.md"),
    ),
    AssetCheck(
        "M226-E008-ASSET-03",
        Path("docs/contracts/m226_parser_sema_recovery_determinism_hardening_b008_expectations.md"),
    ),
    AssetCheck(
        "M226-E008-ASSET-04",
        Path("docs/contracts/m226_parse_lowering_recovery_determinism_hardening_c008_expectations.md"),
    ),
    AssetCheck(
        "M226-E008-ASSET-05",
        Path("docs/contracts/m226_frontend_build_invocation_recovery_determinism_hardening_d008_expectations.md"),
    ),
    AssetCheck(
        "M226-E008-ASSET-06",
        Path("scripts/check_m226_e008_lane_e_integration_gate_recovery_determinism_evidence_contract.py"),
    ),
    AssetCheck(
        "M226-E008-ASSET-07",
        Path("tests/tooling/test_check_m226_e008_lane_e_integration_gate_recovery_determinism_evidence_contract.py"),
    ),
)

CONTRACT_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E008-DOC-CON-01",
        "# M226 Lane E Integration Gate Recovery Determinism Evidence Expectations (E008)",
    ),
    SnippetCheck(
        "M226-E008-DOC-CON-02",
        "Contract ID: `objc3c-lane-e-integration-gate-recovery-determinism-evidence-contract/m226-e008-v1`",
    ),
    SnippetCheck(
        "M226-E008-DOC-CON-03",
...
FREEZE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E008-DOC-FRZ-01",
        "| `M226-E008` | `objc3c-lane-e-integration-gate-recovery-determinism-evidence-contract/m226-e008-v1` |",
    ),
    SnippetCheck("M226-E008-DOC-FRZ-02", "## Packet: `M226-E008`"),
    SnippetCheck(
        "M226-E008-DOC-FRZ-03",
        "`scripts/check_m226_e008_lane_e_integration_gate_recovery_determinism_evidence_contract.py`",
    ),
    SnippetCheck(
        "M226-E008-DOC-FRZ-04",
        "`tests/tooling/test_check_m226_e008_lane_e_integration_gate_recovery_determinism_evidence_contract.py`",
    ),
)
