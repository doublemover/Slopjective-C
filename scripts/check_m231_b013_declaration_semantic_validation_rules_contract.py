#!/usr/bin/env python3
"""Fail-closed checker for M231-B013 Declaration semantic validation rules contract freeze."""
...
MODE = "m231-b013-declaration-semantic-validation-rules-docs-and-operator-runbook-synchronization-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m231"
    / "m231_b013_declaration_semantic_validation_rules_docs_and_operator_runbook_synchronization_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M231-B013-DOC-PKT-01",
        "# M231-B013 Declaration Grammar Expansion and Normalization Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M231-B013-DOC-PKT-02", "Packet: `M231-B013`"),
    SnippetCheck("M231-B013-DOC-PKT-03", "Issue: `#5527`"),
    SnippetCheck("M231-B013-DOC-PKT-04", "Dependencies: `M231-B012`"),
    SnippetCheck(
        "M231-B013-DOC-PKT-05",
        "check:objc3c:m231-b013-declaration-semantic-validation-rules-docs-and-operator-runbook-synchronization-contract",
    ),
    SnippetCheck(
        "M231-B013-DOC-PKT-06",
        "tmp/reports/m231/M231-B013/declaration_semantic_validation_rules_docs_and_operator_runbook_synchronization_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M231-B013-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M231-B013-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M231-B013-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M231-B013-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M231-B013-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M231-B013-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
