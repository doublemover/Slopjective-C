#!/usr/bin/env python3
"""Fail-closed checker for M235-E014 qualifier/generic conformance gate release-candidate and replay dry-run."""
...
MODE = "m235-e014-qualifier-generic-conformance-gate-release-candidate-and-replay-dry-run-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_generic_conformance_gate_release_candidate_and_replay_dry_run_e014_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_e014_qualifier_generic_conformance_gate_release_candidate_and_replay_dry_run_packet.md"
)
DEFAULT_SUMMARY_OUT = Path("tmp/reports/m235/M235-E014/local_check_summary.json")
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-E014-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-E014-DOC-PKT-EXISTS", PACKET_SNIPPETS),
    ):
