#!/usr/bin/env python3
"""Fail-closed checker for M229-A010 class/protocol/category metadata conformance corpus expansion."""
...
MODE = "m229-a010-class-protocol-category-metadata-generation-conformance-corpus-expansion-contract-v1"
...
DEFAULT_A009_CHECKER = (
    ROOT / "scripts" / "check_m229_a009_class_protocol_category_metadata_generation_conformance_matrix_implementation_contract.py"
)
DEFAULT_A009_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m229_a009_class_protocol_category_metadata_generation_conformance_matrix_implementation_contract.py"
)
...
PREREQUISITE_ASSETS: tuple[tuple[str, Path], ...] = (
    (
        "M229-A010-DEP-A009-01",
        Path("docs/contracts/m229_class_protocol_category_metadata_generation_conformance_matrix_implementation_a009_expectations.md"),
    ),
    (
        "M229-A010-DEP-A009-02",
        Path("spec/planning/compiler/m229/m229_a009_class_protocol_category_metadata_generation_conformance_matrix_implementation_packet.md"),
    ),
    (
        "M229-A010-DEP-A009-03",
        Path("scripts/check_m229_a009_class_protocol_category_metadata_generation_conformance_matrix_implementation_contract.py"),
    ),
    (
        "M229-A010-DEP-A009-04",
        Path("tests/tooling/test_check_m229_a009_class_protocol_category_metadata_generation_conformance_matrix_implementation_contract.py"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A010-DOC-EXP-01",
        "# M229 Class/Protocol/Category Metadata Generation Conformance Corpus Expansion Expectations (A010)",
    ),
    SnippetCheck(
        "M229-A010-DOC-EXP-02",
        "Contract ID: `objc3c-class-protocol-category-metadata-generation-conformance-corpus-expansion/m229-a010-v1`",
    ),
    SnippetCheck("M229-A010-DOC-EXP-03", "Dependencies: `M229-A009`"),
    SnippetCheck(
        "M229-A010-DOC-EXP-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A010-DOC-EXP-05",
        "check:objc3c:m229-a010-class-protocol-category-metadata-generation-conformance-corpus-expansion-contract",
    ),
    SnippetCheck(
        "M229-A010-DOC-EXP-06",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-A010-DOC-PKT-01",
        "# M229-A010 Class/Protocol/Category Metadata Generation Conformance Corpus Expansion Packet",
    ),
    SnippetCheck("M229-A010-DOC-PKT-02", "Packet: `M229-A010`"),
    SnippetCheck("M229-A010-DOC-PKT-03", "Dependencies: `M229-A009`"),
    SnippetCheck(
        "M229-A010-DOC-PKT-04",
        "code/spec anchors and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M229-A010-DOC-PKT-05",
...
A009_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M229-A010-A009-PKT-01", "Packet: `M229-A009`"),
    SnippetCheck("M229-A010-A009-PKT-02", "Dependencies: `M229-A008`"),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m229-a010-class-protocol-category-metadata-generation-conformance-corpus-expansion-contract '
        '&& npm run test:tooling:m229-a010-class-protocol-category-metadata-generation-conformance-corpus-expansion-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M229-A010-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M229-A010-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a009_expectations_doc, "M229-A010-A009-EXP-EXISTS", A009_EXPECTATIONS_SNIPPETS),
        (args.a009_packet_doc, "M229-A010-A009-PKT-EXISTS", A009_PACKET_SNIPPETS),
        (args.architecture_doc, "M229-A010-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M229-A010-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M229-A010-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M229-A010-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
