...
def main() -> int:
    ...
    expect(command_surfaces.get("build_playground") == "npm run objc3c -- materialize-playground-workspace", "package manifest missing build_playground command surface")
    ...
    expect(command_surfaces.get("inspect_playground") == "npm run objc3c -- inspect-playground-repro", "package manifest missing inspect_playground command surface")
    ...
    expect(command_surfaces.get("inspect_capabilities") == "npm run objc3c -- inspect-capability-explorer", "package manifest missing inspect_capabilities command surface")
    expect(command_surfaces.get("inspect_runtime") == "npm run objc3c -- inspect-runtime-inspector", "package manifest missing inspect_runtime command surface")
    expect(command_surfaces.get("trace_stages") == "npm run objc3c -- trace-compile-stages", "package manifest missing trace_stages command surface")
    expect(command_surfaces.get("developer_tooling") == "npm run objc3c -- validate-developer-tooling", "package manifest missing developer_tooling command surface")
    expect(command_surfaces.get("getting_started") == "npm run objc3c -- validate-getting-started", "package manifest missing getting_started command surface")
