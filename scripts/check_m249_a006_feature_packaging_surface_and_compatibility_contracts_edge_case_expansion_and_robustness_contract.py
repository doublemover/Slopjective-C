#!/usr/bin/env python3
"""Fail-closed checker for M249-A006 feature packaging edge-case expansion and robustness."""
...
MODE = "m249-a006-feature-packaging-surface-compatibility-edge-case-expansion-and-robustness-contract-v1"
...
DEFAULT_A005_CHECKER = (
    ROOT / "scripts" / "check_m249_a005_feature_packaging_surface_and_compatibility_contracts_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_A005_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m249_a005_feature_packaging_surface_and_compatibility_contracts_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_RUNNER_SCRIPT = ROOT / "scripts" / "run_m249_a006_lane_a_readiness.py"
DEFAULT_ARCHITECTURE_DOC = ROOT / "native" / "objc3c" / "src" / "ARCHITECTURE.md"
DEFAULT_LOWERING_SPEC = ROOT / "spec" / "LOWERING_AND_RUNTIME_CONTRACTS.md"
DEFAULT_METADATA_SPEC = ROOT / "spec" / "MODULE_METADATA_AND_ABI_TABLES.md"
DEFAULT_PACKAGE_JSON = ROOT / "package.json"
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m249/M249-A006/"
    "feature_packaging_surface_and_compatibility_contracts_edge_case_expansion_and_robustness_summary.json"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-A006-DOC-PKT-01",
        "# M249-A006 Feature Packaging Surface and Compatibility Contracts Edge-Case Expansion and Robustness Packet",
    ),
    SnippetCheck("M249-A006-DOC-PKT-02", "Packet: `M249-A006`"),
    SnippetCheck("M249-A006-DOC-PKT-03", "Dependencies: `M249-A005`"),
    SnippetCheck(
        "M249-A006-DOC-PKT-04",
        "edge-case expansion and robustness prerequisites",
    ),
    SnippetCheck(
        "M249-A006-DOC-PKT-05",
    ...
    SnippetCheck(
        "M249-A006-DOC-PKT-07",
        "scripts/run_m249_a006_lane_a_readiness.py",
    ),
    SnippetCheck("M249-A006-DOC-PKT-08", "`npm run check:objc3c:m249-a006-lane-a-readiness`"),
    SnippetCheck("M249-A006-DOC-PKT-09", "`check:objc3c:m249-a005-lane-a-readiness`"),
)

A005_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-A006-A005-DOC-01",
        "# M249 Feature Packaging Surface and Compatibility Contracts Edge-Case and Compatibility Completion Expectations (A005)",
    ),
    SnippetCheck(
        "M249-A006-A005-DOC-02",
        "Contract ID: `objc3c-feature-packaging-surface-compatibility-contracts-edge-case-and-compatibility-completion/m249-a005-v1`",
    ),
    SnippetCheck("M249-A006-A005-DOC-03", "Dependencies: `M249-A004`"),
)

A005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M249-A006-A005-PKT-01", "Packet: `M249-A005`"),
    SnippetCheck("M249-A006-A005-PKT-02", "Dependencies: `M249-A004`"),
    SnippetCheck("M249-A006-A005-PKT-03", "scripts/run_m249_a005_lane_a_readiness.py"),
)
...
RUNNER_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-A006-RUN-04",
        "M249-A006 lane-A readiness chain completed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M249-A006-PKG-03",
        '"check:objc3c:m249-a006-lane-a-readiness": "python scripts/run_m249_a006_lane_a_readiness.py"',
    ),
    SnippetCheck("M249-A006-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M249-A006-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-A006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-A006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.a005_expectations_doc, "M249-A006-A005-DOC-EXISTS", A005_EXPECTATIONS_SNIPPETS),
        (args.a005_packet_doc, "M249-A006-A005-PKT-EXISTS", A005_PACKET_SNIPPETS),
        (args.runner_script, "M249-A006-RUN-EXISTS", RUNNER_SNIPPETS),
        (args.architecture_doc, "M249-A006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-A006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-A006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-A006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.a005_checker, "M249-A006-DEP-A005-ARG-01"),
        (args.a005_test, "M249-A006-DEP-A005-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
