#!/usr/bin/env python3
"""Fail-closed contract checker for the M245-B005 semantic parity/platform constraints edge-case and compatibility completion packet."""
...
MODE = "m245-b005-semantic-parity-platform-constraints-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_B004_CHECKER = (
    ROOT / "scripts" / "check_m245_b004_semantic_parity_and_platform_constraints_core_feature_expansion_contract.py"
)
DEFAULT_B004_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m245_b004_semantic_parity_and_platform_constraints_core_feature_expansion_contract.py"
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M245-B005-DOC-EXP-09",
        "milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-B005-DOC-EXP-10",
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B005-DOC-PKT-01",
        "# M245-B005 Semantic Parity and Platform Constraints Edge-Case and Compatibility Completion Packet",
    ),
    SnippetCheck("M245-B005-DOC-PKT-02", "Packet: `M245-B005`"),
    SnippetCheck("M245-B005-DOC-PKT-03", "Issue: `#6627`"),
    SnippetCheck("M245-B005-DOC-PKT-04", "Dependencies: `M245-B004`"),
    SnippetCheck(
        "M245-B005-DOC-PKT-05",
        "`scripts/check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M245-B005-DOC-PKT-06",
        "`tests/tooling/test_check_m245_b005_semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M245-B005-DOC-PKT-07",
        "`scripts/check_m245_b004_semantic_parity_and_platform_constraints_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M245-B005-DOC-PKT-08",
        "`tests/tooling/test_check_m245_b004_semantic_parity_and_platform_constraints_core_feature_expansion_contract.py`",
    ),
    SnippetCheck(
        "M245-B005-DOC-PKT-09",
        "dependency surfaces and milestone optimization improvements as mandatory scope inputs.",
    ),
    SnippetCheck(
        "M245-B005-DOC-PKT-10",
        "`tmp/reports/m245/M245-B005/semantic_parity_and_platform_constraints_edge_case_and_compatibility_completion_summary.json`",
    ),
)
...
B004_EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M245-B005-B004-DOC-01",
        "Contract ID: `objc3c-semantic-parity-platform-constraints-core-feature-expansion/m245-b004-v1`",
    ),
    SnippetCheck("M245-B005-B004-DOC-02", "- Issue: `#6626`"),
    SnippetCheck("M245-B005-B004-DOC-03", "- Dependencies: `M245-B003`"),
    SnippetCheck(
        "M245-B005-B004-DOC-04",
        "scripts/check_m245_b004_semantic_parity_and_platform_constraints_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-B005-B004-DOC-05",
...
B004_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M245-B005-B004-PKT-01", "Packet: `M245-B004`"),
    SnippetCheck("M245-B005-B004-PKT-02", "Issue: `#6626`"),
    SnippetCheck("M245-B005-B004-PKT-03", "Dependencies: `M245-B003`"),
    SnippetCheck(
        "M245-B005-B004-PKT-04",
        "scripts/check_m245_b004_semantic_parity_and_platform_constraints_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-B005-B004-PKT-05",
        "tests/tooling/test_check_m245_b004_semantic_parity_and_platform_constraints_core_feature_expansion_contract.py",
    ),
    SnippetCheck(
        "M245-B005-B004-PKT-06",
        "tmp/reports/m245/M245-B004/semantic_parity_and_platform_constraints_core_feature_expansion_summary.json",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M245-B005-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M245-B005-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b004_expectations_doc, "M245-B005-B004-DOC-EXISTS", B004_EXPECTATIONS_SNIPPETS),
        (args.b004_packet_doc, "M245-B005-B004-PKT-EXISTS", B004_PACKET_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b004_checker, "M245-B005-DEP-B004-ARG-01"),
        (args.b004_test, "M245-B005-DEP-B004-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
