#!/usr/bin/env python3
"""Fail-closed checker for M248-A011 suite partitioning performance and quality guardrails contract."""
...
MODE = "m248-a011-suite-partitioning-fixture-ownership-performance-and-quality-guardrails-contract-v1"
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-A011/"
    "suite_partitioning_and_fixture_ownership_performance_and_quality_guardrails_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    ...
    AssetCheck(
        ...
        Path(
            ...
            "m248_a010_suite_partitioning_and_fixture_ownership_conformance_corpus_expansion_packet.md"
        ),
    ),
    AssetCheck(
        "M248-A011-A010-03",
    ...
    AssetCheck(
        ...
        Path(
            "tests/tooling/"
            "test_check_m248_a010_suite_partitioning_and_fixture_ownership_conformance_corpus_expansion_contract.py"
        ),
    ),
)
...
EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-A011-DOC-EXP-01",
        "Contract ID: `objc3c-suite-partitioning-and-fixture-ownership-performance-and-quality-guardrails/m248-a011-v1`",
    ),
    SnippetCheck("M248-A011-DOC-EXP-02", "Dependencies: `M248-A010`"),
    SnippetCheck(
        "M248-A011-DOC-EXP-03",
        "Issue `#6798` defines canonical lane-A performance and quality guardrails scope.",
    ),
    SnippetCheck("M248-A011-DOC-EXP-04", "`check:objc3c:m248-a011-lane-a-readiness`"),
    SnippetCheck("M248-A011-DOC-EXP-05", "`check:objc3c:m248-a010-lane-a-readiness`"),
    SnippetCheck("M248-A011-DOC-EXP-06", "`test:objc3c:parser-replay-proof`"),
    SnippetCheck("M248-A011-DOC-EXP-07", "`test:objc3c:parser-ast-extraction`"),
    SnippetCheck(
        "M248-A011-DOC-EXP-08",
    ...
    SnippetCheck(
        "M248-A011-DOC-EXP-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-A011-DOC-PKT-01", "Packet: `M248-A011`"),
    SnippetCheck("M248-A011-DOC-PKT-02", "Issue: `#6798`"),
    SnippetCheck("M248-A011-DOC-PKT-03", "Dependencies: `M248-A010`"),
    SnippetCheck(
        "M248-A011-DOC-PKT-04",
        "`scripts/check_m248_a011_suite_partitioning_and_fixture_ownership_performance_and_quality_guardrails_contract.py`",
    ),
    SnippetCheck(
        "M248-A011-DOC-PKT-05",
    ...
    SnippetCheck("M248-A011-DOC-PKT-06", "`check:objc3c:m248-a011-lane-a-readiness`"),
    SnippetCheck("M248-A011-DOC-PKT-07", "`test:objc3c:parser-replay-proof`"),
    SnippetCheck("M248-A011-DOC-PKT-08", "`test:objc3c:parser-ast-extraction`"),
    SnippetCheck(
        "M248-A011-DOC-PKT-09",
        "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-A011-PKG-03", "check:objc3c:m248-a011-lane-a-readiness"),
    PackageScriptKeyCheck("M248-A011-PKG-04", "test:objc3c:parser-replay-proof"),
    PackageScriptKeyCheck("M248-A011-PKG-05", "test:objc3c:parser-ast-extraction"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-a010-lane-a-readiness && npm run check:objc3c:m248-a011-suite-partitioning-fixture-ownership-performance-and-quality-guardrails-contract && npm run test:tooling:m248-a011-suite-partitioning-fixture-ownership-performance-and-quality-guardrails-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for artifact_name, path, exists_check_id, snippets in (
        ("expectations_doc", args.expectations_doc, "M248-A011-DOC-EXP-00", EXPECTATIONS_SNIPPETS),
        ("packet_doc", args.packet_doc, "M248-A011-DOC-PKT-00", PACKET_SNIPPETS),
        ("architecture_doc", args.architecture_doc, "M248-A011-ARCH-00", ARCHITECTURE_SNIPPETS),
        ("lowering_spec", args.lowering_spec, "M248-A011-SPC-00", LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", args.metadata_spec, "M248-A011-META-00", METADATA_SPEC_SNIPPETS),
    ):
