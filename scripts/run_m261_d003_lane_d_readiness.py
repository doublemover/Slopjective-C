#!/usr/bin/env python3
"""Run the focused M261-D003 lane-D readiness chain."""
...
def main() -> int:
    ...
    run([
        ...
        "-m",
        "pytest",
        "tests/tooling/test_check_m261_d003_byref_forwarding_cells_heap_promotion_and_ownership_interop_for_escaping_blocks_core_feature_expansion.py",
        "-q",
    ])
    return 0
