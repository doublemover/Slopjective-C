#!/usr/bin/env python3
"""Fail-closed checker for M234-C006 accessor and ivar lowering edge-case expansion and robustness."""
...
MODE = "m234-c006-accessor-and-ivar-lowering-contracts-edge-case-expansion-and-robustness-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m234_accessor_and_ivar_lowering_contracts_edge_case_expansion_and_robustness_c006_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m234"
    / "m234_c006_accessor_and_ivar_lowering_contracts_edge_case_expansion_and_robustness_packet.md"
)
...
DEFAULT_C005_CHECKER = (
    ROOT / "scripts" / "check_m234_c005_accessor_and_ivar_lowering_contracts_edge_case_and_compatibility_completion_contract.py"
)
DEFAULT_C005_TEST = (
    ROOT
    / "tests"
    / "tooling"
    / "test_check_m234_c005_accessor_and_ivar_lowering_contracts_edge_case_and_compatibility_completion_contract.py"
)
...
C005_PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M234-C006-C005-PKT-01", "Packet: `M234-C005`"),
    SnippetCheck("M234-C006-C005-PKT-02", "Dependencies: `M234-C004`"),
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M234-C006-META-02",
        "explicit `M234-C005` dependency continuity so edge-case expansion and robustness drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m234-c006-accessor-and-ivar-lowering-contracts-edge-case-expansion-and-robustness-contract '
        '&& npm run test:tooling:m234-c006-accessor-and-ivar-lowering-contracts-edge-case-expansion-and-robustness-contract"',
    ),
    SnippetCheck("M234-C006-PKG-04", '"compile:objc3c": '),
    SnippetCheck("M234-C006-PKG-05", '"proof:objc3c": '),
    SnippetCheck("M234-C006-PKG-06", '"test:objc3c:execution-replay-proof": '),
    SnippetCheck("M234-C006-PKG-07", '"test:objc3c:perf-budget": '),
)
...
def run(argv: Sequence[str] | None = None) -> int:
    ...
    for path, exists_id, snippets in (
        (args.expectations_doc, "M234-C006-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M234-C006-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c005_expectations_doc, "M234-C006-C005-DOC-EXISTS", C005_EXPECTATIONS_SNIPPETS),
        (args.c005_packet_doc, "M234-C006-C005-PKT-EXISTS", C005_PACKET_SNIPPETS),
        (args.architecture_doc, "M234-C006-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M234-C006-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M234-C006-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M234-C006-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.c005_checker, "M234-C006-C005-CHECKER-EXISTS"),
        (args.c005_test, "M234-C006-C005-TEST-EXISTS"),
    ):
