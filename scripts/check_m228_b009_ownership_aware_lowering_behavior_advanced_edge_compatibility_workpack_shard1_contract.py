#!/usr/bin/env python3
"""Fail-closed validator for M228-B016 ownership-aware lowering advanced edge compatibility workpack (shard 1) contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "b015_contract_doc": ROOT
    / "docs"
    / "contracts"
    / "m228_ownership_aware_lowering_behavior_advanced_core_workpack_shard1_b015_expectations.md",
    "b015_checker": ROOT
    / "scripts"
    / "check_m228_b015_ownership_aware_lowering_behavior_advanced_core_workpack_shard1_contract.py",
    "b015_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_b015_ownership_aware_lowering_behavior_advanced_core_workpack_shard1_contract.py",
    "b015_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "contract_doc": (
        ...
        ("M228-B016-DOC-02", "Execute issue `#5210`"),
        ("M228-B016-DOC-03", "Dependencies: `M228-B015`"),
        (
            "M228-B016-DOC-04",
            "Code/spec anchors and milestone optimization improvements are mandatory scope inputs.",
        ),
        ("M228-B016-DOC-05", "`docs/runbooks/m228_wave_execution_runbook.md`"),
        (
            "M228-B016-DOC-06",
        ...
        ("M228-B016-DOC-08", "`npm run check:objc3c:m228-b016-lane-b-readiness`"),
        (
            "M228-B016-DOC-09",
    ...
    "runbook_doc": (
        ...
        ("M228-B016-RUN-06", "npm run check:objc3c:m228-b016-lane-b-readiness"),
        ("M228-B016-RUN-07", "tmp/reports/m228/"),
    ),
    "planning_packet": (
        ("M228-B016-PKT-01", "Packet: `M228-B016`"),
        ("M228-B016-PKT-02", "Issue: `#5210`"),
        ("M228-B016-PKT-03", "Dependencies: `M228-B015`"),
        ("M228-B016-PKT-04", "docs/runbooks/m228_wave_execution_runbook.md"),
        (
            "M228-B016-PKT-05",
            "scripts/check_m228_b016_ownership_aware_lowering_behavior_advanced_edge_compatibility_workpack_shard1_contract.py",
        ),
        ...
        ("M228-B016-PKT-07", "check:objc3c:m228-b016-lane-b-readiness"),
        (
            "M228-B016-PKT-08",
            "tmp/reports/m228/M228-B016/ownership_aware_lowering_behavior_advanced_edge_compatibility_workpack_shard1_contract_summary.json",
        ),
    ...
    "b015_tooling_test": (
        ("M228-B016-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "b015_packet_doc": (
        ("M228-B016-DEP-04", "Packet: `M228-B015`"),
        ("M228-B016-DEP-05", "Issue: `#5209`"),
    ),
    "package_json": (
        ("M228-B016-PKG-01", '"check:objc3c:m228-b015-lane-b-readiness"'),
        (
            "M228-B016-PKG-02",
        ...
        ("M228-B016-PKG-04", '"check:objc3c:m228-b016-lane-b-readiness"'),
        (
            "M228-B016-PKG-05",
            '"check:objc3c:m228-b016-lane-b-readiness": "npm run check:objc3c:m228-b015-lane-b-readiness &&',
        ),
        (
            "M228-B016-PKG-06",
            "scripts/check_m228_b016_ownership_aware_lowering_behavior_advanced_edge_compatibility_workpack_shard1_contract.py",
        ...
        (
            "M228-B016-PKG-07",
            "tests/tooling/test_check_m228_b016_ownership_aware_lowering_behavior_advanced_edge_compatibility_workpack_shard1_contract.py -q",
        ),
        ("M228-B016-PKG-08", '"compile:objc3c"'),
        ("M228-B016-PKG-09", '"proof:objc3c"'),
        ("M228-B016-PKG-10", '"test:objc3c:execution-smoke"'),
        ("M228-B016-PKG-11", '"test:objc3c:lowering-replay-proof"'),
    ),
    "architecture_doc": (
        (
            "M228-B016-ARC-01",
    ...
    "metadata_spec": (
        ...
        (
            "M228-B016-META-02",
            "advanced-edge-compatibility-shard1 metadata anchors for `M228-B016`",
        ),
        (
            "M228-B016-META-03",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-B016-FORB-01",
            '"check:objc3c:m228-b016-lane-b-readiness": "npm run check:objc3c:m228-b014-lane-b-readiness',
        ),
    ),
}
