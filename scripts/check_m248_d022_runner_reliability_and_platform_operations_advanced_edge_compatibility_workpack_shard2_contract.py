#!/usr/bin/env python3
"""Fail-closed validator for M248-D022 runner/platform advanced edge compatibility workpack (shard 2)."""
...
MODE = "m248-runner-reliability-platform-operations-advanced-edge-compatibility-workpack-shard2-contract-d022-v1"
...
ARTIFACTS: dict[str, Path] = {
    ...
    / "compiler"
    / "m248"
    / "m248_d022_runner_reliability_and_platform_operations_advanced_edge_compatibility_workpack_shard2_packet.md",
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "contract_doc": (
        ...
        ("M248-D022-DOC-06", "npm run check:objc3c:m248-d022-lane-d-readiness"),
    ),
    "packet_doc": (
        ("M248-D022-PKT-01", "Packet: `M248-D022`"),
        ("M248-D022-PKT-02", "Dependencies: `M248-D021`"),
        ("M248-D022-PKT-03", "Issue: `#6857`"),
        (
            "M248-D022-PKT-04",
            "scripts/check_m248_d022_runner_reliability_and_platform_operations_advanced_edge_compatibility_workpack_shard2_contract.py",
        ),
    ...
    "package_json": (
        (
            "M248-D022-CFG-01",
            '"check:objc3c:m248-d022-runner-reliability-platform-operations-advanced-edge-compatibility-workpack-shard2-contract"',
        ),
        (
            "M248-D022-CFG-02",
            '"test:tooling:m248-d022-runner-reliability-platform-operations-advanced-edge-compatibility-workpack-shard2-contract"',
        ),
        ("M248-D022-CFG-03", '"check:objc3c:m248-d022-lane-d-readiness"'),
        ("M248-D022-CFG-04", "python scripts/run_m248_d022_lane_d_readiness.py"),
    ),
}
