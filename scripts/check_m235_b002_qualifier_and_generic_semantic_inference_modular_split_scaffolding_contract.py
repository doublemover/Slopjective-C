#!/usr/bin/env python3
"""Fail-closed checker for M235-B002 qualifier/generic semantic inference modular split/scaffolding."""
...
MODE = "m235-b002-qualifier-and-generic-semantic-inference-modular-split-scaffolding-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_modular_split_scaffolding_b002_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m235"
    / "m235_b002_qualifier_and_generic_semantic_inference_modular_split_scaffolding_packet.md"
)
DEFAULT_B001_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m235_qualifier_and_generic_semantic_inference_contract_and_architecture_freeze_b001_expectations.md"
)
DEFAULT_B001_PACKET_DOC = (
    ...
    / "compiler"
    / "m235"
    / "m235_b001_qualifier_and_generic_semantic_inference_contract_and_architecture_freeze_packet.md"
)
DEFAULT_B001_CHECKER = (
    ROOT / "scripts" / "check_m235_b001_qualifier_and_generic_semantic_inference_contract.py"
)
DEFAULT_B001_TEST = (
    ROOT / "tests" / "tooling" / "test_check_m235_b001_qualifier_and_generic_semantic_inference_contract.py"
)
...
METADATA_SPEC_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B002-META-02",
        "explicit `M235-B001` dependency continuity so nullability/generics/qualifier semantic-inference scaffolding drift fails closed",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M235-B002-PKG-02",
        '"test:tooling:m235-b002-qualifier-and-generic-semantic-inference-modular-split-scaffolding-contract": '
    ...
    SnippetCheck(
        "M235-B002-PKG-03",
        '"check:objc3c:m235-b002-lane-b-readiness": '
        '"npm run check:objc3c:m235-b001-lane-b-readiness '
        '&& npm run check:objc3c:m235-b002-qualifier-and-generic-semantic-inference-modular-split-scaffolding-contract '
        '&& npm run test:tooling:m235-b002-qualifier-and-generic-semantic-inference-modular-split-scaffolding-contract"',
    ),
    SnippetCheck("M235-B002-PKG-04", '"test:objc3c:parser-replay-proof": '),
    SnippetCheck("M235-B002-PKG-05", '"test:objc3c:parser-ast-extraction": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M235-B002-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M235-B002-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.b001_expectations_doc, "M235-B002-B001-DOC-EXISTS", B001_EXPECTATIONS_SNIPPETS),
        (args.b001_packet_doc, "M235-B002-B001-PKT-EXISTS", B001_PACKET_SNIPPETS),
        (args.architecture_doc, "M235-B002-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M235-B002-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M235-B002-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M235-B002-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
    ...
    for path, check_id in (
        (args.b001_checker, "M235-B002-DEP-B001-ARG-01"),
        (args.b001_test, "M235-B002-DEP-B001-ARG-02"),
    ):
        checks_total += 1
        if not path.exists():
            failures.append(
