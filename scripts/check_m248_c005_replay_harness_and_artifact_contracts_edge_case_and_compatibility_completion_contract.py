#!/usr/bin/env python3
"""Fail-closed checker for M248-C005 replay harness/artifact edge-case compatibility completion contract."""
...
MODE = "m248-c005-replay-harness-and-artifact-contracts-edge-case-and-compatibility-completion-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m248"
    / "m248_c005_replay_harness_and_artifact_contracts_edge_case_and_compatibility_completion_packet.md"
)
DEFAULT_C004_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m248_replay_harness_and_artifact_contracts_core_feature_expansion_c004_expectations.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-C005/"
    "replay_harness_and_artifact_contracts_edge_case_and_compatibility_completion_contract_summary.json"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C005-DOC-PKT-01", "Packet: `M248-C005`"),
    SnippetCheck("M248-C005-DOC-PKT-02", "Issue: `#6821`"),
    SnippetCheck("M248-C005-DOC-PKT-03", "Dependencies: `M248-C004`"),
    SnippetCheck(
        "M248-C005-DOC-PKT-04",
        "`scripts/check_m248_c005_replay_harness_and_artifact_contracts_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M248-C005-DOC-PKT-05",
        "`tests/tooling/test_check_m248_c005_replay_harness_and_artifact_contracts_edge_case_and_compatibility_completion_contract.py`",
    ),
    SnippetCheck(
        "M248-C005-DOC-PKT-06",
        "`tmp/reports/m248/M248-C005/replay_harness_and_artifact_contracts_edge_case_and_compatibility_completion_contract_summary.json`",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-C005-CFG-03", "check:objc3c:m248-c005-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C005-CFG-04", "check:objc3c:m248-c004-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C005-CFG-05", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M248-C005-CFG-06", "test:objc3c:execution-replay-proof"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-c004-lane-c-readiness && npm run check:objc3c:m248-c005-replay-harness-artifact-contracts-edge-case-and-compatibility-completion-contract && npm run test:tooling:m248-c005-replay-harness-artifact-contracts-edge-case-and-compatibility-completion-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M248-C005-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M248-C005-DOC-PKT-00",
        snippets=PACKET_SNIPPETS,
    )
    checks_total += packet_checks
    findings.extend(packet_findings)

    c004_checks, c004_findings = check_doc_contract(
        artifact_name="c004_expectations_doc",
        path=args.c004_expectations_doc,
        exists_check_id="M248-C005-C004-DOC-00",
        snippets=C004_EXPECTATIONS_SNIPPETS,
    )
    checks_total += c004_checks
    findings.extend(c004_findings)
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M248-C005-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M248-C005-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M248-C005-META-00",
