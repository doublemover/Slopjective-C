#!/usr/bin/env python3
"""Fail-closed contract checker for M249-C003 IR/object packaging core feature implementation."""
...
MODE = "m249-c003-ir-object-packaging-symbol-policy-core-feature-implementation-contract-v1"

DEFAULT_EXPECTATIONS_DOC = (
    ROOT
    / "docs"
    / "contracts"
    / "m249_ir_object_packaging_and_symbol_policy_core_feature_implementation_c003_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m249"
    / "m249_c003_ir_object_packaging_and_symbol_policy_core_feature_implementation_packet.md"
)
...
DEFAULT_C002_EXPECTATIONS_DOC = (
    ...
    / "docs"
    / "contracts"
    / "m249_ir_object_packaging_and_symbol_policy_modular_split_scaffolding_c002_expectations.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m249/M249-C003/"
    "ir_object_packaging_and_symbol_policy_core_feature_implementation_contract_summary.json"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M249-C003-DOC-PKT-01",
        "# M249-C003 IR/Object Packaging and Symbol Policy Core Feature Implementation Packet",
    ),
    SnippetCheck("M249-C003-DOC-PKT-02", "Packet: `M249-C003`"),
    SnippetCheck(
        "M249-C003-DOC-PKT-03",
        "Dependencies: `M249-C001`, `M249-C002`",
    ),
    SnippetCheck(
        "M249-C003-DOC-PKT-04",
        "m249_c002_ir_object_packaging_and_symbol_policy_modular_split_scaffolding_packet.md",
    ),
    SnippetCheck(
        "M249-C003-DOC-PKT-05",
        "`check:objc3c:m249-c003-lane-c-readiness`",
    ),
    SnippetCheck(
        "M249-C003-DOC-PKT-06",
        "`test:objc3c:execution-replay-proof`",
    ),
    SnippetCheck(
        "M249-C003-DOC-PKT-07",
        "code/spec anchors, and milestone optimization improvements treated as mandatory",
    ),
    SnippetCheck(
        "M249-C003-DOC-PKT-08",
        "scope inputs.",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        ...
        '&& npm run check:objc3c:m249-c003-ir-object-packaging-symbol-policy-core-feature-implementation-contract '
        '&& npm run test:tooling:m249-c003-ir-object-packaging-symbol-policy-core-feature-implementation-contract"',
    ),
    SnippetCheck("M249-C003-PKG-04", '"test:objc3c:lowering-replay-proof": '),
    SnippetCheck("M249-C003-PKG-05", '"test:objc3c:execution-replay-proof": '),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    for path, exists_check_id, snippets in (
        (args.expectations_doc, "M249-C003-DOC-EXP-EXISTS", EXPECTATIONS_SNIPPETS),
        (args.packet_doc, "M249-C003-DOC-PKT-EXISTS", PACKET_SNIPPETS),
        (args.c001_expectations_doc, "M249-C003-C001-EXISTS", C001_EXPECTATIONS_SNIPPETS),
        (args.c002_expectations_doc, "M249-C003-C002-EXISTS", C002_EXPECTATIONS_SNIPPETS),
        (args.architecture_doc, "M249-C003-ARCH-EXISTS", ARCHITECTURE_SNIPPETS),
        (args.lowering_spec, "M249-C003-SPC-EXISTS", LOWERING_SPEC_SNIPPETS),
        (args.metadata_spec, "M249-C003-META-EXISTS", METADATA_SPEC_SNIPPETS),
        (args.package_json, "M249-C003-PKG-EXISTS", PACKAGE_SNIPPETS),
    ):
