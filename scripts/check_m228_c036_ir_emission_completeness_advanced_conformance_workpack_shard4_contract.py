#!/usr/bin/env python3
"""Fail-closed validator for M228-C036 IR-emission advanced integration shard1 contract."""
...
ARTIFACTS: dict[str, Path] = {
    ...
    "c035_tooling_test": ROOT
    / "tests"
    / "tooling"
    / "test_check_m228_c035_ir_emission_completeness_advanced_diagnostics_workpack_shard4_contract.py",
    "c035_packet_doc": ROOT
    / "spec"
    / "planning"
    / "compiler"
    / "m228"
...
REQUIRED_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "runbook_doc": (
        ...
        ("M228-C036-RUN-04", "npm run check:objc3c:m228-c036-lane-c-readiness"),
    ),
    "architecture_doc": (
        (
            "M228-C036-ARC-01",
    ...
    "package_json": (
        ("M228-C036-PKG-01", '"check:objc3c:m228-c035-lane-c-readiness"'),
        (
            "M228-C036-PKG-02",
            '"check:objc3c:m228-c036-ir-emission-completeness-advanced-conformance-workpack-shard4-contract"',
        ),
        (
            "M228-C036-PKG-03",
            '"test:tooling:m228-c036-ir-emission-completeness-advanced-conformance-workpack-shard4-contract"',
        ),
        ("M228-C036-PKG-04", '"check:objc3c:m228-c036-lane-c-readiness"'),
        (
            "M228-C036-PKG-05",
            '"check:objc3c:m228-c036-lane-c-readiness": "npm run check:objc3c:m228-c035-lane-c-readiness &&',
        ),
    ),
    "c035_contract_doc": (
        (
    ...
    "c035_tooling_test": (
        ("M228-C036-DEP-03", "def test_contract_passes_on_repository_sources"),
    ),
    "c035_packet_doc": (
        ("M228-C036-DEP-04", "Packet: `M228-C035`"),
        ("M228-C036-DEP-05", "Issue: `#5261`"),
    ),
    "contract_doc": (
        (
            "M228-C036-DOC-01",
        ...
        ("M228-C036-DOC-02", "Execute issue `#5262`"),
        ("M228-C036-DOC-03", "Dependencies: `M228-C035`"),
        (
            "M228-C036-DOC-04",
            "BuildObjc3IREmissionCoreFeatureAdvancedIntegrationShard1Key",
        ),
    ...
    "packet_doc": (
        ...
        ("M228-C036-PKT-02", "Packet: `M228-C036`"),
        ("M228-C036-PKT-03", "Issue: `#5262`"),
        ("M228-C036-PKT-04", "Dependencies: `M228-C035`"),
        (
            "M228-C036-PKT-05",
...
FORBIDDEN_SNIPPETS: dict[str, tuple[tuple[str, str], ...]] = {
    "package_json": (
        (
            "M228-C036-FORB-01",
            '"check:objc3c:m228-c036-lane-c-readiness": "npm run check:objc3c:m228-c017-lane-c-readiness',
        ),
    ),
}
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "tmp/reports/m228/M228-C036/"
            "ir_emission_completeness_advanced_conformance_workpack_shard4_contract_summary.json"
        ),
    )
