#!/usr/bin/env python3
"""Fail-closed checker for M248-C007 replay harness/artifact diagnostics hardening contract."""
...
MODE = "m248-c007-replay-harness-and-artifact-contracts-diagnostics-hardening-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m248"
    / "m248_c007_replay_harness_and_artifact_contracts_diagnostics_hardening_packet.md"
)
...
DEFAULT_SUMMARY_OUT = Path(
    "tmp/reports/m248/M248-C007/"
    "replay_harness_and_artifact_contracts_diagnostics_hardening_contract_summary.json"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M248-C007-C006-01",
        "M248-C006",
        Path("docs/contracts/m248_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_c006_expectations.md"),
    ),
    AssetCheck(
        "M248-C007-C006-02",
        "M248-C006",
        Path("scripts/check_m248_c006_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_contract.py"),
    ),
    AssetCheck(
        "M248-C007-C006-03",
        "M248-C006",
        Path("tests/tooling/test_check_m248_c006_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_contract.py"),
    ),
    AssetCheck(
        "M248-C007-C006-04",
        "M248-C006",
        Path("spec/planning/compiler/m248/m248_c006_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_packet.md"),
    ),
)

EXPECTATIONS_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M248-C007-DOC-EXP-01",
        "Contract ID: `objc3c-replay-harness-artifact-contracts-diagnostics-hardening/m248-c007-v1`",
    ),
    SnippetCheck("M248-C007-DOC-EXP-02", "Dependencies: `M248-C006`"),
    SnippetCheck(
        "M248-C007-DOC-EXP-02A",
        "Scope: lane-C replay harness/artifact diagnostics hardening governance with fail-closed continuity from C006.",
    ),
    SnippetCheck(
        "M248-C007-DOC-EXP-03",
        "Issue `#6823` defines canonical lane-C diagnostics hardening scope.",
    ),
    SnippetCheck("M248-C007-DOC-EXP-04", "`check:objc3c:m248-c007-lane-c-readiness`"),
    SnippetCheck("M248-C007-DOC-EXP-05", "`check:objc3c:m248-c006-lane-c-readiness`"),
    SnippetCheck(
        "M248-C007-DOC-EXP-06",
        "`scripts/check_m248_c007_replay_harness_and_artifact_contracts_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-C007-DOC-EXP-07",
        "`tests/tooling/test_check_m248_c007_replay_harness_and_artifact_contracts_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-C007-DOC-EXP-08",
        "`tmp/reports/m248/M248-C007/replay_harness_and_artifact_contracts_diagnostics_hardening_contract_summary.json`",
    ),
    SnippetCheck(
        "M248-C007-DOC-EXP-09",
        "`docs/contracts/m248_replay_harness_and_artifact_contracts_edge_case_expansion_and_robustness_c006_expectations.md`",
    ),
)

PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck("M248-C007-DOC-PKT-01", "Packet: `M248-C007`"),
    SnippetCheck("M248-C007-DOC-PKT-02", "Issue: `#6823`"),
    SnippetCheck("M248-C007-DOC-PKT-03", "Dependencies: `M248-C006`"),
    SnippetCheck("M248-C007-DOC-PKT-03A", "## Dependency Anchors (M248-C006)"),
    SnippetCheck(
        "M248-C007-DOC-PKT-04",
        "`scripts/check_m248_c007_replay_harness_and_artifact_contracts_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck(
        "M248-C007-DOC-PKT-05",
        "`tests/tooling/test_check_m248_c007_replay_harness_and_artifact_contracts_diagnostics_hardening_contract.py`",
    ),
    SnippetCheck("M248-C007-DOC-PKT-06", "`check:objc3c:m248-c007-lane-c-readiness`"),
    SnippetCheck(
        "M248-C007-DOC-PKT-07",
        "`tmp/reports/m248/M248-C007/replay_harness_and_artifact_contracts_diagnostics_hardening_contract_summary.json`",
    ),
)
...
PACKAGE_SCRIPT_KEY_CHECKS: tuple[PackageScriptKeyCheck, ...] = (
    ...
    PackageScriptKeyCheck("M248-C007-CFG-03", "check:objc3c:m248-c007-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C007-CFG-04", "check:objc3c:m248-c006-lane-c-readiness"),
    PackageScriptKeyCheck("M248-C007-CFG-05", "test:objc3c:lowering-replay-proof"),
    PackageScriptKeyCheck("M248-C007-CFG-06", "test:objc3c:execution-replay-proof"),
)
...
PACKAGE_SCRIPT_CHECKS: tuple[PackageScriptCheck, ...] = (
    ...
    PackageScriptCheck(
        ...
        "npm run check:objc3c:m248-c006-lane-c-readiness && npm run check:objc3c:m248-c007-replay-harness-artifact-contracts-diagnostics-hardening-contract && npm run test:tooling:m248-c007-replay-harness-artifact-contracts-diagnostics-hardening-contract",
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    expectations_checks, expectations_findings = check_doc_contract(
        ...
        exists_check_id="M248-C007-DOC-EXP-00",
    ...
    packet_checks, packet_findings = check_doc_contract(
        ...
        exists_check_id="M248-C007-DOC-PKT-00",
        snippets=PACKET_SNIPPETS,
    )
    checks_total += packet_checks
    findings.extend(packet_findings)

    c006_checks, c006_findings = check_doc_contract(
        artifact_name="c006_expectations_doc",
        path=args.c006_expectations_doc,
        exists_check_id="M248-C007-C006-DOC-00",
        snippets=C006_EXPECTATIONS_SNIPPETS,
    )
    checks_total += c006_checks
    findings.extend(c006_findings)
    ...
    architecture_checks, architecture_findings = check_doc_contract(
        ...
        exists_check_id="M248-C007-ARCH-00",
    ...
    lowering_checks, lowering_findings = check_doc_contract(
        ...
        exists_check_id="M248-C007-SPC-00",
    ...
    metadata_checks, metadata_findings = check_doc_contract(
        ...
        exists_check_id="M248-C007-META-00",
