#!/usr/bin/env python3
"""Fail-closed checker for M229-D027 packaging and runtime launch ergonomics contract freeze."""
...
MODE = "m229-d027-packaging-runtime-launch-ergonomics-integration-closeout-and-gate-sign-off-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_d027_packaging_runtime_launch_ergonomics_integration_closeout_and_gate_sign_off_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-D027-DOC-PKT-01",
        "# M229-D027 Packaging and runtime launch ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-D027-DOC-PKT-02", "Packet: `M229-D027`"),
    SnippetCheck("M229-D027-DOC-PKT-03", "Issue: `#5377`"),
    SnippetCheck("M229-D027-DOC-PKT-04", "Dependencies: `M229-D026`"),
    SnippetCheck(
        "M229-D027-DOC-PKT-05",
        "check:objc3c:m229-d027-packaging-runtime-launch-ergonomics-integration-closeout-and-gate-sign-off-contract",
    ),
    SnippetCheck(
        "M229-D027-DOC-PKT-06",
        "tmp/reports/m229/M229-D027/packaging_runtime_launch_ergonomics_integration_closeout_and_gate_sign_off_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-D027-PKG-03",
        '"check:objc3c:m229-d027-lane-d-readiness": '
        '"npm run check:objc3c:m229-d026-lane-d-readiness && npm run check:objc3c:m229-d027-packaging-runtime-launch-ergonomics-integration-closeout-and-gate-sign-off-contract '
        '&& npm run test:tooling:m229-d027-packaging-runtime-launch-ergonomics-integration-closeout-and-gate-sign-off-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-D027-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-D027-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-D027-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-D027-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-D027-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-D027-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
