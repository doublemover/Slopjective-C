#!/usr/bin/env python3
"""Fail-closed validator for M226-E010 lane-E conformance corpus evidence."""
...
MODE = "m226-e010-lane-e-integration-gate-conformance-corpus-evidence-contract-v1"

DEFAULT_CONTRACT_DOC = (
    ROOT / "docs" / "contracts" / "m226_lane_e_integration_gate_e010_conformance_corpus_evidence_expectations.md"
)
DEFAULT_PACKET_DOC = (
    ROOT
    / "spec"
    ...
    / "compiler"
    / "m226"
    / "m226_e010_lane_e_integration_gate_conformance_corpus_evidence_packet.md"
)
DEFAULT_EVIDENCE_DOC = (
    ...
    / "compiler"
    / "m226"
    / "m226_e010_lane_e_integration_gate_conformance_corpus_evidence_scaffold.md"
)
...
PREREQUISITE_ASSETS: tuple[AssetCheck, ...] = (
    AssetCheck(
        "M226-E010-ASSET-01",
        Path("docs/contracts/m226_lane_e_integration_gate_e009_conformance_matrix_evidence_expectations.md"),
    ),
    AssetCheck(
        "M226-E010-ASSET-02",
        Path("docs/contracts/m226_parser_conformance_corpus_expansion_expectations.md"),
    ),
    AssetCheck(
        "M226-E010-ASSET-03",
        Path("docs/contracts/m226_parser_sema_conformance_corpus_b010_expectations.md"),
    ),
    AssetCheck(
        "M226-E010-ASSET-04",
        Path("docs/contracts/m226_parse_lowering_conformance_corpus_c010_expectations.md"),
    ),
    AssetCheck(
        "M226-E010-ASSET-05",
        Path("docs/contracts/m226_frontend_build_invocation_conformance_corpus_d010_expectations.md"),
    ),
    AssetCheck(
        "M226-E010-ASSET-06",
        Path("scripts/check_m226_e010_lane_e_integration_gate_conformance_corpus_evidence_contract.py"),
    ),
    AssetCheck(
        "M226-E010-ASSET-07",
        Path("tests/tooling/test_check_m226_e010_lane_e_integration_gate_conformance_corpus_evidence_contract.py"),
    ),
)

CONTRACT_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E010-DOC-CON-01",
        "# M226 Lane E Integration Gate Conformance Corpus Evidence Expectations (E010)",
    ),
    SnippetCheck(
        "M226-E010-DOC-CON-02",
        "Contract ID: `objc3c-lane-e-integration-gate-conformance-corpus-evidence-contract/m226-e010-v1`",
    ),
    SnippetCheck(
        "M226-E010-DOC-CON-03",
...
FREEZE_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M226-E010-DOC-FRZ-01",
        "| `M226-E010` | `objc3c-lane-e-integration-gate-conformance-corpus-evidence-contract/m226-e010-v1` |",
    ),
    SnippetCheck("M226-E010-DOC-FRZ-02", "## Packet: `M226-E010`"),
    SnippetCheck(
        "M226-E010-DOC-FRZ-03",
        "`docs/contracts/m226_lane_e_integration_gate_e010_conformance_corpus_evidence_expectations.md`",
    ),
    SnippetCheck(
        "M226-E010-DOC-FRZ-04",
        "`scripts/check_m226_e010_lane_e_integration_gate_conformance_corpus_evidence_contract.py`",
    ),
    SnippetCheck(
        "M226-E010-DOC-FRZ-05",
        "`tests/tooling/test_check_m226_e010_lane_e_integration_gate_conformance_corpus_evidence_contract.py`",
    ),
    SnippetCheck(
        "M226-E010-DOC-FRZ-06",
        "#### Upstream Conformance Corpus Anchors",
    ),
    SnippetCheck(
        "M226-E010-DOC-FRZ-07",
        "`tmp/reports/m226/M226-A010/parser_conformance_corpus_summary.json`",
    ),
    SnippetCheck(
        "M226-E010-DOC-FRZ-08",
