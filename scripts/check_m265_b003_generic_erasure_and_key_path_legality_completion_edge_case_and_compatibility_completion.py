...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    snippet_targets: list[tuple[Path, list[SnippetCheck]]] = [
        ...
        (DOC_SOURCE, [SnippetCheck("M265-B003-DOCSRC-01", "typed key-path literals such as `@keypath(...)` remain fail closed on the"), SnippetCheck("M265-B003-DOCSRC-02", "generic Objective-C method declarations written as `- <T> ...` remain")]),
        (DOC_NATIVE, [SnippetCheck("M265-B003-DOCNATIVE-01", "typed key-path literals such as `@keypath(...)` remain fail closed on the"), SnippetCheck("M265-B003-DOCNATIVE-02", "generic Objective-C method declarations written as `- <T> ...` remain")]),
        ...
        (SPEC_ATTR, [SnippetCheck("M265-B003-ATTR-01", "Current implementation status (`M265-C001`)"), SnippetCheck("M265-B003-ATTR-02", "class-root key paths such as `@keypath(Person, name)` now fail closed unless")]),
        (SPEC_PART3, [SnippetCheck("M265-B003-PART3-01", "Implementation note (`M265-C001`)"), SnippetCheck("M265-B003-PART3-02", "Multi-component typed key-path member chains still fail closed")]),
