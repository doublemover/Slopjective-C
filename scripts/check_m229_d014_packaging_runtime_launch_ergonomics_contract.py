#!/usr/bin/env python3
"""Fail-closed checker for M229-D014 packaging and runtime launch ergonomics contract freeze."""
...
MODE = "m229-d014-packaging-runtime-launch-ergonomics-release-candidate-and-replay-dry-run-contract-v1"
...
DEFAULT_PACKET_DOC = (
    ...
    / "compiler"
    / "m229"
    / "m229_d014_packaging_runtime_launch_ergonomics_release_candidate_and_replay_dry_run_packet.md"
)
...
PACKET_SNIPPETS: tuple[SnippetCheck, ...] = (
    SnippetCheck(
        "M229-D014-DOC-PKT-01",
        "# M229-D014 Packaging and runtime launch ergonomics Contract and Architecture Freeze Packet",
    ),
    SnippetCheck("M229-D014-DOC-PKT-02", "Packet: `M229-D014`"),
    SnippetCheck("M229-D014-DOC-PKT-03", "Issue: `#5364`"),
    SnippetCheck("M229-D014-DOC-PKT-04", "Dependencies: `M229-D013`"),
    SnippetCheck(
        "M229-D014-DOC-PKT-05",
        "check:objc3c:m229-d014-packaging-runtime-launch-ergonomics-release-candidate-and-replay-dry-run-contract",
    ),
    SnippetCheck(
        "M229-D014-DOC-PKT-06",
        "tmp/reports/m229/M229-D014/packaging_runtime_launch_ergonomics_release_candidate_and_replay_dry_run_summary.json",
    ),
)
...
PACKAGE_SNIPPETS: tuple[SnippetCheck, ...] = (
    ...
    SnippetCheck(
        "M229-D014-PKG-03",
        '"check:objc3c:m229-d014-lane-d-readiness": '
        '"npm run check:objc3c:m229-d013-lane-d-readiness && npm run check:objc3c:m229-d014-packaging-runtime-launch-ergonomics-release-candidate-and-replay-dry-run-contract '
        '&& npm run test:tooling:m229-d014-packaging-runtime-launch-ergonomics-release-candidate-and-replay-dry-run-contract"',
    ),
)
...
def run(argv: Sequence[str]) -> int:
    ...
    artifact_inputs = (
        ("expectations_doc", "M229-D014-EXPECTATIONS", args.expectations_doc, EXPECTATIONS_SNIPPETS),
        ("packet_doc", "M229-D014-PACKET", args.packet_doc, PACKET_SNIPPETS),
        ("architecture_doc", "M229-D014-ARCHITECTURE", args.architecture_doc, ARCHITECTURE_SNIPPETS),
        ("lowering_spec", "M229-D014-LOWERING-SPEC", args.lowering_spec, LOWERING_SPEC_SNIPPETS),
        ("metadata_spec", "M229-D014-METADATA-SPEC", args.metadata_spec, METADATA_SPEC_SNIPPETS),
        ("package_json", "M229-D014-PACKAGE", args.package_json, PACKAGE_SNIPPETS),
    )
