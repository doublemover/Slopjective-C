...
| `language.control-flow.statement-guarded-match` | `objc3c.behavior.language.control-flow.statement-guarded-match` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_guarded_match_pattern_reserved.objc3` |  |
| `language.control-flow.statement-guarded-match` | `objc3c.behavior.language.control-flow.statement-guarded-match` | `source` | `native/objc3c/src/parse/objc3_parser_core_statement_switch_parsing_match_case_diagnostics.inc` |  |
| `language.control-flow.statement-guarded-match` | `objc3c.behavior.language.control-flow.statement-guarded-match` | `source` | `native/objc3c/src/sema/objc3_semantic_match_exhaustiveness.cpp` |  |
| `language.control-flow.statement-guarded-match` | `objc3c.behavior.language.control-flow.statement-guarded-match` | `source` | `native/objc3c/src/pipeline/frontend_control_flow_source_closure_helpers.cpp` |  |
| `language.control-flow.statement-guarded-match` | `objc3c.behavior.language.control-flow.statement-guarded-match` | `source` | `tests/tooling/fixtures/native/match_guarded_pattern_language_evolution_contract.json` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `test` | `tests/tooling/fixtures/native/recovery/positive/match_expression_literal_result.objc3` | `npm run objc3c -- validate-conformance-corpus` |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `test` | `tests/tooling/fixtures/native/recovery/positive/match_expression_guarded_bool.objc3` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `test` | `tests/tooling/fixtures/native/recovery/positive/match_expression_result_case_semantic.objc3` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_match_expression_non_exhaustive.objc3` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_match_expression_binding_scope_leak.objc3` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_match_expression_result_type_mismatch.objc3` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_match_expression_type_test_reserved.objc3` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_match_expression_guard_side_effect.objc3` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `source` | `native/objc3c/src/parse/objc3_parser_core_primary_message_expressions_match_expression.inc` |  |
| `language.control-flow.match-expression` | `objc3c.behavior.language.control-flow.match-expression` | `source` | `native/objc3c/src/sema/objc3_semantic_passes_expression_statement_validation_match_expression_case.inc` |  |
...
| `language.protocols.protocol-qualified-existential-value-flow` | `objc3c.behavior.language.protocols.protocol-qualified-existential-value-flow` | `test` | `tests/conformance/semantic/TYP-8013-18.json` |  |
| `language.protocols.protocol-qualified-existential-value-flow` | `objc3c.behavior.language.protocols.protocol-qualified-existential-value-flow` | `test` | `tests/conformance/semantic/TYP-8013-25.json` |  |
...
| `language.protocols.protocol-qualified-existential-value-flow` | `objc3c.behavior.language.protocols.protocol-qualified-existential-value-flow` | `source` | `native/objc3c/src/pipeline/runtime_import_type_system_preservation_protocol.cpp` |  |
...
| `language.generics.callable-type-parameters` | `objc3c.behavior.language.generics.callable-type-parameters` | `test` | `tests/tooling/fixtures/native/type_semantic_generic_method_substitution_positive.objc3` | `npm run objc3c -- validate-conformance-corpus` |
| `language.generics.callable-type-parameters` | `objc3c.behavior.language.generics.callable-type-parameters` | `test` | `tests/tooling/fixtures/native/type_semantic_generic_function_positive.objc3` |  |
| `language.generics.callable-type-parameters` | `objc3c.behavior.language.generics.callable-type-parameters` | `test` | `tests/conformance/semantic/TYP-8013-23.json` |  |
| `language.generics.callable-type-parameters` | `objc3c.behavior.language.generics.callable-type-parameters` | `test` | `tests/conformance/semantic/TYP-8013-24.json` |  |
| `language.generics.callable-type-parameters` | `objc3c.behavior.language.generics.callable-type-parameters` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_type_semantic_generic_function_constraint_violation.objc3` |  |
| `language.generics.callable-type-parameters` | `objc3c.behavior.language.generics.callable-type-parameters` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_type_semantic_generic_function_unresolved_return.objc3` |  |
| `language.generics.callable-type-parameters` | `objc3c.behavior.language.generics.callable-type-parameters` | `source` | `native/objc3c/src/sema/objc3_semantic_passes_generic_protocol_message_validation.inc` |  |
| `language.generics.callable-type-parameters` | `objc3c.behavior.language.generics.callable-type-parameters` | `source` | `native/objc3c/src/sema/objc3_semantic_generic_argument_relations.cpp` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `test` | `tests/tooling/fixtures/native/type_semantic_generic_reified_objc_method_positive.objc3` | `npm run objc3c -- validate-conformance-corpus` |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `test` | `tests/tooling/fixtures/native/type_semantic_generic_reified_function_positive.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `test` | `tests/tooling/fixtures/native/type_semantic_generic_objc_method_positive.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `test` | `tests/tooling/fixtures/native/type_semantic_generic_function_positive.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `source` | `tests/tooling/fixtures/native/generic_callable_reification_contract.json` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_generic_method_selector_form_ambiguous.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_reify_generics_unsupported_scope.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_cstyle_generic_function_reserved.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_type_semantic_generic_function_signature_drift.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_type_semantic_generic_method_override_mismatch.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_type_semantic_generic_callable_constraint_cycle.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_type_semantic_erased_to_reified_redeclaration_drift.objc3` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `diagnostic` | `tests/tooling/fixtures/native/generic_callable_cross_module_mangling_policy_mismatch.json` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `source` | `native/objc3c/src/sema/objc3_semantic_passes_generic_callable_contracts.inc` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `source` | `native/objc3c/src/sema/objc3_sema_contract_semantic_type_metadata_function_records.h` |  |
| `language.generics.generic-callable-reification` | `objc3c.behavior.language.generics.generic-callable-reification` | `source` | `native/objc3c/src/sema/objc3_sema_contract_semantic_type_metadata_method_records.h` |  |
...
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `test` | `tests/tooling/fixtures/package_ecosystem/direct_import_module_syntax_contract.json` | `npm run objc3c -- validate-direct-import-module-syntax` |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `test` | `tests/tooling/test_direct_import_module_syntax_contract.py` | `npm run objc3c -- validate-direct-import-module-syntax` |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `test` | `tests/tooling/fixtures/native/direct_import_syntax_consumer.objc3` | `npm run objc3c -- validate-direct-import-module-syntax` |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_direct_import_malformed_module_identity.objc3` | `npm run objc3c -- validate-direct-import-module-syntax` |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_direct_import_without_package_provenance.objc3` | `npm run objc3c -- validate-direct-import-module-syntax` |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_direct_import_ambiguous_module_identity.objc3` | `npm run objc3c -- validate-direct-import-module-syntax` |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `source` | `scripts/objc3c_package_manager/model.py` |  |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `source` | `scripts/check_objc3c_direct_import_module_syntax.py` |  |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `source` | `native/objc3c/src/parse/objc3_parser_core_cstyle_parameters_module_global_parsing.inc` |  |
| `modules.direct-import-syntax` | `objc3c.behavior.modules.direct-import-syntax` | `doc` | `docs/support/hard_cutover_capability_truth.md` |  |
...
| `language.text.source-string-literal-text-shape-handle` | `objc3c.behavior.language.text.source-string-literal-text-shape-handle` | `source` | `native/objc3c/src/runtime/stdlib/text_runtime.cpp` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `test` | `tests/tooling/fixtures/native/execution/positive/source_string_interpolation_text_i32.objc3` | `npm run objc3c -- test-execution-smoke` |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `test` | `tests/tooling/fixtures/native/execution/positive/source_string_interpolation_text_i32.exitcode.txt` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_text_interpolation_empty_payload_rejected.objc3` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_text_interpolation_nested_rejected.objc3` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_text_interpolation_unterminated_rejected.objc3` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `test` | `tests/tooling/fixtures/native/recovery/negative/negative_text_interpolation_bool_payload_rejected.objc3` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `test` | `tests/tooling/test_source_string_interpolation_text_support.py` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/lex/objc3_lexer_scanning.cpp` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/parse/objc3_parser_core_primary_message_expressions_primary_literals_identifiers_dispatch.inc` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/parse/objc3_parser_literal_expression_nodes_scalar_literals.inc` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/ast/objc3_ast_expr_kind_members.h` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/ast/objc3_ast_expr_control_flow_members.h` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/ast/objc3_ast_value_type.h` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/sema/objc3_semantic_passes_generic_protocol_message_validation_expr_literal_identifier_cases.inc` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/ir/objc3_ir_expression_emission.cpp` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/ir/objc3_ir_prototype_declarations_runtime_helpers.cpp` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/runtime/stdlib/text_runtime_contract.h` |  |
| `language.text.source-string-interpolation` | `objc3c.behavior.language.text.source-string-interpolation` | `source` | `native/objc3c/src/runtime/stdlib/text_runtime.cpp` |  |
...
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `doc` | `docs/support/hard_cutover_capability_truth.md` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `doc` | `spec/PART_6_ERRORS_RESULTS_THROWS.md` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `doc` | `spec/PART_7_CONCURRENCY_ASYNC_AWAIT_ACTORS.md` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `doc` | `spec/PART_10_METAPROGRAMMING_DERIVES_MACROS_PROPERTY_BEHAVIORS.md` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `source` | `scripts/objc3c_runtime_acceptance/domains/advanced_runtime_capability_split.py` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/tooling/test_runtime_capability_public_split.py` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `source` | `scripts/check_objc3c_advanced_runtime_closure.py` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `source` | `native/objc3c/src/pipeline/runtime_import_preservation_evidence_metaprogramming.cpp` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `source` | `native/objc3c/src/runtime/concurrency/actor_mailbox_operations.cpp` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/native/runtime/advanced_closure/combined_positive.objc3` | `npm run objc3c -- validate-advanced-runtime-closure` |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/native/runtime/advanced_closure/combined_provider.objc3` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/native/runtime/advanced_closure/negative_matrix.contract.json` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/tooling/fixtures/advanced_runtime_closure/combined_runtime_identity_contract.json` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/tooling/fixtures/advanced_runtime_closure/combined_runtime_source_debug_map.json` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/tooling/fixtures/advanced_runtime_closure/executable_runtime_contract_surfaces.json` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/tooling/fixtures/advanced_runtime_closure/native_artifact_contract.json` |  |
| `language.advanced-runtime-closure` | `objc3c.behavior.language.advanced-runtime-closure` | `test` | `tests/tooling/fixtures/cross_lane_e2e/advanced_runtime_closure.expectation.json` | `npm run objc3c -- validate-cross-lane-e2e` |
...
| `capability.governance.umbrella-readiness` |  | `schema` | `schemas/objc3c-umbrella-readiness-v1.schema.json` |  |
| `capability.governance.umbrella-readiness` |  | `source` | `docs/support/umbrella_readiness.json` |  |
| `capability.governance.umbrella-readiness` |  | `doc` | `docs/support/umbrella_readiness.md` |  |
| `capability.governance.umbrella-readiness` |  | `source` | `scripts/capability_docs_validator/umbrella_readiness.py` |  |
| `capability.governance.umbrella-readiness` |  | `source` | `scripts/check_objc3c_umbrella_readiness.py` |  |
| `capability.governance.umbrella-readiness` |  | `source` | `scripts/objc3c_workflow/action_catalog_core_documentation_validation.py` |  |
| `capability.governance.umbrella-readiness` |  | `source` | `scripts/objc3c_workflow/action_handlers_core_documentation_validation.py` |  |
...
| `tooling.json.schema-registry` |  | `schema` | `schemas/objc3c-umbrella-readiness-v1.schema.json` |  |
...
| `tooling.json.schema-registry` |  | `schema` | `schemas/objc3c-platform-support-source-truth-v1.schema.json` |  |
...
| `tooling.json.schema-registry` |  | `schema` | `schemas/objc3c-optimization-runtime-debug-safety-v1.schema.json` |  |
...
| `ecosystem.package-manager.local-registry` | `objc3c.behavior.package.manager-local-registry` | `test` | `tests/tooling/fixtures/package_ecosystem/negative_package_metadata_contracts.json` | `npm run objc3c -- validate-package-manager-model` |
...
| `ecosystem.package-manager.local-registry` | `objc3c.behavior.package.manager-local-registry` | `schema` | `schemas/objc3c-package-signing-trust-v1.schema.json` |  |
...
| `ecosystem.package-manager.local-registry` | `objc3c.behavior.package.manager-local-registry` | `source` | `scripts/objc3c_package_manager/trust.py` |  |
...
| `ecosystem.package-manager.network-dependency-resolution` | `objc3c.behavior.package.network-dependency-resolution` | `schema` | `schemas/objc3c-package-network-resolution-v1.schema.json` |  |
| `ecosystem.package-manager.network-dependency-resolution` | `objc3c.behavior.package.network-dependency-resolution` | `source` | `scripts/objc3c_package_manager/network_publication.py` |  |
| `ecosystem.package-manager.network-dependency-resolution` | `objc3c.behavior.package.network-dependency-resolution` | `source` | `scripts/check_objc3c_package_network_publication.py` |  |
| `ecosystem.package-manager.release-channel-publication` | `objc3c.behavior.package.release-channel-publication` | `test` | `tests/tooling/fixtures/package_ecosystem/network_resolution/package-release-channel-publication.json` | `npm run objc3c -- validate-package-network-publication` |
| `ecosystem.package-manager.release-channel-publication` | `objc3c.behavior.package.release-channel-publication` | `test` | `tests/tooling/fixtures/package_ecosystem/network_resolution/negative-network-publication-cases.json` | `npm run objc3c -- validate-package-network-publication` |
| `ecosystem.package-manager.release-channel-publication` | `objc3c.behavior.package.release-channel-publication` | `test` | `tests/tooling/test_package_network_publication_contract.py` | `npm run objc3c -- validate-package-network-publication` |
| `ecosystem.package-manager.release-channel-publication` | `objc3c.behavior.package.release-channel-publication` | `schema` | `schemas/objc3c-package-release-channel-publication-v1.schema.json` |  |
| `ecosystem.package-manager.release-channel-publication` | `objc3c.behavior.package.release-channel-publication` | `source` | `scripts/objc3c_package_manager/network_publication.py` |  |
| `ecosystem.package-manager.release-channel-publication` | `objc3c.behavior.package.release-channel-publication` | `source` | `scripts/check_objc3c_package_network_publication.py` |  |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `test` | `tests/tooling/fixtures/package_ecosystem/package_security_hardening_contract.json` | `npm run objc3c -- validate-package-security-hardening` |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `test` | `tests/tooling/test_package_signing_trust.py` | `npm run objc3c -- validate-package-security-hardening` |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `schema` | `schemas/objc3c-package-signing-trust-v1.schema.json` |  |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `schema` | `schemas/objc3c-package-lock-v1.schema.json` |  |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `source` | `scripts/objc3c_package_manager/trust.py` |  |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `source` | `scripts/sign_objc3c_package.py` |  |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `source` | `scripts/verify_objc3c_package.py` |  |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `source` | `scripts/objc3c_package_manager/operations.py` |  |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `source` | `scripts/objc3c_package_manager/install_distribution.py` |  |
| `ecosystem.package-manager.security-hardening` | `objc3c.behavior.package.security-hardening` | `source` | `scripts/check_objc3c_package_security_hardening.py` |  |
...
| `ecosystem.package-install.clean-distribution` | `objc3c.behavior.package.install-clean-distribution` | `test` | `tests/tooling/fixtures/package_ecosystem/install_distribution_credibility_contract.json` | `npm run objc3c -- validate-package-install-distribution --from-nothing` |
| `ecosystem.package-install.clean-distribution` | `objc3c.behavior.package.install-clean-distribution` | `test` | `tests/tooling/test_package_install_distribution_credibility.py` | `npm run objc3c -- validate-package-install-distribution --from-nothing` |
...
| `ecosystem.package-install.clean-distribution` | `objc3c.behavior.package.install-clean-distribution` | `source` | `tests/tooling/fixtures/package_ecosystem/from_nothing_install_proof_contract.json` |  |
...
| `compiler.optimization.semantic-preserving-pipeline` | `objc3c.behavior.semantic_optimization_pipeline` | `source` | `tests/tooling/fixtures/performance_governance/optimization_runtime_debug_safety_contract.json` |  |
...
| `compiler.optimization.semantic-preserving-pipeline` | `objc3c.behavior.semantic_optimization_pipeline` | `schema` | `schemas/objc3c-optimization-runtime-debug-safety-v1.schema.json` |  |
...
| `compiler.optimization.runtime-debug-safety` |  | `schema` | `schemas/objc3c-optimization-runtime-debug-safety-v1.schema.json` |  |
| `compiler.optimization.runtime-debug-safety` |  | `source` | `tests/tooling/fixtures/performance_governance/optimization_runtime_debug_safety_contract.json` |  |
| `compiler.optimization.runtime-debug-safety` |  | `source` | `tests/tooling/fixtures/performance_governance/budget_model.json` |  |
| `compiler.optimization.runtime-debug-safety` |  | `test` | `tests/tooling/fixtures/semantic_optimization_pipeline/proof_cases.json` | `npm run objc3c -- validate-semantic-optimization-pipeline` |
| `compiler.optimization.runtime-debug-safety` |  | `test` | `tests/tooling/test_semantic_optimization_pipeline.py` | `npm run objc3c -- validate-semantic-optimization-pipeline` |
| `compiler.optimization.runtime-debug-safety` |  | `doc` | `docs/runbooks/objc3c_performance_governance.md` |  |
...
| `compiler.optimization.method-inlining` | `objc3c.behavior.optimization.method-inlining-safe-subset` | `test` | `tests/tooling/fixtures/semantic_optimization_pipeline/negative_method_inlining_stale_dispatch_invalidation.json` | `npm run objc3c -- validate-semantic-optimization-pipeline` |
| `compiler.optimization.method-inlining` | `objc3c.behavior.optimization.method-inlining-safe-subset` | `test` | `tests/tooling/fixtures/semantic_optimization_pipeline/negative_method_inlining_side_effecting_method_as_pure.json` | `npm run objc3c -- validate-semantic-optimization-pipeline` |
| `compiler.optimization.method-inlining` | `objc3c.behavior.optimization.method-inlining-safe-subset` | `test` | `tests/tooling/fixtures/semantic_optimization_pipeline/negative_method_inlining_source_map_step_drift.json` | `npm run objc3c -- validate-semantic-optimization-pipeline` |
| `compiler.optimization.method-inlining` | `objc3c.behavior.optimization.method-inlining-safe-subset` | `test` | `tests/native/ir/optimization/semantic_pipeline_method_inlining.before.ll` | `npm run objc3c -- validate-semantic-optimization-pipeline` |
| `compiler.optimization.method-inlining` | `objc3c.behavior.optimization.method-inlining-safe-subset` | `test` | `tests/native/ir/optimization/semantic_pipeline_method_inlining.after.ll` | `npm run objc3c -- validate-semantic-optimization-pipeline` |
...
| `runtime.debug-trace.full-source-map-publication` |  | `test` | `tests/tooling/fixtures/developer_tooling/debug_source_maps/positive.json` | `npm run objc3c -- validate-debug-source-maps` |
...
| `runtime.debug-trace.lldb-plugin` | `objc3c.behavior.runtime.debug-trace.lldb-plugin` | `test` | `tests/tooling/fixtures/developer_tooling/debugger_integration/replay.json` | `npm run objc3c -- validate-debugger-integration` |
| `runtime.debug-trace.lldb-plugin` | `objc3c.behavior.runtime.debug-trace.lldb-plugin` | `test` | `tests/tooling/fixtures/developer_tooling/debugger_integration/lldb_protocol_contract.json` | `npm run objc3c -- validate-debugger-integration` |
| `runtime.debug-trace.lldb-plugin` | `objc3c.behavior.runtime.debug-trace.lldb-plugin` | `doc` | `docs/runbooks/objc3c_developer_tooling.md` |  |
| `runtime.debug-trace.statement-stepping` | `objc3c.behavior.runtime.debug-trace.statement-stepping` | `test` | `tests/tooling/fixtures/developer_tooling/debug_source_maps/positive.json` | `npm run objc3c -- validate-debug-source-maps` |
| `runtime.debug-trace.statement-stepping` | `objc3c.behavior.runtime.debug-trace.statement-stepping` | `test` | `tests/tooling/fixtures/developer_tooling/debugger_integration/replay.json` | `npm run objc3c -- validate-debugger-integration` |
| `runtime.debug-trace.statement-stepping` | `objc3c.behavior.runtime.debug-trace.statement-stepping` | `test` | `tests/tooling/fixtures/developer_tooling/debug_source_maps/negative_cases.json` | `npm run objc3c -- validate-debug-source-maps` |
| `runtime.debug-trace.statement-stepping` | `objc3c.behavior.runtime.debug-trace.statement-stepping` | `doc` | `docs/runbooks/objc3c_developer_tooling.md` |  |
| `runtime.debug-trace.inline-frame-source-map` | `objc3c.behavior.runtime.debug-trace.inline-frame-source-map` | `test` | `tests/tooling/fixtures/developer_tooling/debug_source_maps/inline_frame_source_map_contract.json` | `npm run objc3c -- validate-debug-source-maps` |
| `runtime.debug-trace.inline-frame-source-map` | `objc3c.behavior.runtime.debug-trace.inline-frame-source-map` | `test` | `tests/tooling/fixtures/developer_tooling/debug_source_maps/positive.json` | `npm run objc3c -- validate-debug-source-maps` |
...
| `platform.linux-x64.unsupported` |  | `test` | `tests/tooling/test_platform_host_evidence_review.py` |  |
| `platform.linux-x64.unsupported` |  | `source` | `tests/tooling/fixtures/platform_hardening/host_promotion_reviewed_source_inputs.json` |  |
...
| `platform.darwin-arm64.unsupported` |  | `test` | `tests/tooling/test_platform_host_evidence_review.py` |  |
| `platform.darwin-arm64.unsupported` |  | `source` | `tests/tooling/fixtures/platform_hardening/host_promotion_reviewed_source_inputs.json` |  |
...
| `platform.expansion.umbrella-readiness` |  | `source` | `tests/tooling/fixtures/platform_support/source_truth_matrix.json` |  |
...
| `platform.expansion.umbrella-readiness` |  | `test` | `tests/tooling/test_platform_host_evidence_review.py` |  |
| `platform.expansion.umbrella-readiness` |  | `source` | `tests/tooling/fixtures/platform_hardening/host_promotion_reviewed_source_inputs.json` |  |
...
| `modules.standalone-textual-interface-payload` | `objc3c.behavior.modules.standalone-textual-interface-payload` | `schema` | `schemas/objc3c-standalone-textual-interface-payload-v1.schema.json` |  |
| `modules.standalone-textual-interface-payload` | `objc3c.behavior.modules.standalone-textual-interface-payload` | `source` | `native/objc3c/src/artifacts/objc3_frontend_textual_interface_payload_artifact.cpp` |  |
| `modules.standalone-textual-interface-payload` | `objc3c.behavior.modules.standalone-textual-interface-payload` | `source` | `native/objc3c/src/artifacts/objc3_frontend_textual_interface_payload_import.cpp` |  |
| `modules.standalone-textual-interface-payload` | `objc3c.behavior.modules.standalone-textual-interface-payload` | `test` | `tests/tooling/fixtures/module_interfaces/standalone_textual_interface_payload.json` | `npm run objc3c -- validate-standalone-textual-interface-payload` |
| `modules.standalone-textual-interface-payload` | `objc3c.behavior.modules.standalone-textual-interface-payload` | `test` | `tests/tooling/test_native_interface_and_runtime_contracts.py` | `npm run objc3c -- validate-standalone-textual-interface-payload` |
| `modules.standalone-textual-interface-payload` | `objc3c.behavior.modules.standalone-textual-interface-payload` | `source` | `native/objc3c/src/driver/objc3_driver_frontend_interface_payload_artifact_publication.cpp` |  |
| `modules.standalone-textual-interface-payload` | `objc3c.behavior.modules.standalone-textual-interface-payload` | `source` | `native/objc3c/src/artifacts/json/artifact_schema_contract_table.cpp` |  |
