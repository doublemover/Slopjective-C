...
| `language.advanced-runtime-closure` |  | `test` | `tests/tooling/fixtures/advanced_runtime_closure/native_artifact_contract.json` |  |
...
| `modules.standalone-textual-interface-payload` |  | `schema` | `schemas/objc3c-standalone-textual-interface-payload-v1.schema.json` |  |
| `modules.standalone-textual-interface-payload` |  | `source` | `native/objc3c/src/artifacts/objc3_frontend_textual_interface_payload_artifact.cpp` |  |
| `modules.standalone-textual-interface-payload` |  | `source` | `native/objc3c/src/driver/objc3_driver_frontend_interface_payload_artifact_publication.cpp` |  |
| `modules.standalone-textual-interface-payload` |  | `source` | `native/objc3c/src/artifacts/json/artifact_schema_contract_table.cpp` |  |
