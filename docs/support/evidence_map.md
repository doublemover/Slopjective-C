...
| `language.control-flow.statement-guarded-match` | `objc3c.behavior.language.control-flow.statement-guarded-match` | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_match_expression_position_reserved.objc3` |  |
...
| `language.generics.generic-callable-reification` |  | `source` | `tests/tooling/fixtures/native/generic_callable_reification_contract.json` |  |
| `language.generics.generic-callable-reification` |  | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_reify_generics_marker_reserved.objc3` |  |
| `language.generics.generic-callable-reification` |  | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_generic_method_type_parameter_clause_reserved.objc3` |  |
| `language.generics.generic-callable-reification` |  | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_cstyle_generic_function_reserved.objc3` |  |
| `language.generics.generic-callable-reification` |  | `diagnostic` | `tests/tooling/fixtures/native/recovery/negative/negative_type_semantic_generic_function_signature_drift.objc3` |  |
| `language.generics.generic-callable-reification` |  | `source` | `native/objc3c/src/sema/objc3_semantic_passes_generic_callable_contracts.inc` |  |
| `language.generics.generic-callable-reification` |  | `source` | `native/objc3c/src/sema/objc3_sema_contract_semantic_type_metadata_function_records.h` |  |
