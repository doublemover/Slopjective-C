...
| Full source-map publication, statement stepping, LLDB plugin integration, and public hosted package registry services                                 | `reserved`                                       | Describe as unavailable even when source-graph, local registry, hosted-fixture, or debug-anchor evidence exists.                                                                                                                                                                                                      |
...
or statement stepping; direct `@import` support is claimed only through
`modules.direct-import-syntax` and its package provenance validator. Optimization runtime
