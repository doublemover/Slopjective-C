...
Scope: M237 lane-E block conformance and replay gate docs and operator runbook synchronization bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_e013_block_conformance_and_replay_gate_docs_and_operator_runbook_synchronization_packet.md`
...
- `python scripts/check_m237_e013_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E013/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e013_block_conformance_and_replay_gate_contract.py -q`
