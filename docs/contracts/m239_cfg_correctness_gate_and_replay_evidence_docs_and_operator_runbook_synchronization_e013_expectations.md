# M239 CFG correctness gate and replay evidence Docs and Operator Runbook Synchronization Expectations (E013)

Contract ID: `objc3c-cfg-correctness-gate-and-replay-evidence-docs-and-operator-runbook-synchronization/m239-e013-v1`
Status: Accepted
Issue: `#5025`
Dependencies: `M239-A001`, `M239-B001`, `M239-C001`
Scope: M239 lane-E cfg correctness gate and replay evidence docs and operator runbook synchronization bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_e013_cfg_correctness_gate_and_replay_evidence_docs_and_operator_runbook_synchronization_packet.md`
  - `scripts/check_m239_e013_cfg_correctness_gate_and_replay_evidence_contract.py`
  - `tests/tooling/test_check_m239_e013_cfg_correctness_gate_and_replay_evidence_contract.py`
...
- `python scripts/check_m239_e013_cfg_correctness_gate_and_replay_evidence_contract.py --summary-out tmp/reports/m239/M239-E013/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m239_e013_cfg_correctness_gate_and_replay_evidence_contract.py -q`

## Evidence Path

- `tmp/reports/m239/M239-E013/local_check_summary.json`
