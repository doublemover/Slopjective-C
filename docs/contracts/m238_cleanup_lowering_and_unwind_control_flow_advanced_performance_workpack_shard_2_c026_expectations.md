...
Status: Accepted
Dependencies: none
Scope: M238 lane-C qualified type lowering and ABI representation advanced performance workpack (shard 2) for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_c026_cleanup_lowering_and_unwind_control_flow_advanced_performance_workpack_shard_2_packet.md`
  - `scripts/check_m238_c026_cleanup_lowering_and_unwind_control_flow_contract.py`
  - `tests/tooling/test_check_m238_c026_cleanup_lowering_and_unwind_control_flow_contract.py`

## Architecture and Spec Anchors

- `native/objc3c/src/ARCHITECTURE.md` includes explicit M238 lane-C C026
...
- `package.json` includes `check:objc3c:m238-c026-lane-c-readiness`.
...
- `npm run check:objc3c:m238-c026-lane-c-readiness`
