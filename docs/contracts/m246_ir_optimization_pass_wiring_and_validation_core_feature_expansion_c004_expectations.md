...
Status: Accepted
Scope: M246 lane-C IR optimization pass wiring and validation core feature expansion continuity with explicit `M246-C003` dependency governance and predecessor anchor integrity.
...
- C003 packet/checker/test/readiness assets remain mandatory prerequisites:
...
- C004 packet/checker/test/readiness assets remain mandatory:
...
- `scripts/run_m246_c004_lane_c_readiness.py` must preserve fail-closed dependency chaining:
  - `scripts/run_m246_c003_lane_c_readiness.py`
  - `scripts/check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py`
  - `tests/tooling/test_check_m246_c004_ir_optimization_pass_wiring_and_validation_core_feature_expansion_contract.py`
