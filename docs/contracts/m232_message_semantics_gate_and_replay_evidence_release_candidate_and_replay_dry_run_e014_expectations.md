...
Execute release-candidate and replay dry-run governance for lane-E message semantics gate and replay evidence, locking deterministic declaration-grammar boundaries before modular split/scaffolding work begins.
...
- `spec/planning/compiler/m232/m232_e014_message_semantics_gate_and_replay_evidence_release_candidate_and_replay_dry_run_packet.md`
...
- `package.json` (`check:objc3c:m232-e014-lane-e-readiness`)

## Deterministic Invariants

1. Contract-freeze artifacts and packet anchors must remain synchronized and fail closed on drift.
2. Lane-A architecture/spec/package anchors must remain explicit and deterministic for `M232-E014`.
