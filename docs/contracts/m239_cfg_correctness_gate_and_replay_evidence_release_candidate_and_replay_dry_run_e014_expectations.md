...
Scope: M239 lane-E cfg correctness gate and replay evidence release-candidate and replay dry-run bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_e014_cfg_correctness_gate_and_replay_evidence_release_candidate_and_replay_dry_run_packet.md`
