...
Scope: M239 lane-D interop behavior for qualified generic APIs diagnostics hardening for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_d007_runtime_call_edge_behavior_and_integration_diagnostics_hardening_packet.md`
...
- Lane-D D007 freeze remains issue-local and fail-closed against `M239-C001` drift.
