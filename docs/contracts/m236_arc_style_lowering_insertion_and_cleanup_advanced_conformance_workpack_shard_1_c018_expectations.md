...
Status: Accepted
Dependencies: none
Scope: M236 lane-C qualified type lowering and ABI representation advanced conformance workpack (shard 1) for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_c018_arc_style_lowering_insertion_and_cleanup_advanced_conformance_workpack_shard_1_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M236 lane-C C018
...
- `package.json` includes `check:objc3c:m236-c018-lane-c-readiness`.
