# M227 Typed Sema-to-Lowering Advanced Integration Workpack (Shard 1) Expectations (C019)

Contract ID: `objc3c-typed-sema-to-lowering-advanced-integration-shard1/m227-c019-v1`
Status: Accepted
Scope: typed sema-to-lowering advanced integration workpack (shard 1) on top of C018 advanced conformance shard 1.

## Objective

Execute issue `#5139` by extending typed sema-to-lowering and parse/lowering
readiness surfaces with advanced-integration-shard1
...
- `M227-C018` remains a mandatory prerequisite:
...
1. `Objc3TypedSemaToLoweringContractSurface` carries typed advanced-integration-shard1 fields:
   - `typed_advanced_integration_shard1_consistent`
   - `typed_advanced_integration_shard1_ready`
   - `typed_advanced_integration_shard1_key`
2. `Objc3ParseLoweringReadinessSurface` carries mapped typed advanced-integration-shard1 fields:
   - `typed_sema_advanced_integration_shard1_consistent`
   - `typed_sema_advanced_integration_shard1_ready`
   - `typed_sema_advanced_integration_shard1_key`
3. Parse/lowering readiness fails closed when typed advanced-integration-shard1
