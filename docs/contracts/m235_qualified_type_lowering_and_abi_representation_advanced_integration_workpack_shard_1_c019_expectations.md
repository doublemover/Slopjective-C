...
Scope: M235 lane-C qualified type lowering and ABI representation advanced integration workpack (shard 1) continuity for deterministic dependency-chain governance.

## Objective

Fail closed unless lane-C qualified type lowering and ABI representation
advanced integration workpack (shard 1) anchors remain explicit, deterministic, and traceable
...
- Dependencies: `M235-C018`
- M235-C018 advanced conformance workpack (shard 1) anchors remain mandatory prerequisites:
...
- `native/objc3c/src/ARCHITECTURE.md` preserves explicit M235 lane-C C018
  qualified type lowering and ABI representation advanced integration workpack (shard 1) anchors.
- `spec/LOWERING_AND_RUNTIME_CONTRACTS.md` preserves lane-C qualified type
  lowering and ABI representation advanced integration workpack (shard 1) fail-closed dependency wording.
- `spec/MODULE_METADATA_AND_ABI_TABLES.md` preserves deterministic lane-C
  qualified type lowering and ABI representation advanced integration workpack (shard 1) metadata wording.
...
- Readiness dependency chain order: `C018 readiness -> C019 checker -> C019 pytest`.
