...
Scope: M236 lane-E ownership gate and performance evidence docs and operator runbook synchronization bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e013_ownership_gate_and_performance_evidence_docs_and_operator_runbook_synchronization_packet.md`
...
- `python scripts/check_m236_e013_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E013/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e013_ownership_gate_and_performance_evidence_contract.py -q`
