# M238 Qualifier/Generic Grammar Normalization Contract and Architecture Freeze Expectations (A006)

Contract ID: `objc3c-exception-syntax-and-parse-recovery/m238-a006-v1`
Status: Accepted
Scope: M238 lane-A qualifier/generic grammar normalization edge-case expansion and robustness for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_a006_exception_syntax_and_parse_recovery_edge_case_expansion_and_robustness_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M238 lane-A A006 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m238-a006-exception-syntax-and-parse-recovery-contract`.
- `package.json` includes `test:tooling:m238-a006-exception-syntax-and-parse-recovery-contract`.
- `package.json` includes `check:objc3c:m238-a006-lane-a-readiness`.
