...
Scope: M241 lane-E module gate and reproducibility evidence conformance corpus expansion bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_e010_module_gate_and_reproducibility_evidence_conformance_corpus_expansion_packet.md`
...
- `python scripts/check_m241_e010_module_gate_and_reproducibility_evidence_contract.py --summary-out tmp/reports/m241/M241-E010/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m241_e010_module_gate_and_reproducibility_evidence_contract.py -q`
