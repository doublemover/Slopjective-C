...
Status: Accepted
Scope: M236 lane-B qualifier/generic semantic inference edge-case and compatibility completion for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_b005_ownership_semantic_modeling_and_checks_edge_case_and_compatibility_completion_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M236 lane-B B005 qualifier/generic semantic inference fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m236-b005-ownership-semantic-modeling-and-checks-edge-case-and-compatibility-completion-contract`.
- `package.json` includes `test:tooling:m236-b005-ownership-semantic-modeling-and-checks-edge-case-and-compatibility-completion-contract`.
- `package.json` includes `check:objc3c:m236-b005-lane-b-readiness`.
