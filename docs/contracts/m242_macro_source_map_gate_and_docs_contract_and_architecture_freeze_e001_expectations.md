...
Scope: M242 lane-E macro/source-map gate and docs contract and architecture freeze bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e001_macro_source_map_gate_and_docs_contract_and_architecture_freeze_packet.md`
...
- `python scripts/check_m242_e001_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E001/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e001_macro_source_map_gate_and_docs_contract.py -q`
