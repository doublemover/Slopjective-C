...
Status: Accepted
Dependencies: none
Scope: M238 lane-C qualified type lowering and ABI representation advanced conformance workpack (shard 2) for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_c024_cleanup_lowering_and_unwind_control_flow_advanced_conformance_workpack_shard_2_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M238 lane-C C024
...
- `package.json` includes `check:objc3c:m238-c024-lane-c-readiness`.
