...
Status: Accepted
Scope: M236 lane-B qualifier/generic semantic inference advanced performance workpack (shard 1) for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_b020_ownership_semantic_modeling_and_checks_advanced_performance_workpack_shard_1_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M236 lane-B B020 qualifier/generic semantic inference fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m236-b020-ownership-semantic-modeling-and-checks-advanced-performance-workpack-shard-1-contract`.
- `package.json` includes `test:tooling:m236-b020-ownership-semantic-modeling-and-checks-advanced-performance-workpack-shard-1-contract`.
- `package.json` includes `check:objc3c:m236-b020-lane-b-readiness`.
