# M242 Interop Behavior for Qualified Generic APIs Core Feature Expansion Expectations (D004)

Contract ID: `objc3c-build-runtime-integration-for-preprocessing/m242-d004-v1`
Status: Accepted
Dependencies: `M242-C001`
Scope: M242 lane-D interop behavior for qualified generic APIs core feature expansion for nullability, generics, and qualifier completeness interop continuity.
...
- Issue `#6375` defines canonical lane-D core feature expansion scope.
- Dependencies: `M242-C001`
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_d004_build_runtime_integration_for_preprocessing_core_feature_expansion_packet.md`
  - `scripts/check_m242_d004_build_runtime_integration_for_preprocessing_contract.py`
  - `tests/tooling/test_check_m242_d004_build_runtime_integration_for_preprocessing_contract.py`
- Lane-D D004 freeze remains issue-local and fail-closed against `M242-C001` drift.
...
- `python scripts/check_m242_d004_build_runtime_integration_for_preprocessing_contract.py`
- `python -m pytest tests/tooling/test_check_m242_d004_build_runtime_integration_for_preprocessing_contract.py -q`

## Evidence Path

- `tmp/reports/m242/M242-D004/build_runtime_integration_for_preprocessing_contract_summary.json`
