...
Execute conformance matrix implementation governance for lane-C Declaration lowering contract updates, locking deterministic declaration-grammar boundaries before modular split/scaffolding work begins.
...
- `spec/planning/compiler/m231/m231_c009_declaration_lowering_contract_updates_conformance_matrix_implementation_packet.md`
...
- `package.json` (`check:objc3c:m231-c009-lane-c-readiness`)

## Deterministic Invariants

1. Contract-freeze artifacts and packet anchors must remain synchronized and fail closed on drift.
2. Lane-A architecture/spec/package anchors must remain explicit and deterministic for `M231-C009`.
