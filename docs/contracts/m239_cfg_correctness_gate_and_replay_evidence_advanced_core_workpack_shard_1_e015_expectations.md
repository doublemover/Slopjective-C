...
Scope: M239 lane-E cfg correctness gate and replay evidence advanced core workpack (shard 1) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_e015_cfg_correctness_gate_and_replay_evidence_advanced_core_workpack_shard_1_packet.md`
...
- `python scripts/check_m239_e015_cfg_correctness_gate_and_replay_evidence_contract.py --summary-out tmp/reports/m239/M239-E015/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m239_e015_cfg_correctness_gate_and_replay_evidence_contract.py -q`
