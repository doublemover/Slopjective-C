...
Status: Accepted
Dependencies: none
Scope: M237 lane-C qualified type lowering and ABI representation advanced diagnostics workpack (shard 2) for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_c023_block_lowering_and_invoke_emission_advanced_diagnostics_workpack_shard_2_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M237 lane-C C023
...
- `package.json` includes `check:objc3c:m237-c023-lane-c-readiness`.
