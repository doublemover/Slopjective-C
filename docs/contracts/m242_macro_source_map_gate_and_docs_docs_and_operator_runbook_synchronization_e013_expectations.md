...
Scope: M242 lane-E macro/source-map gate and docs docs and operator runbook synchronization bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e013_macro_source_map_gate_and_docs_docs_and_operator_runbook_synchronization_packet.md`
