...
Contract ID: `objc3c-program-control-and-release-readiness-governance/m230-e014-v1`
Status: Accepted
...
Execute release-candidate and replay dry-run governance for lane-E Program control and release readiness governance, locking deterministic conformance-corpus boundaries before modular split/scaffolding work begins.
...
- `spec/planning/compiler/m230/m230_e014_program_control_and_release_readiness_governance_release_candidate_and_replay_dry_run_packet.md`
...
- `package.json` (`check:objc3c:m230-e014-lane-e-readiness`)

## Deterministic Invariants

1. Contract-freeze artifacts and packet anchors must remain synchronized and fail closed on drift.
2. Lane-A architecture/spec/package anchors must remain explicit and deterministic for `M230-E014`.
