...
Status: Accepted
Scope: M246 lane-C IR optimization pass wiring and validation docs and operator runbook synchronization continuity with explicit `M246-C012` dependency governance and predecessor anchor integrity.

## Objective

Fail closed unless lane-C IR optimization pass wiring and validation docs and
...
- C012 packet/checker/test/readiness assets remain mandatory prerequisites:
...
- `scripts/run_m246_c013_lane_c_readiness.py` must preserve fail-closed dependency chaining:
  - `scripts/run_m246_c012_lane_c_readiness.py`
