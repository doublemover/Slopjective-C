...
Status: Accepted
Scope: M237 lane-B qualifier/generic semantic inference cross-lane integration sync for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_b012_block_semantic_capture_and_lifetime_rules_cross_lane_integration_sync_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M237 lane-B B012 qualifier/generic semantic inference fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m237-b012-block-semantic-capture-and-lifetime-rules-cross-lane-integration-sync-contract`.
- `package.json` includes `test:tooling:m237-b012-block-semantic-capture-and-lifetime-rules-cross-lane-integration-sync-contract`.
- `package.json` includes `check:objc3c:m237-b012-lane-b-readiness`.
