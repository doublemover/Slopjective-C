...
Scope: M236 lane-D interop behavior for qualified generic APIs conformance matrix implementation for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_d009_runtime_ownership_abi_and_interoperability_conformance_matrix_implementation_packet.md`
  - `scripts/check_m236_d009_runtime_ownership_abi_and_interoperability_contract.py`
  - `tests/tooling/test_check_m236_d009_runtime_ownership_abi_and_interoperability_contract.py`
- Lane-D D009 freeze remains issue-local and fail-closed against `M236-C001` drift.
...
- `python scripts/check_m236_d009_runtime_ownership_abi_and_interoperability_contract.py`
- `python -m pytest tests/tooling/test_check_m236_d009_runtime_ownership_abi_and_interoperability_contract.py -q`
