...
Scope: M241 lane-E module gate and reproducibility evidence contract and architecture freeze bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_e001_module_gate_and_reproducibility_evidence_contract_and_architecture_freeze_packet.md`
...
- `python scripts/check_m241_e001_module_gate_and_reproducibility_evidence_contract.py --summary-out tmp/reports/m241/M241-E001/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m241_e001_module_gate_and_reproducibility_evidence_contract.py -q`
