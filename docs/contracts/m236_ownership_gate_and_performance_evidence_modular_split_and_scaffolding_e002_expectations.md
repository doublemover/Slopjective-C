...
Scope: M236 lane-E ownership gate and performance evidence modular split and scaffolding bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e002_ownership_gate_and_performance_evidence_modular_split_and_scaffolding_packet.md`
...
- `python scripts/check_m236_e002_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E002/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e002_ownership_gate_and_performance_evidence_contract.py -q`
