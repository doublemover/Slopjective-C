...
Execute core feature expansion governance for lane-A conformance corpus governance and sharding so modular split/scaffolding outputs from `M230-A003` are consumed deterministically and fail-closed before edge-case and compatibility workpacks begin.

This stage treats code/spec anchors and milestone optimization improvements as mandatory scope inputs.

## Dependency Inputs (M230-A003)
...
- `package.json` (`check:objc3c:m230-a004-lane-a-readiness`)

## Deterministic Invariants

1. A004 readiness must chain from `M230-A003` readiness and fail closed when dependency continuity drifts.
