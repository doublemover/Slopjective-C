...
Scope: M242 lane-E macro/source-map gate and docs advanced diagnostics workpack (shard 1) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e017_macro_source_map_gate_and_docs_advanced_diagnostics_workpack_shard_1_packet.md`
