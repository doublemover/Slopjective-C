...
- `artifacts/bin/objc3c-frontend-c-api-runner.exe tests/tooling/fixtures/native/m265_optional_member_access_fail_closed.objc3 --out-dir tmp/artifacts/compilation/objc3c-native/m265/a002/optional-member-access --emit-prefix module --no-emit-ir --no-emit-object`
...
- unsupported claim ids contain only `unsupported:optional-member-access`
- optional-send, nil-coalescing, and typed key-path site counts are nonzero for the positive fixture
- `optional_member_access_fail_closed` remains `true`
