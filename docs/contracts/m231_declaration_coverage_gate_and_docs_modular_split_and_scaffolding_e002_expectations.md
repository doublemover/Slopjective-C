...
Execute modular split and scaffolding governance for lane-E Declaration coverage gate and docs, locking deterministic declaration-grammar boundaries before modular split/scaffolding work begins.
...
- `spec/planning/compiler/m231/m231_e002_declaration_coverage_gate_and_docs_modular_split_and_scaffolding_packet.md`
...
- `package.json` (`check:objc3c:m231-e002-lane-e-readiness`)

## Deterministic Invariants

1. Contract-freeze artifacts and packet anchors must remain synchronized and fail closed on drift.
2. Lane-A architecture/spec/package anchors must remain explicit and deterministic for `M231-E002`.
