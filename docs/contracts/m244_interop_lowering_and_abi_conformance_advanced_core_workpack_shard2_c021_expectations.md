# M244 Interop Lowering and ABI Conformance advanced core workpack (shard 2) Expectations (C021)

Contract ID: `objc3c-interop-lowering-and-abi-conformance-advanced-core-workpack-shard2/m244-c021-v1`
Status: Accepted
Dependencies: `m244-c020`
Scope: lane-C interop lowering/ABI advanced core workpack (shard 2) governance with deterministic dependency continuity and fail-closed readiness integration.

## Objective

Execute lane-C advanced core workpack (shard 2) governance for interop
lowering and ABI conformance on top of C020 docs/runbook synchronization assets.
Deterministic anchors, explicit dependency tokens, and fail-closed behavior are mandatory scope inputs.
Code/spec anchors and milestone optimization improvements are mandatory scope inputs.

## Dependency Scope

- Issue `#6570` defines canonical lane-C advanced core workpack (shard 2) scope.
- `m244-c020` assets remain mandatory prerequisites:
...
2. Readiness command chain enforces `m244-c020` before `m244-c021`
   evidence checks run.
...
- `package.json` includes `check:objc3c:m244-c021-lane-c-readiness`.
