...
Status: Accepted
Scope: M236 lane-A qualifier/generic grammar normalization performance and quality guardrails for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_a011_ownership_syntax_and_annotation_ingestion_performance_and_quality_guardrails_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M236 lane-A A011 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m236-a011-ownership-syntax-and-annotation-ingestion-contract`.
- `package.json` includes `test:tooling:m236-a011-ownership-syntax-and-annotation-ingestion-contract`.
- `package.json` includes `check:objc3c:m236-a011-lane-a-readiness`.
