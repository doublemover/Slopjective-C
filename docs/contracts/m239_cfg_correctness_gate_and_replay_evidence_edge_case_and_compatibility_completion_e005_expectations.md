# M239 CFG correctness gate and replay evidence Edge-case and Compatibility Completion Expectations (E005)

Contract ID: `objc3c-cfg-correctness-gate-and-replay-evidence-edge-case-and-compatibility-completion/m239-e005-v1`
Status: Accepted
Issue: `#5017`
Dependencies: `M239-A001`, `M239-B001`, `M239-C001`
Scope: M239 lane-E cfg correctness gate and replay evidence edge-case and compatibility completion bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_e005_cfg_correctness_gate_and_replay_evidence_edge_case_and_compatibility_completion_packet.md`
  - `scripts/check_m239_e005_cfg_correctness_gate_and_replay_evidence_contract.py`
  - `tests/tooling/test_check_m239_e005_cfg_correctness_gate_and_replay_evidence_contract.py`
...
- `python scripts/check_m239_e005_cfg_correctness_gate_and_replay_evidence_contract.py --summary-out tmp/reports/m239/M239-E005/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m239_e005_cfg_correctness_gate_and_replay_evidence_contract.py -q`

## Evidence Path

- `tmp/reports/m239/M239-E005/local_check_summary.json`
