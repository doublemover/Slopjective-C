...
Status: Accepted
Scope: M249 lane-B core feature expansion continuity for semantic compatibility and migration checks dependency wiring.
...
- M249-B003 core feature implementation anchors remain mandatory prerequisites:
...
- Packet/checker/test/readiness assets for B004 remain mandatory:
...
- `package.json` includes `check:objc3c:m249-b004-lane-b-readiness`.
