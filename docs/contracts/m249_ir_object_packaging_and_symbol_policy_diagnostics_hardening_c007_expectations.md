...
Status: Accepted
Scope: M249 lane-C IR/object packaging and symbol policy diagnostics hardening continuity with explicit `M249-C006` dependency governance.

## Objective

Fail closed unless lane-C IR/object packaging and symbol policy diagnostics
...
This contract treats optimization improvements as mandatory scope inputs.
...
- `package.json` includes `check:objc3c:m249-c007-lane-c-readiness`.
