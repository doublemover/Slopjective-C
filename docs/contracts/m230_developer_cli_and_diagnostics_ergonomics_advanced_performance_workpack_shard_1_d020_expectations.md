...
Execute advanced performance workpack (shard 1) governance for lane-D Developer CLI and diagnostics ergonomics, locking deterministic conformance-corpus boundaries before modular split/scaffolding work begins.
...
- `spec/planning/compiler/m230/m230_d020_developer_cli_and_diagnostics_ergonomics_advanced_performance_workpack_shard_1_packet.md`
...
- `package.json` (`check:objc3c:m230-d020-lane-d-readiness`)

## Deterministic Invariants

1. Contract-freeze artifacts and packet anchors must remain synchronized and fail closed on drift.
2. Lane-A architecture/spec/package anchors must remain explicit and deterministic for `M230-D020`.
