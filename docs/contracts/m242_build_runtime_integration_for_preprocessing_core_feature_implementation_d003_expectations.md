...
Scope: M242 lane-D interop behavior for qualified generic APIs core feature implementation for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_d003_build_runtime_integration_for_preprocessing_core_feature_implementation_packet.md`
  - `scripts/check_m242_d003_build_runtime_integration_for_preprocessing_contract.py`
  - `tests/tooling/test_check_m242_d003_build_runtime_integration_for_preprocessing_contract.py`
- Lane-D D003 freeze remains issue-local and fail-closed against `M242-C001` drift.
...
- `python scripts/check_m242_d003_build_runtime_integration_for_preprocessing_contract.py`
- `python -m pytest tests/tooling/test_check_m242_d003_build_runtime_integration_for_preprocessing_contract.py -q`
