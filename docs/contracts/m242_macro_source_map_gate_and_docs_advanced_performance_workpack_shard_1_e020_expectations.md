# M242 Macro/source-map gate and docs Advanced Performance Workpack (shard 1) Expectations (E020)

Contract ID: `objc3c-macro-source-map-gate-and-docs-advanced-performance-workpack-shard-1/m242-e020-v1`
Status: Accepted
Issue: `#6412`
Dependencies: `M242-A001`, `M242-B001`, `M242-C001`
Scope: M242 lane-E macro/source-map gate and docs advanced performance workpack (shard 1) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e020_macro_source_map_gate_and_docs_advanced_performance_workpack_shard_1_packet.md`
  - `scripts/check_m242_e020_macro_source_map_gate_and_docs_contract.py`
  - `tests/tooling/test_check_m242_e020_macro_source_map_gate_and_docs_contract.py`
...
- `python scripts/check_m242_e020_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E020/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e020_macro_source_map_gate_and_docs_contract.py -q`

## Evidence Path

- `tmp/reports/m242/M242-E020/local_check_summary.json`
