...
Status: Accepted
Scope: M237 lane-B qualifier/generic semantic inference release-candidate and replay dry-run for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_b014_block_semantic_capture_and_lifetime_rules_release_candidate_and_replay_dry_run_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M237 lane-B B014 qualifier/generic semantic inference fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m237-b014-block-semantic-capture-and-lifetime-rules-release-candidate-and-replay-dry-run-contract`.
- `package.json` includes `test:tooling:m237-b014-block-semantic-capture-and-lifetime-rules-release-candidate-and-replay-dry-run-contract`.
- `package.json` includes `check:objc3c:m237-b014-lane-b-readiness`.
