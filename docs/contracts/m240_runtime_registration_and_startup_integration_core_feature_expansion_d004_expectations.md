...
Scope: M240 lane-D interop behavior for qualified generic APIs core feature expansion for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_d004_runtime_registration_and_startup_integration_core_feature_expansion_packet.md`
...
- Lane-D D004 freeze remains issue-local and fail-closed against `M240-C001` drift.
