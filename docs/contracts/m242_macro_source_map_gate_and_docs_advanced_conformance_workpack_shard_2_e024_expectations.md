# M242 Macro/source-map gate and docs Advanced Conformance Workpack (shard 2) Expectations (E024)

Contract ID: `objc3c-macro-source-map-gate-and-docs-advanced-conformance-workpack-shard-2/m242-e024-v1`
Status: Accepted
Issue: `#6416`
Dependencies: `M242-A001`, `M242-B001`, `M242-C001`
Scope: M242 lane-E macro/source-map gate and docs advanced conformance workpack (shard 2) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e024_macro_source_map_gate_and_docs_advanced_conformance_workpack_shard_2_packet.md`
  - `scripts/check_m242_e024_macro_source_map_gate_and_docs_contract.py`
  - `tests/tooling/test_check_m242_e024_macro_source_map_gate_and_docs_contract.py`
...
- `python scripts/check_m242_e024_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E024/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e024_macro_source_map_gate_and_docs_contract.py -q`

## Evidence Path

- `tmp/reports/m242/M242-E024/local_check_summary.json`
