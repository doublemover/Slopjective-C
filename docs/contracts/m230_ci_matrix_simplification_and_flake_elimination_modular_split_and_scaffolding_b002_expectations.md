...
Contract ID: `objc3c-ci-matrix-simplification-and-flake-elimination/m230-b002-v1`
Status: Accepted
...
Execute modular split and scaffolding governance for lane-B CI matrix simplification and flake elimination, locking deterministic conformance-corpus boundaries before modular split/scaffolding work begins.
...
- `spec/planning/compiler/m230/m230_b002_ci_matrix_simplification_and_flake_elimination_modular_split_and_scaffolding_packet.md`
...
- `package.json` (`check:objc3c:m230-b002-lane-b-readiness`)

## Deterministic Invariants

1. Contract-freeze artifacts and packet anchors must remain synchronized and fail closed on drift.
2. Lane-A architecture/spec/package anchors must remain explicit and deterministic for `M230-B002`.
