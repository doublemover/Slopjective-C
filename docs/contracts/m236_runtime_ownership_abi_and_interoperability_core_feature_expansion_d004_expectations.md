...
Scope: M236 lane-D interop behavior for qualified generic APIs core feature expansion for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_d004_runtime_ownership_abi_and_interoperability_core_feature_expansion_packet.md`
...
- Lane-D D004 freeze remains issue-local and fail-closed against `M236-C001` drift.
