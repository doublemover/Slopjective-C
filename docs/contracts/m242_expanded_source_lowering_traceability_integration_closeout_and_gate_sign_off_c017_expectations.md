...
Status: Accepted
Dependencies: none
Scope: M242 lane-C qualified type lowering and ABI representation integration closeout and gate sign-off for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_c017_expanded_source_lowering_traceability_integration_closeout_and_gate_sign_off_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M242 lane-C C017
...
- `package.json` includes `check:objc3c:m242-c017-lane-c-readiness`.
