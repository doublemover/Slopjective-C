...
Scope: M236 lane-E ownership gate and performance evidence advanced conformance workpack (shard 1) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e018_ownership_gate_and_performance_evidence_advanced_conformance_workpack_shard_1_packet.md`
...
- `python scripts/check_m236_e018_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E018/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e018_ownership_gate_and_performance_evidence_contract.py -q`
