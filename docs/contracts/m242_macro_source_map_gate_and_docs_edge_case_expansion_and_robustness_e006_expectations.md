...
Scope: M242 lane-E macro/source-map gate and docs edge-case expansion and robustness bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e006_macro_source_map_gate_and_docs_edge_case_expansion_and_robustness_packet.md`
