...
- `native/objc3c/src/ARCHITECTURE.md` preserves lane-D `M249-D019`
  advanced integration workpack (shard 1) continuity anchors tied to `M249-D017` advanced-diagnostics closure.
...
- `scripts/run_m249_d019_lane_d_readiness.py` enforces predecessor chaining
  through `python scripts/run_m249_d017_lane_d_readiness.py` before D019 checks execute.
