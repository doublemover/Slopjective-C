# M240 Metadata gate, docs, and operations Docs and Operator Runbook Synchronization Expectations (E013)

Contract ID: `objc3c-metadata-gate-docs-and-operations-docs-and-operator-runbook-synchronization/m240-e013-v1`
Status: Accepted
Issue: `#6227`
Dependencies: `M240-A001`, `M240-B001`, `M240-C001`
Scope: M240 lane-E metadata gate, docs, and operations docs and operator runbook synchronization bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_e013_metadata_gate_docs_and_operations_docs_and_operator_runbook_synchronization_packet.md`
  - `scripts/check_m240_e013_metadata_gate_docs_and_operations_contract.py`
  - `tests/tooling/test_check_m240_e013_metadata_gate_docs_and_operations_contract.py`
...
- `python scripts/check_m240_e013_metadata_gate_docs_and_operations_contract.py --summary-out tmp/reports/m240/M240-E013/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m240_e013_metadata_gate_docs_and_operations_contract.py -q`

## Evidence Path

- `tmp/reports/m240/M240-E013/local_check_summary.json`
