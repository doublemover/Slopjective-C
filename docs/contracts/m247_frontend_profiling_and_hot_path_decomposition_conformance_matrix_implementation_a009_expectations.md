...
Scope: M247 lane-A conformance matrix implementation governance for frontend profiling and hot-path decomposition with deterministic dependency continuity and fail-closed readiness integration.
...
- Packet/checker/test/readiness assets for A009 remain mandatory:
...
- `native/objc3c/src/ARCHITECTURE.md` preserves explicit lane-A frontend profiling
  and hot-path decomposition conformance matrix anchor continuity for `M247-A009`.
- `spec/LOWERING_AND_RUNTIME_CONTRACTS.md` preserves lane-A frontend profiling
  and hot-path decomposition conformance matrix fail-closed governance wording.
- `spec/MODULE_METADATA_AND_ABI_TABLES.md` preserves deterministic lane-A
  frontend profiling and hot-path decomposition conformance matrix metadata
