...
Status: Accepted
Scope: M242 lane-A qualifier/generic grammar normalization contract and architecture freeze for nullability, generics, and qualifier completeness.
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M242 lane-A A001 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m242-a001-directive-parsing-and-token-stream-integration-contract`.
- `package.json` includes `test:tooling:m242-a001-directive-parsing-and-token-stream-integration-contract`.
- `package.json` includes `check:objc3c:m242-a001-lane-a-readiness`.
