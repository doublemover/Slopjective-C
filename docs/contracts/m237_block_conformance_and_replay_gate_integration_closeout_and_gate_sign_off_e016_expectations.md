...
Scope: M237 lane-E block conformance and replay gate integration closeout and gate sign-off bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_e016_block_conformance_and_replay_gate_integration_closeout_and_gate_sign_off_packet.md`
...
- `python scripts/check_m237_e016_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E016/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e016_block_conformance_and_replay_gate_contract.py -q`
