...
Scope: M241 lane-D interop behavior for qualified generic APIs diagnostics hardening for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_d007_build_system_and_artifact_orchestration_diagnostics_hardening_packet.md`
  - `scripts/check_m241_d007_build_system_and_artifact_orchestration_contract.py`
  - `tests/tooling/test_check_m241_d007_build_system_and_artifact_orchestration_contract.py`
- Lane-D D007 freeze remains issue-local and fail-closed against `M241-C001` drift.
...
- `python scripts/check_m241_d007_build_system_and_artifact_orchestration_contract.py`
- `python -m pytest tests/tooling/test_check_m241_d007_build_system_and_artifact_orchestration_contract.py -q`
