...
Status: Accepted
Dependencies: none
Scope: M236 lane-C qualified type lowering and ABI representation advanced integration workpack (shard 3) for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_c031_arc_style_lowering_insertion_and_cleanup_advanced_integration_workpack_shard_3_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M236 lane-C C031
...
- `package.json` includes `check:objc3c:m236-c031-lane-c-readiness`.
