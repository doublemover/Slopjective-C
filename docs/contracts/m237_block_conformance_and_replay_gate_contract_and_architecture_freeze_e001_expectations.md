...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_e001_block_conformance_and_replay_gate_contract_and_architecture_freeze_packet.md`
...
- `python scripts/check_m237_e001_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E001/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e001_block_conformance_and_replay_gate_contract.py -q`
