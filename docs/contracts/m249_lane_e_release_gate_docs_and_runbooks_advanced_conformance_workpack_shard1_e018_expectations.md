...
- Issue: `#6965`
Scope: M249 lane-E release gate/docs/runbooks advanced conformance workpack (shard 1) continuity for deterministic readiness-chain governance.

## Objective

Fail closed unless M249 lane-E release gate/docs/runbooks advanced conformance
...
- Prerequisite advanced diagnostics workpack (shard 1) assets from `M249-E017` remain mandatory:
...
- Packet/checker/test/readiness assets for `M249-E018` remain mandatory:
...
- `native/objc3c/src/ARCHITECTURE.md` preserves lane-E `M249-E018`
  advanced conformance workpack (shard 1) continuity anchors tied to
  `M249-E017`, `M249-A007`, `M249-B008`, `M249-C009`, and `M249-D015`.
- `spec/LOWERING_AND_RUNTIME_CONTRACTS.md` preserves lane-E release
  gate/docs/runbooks advanced conformance workpack (shard 1) fail-closed governance wording.
- `spec/MODULE_METADATA_AND_ABI_TABLES.md` preserves deterministic lane-E
  release gate/docs/runbooks advanced conformance workpack (shard 1)
  metadata wording for dependency continuity.

## Build and Readiness Integration

- `scripts/run_m249_e018_lane_e_readiness.py` enforces predecessor chaining
  through `python scripts/run_m249_e017_lane_e_readiness.py` before E018 checks execute.
- `package.json` exposes:
  - `check:objc3c:m249-e018-lane-e-release-gate-docs-runbooks-advanced-conformance-workpack-shard1-contract`
  - `test:tooling:m249-e018-lane-e-release-gate-docs-runbooks-advanced-conformance-workpack-shard1-contract`
  - `check:objc3c:m249-e018-lane-e-readiness`
