...
Scope: M239 lane-E cfg correctness gate and replay evidence recovery and determinism hardening bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_e008_cfg_correctness_gate_and_replay_evidence_recovery_and_determinism_hardening_packet.md`
...
- `python scripts/check_m239_e008_cfg_correctness_gate_and_replay_evidence_contract.py --summary-out tmp/reports/m239/M239-E008/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m239_e008_cfg_correctness_gate_and_replay_evidence_contract.py -q`
