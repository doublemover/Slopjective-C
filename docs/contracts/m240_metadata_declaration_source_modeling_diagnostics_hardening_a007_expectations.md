...
Status: Accepted
Scope: M240 lane-A qualifier/generic grammar normalization diagnostics hardening for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_a007_metadata_declaration_source_modeling_diagnostics_hardening_packet.md`
  - `scripts/check_m240_a007_metadata_declaration_source_modeling_contract.py`
  - `tests/tooling/test_check_m240_a007_metadata_declaration_source_modeling_contract.py`

## Architecture and Spec Anchors

- `native/objc3c/src/ARCHITECTURE.md` includes explicit M240 lane-A A007 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m240-a007-metadata-declaration-source-modeling-contract`.
- `package.json` includes `test:tooling:m240-a007-metadata-declaration-source-modeling-contract`.
- `package.json` includes `check:objc3c:m240-a007-lane-a-readiness`.
...
- `npm run check:objc3c:m240-a007-lane-a-readiness`
