...
Scope: M236 lane-D interop behavior for qualified generic APIs contract and architecture freeze for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_d001_runtime_ownership_abi_and_interoperability_contract_and_architecture_freeze_packet.md`
  - `scripts/check_m236_d001_runtime_ownership_abi_and_interoperability_contract.py`
  - `tests/tooling/test_check_m236_d001_runtime_ownership_abi_and_interoperability_contract.py`
- Lane-D D001 freeze remains issue-local and fail-closed against `M236-C001` drift.
...
- `python scripts/check_m236_d001_runtime_ownership_abi_and_interoperability_contract.py`
- `python -m pytest tests/tooling/test_check_m236_d001_runtime_ownership_abi_and_interoperability_contract.py -q`
