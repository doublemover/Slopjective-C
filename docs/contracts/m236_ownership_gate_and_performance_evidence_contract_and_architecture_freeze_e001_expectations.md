...
Scope: M236 lane-E ownership gate and performance evidence contract and architecture freeze bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e001_ownership_gate_and_performance_evidence_contract_and_architecture_freeze_packet.md`
...
- `python scripts/check_m236_e001_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E001/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e001_ownership_gate_and_performance_evidence_contract.py -q`
