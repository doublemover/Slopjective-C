# M243 Lane-E Diagnostics Quality Gate and Replay Policy Advanced Diagnostics Workpack (shard 2) Expectations (E023)
...
- Issue `#6509` defines the canonical lane-E dependency chain for E012.
...
- `python scripts/check_m243_e023_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_diagnostics_workpack_shard_2_contract.py --emit-json`
