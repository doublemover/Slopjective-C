...
Status: Accepted
Scope: M237 lane-A qualifier/generic grammar normalization conformance matrix implementation for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_a009_block_syntax_and_capture_declarations_conformance_matrix_implementation_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M237 lane-A A009 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m237-a009-block-syntax-and-capture-declarations-contract`.
- `package.json` includes `test:tooling:m237-a009-block-syntax-and-capture-declarations-contract`.
- `package.json` includes `check:objc3c:m237-a009-lane-a-readiness`.
