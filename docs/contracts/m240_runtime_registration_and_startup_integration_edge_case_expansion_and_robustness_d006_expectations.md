# M240 Interop Behavior for Qualified Generic APIs Edge-case Expansion and Robustness Expectations (D006)

Contract ID: `objc3c-runtime-registration-and-startup-integration/m240-d006-v1`
Status: Accepted
Dependencies: `M240-C001`
Scope: M240 lane-D interop behavior for qualified generic APIs edge-case expansion and robustness for nullability, generics, and qualifier completeness interop continuity.
...
- Issue `#6195` defines canonical lane-D edge-case expansion and robustness scope.
- Dependencies: `M240-C001`
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_d006_runtime_registration_and_startup_integration_edge_case_expansion_and_robustness_packet.md`
  - `scripts/check_m240_d006_runtime_registration_and_startup_integration_contract.py`
  - `tests/tooling/test_check_m240_d006_runtime_registration_and_startup_integration_contract.py`
- Lane-D D006 freeze remains issue-local and fail-closed against `M240-C001` drift.
...
- `python scripts/check_m240_d006_runtime_registration_and_startup_integration_contract.py`
- `python -m pytest tests/tooling/test_check_m240_d006_runtime_registration_and_startup_integration_contract.py -q`

## Evidence Path

- `tmp/reports/m240/M240-D006/runtime_registration_and_startup_integration_contract_summary.json`
