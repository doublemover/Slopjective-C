...
Scope: M241 lane-D interop behavior for qualified generic APIs edge-case expansion and robustness for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_d006_build_system_and_artifact_orchestration_edge_case_expansion_and_robustness_packet.md`
...
- Lane-D D006 freeze remains issue-local and fail-closed against `M241-C001` drift.
