# M238 Exception conformance gate and documentation Cross-lane Integration Sync Expectations (E012)

Contract ID: `objc3c-exception-conformance-gate-and-documentation-cross-lane-integration-sync/m238-e012-v1`
Status: Accepted
Issue: `#6126`
Dependencies: `M238-A001`, `M238-B001`, `M238-C001`
Scope: M238 lane-E exception conformance gate and documentation cross-lane integration sync bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_e012_exception_conformance_gate_and_documentation_cross_lane_integration_sync_packet.md`
  - `scripts/check_m238_e012_exception_conformance_gate_and_documentation_contract.py`
  - `tests/tooling/test_check_m238_e012_exception_conformance_gate_and_documentation_contract.py`
...
- `python scripts/check_m238_e012_exception_conformance_gate_and_documentation_contract.py --summary-out tmp/reports/m238/M238-E012/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m238_e012_exception_conformance_gate_and_documentation_contract.py -q`

## Evidence Path

- `tmp/reports/m238/M238-E012/local_check_summary.json`
