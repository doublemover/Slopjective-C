...
Scope: M240 lane-D interop behavior for qualified generic APIs advanced conformance workpack (shard 2) for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_d024_runtime_registration_and_startup_integration_advanced_conformance_workpack_shard_2_packet.md`
...
- Lane-D D024 freeze remains issue-local and fail-closed against `M240-C001` drift.
