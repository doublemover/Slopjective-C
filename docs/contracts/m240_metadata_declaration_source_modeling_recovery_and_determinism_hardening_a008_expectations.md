...
Status: Accepted
Scope: M240 lane-A qualifier/generic grammar normalization recovery and determinism hardening for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_a008_metadata_declaration_source_modeling_recovery_and_determinism_hardening_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M240 lane-A A008 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m240-a008-metadata-declaration-source-modeling-contract`.
- `package.json` includes `test:tooling:m240-a008-metadata-declaration-source-modeling-contract`.
- `package.json` includes `check:objc3c:m240-a008-lane-a-readiness`.
