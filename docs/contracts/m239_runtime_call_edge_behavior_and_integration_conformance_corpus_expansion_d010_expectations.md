...
Scope: M239 lane-D interop behavior for qualified generic APIs conformance corpus expansion for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_d010_runtime_call_edge_behavior_and_integration_conformance_corpus_expansion_packet.md`
  - `scripts/check_m239_d010_runtime_call_edge_behavior_and_integration_contract.py`
  - `tests/tooling/test_check_m239_d010_runtime_call_edge_behavior_and_integration_contract.py`
- Lane-D D010 freeze remains issue-local and fail-closed against `M239-C001` drift.
...
- `python scripts/check_m239_d010_runtime_call_edge_behavior_and_integration_contract.py`
- `python -m pytest tests/tooling/test_check_m239_d010_runtime_call_edge_behavior_and_integration_contract.py -q`
