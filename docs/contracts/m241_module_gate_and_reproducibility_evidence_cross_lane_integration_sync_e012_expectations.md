...
Scope: M241 lane-E module gate and reproducibility evidence cross-lane integration sync bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_e012_module_gate_and_reproducibility_evidence_cross_lane_integration_sync_packet.md`
...
- `python scripts/check_m241_e012_module_gate_and_reproducibility_evidence_contract.py --summary-out tmp/reports/m241/M241-E012/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m241_e012_module_gate_and_reproducibility_evidence_contract.py -q`
