...
Scope: M238 lane-E exception conformance gate and documentation core feature expansion bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_e004_exception_conformance_gate_and_documentation_core_feature_expansion_packet.md`
...
- `python scripts/check_m238_e004_exception_conformance_gate_and_documentation_contract.py --summary-out tmp/reports/m238/M238-E004/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m238_e004_exception_conformance_gate_and_documentation_contract.py -q`
