# M241 Module gate and reproducibility evidence Integration Closeout and Gate Sign-off Expectations (E032)

Contract ID: `objc3c-module-gate-and-reproducibility-evidence-integration-closeout-and-gate-sign-off/m241-e032-v1`
Status: Accepted
Issue: `#6329`
Dependencies: `M241-A001`, `M241-B001`, `M241-C001`
Scope: M241 lane-E module gate and reproducibility evidence integration closeout and gate sign-off bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_e032_module_gate_and_reproducibility_evidence_integration_closeout_and_gate_sign_off_packet.md`
  - `scripts/check_m241_e032_module_gate_and_reproducibility_evidence_contract.py`
  - `tests/tooling/test_check_m241_e032_module_gate_and_reproducibility_evidence_contract.py`
...
- `python scripts/check_m241_e032_module_gate_and_reproducibility_evidence_contract.py --summary-out tmp/reports/m241/M241-E032/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m241_e032_module_gate_and_reproducibility_evidence_contract.py -q`

## Evidence Path

- `tmp/reports/m241/M241-E032/local_check_summary.json`
