...
Execute modular split and scaffolding governance for lane-C interop boundary ABI handling, locking deterministic declaration-grammar boundaries before modular split/scaffolding work begins.
...
- `spec/planning/compiler/m229/m229_c002_interop_boundary_abi_handling_modular_split_and_scaffolding_packet.md`
...
- `package.json` (`check:objc3c:m229-c002-lane-c-readiness`)

## Deterministic Invariants

1. Contract-freeze artifacts and packet anchors must remain synchronized and fail closed on drift.
2. Lane-B architecture/spec/package anchors must remain explicit and deterministic for `M229-C002`.
