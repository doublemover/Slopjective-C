...
Status: Accepted
Dependencies: none
Scope: M241 lane-C qualified type lowering and ABI representation core feature implementation for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_c003_incremental_lowering_and_artifact_reuse_core_feature_implementation_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M241 lane-C C003
...
- `package.json` includes `check:objc3c:m241-c003-lane-c-readiness`.
