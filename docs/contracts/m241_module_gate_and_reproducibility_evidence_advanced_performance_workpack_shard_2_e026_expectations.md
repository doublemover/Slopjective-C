...
Scope: M241 lane-E module gate and reproducibility evidence advanced performance workpack (shard 2) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_e026_module_gate_and_reproducibility_evidence_advanced_performance_workpack_shard_2_packet.md`
...
- `python scripts/check_m241_e026_module_gate_and_reproducibility_evidence_contract.py --summary-out tmp/reports/m241/M241-E026/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m241_e026_module_gate_and_reproducibility_evidence_contract.py -q`
