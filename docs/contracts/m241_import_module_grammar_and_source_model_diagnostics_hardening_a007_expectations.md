...
Status: Accepted
Scope: M241 lane-A qualifier/generic grammar normalization diagnostics hardening for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_a007_import_module_grammar_and_source_model_diagnostics_hardening_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M241 lane-A A007 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m241-a007-import-module-grammar-and-source-model-contract`.
- `package.json` includes `test:tooling:m241-a007-import-module-grammar-and-source-model-contract`.
- `package.json` includes `check:objc3c:m241-a007-lane-a-readiness`.
