...
Scope: M236 lane-D interop behavior for qualified generic APIs recovery and determinism hardening for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_d008_runtime_ownership_abi_and_interoperability_recovery_and_determinism_hardening_packet.md`
...
- Lane-D D008 freeze remains issue-local and fail-closed against `M236-C001` drift.
