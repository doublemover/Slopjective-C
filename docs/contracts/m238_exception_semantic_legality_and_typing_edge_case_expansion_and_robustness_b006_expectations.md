...
Status: Accepted
Scope: M238 lane-B qualifier/generic semantic inference edge-case expansion and robustness for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_b006_exception_semantic_legality_and_typing_edge_case_expansion_and_robustness_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M238 lane-B B006 qualifier/generic semantic inference fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m238-b006-exception-semantic-legality-and-typing-edge-case-expansion-and-robustness-contract`.
- `package.json` includes `test:tooling:m238-b006-exception-semantic-legality-and-typing-edge-case-expansion-and-robustness-contract`.
- `package.json` includes `check:objc3c:m238-b006-lane-b-readiness`.
