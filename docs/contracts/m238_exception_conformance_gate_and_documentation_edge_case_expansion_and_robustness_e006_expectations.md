...
Scope: M238 lane-E exception conformance gate and documentation edge-case expansion and robustness bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_e006_exception_conformance_gate_and_documentation_edge_case_expansion_and_robustness_packet.md`
...
- `python scripts/check_m238_e006_exception_conformance_gate_and_documentation_contract.py --summary-out tmp/reports/m238/M238-E006/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m238_e006_exception_conformance_gate_and_documentation_contract.py -q`
