...
Status: Accepted
Scope: M239 lane-A qualifier/generic grammar normalization conformance corpus expansion for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_a010_frontend_normalization_hints_for_cfg_quality_conformance_corpus_expansion_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M239 lane-A A010 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m239-a010-frontend-normalization-hints-for-cfg-quality-contract`.
- `package.json` includes `test:tooling:m239-a010-frontend-normalization-hints-for-cfg-quality-contract`.
- `package.json` includes `check:objc3c:m239-a010-lane-a-readiness`.
