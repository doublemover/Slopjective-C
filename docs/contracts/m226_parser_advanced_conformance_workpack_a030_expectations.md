# M226 Parser Advanced Conformance Workpack Expectations (A030)

Contract ID: `objc3c-parser-advanced-conformance-workpack-contract/m226-a030-v1`
Status: Accepted
Scope: Parser advanced conformance workpack shard 3 for native frontend decomposition and parser completeness.
...
1. Shard-2 conformance runner exists:
   - `scripts/run_m226_a030_parser_conformance_workpack.ps1`
...
7. Validation entrypoints are pinned:
   - `python scripts/check_m226_a030_parser_advanced_conformance_workpack_contract.py`
   - `python -m pytest tests/tooling/test_check_m226_a030_parser_advanced_conformance_workpack_contract.py -q`

## Validation

- `python scripts/check_m226_a030_parser_advanced_conformance_workpack_contract.py`
- `python -m pytest tests/tooling/test_check_m226_a030_parser_advanced_conformance_workpack_contract.py -q`
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/run_m226_a030_parser_conformance_workpack.ps1`
