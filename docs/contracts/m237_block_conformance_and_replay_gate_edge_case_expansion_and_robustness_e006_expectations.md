# M237 Block conformance and replay gate Edge-case Expansion and Robustness Expectations (E006)

Contract ID: `objc3c-block-conformance-and-replay-gate-edge-case-expansion-and-robustness/m237-e006-v1`
Status: Accepted
Issue: `#6037`
Dependencies: `M237-A001`, `M237-B001`, `M237-C001`
Scope: M237 lane-E block conformance and replay gate edge-case expansion and robustness bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_e006_block_conformance_and_replay_gate_edge_case_expansion_and_robustness_packet.md`
...
- `python scripts/check_m237_e006_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E006/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e006_block_conformance_and_replay_gate_contract.py -q`
