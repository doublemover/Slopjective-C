...
Scope: M247 lane-B semantic hot-path analysis and budgeting advanced core workpack (shard 1) dependency continuity and fail-closed readiness governance.
...
- `M247-B014` release-candidate/replay dry-run anchors remain mandatory prerequisites:
