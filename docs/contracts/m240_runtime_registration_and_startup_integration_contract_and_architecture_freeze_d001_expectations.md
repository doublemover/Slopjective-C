...
Scope: M240 lane-D interop behavior for qualified generic APIs contract and architecture freeze for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_d001_runtime_registration_and_startup_integration_contract_and_architecture_freeze_packet.md`
  - `scripts/check_m240_d001_runtime_registration_and_startup_integration_contract.py`
  - `tests/tooling/test_check_m240_d001_runtime_registration_and_startup_integration_contract.py`
- Lane-D D001 freeze remains issue-local and fail-closed against `M240-C001` drift.
...
- `python scripts/check_m240_d001_runtime_registration_and_startup_integration_contract.py`
- `python -m pytest tests/tooling/test_check_m240_d001_runtime_registration_and_startup_integration_contract.py -q`
