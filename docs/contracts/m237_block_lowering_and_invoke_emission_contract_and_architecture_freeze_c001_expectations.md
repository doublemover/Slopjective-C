...
Status: Accepted
Dependencies: none
Scope: M237 lane-C qualified type lowering and ABI representation contract and architecture freeze for nullability, generics, and qualifier completeness.
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M237 lane-C C001
