# M240 Metadata gate, docs, and operations Edge-case Expansion and Robustness Expectations (E006)

Contract ID: `objc3c-metadata-gate-docs-and-operations-edge-case-expansion-and-robustness/m240-e006-v1`
Status: Accepted
Issue: `#6220`
Dependencies: `M240-A001`, `M240-B001`, `M240-C001`
Scope: M240 lane-E metadata gate, docs, and operations edge-case expansion and robustness bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_e006_metadata_gate_docs_and_operations_edge_case_expansion_and_robustness_packet.md`
  - `scripts/check_m240_e006_metadata_gate_docs_and_operations_contract.py`
  - `tests/tooling/test_check_m240_e006_metadata_gate_docs_and_operations_contract.py`
...
- `python scripts/check_m240_e006_metadata_gate_docs_and_operations_contract.py --summary-out tmp/reports/m240/M240-E006/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m240_e006_metadata_gate_docs_and_operations_contract.py -q`

## Evidence Path

- `tmp/reports/m240/M240-E006/local_check_summary.json`
