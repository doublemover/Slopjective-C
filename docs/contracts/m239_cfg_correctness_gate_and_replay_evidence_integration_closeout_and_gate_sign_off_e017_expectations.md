...
Scope: M239 lane-E cfg correctness gate and replay evidence integration closeout and gate sign-off bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_e017_cfg_correctness_gate_and_replay_evidence_integration_closeout_and_gate_sign_off_packet.md`
...
- `python scripts/check_m239_e017_cfg_correctness_gate_and_replay_evidence_contract.py --summary-out tmp/reports/m239/M239-E017/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m239_e017_cfg_correctness_gate_and_replay_evidence_contract.py -q`
