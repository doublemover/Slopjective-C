# M242 Macro/source-map gate and docs Edge-case and Compatibility Completion Expectations (E005)

Contract ID: `objc3c-macro-source-map-gate-and-docs-edge-case-and-compatibility-completion/m242-e005-v1`
Status: Accepted
Issue: `#6397`
Dependencies: `M242-A001`, `M242-B001`, `M242-C001`
Scope: M242 lane-E macro/source-map gate and docs edge-case and compatibility completion bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e005_macro_source_map_gate_and_docs_edge_case_and_compatibility_completion_packet.md`
  - `scripts/check_m242_e005_macro_source_map_gate_and_docs_contract.py`
  - `tests/tooling/test_check_m242_e005_macro_source_map_gate_and_docs_contract.py`
...
- `python scripts/check_m242_e005_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E005/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e005_macro_source_map_gate_and_docs_contract.py -q`

## Evidence Path

- `tmp/reports/m242/M242-E005/local_check_summary.json`
