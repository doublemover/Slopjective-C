...
Scope: M236 lane-E ownership gate and performance evidence release-candidate and replay dry-run bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e014_ownership_gate_and_performance_evidence_release_candidate_and_replay_dry_run_packet.md`
