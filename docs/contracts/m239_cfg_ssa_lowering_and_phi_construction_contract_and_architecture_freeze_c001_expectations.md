...
Status: Accepted
Dependencies: none
Scope: M239 lane-C qualified type lowering and ABI representation contract and architecture freeze for nullability, generics, and qualifier completeness.
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M239 lane-C C001
