...
Scope: M238 lane-E exception conformance gate and documentation edge-case and compatibility completion bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_e005_exception_conformance_gate_and_documentation_edge_case_and_compatibility_completion_packet.md`
...
- `python scripts/check_m238_e005_exception_conformance_gate_and_documentation_contract.py --summary-out tmp/reports/m238/M238-E005/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m238_e005_exception_conformance_gate_and_documentation_contract.py -q`
