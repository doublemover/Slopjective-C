...
Scope: M236 lane-D interop behavior for qualified generic APIs integration closeout and gate sign-off for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_d014_runtime_ownership_abi_and_interoperability_integration_closeout_and_gate_sign_off_packet.md`
  - `scripts/check_m236_d014_runtime_ownership_abi_and_interoperability_contract.py`
  - `tests/tooling/test_check_m236_d014_runtime_ownership_abi_and_interoperability_contract.py`
- Lane-D D014 freeze remains issue-local and fail-closed against `M236-C001` drift.
...
- `python scripts/check_m236_d014_runtime_ownership_abi_and_interoperability_contract.py`
- `python -m pytest tests/tooling/test_check_m236_d014_runtime_ownership_abi_and_interoperability_contract.py -q`
