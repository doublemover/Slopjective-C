# M243 Lane-E Diagnostics Quality Gate and Replay Policy Advanced Conformance Workpack (shard 2) Expectations (E024)
...
- Issue `#6510` defines the canonical lane-E dependency chain for E012.
...
- `python scripts/check_m243_e024_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_conformance_workpack_shard_2_contract.py --emit-json`
