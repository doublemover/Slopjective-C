...
Scope: M237 lane-D interop behavior for qualified generic APIs integration closeout and gate sign-off for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_d012_block_runtime_abi_wiring_and_linkage_integration_closeout_and_gate_sign_off_packet.md`
...
- Lane-D D012 freeze remains issue-local and fail-closed against `M237-C001` drift.
