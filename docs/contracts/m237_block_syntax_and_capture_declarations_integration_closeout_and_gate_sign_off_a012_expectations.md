...
Status: Accepted
Scope: M237 lane-A qualifier/generic grammar normalization integration closeout and gate sign-off for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_a012_block_syntax_and_capture_declarations_integration_closeout_and_gate_sign_off_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M237 lane-A A012 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m237-a012-block-syntax-and-capture-declarations-contract`.
- `package.json` includes `test:tooling:m237-a012-block-syntax-and-capture-declarations-contract`.
- `package.json` includes `check:objc3c:m237-a012-lane-a-readiness`.
