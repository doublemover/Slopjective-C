# M238 Interop Behavior for Qualified Generic APIs Diagnostics Hardening Expectations (D007)

Contract ID: `objc3c-runtime-and-linker-exception-integration/m238-d007-v1`
Status: Accepted
Dependencies: `M238-C001`
Scope: M238 lane-D interop behavior for qualified generic APIs diagnostics hardening for nullability, generics, and qualifier completeness interop continuity.
...
- Issue `#6110` defines canonical lane-D diagnostics hardening scope.
- Dependencies: `M238-C001`
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_d007_runtime_and_linker_exception_integration_diagnostics_hardening_packet.md`
...
- Lane-D D007 freeze remains issue-local and fail-closed against `M238-C001` drift.
