...
Scope: M240 lane-E metadata gate, docs, and operations core feature expansion bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_e004_metadata_gate_docs_and_operations_core_feature_expansion_packet.md`
...
- `python scripts/check_m240_e004_metadata_gate_docs_and_operations_contract.py --summary-out tmp/reports/m240/M240-E004/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m240_e004_metadata_gate_docs_and_operations_contract.py -q`
