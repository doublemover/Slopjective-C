...
Scope: M237 lane-D interop behavior for qualified generic APIs contract and architecture freeze for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_d001_block_runtime_abi_wiring_and_linkage_contract_and_architecture_freeze_packet.md`
  - `scripts/check_m237_d001_block_runtime_abi_wiring_and_linkage_contract.py`
  - `tests/tooling/test_check_m237_d001_block_runtime_abi_wiring_and_linkage_contract.py`
- Lane-D D001 freeze remains issue-local and fail-closed against `M237-C001` drift.
...
- `python scripts/check_m237_d001_block_runtime_abi_wiring_and_linkage_contract.py`
- `python -m pytest tests/tooling/test_check_m237_d001_block_runtime_abi_wiring_and_linkage_contract.py -q`
