...
Execute performance and quality guardrails governance for lane-A conformance corpus governance and sharding so conformance-corpus-expansion outputs from `M230-A010` are consumed deterministically and fail-closed before robustness workpacks begin.

This stage treats code/spec anchors and milestone optimization improvements as mandatory scope inputs.

## Dependency Inputs (M230-A010)
...
- `package.json` (`check:objc3c:m230-a011-lane-a-readiness`)

## Deterministic Invariants

1. A011 readiness must chain from `M230-A010` readiness and fail closed when dependency continuity drifts.
