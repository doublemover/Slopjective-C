...
Scope: M238 lane-E exception conformance gate and documentation contract and architecture freeze bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_e001_exception_conformance_gate_and_documentation_contract_and_architecture_freeze_packet.md`
...
- `python scripts/check_m238_e001_exception_conformance_gate_and_documentation_contract.py --summary-out tmp/reports/m238/M238-E001/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m238_e001_exception_conformance_gate_and_documentation_contract.py -q`
