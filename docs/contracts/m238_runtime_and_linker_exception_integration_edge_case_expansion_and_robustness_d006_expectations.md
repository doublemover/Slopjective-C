...
Scope: M238 lane-D interop behavior for qualified generic APIs edge-case expansion and robustness for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_d006_runtime_and_linker_exception_integration_edge_case_expansion_and_robustness_packet.md`
...
- Lane-D D006 freeze remains issue-local and fail-closed against `M238-C001` drift.
