# M236 Ownership Gate and Performance Evidence Recovery and Determinism Hardening Expectations (E001)
...
Scope: M236 lane-E ownership gate and performance evidence recovery and determinism hardening bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e008_ownership_gate_and_performance_evidence_recovery_and_determinism_hardening_packet.md`
  - `scripts/check_m236_e008_ownership_gate_and_performance_evidence_contract.py`
  - `tests/tooling/test_check_m236_e008_ownership_gate_and_performance_evidence_contract.py`
...
- `python scripts/check_m236_e008_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E008/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e008_ownership_gate_and_performance_evidence_contract.py -q`

## Evidence Path

- `tmp/reports/m236/M236-E008/local_check_summary.json`
