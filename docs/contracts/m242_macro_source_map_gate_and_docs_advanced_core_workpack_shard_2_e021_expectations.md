...
Scope: M242 lane-E macro/source-map gate and docs advanced core workpack (shard 2) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e021_macro_source_map_gate_and_docs_advanced_core_workpack_shard_2_packet.md`
...
- `python scripts/check_m242_e021_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E021/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e021_macro_source_map_gate_and_docs_contract.py -q`
