...
Execute diagnostics hardening governance for lane-A class/protocol/category metadata generation so modular split/scaffolding outputs from `M229-A006` are consumed deterministically and fail-closed before edge-case and compatibility workpacks begin.

This stage treats code/spec anchors and milestone optimization improvements as mandatory scope inputs.

## Dependency Inputs (M229-A006)
...
- `package.json` (`check:objc3c:m229-a007-lane-a-readiness`)

## Deterministic Invariants

1. A007 readiness must chain from `M229-A006` readiness and fail closed when dependency continuity drifts.
