...
Scope: M237 lane-D interop behavior for qualified generic APIs recovery and determinism hardening for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_d008_block_runtime_abi_wiring_and_linkage_recovery_and_determinism_hardening_packet.md`
...
- Lane-D D008 freeze remains issue-local and fail-closed against `M237-C001` drift.
