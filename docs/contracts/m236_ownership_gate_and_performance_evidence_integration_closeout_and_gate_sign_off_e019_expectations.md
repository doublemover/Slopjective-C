...
Scope: M236 lane-E ownership gate and performance evidence integration closeout and gate sign-off bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e019_ownership_gate_and_performance_evidence_integration_closeout_and_gate_sign_off_packet.md`
...
- `python scripts/check_m236_e019_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E019/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e019_ownership_gate_and_performance_evidence_contract.py -q`
