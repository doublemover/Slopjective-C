# M238 Exception conformance gate and documentation Modular Split and Scaffolding Expectations (E002)

Contract ID: `objc3c-exception-conformance-gate-and-documentation-modular-split-and-scaffolding/m238-e002-v1`
Status: Accepted
Issue: `#6116`
Dependencies: `M238-A001`, `M238-B001`, `M238-C001`
Scope: M238 lane-E exception conformance gate and documentation modular split and scaffolding bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m238/m238_e002_exception_conformance_gate_and_documentation_modular_split_and_scaffolding_packet.md`
  - `scripts/check_m238_e002_exception_conformance_gate_and_documentation_contract.py`
  - `tests/tooling/test_check_m238_e002_exception_conformance_gate_and_documentation_contract.py`
...
- `python scripts/check_m238_e002_exception_conformance_gate_and_documentation_contract.py --summary-out tmp/reports/m238/M238-E002/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m238_e002_exception_conformance_gate_and_documentation_contract.py -q`

## Evidence Path

- `tmp/reports/m238/M238-E002/local_check_summary.json`
