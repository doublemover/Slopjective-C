# M242 Macro/source-map gate and docs Release-candidate and Replay Dry-run Expectations (E014)

Contract ID: `objc3c-macro-source-map-gate-and-docs-release-candidate-and-replay-dry-run/m242-e014-v1`
Status: Accepted
Issue: `#6406`
Dependencies: `M242-A001`, `M242-B001`, `M242-C001`
Scope: M242 lane-E macro/source-map gate and docs release-candidate and replay dry-run bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e014_macro_source_map_gate_and_docs_release_candidate_and_replay_dry_run_packet.md`
  - `scripts/check_m242_e014_macro_source_map_gate_and_docs_contract.py`
  - `tests/tooling/test_check_m242_e014_macro_source_map_gate_and_docs_contract.py`
...
- `python scripts/check_m242_e014_macro_source_map_gate_and_docs_contract.py --summary-out tmp/reports/m242/M242-E014/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m242_e014_macro_source_map_gate_and_docs_contract.py -q`

## Evidence Path

- `tmp/reports/m242/M242-E014/local_check_summary.json`
