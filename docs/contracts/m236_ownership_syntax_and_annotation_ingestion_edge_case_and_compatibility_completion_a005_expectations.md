...
Status: Accepted
Scope: M236 lane-A qualifier/generic grammar normalization edge-case and compatibility completion for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_a005_ownership_syntax_and_annotation_ingestion_edge_case_and_compatibility_completion_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M236 lane-A A005 qualifier/generic grammar normalization fail-closed anchor text.
...
- `package.json` includes `check:objc3c:m236-a005-ownership-syntax-and-annotation-ingestion-contract`.
- `package.json` includes `test:tooling:m236-a005-ownership-syntax-and-annotation-ingestion-contract`.
- `package.json` includes `check:objc3c:m236-a005-lane-a-readiness`.
