...
Status: Accepted
Dependencies: none
Scope: M239 lane-C qualified type lowering and ABI representation cross-lane integration sync for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m239/m239_c012_cfg_ssa_lowering_and_phi_construction_cross_lane_integration_sync_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M239 lane-C C012
...
- `package.json` includes `check:objc3c:m239-c012-lane-c-readiness`.
