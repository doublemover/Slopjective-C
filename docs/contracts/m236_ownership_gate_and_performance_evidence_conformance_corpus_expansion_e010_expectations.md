# M236 Ownership Gate and Performance Evidence Conformance Corpus Expansion Expectations (E001)
...
Scope: M236 lane-E ownership gate and performance evidence conformance corpus expansion bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e010_ownership_gate_and_performance_evidence_conformance_corpus_expansion_packet.md`
  - `scripts/check_m236_e010_ownership_gate_and_performance_evidence_contract.py`
  - `tests/tooling/test_check_m236_e010_ownership_gate_and_performance_evidence_contract.py`
...
- `python scripts/check_m236_e010_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E010/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e010_ownership_gate_and_performance_evidence_contract.py -q`

## Evidence Path

- `tmp/reports/m236/M236-E010/local_check_summary.json`
