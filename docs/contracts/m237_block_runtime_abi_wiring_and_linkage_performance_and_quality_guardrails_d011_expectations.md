...
Scope: M237 lane-D interop behavior for qualified generic APIs performance and quality guardrails for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_d011_block_runtime_abi_wiring_and_linkage_performance_and_quality_guardrails_packet.md`
...
- Lane-D D011 freeze remains issue-local and fail-closed against `M237-C001` drift.
