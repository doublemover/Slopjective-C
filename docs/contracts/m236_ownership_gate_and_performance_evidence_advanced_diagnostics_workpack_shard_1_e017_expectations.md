# M236 Ownership Gate and Performance Evidence Advanced Diagnostics Workpack (shard 1) Expectations (E001)
...
Scope: M236 lane-E ownership gate and performance evidence advanced diagnostics workpack (shard 1) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m236/m236_e017_ownership_gate_and_performance_evidence_advanced_diagnostics_workpack_shard_1_packet.md`
  - `scripts/check_m236_e017_ownership_gate_and_performance_evidence_contract.py`
  - `tests/tooling/test_check_m236_e017_ownership_gate_and_performance_evidence_contract.py`
...
- `python scripts/check_m236_e017_ownership_gate_and_performance_evidence_contract.py --summary-out tmp/reports/m236/M236-E017/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m236_e017_ownership_gate_and_performance_evidence_contract.py -q`

## Evidence Path

- `tmp/reports/m236/M236-E017/local_check_summary.json`
