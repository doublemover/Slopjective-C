...
Scope: M241 lane-E module gate and reproducibility evidence advanced diagnostics workpack (shard 1) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m241/m241_e017_module_gate_and_reproducibility_evidence_advanced_diagnostics_workpack_shard_1_packet.md`
...
- `python scripts/check_m241_e017_module_gate_and_reproducibility_evidence_contract.py --summary-out tmp/reports/m241/M241-E017/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m241_e017_module_gate_and_reproducibility_evidence_contract.py -q`
