...
Execute advanced diagnostics workpack (shard 1) governance for lane-C interop boundary ABI handling, locking deterministic declaration-grammar boundaries before modular split/scaffolding work begins.
...
- `spec/planning/compiler/m229/m229_c017_interop_boundary_abi_handling_advanced_diagnostics_workpack_shard1_packet.md`
...
- `package.json` (`check:objc3c:m229-c017-lane-c-readiness`)

## Deterministic Invariants

1. Contract-freeze artifacts and packet anchors must remain synchronized and fail closed on drift.
2. Lane-B architecture/spec/package anchors must remain explicit and deterministic for `M229-C017`.
