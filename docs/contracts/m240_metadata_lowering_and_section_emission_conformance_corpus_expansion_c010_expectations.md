# M240 Qualified Type Lowering and ABI Representation Conformance Corpus Expansion Expectations (C010)

Contract ID: `objc3c-metadata-lowering-and-section-emission-contract/m240-c010-v1`
Status: Accepted
Dependencies: none
Scope: M240 lane-C qualified type lowering and ABI representation conformance corpus expansion for nullability, generics, and qualifier completeness.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_c010_metadata_lowering_and_section_emission_conformance_corpus_expansion_packet.md`
...
- `native/objc3c/src/ARCHITECTURE.md` includes explicit M240 lane-C C010
...
- `package.json` includes `check:objc3c:m240-c010-lane-c-readiness`.
