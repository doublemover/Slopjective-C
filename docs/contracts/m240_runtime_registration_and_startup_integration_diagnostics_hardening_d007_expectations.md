...
Scope: M240 lane-D interop behavior for qualified generic APIs diagnostics hardening for nullability, generics, and qualifier completeness interop continuity.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m240/m240_d007_runtime_registration_and_startup_integration_diagnostics_hardening_packet.md`
...
- Lane-D D007 freeze remains issue-local and fail-closed against `M240-C001` drift.
