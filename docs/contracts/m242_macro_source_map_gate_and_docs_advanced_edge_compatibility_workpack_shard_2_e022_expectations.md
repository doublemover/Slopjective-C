...
Scope: M242 lane-E macro/source-map gate and docs advanced edge compatibility workpack (shard 2) bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m242/m242_e022_macro_source_map_gate_and_docs_advanced_edge_compatibility_workpack_shard_2_packet.md`
