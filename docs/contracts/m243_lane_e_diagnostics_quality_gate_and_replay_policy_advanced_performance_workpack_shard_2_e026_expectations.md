# M243 Lane-E Diagnostics Quality Gate and Replay Policy Advanced Performance Workpack (shard 2) Expectations (E026)
...
- Issue `#6512` defines the canonical lane-E dependency chain for E012.
...
- `python scripts/check_m243_e026_lane_e_diagnostics_quality_gate_and_replay_policy_advanced_performance_workpack_shard_2_contract.py --emit-json`
