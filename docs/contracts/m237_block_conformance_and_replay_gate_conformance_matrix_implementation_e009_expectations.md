...
Scope: M237 lane-E block conformance and replay gate conformance matrix implementation bound to currently-closed early lane steps.
...
- Packet/checker/test assets remain mandatory:
  - `spec/planning/compiler/m237/m237_e009_block_conformance_and_replay_gate_conformance_matrix_implementation_packet.md`
...
- `python scripts/check_m237_e009_block_conformance_and_replay_gate_contract.py --summary-out tmp/reports/m237/M237-E009/local_check_summary.json`
- `python -m pytest tests/tooling/test_check_m237_e009_block_conformance_and_replay_gate_contract.py -q`
