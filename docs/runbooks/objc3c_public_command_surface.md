...
- Current public script count: `58`
...
| `check:showcase:surface` | `check-showcase-surface` | `repo` | `showcase examples stay compile-coupled, checked in, and tied to the public compiler path` | `fixed-shape` | `python:scripts/check_showcase_surface.py` |
