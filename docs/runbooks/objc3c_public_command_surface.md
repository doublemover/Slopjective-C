...
| `test:fast` | `test-fast` | `fast` | `runtime acceptance and ABI/accessor proof` | `fixed-shape` | `runner-internal` |
...
| `test:objc3c` | `test-recovery` | `recovery` | `recovery compile success and deterministic recovery diagnostics` | `fixed-shape` | `pwsh:scripts/check_objc3c_native_recovery_contract.ps1` |
