...
- latest source head folded into this docs-only map: `ea5924980` (`HC extract final readiness failure reasons module`)
...
- The latest committed source head folded into this docs-only map is `ea5924980`.
  Validation, GitHub commands, push, and remote issue edits remain deferred.
