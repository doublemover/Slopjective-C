...
- latest source head folded into this docs-only map: `248820d9a` (`HC move metaprogramming artifact emission builders`)
...
- The latest committed source head folded into this docs-only map is `248820d9a`.
  Validation, GitHub commands, push, and remote issue edits remain deferred.
