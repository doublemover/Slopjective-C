...
source head is `10abd536d` (`HC move interop lowering contract builders`).
Prior covered source heads were `7ef7fd02a` (`HC split runtime corrective behavior owners`),
...
`98d10a61c`, and the latest local implementation slices through `10abd536d`.
