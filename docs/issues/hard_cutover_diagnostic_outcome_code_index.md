...
| `OBJC3-E-REMOVED-COMPATIBILITY-SHIM` | semantic rejection | removed compatibility shim gate | `#8135`, `#8145`, `#8147` |
...
| `absent-support` | absent support | migration lane as behavior support | `#8145`, `#8149`, `#8150` |
