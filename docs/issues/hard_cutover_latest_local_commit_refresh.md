...
refreshes through source commit `9e36fd3fe`. It does not assert validation, remote issue
...
| Diagnostics, removed-mode diagnostics, and capability truth | `#8135`, `#8145` | `d76f9e53a`, `e426ab91d`, `0ef6dd41f`, `8ec96d428`, `71d3e8c4c`, `2b4b66526`, `01a58e0ab`, `0da6806ec`, `4b41eeefc`, `9d337d188`, `578ade056`, `3d90deeaf` | Diagnostic code/severity/core/parse/catalog and removed-mode classifiers own rejection truth. Stdlib, support docs, and runbook edits align capability truth around canonical support and explicit absence of retired adapters, alternate acceptance paths, retired-source lanes, and compatibility-mode support. |
...
| Diagnostics, config, and capability truth surfaces | `#8135`, `#8138`, `#8145`, `#8148`, `#8150` | `bad575206`, `8fd99d3e`, `34bb8547b`, `68865ee06`, `dfe365b2e`, `8457e4728`, `720c366a5`, `f38134a38`, `110c07879` | Diagnostic render/sink owner collapse, config state owner collapse, schema retired-term guidance, schema contract-table ownership, canonical config tooling expectations, public docs command-surface alignment, native docs source ownership, spec hard-cutover prose, and prose planning overlays refresh diagnostic/config/support truth. These commits keep retired compatibility terms restricted to rejection, source-hygiene, or negative evidence contexts. |
...
| `#8133` | Runtime dispatch evidence is refreshed by image class metadata owners, dispatch fast-path seeding, method resolution table/cache/builtin lookup/class-chain owners, dispatch status helpers, runtime public ABI records, class graph snapshots, dispatch state snapshots, protocol conformance snapshots/query owners, property/storage reflection snapshot owners, and image registration API owners. Fallback dispatch remains strict-error evidence. |
...
| `#8145` | Capability truth evidence is refreshed by diagnostic/config owner cleanup, schema retired-term/contract-table guidance, canonical config tooling expectations, public docs command-surface alignment, native docs source ownership, spec hard-cutover prose, prose planning overlays, and fixture boundary residue contracts. Retired compatibility terms stay bounded to negative evidence and source-hygiene contexts. |
...
to source commit `9e36fd3fe` without running validation, GitHub commands, push, or remote
